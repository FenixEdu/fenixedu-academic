...
//	}
	...
	public void testReadAllMasterDegrees(){
		try {
			...
			ICursoExecucao cursoExecucao = (ICursoExecucao) result.get(0);

			System.out.println("===========================================");
			System.out.println(cursoExecucao.getCurricularPlan().getDegree().getNome());
			
			System.out.println(cursoExecucao.getCurricularPlan().getCurricularCourses().size());
			System.out.println(((ICurricularCourse)cursoExecucao.getCurricularPlan().getCurricularCourses().get(0)).getName());
			System.out.println("===========================================");
