 ...
 *
 */
public class VisualizePersonalInfoActionTest
	...
	public static Test suite() {
		TestSuite suite = new TestSuite(VisualizePersonalInfoActionTest.class);
		return suite;
	}
	 ...
	 * @param testName
	 */
	public VisualizePersonalInfoActionTest(String testName) {
		super(testName);
	}
	...
	protected Map getExistingAttributesListToVerifyInSuccessfulExecution() {
		...
		requestAttributes.add("personalInfo");
