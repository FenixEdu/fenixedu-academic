...
public class CreateContributorDispatchActionCreateMethodTest
	...
	public static Test suite() {
		TestSuite suite = new TestSuite(CreateContributorDispatchActionCreateMethodTest.class);
		return suite;
	}
	 ...
	 * @param testName
	 */
	public CreateContributorDispatchActionCreateMethodTest(String testName) {
		super(testName);
	}
	...
	protected Map getItemsToPutInRequestForActionToBeTestedSuccessfuly() {
		...
		requestParameters.put("contributorNumber","999");
	...
	protected String getRequestPathInfoNameAction() {
		return "/createContributorDispatchAction";
	}
