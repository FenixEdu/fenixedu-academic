...
public class ChooseGuideDispatchActionChooseVersionMethodTest
	...
	public static Test suite() {
		TestSuite suite = new TestSuite(ChooseGuideDispatchActionChooseVersionMethodTest.class);
		return suite;
	}
	 ...
	 * @param testName
	 */
	public ChooseGuideDispatchActionChooseVersionMethodTest(String testName) {
		super(testName);
	}
	...
	protected Map getItemsToPutInRequestForActionToBeTestedSuccessfuly() {
		...
		requestParameters.put("method","chooseVersion");
		requestParameters.put("number","1");
		requestParameters.put("year","2002");
