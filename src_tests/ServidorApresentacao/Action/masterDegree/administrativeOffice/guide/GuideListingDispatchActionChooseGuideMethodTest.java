...
public class GuideListingDispatchActionChooseGuideMethodTest
	...
	public static Test suite() {
		TestSuite suite = new TestSuite(GuideListingDispatchActionChooseGuideMethodTest.class);
		return suite;
	}
	 ...
	 * @param testName
	 */
	public GuideListingDispatchActionChooseGuideMethodTest(String testName) {
		super(testName);
	}
	...
	protected Map getItemsToPutInRequestForActionToBeTestedSuccessfuly() {
		...
		requestParameters.put("method","chooseGuide");
	...
	protected Map getExistingAttributesListToVerifyInSuccessfulExecution() {
		...
		requestAttributes.add(SessionConstants.GUIDE_NUMBER);
		requestAttributes.add(SessionConstants.GUIDE_YEAR);
