...
public class ChooseGuideDispatchActionPrepareChooseMethodTest
	...
	public static Test suite() {
		TestSuite suite = new TestSuite(ChooseGuideDispatchActionPrepareChooseMethodTest.class);
		return suite;
	}
	 ...
	 * @param testName
	 */
	public ChooseGuideDispatchActionPrepareChooseMethodTest(String testName) {
		super(testName);
	}
	...
	protected Map getExistingAttributesListToVerifyInSuccessfulExecution() {
		...
		requestAttributes.add(SessionConstants.ACTION);
