...
public class ChooseGuideDispatchActionChooseMethodTest
	...
	public static Test suite() {
		TestSuite suite = new TestSuite(ChooseGuideDispatchActionChooseMethodTest.class);
		return suite;
	}
	 ...
	 * @param testName
	 */
	public ChooseGuideDispatchActionChooseMethodTest(String testName) {
		super(testName);
	}
	...
	protected Map getItemsToPutInRequestForActionToBeTestedSuccessfuly() {
		...
		requestParameters.put("method","choose");
		requestParameters.put("guideNumber","1");
		requestParameters.put("guideYear","2002");
	...
	protected Map getExistingAttributesListToVerifyInSuccessfulExecution() {
		...
		requestAttributes.add(SessionConstants.GUIDE_LIST);
	...
	protected String getRequestPathInfoNameAction() {
		return "/chooseGuideDispatchAction";
	}
