...
public class GuideListingDispatchActionPrepareChooseYearMethodTest
	...
	public static Test suite() {
		TestSuite suite = new TestSuite(GuideListingDispatchActionPrepareChooseYearMethodTest.class);
		return suite;
	}
	 ...
	 * @param testName
	 */
	public GuideListingDispatchActionPrepareChooseYearMethodTest(String testName) {
		super(testName);
	}
	...
	protected Map getItemsToPutInRequestForActionToBeTestedSuccessfuly() {
		...
		requestParameters.put("method","prepareChooseYear");
