...
public class EditGuideDispatchActionPrepareEditGuideInformationMethodTest
	...
	public static Test suite() {
		TestSuite suite = new TestSuite(EditGuideDispatchActionPrepareEditGuideInformationMethodTest.class);
		return suite;
	}
	 ...
	 * @param testName
	 */
	public EditGuideDispatchActionPrepareEditGuideInformationMethodTest(String testName) {
		super(testName);
	}
	...
	protected Map getItemsToPutInRequestForActionToBeTestedSuccessfuly() {
		...
		requestParameters.put("method","prepareEditInformation");
	...
	protected Map getExistingAttributesListToVerifyInSuccessfulExecution() {
		...
		sessionAttributes.add(SessionConstants.CONTRIBUTOR_LIST);
