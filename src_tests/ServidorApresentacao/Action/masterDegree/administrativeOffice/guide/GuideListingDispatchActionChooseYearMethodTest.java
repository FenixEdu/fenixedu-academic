...
public class GuideListingDispatchActionChooseYearMethodTest
	...
	public static Test suite() {
		TestSuite suite = new TestSuite(GuideListingDispatchActionChooseYearMethodTest.class);
		return suite;
	}
	 ...
	 * @param testName
	 */
	public GuideListingDispatchActionChooseYearMethodTest(String testName) {
		super(testName);
	}
	...
	protected Map getItemsToPutInRequestForActionToBeTestedSuccessfuly() {
		...
		requestParameters.put("method","chooseYear");
