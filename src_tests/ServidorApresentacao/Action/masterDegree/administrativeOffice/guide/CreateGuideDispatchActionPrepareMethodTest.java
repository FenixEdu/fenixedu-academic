...
public class CreateGuideDispatchActionPrepareMethodTest
	...
	public static Test suite() {
		TestSuite suite = new TestSuite(CreateGuideDispatchActionPrepareMethodTest.class);
		return suite;
	}
	 ...
	 * @param testName
	 */
	public CreateGuideDispatchActionPrepareMethodTest(String testName) {
		super(testName);
	}
	...
	protected Map getExistingAttributesListToVerifyInSuccessfulExecution() {
		...
		requestAttributes.add(SessionConstants.GUIDE_REQUESTER_LIST);
