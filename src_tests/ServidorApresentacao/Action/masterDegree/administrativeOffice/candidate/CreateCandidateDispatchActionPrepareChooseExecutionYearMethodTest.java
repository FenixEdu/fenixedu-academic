...
public class CreateCandidateDispatchActionPrepareChooseExecutionYearMethodTest
	...
	public static Test suite() {
		TestSuite suite = new TestSuite(CreateCandidateDispatchActionPrepareChooseExecutionYearMethodTest.class);
		return suite;
	}
	 ...
	 * @param testName
	 */
	public CreateCandidateDispatchActionPrepareChooseExecutionYearMethodTest(String testName) {
		super(testName);
	}
	...
	protected Map getItemsToPutInRequestForActionToBeTestedSuccessfuly() {
		...
		requestParameters.put("method","prepareChooseExecutionYear");
	...
	protected Map getExistingAttributesListToVerifyInSuccessfulExecution() {
		...
		requestAttributes.add(SessionConstants.EXECUTION_YEAR_LIST);
