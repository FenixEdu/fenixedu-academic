...
public class ListCandidateDispatchActionPrepareChooseMethodTest
	...
	public static Test suite() {
		TestSuite suite = new TestSuite(ListCandidateDispatchActionPrepareChooseMethodTest.class);
		return suite;
	}
	 ...
	 * @param testName
	 */
	public ListCandidateDispatchActionPrepareChooseMethodTest(String testName) {
		super(testName);
	}
