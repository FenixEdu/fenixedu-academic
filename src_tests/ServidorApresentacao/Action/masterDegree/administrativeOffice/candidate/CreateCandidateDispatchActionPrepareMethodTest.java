...
public class CreateCandidateDispatchActionPrepareMethodTest
	...
	public static Test suite() {
		TestSuite suite = new TestSuite(CreateCandidateDispatchActionPrepareMethodTest.class);
		return suite;
	}
	 ...
	 * @param testName
	 */
	public CreateCandidateDispatchActionPrepareMethodTest(String testName) {
		super(testName);
	}
	...
	protected Map getExistingAttributesListToVerifyInSuccessfulExecution() {
		...
		requestAttributes.add(SessionConstants.DEGREE_LIST);
		requestAttributes.add(SessionConstants.IDENTIFICATION_DOCUMENT_TYPE_LIST);
