 ...
 *
 */
public class ChooseCandidateActionTest
	...
	public static Test suite() {
		TestSuite suite = new TestSuite(ChooseCandidateActionTest.class);
		return suite;
	}
	 ...
	 * @param testName
	 */
	public ChooseCandidateActionTest(String testName) {
		super(testName);
	}
	...
	protected Map getItemsToPutInSessionForActionToBeTestedSuccessfuly() {
		...
		List masterDegreeList = new ArrayList();
		masterDegreeList.add(infoMasterDegreeCandidate);
		masterDegreeList.add(infoMasterDegreeCandidate);
		
		HashMap requestParameters = new HashMap();
		requestParameters.put(SessionConstants.MASTER_DEGREE_CANDIDATE_LIST, masterDegreeList);
	...
	protected Map getItemsToPutInRequestForActionToBeTestedSuccessfuly() {
		HashMap requestParameters = new HashMap();
		requestParameters.put("candidate","1");
		return requestParameters;
	}
