...
@author tfc130
*/
public class PrepararVerTurnoFormActionTest extends MockStrutsTestCase {
...
new Double(3.0),
    ...
    privilegios.add(new Privilegio(_pessoa1, new String("LerAulasDeTurno")));
...
/*  Nunca ocorre...*/
/*
  public void testUnsuccessfulPrepararVerTurno() {
  		...
  		InfoDisciplinaExecucao iDE1 = new InfoDisciplinaExecucao(_disciplinaExecucao1.getNome(), _disciplinaExecucao1.getSigla(),
  																_disciplinaExecucao1.getPrograma(),
  																 new InfoLicenciaturaExecucao (_disciplinaExecucao1.getLicenciaturaExecucao().getAnoLectivo(),
  																							   new InfoLicenciatura(_disciplinaExecucao1.getLicenciaturaExecucao().getLicenciatura().getSigla(),
  																													_disciplinaExecucao1.getLicenciaturaExecucao().getLicenciatura().getSigla())));
  		InfoTurno infoTurnoInexistente = new InfoTurno("turnoInexistente", _turno1.getTipo(), _turno1.getLotacao(), iDE);
  		getSession().setAttribute("infoTurno", infoTurnoInexistente);

  		Object argsLerAulasDeTurno[] = { new KeyTurno(infoTurnoInexistente.getNome())};
  		ArrayList infoAulasDeTurno = (ArrayList) gestor.executar(userView, "LerAulasDeTurno", argsLerAulasDeTurno);
  		getSession().setAttribute("infoAulasDeTurno", infoAulasDeTurno);
