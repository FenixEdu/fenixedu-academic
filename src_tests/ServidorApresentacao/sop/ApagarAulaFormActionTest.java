...
@author tfc130
*/
public class ApagarAulaFormActionTest extends MockStrutsTestCase {
...
_disciplinaExecucao1 =
    ...
    _aula1 = new Aula(new DiaSemana(DiaSemana.SEGUNDA_FEIRA), inicio, fim, new TipoAula(TipoAula.TEORICA), _sala1, _disciplinaExecucao1);
    _aulaPersistente.lockWrite(_aula1);

    _aula2 = new Aula(new DiaSemana(DiaSemana.TERCA_FEIRA), inicio, fim, new TipoAula(TipoAula.TEORICA), _sala1, _disciplinaExecucao1);
