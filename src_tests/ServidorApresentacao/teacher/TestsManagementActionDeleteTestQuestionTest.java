 ...
 */
public class TestsManagementActionDeleteTestQuestionTest
	extends TestCasePresentationTeacherPortal {

	public TestsManagementActionDeleteTestQuestionTest(String testName) {
		super(testName);
	}
	...
	protected Map getItemsToPutInRequestForActionToBeTestedSuccessfuly() {
		...
		result.put("method", "deleteTestQuestion");
