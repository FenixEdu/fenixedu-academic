 ...
 */
public class TestsManagementActionPrepareEditTestHeader
	extends TestCasePresentationTeacherPortal {

	public TestsManagementActionPrepareEditTestHeader(String testName) {
		super(testName);
	}
	...
	protected Map getItemsToPutInRequestForActionToBeTestedSuccessfuly() {
		...
		result.put("method", "prepareEditTestHeader");
