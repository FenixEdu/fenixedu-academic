 ...
 */
public class TestsManagementActionEditTestQuestionTest
	extends TestCasePresentationTeacherPortal {

	public TestsManagementActionEditTestQuestionTest(String testName) {
		super(testName);
	}
	...
	protected Map getItemsToPutInRequestForActionToBeTestedSuccessfuly() {
		...
		Integer testQuestionCode = new Integer(8);
		Integer testQuestionOrder = new Integer(1);
		Integer testQuestionValue = new Integer(1);

		result.put("method", "editTestQuestion");
		result.put("objectCode", objectCode.toString());
		result.put("testCode", testCode.toString());
		result.put("testQuestionCode", testQuestionCode.toString());
		result.put("testQuestionOrder", testQuestionOrder.toString());
		result.put("testQuestionValue", testQuestionValue.toString());
