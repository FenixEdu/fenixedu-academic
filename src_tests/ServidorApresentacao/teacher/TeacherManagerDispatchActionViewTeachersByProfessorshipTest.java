 ...
 * Window>Preferences>Java>Code Generation>Code and Comments
 */
public class TeacherManagerDispatchActionViewTeachersByProfessorshipTest
	extends TestCasePresentationTeacherPortal {

	/**
	 * @param testName
	 */
	public TeacherManagerDispatchActionViewTeachersByProfessorshipTest(String testName) {
		super(testName);		
	}
	...
	protected Map getItemsToPutInRequestForActionToBeTestedSuccessfuly() {
		Map result = new HashMap();
		result.put("method","viewTeachersByProfessorship");			
		return result;
	}
