 ...
 */
public class TestsManagementActionInsertTestQuestionTest
	extends TestCasePresentationTeacherPortal {

	public TestsManagementActionInsertTestQuestionTest(String testName) {
		super(testName);
	}
	...
	protected Map getItemsToPutInRequestForActionToBeTestedSuccessfuly() {
		...
		Integer metadataCode = new Integer(3);
		Integer questionOrder = new Integer(1);
		Integer questionValue = new Integer(1);

		result.put("method", "insertTestQuestion");
		...
		result.put("questionOrder", questionOrder.toString());
		result.put("questionValue", questionValue.toString());
