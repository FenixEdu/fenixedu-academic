 ...
 */
public class TestsManagementActionPrepareEditTestQuestionTest
	extends TestCasePresentationTeacherPortal {

	public TestsManagementActionPrepareEditTestQuestionTest(String testName) {
		super(testName);
	}
	...
	protected Map getItemsToPutInRequestForActionToBeTestedSuccessfuly() {
		...
		Integer questionCode = new Integer(1);

		result.put("method", "prepareEditTestQuestion");
		result.put("objectCode", objectCode.toString());
		result.put("testCode", testCode.toString());
		result.put("questionCode", questionCode.toString());
