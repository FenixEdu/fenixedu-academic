 ...
 */
public class TestsManagementActionShowAvailableQuestionsTest
	extends TestCasePresentationTeacherPortal {

	public TestsManagementActionShowAvailableQuestionsTest(String testName) {
		super(testName);
	}
	...
	protected Map getItemsToPutInRequestForActionToBeTestedSuccessfuly() {
		...
		result.put("method", "showAvailableQuestions");
