...
import ServidorAplicacao.Servico.sop.exams.EditExamNew;
...
public class EditExamNewTest extends ServiceTestCase
{
    ...
    public void testSuccessfullEditExamNewAddElementsAndChangeDateAndTimeAndSeason()
    {
        ...
        catch (FenixServiceException ex)
        {
            ...
            fail("testSuccessfullEditExamNewAddElementsAndChangeDateAndTimeAndSeason - Fenix Service Exception " + ex);
        }
        catch (Exception ex)
        {
            //sp.cancelarTransaccao();			
    ...
    public void testSuccessfullEditExamNewChangeDateAndTimeOnExamWithoutRooms()
    {
        ...
        {
            //sp.cancelarTransaccao();
            fail("testSuccessfullEditExamNewChangeDateAndTimeOnExamWithoutRooms - Fenix Service Exception " + ex);
        }
        catch (Exception ex)
        {
            //sp.cancelarTransaccao();			
    ...
    public void testSuccessfullEditExamNewAddAndRemoveScopes()
    {
        ...
        String[] executionCourseIDArray = 
			{ "36721" };
        String[] scopeIDArray = 
			{"17335" }; //removed 18276 and added 17335
        String[] roomIDArray = 
			{ };
    ...
    public void testSuccessfullEditExamNewAddAndRemoveExecutionCourses()
    {
        ...
        Season season = new Season(new Integer(2));
         String[] executionCourseIDArray = 
			{ "36422" }; //removed 36723 and added 36422		 
        ...
        {
            //sp.cancelarTransaccao();
            fail("testSuccessfullEditExamNewAddAndRemoveExecutionCourses - Fenix Service Exception " + ex);
        }
        catch (Exception ex)
        {
            //sp.cancelarTransaccao();			
    ...
    public void testUnsuccessfullEditExamNewChangeDateAndTimeForRoomsOccupied()
    {
        ...
        catch (FenixServiceException ex)
        {
			...
			{		
				fail("testUnsuccessfullEditExamNewChangeDateAndTimeForRoomsOccupied - Exception cancelar transacção " + e);
			}
   	...
   	public void testUnsuccessfullEditExamNewChangeSeasonForAlreadyExistingSeason()
    {
        ...
        catch (FenixServiceException ex)
        {
			...
			{		
				fail("testUnsuccessfullEditExamNewChangeSeasonForAlreadyExistingSeason - Exception cancelar transacção " + e);
			}
			compareDataSetUsingExceptedDataSetTableColumns(getDataSetFilePath());     
        }
        catch (Exception ex)
   	...
   	public void testUnsuccessfullEditExamNewAddExecutionCourseThatAlreadyHasExamForThatSeason()
    {
        ...
        Season season = new Season(new Integer(2));
      	String[] executionCourseIDArray = 
				{ "36422",
				  "36723" //execution course with exam
				 };
        String[] scopeIDArray = 
				{ "724",
				  "731",
        ...
        catch (FenixServiceException ex)
        {
			...
			{		
				fail("testUnsuccessfullEditExamNewAddExecutionCourseThatAlreadyHasExamForThatSeason - Exception cancelar transacção " + e);
			}
			compareDataSetUsingExceptedDataSetTableColumns(getDataSetFilePath());     
        }
        catch (Exception ex)
        {			
			fail("testUnsuccessfullEditExamNewAddExecutionCourseThatAlreadyHasExamForThatSeason - Exception " + ex);
        }
    }
   	...
   	public void testUnsuccessfullEditExamNewAddScopesThatAlreadyHasExamForThatSeason()
    {
        ...
        catch (FenixServiceException ex)
        {
			...
			{		
				fail("testUnsuccessfullEditExamNewAddScopesThatAlreadyHasExamForThatSeason - Exception cancelar transacção " + e);
			}
			compareDataSetUsingExceptedDataSetTableColumns(getDataSetFilePath());     
        }
        catch (Exception ex)
        {			
			fail("testUnsuccessfullEditExamNewAddScopesThatAlreadyHasExamForThatSeason - Exception " + ex);
        }
    }
   	...
   	public void testUnsuccessfullEditExamNewWithUnexistentExecutionCourseAndScopeAndRoom()
    {
        ...
        Season season = new Season(new Integer(2));
        String[] executionCourseIDArray = 
			{ "36000" //unexistent execution course
			};
        String[] scopeIDArray = 
			{ "17000" //unexistent scope
			};
        String[] roomIDArray = 
			{ "800" //unexistent room
			};
        ...
        catch (FenixServiceException ex)
        {
			...
			{		
				fail("testUnsuccessfullEditExamNewWithUnexistentExecutionCourseAndScopeAndRoom - Exception cancelar transacção " + e);
			}
			compareDataSetUsingExceptedDataSetTableColumns(getDataSetFilePath());     
        }
        catch (Exception ex)
        {			
			fail("testUnsuccessfullEditExamNewWithUnexistentExecutionCourseAndScopeAndRoom - Exception " + ex);
        }
    } 
   	...
   	public void testUnsuccessfullEditExamNewRemoveAllExecutionCoursesAndScopes()
    {
        ...
        catch (FenixServiceException ex)
        {
			...
			{		
				fail("testUnsuccessfullEditExamNewRemoveAllExecutionCoursesAndScopes - Exception cancelar transacção " + e);
			}
			compareDataSetUsingExceptedDataSetTableColumns(getDataSetFilePath());     
        }
        catch (Exception ex)
