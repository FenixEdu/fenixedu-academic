...
public class ReadFilteredExamsMapTest extends ServiceTestCase
{
    ...
    private InfoDegreeCurricularPlan createInfoDegreeCurricularPlan(InfoDegree infoDegree)
    {
        ...
        InfoDegreeCurricularPlan infoDegreeCurricularPlan =
            new InfoDegreeCurricularPlan("LEIC - Currículo Antigo", infoDegree);
    ...
    public void testSuccessfullReadFilteredExamsMap()
    {
        ...
        try
        {
            ...
            InfoExecutionDegree infoExecutionDegree =
                ReadExecutionDegreeByOID.getService().run(new Integer(10));
            InfoExecutionPeriod infoExecutionPeriod =
                ReadExecutionPeriod.getService().run(new Integer(1));
            /////
            ...
            assertTrue(
                "Curricular year 4 not in list!",
                infoExamsMap.getCurricularYears().contains(new Integer(4)));
