...
public class ChangeApplicationInfoTest extends TestCaseServicosCandidato {
    ...
    public void testAlterarCandidatoComPrivilegios() {
        ...
        assertEquals(infoMasterDegreeCandidate.getMajorDegree(), newInfoMasterDegreeCandidate
                .getMajorDegree());
        assertEquals(infoMasterDegreeCandidate.getMajorDegreeSchool(), newInfoMasterDegreeCandidate
                .getMajorDegreeSchool());
        assertEquals(infoMasterDegreeCandidate.getMajorDegreeYear(), newInfoMasterDegreeCandidate
                .getMajorDegreeYear());
    ...
    public void testReadMasterDegreeCandidateExistingWithoutRole() {
        ...
        try {
            infoMasterDegreeCandidate = (InfoMasterDegreeCandidate) ServiceManagerServiceFactory
                    .executeService(userView, "ChangeApplicationInfo", null);
