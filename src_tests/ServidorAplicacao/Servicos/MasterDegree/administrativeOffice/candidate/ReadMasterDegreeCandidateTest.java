...
public class ReadMasterDegreeCandidateTest extends TestCaseReadServicesIntranet {
  ...
  protected Object getObjectToCompare(){
	...
	try {
		...
		IDegreeCurricularPlan degreeCurricularPlan = sp.getIPersistentDegreeCurricularPlan().readByNameAndDegree("plano2", degree);
		...
		infoMasterDegreeCandidate = Cloner.copyIMasterDegreeCandidate2InfoMasterDegreCandidate(masterDegreeCandidate);
  ...
  protected Object[] getArgumentsOfServiceToBeTestedSuccessfuly() {
	...
	try {
		...
		executionDegree = sp.getICursoExecucaoPersistente().readByDegreeCurricularPlanAndExecutionYear(degreeCurricularPlan, executionYear);
		assertNotNull(executionDegree);
