 ...
 *  
 */
public class ReadGratuityValuesByDegreeCurricularPlanAndExecutionYear extends
        AdministrativeOfficeBaseTest {

    public ReadGratuityValuesByDegreeCurricularPlanAndExecutionYear(String name) {
        super(name);
        this.dataSetFilePath = "etc/datasets/servicos/MasterDegree/administrativeOffice/gratuity/testReadGratuityValuesByDegreeCurricularPlanAndExecutionYearDataSet.xml";
    }
    ...
    public void testSucessReadGratuityValues() {
        ...
        // SCHOLARSHIP_VALUE='NULL' FINAL_PROOF_VALUE='NULL'
        //COURSE_VALUE='50' CREDIT_VALUE='NULL' PROOF_REQUEST_PAYMENT='1'
        // START_PAYMENT='2003-01-01' END_PAYMENT='2003-12-31'
        // KEY_EXECUTION_DEGREE='10' />
