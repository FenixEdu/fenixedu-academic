...
public abstract class AdministrativeOfficeBaseTest extends ServiceTestCase {
	...
	public void testNotAuthenticatedExecution() {
		try {
			serviceManager.executar(null, getNameOfServiceToBeTested(), getServiceArgumentsForNotAuthenticatedUser());
	...
	public void testNotAuthorizedExecution() {
		try {
			serviceManager.executar(userViewNotAuthorized, getNameOfServiceToBeTested(), getServiceArgumentsForNotAuthorizedUser());
	...
	protected abstract Object[] getServiceArgumentsForNotAuthenticatedUser() throws FenixServiceException;
