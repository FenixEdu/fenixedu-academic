...
public class ChangeMasterDegreeThesisDataTest extends AdministrativeOfficeBaseTest {
    ...
    protected Object[] getServiceArgumentsForNotAuthenticatedUser() {
        ...
        Object[] argsChangeMasterDegreeThesis = { null, infoStudentCurricularPlan, "some title",
    ...
    protected Object[] getServiceArgumentsForNotAuthorizedUser() throws FenixServiceException {
        ...
        Object[] argsChangeMasterDegreeThesis = { userViewNotAuthorized, infoStudentCurricularPlan,
    ...
    public void testSuccessfulChangeMasterDegreeThesisData() {
        try {
            ...
            List externalAssistentGuiders = infoMasterDegreeThesisDataVersion
    ...
    public void testChangeMasterDegreeThesisDataUsingExistingDissertationTitle() {
        try {
            ...
            Object[] argsChangeMasterDegreeThesis = { userView, infoStudentCurricularPlan,
    ...
    public void testChangeWhenMasterDegreeThesisDoesNotExist() {
        try {
            Object[] argsReadStudentCurricularPlan = { new Integer(180),
                    new TipoCurso(TipoCurso.MESTRADO) };
            InfoStudentCurricularPlan infoStudentCurricularPlan = (InfoStudentCurricularPlan) ServiceManagerServiceFactory
                    .executeService(userView,
                            "student.ReadActiveStudentCurricularPlanByNumberAndDegreeType",
    ...
    /*
     * public void testChangeMasterDegreeThesisDataWithoutGuiders() { try {
     * Object[] argsReadStudentCurricularPlan = { new Integer(142), new
     ...
     * infoMasterDegreeThesisDataVersion.getInfoAssistentGuiders(); List
     * externalAssistentGuiders =
     ...
     * assistentGuiders.add(infoTeacherAssistent);
     * 
     * Object[] argsChangeMasterDegreeThesis = { userView,
     ...
     * getNameOfServiceToBeTested(), argsChangeMasterDegreeThesis);
     * 
     * fail("testChangeMasterDegreeThesisDataWithoutGuiders did not throw
     * RequiredGuidersServiceException"); } catch
     * (RequiredGuidersServiceException e) { //ok } catch (Exception ex) {
     * ex.printStackTrace();
     * fail("testChangeMasterDegreeThesisDataWithoutGuiders " +
     * ex.getMessage()); }
     */
    ...
    public void testChangeMasterDegreeThesisWithTeacherBeingGuiderAndAssistentGuider() {
        try {
            ...
            ex.printStackTrace();
            fail("testChangeMasterDegreeThesisWithTeacherBeingGuiderAndAssistentGuider"
                    + ex.getMessage());
        }
    }
    ...
    public void testChangeWithExternalPersonBeingExternalGuiderAndExternalAssistentGuider() {
        ...
        } catch (GuiderAlreadyChosenServiceException e) { //ok
        } catch (Exception ex) {
            ex.printStackTrace();
            fail("testChangeWithExternalPersonBeingExternalGuiderAndExternalAssistentGuider"
                    + ex.getMessage());
        }
    }
}