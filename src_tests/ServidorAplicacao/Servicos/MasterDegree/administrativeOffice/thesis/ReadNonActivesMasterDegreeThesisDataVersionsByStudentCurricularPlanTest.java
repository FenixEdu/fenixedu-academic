    ...
    extends AdministrativeOfficeBaseTest
{
    ...
    public ReadNonActivesMasterDegreeThesisDataVersionsByStudentCurricularPlanTest(String testName)
    {
        ...
        this.dataSetFilePath =
            "etc/datasets/servicos/MasterDegree/administrativeOffice/thesis/testReadNonActivesMasterDegreeThesisDataVersionsByStudentCurricularPlanDataSet.xml";
    }
    ...
    public void testReadExistingNonActivesMasterDegreeThesisDataVersions()
    {
        try
        {
            ...
            Object[] argsReadMasterDegreeThesisDataVersion = { infoStudentCurricularPlan };
            List infoMasterDegreeThesisDataVersions =
