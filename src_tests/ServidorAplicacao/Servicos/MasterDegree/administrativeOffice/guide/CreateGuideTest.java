...
public class CreateGuideTest extends TestCaseServicos {
	...
	public void testCreateGuide() {
		...
		try {
			...
			person = (IPessoa) sp.getIPessoaPersistente().lerPessoaPorUsername("nmsn");
			assertNotNull(person);
			
			contributor = (IContributor) sp.getIPersistentContributor().readByContributorNumber(new Integer(123));
		...
		infoGuide.setInfoExecutionDegree(Cloner.copyIExecutionDegree2InfoExecutionDegree(executionDegree));
		...
		Object[] args = { infoGuide, "Selos", new Double(10), "observacoes", SituationOfGuide.PAYED_TYPE, PaymentType.ATM_STRING };
