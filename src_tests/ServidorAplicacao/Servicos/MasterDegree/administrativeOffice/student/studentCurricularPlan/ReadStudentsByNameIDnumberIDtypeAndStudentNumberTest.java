...
public class ReadStudentsByNameIDnumberIDtypeAndStudentNumberTest extends TestCase {
    ...
    protected void setUp() {
        ...
        try {
            this.authorisedUserView = (IUserView) ServiceManagerServiceFactory.executeService(null,
                    "Autenticacao", args1);
            this.notAuthorisedUserView = (IUserView) ServiceManagerServiceFactory.executeService(null,
                    "Autenticacao", args2);
        } catch (Exception ex) {
            System.out.println(ex.toString());
    ...
    public void testFindingOneStudent() {
        ...
        TipoDocumentoIdentificacao idType = new TipoDocumentoIdentificacao(
                TipoDocumentoIdentificacao.BILHETE_DE_IDENTIDADE);

        Object args[] = { studentName, idNumber, idType, studentNumber };

        try {
            result = (List) ServiceManagerServiceFactory.executeService(this.authorisedUserView,
        ...
        assertEquals(((InfoStudent) result.get(0)).getInfoPerson().getNumeroDocumentoIdentificacao(),
                idNumber);
        assertEquals(((InfoStudent) result.get(0)).getInfoPerson().getTipoDocumentoIdentificacao(),
                idType);
    ...
    public void testNotMasterDegreeAdminOfficeEmployee() {
        ...
        try {
            ServiceManagerServiceFactory.executeService(this.notAuthorisedUserView,
                    "ReadStudentsByNameIDnumberIDtypeAndStudentNumber", args);
