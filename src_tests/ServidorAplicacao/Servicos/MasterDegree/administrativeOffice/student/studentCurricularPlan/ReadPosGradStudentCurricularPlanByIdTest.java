...
public class ReadPosGradStudentCurricularPlanByIdTest extends TestCase {
	...
	public void testReadPosGradStudentCurricularPlanById() {
		...
		assertEquals(
			"Find correct Student of the Student curricular Plan",
		infoStudentCurricularPlan.getInfoStudent().getNumber(),
			new Integer(6000));
		assertEquals("Expect Student is master degree student", infoStudentCurricularPlan.getInfoStudent().getDegreeType(), new TipoCurso(2));
		assertEquals(
					"Find enrolments of the Student curricular Plan",
				new Integer(infoStudentCurricularPlan.getInfoEnrolments().size()),
					new Integer(4));
		...
		infoStudentCurricularPlan.getInfoStudent().getNumber(),
			new Integer(7000));
		assertEquals("Expect Student is degree student", infoStudentCurricularPlan.getInfoStudent().getDegreeType(), new TipoCurso(1));
