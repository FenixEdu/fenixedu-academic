...
public class TeacherAdministrationSiteComponentServiceAnnouncementsTest extends TestCaseReadServices {
	...
	protected Object[] getArgumentsOfServiceToBeTestedSuccessfuly() {
		 ...
		 Object[] args = { new Integer(26), new InfoSiteCommon(), new InfoSiteAnnouncement(), null, null, null};
		return args;
	}
	...
	protected  Object getObjectToCompare(){
		...
		TeacherAdministrationSiteView siteView = new TeacherAdministrationSiteView(infoSiteCommon, infoSiteAnnouncement);
