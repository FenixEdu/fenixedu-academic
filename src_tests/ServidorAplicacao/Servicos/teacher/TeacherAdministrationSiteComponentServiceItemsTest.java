...
public class TeacherAdministrationSiteComponentServiceItemsTest extends TestCaseReadServices {
	...
	protected Object[] getArgumentsOfServiceToBeTestedSuccessfuly() {
		...
		Object[] args = { new Integer(24), new InfoSiteCommon(), new InfoSiteItems(), null, new Integer(2), null };
		return args;
	}
	...
	protected Object getObjectToCompare() {
		...
		TeacherAdministrationSiteView siteView = new TeacherAdministrationSiteView(infoSiteCommon, infoSiteItems);
