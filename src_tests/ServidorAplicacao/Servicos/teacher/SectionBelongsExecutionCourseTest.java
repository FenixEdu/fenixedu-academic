 ...
 *  
 */
public abstract class SectionBelongsExecutionCourseTest extends ServiceNeedsAuthenticationTestCase {
    ...
    public void testSectionBelongsExecutionCourse() {
        ...
        try {
            ServiceManagerServiceFactory.executeService(userView, getNameOfServiceToBeTested(),
                    serviceArguments);
            System.out.println("testSectionBelongsExecutionCourse was SUCCESSFULY runned by service: "
    ...
    public void testSectionNotBelongsExecutionCourse() {
        ...
        try {
            ...
            System.out
                    .println("testSectionNotBelongsExecutionCourse was SUCCESSFULY runned by service: "
                            + getNameOfServiceToBeTested());
