...
public class ReadMetadatasTest extends TestCaseReadServices
{
    ...
    protected Object getObjectToCompare()
    {
        ...
        try
        {
            ...
            metadata1 = (IMetadata) persistentMetadata.readByOId(metadata1, false);
            ...
            metadata5 = (IMetadata) persistentMetadata.readByOId(metadata5, false);
            ...
            metadata7 = (IMetadata) persistentMetadata.readByOId(metadata7, false);
            assertNotNull("metadata null", metadata7);

            sp.confirmarTransaccao();
            infoExecutionCourse = (InfoExecutionCourse) Cloner.get(executionCourse);
            InfoMetadata infoMetadata1 = Cloner.copyIMetadata2InfoMetadata(metadata1);
            ...
            InfoMetadata infoMetadata5 = Cloner.copyIMetadata2InfoMetadata(metadata5);
            InfoMetadata infoMetadata6 = Cloner.copyIMetadata2InfoMetadata(metadata6);
            InfoMetadata infoMetadata7 = Cloner.copyIMetadata2InfoMetadata(metadata7);

            ParseMetadata p = new ParseMetadata();
            try
            {
                infoMetadata1 = p.parseMetadata(metadata1.getMetadataFile(), infoMetadata1, "");
                ...
                infoMetadata5 = p.parseMetadata(metadata5.getMetadataFile(), infoMetadata5, "");
                infoMetadata6 = p.parseMetadata(metadata6.getMetadataFile(), infoMetadata6, "");
                infoMetadata7 = p.parseMetadata(metadata7.getMetadataFile(), infoMetadata7, "");
            }
            catch (Exception e)
            {
