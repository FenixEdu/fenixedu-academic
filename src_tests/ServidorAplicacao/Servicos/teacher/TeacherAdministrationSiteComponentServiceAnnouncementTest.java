...
public class TeacherAdministrationSiteComponentServiceAnnouncementTest extends TestCaseReadServices {
	...
	protected Object[] getArgumentsOfServiceToBeTestedSuccessfuly() {
		...
		Object[] args = { new Integer(24), new InfoSiteCommon(), new InfoAnnouncement(), null, new Integer(1), null };
		return args;
	}
	...
	protected Object getObjectToCompare() {
		...
		try {
			...
			iAnnouncement = (IAnnouncement)sp.getIPersistentAnnouncement().readByOId(new Announcement(new Integer(1)), false);
		...
		TeacherAdministrationSiteView siteView = new TeacherAdministrationSiteView(infoSiteCommon, infoAnnouncement);
