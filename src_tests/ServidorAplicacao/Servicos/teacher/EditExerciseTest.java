...
public class EditExerciseTest extends ServiceNeedsAuthenticationTestCase {
    ...
    protected Object[] getAuthorizeArguments() {
        ...
        Object[] args = { executionCourseId, metadataId, author, description, difficulty, learningTime,
    ...
    public void testSuccessfull() {
        ...
        try {
            ...
            assertEquals(metadata.getLearningTime().get(Calendar.HOUR_OF_DAY),
                    expectedDistributedLearningTime.get(Calendar.HOUR_OF_DAY));
            assertEquals(metadata.getLearningTime().get(Calendar.MINUTE),
                    expectedDistributedLearningTime.get(Calendar.MINUTE));
            assertEquals(metadata.getLearningTime().get(Calendar.SECOND),
