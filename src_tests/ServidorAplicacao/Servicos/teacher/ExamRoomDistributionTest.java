 ...
 *  
 */
public class ExamRoomDistributionTest
	...
	protected Object[] getAuthorizeArguments() {
		...
		Object[] args =
			{ new Integer(27), new Integer(1), rooms, new Boolean(false)};
		return args;
	}
	...
	public void testSuccessfull() {
		...
		try {
			...
			IExam exam =
				(IExam) persistentExam.readByOId(
					new Exam((Integer) getAuthorizeArguments()[1]),
					false);
			...
			while (iter.hasNext()) {
				...
				assertTrue(
					rooms.contains(examStudentRoom.getRoom().getIdInternal()));
			}
	...
	public void testSuccessfullWithNoEnrollment() {
		List rooms = new ArrayList();
		rooms.add(new Integer(44));
		rooms.add(new Integer(45));
		rooms.add(new Integer(46));
		...
		Object[] args =
			{ new Integer(27), new Integer(5), rooms, new Boolean(false)};
		...
		try {
			...
			sp.confirmarTransaccao();
			System.out.println(
				"testSuccessfullWithNoEnrollment was SUCCESSFULY runned by class: "
					+ this.getClass().getName());
		} catch (Exception ex) {
			ex.printStackTrace();
			System.out.println(ex.getMessage());
			System.out.println(
				"testSuccessfullWithNoEnrollment was UNSUCCESSFULY runned by class: "
					+ this.getClass().getName());
	...
	public void testNonExistingRoom() {
		...
		try {
			...
			System.out.println(
				"testNonExistingRoom was UNSUCCESSFULY runned by class: "
					+ this.getClass().getName());
			...
			ex.printStackTrace();
			System.out.println(
				"testNonExistingRoom was SUCCESSFULY runned by service: "
					+ this.getClass().getName());

		} catch (Exception ex) {
			ex.printStackTrace();
			System.out.println(
				"testNonExistingRoom was UNSUCCESSFULY runned by service: "
					+ this.getClass().getName());
	...
	public void testInsuficientRooms() {
		...
		public void testNonExistingExecutionCourse() {
			...
			Object[] args =
				{ new Integer(100), new Integer(1), rooms, new Boolean(false)};
			try {
		...
		public void testNonExistingExam() {
			...
			Object[] args =
				{ new Integer(27), new Integer(100), rooms, new Boolean(false)};
			...
			try {
				...
				System.out.println(
					"testNonExistingExam was SUCCESSFULY runned by class: "
						+ this.getClass().getName());
			} catch (Exception ex) {
				ex.printStackTrace();
				System.out.println(
					"testNonExistingExam was UNSUCCESSFULY runned by service: "
						+ this.getClass().getName());
				fail("Unable to run service: " + this.getClass().getName());
			}
		}
		...
		public void testExamNotBelongsExecutionCourse() {
			...
			Object[] args =
				{ new Integer(27), new Integer(2), rooms, new Boolean(false)};
			...
			try {
				...
				System.out.println(
					"testExamNotBelongsExecutionCourse was SUCCESSFULY runned by class: "
						+ this.getClass().getName());
			} catch (Exception ex) {
				ex.printStackTrace();
				System.out.println(
					"testExamNotBelongsExecutionCourse was UNSUCCESSFULY runned by service: "
						+ this.getClass().getName());
				fail("Unable to run service: " + this.getClass().getName());
			}
		}
		...
		public void testNonDefinedEnrollmentPeriod() {
			...
			Object[] args =
				{ new Integer(27), new Integer(3), rooms, new Boolean(false)};
	
			try {
				gestor.executar(userView, getNameOfServiceToBeTested(), args);
	
				System.out.println(
					"testNonDefinedEnrollmentPeriod was UNSUCCESSFULY runned by class: "
						+ this.getClass().getName());
				fail("testNonDefinedEnrollmentPeriod");
			} catch (FenixServiceException ex) {
				if (ex.getErrorType()
					== ExamRoomDistribution.NON_DEFINED_ENROLLMENT_PERIOD) {
					System.out.println(
						"testNonDefinedEnrollmentPeriod was SUCCESSFULY runned by class: "
							+ this.getClass().getName());
				} else {
					System.out.println(
						"testNonDefinedEnrollmentPeriod was UNSUCCESSFULY runned by class: "
				...
				ex.printStackTrace();
				System.out.println(
					"testNonDefinedEnrollmentPeriod was UNSUCCESSFULY runned by service: "
						+ this.getClass().getName());
				fail("Unable to run service: " + this.getClass().getName());
			}
		}
		...
		public void testOutofEnrollmentPeriod() {
			...
			Object[] args =
				{ new Integer(27), new Integer(4), rooms, new Boolean(false)};
			...
			try {
				...
				if (ex.getErrorType()
					...
					System.out.println(
						"testOutofEnrollmentPeriod was SUCCESSFULY runned by class: "
							+ this.getClass().getName());
				} else {
					System.out.println(
						"testOutofEnrollmentPeriod was UNSUCCESSFULY runned by class: "
				...
				ex.printStackTrace();
				System.out.println(
					"testOutofEnrollmentPeriod was UNSUCCESSFULY runned by service: "
						+ this.getClass().getName());
				fail("Unable to run service: " + this.getClass().getName());
			}
		}
