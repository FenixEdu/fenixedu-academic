...
public class ExamRoomDistributionTest extends ServiceNeedsAuthenticationTestCase
{
    ...
    public void testSuccessfullEnrolledStudents()
    {
        ...
        try
        {
            ...
            IExam exam =
                (IExam)persistentExam.readByOId(new Exam((Integer)getAuthorizeArguments()[1]), false);
    ...
    public void testSuccessfullNotEnrolledStudents()
    {
        ...
        Object[] args =
            { new Integer(27), new Integer(5), rooms, new Boolean(false), new Boolean(false)};
        ...
        try
        {
            ...
            IPersistentExam persistentExam = sp.getIPersistentExam();
            sp.iniciarTransaccao();
            IExam exam = (IExam)persistentExam.readByOId(new Exam((Integer)args[1]), false);
            IPersistentExamStudentRoom persistentExamStudentRoom = sp.getIPersistentExamStudentRoom();
            List examStudentRoomList = persistentExamStudentRoom.readBy(exam);
            assertEquals(examStudentRoomList.size(), 4);
            Iterator iter = examStudentRoomList.iterator();
    ...
    public void testNonExistingRoom()
    {
        ...
        } catch (InvalidArgumentsServiceException ex)
        {
            ex.printStackTrace();
            System.out.println(
                "testNonExistingRoom was SUCCESSFULY runned by service: " + this.getClass().getName());

        } catch (Exception ex)
        {
            ex.printStackTrace();
            System.out.println(
                "testNonExistingRoom was UNSUCCESSFULY runned by service: " + this.getClass().getName());
    ...
    public void testNonExistingExecutionCourse()
    {
        ...
        Object[] args =
            { new Integer(100), new Integer(1), rooms, new Boolean(false), new Boolean(true)};
        try
        {
    ...
    public void testNonExistingExam()
    {
        ...
        Object[] args =
            { new Integer(27), new Integer(100), rooms, new Boolean(false), new Boolean(true)};
        ...
        {
            System.out.println(
                "testNonExistingExam was SUCCESSFULY runned by class: " + this.getClass().getName());
        } catch (Exception ex)
        {
            ex.printStackTrace();
            System.out.println(
                "testNonExistingExam was UNSUCCESSFULY runned by service: " + this.getClass().getName());
            fail("Unable to run service: " + this.getClass().getName());
        }
    }
    ...
    public void testNonDefinedEnrollmentPeriod()
    {
        ...
        Object[] args =
            { new Integer(27), new Integer(6), rooms, new Boolean(false), new Boolean(true)};
	...
	public void testDistribute2WeeksBeforeExam()
	 {
		 ...
		 } catch (FenixServiceException ex)
		 {
			 ...
			 {
				 System.out.println(
					 "testDistribute2WeeksBeforeExam was SUCCESSFULY runned by class: "
						 + this.getClass().getName());
			 } else
			 {
				 System.out.println(
		 ...
		 } catch (Exception ex)
		 {
			 ex.printStackTrace();
			 System.out.println(
				 "testDistribute2WeeksBeforeExam was UNSUCCESSFULY runned by service: "
					 + this.getClass().getName());
			 fail("Unable to run service: " + this.getClass().getName());
		 }
	 }
