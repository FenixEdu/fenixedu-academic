...
public class InsertItemTest extends SectionBelongsExecutionCourseTest {
    ...
    public void testInsertExistingItem() {
        ...
        try {
            ...
            System.out
                    .println("testInsertExistingItem was UNSUCCESSFULY runned by class: "
            ...
            System.out
                    .println("testInsertExistingItem was SUCCESSFULY runned by class: "
                            + this.getClass().getName());
        } catch (Exception ex) {
            ex.printStackTrace();
            System.out
    ...
    public void testInsertNonExistingItemBeforeFirst() {
        ...
        try {
            ...
            IPersistentItem persistentItem = persistentSuport
                    .getIPersistentItem();
            IItem iItem = persistentItem.readBySectionAndName(iSection,
                    "novoItem");
            InfoItem novoInfoItem = Cloner.copyIItem2InfoItem(iItem);

            assertEquals(novoInfoItem.getInfoSection(), infoItem
                    .getInfoSection());
            assertEquals(novoInfoItem.getItemOrder(), infoItem.getItemOrder());
            assertEquals(novoInfoItem.getInformation(), infoItem
                    .getInformation());
            ...
            System.out
                    .println("testInsertNonExistingItemBeforeFirst was SUCCESSFULY runned by class: "
                            + this.getClass().getName());
        } catch (Exception ex) {
            ex.printStackTrace();
            System.out
    ...
    public void testInsertNonExistingItemInMiddle() {
        ...
        try {
            ...
            System.out
                    .println("testInsertNonExistingItemInMiddle was SUCCESSFULY runned by class: "
                            + this.getClass().getName());
        } catch (Exception ex) {
            ex.printStackTrace();
            System.out
                    .println("testInsertNonExistingItemInMiddle was UNSUCCESSFULY runned by class: "
                            + this.getClass().getName());
    ...
    public void testInsertNonExistingItemBeforeEnd() {
        ...
        try {
            ...
            System.out
                    .println("testInsertNonExistingItemBeforeEnd was SUCCESSFULY runned by class: "
                            + this.getClass().getName());
        } catch (Exception ex) {
            ex.printStackTrace();
            System.out
                    .println("testInsertNonExistingItemBeforeEnd was UNSUCCESSFULY runned by class: "
                            + this.getClass().getName());
