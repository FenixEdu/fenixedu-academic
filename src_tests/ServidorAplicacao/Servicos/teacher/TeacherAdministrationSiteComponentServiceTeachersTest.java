...
public class TeacherAdministrationSiteComponentServiceTeachersTest extends TestCaseReadServices {
	...
	protected Object[] getArgumentsOfServiceToBeTestedSuccessfuly() {
		...
		Object[] args = { new Integer(26), new InfoSiteCommon(), new InfoSiteTeachers(), null, null, new String("user")};
		return args;
	}
	...
	protected Object getObjectToCompare() {
		...
		try {
			...
			responsibleFor = persistentResponsibleFor.readByTeacherAndExecutionCourse(teacher, executionCourse);
		...
		TeacherAdministrationSiteView siteView = new TeacherAdministrationSiteView(infoSiteCommon, infoSiteTeachers);
