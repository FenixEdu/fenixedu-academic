...
public class EditSectionTest extends SectionBelongsExecutionCourseTest {
    ...
    protected Object[] getAuthorizeArguments() {
        ...
        Object[] args = { new Integer(27), new Integer(6), "novoNome", new Integer(0) };
        return args;
    }
    ...
    protected Object[] getTestSectionUnsuccessfullArguments() {
        Object[] args = { new Integer(27), new Integer(7), "novoNome", new Integer(0) };
        return args;
    }
    ...
    public void testEditExistingSection() {
        ...
        try {
            ...
            System.out.println("testEditExistingSection was SUCCESSFULY runned by class: "
                    + this.getClass().getName());
        } catch (Exception ex) {
            ex.printStackTrace();
            System.out.println("testEditExistingSection was UNSUCCESSFULY runned by class: "
                    + this.getClass().getName());
    ...
    public void testEditNonExistingSection() {
        Object[] args = { new Integer(27), new Integer(100), "novoNome", new Integer(0) };

        try {
            ServiceManagerServiceFactory.executeService(userView, getNameOfServiceToBeTested(), args);
            System.out.println("testEditNonExistingSection was UNSUCCESSFULY runned by class: "
                    + this.getClass().getName());
            fail("testEditNonExistingSection");

        } catch (NotAuthorizedException e) {
            System.out.println("testEditNonExistingSection was SUCCESSFULY runned by class: "
                    + this.getClass().getName());
        } catch (Exception ex) {
            ex.printStackTrace();
            System.out.println("testEditNonExistingSection was UNSUCCESSFULY runned by class: "
