...
public class DeleteItemTest extends ItemBelongsExecutionCourseTest {
    ...
    public void testDeleteExistingItem() {
        ...
        try {
            ...
            System.out.println("testDeleteExistingItem was SUCCESSFULY runned by class: "
                    + this.getClass().getName());

        } catch (Exception ex) {
            ex.printStackTrace();
            System.out.println("testDeleteExistingItem was UNSUCCESSFULY runned by class: "
                    + this.getClass().getName());
    ...
    public void testDeleteNonExistingItem() {
        ...
        try {
            ServiceManagerServiceFactory.executeService(userView, getNameOfServiceToBeTested(), args);
            System.out.println("testDeleteNonExistingItem was UNSUCCESSFULY runned by class: "
                    + this.getClass().getName());
            fail("testDeleteNonExistingItem");

        } catch (NotAuthorizedException e) {
            System.out.println("testDeleteNonExistingItem was SUCCESSFULY runned by class: "
                    + this.getClass().getName());
        } catch (Exception ex) {
            ex.printStackTrace();
            System.out.println("testDeleteNonExistingItem was UNSUCCESSFULY runned by class: "
