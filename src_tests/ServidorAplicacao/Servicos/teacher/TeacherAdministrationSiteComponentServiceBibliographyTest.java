...
public class TeacherAdministrationSiteComponentServiceBibliographyTest extends TestCaseReadServices {
	...
	protected Object[] getArgumentsOfServiceToBeTestedSuccessfuly() {
		...
		Object[] args = { new Integer(24), new InfoSiteCommon(), new InfoBibliographicReference(), null, new Integer(1), null };
		return args;
	}
	...
	protected Object getObjectToCompare() {
		...
		try {
			...
			iBibliographicReference =
				(IBibliographicReference) sp.getIPersistentBibliographicReference().readByOId(
					new BibliographicReference(new Integer(1)), false);
		...
		TeacherAdministrationSiteView siteView = new TeacherAdministrationSiteView(infoSiteCommon, infoBibliographicReference);
