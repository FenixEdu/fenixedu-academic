 ...
 *  
 */
public abstract class ItemBelongsExecutionCourseTest extends ServiceNeedsAuthenticationTestCase {
    ...
    public void testItemBelongsExecutionCourse() {
        ...
        try {
            ServiceManagerServiceFactory.executeService(userView, getNameOfServiceToBeTested(),
                    serviceArguments);
            System.out.println("testItemBelongsExecutionCourse was SUCCESSFULY runned by service: "
                    + getNameOfServiceToBeTested());

        } catch (NotAuthorizedException ex) {
            fail(getNameOfServiceToBeTested() + "fail testItemBelongsExecutionCourse" + ex);

        } catch (Exception ex) {
            fail(getNameOfServiceToBeTested() + " testItemBelongsExecutionCourse " + ex);
        }
    ...
    public void testItemNotBelongsExecutionCourse() {
        ...
        try {
            ServiceManagerServiceFactory.executeService(userView, getNameOfServiceToBeTested(),
                    serviceArguments);
            fail(getNameOfServiceToBeTested() + "testItemNotBelongsExecutionCourse");
            ...
            fail(getNameOfServiceToBeTested() + " testItemNotBelongsExecutionCourse " + ex);
        }
    }
