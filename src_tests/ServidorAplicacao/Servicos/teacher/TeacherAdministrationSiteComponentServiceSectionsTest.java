...
public class TeacherAdministrationSiteComponentServiceSectionsTest extends TestCaseReadServices {
	...
	protected Object[] getArgumentsOfServiceToBeTestedSuccessfuly() {
		...
		Object[] args = { new Integer(27), new InfoSiteCommon(), new InfoSiteSections(), null, new Integer(4), null };
		return args;
	}
	...
	protected Object getObjectToCompare() {
		...
		TeacherAdministrationSiteView siteView = new TeacherAdministrationSiteView(infoSiteCommon, infoSiteSections);
