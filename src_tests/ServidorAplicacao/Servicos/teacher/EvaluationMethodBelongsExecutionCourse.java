 ...
 *  
 */
public abstract class EvaluationMethodBelongsExecutionCourse extends ServiceNeedsAuthenticationTestCase {
    ...
    public void testEvaluationMethodBelongsExecutionCourse() {
        ...
        try {
            ServiceManagerServiceFactory.executeService(userView, getNameOfServiceToBeTested(),
                    serviceArguments);
            System.out
                    .println("testEvaluationMethodBelongsExecutionCourse was SUCCESSFULY runned by service: "
