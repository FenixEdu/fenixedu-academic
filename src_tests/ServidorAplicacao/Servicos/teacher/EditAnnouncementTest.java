...
public class EditAnnouncementTest extends AnnouncementBelongsToExecutionCourseTest {
    ...
    protected Object[] getAuthorizeArguments() {
        ...
        Object[] args = { infoExecutionCourseCode, announcementCode, announcementNewTitle,
    ...
    public void testEditAnnouncementSuccefull() {
        try {
            ...
            Object[] argserv = { infoExecutionCourseCode, announcementCode, announcementNewTitle,
                    announcementNewInformation };
    ...
    public void testEditAnnouncementUnsuccefull() {
        try {
            ...
            //The announcement doesn't exist.. so the filter return an
            // exception
