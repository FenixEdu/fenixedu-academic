...
public class SearchGrantOwnerTest
	...
	protected String getDataSetFilePath() {
		return "etc/datasets/servicos/grant/owner/testSearchGrantOwnerDataSet.xml";
	}
	...
	protected Object[] getArgumentsToSearchByIDAndGetOneResult() {
		...
		Object[] args = { null, idNumber, idType };
		return args;
	}
	...
	public void testSearchByNameSuccessfullPersonNotGrantOwner() {
		try {
			...
			UtilsTestCase.readTestList(
					result,
					values,
					"personInfo.idInternal",
					InfoGrantOwner.class);
			//Verify unchanged database
			compareDataSetUsingExceptedDataSetTableColumns(
					getDataSetFilePath());
			System.out.println(
					"testSearchByNameSuccessfullPersonNotGrantOwner was SUCCESSFULY runned by: "
	...
	/*
	 * Search by IDnumber and IDtype successfull with one result: a person not grantOwner.
	 */
	public void testSearchByIDNumberAndIDTypeSuccessfullPersonNotGrantOwner() {
		try {
			...
			System.out.println(
					"testSearchByIDNumberAndIDTypeSuccessfullPersonNotGrantOwner was SUCCESSFULY runned by: "
						+ getNameOfServiceToBeTested());
		} catch (FenixServiceException e) {
	...
	/*
	 * Search by Name, IDnumber and IDtype successfull with one result: a person not grantOwner.
	 */
	public void testSearchByNameAndIDNumberAndIDTypeSuccessfullPersonNotGrantOwner() {
		try {
			...
			compareDataSetUsingExceptedDataSetTableColumns(getDataSetFilePath());
			System.out.println(
					"testSearchByNameAndIDNumberAndIDTypeSuccessfullPersonNotGrantOwner was SUCCESSFULY runned by: "
						+ getNameOfServiceToBeTested());
		} catch (FenixServiceException e) {
			fail(
				"Searching by name and ID a person that is NOT a grantOwner "
					+ e);
		} catch (Exception e) {
			fail(
				"Searching by name and ID a person that is NOT a grantOwner "
	...
	/*
	 * Search by Name successfull with one result: a person that is also a grantOwner.
	 */
	public void testSearchByNameSuccessfullPersonIsGrantOwner() {
		try {
			...
			compareDataSetUsingExceptedDataSetTableColumns(
					getDataSetFilePath());
			System.out.println(
					"testSearchByNameSuccessfullPersonIsGrantOwner was SUCCESSFULY runned by: "
						+ getNameOfServiceToBeTested());
		} catch (FenixServiceException e) {
	...
	/*
	 * Search by IDnumber and IDtype successfull with one result: a person that is also a grantOwner.
	 */
	public void testSearchByIDNumberAndIDTypeSuccessfullPersonIsGrantOwner() {
		try {
			...
			compareDataSetUsingExceptedDataSetTableColumns(
					getDataSetFilePath());
			System.out.println(
					"testSearchByIDNumberAndIDTypeSuccessfullPersonIsGrantOwner was SUCCESSFULY runned by: "
						+ getNameOfServiceToBeTested());
		} catch (FenixServiceException e) {
	...
	/*
	 * Search by Name, IDnumber and IDtype successfull with one result: a person that is also a grantOwner.
	 */
	public void testSearchByNameAndIDNumberAndIDTypeSuccessfullPersonIsGrantOwner() {
		try {
			...
			compareDataSetUsingExceptedDataSetTableColumns(
					getDataSetFilePath());
			System.out.println(
					"testSearchByNameAndIDNumberAndIDTypeSuccessfullPersonIsGrantOwner was SUCCESSFULY runned by: "
						+ getNameOfServiceToBeTested());

		} catch (FenixServiceException e) {
			fail(
				"Searching by name and ID a person that IS ALSO a grantOwner "
					+ e);
		} catch (Exception e) {
			fail(
				"Searching by name and ID a person that ID ALSO a grantOwner "
					+ e);
		}
	}
	...
	public void testSearchByNameSuccessfullSeveralPerson() {
		try {
			...
			//Check the search result
			Object[] values =
				{ new Integer(1), new Integer(3), new Integer(13)};
			UtilsTestCase.readTestList(
					result,
					values,
					"personInfo.idInternal",
			...
			compareDataSetUsingExceptedDataSetTableColumns(
					getDataSetFilePath());
			System.out.println(
					"testSearchByNameSuccessfullSeveralPerson was SUCCESSFULY runned by: "
						+ getNameOfServiceToBeTested());
		} catch (FenixServiceException e) {
	...
	public void testSearchByNameAndIDNumberAndIDTypeSuccessfullSeveralPerson() {
		try {
			...
			compareDataSetUsingExceptedDataSetTableColumns(
					getDataSetFilePath());
				System.out.println(
					"testSearchByNameAndIDNumberAndIDTypeSuccessfullSeveralPerson was SUCCESSFULY runned by: "
						+ getNameOfServiceToBeTested());
		} catch (FenixServiceException e) {
	...
	public void testSearchByNameUnsuccessfull() {
		try {
			...
			compareDataSetUsingExceptedDataSetTableColumns(
				getDataSetFilePath());
			System.out.println(
				"testSearchByNameUnsuccessfull was SUCCESSFULY runned by: "
					+ getNameOfServiceToBeTested());
		} catch (FenixServiceException e) {
	...
	public void testSearchByIDNumberAndIDTypeUnsuccessfull() {
		try {
			...
			compareDataSetUsingExceptedDataSetTableColumns(
				getDataSetFilePath());
			System.out.println(
				"testSearchByIDNumberAndIDTypeUnsuccessfull was SUCCESSFULY runned by: "
					+ getNameOfServiceToBeTested());
		} catch (FenixServiceException e) {
	...
	public void testSearchByNameAndIDNumberAndIDTypeUnsuccessfull() {
		try {
			...
			compareDataSetUsingExceptedDataSetTableColumns(
				getDataSetFilePath());
			System.out.println(
				"testSearchByNameAndIDNumberAndIDTypeUnsuccessfull was SUCCESSFULY runned by: "
					+ getNameOfServiceToBeTested());
		} catch (FenixServiceException e) {
