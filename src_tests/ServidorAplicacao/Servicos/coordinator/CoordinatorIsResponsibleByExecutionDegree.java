 ...
 *  
 */
public abstract class CoordinatorIsResponsibleByExecutionDegree extends
    ...
    public void testCoordinatorIsNotResponsibleCoordinatorOfExecutionDegree() {
        ...
        try {
            ServiceManagerServiceFactory.executeService(userView4, getNameOfServiceToBeTested(),
                    serviceArguments);
            System.out
                    .println("testCoordinatorIsNotResponsibleCoordinatorOfExecutionDegree was UNSUCCESSFULY runned by service: "
                            + getNameOfServiceToBeTested());
            fail(getNameOfServiceToBeTested()
                    + "fail testCoordinatorIsNotResponsibleCoordinatorOfExecutionDegree");
        } catch (NotAuthorizedException ex) {
            System.out
                    .println("testCoordinatorIsNotResponsibleCoordinatorOfExecutionDegree was SUCCESSFULY runned by service: "
                            + getNameOfServiceToBeTested());
        } catch (Exception ex) {
            System.out
                    .println("testCoordinatorIsNotResponsibleCoordinatorOfExecutionDegree was UNSUCCESSFULY runned by service: "
