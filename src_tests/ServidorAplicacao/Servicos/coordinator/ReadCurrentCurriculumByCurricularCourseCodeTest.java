...
public class ReadCurrentCurriculumByCurricularCourseCodeTest extends ServiceTestCase {
    ...
    public void testReadCurrentCurriculumByCurricularCourseCodeSuccessfull() {
        try {
            ...
            assertEquals(new String("objectivos gerais em portugues"), infoCurriculum
                    .getGeneralObjectives());
            assertEquals(new String("objectivos gerais em ingles"), infoCurriculum
                    .getGeneralObjectivesEn());
            assertEquals(new String("objectivos operacionais em portugues"), infoCurriculum
                    .getOperacionalObjectives());
            assertEquals(new String("objectivos operacionais em ingles"), infoCurriculum
            ...
            assertEquals(new Integer(infoCurriculum.getInfoCurricularCourse()
                    .getInfoAssociatedExecutionCourses().size()), new Integer(0));

            System.out
                    .println("testReadCurrentCurriculumByCurricularCourseCodeSuccessfull was SUCCESSFULY runned by service: "
    ...
    public void testReadCurrentCurriculumByCurricularCourseCodeUserUnsuccessfull() {
        try {
            ...
            System.out
                    .println("testReadCurrentCurriculumByCurricularCourseCodeUserUnsuccessfull was SUCCESSFULY runned by service: "
                            + getNameOfServiceToBeTested());
        } catch (FenixServiceException e) {
    ...
    public void testReadCurrentCurriculumByCurricularCourseCodeNoCurricularCourseUnsuccessfull() {
        try {
            ...
            System.out
                    .println("testReadCurrentCurriculumByCurricularCourseCodeNoCurricularCourseUnsuccessfull was SUCCESSFULY runned by service: "
                            + getNameOfServiceToBeTested());
        } catch (FenixServiceException e) {
    ...
    public void testReadCurrentCurriculumByCurricularCourseCodeNullCurriculumUnsuccessfull() {
        try {
            ...
            if (infoCurriculum == null) {
                ...
                //				assertEquals(infoCurriculum.getInfoCurricularCourse().getIdInternal(),
                // infoCurricularCourseCode);

                System.out
                        .println("testReadCurrentCurriculumByCurricularCourseCodeNullCurriculumUnsuccessfull was SUCCESSFULY runned by service: "
                                + getNameOfServiceToBeTested());
            }
        } catch (FenixServiceException e) {
    ...
    public void testReadCurrentCurriculumByCurricularCourseCodeNullCodeUnsuccessfull() {
        try {
            ...
            if (e.getMessage().equals("nullCurricularCourse")) {
                System.out
                        .println("testReadCurrentCurriculumByCurricularCourseCodeNullCodeUnsuccessfull was SUCCESSFULY runned by service: "
                                + getNameOfServiceToBeTested());
            } else {
