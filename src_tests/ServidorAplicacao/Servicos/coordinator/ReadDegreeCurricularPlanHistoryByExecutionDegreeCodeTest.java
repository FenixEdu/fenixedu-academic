...
public class ReadDegreeCurricularPlanHistoryByExecutionDegreeCodeTest extends ServiceTestCase {
    ...
    public void testReadDegreeCurricularPlanHistoryByExecutionDegreeCodeSuccessfull() {
        try {
            ...
            System.out
                    .println("testReadDegreeCurricularPlanHistoryByExecutionDegreeCodeSuccessfull was SUCCESSFULY runned by service: "
    ...
    public void testReadDegreeCurricularPlanHistoryByExecutionDegreeCodeUserUnsuccessfull() {
        try {
            ...
            System.out
                    .println("testReadDegreeCurricularPlanHistoryByExecutionDegreeCodeUserUnsuccessfull was SUCCESSFULY runned by service: "
                            + getNameOfServiceToBeTested());
        } catch (FenixServiceException e) {
    ...
    public void testReadDegreeCurricularPlanHistoryByExecutionDegreeCodeNoDegreeUnsuccessfull3() {
        try {
            ...
            System.out
                    .println("testReadDegreeCurricularPlanHistoryByExecutionDegreeCodeNoDegreeUnsuccessfull was SUCCESSFULY runned by service: "
                            + getNameOfServiceToBeTested());
        } catch (FenixServiceException e) {
    ...
    public void testReadDegreeCurricularPlanHistoryByExecutionDegreeCodeNullDCPUnsuccessfull() {
        try {
            ...
            System.out
                    .println("testReadDegreeCurricularPlanHistoryByExecutionDegreeCodeNullDCPUnsuccessfull was SUCCESSFULY runned by service: "
                            + getNameOfServiceToBeTested());
        } catch (FenixServiceException e) {
    ...
    public void testReadDegreeCurricularPlanHistoryByExecutionDegreeCodeNullDegreeUnsuccessfull() {
        try {
            ...
            if (e.getMessage().equals("nullDegree")) {
                System.out
                        .println("testReadDegreeCurricularPlanHistoryByExecutionDegreeCodeNullDegreeUnsuccessfull was SUCCESSFULY runned by service: "
                                + getNameOfServiceToBeTested());
            } else {
