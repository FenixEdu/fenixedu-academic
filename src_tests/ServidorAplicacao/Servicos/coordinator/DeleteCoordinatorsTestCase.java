    ...
    public void testDeleteCoordinator() {
        ...
        try {
            ServiceManagerServiceFactory.executeService(userView, getNameOfServiceToBeTested(),
                    serviceArguments);
            System.out.println("testDeleteCoordinator was SUCCESSFULY runned by service: "
                    + getNameOfServiceToBeTested());

        } catch (NotAuthorizedException ex) {
            ex.printStackTrace();
            System.out.println("testDeleteCoordinator was UNSUCCESSFULY runned by service: "
                    + getNameOfServiceToBeTested());
