 ...
 *
 */
public abstract class CoordinatorBelongsToCurrentExecutionDegree
	...
	public void testCoordinatorIsNotCoordinatorOfCurrentExecutionDegree() {
		...
		try {
			...
			System.out.println(
				"testCoordinatorIsNotCoordinatorOfCurrentExecutionDegree was SUCCESSFULY runned by service: "
					+ getNameOfServiceToBeTested());
		} catch (Exception ex) {
			System.out.println(
				"testCoordinatorIsNotCoordinatorOfCurrentExecutionDegree was UNSUCCESSFULY runned by service: "
