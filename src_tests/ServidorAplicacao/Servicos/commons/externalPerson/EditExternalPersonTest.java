...
public class EditExternalPersonTest extends ServiceTestCase {
    ...
    public EditExternalPersonTest(String testName) {
        super(testName);
        this.dataSetFilePath = "etc/datasets/servicos/commons/externalPerson/testEditExternalPersonDataSet.xml";
    }
    ...
    public void testSucessfullEdit() {
        try {
            ...
            Object[] args = { new Integer(24), "Some one external", "Some address 2", new Integer(22),
                    "1234567890", "981234567", "http://fenix-ashes.ist.utl.pt:8080",
    ...
    public void testChangeToExisting() {
        try {
            Object[] args = { new Integer(24), "Xxxxxxxxxxxxxxxx Xxxxxxxxx Xxxxxxx Xxxxxxxxx",
                    "XXXXXXXXXX", new Integer(22), null, null, null, null };
            ServiceManagerServiceFactory.executeService(null, getNameOfServiceToBeTested(), args);
