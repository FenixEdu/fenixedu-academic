    ...
    public void testUnsuccessfulExecutionOfDeleteService() {
        ...
        if (args != null) {
            ...
            try {
                ...
                assertEquals("testUnsuccessfulExecutionOfDeleteService", Boolean.FALSE.booleanValue(),
                        ((Boolean) result).booleanValue());
                System.out
                        .println("testUnsuccessfulExecutionOfDeleteService was SUCCESSFULY runned by class: "
                ...
                ex.printStackTrace();
                System.out
                        .println("testUnsuccessfulExecutionOfDeleteService was UNSUCCESSFULY runned by class: "
                                + this.getClass().getName());
    ...
    public void testSuccessfulExecutionOfDeleteService() {
        ...
        if (args != null) {
            ...
            try {
                result = ServiceManagerServiceFactory.executeService(_userView,
                        getNameOfServiceToBeTested(), args);
                assertEquals("testSuccessfulExecutionOfDeleteService", Boolean.TRUE.booleanValue(),
                        ((Boolean) result).booleanValue());
                System.out
                        .println("testSuccessfulExecutionOfDeleteService was SUCCESSFULY runned by class: "
                                + this.getClass().getName());
            } catch (Exception ex) {
                ex.printStackTrace();
                System.out
                        .println("testSuccessfulExecutionOfDeleteService was UNSUCCESSFULY runned by class: "
                                + this.getClass().getName());
