...
public class ChangePasswordTest extends TestCaseNeedAuthorizationServices {
	...
	public void testSuccessfullChangePassword() {
		...
		assertEquals("Passwords aren't equals!",PasswordEncryptor.encryptPassword("pass2"),person.getPassword());
	}
	...
	public void testUnsucessfullChangePassword(){
		...
		IPessoa person = readPerson("user");
		assertEquals("Password must not change!", PasswordEncryptor.encryptPassword("pass"), person.getPassword());
	}
