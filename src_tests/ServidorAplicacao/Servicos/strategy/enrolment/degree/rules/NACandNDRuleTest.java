...
public class NACandNDRuleTest extends BaseEnrolmentRuleTest {
	...
	public void testApplyNACandNDRule() {
		...
		doApplyRule(new EnrolmentRuleNACandND(), enrolmentContext);
		...
		curricularCourse = getCurricularCourse("Analise Matematica III", "AMIII");
