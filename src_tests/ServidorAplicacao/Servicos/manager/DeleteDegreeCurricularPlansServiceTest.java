...
public class DeleteDegreeCurricularPlansServiceTest extends TestCaseManagerDeleteServices {

	public DeleteDegreeCurricularPlansServiceTest(String testName) {
		super(testName);
	}
