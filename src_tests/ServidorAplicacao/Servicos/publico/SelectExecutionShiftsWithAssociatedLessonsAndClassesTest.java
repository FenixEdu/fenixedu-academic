...
public class SelectExecutionShiftsWithAssociatedLessonsAndClassesTest extends TestCaseServicos
{
    ...
    public void testReadAll()
    {
        ...
        Object argsSelectExecutionShiftsWithAssociatedLessonsAndClasses[] = new Object[1];

        Object result = null;

        //execution course with 10 shifts with 1st shift with 1 associated
		// lessons and 1 associated classes
        this.prepareTestCase(1);

        argsSelectExecutionShiftsWithAssociatedLessonsAndClasses[0] = this.infoExecutionCourse;
        ...
        //10 shifts in database with no associated lessons and no associated
		// classes
    ...
    private void prepareTestCase(int testCase)
    {
        ...
        try
        {
            ...
            ITurnoAulaPersistente turnoAulaPersistente = sp.getITurnoAulaPersistente();

            ITurmaTurnoPersistente turmaTurnoPersistente = sp.getITurmaTurnoPersistente();
