...
public class ReadExecutionDegreesByDegreeAndExecutionPeriodTest extends ServiceTestCase {
	...
	public void testSuccessfull() {
		try {
			...
			assertEquals(new Integer(10), infoExecutionDegree.getInfoDegreeCurricularPlan().getIdInternal());

			System.out.println("ReadExecutionDegreesByDegreeAndExecutionPeriodTest was SUCCESSFULY in test: testSuccessfull");
	...
	public void testSuccessfullWithMoreThanOneExecutionDegree() {
		try {
			...
			assertEquals(new String("Alameda"), infoExecutionDegree.getInfoCampus().getName());
			assertEquals(new Integer(100100100), infoExecutionDegree.getInfoCoordinator().getTeacherNumber());
			assertEquals(new Integer(1000), infoExecutionDegree.getInfoDegreeCurricularPlan().getIdInternal());
			...
			assertEquals(new Integer(101101101), infoExecutionDegree.getInfoCoordinator().getTeacherNumber());
			assertEquals(new Integer(1000), infoExecutionDegree.getInfoDegreeCurricularPlan().getIdInternal());
	...
	public void testNULLArg1() {
		try {
			...
			System.out.println("ReadExecutionDegreesByDegreeAndExecutionPeriodTest was SUCCESSFULY in test: testNULLArg1");
	...
	public void testNULLArg2() {
		try {
			...
			System.out.println("ReadExecutionDegreesByDegreeAndExecutionPeriodTest was SUCCESSFULY in test: testNULLArg2");
	...
	public void testNoExecutionPeriod() {
		try {
			...
			System.out.println("ReadExecutionDegreesByDegreeAndExecutionPeriodTest was SUCCESSFULY in test: testNoExecutionPeriod");
	...
	public void testNoExecutionYear() {
		try {
			...
			System.out.println("ReadExecutionDegreesByDegreeAndExecutionPeriodTest was SUCCESSFULY in test: testNoExecutionYear");
	...
	public void testNoDegree() {
		try {
			...
			System.out.println("ReadExecutionDegreesByDegreeAndExecutionPeriodTest was SUCCESSFULY in test: testNoDegree");
