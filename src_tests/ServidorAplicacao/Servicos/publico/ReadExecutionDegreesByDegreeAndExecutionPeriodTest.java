...
public class ReadExecutionDegreesByDegreeAndExecutionPeriodTest extends ServiceTestCase {
    ...
    public void testSuccessfull() {
        try {
            ...
            System.out
                    .println("ReadExecutionDegreesByDegreeAndExecutionPeriodTest was SUCCESSFULY in test: testSuccessfull");
    ...
    public void testSuccessfullWithMoreThanOneExecutionDegree() {
        try {
            ...
            //infoExecutionDegree.getInfoCoordinator().getTeacherNumber());
            if (infoExecutionDegree.getInfoDegreeCurricularPlan() != null) {
                assertEquals(new Integer(1000), infoExecutionDegree.getInfoDegreeCurricularPlan()
                        .getIdInternal());
            }
            ...
            System.out
                    .println("ReadExecutionDegreesByDegreeAndExecutionPeriodTest was SUCCESSFULY in test: testSuccessfullWithMoreThanOneExecutionDegree");
    ...
    public void testSuccessfullWithDegreeInfoLastYear() {
        try {
            ...
            System.out
                    .println("ReadExecutionDegreesByDegreeAndExecutionPeriodTest was SUCCESSFULY in test: testSuccessfullWithDegreeInfoLastYear");
    ...
    public void testNULLArg1() {
        try {
            ...
            System.out
                    .println("ReadExecutionDegreesByDegreeAndExecutionPeriodTest was SUCCESSFULY in test: testNULLArg1");
    ...
    public void testNULLArg2() {
        try {
            ...
            System.out
                    .println("ReadExecutionDegreesByDegreeAndExecutionPeriodTest was SUCCESSFULY in test: testNULLArg2");
    ...
    public void testNoExecutionPeriod() {
        try {
            ...
            System.out
                    .println("ReadExecutionDegreesByDegreeAndExecutionPeriodTest was SUCCESSFULY in test: testNoExecutionPeriod");
    ...
    public void testNoExecutionYear() {
        try {
            ...
            System.out
                    .println("ReadExecutionDegreesByDegreeAndExecutionPeriodTest was SUCCESSFULY in test: testNoExecutionYear");
    ...
    public void testNoDegree() {
        try {
            ...
            System.out
                    .println("ReadExecutionDegreesByDegreeAndExecutionPeriodTest was SUCCESSFULY in test: testNoDegree");
