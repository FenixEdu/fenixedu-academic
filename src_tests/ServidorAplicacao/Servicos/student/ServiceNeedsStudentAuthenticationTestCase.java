 ...
 *  
 */
public abstract class ServiceNeedsStudentAuthenticationTestCase extends ServiceTestCase {
    ...
    public void testAuthorizedUser() {
        ...
        try {
            ...
            System.out.println("testAuthorizedUser was UNSUCCESSFULY runned by service: "
                    + getNameOfServiceToBeTested());
    ...
    public void testNonStudentUser() {
        ...
        try {
            ...
            System.out.println("testNonStudentUser was UNSUCCESSFULY runned by service: "
                    + getNameOfServiceToBeTested());
            fail(getNameOfServiceToBeTested() + "fail testNonStudentUser");

        } catch (NotAuthorizedException ex) {
            System.out.println("testNonStudentUser was SUCCESSFULY runned by service: "
                    + getNameOfServiceToBeTested());
