...
public class EnrollStudentInExamTest extends ServiceNeedsAuthenticationTestCase {
    ...
    public void testEnrollNonExistingStudentInExam() {
        ...
        try {
            ...
            System.out.println("testEnrollNonExistingStudentInExam was UNSUCCESSFULY runned by class: "
            ...
            ex.printStackTrace();
            System.out.println("testEnrollNonExistingStudentInExam was SUCCESSFULY runned by class: "
                    + this.getClass().getName());
    ...
    public void testEnrollStudentInNonExistingExam() {
        ...
        try {
            ServiceManagerServiceFactory.executeService(userView, getNameOfServiceToBeTested(), args);
            System.out.println("testEnrollStudentInNonExistingExam was UNSUCCESSFULY runned by class: "
                    + this.getClass().getName());
            ...
            ex.printStackTrace();
            System.out.println("testEnrollStudentInNonExistingExam was SUCCESSFULY runned by class: "
                    + this.getClass().getName());
    ...
    public void testReEnrollStudentInExam() {
        ...
        try {
            ServiceManagerServiceFactory.executeService(userView, getNameOfServiceToBeTested(), args);
            System.out.println("testReEnrollStudentInExam was UNSUCCESSFULY runned by class: "
                    + this.getClass().getName());
            ...
            ex.printStackTrace();
            System.out.println("testReEnrollStudentInExam was SUCCESSFULY runned by class: "
                    + this.getClass().getName());
    ...
    public void testEnrollStudentInExam() {
        ...
        try {
            ...
            System.out.println("testEnrollStudentInExam was SUCCESSFULY runned by class: "
                    + this.getClass().getName());

        } catch (Exception ex) {
            ex.printStackTrace();
            System.out.println("testEnrollStudentInExam was UNSUCCESSFULY runned by class: "
                    + this.getClass().getName());
