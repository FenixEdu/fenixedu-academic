...
public class ReadShiftEnrolmentTest extends TestCaseServicos {
    ...
    protected void setUp() {
        ...
        //    IStudent student = new Student(new Integer(45498), new Integer(567),
        // person, new TipoCurso(TipoCurso.LICENCIATURA));
        //
        ...
        //	infoStudent = new InfoStudent(student.getNumber(),
        // student.getState(), infoPerson, new
        // TipoCurso(TipoCurso.LICENCIATURA));
    }
    ...
    public void testUnauthorizedReadShiftEnrolment() {
        ...
        Object result = null;
        try {
            result = ServiceManagerServiceFactory.executeService(_userView2, "ReadShiftEnrolment",
    ...
    public void testAuthorizedReadShiftEnrolment() {
        ...
        try {
            ...
            // iSE.getInfoEnrolmentWithOutShift().size());
            assertEquals("testAuthorizedReadShiftEnrolment", 2, iSE.getInfoEnrolmentWithShift().size());
            InfoCourseExecutionAndListOfTypeLessonAndInfoShift pair1 = (InfoCourseExecutionAndListOfTypeLessonAndInfoShift) iSE
                    .getInfoEnrolmentWithShift().get(0);
            InfoCourseExecutionAndListOfTypeLessonAndInfoShift pair2 = (InfoCourseExecutionAndListOfTypeLessonAndInfoShift) iSE
                    .getInfoEnrolmentWithShift().get(1);
            assertEquals("testAuthorizedReadShiftEnrolment", "Engenharia da Programacao", pair1
                    .getInfoExecutionCourse().getNome());
            assertEquals("testAuthorizedReadShiftEnrolment", "Aprendizagem", pair2
                    .getInfoExecutionCourse().getNome());
            assertEquals("testAuthorizedReadShiftEnrolment", 3, pair1.getTypeLessonsAndInfoShifts()
                    .size());
            assertEquals("testAuthorizedReadShiftEnrolment", 2, pair2.getTypeLessonsAndInfoShifts()
                    .size());
        } catch (Exception ex) {
    ...
    public void testAuthorizedReadShiftEnrolmentNoFrequemcies() {
        ...
        //  argsReadShiftEnrolment[0] = new InfoStudent(_aluno1.getNumber(),
        // _aluno1.getState(), infoPerson, new
        // TipoCurso(TipoCurso.LICENCIATURA));
        //
        //  Object result = null;
        //	try {
        ...
        // iSE.getInfoEnrolmentWithOutShift().isEmpty());
        //	  assertTrue("testAuthorizedReadShiftEnrolment",
        // iSE.getInfoEnrolmentWithShift().isEmpty());
        //	} catch (Exception ex) {
        //	  fail("testAuthorizedReadShiftEnrolment");
        //	}
    }
