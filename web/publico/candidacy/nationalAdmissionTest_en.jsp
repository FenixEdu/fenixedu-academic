...
<div class="breadcumbs">
	...
	<%= ChecksumRewriter.NO_CHECKSUM_PREFIX_HAS_CONTEXT_PREFIX %><a href="<%= request.getContextPath() + "/candidaturas/licenciaturas" %>">Bachelor Programmes</a> &gt;
...
<h2 class="brown">On this page</h2>
	<ul>
    	<li><%= ChecksumRewriter.NO_CHECKSUM_PREFIX_HAS_CONTEXT_PREFIX %><a href="#con">General Admission Procedure</a></li>
   </ul>
</div>
<h1>Prospective Students: BSc degree in IST</h1>
<p>Students applying to a 1st cycle (BSc degree) in IST should enroll into one of the following programs:</p>
<ul>
...
<p>Eight Engineering programs and the Architecture program in IST are organized as Integrated Master Programs aiming at a MSc degree. The remainder Engineering programs and Applied Mathematics follow a two-cycles model (BSc+MSc).</p>
...
<p>The requirements to apply for the IST Courses are the following (on a scale of 0 to 200 points):</p>
<ul>
