...
<div class="breadcumbs">
	...
	<a href="<%= request.getContextPath() + "/publico/candidacies/caseHandlingDegreeChangeIndividualCandidacyProcess.do?method=beginCandidacyProcessIntro" %>">Mudança de curso </a> &gt;
...
<fr:form action="/candidacies/caseHandlingDegreeChangeIndividualCandidacyProcess.do" id="editCandidacyForm">
