...
<fr:form action='/candidacies/caseHandlingDegreeChangeIndividualCandidacyProcess.do?method=submitCandidacy' encoding="multipart/form-data" >
		...
		<fr:edit id="candidacyProcess.personalDataBean"
			...
			<fr:destination name="invalid" path='/candidacies/caseHandlingDegreeChangeIndividualCandidacyProcess.do?method=executeCreateCandidacyPersonalInformationInvalid' />
			<fr:destination name="cancel" path='/candidacies/caseHandlingDegreeChangeIndividualCandidacyProcess.do?method=beginCandidacyProcessIntro' />			
		</fr:edit>
