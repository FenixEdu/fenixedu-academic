...
<h2 class="brown">Nesta página</h2>
	<ul>
    	<li><%= ChecksumRewriter.NO_CHECKSUM_PREFIX_HAS_CONTEXT_PREFIX %><a href="#desc">Descrição</a></li>
