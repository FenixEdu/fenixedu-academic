...
<logic:present name="selectedSpaceInformation">
	...
	<logic:empty name="unitSpaceOccupation">
		...
		<bean:define id="exceptionLink">/manageUnitSpaceOccupations.do?method=prepareManageUnitOccupationInterval&page=0&spaceInformationID=<bean:write name="selectedSpaceInformationId"/>&unitID=<bean:write name="unit" property="idInternal"/></bean:define>	
	...
	<logic:notEmpty name="unitSpaceOccupation">
		...
		<bean:define id="exceptionLink2">/manageUnitSpaceOccupations.do?method=prepareEditUnitSpaceOccupation&page=0&unitSpaceOccupationID=<bean:write name="unitSpaceOccupation" property="idInternal"/></bean:define>	
