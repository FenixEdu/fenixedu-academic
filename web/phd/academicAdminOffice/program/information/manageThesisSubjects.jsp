...
<logic:notEmpty name="thesisSubjects">
	<fr:view name="thesisSubjects">
		...
		<fr:layout name="tabular">
			...
			<fr:property name="linkFormat(remove)" value="<%= "/phdProgramInformation.do?method=removeThesisSubject&thesisSubjectId=${externalId}&focusAreaId=" + focusArea.getExternalId() %>"/>
...
<fr:edit id="thesisSubjectBean" name="thesisSubjectBean" action="<%= "/phdProgramInformation.do?method=addThesisSubject&focusAreaId=" + focusArea.getExternalId() %>">
	<fr:schema bundle="PHD_RESOURCES" type="net.sourceforge.fenixedu.presentationTier.Action.phd.program.PhdProgramInformationDA$ThesisSubjectBean">
	...
	<fr:layout name="tabular">
		...
		<fr:destination name="cancel" path="/phdProgramInformation.do?method=manageFocusAreas"/>
</fr:edit>
