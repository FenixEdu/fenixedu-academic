...
<p>
	<html:link action="/phdIndividualProgramProcess.do?method=manageProcesses" paramId="processId" paramName="process" paramProperty="externalId">
		...
		<fr:edit name="phdParticipantBean">
			...
			<logic:equal name="phdParticipantBean" property="participant.internal" value="false">
				<fr:schema bundle="PHD_RESOURCES" type="net.sourceforge.fenixedu.domain.phd.ExternalPhdParticipant">
					...
					<fr:slot name="workLocation" validator="pt.ist.fenixWebFramework.renderers.validators.RequiredValidator" />
