...
<h2><bean:message key="label.phd.validate.public.presentation.seminar.comission" bundle="PHD_RESOURCES" /></h2>
<%-- ### End of Title ### --%>
...
<fr:form action="<%="/publicPresentationSeminarProcess.do?processId=" + processId.toString() %>" encoding="multipart/form-data">
	...
	<html:submit bundle="HTMLALT_RESOURCES" altKey="submit.submit" onclick="this.form.method.value='validateComission';"><bean:message bundle="PHD_RESOURCES" key="label.submit"/></html:submit>
