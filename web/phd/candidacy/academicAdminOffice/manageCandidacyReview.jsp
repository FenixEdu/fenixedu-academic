...
<h2><bean:message key="label.phd.candidacy.academicAdminOffice.manageCandidacyReview" bundle="PHD_RESOURCES" /></h2>
<%-- ### End of Title ### --%>
...
<fr:form action="/phdProgramCandidacyProcess.do?method=uploadCandidacyReview" encoding="multipart/form-data">
  	...
  	<strong><bean:message  key="label.phd.candidacy.academicAdminOffice.candidacy.review.document" bundle="PHD_RESOURCES"/></strong>
