...
<fieldset class="lfloat3">
	...
	<p><label><bean:message key="label.sendEmail.CC" bundle="APPLICATION_RESOURCES"/>:&nbsp;</label><html:text bundle="HTMLALT_RESOURCES" altKey="text.copyTo" property="copyTo" size="50"/><font size="-2"> (separe os endereï¿½os por vï¿½rgulas)</font></p>
	<p><label><bean:message key="label.sendEmail.copyToSender" bundle="APPLICATION_RESOURCES"/>:&nbsp;</label><html:checkbox bundle="HTMLALT_RESOURCES" altKey="checkbox.copyToSender" property="copyToSender"/>(assinale caso deseje receber uma cï¿½pia da mensagem no endereï¿½o do remetente)</p>
