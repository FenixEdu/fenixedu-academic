...
<logic:present role="ACADEMIC_ADMINISTRATIVE_OFFICE">
	...
	<fr:form action='<%="/exemptionsManagement.do?eventId=" + eventId %>'>
		...
		<fr:edit id="exemptionBean" name="exemptionBean" schema="DegreeFinalizationCertificateRequestExemption.edit">
			<fr:layout name="tabular">
				<fr:property name="classes" value="tstyle4" />
				<fr:property name="columnClasses" value=",,tdclear tderror1" />
			</fr:layout>
			<fr:destination name="invalid" path='<%="/exemptionsManagement.do?method=prepareCreateDegreeFinalizationCertificateRequestExemptionInvalid&amp;eventId=" + eventId %>'/>
		</fr:edit>

		<html:submit bundle="HTMLALT_RESOURCES" altKey="submit.submit" onclick="this.form.method.value='createDegreeFinalizationCertificateRequestExemption';">
