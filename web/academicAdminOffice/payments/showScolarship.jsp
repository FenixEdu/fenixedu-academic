...
<logic:equal name="exemption" property="fctScholarshipPhdGratuityContribuitionEvent.open" value="true">
	<fr:view name="exemption">
		<fr:schema bundle="ACADEMIC_OFFICE_RESOURCES" type="net.sourceforge.fenixedu.domain.phd.debts.PhdGratuityFctScholarshipExemption">
			<fr:slot name="description" key="label.serviceRequests.purpose"></fr:slot>
			<fr:slot name="fctScholarshipPhdGratuityContribuitionEvent.totalValue" key="label.total.amount"></fr:slot>
...
<p><em>Deseja saldar esta divida?</em></p>
	...
	<fr:form action="/fctDebts.do" >
			...
			<fr:edit id="bean" name="bean">
				<fr:schema bundle="ACADEMIC_OFFICE_RESOURCES" type="net.sourceforge.fenixedu.presentationTier.Action.administrativeOffice.payments.FCTManagementDebtsDA$AmountBean">
...
<logic:equal name="exemption" property="fctScholarshipPhdGratuityContribuitionEvent.open" value="false">
	<fr:view name="exemption">
		<fr:schema bundle="ACADEMIC_OFFICE_RESOURCES" type="net.sourceforge.fenixedu.domain.phd.debts.PhdGratuityFctScholarshipExemption">
			<fr:slot name="description" key="label.serviceRequests.purpose"></fr:slot>
			<fr:slot name="fctScholarshipPhdGratuityContribuitionEvent.totalValue" key="label.total.amount"></fr:slot>
