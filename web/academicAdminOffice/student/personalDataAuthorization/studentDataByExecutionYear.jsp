...
<ul class="list5">
	<li>
		<html:link action="/studentDataByExecutionYear.do?method=prepareCreate" paramName="student" paramProperty="idInternal" paramId="studentId">
			<bean:message bundle="ACADEMIC_OFFICE_RESOURCES" key="label.add.studentData" />
		</html:link>
	</li>
	<li>
...
<logic:notEmpty name="createBean">
	<div class="mbottom15">
		<fr:edit id="createBeanData" name="createBean" schema="StudentDataByExecutionYearBean" action="<%= "/studentDataByExecutionYear.do?method=create&amp;studentId=" + studentId.toString() %>">
