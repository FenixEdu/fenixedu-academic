...
<!-- Duplicated for Supervisor role. And yes, it lacks elegance. A whole lot! -->
<logic:present role="EXTERNAL_SUPERVISOR">
	...
	<p>
	<logic:equal name="curriculum" property="empty" value="false">
		<html:link page="/registration.do?method=prepareViewRegistrationCurriculumForSupervisor" paramId="personId" paramName="studentPerson" paramProperty="externalId">
			<bean:message key="link.student.back" bundle="ACADEMIC_OFFICE_RESOURCES"/>
		</html:link>
	</logic:equal>
	
	<logic:equal name="curriculum" property="empty" value="true">
		<html:link page="/viewStudent.do?method=showStats" paramId="personId" paramName="studentPerson" paramProperty="externalId">
			<bean:message key="link.student.back" bundle="ACADEMIC_OFFICE_RESOURCES"/>
		</html:link>
	</logic:equal>
	</p>
