...
<tiles:insert definition="df.layout.two-column.posGrad" beanName="" flush="true">
  ...
  <tiles:put name="serviceName" value="Secretaria de Pós-Graduação102" />
  ...
  <tiles:put name="body" value="/masterDegreeAdministrativeOffice/candidate/candidateRegistered_bd.jsp" />
