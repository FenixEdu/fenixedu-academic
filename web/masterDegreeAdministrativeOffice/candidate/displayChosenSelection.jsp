...
<tiles:insert definition="df.layout.two-column.posGrad" beanName="" flush="true">
  <tiles:put name="title" value="Secretaria de Pós-Graduação14" />
  <tiles:put name="serviceName" value="Secretaria de Pós-Graduação111" />
  ...
  <tiles:put name="body" value="/masterDegreeAdministrativeOffice/candidate/displayChosenSelection_bd.jsp" />
