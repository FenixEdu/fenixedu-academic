...
<tiles:insert definition="df.layout.two-column.posGrad" beanName="" flush="true">
  <tiles:put name="title" value="Secretaria de Pós-Graduação179" />
  ...
  <tiles:put name="body" value="/masterDegreeAdministrativeOffice/thesis/changeMasterDegreeThesis_bd.jsp" />
