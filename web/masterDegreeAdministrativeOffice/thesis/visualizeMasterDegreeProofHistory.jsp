...
<tiles:insert definition="df.layout.two-column.posGrad" beanName="" flush="true">
  <tiles:put name="title" value="Secretaria de Pós-Graduação188" />
  ...
  <tiles:put name="body" value="/masterDegreeAdministrativeOffice/thesis/visualizeMasterDegreeProofHistory_bd.jsp" />
