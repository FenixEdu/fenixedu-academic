...
<div class="infoop2">
	...
	<p class="mvert05"><b><bean:message key="label.teacher.number.short" bundle="TEACHER_CREDITS_SHEET_RESOURCES"/>:</b> <bean:write name="teacher" property="teacherId"/></p>
...
<h3 class="mtop2 separator2"><span class="underline1">2) <bean:message key="label.teacherCreditsSheet.professorships.postGraduation" bundle="TEACHER_CREDITS_SHEET_RESOURCES"/></span></h3>
...
<logic:equal name="showLinks" value="true">
	<p class="mtop0 pleft1">
		<html:link page='<%= "/manageCreditsNotes.do?method=viewNote&amp;noteType=masterDegreeTeachingNote&amp;page=0" + "&amp;executionPeriodId=" + executionPeriodId %>' paramId="teacherId" paramName="teacher" paramProperty="teacherId">
...
<h3 class="mtop2 separator2"><span class="underline1">4) <bean:message key="label.teacherCreditsSheet.thesis" bundle="TEACHER_CREDITS_SHEET_RESOURCES"/></span></h3>
	...
	<table class="tstyle4 mbottom05">
			...
			<logic:iterate id="thesis" name="teacherThesisEvaluationParticipants">
				<tr>
					...
					<td>
						<bean:write name="thesis" property="thesis.student.person.name"/>
					</td>
					<td>
						<bean:write name="thesis" property="thesis.title"/>
					</td>
					<td>
						<fmt:formatNumber maxFractionDigits="1" minFractionDigits="1" pattern="###.#">
							<logic:equal value="ORIENTATOR" name="thesis" property="type">
								<bean:write name="thesis" property="thesis.orientatorCreditsDistribution"/>
							</logic:equal>
							<logic:equal value="COORIENTATOR" name="thesis" property="type">
								<bean:write name="thesis" property="thesis.coorientatorCreditsDistribution"/>
							</logic:equal>
						</fmt:formatNumber>
					</td>
					<td>
...
<logic:equal name="showLinks" value="true">
	<p class="mtop0 pleft1">
		<html:link page='<%= "/manageCreditsNotes.do?method=viewNote&amp;noteType=thesisNote&amp;page=0" + "&amp;executionPeriodId=" + executionPeriodId %>' paramId="teacherId" paramName="teacher" paramProperty="teacherId">
			<bean:message key="link.notes" bundle="TEACHER_CREDITS_SHEET_RESOURCES"/>
		</html:link>
	</p>
</logic:equal>
<%-- ========================== TEACHER INSTITUTION WORKING TIME ============================ --%>
<h3 class="mtop2 separator2"><span class="underline1">5) <bean:message key="label.teacherCreditsSheet.institutionWorkingTime" bundle="TEACHER_CREDITS_SHEET_RESOURCES"/></span></h3>
...
<h3 class="mtop2 separator2"><span class="underline1">6) <bean:message key="label.teacherCreditsSheet.functionsAccumulation" bundle="TEACHER_CREDITS_SHEET_RESOURCES"/></span></h3>
...
<logic:equal name="showLinks" value="true">
	<p class="mtop0 pleft1">
		<html:link page='<%= "/manageCreditsNotes.do?method=viewNote&amp;noteType=functionsAccumulationNote&amp;page=0" + "&amp;executionPeriodId=" + executionPeriodId %>' paramId="teacherId" paramName="teacher" paramProperty="teacherId">
			<bean:message key="link.notes" bundle="TEACHER_CREDITS_SHEET_RESOURCES"/>
		</html:link>
	</p>
</logic:equal>
...
<h3 class="mtop2 separator2"><span class="underline1">7) <bean:message key="label.teacherCreditsSheet.otherTypeCreditLines" bundle="TEACHER_CREDITS_SHEET_RESOURCES"/></span></h3>
...
<logic:equal name="showLinks" value="true">
	<p class="mtop0 pleft1">
		<html:link page='<%= "/manageCreditsNotes.do?method=viewNote&amp;noteType=otherNote&amp;page=0" + "&amp;executionPeriodId=" + executionPeriodId %>' paramId="teacherId" paramName="teacher" paramProperty="teacherId">
			<bean:message key="link.notes" bundle="TEACHER_CREDITS_SHEET_RESOURCES"/>
		</html:link>
	</p>
</logic:equal>
...
<h3 class="mtop2 separator2"><span class="underline1">8) <bean:message key="label.teacherCreditsSheet.managementPositionLines" bundle="TEACHER_CREDITS_SHEET_RESOURCES"/></span></h3>
...
<logic:equal name="showLinks" value="true">
	<p class="mtop0 pleft1">
		<html:link page='<%= "/manageCreditsNotes.do?method=viewNote&amp;noteType=managementFunctionNote&amp;page=0" + "&amp;executionPeriodId=" + executionPeriodId %>' paramId="teacherId" paramName="teacher" paramProperty="teacherId">
			<bean:message key="link.notes" bundle="TEACHER_CREDITS_SHEET_RESOURCES"/>
		</html:link>
	</p>
</logic:equal>
<%-- ============================ SERVICE EXEMPTIONS ================================= --%>
<h3 class="mtop2 separator2"><span class="underline1">9) <bean:message key="label.teacherCreditsSheet.serviceExemptionLines" bundle="TEACHER_CREDITS_SHEET_RESOURCES"/></span></h3>
...
<logic:equal name="showLinks" value="true">
	<p class="mtop0 pleft1">
		<html:link page='<%= "/manageCreditsNotes.do?method=viewNote&amp;noteType=serviceExemptionNote&amp;page=0" + "&amp;executionPeriodId=" + executionPeriodId %>' paramId="teacherId" paramName="teacher" paramProperty="teacherId">
				<bean:message key="link.notes" bundle="TEACHER_CREDITS_SHEET_RESOURCES"/>
		</html:link>
	</p>
</logic:equal>
