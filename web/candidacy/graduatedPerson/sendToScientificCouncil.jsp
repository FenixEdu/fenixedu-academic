...
<h2><bean:message key="label.candidacy.graduatedPerson.send.to.scientificCouncil" bundle="APPLICATION_RESOURCES"/></h2>
...
<fr:form action='<%= "/caseHandling" + processName.toString() + ".do?processId=" + processId.toString() %>'>
	...
	<strong><bean:message key="label.candidacy.graduatedPerson.send.to.scientificCouncil.confirm.message" bundle="APPLICATION_RESOURCES" />?</strong>
	<br/>
	<br/>
