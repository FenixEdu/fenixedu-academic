...
<ft:tilesView definition="definition.degreeAdministrativeOffice.masterPage" attributeName="body-inline">
	...
	<h:panelGroup>
		...
		<fc:dataRepeater value="#{DegreeManagement.filteredBolonhaDegrees}" var="degree" rendered="#{!empty DegreeManagement.filteredBolonhaDegrees}">
			...
			<h:outputLink value="#{DegreeManagement.request.contextPath}/degreeAdministrativeOffice/curricularPlans/viewDegree.faces">
			...
			<fc:dataRepeater value="#{degree.degreeCurricularPlans}" var="degreeCurricularPlan" rendered="#{!empty degree.degreeCurricularPlans}" rowIndexVar="index">
				...
				<h:outputText value="<td>" escape="false"/>
				<h:outputLink value="#{DegreeManagement.request.contextPath}/degreeAdministrativeOffice/curricularPlans/viewCurricularPlan.faces">
				...
				<h:outputLink value="#{DegreeManagement.request.contextPath}/degreeAdministrativeOffice/curricularPlans/buildCurricularPlan.faces" rendered="#{degreeCurricularPlan.userCanBuild}">
