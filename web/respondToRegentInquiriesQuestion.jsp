				...
				<div class="infoop2">
					...
					<logic:iterate id="executionCourse" name="executionCourses">
						<p style="margin: 0 0 0.5em 0;">
							...
							<html:link page="/teacher/regentInquiry.do?method=showInquiriesPrePage&contentContextPath_PATH=/docencia/docencia" paramId="executionCourseID" paramName="executionCourse" paramProperty="idInternal">
								<strong>
