...
<logic:present role="MANAGER">
	...
	<fr:edit name="event" schema="ChangePaymentPlan">
		...
		<fr:destination name="success" path="<%="/payments.do?method=backToShowEvents&personId=" + personId.toString() %>" />
		<fr:destination name="invalid" path="<%="/payments.do?method=prepareChangePaymentPlan&eventId=" + eventId.toString() %>" />
