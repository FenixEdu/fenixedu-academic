...
<p class="mtop2"><h2><bean:message bundle="MANAGER_RESOURCES" bundle="MANAGER_RESOURCES" key="label.manager.executionCourseManagement.edit.executionCourse"/></h2></p>
...
<logic:present name="<%=SessionConstants.EXECUTION_COURSE%>">
	...
	<p class="mtop2"><h2><bean:message bundle="MANAGER_RESOURCES" bundle="MANAGER_RESOURCES" key="label.manager.curricularCourses"/></h2></p>
	<ul>
		<li>
