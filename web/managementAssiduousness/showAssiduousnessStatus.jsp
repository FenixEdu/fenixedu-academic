...
<ul class="list5 mtop15">
	<li>
		<html:link page="/assiduousnessParametrization.do?method=editAssiduousnessStatus"><bean:message key="link.createAssiduousnessStatus" /></html:link>
	</li>
</ul>
<%}%>
<logic:present name="assiduousnessStatus">
	<fr:view name="assiduousnessStatus" schema="assiduousnessStatusSchema">
		<fr:layout name="tabular">
			<fr:property name="classes" value="tstyle1 printborder tdleft" />
			<fr:property name="headerClasses" value="acenter" />
			<%if (net.sourceforge.fenixedu.domain.ManagementGroups.isAssiduousnessManagerMember(user.getPerson())) {  %>
                <fr:property name="link(edit)" value="/assiduousnessParametrization.do?method=editAssiduousnessStatus" />
