...
<logic:present name="yearMonthToExport">
	...
	<p>
		<fr:form action="/monthClosure.do">
			<html:hidden name="parametrizationForm" property="method" value="exportClosedMonthWorkAbsencesToGIAF"/> 
			...
			<html:submit bundle="HTMLALT_RESOURCES" altKey="cancel.cancel" onclick="this.form.method.value='prepareToCloseMonth'">
