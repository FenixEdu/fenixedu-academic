...
<logic:present name="employeeWorkSheet">
	<logic:present name="yearMonth">
		...
		<bean:define id="employee" name="employeeWorkSheet"
			property="employee" />
		...
		<logic:present name="employeeJustificationFactory">
			<span class="error0 mtop0"><html:messages id="errorMessage"
				message="true" property="errorMessage">
		...
		<logic:empty name="employeeWorkSheet" property="workDaySheetList">
			<p><em><bean:message key="message.employee.noWorkSheet" /></em>
			</p>
		</logic:empty>
		<logic:notEmpty name="employeeWorkSheet" property="workDaySheetList">
			<fr:view name="employeeWorkSheet" property="workDaySheetList" schema="show.workDaySheet">
				<fr:layout name="tabular">
					...
					<%if (net.sourceforge.fenixedu.domain.ManagementGroups.isAssiduousnessManagerMember(user.getPerson())) { %>
						<fr:property name="link(justification)"
							value="<%="/employeeAssiduousness.do?method=prepareCreateEmployeeJustification&correction=JUSTIFICATION&employeeNumber="+employeeNumber.toString()%>" />
						...
						<fr:property name="link(regularization)"
							value="<%="/employeeAssiduousness.do?method=prepareCreateEmployeeJustification&correction=REGULARIZATION&employeeNumber="+employeeNumber.toString()%>" />
			...
			<div class="print_smaller"><logic:notEmpty
				name="displayCurrentDayNote">
				<em><bean:message key="message.employee.currentDayIgnored" /></em>
			</logic:notEmpty>
			<table class="mtop1">
				<tr>
					<td><bean:message key="label.totalBalance" />: <b><bean:write
						name="employeeWorkSheet" property="totalBalanceString" /></b></td>
					<td><bean:message key="label.totalSaturday" />: <b><bean:write
						name="employeeWorkSheet" property="complementaryWeeklyRestString" /></b></td>
					<td><bean:message key="label.unjustifiedDays" />: <b><bean:write
						name="employeeWorkSheet" property="unjustifiedDays" /></b></td>
				</tr>
				<tr>
					<td style="padding-right: 2em;"><bean:message
						key="label.totalUnjustified" />: <b><bean:write
						name="employeeWorkSheet" property="unjustifiedBalanceString" /></b></td>
					<td><bean:message key="label.totalSunday" />: <b><bean:write
						name="employeeWorkSheet" property="weeklyRestString" /></b></td>
					<td><bean:message key="label.accumulatedUnjustifiedDays" />:
					<b><bean:write name="employeeWorkSheet"
						property="accumulatedUnjustifiedDays" /></b></td>
				</tr>
				<tr>
					<td></td>
					<td><bean:message key="label.totalHoliday" />: <b><bean:write
						name="employeeWorkSheet" property="holidayRestString" /></b></td>
					<td><bean:message key="label.accumulatedArticle66Days" />: <b><bean:write
						name="employeeWorkSheet" property="accumulatedArticle66Days" /></b></td>
				</tr>
			</table>
			</div>
...
<logic:notPresent name="employeeWorkSheet">
	<p><em><bean:message key="message.employee.noWorkSheet" /></em></p>
</logic:notPresent>
