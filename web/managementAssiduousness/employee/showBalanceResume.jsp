...
<logic:present name="employeeMonthyBalanceResume">
	<logic:present name="yearMonth">
		<bean:define id="month" name="yearMonth" property="month" />
		<bean:define id="year" name="yearMonth" property="year" />
		<bean:define id="employee" name="employeeMonthyBalanceResume" property="employee"/>
		<bean:define id="employeeNumber" name="employeeMonthyBalanceResume" property="employee.employeeNumber" />
		...
		<logic:iterate id="employeeBalanceResume" name="employeeMonthyBalanceResume" property="employeeBalanceResumeList">
			<fr:view name="employeeBalanceResume" property="assiduousnessStatusHistory" schema="show.employeeStatus" layout="tabular"/>
