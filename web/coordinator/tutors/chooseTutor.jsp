	...
	<logic:notEmpty name="tutors">
		...
		<fr:view name="tutors" layout="tabular-sortable" schema="coordinator.chooseTutor.tutorList">
			<fr:layout>
				...
				<fr:property name="sortableSlots" value="teacherId,teacher.person.name,teacher.currentWorkingDepartment.name,teacher.category,teacher.numberOfPastTutorships,teacher.numberOfActiveTutorships"/>
