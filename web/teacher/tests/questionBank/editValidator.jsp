...
<h2><bean:message key="title.editValidator" bundle="TESTS_RESOURCES" /></h2>
...
<html:hidden bundle="HTMLALT_RESOURCES" altKey="hidden.returnTo" property="returnTo" value="editValidator" />
<fr:edit name="bean"
...
<fr:form action="/tests/questionBank.do?method=chooseValidator">
<html:hidden bundle="HTMLALT_RESOURCES" altKey="hidden.returnTo" property="returnTo" value="editValidator" />
<fr:edit name="bean"
...
<logic:notEmpty name="bean" property="question.validator">
	...
	<fr:view name="bean" property="question" schema="tests.atomicQuestion.validator" layout="flow" />
</logic:notEmpty>
<logic:empty name="bean" property="question.validator">
