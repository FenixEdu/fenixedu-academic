...
<fr:form action="/studentListByDegree.do" id="searchForm">
...
<html:hidden property="extendedInfo" value="false"/>
	...
	<fr:edit id="chosenDegree" name="searchParametersBean" schema="SearchStudentsByDegreeParametersBean.edit.degreeAndRegistrationInfo">
		<fr:destination name="postBack" path="/studentListByDegree.do?method=postBack"/>
		<fr:destination name="invalid" path="/studentListByDegree.do?method=prepareByDegree"/>
...
<logic:present name="studentCurricularPlanList">
	...
	<fr:view schema="gep.studentCurricularPlanList.view" name="studentCurricularPlanList">
		<fr:layout name="tabular">
