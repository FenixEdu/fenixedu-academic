...
<p>
	<a id="createRuleLink" href="#" onclick="showCreateRule"><strong><bean:message
				bundle="ACADEMIC_OFFICE_RESOURCES" key="label.academicAdministration.authorizations.create" /></strong> </a>
</p>
			...
			<div id="period" class="authorization period  ui-droppable">
				<header id="header">
					...
					<logic:equal name="memberRules" property="key.person" value="true">
						...
						<bean:write name="memberRules" property="key.name" /> - <bean:write name="memberRules" property="key.username" />
					</logic:equal>
				...
				<ul>
					<logic:iterate id="rule" name="memberRules" property="value">
						<li>Pode <strong><bean:write name="rule" property="operation.localizedName" /></strong> <logic:notEmpty
								name="rule" property="office"> para os cursos geridos pelas secretarias: <logic:iterate
									id="office" name="rule" property="office">
									<bean:write name="office" property="unit.name" />
								</logic:iterate>
							</logic:notEmpty> <logic:notEmpty name="rule" property="program">e para os cursos: <logic:iterate id="program"
									name="rule" property="program">
