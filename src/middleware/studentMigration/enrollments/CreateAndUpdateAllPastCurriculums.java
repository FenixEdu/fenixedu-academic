...
public class CreateAndUpdateAllPastCurriculums
{
	...
	public static void main(String args[])
	{
		try
		{
			...
			IPersistentMWCurricularCourseScope persistentMWCurricularCourseScope =
			...
			numberOfSpans =
				numberOfMWCurricularCourseScopes.intValue() % numberOfElementsInSpan > 0
					? numberOfSpans + 1
					: numberOfSpans;
			...
			for (int span = 0; span < numberOfSpans; span++)
			{
				...
				List result =
					persistentMWCurricularCourseScope.readAllBySpan(
						new Integer(span),
						new Integer(numberOfElementsInSpan));
				CreateAndUpdateAllPastCurriculums.mwCurricularCourseScopesRead =
					CreateAndUpdateAllPastCurriculums.mwCurricularCourseScopesRead + result.size();
				...
				while (iterator.hasNext())
				{
					...
					MWCurricularCourseScope mwCurricularCourseScope =
						(MWCurricularCourseScope) iterator.next();

					fenixPersistentSuport.iniciarTransaccao();

					CreateAndUpdateAllPastCurriculums.writeAndUpdate(
						mwCurricularCourseScope,
		...
		System.out.println(
			"[INFO] Total DegreeCurricularPlans created: ["
				+ CreateAndUpdateAllPastCurriculums.degreeCurricularPlansCreated
				+ "].");
		System.out.println(
			"[INFO] Total CurricularCourses created: ["
				+ CreateAndUpdateAllPastCurriculums.curricularCoursesCreated
				+ "].");
		System.out.println(
			"[INFO] Total CurricularCourseScopes created: ["
				+ CreateAndUpdateAllPastCurriculums.curricularCourseScopesCreated
				+ "].");
		System.out.println(
			"[INFO] Total Branches created: ["
				+ CreateAndUpdateAllPastCurriculums.branchesCreated.size()
				+ "].");
		System.out.println(
			"[INFO] Total Universitys created: ["
				+ CreateAndUpdateAllPastCurriculums.universitysCreated
				+ "].");
		System.out.println(
			"[INFO] Total MWCurricularCourseScopes read: ["
				+ CreateAndUpdateAllPastCurriculums.mwCurricularCourseScopesRead
				+ "].");
	 ...
	 * @throws Throwable
	 */
	private static void writeAndUpdate(
		MWCurricularCourseScope mwCurricularCourseScope,
		...
		throws Throwable
	{
		try
		{
			IDegreeCurricularPlan degreeCurricularPlan =
				CreateAndUpdateAllPastCurriculums.getDegreeCurricularPlan(
					mwCurricularCourseScope,
					fenixPersistentSuport);
			if (degreeCurricularPlan == null)
			{
				System.out.println(
					"[ERROR 101] No record of Degree with code: ["
						+ mwCurricularCourseScope.getDegreecode()
						+ "]! ExecutionYear: ["
						+ mwCurricularCourseScope.getExecutionyear()
						+ "]");
				return;
			}

			IBranch branch =
				CreateAndUpdateAllPastCurriculums.getBranch(
					mwCurricularCourseScope.getDegreecode(),
			...
			{
				System.out.println(
					"[ERROR 102] No record of Branch with code: ["
						+ mwCurricularCourseScope.getBranchcode()
			...
			ICurricularCourse curricularCourse =
				CreateAndUpdateAllPastCurriculums.getCurricularCourse(
			...
			{
				System.out.println(
					"[ERROR 103] No record of CurricularCourse with code: ["
						+ mwCurricularCourseScope.getCoursecode()
						+ "]! ExecutionYear: ["
						+ mwCurricularCourseScope.getExecutionyear()
						+ "]");
			...
			ICurricularCourseScope curricularCourseScope =
				CreateAndUpdateAllPastCurriculums.getCurricularCourseScope(
					mwCurricularCourseScope,
					curricularCourse,
					branch,
					fenixPersistentSuport);
			if (curricularCourseScope == null)
			{
				...
				System.out.print(
					"Curricular Year - [" + mwCurricularCourseScope.getCurricularyear() + "], ");
				System.out.print(
					"Curricular Semester - [" + mwCurricularCourseScope.getCurricularsemester() + "], ");
				System.out.println(
					"Execution Year: [" + mwCurricularCourseScope.getExecutionyear() + "]!");
				return;
			}
		...
		catch (Throwable e)
		{
			...
			System.out.println(
				"[ERROR 109] Execution Year: [" + mwCurricularCourseScope.getExecutionyear() + "]");
			System.out.println(
				"[ERROR 109] Course Code: [" + mwCurricularCourseScope.getCoursecode() + "]");
			System.out.println(
				"[ERROR 109] Degree Code: [" + mwCurricularCourseScope.getDegreecode() + "]");
			System.out.println(
				"[ERROR 109] Branch Code: [" + mwCurricularCourseScope.getBranchcode() + "]");
			System.out.println(
				"[ERROR 109] Curricular Year: [" + mwCurricularCourseScope.getCurricularyear() + "]");
			System.out.println(
				"[ERROR 109] Curricular Semester: ["
					+ mwCurricularCourseScope.getCurricularsemester()
					+ "]");
			System.out.println(
				"[ERROR 109] Course Type: [" + mwCurricularCourseScope.getCoursetype() + "]");
		...
		throws Throwable
	{
		...
		MWDegreeTranslation mwDegreeTranslation =
			persistentMWDegreeTranslation.readByDegreeCode(mwCurricularCourseScope.getDegreecode());
	 ...
	 *         Throwable
	 */
	protected static ICurricularCourse getCurricularCourse(
		String courseCode,
		IDegreeCurricularPlan degreeCurricularPlan,
		ISuportePersistente fenixPersistentSuport)
		throws Throwable
	{
		...
		List curricularCourses =
			persistentCurricularCourse.readbyCourseCodeAndDegreeCurricularPlan(
		...
		else if (curricularCourses.size() < 1)
		{
			...
			String curricularCourseName =
				CreateAndUpdateAllPastCurriculums.getCurricularCourseName(StringUtils.trim(courseCode));
			if (curricularCourseName == null)
			{
				System.out.println(
					"[ERROR 106] Couldn't find name for CurricularCourse with code ["
						+ StringUtils.trim(courseCode)
						+ "]!");
				return null;
			}
		...
		{
			// It has been found exactly ONE CurricularCourse already in the Fenix DB with that code,
			// for that DegreeCurricularPlan.
	 ...
	 *         Throwable
	 */
	protected static ICurricularCourseScope getCurricularCourseScope(
		MWCurricularCourseScope mwCurricularCourseScope,
		ICurricularCourse curricularCourse,
		IBranch branch,
		ISuportePersistente fenixPersistentSuport)
		throws Throwable
	{
		IPersistentCurricularCourseScope persistentCurricularCourseScope =
			fenixPersistentSuport.getIPersistentCurricularCourseScope();
		IPersistentCurricularSemester persistentCurricularSemester =
			fenixPersistentSuport.getIPersistentCurricularSemester();
		IPersistentCurricularYear persistentCurricularYear =
			fenixPersistentSuport.getIPersistentCurricularYear();

		ICurricularYear curricularYear =
			persistentCurricularYear.readCurricularYearByYear(
				mwCurricularCourseScope.getCurricularyear());
		if (curricularYear == null)
		{
			System.out.println(
				"[ERROR 107] Can't find in Fenix DB CurricularYear with year ["
					+ mwCurricularCourseScope.getCurricularyear()
					+ "]!");
			return null;
		}
		...
		ICurricularSemester curricularSemester =
			persistentCurricularSemester.readCurricularSemesterBySemesterAndCurricularYear(
				mwCurricularCourseScope.getCurricularsemester(),
				curricularYear);
		if (curricularSemester == null)
		{
			System.out.println(
				"[ERROR 108] Can't find in Fenix DB CurricularSemester with semester ["
					+ mwCurricularCourseScope.getCurricularsemester()
					+ "] and year ["
		...
		if (curricularCourseScope == null)
		{
			...
			// This means no CurricularCourseScope was found with CurricularCourse, CurricularSemester
			// and Branch.
			...
			calendar.setTimeInMillis(
				CreateAndUpdateAllPastCurriculums
					.getExecutionPeriod(mwCurricularCourseScope, fenixPersistentSuport)
					.getBeginDate()
					.getTime());
	 ...
	 *         Throwable
	 */
	protected static String getCurricularCourseName(String curricularCourseCode) throws Throwable
	{
		IPersistentMiddlewareSupport mws = PersistentMiddlewareSupportOJB.getInstance();
		IPersistentMWCurricularCourse persistentMWCurricualrCourse =
			mws.getIPersistentMWCurricularCourse();

		MWCurricularCourse mwCurricularCourse =
			persistentMWCurricualrCourse.readByCode(curricularCourseCode);
	 ...
	 * @throws Throwable
	 */
	private static void createAndUpdateUniversitys(
		IPersistentMiddlewareSupport persistentMiddlewareSupport,
		ISuportePersistente fenixPersistentSuport)
		throws Throwable
	{
		IPersistentMWUniversity persistentMWUniversity =
			persistentMiddlewareSupport.getIPersistentMWUniversity();
	 ...
	 *         Throwable
	 */
	public static IBranch solveBranchesProblemsForDegrees1And4And6And51And53And54And64(
		Integer degreeCode,
		Integer branchCode,
		IDegreeCurricularPlan degreeCurricularPlan,
		IPersistentBranch persistentBranch)
		throws Throwable
	{
	 ...
	 *         Throwable
	 */
	private static IExecutionPeriod getExecutionPeriod(
		MWCurricularCourseScope mwCurricularCourseScope,
		ISuportePersistente fenixPersistentSuport)
		throws Throwable
	{
		...
		IExecutionPeriod executionPeriod =
			CreateAndUpdateAllStudentsPastEnrolments.getExecutionPeriodForThisMWEnrolment(
				mwEnrolment,
				fenixPersistentSuport);
