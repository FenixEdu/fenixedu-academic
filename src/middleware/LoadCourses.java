...
public class LoadCourses extends DataFileLoader
{
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            // Apagar as associações de disciplinas curriculares a disciplinas
            // execucao.
    ...
    private static void carregarDisciplinaCurricular(String line) throws ExcepcaoPersistencia
    {
        ...
        IPersistentCurricularCourse iDisciplinaCurricularPersistente = sp
                .getIPersistentCurricularCourse();
        IPersistentDegreeCurricularPlan curricularDegreePlanDAO = sp
                .getIPersistentDegreeCurricularPlan();
        //        IDisciplinaExecucaoPersistente iDisciplinaExecucaoPersistente =
        // SuportePersistente.getInstance().iDisciplinaExecucaoPersistente();

        // Criar a disciplina curricular.
        ICurricularCourse disciplinaCurricular = new CurricularCourse();

        String degreeCode = MiddlewareUtil.gerarSiglaDeLicenciatura(Integer.parseInt(chaveLicenciatura));
        ...
        IDegreeCurricularPlan planoCurricularCurso = (IDegreeCurricularPlan) curricularDegreePlanDAO
                .readDomainObjectByCriteria(planoCurricularCursoTemp);
        ...
        criteriaCurricularCourse = (ICurricularCourse) iDisciplinaCurricularPersistente
                .readDomainObjectByCriteria(criteriaCurricularCourse);
        if (criteriaCurricularCourse == null)
        {
            iDisciplinaCurricularPersistente.simpleLockWrite(disciplinaCurricular);
            disciplinaCurricular.setCode(sigla);
            disciplinaCurricular.setCredits(null);
            //      disciplinaCurricular.setCurricularYear(new
            ...
            disciplinaCurricular.setTheoPratHours(new Double(cargaHorariaTeoricoPratica));
            disciplinaCurricular.setTheoreticalHours(new Double(cargaHorariaTeorica));
