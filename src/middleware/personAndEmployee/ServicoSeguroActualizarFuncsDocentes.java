...
public class ServicoSeguroActualizarFuncsDocentes extends ServicoSeguroSuperMigracaoPessoas
{
	...
	/** Construtor */
	public ServicoSeguroActualizarFuncsDocentes(String[] args) throws NotExecuteException 
	{
		String path;
		try
		{
