...
public class State implements Serializable {
	...
	public State(String validation) {
		if (validation.equals(State.ACTIVE_STRING)) this.state = new Integer(State.ACTIVE);
		if (validation.equals(State.INACTIVE_STRING)) this.state = new Integer(State.INACTIVE);
	}
	...
	public String toString() {
		if (state.intValue()== State.ACTIVE) return State.ACTIVE_STRING;
		if (state.intValue()== State.INACTIVE) return State.INACTIVE_STRING;
		return "ERROR!"; 
	}
