...
public class PaymentType implements Serializable {
	...
	public PaymentType(String type) {
		if (type.equals(PaymentType.CASH_STRING)) this.type = new Integer(PaymentType.CASH);
		if (type.equals(PaymentType.ATM_STRING)) this.type = new Integer(PaymentType.ATM);
		if (type.equals(PaymentType.CHEQUE_STRING)) this.type = new Integer(PaymentType.CHEQUE);
		if (type.equals(PaymentType.NIB_TRANSFER_STRING)) this.type = new Integer(PaymentType.NIB_TRANSFER);
		if (type.equals(PaymentType.POSTAL_STRING)) this.type = new Integer(PaymentType.POSTAL);
...
//			
	...
	public String toString() {
		if (type.intValue()== PaymentType.CASH) return PaymentType.CASH_STRING;
		if (type.intValue()== PaymentType.ATM) return PaymentType.ATM_STRING;
		if (type.intValue()== PaymentType.CHEQUE) return PaymentType.CHEQUE_STRING;
		if (type.intValue()== PaymentType.NIB_TRANSFER) return PaymentType.NIB_TRANSFER_STRING;
		if (type.intValue()== PaymentType.POSTAL) return PaymentType.POSTAL_STRING;
