...
public class StudentCurricularPlanState {
	...
	public static final StudentCurricularPlanState CONCLUDED_OBJ =
		new StudentCurricularPlanState(StudentCurricularPlanState.CONCLUDED);
	public static final StudentCurricularPlanState INCOMPLETE_OBJ =
		new StudentCurricularPlanState(StudentCurricularPlanState.INCOMPLETE);
	public static final StudentCurricularPlanState SCHOOLPARTCONCLUDED_OBJ =
	...
	public static final String SCHOOLPARTCONCLUDED_STRING =
		"Parte Escolar Concluida";
	...
	public StudentCurricularPlanState(String state) {
		...
		if (state
			.equals(StudentCurricularPlanState.SCHOOLPARTCONCLUDED_STRING))
			this.state =
				new Integer(StudentCurricularPlanState.SCHOOLPARTCONCLUDED);
