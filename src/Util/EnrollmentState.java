...
public class EnrollmentState extends FenixValuedEnum {
	...
	public static final EnrollmentState APROVED =
		new EnrollmentState("msg.approved", EnrollmentState.APROVED_TYPE);
	public static final EnrollmentState NOT_APROVED =
		new EnrollmentState("msg.notApproved", EnrollmentState.NOT_APROVED_TYPE);
	public static final EnrollmentState ENROLLED =
		new EnrollmentState("msg.enrolled", EnrollmentState.ENROLLED_TYPE);
	public static final EnrollmentState TEMPORARILY_ENROLED =
		new EnrollmentState(
			"msg.temporarilyEnrolled",
			EnrollmentState.TEMPORARILY_ENROLLED_TYPE);
	public static final EnrollmentState ANNULED =
		new EnrollmentState("msg.annuled", EnrollmentState.ANNULED_TYPE);
	public static final EnrollmentState NOT_EVALUATED =
		new EnrollmentState(
			"msg.notEvaluated",
