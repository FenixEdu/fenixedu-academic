...
public class GratuitySituationType extends FenixValuedEnum {
    ...
    public static final GratuitySituationType DEBTOR = new GratuitySituationType("debtor",
            GratuitySituationType.DEBTOR_TYPE);

    public static final GratuitySituationType CREDITOR = new GratuitySituationType("creditor",
            GratuitySituationType.CREDITOR_TYPE);

    public static final GratuitySituationType REGULARIZED = new GratuitySituationType("regularized",
            GratuitySituationType.REGULARIZED_TYPE);
