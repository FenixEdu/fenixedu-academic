...
public class TestType extends FenixUtil
{
    ...
    public List getAllTypes()
    {
        ...
        result.add(new LabelValueBean(EVALUATION_STRING,
                new Integer(EVALUATION).toString()));
        result.add(new LabelValueBean(STUDY_STRING, new Integer(STUDY)
                .toString()));
        return result;
    }
    ...
    {
        if (typeName.equals(EVALUATION_STRING)) return new Integer(EVALUATION);
        else if (typeName.equals(STUDY_STRING)) return new Integer(STUDY);
        return null;
    }

    public String getTypeString()
    {
        if (type.intValue() == EVALUATION) return new String(EVALUATION_STRING);
        else if (type.intValue() == STUDY) return new String(STUDY_STRING);
        return null;
    }
