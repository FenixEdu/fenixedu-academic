...
public class Season extends FenixUtil {
    ...
    public Season(String season) {
		if (season.equals(Season.SEASON1_STRING)) this.season = new Integer(Season.SEASON1);
		if (season.equals(Season.SEASON2_STRING)) this.season = new Integer(Season.SEASON2);
		if (season.equals(Season.SPECIAL_SEASON_STRING)) this.season = new Integer(Season.SPECIAL_SEASON);
    }
    ...
    public String toString() {
		if (season.intValue()== Season.SEASON1) return Season.SEASON1_STRING;
	    if (season.intValue()== Season.SEASON2) return Season.SEASON2_STRING;
		if (season.intValue()== Season.SPECIAL_SEASON) return Season.SPECIAL_SEASON_STRING;
