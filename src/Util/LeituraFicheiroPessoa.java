...
public class LeituraFicheiroPessoa {
      ...
      if((linhaFicheiro != null) && (linhaFicheiro.length()>10)){
        ...
        try {
            ...
            try {
                ...
                System.out.println("LeituraFicheiroPessoa.lerFicheiro:Erro a escrever ficheiro de erros " + 
                    exception2.toString());
            }
        }
  ...
  private static Date formataData(String naoFormatada){
      ...
      if (todaData.intValue() == 0){
          resultado = new Date(0, 0, 1);
          System.out.println("Data inválida: " + resultado.toString());
          return resultado;
      }
  ...
  private static Integer formataSexo(String naoFormatado){
      ...
      if (naoFormatado.equals("feminino")) resultado = new Integer(9);
      if (naoFormatado.equals("masculino")) resultado = new Integer(8);
  ...
  private static Integer formataEstadoCivil(String naoFormatado){
      ...
      if (naoFormatado.equals("casado")) resultado = new Integer(11);
      if (naoFormatado.equals("solteiro")) resultado = new Integer(10);
      if (naoFormatado.equals("divorciado")) resultado = new Integer(12);
      if (naoFormatado.equals("viuvo")) resultado = new Integer(13);
      if (naoFormatado.equals("separado")) resultado = new Integer(14);
      if (naoFormatado.equals("uniao de facto")) resultado = new Integer(15);
      if (naoFormatado.equals("desconhecido")) resultado = new Integer(16);

      System.out.println("Estado Civil nao formatado: " + naoFormatado + " formatado: " + 
        resultado);
      return resultado;
  ...
  private static Integer formataTipoDocumentoIdentificacao(String naoFormatado){
      ...
      //trocar estes valores por constantes
      if (naoFormatado.equals("00")) resultado = new Integer(7);
      if (naoFormatado.equals("01")) resultado = new Integer(1);
      if (naoFormatado.equals("02")) resultado = new Integer(2);
      if (naoFormatado.equals("03")) resultado = new Integer(5);
      if (naoFormatado.equals("04")) resultado = new Integer(3);
      if (naoFormatado.equals("05")) resultado = new Integer(4);
      if (naoFormatado.equals("06")) resultado = new Integer(6);
      
      System.out.println("tipo documento nao formatado: " + naoFormatado + " formatado: " + 
        resultado);
  ...
  private static Integer formataNacionalidadeCompleta(String naoFormatada){
      ...
      System.out.println("pais nao formatado: " + naoFormatada + " chavePais: " + chavePais + 
        " codigoInterno " + resultado);
