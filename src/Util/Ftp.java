...
public class Ftp {
	...
	public static void enviarFicheiro(String nomeFicheiroConfig, String nomeFicheiro, String caminho) throws IOException{
	...
	public static void enviarFicheiros(String nomeFicheiroConfig, List files, String caminho) throws IOException{
		carregaPropriedades(nomeFicheiroConfig);
		...
		try {
			...
			while (iter.hasNext())
            {
                ...
                InputStream inputStream =
                    new FileInputStream(
                        System.getProperty("java.io.tmpdir") + File.separator + file.getName());
