...
public class ReimbursementGuideState {
	...
	public static final ReimbursementGuideState APPROVED_TYPE =
		new ReimbursementGuideState(APPROVED);
	public static final ReimbursementGuideState PAYED_TYPE = new ReimbursementGuideState(PAYED);
	public static final ReimbursementGuideState ANNULLED_TYPE =
		new ReimbursementGuideState(ANNULLED);

	public static final String ISSUED_STRING = "Emitida";
	public static final String APPROVED_STRING = "Emitida";
