...
public final class RoleType extends ValuedEnum implements Serializable  {
	...
	public static final RoleType DEPARTMENT_CREDITS_MANAGER =
		new RoleType(
			"role.department.credits.manager",
			RoleType.DEPARTMENT_CREDITS_MANAGER_TYPE);
	...
	public static final RoleType DEPARTMENT_MEMBER = new RoleType("role.department.member", RoleType.DEPARTMENT_MEMBER_TYPE);
