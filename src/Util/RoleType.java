...
public final class RoleType extends ValuedEnum {
	...
	public static final RoleType PERSON =
		new RoleType("person", RoleType.PERSON_TYPE);
	public static final RoleType STUDENT =
		new RoleType("student", RoleType.STUDENT_TYPE);
	public static final RoleType TEACHER =
		new RoleType("teacher", RoleType.TEACHER_TYPE);
	...
	public static final RoleType TREASURY =
		new RoleType("treasury", RoleType.TREASURY_TYPE);
	public static final RoleType COORDINATOR =
		new RoleType("coordinator", RoleType.COORDINATOR_TYPE);
	public static final RoleType EMPLOYEE =
		new RoleType("employee", RoleType.EMPLOYEE_TYPE);
	public static final RoleType MANAGEMENT_ASSIDUOUSNESS =
		new RoleType(
			"managementAssiduousness",
			RoleType.MANAGEMENT_ASSIDUOUSNESS_TYPE);
	public static final RoleType MANAGER =
		new RoleType("manager", RoleType.MANAGER_TYPE);
	public static final RoleType DEGREE_ADMINISTRATIVE_OFFICE =
		new RoleType(
			"degreeAdministrativeOffice",
			RoleType.DEGREE_ADMINISTRATIVE_OFFICE_TYPE);
	public static final RoleType CREDITS_MANAGER =
		new RoleType("creditsManager", RoleType.CREDITS_MANAGER_TYPE);
	public static final RoleType CREDITS_MANAGER_DEPARTMENT =
		new RoleType(
			"creditsManagerDepartment",
			RoleType.CREDITS_MANAGER_DEPARTMENT_TYPE);
	...
	public static final RoleType ERASUMS =
		new RoleType("erasmus", RoleType.ERASMUS_TYPE);
	...
	public static final RoleType ADMINISTRATOR =
		new RoleType("admin", RoleType.ADMINISTRATOR_TYPE);
	public static final RoleType OPERATOR =
		new RoleType("operator", RoleType.OPERATOR_TYPE);
	public static final RoleType SEMINARIES_COORDINATOR =
		new RoleType(
			"seminariesCoordinator",
