...
public class EstadoCivil implements Serializable {
    ...
    public ArrayList toArrayList()
    {
        ...
        result.add(
            new LabelValueBean(EstadoCivil.UNIAO_DE_FACTO_STRING, EstadoCivil.UNIAO_DE_FACTO_STRING));
    ...
    public static ArrayList toIntegerArrayList()
    {
        ...
        result.add(new LabelValueBean(EstadoCivil.DEFAULT, null));
        result.add(
            new LabelValueBean(EstadoCivil.SOLTEIRO_STRING, String.valueOf(EstadoCivil.SOLTEIRO)));
        result.add(new LabelValueBean(EstadoCivil.CASADO_STRING, String.valueOf(EstadoCivil.CASADO)));
        result.add(
            new LabelValueBean(EstadoCivil.DIVORCIADO_STRING, String.valueOf(EstadoCivil.DIVORCIADO)));
        result.add(new LabelValueBean(EstadoCivil.VIUVO_STRING, String.valueOf(EstadoCivil.VIUVO)));
        result.add(
            new LabelValueBean(EstadoCivil.SEPARADO_STRING, String.valueOf(EstadoCivil.SEPARADO)));
        result.add(
            new LabelValueBean(
                EstadoCivil.UNIAO_DE_FACTO_STRING,
                String.valueOf(EstadoCivil.UNIAO_DE_FACTO)));
        result.add(
            new LabelValueBean(
                EstadoCivil.DESCONHECIDO_STRING,
                String.valueOf(EstadoCivil.DESCONHECIDO)));
        return result;
    }
