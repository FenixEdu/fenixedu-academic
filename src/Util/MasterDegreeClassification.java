...
public final class MasterDegreeClassification extends FenixValuedEnum {
    ...
    public static final MasterDegreeClassification APPROVED = new MasterDegreeClassification("approved",
            MasterDegreeClassification.APPROVED_TYPE);

    public static final MasterDegreeClassification NOT_APPROVED = new MasterDegreeClassification(
            "not.approved", MasterDegreeClassification.NOT_APPROVED_TYPE);

    public static final MasterDegreeClassification UNDEFINED = new MasterDegreeClassification(
            "undefined", MasterDegreeClassification.UNDEFINED_TYPE);
    ...
    public static List toArrayList() {
        ...
        //result.add(new
        // LabelValueBean(MasterDegreeClassification.DEFAULT_STRING,
        // MasterDegreeClassification.DEFAULT_STRING));
        result.add(new LabelValueBean(MasterDegreeClassification.APPROVED_STRING, String
                .valueOf(MasterDegreeClassification.APPROVED_TYPE)));
        result.add(new LabelValueBean(MasterDegreeClassification.NOT_APPROVED_STRING, String
                .valueOf(MasterDegreeClassification.NOT_APPROVED_TYPE)));
        result.add(new LabelValueBean(MasterDegreeClassification.UNDEFINED_STRING, String
                .valueOf(MasterDegreeClassification.UNDEFINED_TYPE)));
