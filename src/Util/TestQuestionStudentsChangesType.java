...
public class TestQuestionStudentsChangesType extends FenixUtil
{
    ...
    {
        if (typeName.equals(THIS_STUDENT_STRING)) return new Integer(
                THIS_STUDENT);
        else if (typeName.equals(STUDENTS_FROM_TEST_STRING)) return new Integer(
                STUDENTS_FROM_TEST);
    ...
    {
        if (type.intValue() == THIS_STUDENT) return new String(
                THIS_STUDENT_STRING);
        else if (type.intValue() == STUDENTS_FROM_TEST) return new String(
                STUDENTS_FROM_TEST_STRING);
