 ...
 *
 */
public class TestQuestionStudentsChangesType {
	...
	public static final String STUDENTS_FROM_TEST_STRING =
	...
	public List getAllTypes() {
		...
		result.add(
			new LabelValueBean(
				THIS_STUDENT_STRING,
				new Integer(THIS_STUDENT).toString()));
		result.add(
			new LabelValueBean(
				STUDENTS_FROM_TEST_STRING,
				new Integer(STUDENTS_FROM_TEST).toString()));
		result.add(
			new LabelValueBean(
				ALL_STUDENTS_STRING,
				new Integer(ALL_STUDENTS).toString()));
		return result;
	}
