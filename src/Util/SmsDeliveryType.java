...
public class SmsDeliveryType extends FenixValuedEnum
{
	...
	public static final SmsDeliveryType NOT_SENT =
		new SmsDeliveryType("notSent", SmsDeliveryType.NOT_SENT_TYPE);
	public static final SmsDeliveryType DELIVERY_SUCCESS =
		new SmsDeliveryType("deliverySuccess", SmsDeliveryType.DELIVERY_SUCCESS_TYPE);
	public static final SmsDeliveryType DELIVERY_FAILURE =
		new SmsDeliveryType("deliveryFailure", SmsDeliveryType.DELIVERY_FAILURE_TYPE);
	public static final SmsDeliveryType MESSAGE_BUFFERED =
		new SmsDeliveryType("messageBuffered", SmsDeliveryType.MESSAGE_BUFFERED_TYPE);
	public static final SmsDeliveryType SMSC_SUBMIT =
		new SmsDeliveryType("smscSubmit", SmsDeliveryType.SMSC_SUBMIT_TYPE);
	public static final SmsDeliveryType SMSC_REJECT =
		new SmsDeliveryType("smscReject", SmsDeliveryType.SMSC_REJECT_TYPE);
