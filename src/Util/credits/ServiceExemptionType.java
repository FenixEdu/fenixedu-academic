...
public class ServiceExemptionType extends ValuedEnum
{
    ...
    public static final ServiceExemptionType TEACHING_EXEMPTION =
        new ServiceExemptionType("service-exemption-type.teacher-exemption", TEACHING_EXEMPTION_TYPE);
    public static final ServiceExemptionType GRANT_OWNER_EQUIVALENCE =
        new ServiceExemptionType(
            "service-exemption-type.grant-owner-equivalence",
            GRANT_OWNER_EQUIVALENCE_TYPE);
    public static final ServiceExemptionType SABBATICAL =
        new ServiceExemptionType("service-exemption-type.sabbatical", SABBATICAL_TYPE);
