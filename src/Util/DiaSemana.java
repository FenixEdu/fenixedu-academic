...
public class DiaSemana {
    ...
    public String toString() {
    	...
    	switch (diaSemana) {
    		...
    		case SEGUNDA_FEIRA : return "2a feira";
    		case TERCA_FEIRA : return "3a feira";
    		case QUARTA_FEIRA : return "4a feira";
    		case QUINTA_FEIRA : return "5a feira";
    		case SEXTA_FEIRA : return "6a feira";
