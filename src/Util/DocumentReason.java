...
public class DocumentReason {
	...
	public static final int BOLSA = 6;
	...
	public static final DocumentReason BOLSA_TYPE = new DocumentReason(BOLSA);
	...
	public static final String BOLSA_STRING = "Bolsa";
...
//	public static final String DEFAULT_STRING = "[Escolha uma Opção]";
	...
	public DocumentReason(String type) {
		...
		if (type.equals(DocumentReason.BOLSA_STRING)) this.type = new Integer(DocumentReason.BOLSA);
...
//		result.add(new LabelValueBean(DocumentReason.PUBLIC_CONCURSO_STRING, DocumentReason.PUBLIC_CONCURSO_STRING));
		...
		result.add(DocumentReason.BOLSA_STRING);
	...
	public String toString() {
		...
		if (type.intValue()== DocumentReason.BOLSA) return DocumentReason.BOLSA_STRING;
