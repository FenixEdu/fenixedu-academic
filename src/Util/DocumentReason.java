...
public class DocumentReason extends FenixUtil {
    ...
    public DocumentReason(String type) {
        if (type.equals(DocumentReason.FAMILY_ALLOWANCE_STRING))
            this.type = new Integer(DocumentReason.FAMILY_ALLOWANCE);
        if (type.equals(DocumentReason.MILITARY_PURPOSE_STRING))
            this.type = new Integer(DocumentReason.MILITARY_PURPOSE);
        if (type.equals(DocumentReason.BLOOD_PRICE_PENSION_STRING))
            this.type = new Integer(DocumentReason.BLOOD_PRICE_PENSION);
        if (type.equals(DocumentReason.IRS_STRING))
            this.type = new Integer(DocumentReason.IRS);
        if (type.equals(DocumentReason.ADSE_STRING))
            this.type = new Integer(DocumentReason.ADSE);
        if (type.equals(DocumentReason.SCHOLARSHIP_STRING))
            this.type = new Integer(DocumentReason.SCHOLARSHIP);
        if (type.equals(DocumentReason.PUBLIC_CONTEST_STRING))
            this.type = new Integer(DocumentReason.PUBLIC_CONTEST);
    ...
    public static List toArrayList() {
        ...
        //		result.add(new LabelValueBean(DocumentReason.FAMILY_ABONMENT_STRING,
        // DocumentReason.FAMILY_ABONMENT_STRING));
        //		result.add(new LabelValueBean(DocumentReason.MILITARY_FINALY_STRING,
        // DocumentReason.MILITARY_FINALY_STRING));
        //		result.add(new
        // LabelValueBean(DocumentReason.PENSAO_PRECO_SANGUE_STRING,
        // DocumentReason.PENSAO_PRECO_SANGUE_STRING));
        //		result.add(new LabelValueBean(DocumentReason.IRS_STRING,
        // DocumentReason.IRS_STRING));
        //		result.add(new LabelValueBean(DocumentReason.ADSE_STRING,
        // DocumentReason.ADSE_STRING));
        //		result.add(new LabelValueBean(DocumentReason.BOLSA_STRING,
        // DocumentReason.BOLSA_STRING));
        //		result.add(new LabelValueBean(DocumentReason.PUBLIC_CONCURSO_STRING,
        // DocumentReason.PUBLIC_CONCURSO_STRING));
    ...
    public String toString() {
        if (type.intValue() == DocumentReason.FAMILY_ALLOWANCE)
            return DocumentReason.FAMILY_ALLOWANCE_STRING;
        if (type.intValue() == DocumentReason.MILITARY_PURPOSE)
            return DocumentReason.MILITARY_PURPOSE_STRING;
        if (type.intValue() == DocumentReason.BLOOD_PRICE_PENSION)
            return DocumentReason.BLOOD_PRICE_PENSION_STRING;
        if (type.intValue() == DocumentReason.IRS)
            return DocumentReason.IRS_STRING;
        if (type.intValue() == DocumentReason.ADSE)
            return DocumentReason.ADSE_STRING;
        if (type.intValue() == DocumentReason.SCHOLARSHIP)
            return DocumentReason.SCHOLARSHIP_STRING;
        if (type.intValue() == DocumentReason.PUBLIC_CONTEST)
            return DocumentReason.PUBLIC_CONTEST_STRING;
