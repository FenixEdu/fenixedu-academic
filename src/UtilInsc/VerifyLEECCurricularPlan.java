...
public class VerifyLEECCurricularPlan
{
	...
	private static void printItForThisArea(IBranch branch, AreaType areaType) throws ExcepcaoPersistencia
	{
		...
		while (iterator1.hasNext())
		{
			...
			while (iterator2.hasNext())
			{
				...
				List curricularCourses = getCurricularCoursesByScientificAreaInGroup(curricularCourseGroup, scientificArea);
	 ...
	 * @return curricular courses list from the group and belonging to that scientific area.
	 */
	 ...
	 * @throws ExcepcaoPersistencia
	 */
	private static void printItForThisAreaWithScopes(IBranch branch, AreaType areaType) throws ExcepcaoPersistencia
	{
		ISuportePersistente persistentSuport = SuportePersistenteOJB.getInstance();
		IPersistentCurricularCourseGroup curricularCourseGroupDAO = persistentSuport.getIPersistentCurricularCourseGroup();
		...
		while (iterator1.hasNext())
		{
			...
			while (iterator2.hasNext())
			{
				...
				List curricularCourses = getCurricularCourseScopesByScientificAreaInGroup(curricularCourseGroup, scientificArea);
