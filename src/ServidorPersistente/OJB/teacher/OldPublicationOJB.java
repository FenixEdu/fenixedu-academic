 ...
 *
 */
public class OldPublicationOJB extends ObjectFenixOJB implements IPersistentOldPublication
{
     ...
     */
    public List readAllByTeacherAndOldPublicationType(ITeacher teacher, OldPublicationType oldPublicationType) throws ExcepcaoPersistencia
    {
