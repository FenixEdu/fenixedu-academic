...
public class SummaryOJB extends ObjectFenixOJB implements IPersistentSummary {
	 ...
	 */
	public List readByExecutionCourseShifts(IExecutionCourse executionCourse) throws ExcepcaoPersistencia
	{
		Criteria criteria = new Criteria();
	...
	/* (non-Javadoc)
	 * @see ServidorPersistente.IPersistentSummary#readByExecutionCourseShiftsAndTypeLesson(Dominio.IExecutionCourse, Util.TipoAula)
	 * TODO: This method will replace the method readByExecutionCourseAndType
	 */
	public List readByExecutionCourseShiftsAndTypeLesson(IExecutionCourse executionCourse, TipoAula summaryType) throws ExcepcaoPersistencia
	{
		Criteria criteria = new Criteria();
		criteria.addEqualTo("shift.disciplinaExecucao.idInternal", executionCourse.getIdInternal());
	 ...
	 */
	public List readByTeacher(IExecutionCourse executionCourse, ITeacher teacher) throws ExcepcaoPersistencia
	{		
		Criteria criteria = new Criteria();
		criteria.addEqualTo("shift.disciplinaExecucao.idInternal", executionCourse.getIdInternal());		
    ...
    /* (non-Javadoc)
     * @see ServidorPersistente.IPersistentSummary#readSummaryByUnique(Dominio.ITurno, java.util.Calendar, java.util.Calendar)
     */
