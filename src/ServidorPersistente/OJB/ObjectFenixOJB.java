...
public abstract class ObjectFenixOJB implements IPersistentObject {
	...
	protected List queryList(Class classToQuery, Criteria criteria,
			...
			throws ExcepcaoPersistencia {
		return queryList(classToQuery, criteria, false, orderByString,
				reverseOrder);
	}
	...
	protected List queryList(Class classToQuery, Criteria criteria,
			boolean distinct, String orderByString, boolean reverseOrder)
			throws ExcepcaoPersistencia {

		QueryByCriteria queryCriteria = new QueryByCriteria(classToQuery,
				criteria, distinct);
	...
	protected Object queryObject(Class classToQuery, Criteria criteria)
		...
		if (object instanceof MasterDegreeCandidate
	 ...
	 * @author Pica&Barbosa
	 * @param classToQuery
	 * @param criteria, orderBy, reverseOrder
	 * @return
	 * @throws ExcepcaoPersistencia
	 */
	protected Object queryObject(Class classToQuery, Criteria criteria, String orderBy, boolean reverseOrder)
			throws ExcepcaoPersistencia {
		PersistenceBroker pb = getCurrentPersistenceBroker();
		Query query = getQuery(classToQuery, criteria);
	...
	public IDomainObject readByOID(Class classToQuery, Integer oid,
			boolean lockWrite) throws ExcepcaoPersistencia {
		Criteria criteria = new Criteria();
		criteria.addEqualTo("idInternal", oid);
		IDomainObject domainObject = (IDomainObject) queryObject(classToQuery,
				criteria);
		if (lockWrite) {
			tx.lock(domainObject, Transaction.WRITE);
		}
	...
	public List readSpan(Class classToQuery, Criteria criteria,
		...
		if (numberOfElementsInSpan == null
				|| numberOfElementsInSpan.intValue() == 0) {
	 ...
	 */
	protected Iterator readIteratorByCriteria(Class classToQuery,
			Criteria criteria, String orderByString, boolean reverseOrder) {
