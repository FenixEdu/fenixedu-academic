...
public class WebSiteItemOJB extends ObjectFenixOJB implements IPersistentWebSiteItem {
	...
	public IWebSiteItem readByWebSiteSectionAndName(IWebSiteSection webSiteSection, String title) throws ExcepcaoPersistencia {
	...
	public void lockWrite(IWebSiteItem item) throws ExcepcaoPersistencia {
		...
		else if ((item instanceof WebSiteItem) && itemFromDB.getIdInternal().equals(item.getIdInternal())) {
