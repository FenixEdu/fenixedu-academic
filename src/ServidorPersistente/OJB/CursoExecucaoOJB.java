...
public class CursoExecucaoOJB extends ObjectFenixOJB implements ICursoExecucaoPersistente
{
    ...
    public void lockWrite( ICursoExecucao cursoExecucaoToWrite ) throws ExcepcaoPersistencia,
                    ExistingPersistentException
    {
        ...
        if (cursoExecucaoToWrite == null) return;

        // Read cursoExecucao from database.
        cursoExecucaoFromDB = this.readByDegreeCurricularPlanAndExecutionYear(cursoExecucaoToWrite
                        .getCurricularPlan(), cursoExecucaoToWrite.getExecutionYear());

        // If cursoExecucao is not in database, then write it.
        if (cursoExecucaoFromDB == null) super.lockWrite(cursoExecucaoToWrite);
        // else If the cursoExecucao is mapped to the database, then write any
        // existing changes.
        else if ((cursoExecucaoToWrite instanceof CursoExecucao)
    ...
    public ICursoExecucao readByDegreeCodeAndExecutionYear( String degreeCode,
    ...
    public List readByTeacher( ITeacher teacher ) throws ExcepcaoPersistencia
    {
        ...
        Criteria criteria = new Criteria();
        criteria.addEqualTo("coordinatorList.teacher.teacherNumber", teacher.getTeacherNumber());
    ...
    public ICursoExecucao readByDegreeNameAndExecutionYearAndDegreeType( String name,
