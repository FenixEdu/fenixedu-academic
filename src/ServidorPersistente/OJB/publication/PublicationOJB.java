 ...
 *
 */
public class PublicationOJB extends ObjectFenixOJB implements IPersistentPublication
{
     ...
     */
    public List readAllByPersonAndPublicationType(IPessoa pessoa, Integer publicationType) throws ExcepcaoPersistencia
    {
