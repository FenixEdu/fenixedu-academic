...
public interface IPersistentBranch extends IPersistentObject
{
	...
	public List readAllByCurricularCourse(ICurricularCourse curricularCourse) throws ExcepcaoPersistencia;
	public List readAllByDegreeCurricularPlanAndBranchType(IDegreeCurricularPlan degreeCurricularPlan, BranchType branchType) throws ExcepcaoPersistencia;
}