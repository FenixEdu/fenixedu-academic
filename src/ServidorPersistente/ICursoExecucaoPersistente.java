...
public interface ICursoExecucaoPersistente extends IPersistentObject {
	 ...
	 */
	public List readByExecutionYearAndDegreeCurricularPlans(IExecutionYear executionYear, Collection degreeCurricularPlans)
		throws ExcepcaoPersistencia;
	 ...
	 * @return ICursoExecucao This method assumes thar there's only one Execution Degree for each Degree Curricular Plan. This is the
