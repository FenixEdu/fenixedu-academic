...
public abstract class Constants {
	...
	public static String[] siglasLicenciaturas =
		{
			"LEC",
			"LEMIN",
			"LEM",
	...
	static {
		...
		filePathPredicateForMigrationLessonHashMap.put(
			"c:\\middleware\\aulasEmSalasVazias.txt",
		...
		filePathPredicateForMigrationLessonHashMap.put(
			"c:\\middleware\\AulasComMaisDe4Horas.txt",
		...
		filePathPredicateForMigrationLessonHashMap.put(
			"c:\\middleware\\aulasComMaisDeUmTipoAula.txt",
			new PredicateLessonWithManyLessonType());
		filePathPredicateForMigrationLessonHashMap.put(
			"c:\\middleware\\aulasComMaisDeUmCurso.txt",
			new PredicateLessonWithManyDegrees());
		filePathPredicateForMigrationLessonHashMap.put(
			"c:\\middleware\\aulasComMaisDeUmaDisciplina.txt",
			new PredicateLessonWithManyCourses());
		filePathPredicateForMigrationLessonHashMap.put(
