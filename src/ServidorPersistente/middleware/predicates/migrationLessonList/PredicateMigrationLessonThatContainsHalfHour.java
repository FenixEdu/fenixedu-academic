 ...
 * @author jpvl
 */
public class PredicateMigrationLessonThatContainsHalfHour
	...
	public boolean evaluateMigrationLesson(MigrationLesson lesson) {
		return (
				(halfHour.getDia() == lesson.getDay())
				&& ((halfHour.getHora() >= lesson.getStartIndex())
						&& (halfHour.getHora() <= lesson.getEndIndex()))
					&& (lesson
						.getRoom()
						.equals(
