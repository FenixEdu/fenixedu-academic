 ...
 * @author jpvl
 */
public class PredicateLessonWithManyDegreesOrManyCourses
	...
	public boolean evaluateMigrationLesson(MigrationLesson lesson) {
		List degreeList =
			ClassUtils.extractDegreeCodeList(lesson.getClassList());
		return lesson.getCourseInitialsList().size() > 1
			|| degreeList.size() > 1;
