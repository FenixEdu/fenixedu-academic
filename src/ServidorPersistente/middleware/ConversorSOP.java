            ...
            while (degreeToSopCourseIterator.hasNext())
            {
                ...
                while (pairListIterator.hasNext())
                {
                    ...
                    try
                    {
                        ...
                        if (migrationExecutionCourse.getName().equalsIgnoreCase("Física I")
                        ...
                        if (migrationExecutionCourse.getName().equalsIgnoreCase("Química dos Alimentos")
                        ...
                        if (migrationExecutionCourse.getName().equalsIgnoreCase(
                                        "Monitorização e Controlo de Bio Processos")
        ...
        while (iter.hasNext())
        {
            ...
            if (room == null)
            {
                try
                {
                    ...
                    room = new Sala(sigla, "Localização Indefinida", new Integer(0), new TipoSala(
