...
public class MigrationLesson {
	...
	private boolean belongTo(SOPAulas halfHour) {
		if ((day != halfHour.getDia())
			|| (!room
				.equals(halfHour.getSala() == null ? "" : halfHour.getSala()))
			|| (endIndex < halfHour.getHora())
			|| (startIndex > halfHour.getHora())
			) {
			return false;
		}
		return true;
	...
	public boolean isNextTo(SOPAulas halfHour) {
		if ((day != halfHour.getDia())
			|| (!room
				.equals(halfHour.getSala() == null ? "" : halfHour.getSala()))
			|| (shiftNumber != halfHour.getNumeroTurno())
			|| (endIndex + 1 != halfHour.getHora())
	...
	public String toString() {
		...
		stringBuffer
			.append("[MigrationLesson=")
			.append("startIndex=")
			.append(this.startIndex)
			.append(",endIndex=")
			.append(this.endIndex)
			.append(",tipoAula=")
			.append(this.lessonType)
			.append(",room=")
			.append(this.room)
			.append(",numeroTurno=")
			.append(this.shiftNumber)
			.append(",dia=")
		...
		stringBuffer
			.append("\t Disciplinas(")
			.append("size=")
			.append(courseInitialsList.size())
			.append(")")
			.append(":\r\n");
