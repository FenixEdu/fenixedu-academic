...
public class JavaMasterDegreeClassification2SQLMasterDegreeClassificationFieldConversion implements FieldConversion {
   ...
   /*
    ...
    public Object sqlToJava(Object source)
    {
		...
		if (source instanceof Integer) {
			...
			masterDegreeClassification = MasterDegreeClassification.getEnum(masterDegreeClassificationID.intValue());		
			
			if (masterDegreeClassification == null) {
				throw new IllegalArgumentException(this.getClass().getName() + ": Illegal MasterDegreeClassification!(" + source + ")");
			}
		} else {
