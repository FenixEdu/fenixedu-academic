...
public class ShiftAndLessonKeys extends InfoObject {
    ...
    public ShiftAndLessonKeys(String nomeTurno, DiaSemana diaSemana, Calendar inicio, Calendar fim,
            RoomKey keySala) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ShiftAndLessonKeys) {
            ...
            resultado = (getNomeTurno().equals(keysTurnoAndAula.getNomeTurno()))
                    ...
                    && (getInicio().get(Calendar.HOUR_OF_DAY) == keysTurnoAndAula.getInicio().get(
                            Calendar.HOUR_OF_DAY))
                    && (getInicio().get(Calendar.MINUTE) == keysTurnoAndAula.getInicio().get(
                            Calendar.MINUTE))
                    && (getInicio().get(Calendar.SECOND) == keysTurnoAndAula.getInicio().get(
                            Calendar.SECOND))
                    && (getFim().get(Calendar.HOUR_OF_DAY) == keysTurnoAndAula.getFim().get(
                            Calendar.HOUR_OF_DAY))
