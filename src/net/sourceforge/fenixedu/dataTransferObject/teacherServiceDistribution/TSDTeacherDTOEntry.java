...
public class TSDTeacherDTOEntry extends DataTranferObject {
		...
		for(TSDTeacher tsdTeacher : tsdTeacherList) {
			for (TSDCourse course : tsdTeacher.getAssociatedTSDCourses()) {
				if(executionPeriodList.contains(course.getExecutionPeriod()))
					tsdProfessorshipDTOEntryList.add(new TSDProfessorshipDTOEntry(tsdTeacher.getTSDProfessorShipsByCourse(course), executionPeriodList));
			}
		}
    ...
    public Double getTotalTheoreticalHoursLectured() {
    	...
    	for(TSDTeacher tsdTeacher : tsdTeacherList) {
    		totalTheoreticalHoursLectured += tsdTeacher.getTotalTheoreticalHoursLectured(executionPeriodList);
    	}
    ...
    public Double getTotalPraticalHoursLectured() {
    	...
    	for(TSDTeacher tsdTeacher : tsdTeacherList) {
    		totalPraticalHoursLectured += tsdTeacher.getTotalPraticalHoursLectured(executionPeriodList);
    	}
    ...
    public Double getTotalTheoPratHoursLectured() {
    	...
    	for(TSDTeacher tsdTeacher : tsdTeacherList) {
    		totalTheoPratHoursLectured += tsdTeacher.getTotalTheoPratHoursLectured(executionPeriodList);
    	}
    ...
    public Double getTotalLaboratorialHoursLectured() {
    	...
    	for(TSDTeacher tsdTeacher : tsdTeacherList) {
    		totalLaboratorialHoursLectured += tsdTeacher.getTotalLaboratorialHoursLectured(executionPeriodList);
    	}
