...
public class PhotographFilterBean implements Serializable {
	 ...
	 */
	if (getStartDate() != null && getStartDate().isAfter(photograph.getStateChange().toDateMidnight().toLocalDate()) && (getEndDate() == null ? false : getStartDate().isAfter(getEndDate())))
	    return true;
	if (getEndDate() != null && getEndDate().isBefore(photograph.getStateChange().toDateMidnight().toLocalDate()) && (getStartDate() == null ? false : getEndDate().isBefore(getStartDate())))
	    return true;
	return false;
    }
