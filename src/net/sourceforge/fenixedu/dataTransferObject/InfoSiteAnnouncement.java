...
public class InfoSiteAnnouncement extends DataTranferObject implements ISiteComponent {
    ...
    public boolean equals(Object obj) {
        ...
        if (((InfoSiteAnnouncement) obj).getAnnouncements() == null
                ...
                || ((InfoSiteAnnouncement) obj).getAnnouncements().size() != this.getAnnouncements()
                        .size()) {
            return false;
        }
        //		if (((InfoSiteAnnouncement)
        // obj).getAnnouncements().containsAll(this.getAnnouncements())
        //			&& this.getAnnouncements().containsAll(((InfoSiteAnnouncement)
        // obj).getAnnouncements())){
        //				result = true;
        //			}
