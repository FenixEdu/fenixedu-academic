        ...
        if (partyClassification.equals(PartyClassification.TEACHER)) {
            if (getPerson().getTeacher() != null) {
                PersonContractSituation currentOrLastTeacherContractSituation =
                        getPerson().getTeacher().getCurrentOrLastTeacherContractSituation();
            ...
            PersonContractSituation currentEmployeeContractSituation =
                    getPerson().hasEmployee() ? getPerson().getEmployee().getCurrentEmployeeContractSituation() : null;
            ...
            if (student != null) {
                Registration registration =
                        student.getLastRegistrationForDegreeType(DegreeType.valueOf(partyClassification.name()));
