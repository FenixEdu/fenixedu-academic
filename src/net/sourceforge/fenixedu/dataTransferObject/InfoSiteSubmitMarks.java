...
public class InfoSiteSubmitMarks extends DataTranferObject implements ISiteComponent {
	...
	if (((InfoSiteMarks) objectToCompare).getMarksList() == null && this.getSubmited() == null && result == true) {
	    return true;
	}
	...
	/*
	 * ListIterator iter1 = ((InfoSiteMarks)
	 * objectToCompare).getMarksList().listIterator(); ListIterator iter2 =
	 * this.getMarksList().listIterator(); while (result && iter1.hasNext())
	 * { InfoMark infoMark1 = (InfoMark) iter1.next(); InfoMark infoMark2 =
	 * (InfoMark) iter2.next(); if (!infoMark1.equals(infoMark2)) { result =
	 * false; } }
	 */
