 ...
 * 
 */
public class InfoOldInquiriesTeachersRes extends InfoObject implements Comparable {
    ...
    /**
     * @param totalNumberAnswers
     *            The totalNumberAnswers to set.
     */
    public void setTotalNumberAnswers(Integer totalNumberAnswers) {
	this.totalNumberAnswers = totalNumberAnswers;
    }

    public void copyFromDomain(OldInquiriesTeachersRes oldInquiresTeachersRes) throws IllegalAccessException,
    ...
    public static InfoOldInquiriesTeachersRes newInfoFromDomain(OldInquiriesTeachersRes oldInquiriesTeachersRes)
	...
	if (arg0 instanceof InfoOldInquiriesTeachersRes) {
	    ...
	    // result = this.getCurricularYear().intValue() -
	    // iois.getCurricularYear().intValue();
	    // if(result == 0) {
	    // result =
	    // this.getGepCourseName().compareTo(iois.getGepCourseName());
	    // }
	}
	return result;
