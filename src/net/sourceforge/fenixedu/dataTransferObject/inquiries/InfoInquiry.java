...
public class InfoInquiry extends InfoObject implements Comparable {
    ...
    /**
     * @param inquiriesRoomsList
     *            The inquiriesRoomsList to set.
     */
    ...
    /**
     * @param inquiriesTeachersList
     *            The inquiriesTeachersList to set.
     */
    public void setInquiriesTeachersList(List<InfoInquiriesTeacher> inquiriesTeachersList) {
