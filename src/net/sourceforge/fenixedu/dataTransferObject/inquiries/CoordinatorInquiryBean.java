...
public class CoordinatorInquiryBean implements Serializable {
	...
	initCoordinatorInquiryBlocks(coordinatorInquiryTemplate, coordinator, inquiryCoordinatorAnswer);
    }

    private void initCoordinatorInquiryBlocks(CoordinatorInquiryTemplate coordinatorInquiryTemplate, Coordinator coordinator,
	...
	for (InquiryBlockDTO blockDTO : getCoordinatorInquiryBlocks()) {
		...
		for (InquiryQuestionDTO questionDTO : groupQuestionBean.getInquiryQuestions()) {
			...
			if (questionDTO.getQuestionAnswer() != null) {
				...
				setInquiryCoordinatorAnswer(new InquiryCoordinatorAnswer(getCoordinator(), getExecutionSemester()));
			    }
