...
public class TeachingInquiryDTO implements Serializable {
	...
	this.firstPageSecondBlockFirstPart.addQuestion(new CheckBoxQuestion(
		...
		"label.teachingInquiries.disturbingEventsInClassesReasonIndiscipline.tooltip").setInitialValue(
		inquiry == null ? null : inquiry.getDisturbingEventsInClassesReasonIndiscipline()));
	this.firstPageSecondBlockFirstPart.addQuestion(new CheckBoxQuestion(
		"label.teachingInquiries.disturbingEventsInClassesReasonIntermediateEvaluations").setRequired(false).setToolTip(
		"label.teachingInquiries.disturbingEventsInClassesReasonIntermediateEvaluations.tooltip").setInitialValue(
		inquiry == null ? null : inquiry.getDisturbingEventsInClassesReasonIntermediateEvaluations()));
	...
	this.firstPageThirdBlock.addQuestion(new TextBoxQuestion("label.teachingInquiries.relativePedagogicalInitiatives", true)
		.setRequired(false).setShowRequiredMark(false).setInitialValue(
			inquiry == null ? null : inquiry.getRelativePedagogicalInitiatives()));
	this.firstPageThirdBlock.addQuestion(new TextBoxQuestion("label.teachingInquiries.generalCommentToCUOperation", true)
		.setRequired(false).setShowRequiredMark(false).setInitialValue(
			inquiry == null ? null : inquiry.getGeneralCommentToCUOperation()));
	...
	this.secondPageFourthBlock.addQuestion(new TextBoxQuestion("label.teachingInquiries.numberOfExams", false).setInteger(
		true).setToolTip("tooltip.teachingInquiries.numberOfExams").setShowRequiredMark(false).setInitialValue(
		inquiry == null ? null : inquiry.getNumberOfExams()));
	this.secondPageFourthBlock.addQuestion(new TextBoxQuestion("label.teachingInquiries.numberOfTests", false).setInteger(
		true).setToolTip("tooltip.teachingInquiries.numberOfTests").setShowRequiredMark(false).setInitialValue(
		inquiry == null ? null : inquiry.getNumberOfTests()));
	...
	this.secondPageFourthBlockThirdPart.addQuestion(new RadioGroupQuestion("label.teachingInquiries.teachingLanguage", false)
		...
		.addChoice("OTHER", StringUtils.EMPTY).setShowRequiredMark(false).setInitialValue(
			inquiry == null ? null : inquiry.getTeachingLanguage()));
	this.secondPageFourthBlockThirdPart.addQuestion(new TextBoxQuestion("label.teachingInquiries.otherTeachingLanguage",
		false).setRequired(false).setShowRequiredMark(false).setInitialValue(
		inquiry == null ? null : inquiry.getOtherTeachingLanguage()));
	...
	this.secondPageEighthBlock.addQuestion(new TextBoxQuestion("label.teachingInquiries.finalCommentsAndImproovements", true)
		.setRequired(false).setShowRequiredMark(false).setInitialValue(
			inquiry == null ? null : inquiry.getFinalCommentsAndImproovements()));
