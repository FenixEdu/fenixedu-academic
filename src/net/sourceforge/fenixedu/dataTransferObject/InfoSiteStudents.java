...
public class InfoSiteStudents extends DataTranferObject implements ISiteComponent {
    ...
    public boolean equals(Object objectToCompare) {
        ...
        //				&& ((InfoSiteStudents)
        // objectToCompare).getInfoCurricularCourseScope().equals(this.getInfoCurricularCourseScope()))
        //				|| ((InfoSiteStudents)
        // objectToCompare).getInfoCurricularCourseScope() == null
        //				&& this.getInfoCurricularCourseScope() == null))) {
        //			result = true;
        ...
        if (((InfoSiteStudents) objectToCompare).getStudents() == null
                ...
                || ((InfoSiteStudents) objectToCompare).getStudents().size() != this.getStudents()
                        .size()) {
            return false;
        }
