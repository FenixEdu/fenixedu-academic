...
public class EmployeeWorkWeekScheduleBean implements Serializable {
    ...
    public EmployeeWorkWeekScheduleBean(WorkSchedule workSchedule, EmployeeScheduleFactory employeeScheduleFactory) {
    ...
    public EmployeeWorkWeekScheduleBean(Integer weekNumber, EmployeeScheduleFactory employeeScheduleFactory) {
	setEmployeeScheduleFactory(employeeScheduleFactory);
	...
	if (getMondaySchedule() != null || getChooseMonday()) {
	    WorkScheduleType workScheduleType = getChooseMonday() ? getEmployeeScheduleFactory().getChoosenWorkSchedule()
		    : getMondaySchedule();
	...
	if ((getTuesdaySchedule() != null || getChooseTuesday())
		&& !differentWorkScheduleTypes.contains(getChooseTuesday() ? getEmployeeScheduleFactory()
			.getChoosenWorkSchedule() : getTuesdaySchedule())) {
	    WorkScheduleType workScheduleType = getChooseTuesday() ? getEmployeeScheduleFactory().getChoosenWorkSchedule()
		    : getTuesdaySchedule();
	    differentWorkScheduleTypes.add(workScheduleType);
	    WorkWeek workWeek = getWorkWeek(workScheduleType);
	    workSchedules.add(new WorkSchedule(workScheduleType, workWeek, periodicity));
	...
	if ((getWednesdaySchedule() != null || getChooseWednesday())
		&& !differentWorkScheduleTypes.contains(getChooseWednesday() ? getEmployeeScheduleFactory()
			.getChoosenWorkSchedule() : getWednesdaySchedule())) {
	    WorkScheduleType workScheduleType = getChooseWednesday() ? getEmployeeScheduleFactory().getChoosenWorkSchedule()
	...
	if ((getThursdaySchedule() != null || getChooseThursday())
		&& !differentWorkScheduleTypes.contains(getChooseThursday() ? getEmployeeScheduleFactory()
			.getChoosenWorkSchedule() : getThursdaySchedule())) {
	    WorkScheduleType workScheduleType = getChooseThursday() ? getEmployeeScheduleFactory().getChoosenWorkSchedule()
		    : getThursdaySchedule();
	    differentWorkScheduleTypes.add(workScheduleType);
	    WorkWeek workWeek = getWorkWeek(workScheduleType);
	    workSchedules.add(new WorkSchedule(workScheduleType, workWeek, periodicity));
	...
	if ((getFridaySchedule() != null || getChooseFriday())
		&& !differentWorkScheduleTypes.contains(getChooseFriday() ? getEmployeeScheduleFactory().getChoosenWorkSchedule()
			: getFridaySchedule())) {
	    WorkScheduleType workScheduleType = getChooseFriday() ? getEmployeeScheduleFactory().getChoosenWorkSchedule()
		    : getFridaySchedule();
	    differentWorkScheduleTypes.add(workScheduleType);
	    WorkWeek workWeek = getWorkWeek(workScheduleType);
	    workSchedules.add(new WorkSchedule(workScheduleType, workWeek, periodicity));
	...
	if (getTuesdaySchedule() != null && !getChooseTuesday() && !differentWorkScheduleTypes.contains(getTuesdaySchedule())) {
	...
	if (getThursdaySchedule() != null && !getChooseThursday() && !differentWorkScheduleTypes.contains(getThursdaySchedule())) {
	...
	if (getFridaySchedule() != null && !getChooseFriday() && !differentWorkScheduleTypes.contains(getFridaySchedule())) {
	...
	if (getTuesdaySchedule() != null && getTuesdaySchedule() == workScheduleType && !getChooseTuesday()) {
	    weekDays.add(WeekDay.TUESDAY);
	}
	if (getWednesdaySchedule() != null && getWednesdaySchedule() == workScheduleType && !getChooseWednesday()) {
	    weekDays.add(WeekDay.WEDNESDAY);
	}
	if (getThursdaySchedule() != null && getThursdaySchedule() == workScheduleType && !getChooseThursday()) {
	    weekDays.add(WeekDay.THURSDAY);
	}
	...
	if (getMondayMealPeriod().equals("") && getMondayMandatoryMealPeriods().equals("") && getTuesdayMealPeriod().equals("")
	...
	if (workScheduleType.getNormalWorkPeriod().getSecondPeriod() != null) {
	    ...
	    String secondPeriodEnd = fmt.print(workScheduleType.getNormalWorkPeriod().getEndSecondPeriod());
	...
	if (workScheduleType.getFixedWorkPeriod().getSecondPeriod() != null) {
	    ...
	    String secondPeriodEnd = fmt.print(workScheduleType.getFixedWorkPeriod().getEndSecondPeriod());
	    result.append("<br/>").append(secondPeriod).append(" - ").append(secondPeriodEnd);
	}
	return result.toString();
    }
	...
	DateTimeFormatter fmt = DateTimeFormat.forPattern("HH:mm");
	TimeOfDay time = new TimeOfDay(workScheduleType.getMeal().getMinimumMealBreakInterval().getMillis(), chronology);
	String minimum = fmt.print(time);
	time = new TimeOfDay(workScheduleType.getMeal().getMandatoryMealDiscount().getMillis(), chronology);
