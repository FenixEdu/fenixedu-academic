...
public class DistributionTeacherServicesByCourseDTO extends DataTranferObject {
	...
	public class TeacherExecutionCourseServiceDTO {
		...
		public TeacherExecutionCourseServiceDTO(Integer teacherIdInternal, String teacherName, Integer hoursSpentByTeacher, Boolean teacherOfDepartment) {
	...
	public class ExecutionCourseDistributionServiceEntryDTO implements Comparable {
		...
		public ExecutionCourseDistributionServiceEntryDTO(
				Integer executionCourseIdInternal, 
				String executionCourseName,
				String executionCourseCampus, 
				String executionCourseDegreeName,
				Set<String> executionCourseCurricularYearsList, 
				Integer executionCourseSemester,
				Integer executionCourseFirstTimeEnrollementStudentNumber,
				Integer executionCourseSecondTimeEnrollementStudentNumber,
				Double executionCourseTheoreticalHours,
				Double executionCoursePraticalHours,
				Double executionCourseLaboratorialHours,
				Double executionCourseTheoPratHours,
				Double executionCourseStudentsNumberByTheoreticalShift,
				Double executionCourseStudentsNumberByPraticalShift,
				Double executionCourseStudentsNumberByLaboratorialShift,
		...
		public Double getExecutionCourseTotalHours() {
			return executionCoursePraticalHours + executionCourseTheoreticalHours + executionCourseTheoPratHours + executionCourseLaboratorialHours;
		}
	...
	public void addExecutionCourse(				
			Integer executionCourseIdInternal, 
			String executionCourseName,
			String executionCourseCampus, 
			String executionCourseDegreeName,
			Set<String> executionCourseCurricularYear, 
			Integer executionCourseSemester,
			Integer executionCourseFirstTimeEnrollementStudentNumber,
			Integer executionCourseSecondTimeEnrollementStudentNumber,
			Double executionCourseTheoreticalHours,
			...
			Double executionCourseStudentsNumberByLaboratorialShift,
			Double executionCourseStudentsNumberByTheoPraticalShift) {
		ExecutionCourseDistributionServiceEntryDTO t = new ExecutionCourseDistributionServiceEntryDTO(
											executionCourseIdInternal, 
											executionCourseName,
											executionCourseCampus, 
											executionCourseDegreeName,
											executionCourseCurricularYear, 
											executionCourseSemester,
											executionCourseFirstTimeEnrollementStudentNumber,
											executionCourseSecondTimeEnrollementStudentNumber,
											executionCourseTheoreticalHours,
											executionCoursePraticalHours,
											executionCourseLaboratorialHours,
											executionCourseTheoPratHours,
											executionCourseStudentsNumberByTheoreticalShift,
											executionCourseStudentsNumberByPraticalShift,
											executionCourseStudentsNumberByLaboratorialShift,
	...
	public void addTeacherToExecutionCourse(Integer keyExecutionCourse, Integer idInternalTeacher, String name, Integer hoursSpentByTeacher, boolean teacherBelongsToDepartment) {
		TeacherExecutionCourseServiceDTO teacher = new TeacherExecutionCourseServiceDTO(idInternalTeacher,name,hoursSpentByTeacher, teacherBelongsToDepartment);
