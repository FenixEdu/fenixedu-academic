...
public class InfoExtraWorkRequests extends InfoObject {
    ...
    /**
     * @param costCenterMoney
     *            The costCenterMoney to set.
     */
    ...
    /**
     * @param infoCostCenter
     *            The infoCostCenter to set.
     */
    ...
    /**
     * @param infoWhoEmployee
     *            The infoWhoEmployee to set.
     */
