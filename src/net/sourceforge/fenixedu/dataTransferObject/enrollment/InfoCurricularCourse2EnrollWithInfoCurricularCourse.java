...
public class InfoCurricularCourse2EnrollWithInfoCurricularCourse extends InfoCurricularCourse2Enroll implements Serializable {
	...
	if (curricularCourse2Enroll != null) {
	    setInfoCurricularCourse(InfoCurricularCourse.newInfoFromDomain(curricularCourse2Enroll.getCurricularCourse()));
	}
    }

    public static InfoCurricularCourse2Enroll newInfoFromDomain(CurricularCourse2Enroll curricularCourse2Enroll) {
