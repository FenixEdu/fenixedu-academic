...
public class GuideRequester extends FenixUtil {
    ...
    public String toString() {
        if (type.intValue() == GuideRequester.CANDIDATE)
            return GuideRequester.CANDIDATE_STRING;
        if (type.intValue() == GuideRequester.STUDENT)
            return GuideRequester.STUDENT_STRING;
