...
public final class HourMinuteSecond extends BasePartial implements ReadablePartial, Serializable {
    ...
    // -----------------------------------------------------------------------
    /**
     * Constructs a HourMinuteSecond from a <code>java.util.Calendar</code>
     * using exactly the same field values avoiding any time zone effects.
     * <p>
     * Each field is queried from the Calendar and assigned to the
     * HourMinuteSecond. This is useful if you have been using the Calendar as a
     * local date, ignoing the zone.
     * <p>
     ...
     * pass in instances of <code>GregorianCalendar</code> however this is not
     * validated.
     * 
     * @param calendar
     ...
     * <p>
     * Each field is queried from the Date and assigned to the HourMinuteSecond.
     * This is useful if you have been using the Date as a local date, ignoing
     * the zone.
     * <p>
     * This factory method always creates a HourMinuteSecond with ISO
     * chronology.
     * 
     * @param date
     ...
     * <p>
     * The time zone of the specified chronology is ignored, as HourMinuteSecond
     ...
     * <p>
     * For example, if the field type is <code>minuteOfHour</code> then the
     ...
     * <p>
     * This class binds a <code>HourMinuteSecond</code> to a
