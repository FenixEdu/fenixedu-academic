...
public class GraduationType extends FenixUtil {
    ...
    public GraduationType(String type) {
        if (type.equals(GraduationType.MAJOR_DEGREE_STRING))
            this.type = new Integer(GraduationType.MAJOR_DEGREE);
        if (type.equals(GraduationType.MASTER_DEGREE_STRING))
            this.type = new Integer(GraduationType.MASTER_DEGREE);
    }
    ...
    public static List toArrayList() {
        ...
        result.add(new LabelValueBean(GraduationType.MAJOR_DEGREE_STRING,
                GraduationType.MAJOR_DEGREE_STRING));
        result.add(new LabelValueBean(GraduationType.MASTER_DEGREE_STRING,
                GraduationType.MASTER_DEGREE_STRING));
        return result;
    }

    public String toString() {
        if (type.intValue() == GraduationType.MAJOR_DEGREE)
            return GraduationType.MAJOR_DEGREE_STRING;
        if (type.intValue() == GraduationType.MASTER_DEGREE)
            return GraduationType.MASTER_DEGREE_STRING;
