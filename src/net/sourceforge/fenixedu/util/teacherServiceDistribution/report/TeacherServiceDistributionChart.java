            ...
            public void execute(final OutputStream outputStream) throws IOException {
                ...
                if (this.tsd.hasAnyChilds()) {
                    for (TeacherServiceDistribution grouping : this.tsd.getChilds()) {
                        Double allActiveTSDCourseHours =
                        ...
                        dataset.setValue(allActiveTSDCourseHours,
                                resourceBundle.getString("label.teacherServiceDistribution.hours.total"), grouping.getName());
                        /*
                    ...
                    JFreeChart chart =
                            ChartFactory.createBarChart3D(
                                    ...
                                    resourceBundle.getString("label.teacherServiceDistribution.hours.total"), dataset,
            ...
            public void execute(final OutputStream outputStream) throws IOException {
                ...
                if (tsd.hasAnyChilds()) {
                    for (TeacherServiceDistribution grouping : tsd.getChilds()) {
                        Integer allActiveTSDCourseFirstTimeEnrolledStudents =
                                grouping.getAllActiveTSDCourseFirstTimeEnrolledStudentsByExecutionPeriods(executionPeriodList);
                        Integer allActiveTSDCourseSecondTimeEnrolledStudents =
                                grouping.getAllActiveTSDCourseSecondTimeEnrolledStudentsByExecutionPeriods(executionPeriodList);

                        dataset.setValue(allActiveTSDCourseFirstTimeEnrolledStudents
                                + allActiveTSDCourseSecondTimeEnrolledStudents,
                                resourceBundle.getString("label.teacherServiceDistribution.students.total"), grouping.getName());
                        dataset.setValue(allActiveTSDCourseFirstTimeEnrolledStudents,
                                resourceBundle.getString("label.teacherServiceDistribution..num.firstTimeEnrolledStudents"),
                                grouping.getName());
                        dataset.setValue(allActiveTSDCourseSecondTimeEnrolledStudents,
                    ...
                    JFreeChart chart =
                            ChartFactory.createBarChart3D(
                                    ...
                                    resourceBundle.getString("label.teacherServiceDistribution.TeacherServiceDistributions"),
                                    resourceBundle.getString("label.teacherServiceDistribution.students.total"), dataset,
                                    PlotOrientation.VERTICAL, true, true, false);
    ...
    public static TeacherServiceDistributionChart generateValuatedHoursPerGroupingPieChart() {
        return new TeacherServiceDistributionChart() {
            ...
            public void execute(final OutputStream outputStream) throws IOException {
                ...
                if (this.tsd.hasAnyChilds()) {
                    for (TeacherServiceDistribution grouping : this.tsd.getChilds()) {
                        valuatedTotalHoursPerGroupingMap.put(grouping.getName(),
                                grouping.getAllActiveTSDCourseTotalHoursByExecutionPeriods(executionPeriodList));
                    }
                    ...
                    for (String groupingName : valuatedTotalHoursPerGroupingMap.keySet()) {
                        dataset.setValue(
                                groupingName,
                                (new Double(
                                        StrictMath.round((valuatedTotalHoursPerGroupingMap.get(groupingName) / totalHours) * 100)))
                                        .intValue());
                    }

                    JFreeChart chart =
                            ChartFactory.createPieChart3D(
                                    resourceBundle.getString("label.teacherServiceDistribution.hoursByGrouping") + " %", dataset,
                                    true, true, false);
    ...
    public static TeacherServiceDistributionChart generateValuatedNumberStudentsPerGroupingPieChart() {
        return new TeacherServiceDistributionChart() {
            ...
            public void execute(final OutputStream outputStream) throws IOException {
                ...
                if (this.tsd.hasAnyChilds()) {
                    for (TeacherServiceDistribution grouping : this.tsd.getChilds()) {
                        valuatedTotalNumberStudentsPerGroupingMap.put(grouping.getName(),
                    ...
                    for (String groupingName : valuatedTotalNumberStudentsPerGroupingMap.keySet()) {
                        dataset.setValue(
                                groupingName,
                                (new Double(
                                        StrictMath.round((valuatedTotalNumberStudentsPerGroupingMap.get(groupingName) / totalNumberOfStudents) * 100)))
                                        .intValue());
                    }
