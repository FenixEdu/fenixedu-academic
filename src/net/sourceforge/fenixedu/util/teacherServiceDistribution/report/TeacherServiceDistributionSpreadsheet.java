...
public class TeacherServiceDistributionSpreadsheet {
    ...
    public TeacherServiceDistributionSpreadsheet(List<TSDCourseDTOEntry> _tsdCourseDTOEntryList,
	    List<TSDTeacherDTOEntry> _tsdTeacherDTOEntryList, String _spreadsheetName) {
	...
	for (TSDTeacherDTOEntry tsdTeacherDTOEntry : tsdTeacherDTOEntryList) {
		...
		TSDProfessorshipDTOEntry tsdProfessorshipDTOEntry = tsdTeacherDTOEntry
			.getTSDProfessorshipDTOEntryByTSDCourseDTOEntry(tsdCourseDTOEntry);
	...
	/*
	 * row = dsdSheet.createRow(rowStart + 9); cell =
	 * row.createCell(columnStart);
	 * cell.setCellValue(resourceBundle.getString
	 * ("label.teacherServiceDistribution.theoreticalHours"));
	 * cell.setCellStyle(style);
	 * 
	 * row = dsdSheet.createRow(rowStart + 10); cell =
	 * row.createCell(columnStart);
	 * cell.setCellValue(resourceBundle.getString
	 * ("label.teacherServiceDistribution.praticalHours"));
	 * cell.setCellStyle(style);
	 * 
	 * row = dsdSheet.createRow(rowStart + 11); cell =
	 * row.createCell(columnStart);
	 * cell.setCellValue(resourceBundle.getString
	 * ("label.teacherServiceDistribution.theoPratHours"));
	 * cell.setCellStyle(style);
	 * 
	 * row = dsdSheet.createRow(rowStart + 12); cell =
	 * row.createCell(columnStart);
	 * cell.setCellValue(resourceBundle.getString
	 * ("label.teacherServiceDistribution.laboratorialHours"));
	 * cell.setCellStyle(style);
	 */
	...
	/*
	 * double totalTheoreticalHours = 0d; double totalPraticalHours = 0d;
	 * double totalTheoreticalPraticalHours = 0d; double
	 * totalLaboratorialHours = 0d;
	 */
	...
	for (TSDCourseDTOEntry tsdCourseDTOEntry : tsdCourseDTOEntryList) {
	    ...
	    /*
	     * row = dsdSheet.createRow(rowStart + 9); cell = row.createCell(j);
	     * totalTheoreticalHours +=
	     * tsdCourseDTOEntry.getTSDCourse().getHours(ShiftType.TEORICA);
	     * cell
	     * .setCellValue(tsdCourseDTOEntry.getTSDCourse().getHours(ShiftType
	     * .TEORICA)); cell.setCellStyle(courseHoursStyle);
	     * 
	     * row = dsdSheet.createRow(rowStart + 10); cell =
	     * row.createCell(j); totalPraticalHours =
	     * tsdCourseDTOEntry.getTSDCourse().getHours(ShiftType.PRATICA);
	     * cell
	     * .setCellValue(tsdCourseDTOEntry.getTSDCourse().getHours(ShiftType
	     * .PRATICA)); cell.setCellStyle(courseHoursStyle);
	     * 
	     * row = dsdSheet.createRow(rowStart + 11); cell =
	     * row.createCell(j); totalTheoreticalPraticalHours +=
	     * tsdCourseDTOEntry
	     * .getTSDCourse().getHours(ShiftType.TEORICO_PRATICA);
	     * cell.setCellValue
	     * (tsdCourseDTOEntry.getTSDCourse().getHours(ShiftType
	     * .TEORICO_PRATICA)); cell.setCellStyle(courseHoursStyle);
	     * 
	     * row = dsdSheet.createRow(rowStart + 12); cell =
	     * row.createCell(j); totalLaboratorialHours +=
	     * tsdCourseDTOEntry.getTSDCourse
	     * ().getHours(ShiftType.LABORATORIAL);
	     * cell.setCellValue(tsdCourseDTOEntry
	     * .getTSDCourse().getHours(ShiftType.LABORATORIAL));
	...
	/*
	 * row = dsdSheet.createRow(rowStart + 9); cell = row.createCell(j);
	 * cell.setCellValue(totalTheoreticalHours); cell.setCellStyle(style);
	 * 
	 * row = dsdSheet.createRow(rowStart + 10); cell = row.createCell(j);
	 * cell.setCellValue(totalPraticalHours); cell.setCellStyle(style);
	 * 
	 * row = dsdSheet.createRow(rowStart + 11); cell = row.createCell(j);
	 * cell.setCellValue(totalTheoreticalPraticalHours);
	 * cell.setCellStyle(style);
	 * 
	 * row = dsdSheet.createRow(rowStart + 12); cell = row.createCell(j);
	 * cell.setCellValue(totalLaboratorialHours); cell.setCellStyle(style);
	 */
	row = dsdSheet.createRow(rowStart + 9);
	cell = row.createCell(j);
	...
	HSSFSheet teachersResumeSheet = workbook.createSheet(resourceBundle
		.getString("label.teacherServiceDistribution.tsdTeacher"));
