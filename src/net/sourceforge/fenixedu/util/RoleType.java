...
public final class RoleType extends FenixValuedEnum {
    ...
    public static final int PROJECTS_MANAGER_TYPE = 29;
    ...
    public static final RoleType TIME_TABLE_MANAGER = new RoleType("timeTableManager",
            RoleType.TIME_TABLE_MANAGER_TYPE);

    public static final RoleType MASTER_DEGREE_CANDIDATE = new RoleType("masterDegreeCandidate",
            RoleType.MASTER_DEGREE_CANDIDATE_TYPE);

    public static final RoleType MASTER_DEGREE_ADMINISTRATIVE_OFFICE = new RoleType(
            "masterDegreeAdministrativeOffice", RoleType.MASTER_DEGREE_ADMINISTRATIVE_OFFICE_TYPE);
    ...
    public static final RoleType MANAGEMENT_ASSIDUOUSNESS = new RoleType("managementAssiduousness",
            RoleType.MANAGEMENT_ASSIDUOUSNESS_TYPE);

    public static final RoleType MANAGER = new RoleType("manager", RoleType.MANAGER_TYPE);

    public static final RoleType DEGREE_ADMINISTRATIVE_OFFICE = new RoleType(
            "degreeAdministrativeOffice", RoleType.DEGREE_ADMINISTRATIVE_OFFICE_TYPE);

    public static final RoleType CREDITS_MANAGER = new RoleType("creditsManager",
            RoleType.CREDITS_MANAGER_TYPE);

    public static final RoleType DEPARTMENT_CREDITS_MANAGER = new RoleType(
            "role.department.credits.manager", RoleType.DEPARTMENT_CREDITS_MANAGER_TYPE);

    public static final RoleType DEGREE_ADMINISTRATIVE_OFFICE_SUPER_USER = new RoleType(
            "degreeAdministrativeOfficeSuperUser", RoleType.DEGREE_ADMINISTRATIVE_OFFICE_SUPER_USER_TYPE);

    public static final RoleType ERASUMS = new RoleType("erasmus", RoleType.ERASMUS_TYPE);

    public static final RoleType SCIENTIFIC_COUNCIL = new RoleType("scientificCouncil",
            RoleType.SCIENTIFIC_COUNCIL_TYPE);
    ...
    public static final RoleType SEMINARIES_COORDINATOR = new RoleType("seminariesCoordinator",
            RoleType.SEMINARIES_COORDINATOR_TYPE);

    public static final RoleType WEBSITE_MANAGER = new RoleType("WebSiteManager",
            RoleType.WEBSITE_MANAGER_TYPE);

    public static final RoleType GRANT_OWNER = new RoleType("grantOwner", RoleType.GRANT_OWNER_TYPE);

    public static final RoleType GRANT_OWNER_MANAGER = new RoleType("grantOwnerManager",
            RoleType.GRANT_OWNER_MANAGER_TYPE);

    public static final RoleType DEPARTMENT_MEMBER = new RoleType("role.department.member",
            RoleType.DEPARTMENT_MEMBER_TYPE);

    public static final RoleType GEP = new RoleType("role.gep", RoleType.GEP_TYPE);

    public static final RoleType DIRECTIVE_COUNCIL = new RoleType("role.directiveCouncil",
            RoleType.DIRECTIVE_COUNCIL_TYPE);

    public static final RoleType DELEGATE = new RoleType("role.delegate", RoleType.DELEGATE_TYPE);

    public static final RoleType FIRST_TIME_STUDENT = new RoleType("schoolRegistration",
            RoleType.FIRST_TIME_STUDENT_TYPE);

    public static final RoleType PROJECTS_MANAGER = new RoleType("projectsManager", 
            RoleType.PROJECTS_MANAGER_TYPE);
