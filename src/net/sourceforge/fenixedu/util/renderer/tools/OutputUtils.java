...
public class OutputUtils {
     ...
     *         The algorithm tries to provide different colors for similar
     *         strings, and will return equal colors for equal strings. The
     *         colors will all have similar brightness and maximum intensity.
     *         Useful for chart coloring.
     */
