...
public class ReportType extends FenixUtil {
    ...
    public static final String REVENUE_NOTE =
            "Nota: Nos movimentos com tipo DE (Devoluções) e ES (Estorno), embora o valor indicado no movimento seja positivo, eles diminuem o total das despesas. Se quiser usar estes dados para calcular totais efectivos de despesas fazendo somas na coluna total, deve considerar os campos DE e ES como valores negativos.";
    ...
    public static final String OVERHEADS_SUMMARY_NOTE =
    ...
    public static final String PROJECT_BUDGETARY_BALANCE_NOTE =
            "Nota: Nos casos em que o projecto é constituído por vários membros, o valor orçamentado corresponde ao total orçamentado para todos os membros.";
