...
public class ProviderRegimeType extends FenixValuedEnum {
    ...
    public static final ProviderRegimeType EXCLUSIVE_CUMULATIVE = new ProviderRegimeType(
            "regime.exclusiveCumulative", ProviderRegimeType.EXCLUSIVE_CUMULATIVE_TYPE);
