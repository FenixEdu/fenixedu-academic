...
public class SibsPaymentFileUtils {
	...
	try {
		...
		String typeOfRecordString = line.substring(SibsPaymentFileConstants.FIELD_TYPE_OF_RECORD_BEGIN_INDEX,
		...
		if (Integer.parseInt(typeOfRecordString) == SibsPaymentFileConstants.DETAIL_RECORD_CODE) {
		    ...
		    String transactionDateString = line.substring(SibsPaymentFileConstants.FIELD_TRANSACTION_DATE_BEGIN_INDEX,
		    ...
		    // parse payed value
		    String valueString = line.substring(SibsPaymentFileConstants.FIELD_PAYED_VALUE_BEGIN_INDEX,
		    ...
		    // parse reference
		    String sibsReference = line.substring(SibsPaymentFileConstants.FIELD_REFERENCE_BEGIN_INDEX,
			    SibsPaymentFileConstants.FIELD_REFERENCE_END_INDEX);

		    // retrieve year from reference
		    String yearString = sibsReference.substring(SibsPaymentFileConstants.FIELD_REFERENCE_YEAR_BEGIN_INDEX,
