...
public class Sexo extends FenixUtil {
    ...
    public Sexo(String sexo) {
        if (sexo.equals(Sexo.MASCULINO_STRING))
            this.sexo = new Integer(Sexo.MASCULINO);
        if (sexo.equals(Sexo.FEMININO_STRING))
            this.sexo = new Integer(Sexo.FEMININO);
    }
    ...
    public String toString() {
        if (sexo.intValue() == Sexo.MASCULINO)
            return Sexo.MASCULINO_STRING;
        if (sexo.intValue() == Sexo.FEMININO)
            return Sexo.FEMININO_STRING;
