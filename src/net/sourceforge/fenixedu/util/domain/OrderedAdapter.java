...
public interface OrderedAdapter<HolderType, ObjectType> {
	 ...
	 * 
	 * <p>
	 * If and element is given the same order as other element then all the elements with an order equal or greater than the order
	 * of that element will be moved forward, that is, will have their order increased.
	 * 
	 * @param holder
	 ...
	 * 
	 * @return the object that appears after the given object or <code>null</code> if the given object is the last
	 */
	 ...
	 *            the object in question
	 * 
	 * @return the object that appears before the given object or <code>null</code> if the given object is the first
	 */
