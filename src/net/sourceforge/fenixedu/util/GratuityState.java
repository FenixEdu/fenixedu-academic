...
public final class GratuityState extends FenixValuedEnum {
    ...
    public static final GratuityState NOT_PAYED = new GratuityState("not.payed",
            GratuityState.NOT_PAYED_TYPE);

    public static final GratuityState PAYED_PARTIALLY = new GratuityState("payed.partially",
            GratuityState.PAYED_PARTIALLY_TYPE);
    ...
    public static final GratuityState EXEMPT_EMPLOYEE = new GratuityState("exempt.employee",
            GratuityState.EXEMPT_EMPLOYEE_TYPE);

    public static final GratuityState EXEMPT_POLITECNIC_TEACHER = new GratuityState(
            "exempt.politecnic.teacher", GratuityState.EXEMPT_POLITECNIC_TEACHER_TYPE);
