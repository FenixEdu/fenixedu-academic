...
public class AttendacyStateSelectionType {
    ...
    public static final int SPECIAL_SEASON_TYPE = 5;

    public static final AttendacyStateSelectionType ALL = new AttendacyStateSelectionType(AttendacyStateSelectionType.ALL_TYPE);
    public static final AttendacyStateSelectionType ENROLLED = new AttendacyStateSelectionType(
	    AttendacyStateSelectionType.ENROLLED_TYPE);
    public static final AttendacyStateSelectionType NOT_ENROLLED = new AttendacyStateSelectionType(
	    AttendacyStateSelectionType.NOT_ENROLLED_TYPE);
    public static final AttendacyStateSelectionType IMPROVEMENT = new AttendacyStateSelectionType(
	    AttendacyStateSelectionType.IMPROVEMENT_TYPE);
    public static final AttendacyStateSelectionType SPECIAL_SEASON = new AttendacyStateSelectionType(
	    AttendacyStateSelectionType.SPECIAL_SEASON_TYPE);
