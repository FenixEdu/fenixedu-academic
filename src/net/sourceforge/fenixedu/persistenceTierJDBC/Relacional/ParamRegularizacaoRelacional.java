...
import net.sourceforge.fenixedu.persistenceTierJDBC.IParamRegularizacaoPersistente;
...
public class ParamRegularizacaoRelacional implements IParamRegularizacaoPersistente {
    ...
    public boolean alterarParamRegularizacao(ParamRegularizacao paramRegularizacao) {
        ...
        try {
            PreparedStatement sql = UtilRelacional.prepararComando("UPDATE ass_PARAM_REGULARIZACAO SET "
                    + "codigoInterno = ? , " + "sigla = ? , " + "descricao = ? , " + "quem = ? , "
            ...
            System.out
                    .println("ParamRegularizacaoRelacional.alterarParamRegularizacao: " + e.toString());
        }
        return resultado;
    ...
    public boolean apagarParamRegularizacao(String sigla) {
        ...
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("DELETE FROM ass_PARAM_REGULARIZACAO " + "WHERE sigla = ?");
    ...
    public boolean escreverParamRegularizacao(ParamRegularizacao paramRegularizacao) {
        ...
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("INSERT INTO ass_PARAM_REGULARIZACAO " + "VALUES (?, ?, ?, ?, ?)");
            ...
            System.out.println("ParamRegularizacaoRelacional.escreverParamRegularizacao: "
                    + e.toString());
        }
        return resultado;
    ...
    public ParamRegularizacao lerParamRegularizacao(int chaveParamRegularizacao) {
        ...
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("SELECT * FROM ass_PARAM_REGULARIZACAO "
                            + "WHERE codigoInterno = ?");
            ...
            if (resultado.next()) {
                paramRegularizacao = new ParamRegularizacao(resultado.getInt("codigoInterno"), resultado
                        .getString("sigla"), resultado.getString("descricao"), resultado.getInt("quem"),
    ...
    public ParamRegularizacao lerParamRegularizacao(String sigla) {
        ...
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("SELECT * FROM ass_PARAM_REGULARIZACAO " + "WHERE sigla = ?");
    ...
    public List lerTodasParamRegularizacoes() {
        List listaParamRegularizacoes = null;
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("SELECT sigla FROM ass_PARAM_REGULARIZACAO");
            ...
            System.out.println("ParamRegularizacaoRelacional.lerTodasParamRegularizacoes: "
                    + e.toString());
        }
