...
import net.sourceforge.fenixedu.persistenceTierJDBC.IPeriodoFeriasPersistente;
...
public class PeriodoFeriasRelacional implements IPeriodoFeriasPersistente {
    ...
    public boolean alterarPeriodoFerias(PeriodoFerias periodoFerias) {
        ...
        try {
            PreparedStatement sql = UtilRelacional.prepararComando("UPDATE ass_PERIODO_FERIAS SET "
                    + "codigoInterno = ? , " + "chaveFuncionario = ? , " + "dataInicio = ? , "
                    + "dataFim = ? , " + "numDiasUteis = ? , " + "tipoFerias = ? , " + "quem = ? , "
    ...
    public boolean apagarPeriodoFerias(int codigoInterno) {
        ...
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("DELETE FROM ass_PERIODO_FERIAS WHERE codigoInterno = ?");
    ...
    public boolean escreverPeriodoFerias(PeriodoFerias periodoFerias) {
        ...
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("INSERT INTO ass_PERIODO_FERIAS VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    public List historicoFeriasPorFuncionario(int numFuncionario) {
        ...
        try {
            ...
            sql = UtilRelacional
                    .prepararComando("SELECT * FROM ass_PERIODO_FERIAS WHERE chaveFuncionario = ?");
            ...
            while (resultado.next()) {
                ...
                listaFerias.add(new PeriodoFerias(resultado.getInt("codigoInterno"), resultado
                        .getInt("chaveFuncionario"), java.sql.Date.valueOf(resultado
                        .getString("dataInicio")), dataFim, resultado.getInt("numDiasUteis"), resultado
                        .getInt("tipoFerias"), resultado.getInt("quem"), Timestamp.valueOf(resultado
                        .getString("quando"))));
            }
        } catch (Exception e) {
    ...
    public PeriodoFerias lerPeriodoFerias(int codigoInterno) {
        ...
        try {
            PreparedStatement sql = UtilRelacional.prepararComando("SELECT * FROM ass_PERIODO_FERIAS "
                    + "WHERE codigoInterno = ?");
            ...
            if (resultado.next()) {
                ...
                periodoFerias = new PeriodoFerias(resultado.getInt("codigoInterno"), resultado
                        .getInt("chaveFuncionario"), java.sql.Date.valueOf(resultado
                        .getString("dataInicio")), dataFim, resultado.getInt("numDiasUteis"), resultado
                        .getInt("tipoFerias"), resultado.getInt("quem"), Timestamp.valueOf(resultado
                        .getString("quando")));
    ...
    public List lerFuncionariosComFerias(Timestamp dataFerias) {
        ...
        try {
            PreparedStatement sql = UtilRelacional.prepararComando("SELECT chaveFuncionario "
    ...
    public List lerFeriasPorTipo(String tipoFerias) {
        ...
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("SELECT codigoInterno FROM ass_TIPO_FERIAS WHERE sigla = ?");
            ...
            sql = UtilRelacional
                    .prepararComando("SELECT * FROM ass_PERIODO_FERIAS WHERE tipoFerias = ?");
