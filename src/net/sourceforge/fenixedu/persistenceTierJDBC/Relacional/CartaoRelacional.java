...
public class CartaoRelacional implements ICartaoPersistente {
    ...
    public boolean alterarCartao(Cartao cartao) {
        ...
        try {
            PreparedStatement sql = UtilRelacional.prepararComando("UPDATE ass_CARTAO SET "
                    + "codigoInterno = ? , " + "numCartao = ? , " + "chaveFuncionario = ? , "
                    + "dataInicio = ? , " + "dataFim = ? , " + "quem = ? , " + "quando = ? , "
                    + "estado = ? " + "WHERE codigoInterno = ? ");
    ...
    public boolean apagarTodosCartoes() {
        ...
        try {
            ...
            sql.close();
            /*
             * sql = UtilRelacional.prepararComando("ALTER TABLE ass_CARTAO
             * auto_increment=1"); sql.executeUpdate();
             */
            resultado = true;
        } catch (Exception e) {
    ...
    public Cartao cartaoAtribuido(int numCartao) {
        ...
        try {
            PreparedStatement sql = UtilRelacional.prepararComando("SELECT * FROM ass_CARTAO "
                    + "WHERE numCartao = ? AND estado = \"atribuido\"");
            ...
            if (resultado.next()) {
                ...
                cartao = new Cartao(resultado.getInt("codigoInterno"), resultado.getInt("numCartao"),
                        resultado.getInt("chaveFuncionario"), Timestamp.valueOf(resultado
                                .getString("dataInicio")), dataFim, resultado.getInt("quem"), Timestamp
                                .valueOf(resultado.getString("quando")), resultado.getString("estado"));
            }
            sql.close();
        } catch (Exception e) {
    ...
    public List cartaoUtilizado(int numCartao, Timestamp dataInicio, Timestamp dataFim) {
        ...
        try {
            ...
            while (resultado.next()) {
                ...
                listaCartoes.add(new Cartao(resultado.getInt("codigoInterno"), resultado
                        .getInt("numCartao"), resultado.getInt("chaveFuncionario"), Timestamp
                        .valueOf(resultado.getString("dataInicio")), dataFimCartao, resultado
                        .getInt("quem"), Timestamp.valueOf(resultado.getString("quando")), resultado
                        .getString("estado")));
            }
            sql.close();
        } catch (Exception e) {
    ...
    public List consultarCartao(List listaFuncionarios, List listaCartoes, Timestamp dataInicio,
        ...
        try {
            ...
            query = query.concat(" ((dataInicio BETWEEN ? AND ?) "
                    + "OR (dataFim BETWEEN ? AND ?) OR (dataInicio <= ? AND dataFim >= ?))");
            ...
            if (listaFuncionarios != null) {
                ...
                PreparedStatement sqlFuncionario = UtilRelacional
            ...
            while (resultado.next()) {
                ...
                cartoes
                        .add(new Cartao(resultado.getInt("codigoInterno"),
                                resultado.getInt("numCartao"), resultado.getInt("chaveFuncionario"),
                                Timestamp.valueOf(resultado.getString("dataInicio")), dataFimCartao,
                                resultado.getInt("quem"), Timestamp.valueOf(resultado
                                        .getString("quando")), resultado.getString("estado")));
            }
            sql.close();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public boolean escreverCartao(Cartao cartao) {
        ...
        try {
            PreparedStatement sql = UtilRelacional.prepararComando("INSERT INTO ass_CARTAO "
                    + "VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    public boolean escreverCartoes(List listaCartoes) {
        ...
        try {
            while (iterador.hasNext()) {
                ...
                PreparedStatement sql = UtilRelacional.prepararComando("SELECT * FROM ass_CARTAO "
                        + "WHERE numCartao = ? " + "AND chaveFuncionario = ? " + "AND dataInicio = ? "
                        + "AND dataFim = ?");
    ...
    public Cartao lerCartaoLivre() {
        ...
        try {
            ...
            PreparedStatement sql = UtilRelacional.prepararComando("SELECT numCartao FROM ass_CARTAO "
    ...
    public Cartao lerCartaoSubstitutoFuncionario(int chaveFuncionario) {
        ...
        try {
            ...
            if (resultado.next()) {
                cartao = new Cartao(resultado.getInt("codigoInterno"), resultado.getInt("numCartao"),
                        resultado.getInt("chaveFuncionario"), Timestamp.valueOf(resultado
                                .getString("dataInicio")), Timestamp.valueOf(resultado
                                .getString("dataFim")), resultado.getInt("quem"), Timestamp
                                .valueOf(resultado.getString("quando")), resultado.getString("estado"));
            }
            sql.close();
        } catch (Exception e) {
    ...
    public Cartao lerCartaoSubstitutoFuncionario(int chaveFuncionario, Timestamp data) {
        ...
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("SELECT * FROM ass_CARTAO WHERE chaveFuncionario = ? AND ? BETWEEN dataInicio AND dataFim AND numCartao >= 900000");
    ...
    public Cartao lerCartaoSubstitutoFuncionario(int chaveFuncionario, Timestamp dataInicio,
        ...
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("SELECT * FROM ass_CARTAO "
            ...
            while (resultado.next()) {
                ...
                cartao = new Cartao(resultado.getInt("codigoInterno"), resultado.getInt("numCartao"),
                        resultado.getInt("chaveFuncionario"), Timestamp.valueOf(resultado
                                .getString("dataInicio")), dataFimCartao, resultado.getInt("quem"),
                        Timestamp.valueOf(resultado.getString("quando")), resultado.getString("estado"));
            }
            sql.close();
        } catch (Exception e) {
            System.out.println("CartaoRelacional.lerCartaoSubstitutoFuncionario: " + e.toString());
        ...
        try {
            ...
            while (resultado.next()) {
                ...
                listaCartoes
                        .add(new Cartao(resultado.getInt("codigoInterno"),
                                resultado.getInt("numCartao"), resultado.getInt("chaveFuncionario"),
                                Timestamp.valueOf(resultado.getString("dataInicio")), dataFim, resultado
                                        .getInt("quem"), Timestamp
                                        .valueOf(resultado.getString("quando")), resultado
                                        .getString("estado")));
            }
            sql.close();
        } catch (Exception e) {
    ...
    public List lerTodosCartoes() {
        ...
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("SELECT DISTINCT numCartao FROM ass_CARTAO "
    ...
    public List lerTodosCartoesSubstitutos() {
        List listaCartoesSubstitutos = null;
    ...
    public Cartao lerUltimaUtilizacaoCartao(int numCartao, Timestamp dataMarcacao) {
        ...
        try {
            ...
            PreparedStatement sql = UtilRelacional
                    .prepararComando("SELECT MAX(dataFim) FROM ass_CARTAO "
                            + "WHERE numCartao=? and dataFim<=?");
            ...
            if (resultado.next()) {
                ...
                sql = UtilRelacional.prepararComando("SELECT * FROM ass_CARTAO "
                        + "WHERE numCartao=? AND dataFim=?");
                ...
                if (resultado.next()) {
                    ...
                    cartao = new Cartao(resultado.getInt("codigoInterno"),
                            resultado.getInt("numCartao"), resultado.getInt("chaveFuncionario"),
                            Timestamp.valueOf(resultado.getString("dataInicio")), dataFim, resultado
    ...
    public int ultimoCodigoInterno() {
        ...
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("SELECT MAX(codigoInterno) FROM ass_CARTAO");
