...
public class HorarioRelacional implements IHorarioPersistente {
    ...
    public boolean alterarHorario(Horario horario) {
        ...
        try {
            PreparedStatement sql = UtilRelacional.prepararComando("UPDATE ass_HORARIO SET "
                    + "codigoInterno = ? , " + "chaveHorarioTipo = ? , " + "chaveFuncionario = ? , "
                    + "sigla = ? , " + "modalidade = ? , " + "duracaoSemanal = ? , "
                    + "inicioPF1 = ? , " + "fimPF1 = ? , " + "inicioPF2 = ? , " + "fimPF2 = ? , "
                    + "inicioHN1 = ? , " + "fimHN1 = ? , " + "inicioHN2 = ? , " + "fimHN2 = ? , "
                    + "inicioRefeicao = ? , " + "fimRefeicao = ? , " + "descontoObrigatorio = ? , "
                    + "descontoMinimo = ? , " + "inicioExpediente = ? , " + "fimExpediente = ? , "
                    + "dataInicio = ? , " + "dataFim = ? , " + "numDias = ? , " + "posicao = ? , "
                    + "trabalhoConsecutivo = ? , " + "quem = ? , " + "quando = ? "
                    + "WHERE codigoInterno = ? ");
    ...
    public boolean alterarExcepcaoHorario(Horario horario) {
        ...
        try {
            PreparedStatement sql = UtilRelacional.prepararComando("UPDATE ass_HORARIO_EXCEPCAO SET "
                    + "codigoInterno = ? , " + "chaveHorarioTipo = ? , " + "chaveFuncionario = ? , "
                    + "sigla = ? , " + "modalidade = ? , " + "duracaoSemanal = ? , "
                    + "inicioPF1 = ? , " + "fimPF1 = ? , " + "inicioPF2 = ? , " + "fimPF2 = ? , "
                    + "inicioHN1 = ? , " + "fimHN1 = ? , " + "inicioHN2 = ? , " + "fimHN2 = ? , "
    ...
    public boolean alterarDataFimHorario(Date dataFim, int numeroMecanografico) {
        ...
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("SELECT chaveHorarioActual FROM ass_FUNCIONARIO "
    ...
    public boolean apagarHorarioExcepcao(int codigoInterno) {
        ...
        try {
            PreparedStatement sql = UtilRelacional.prepararComando("DELETE FROM ass_HORARIO_EXCEPCAO "
                    + "WHERE codigoInterno = ?");
    ...
    public boolean apagarTodosHorarios() {
        ...
        try {
            ...
            sql.close();
            /*
             * sql = UtilRelacional.prepararComando("ALTER TABLE ass_HORARIO
             ...
             * ass_HORARIO_EXCEPCAO auto_increment=1"); sql.execute();
             */
    ...
    public boolean associarExcepcaoHorarioRegime(int chaveHorario, int chaveRegime) {
        ...
        try {
            PreparedStatement sql = UtilRelacional.prepararComando("INSERT INTO "
                    + "ass_HORARIOEXCEPCAO_REGIME VALUES (?, ?)");
    ...
    public int calcularIndiceRotacao(int numDiasRotacao, java.util.Date dataInicioHorario,
        ...
        try {
            ...
            if (inicioHorario.get(Calendar.YEAR) < diaConsulta.get(Calendar.YEAR)) {
                ...
                numDias = fimAnoHorario.get(Calendar.DAY_OF_YEAR)
                        - inicioHorario.get(Calendar.DAY_OF_YEAR) + 1;
                ...
                numDias = new BigInteger(String
                        .valueOf((diaConsulta.get(Calendar.DAY_OF_YEAR) - inicioHorario
                                .get(Calendar.DAY_OF_YEAR)) + 1)).abs().intValue();
                ...
                numDias = fimAnoHorario.get(Calendar.DAY_OF_YEAR)
                        - diaConsulta.get(Calendar.DAY_OF_YEAR) + 1;
            ...
            indiceRotacao = new BigInteger(String.valueOf(numDias + indiceInicioHorario)).mod(
                    new BigInteger(String.valueOf(numDiasRotacao))).intValue();
            /*
             * int indiceDescanso = new
             * BigInteger(String.valueOf(indiceRotacao)) .mod(new
             * BigInteger(String.valueOf(Constants.NUM_DIAS_SEMANA)))
             * .intValue(); if (indiceDescanso == 0 || indiceDescanso == 1) {
    ...
    public int calcularIndiceDescanso(int indiceRotacao) {
        ...
        try {
            indiceDescanso = new BigInteger(String.valueOf(indiceRotacao)).mod(
                    new BigInteger(String.valueOf(Constants.NUM_DIAS_SEMANA))).intValue();
    ...
    public boolean desassociarHorarioExcepcaoRegime(int codigoInternoHorario, int codigoInternoRegime) {
        ...
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("DELETE FROM ass_HORARIOEXCEPCAO_REGIME "
    ...
    public boolean desassociarHorarioRegime(int codigoInternoHorario, int codigoInternoRegime) {
        boolean resultado = false;
        try {
            PreparedStatement sql = UtilRelacional.prepararComando("DELETE FROM ass_HORARIO_REGIME "
                    + "WHERE chaveHorario=? AND chaveRegime=?");
            sql.setInt(1, codigoInternoHorario);
            sql.setInt(2, codigoInternoRegime);
    ...
    public boolean escreverExcepcaoHorario(Horario horario) {
        ...
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("INSERT INTO ass_HORARIO_EXCEPCAO "
                            + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    public boolean escreverHorario(Horario horario) {
        ...
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("INSERT INTO ass_HORARIO "
                            + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    public boolean escreverRotacoes(List rotacaoHorario) {
        ...
        try {
            ...
            while (iterador.hasNext()) {
                ...
                sql = UtilRelacional.prepararComando("SELECT * FROM ass_HORARIO_TIPO "
                        + "WHERE sigla = ?");
    ...
    public Horario lerExcepcaoHorario(int codigoInterno) {
        ...
        try {
            PreparedStatement sql = UtilRelacional.prepararComando("SELECT * FROM ass_HORARIO_EXCEPCAO "
                    + "WHERE codigoInterno = ?");
            ...
            if (resultado.next()) {
                ...
                horario = new Horario(resultado.getInt("codigoInterno"), resultado
                        ...
                        null, java.sql.Date.valueOf(resultado.getString("dataInicio")), dataFim,
                        resultado.getInt("numDias"), resultado.getInt("posicao"), trabalhoConsecutivo,
                        resultado.getInt("quem"), resultado.getTimestamp("quando"));
            }
            sql.close();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public Horario lerExcepcaoHorarioPorNumMecanografico(int numMecanografico, Timestamp dataConsulta) {
        //ATENCAO: esta função é idêntica à função
        // lerHorarioPorNumMecanografico
        Horario horario = null;
        try {
            PreparedStatement sql = UtilRelacional
            ...
            sql = UtilRelacional
                    .prepararComando("SELECT dataInicio FROM ass_HORARIO_EXCEPCAO "
            ...
            sql = UtilRelacional
                    .prepararComando("SELECT MAX(numDias+posicao) FROM ass_HORARIO_EXCEPCAO "
            ...
            int indiceRotacao = calcularIndiceRotacao(numDiasRotacao, dataInicioHorario,
                    new java.util.Date(dataConsulta.getTime()));

            // horário a ser cumprido agora
            sql = UtilRelacional.prepararComando("SELECT * FROM ass_HORARIO_EXCEPCAO "
                    + "WHERE chaveFuncionario = ? "
            ...
            if (resultado.next()) {
                ...
                horario = new Horario(resultado.getInt("codigoInterno"), resultado
                        ...
                        .getTimestamp("fimRefeicao"), descontoObrigatorio, descontoMinimo, resultado
                        .getTimestamp("inicioExpediente"), resultado.getTimestamp("fimExpediente"),
                        null, dataInicioHorario, dataFim, resultado.getInt("numDias"), resultado
            ...
            e.printStackTrace();
            System.out.println("HorarioRelacional.lerExcepcaoHorarioPorNumMecanografico: "
                    + e.toString());
        }
        return horario;
        ...
        try {
            ...
            while (resultado.next()) {
                ...
                listaHorarios.add(new Horario(resultado.getInt("codigoInterno"), resultado
                        ...
                        .getTimestamp("fimRefeicao"), descontoObrigatorio, descontoMinimo, resultado
                        .getTimestamp("inicioExpediente"), resultado.getTimestamp("fimExpediente"),
                        null, java.sql.Date.valueOf(resultado.getString("dataInicio")), null, resultado
                                .getInt("numDias"), resultado.getInt("posicao"), trabalhoConsecutivo,
                        resultado.getInt("quem"), resultado.getTimestamp("quando")));
            }
            sql.close();
        } catch (Exception e) {
            e.printStackTrace();
            System.out.println("HorarioRelacional.lerExcepcoesHorarioPorNumMecanografico: "
                    + e.toString());
        }
    ...
    public List lerHistoricoHorarioPorNumMecanografico(int numMecanografico) {
        ...
        try {
            ...
            //ATENCAO: atencao aos horarios rotativos no metodo
            ...
            while (resultado.next()) {
                ...
                historicoHorario.add(new Horario(resultado.getInt("codigoInterno"), resultado
                        .getInt("chaveHorarioTipo"), resultado.getInt("chaveFuncionario"), resultado
                        .getString("sigla"), resultado.getString("modalidade"), resultado
                        .getFloat("duracaoSemanal"), resultado.getTimestamp("inicioPF1"), resultado
                        .getTimestamp("fimPF1"), resultado.getTimestamp("inicioPF2"), resultado
            ...
            e.printStackTrace();
            System.out.println("HorarioRelacional.lerHistoricoHorarioPorNumMecanografico: "
                    + e.toString());
        }
    ...
    public Horario lerHorarioPorNumFuncionario(int numMecanografico, Timestamp dataConsulta) {
        ...
        try {
            ...
            // data de inicio do horário
            sql = UtilRelacional
                    .prepararComando("SELECT dataInicio FROM ass_HORARIO "
                            + "WHERE chaveFuncionario = ? "
                            + "AND ((dataFim IS NOT NULL AND ? BETWEEN dataInicio AND dataFim) OR (dataFim IS NULL AND ? >= dataInicio))");
            sql.setInt(1, chaveFuncionario);
            sql.setDate(2, new java.sql.Date(dataConsulta.getTime()));
            ...
            //número de dias da rotação
            sql = UtilRelacional.prepararComando("SELECT MAX(numDias+posicao) FROM ass_HORARIO "
                    + "WHERE chaveFuncionario = ? " + "AND dataInicio = ?");
            sql.setInt(1, chaveFuncionario);
            sql.setDate(2, new java.sql.Date(dataInicioHorario.getTime()));
            resultado = sql.executeQuery();
            ...
            indiceRotacao = calculaIndiceReferenciaDescanso(indiceRotacao, indiceDescanso,
                    numDiasRotacao);
            ...
            e.printStackTrace();
            //System.out.println("HorarioRelacional.lerHorarioPorNumFuncionario:
            // " + e.toString());
        }
        return horario;
    ...
    public List lerHorariosPorNumMecanografico(int numMecanografico, Date dataInicio, Date dataFim) {
        ...
        try {
            ...
            if (dataFim != null) {
                ...
                sql = UtilRelacional.prepararComando("SELECT * FROM ass_HORARIO "
                        + "WHERE chaveFuncionario = ? " + "AND (? BETWEEN dataInicio AND dataFim)");
    ...
    public List lerRegimes(int chaveHorario) {
        ...
        try {
            PreparedStatement sql = UtilRelacional.prepararComando("SELECT * FROM ass_HORARIO_REGIME "
                    + "WHERE chaveHorario = ?");
    ...
    public List lerRegimesHorarioExcepcao(int chaveHorario) {
        ...
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("SELECT * FROM ass_HORARIOEXCEPCAO_REGIME "
                            + "WHERE chaveHorario = ?");
    ...
    public HashMap lerRegimesRotacoes(List rotacaoHorario) {
        ...
        try {
            ...
            PreparedStatement sql = UtilRelacional
                    .prepararComando("SELECT * FROM ass_HORARIOTIPO_REGIME WHERE chaveHorarioTipo = ?");
            PreparedStatement sql2 = UtilRelacional
                    .prepararComando("SELECT designacao FROM regime WHERE codigoInterno = ?");
            ...
            while (iterador.hasNext()) {
                ...
                regimesRotacaoHorario.put(new Integer(horario.getChaveHorarioTipo()),
                        ((ArrayList) listaRegimes).clone());
            }
            sql2.close();
            sql.close();
        } catch (Exception e) {
    ...
    public List lerTodosHorariosExcepcaoComRegime(int chaveRegime, List listaHorariosTipoComRegime,
        ...
        try {
            ...
            if (dataFim != null) {
                query = query
                        .concat("WHERE (dataFim IS NOT NULL AND ((dataInicio BETWEEN ? AND ?) OR (dataFim BETWEEN ? AND ?) OR (dataInicio <= ? AND dataFim >= ?))) ");
            } else {
                query = query
                        .concat("WHERE ((dataFim IS NOT NULL AND ? BETWEEN dataInicio AND dataFim) OR (dataFim IS NULL)) ");
            }
    ...
    public List lerTodosHorariosComRegime(int chaveRegime, List listaHorariosTipoComRegime,
        ...
        try {
            //construção da query
            String query = new String("SELECT ass_HORARIO.* FROM ass_HORARIO "
    ...
    public int ultimoCodigoInterno() {
        ...
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("SELECT MAX(codigoInterno) FROM ass_HORARIO");
    ...
    public int ultimoCodigoInternoExcepcaoHorario() {
        ...
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("SELECT MAX(codigoInterno) FROM ass_HORARIO_EXCEPCAO");
    ...
    public Horario existeExcepcaoHorario(Horario horario) {
        ...
        try {
            PreparedStatement sql = UtilRelacional.prepararComando("SELECT * FROM ass_HORARIO_EXCEPCAO "
                    + "WHERE chaveFuncionario = ? " + "AND dataInicio = ? " + "AND numDias = ? "
                    + "AND posicao = ?");
            ...
            if (resultado.next()) {
                ...
                horarioBD = new Horario(resultado.getInt("codigoInterno"), resultado
                        .getInt("chaveHorarioTipo"), resultado.getInt("chaveFuncionario"), resultado
                        .getString("sigla"), resultado.getString("modalidade"), resultado
                        .getFloat("duracaoSemanal"), resultado.getTimestamp("inicioPF1"), resultado
                        .getTimestamp("fimPF1"), resultado.getTimestamp("inicioPF2"), resultado
