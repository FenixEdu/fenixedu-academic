 ...
 * <li>{@linkplain #setLinkFormat(String, String) link}</li>
 * </ul>
 * 
    ...
    public class CollectionTabularLayout extends TabularLayout {
        ...
        private List<MetaObject> getMetaObjects(Collection collection) {
            ...
            if (contextMetaObject instanceof MultipleMetaObject) {
                // reuse meta objects
                MultipleMetaObject multipleMetaObject = (MultipleMetaObject) getContext()
                        .getMetaObject();
        ...
        protected HtmlComponent generateLinkComponent(MetaObject object, int rowIndex, int number) {
            ...
            if (tableLink.getLinkFormat() != null) {
                link.setUrl(RenderUtils.getFormatedProperties(tableLink.getLinkFormat(), object
                        .getObject()));
            } else {
