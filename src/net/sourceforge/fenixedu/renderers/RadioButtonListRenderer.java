 ...
 * list item will contain the presentation of the object and a radio button that
 ...
 * Example:
 * <form>
 *      <input type="radio" name="option"/><em>&lt;object A presentation&gt;</em><br/>
    ...
    class RadioButtonListLayout extends Layout {
        ...
        public HtmlComponent createComponent(Object object, Class type) {
            ...
            for (MetaObject metaObject : possibleMetaObjects) {
                ...
                HtmlRadioButton radioButton = listComponent.addOption(label, key.toString());
