...
public class UIDegreeModule extends UIInput {
    ...
    protected ExecutionPeriod lastExecutionPeriod;
	...
	if (this.executionYear != null) {
	    encodeLink(module + "/curricularRules/editCurricularRule.faces", "&curricularRuleID="
		    + curricularRule.getIdInternal(), false, "edit");
	    writer.append(", ");
	}
