...
public class JsfRenderUtils {
    ...
    public static void addEventHandlingHiddenFieldsIfNotExists(FacesContext context,
    ...
    private static void renderEmptyHiddenField(String clientId, ResponseWriter writer)
            throws IOException {
    ...
    public static String getEventArgumentHiddenFieldId(String formClientId) {
        ...
        String eventArgumentHiddenFieldFinalId = formClientId
                + JsfRenderConstants.EVENT_ARGUMENT_HIDDEN_FIELD_SUFFIX;
    ...
    public static String getEventArgumentHiddenFieldRenderedAttributeName(String formClientId) {
        ...
        String eventArgumentHiddenFieldRenderedAttributeName = formClientId
                + JsfRenderConstants.EVENT_ARGUMENT_HIDDEN_FIELD_RENDERED_SUFFIX;
    ...
    public static String getSubmitJavaScriptWithArgument(FacesContext context, UIComponent component,
        ...
        onClickEvent.append("document.forms['").append(parentFormClientId).append("'].elements['");
        onClickEvent.append(eventArgumentHiddenFieldId).append("'].value='").append(eventArgument)
                .append("';");
    ...
    public static String getSubmitJavaScriptWithParameters(FacesContext context, UIComponent component,
        ...
        for (int i = 0; i < uiParameterList.size(); i++) {
            ...
            setParametersJavaScript.append("document.forms['").append(parentFormClientId).append(
                    "'].elements['").append(parameter.getName()).append("'].value='").append(
    ...
    private static void addHiddenFieldForParameterIfNotExists(String parentFormClientId,
            HttpServletRequest request, ResponseWriter writer, String parameterName) throws IOException {

        String renderedAttribute = parentFormClientId + parameterName
                + JsfRenderConstants.PARAMETER_HIDDEN_FIELD_RENDERED_SUFFIX;
    ...
    public static void addHiddenFieldsForParametersIfNotExists(FacesContext context,
            UIComponent parentComponent, List<UIParameter> uiParameters) throws IOException {
        ...
        for (int i = 0; i < uiParameters.size(); i++) {
            ...
            addHiddenFieldForParameterIfNotExists(parentFormClientId, request, writer, parameter
                    .getName());
        }
    }
