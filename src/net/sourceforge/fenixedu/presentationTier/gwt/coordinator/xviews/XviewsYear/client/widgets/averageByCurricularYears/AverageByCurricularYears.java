...
public class AverageByCurricularYears extends Raphael {
    ...
    public AverageByCurricularYears(XviewsYear window, int width, int height, int numberOfCurricularYears, double[] averageData,
            String yearTag) {
    ...
    public void onLoad() {
        super.onLoad();
        final Text title = new Text(20, 25, window.getBundle().averageByCurricularYear());
        ...
        if (1 <= numberOfCurricularYears) {
            ...
            final Text firstTotals =
                    new Text(textCoords[0][2], textCoords[0][3], (averageData[0] == 0.0 ? "" : Double.toString(averageData[0])));
        ...
        if (2 <= numberOfCurricularYears) {
            ...
            final Text secondTotals =
                    new Text(textCoords[1][2], textCoords[1][3], (averageData[1] == 0.0 ? "" : Double.toString(averageData[1])));
        ...
        if (3 <= numberOfCurricularYears) {
            ...
            final Text thirdTotals =
                    new Text(textCoords[2][2], textCoords[2][3], (averageData[2] == 0.0 ? "" : Double.toString(averageData[2])));
        ...
        if (4 <= numberOfCurricularYears) {
            ...
            final Text fourthTotals =
                    new Text(textCoords[3][2], textCoords[3][3], (averageData[3] == 0.0 ? "" : Double.toString(averageData[3])));
        ...
        if (5 <= numberOfCurricularYears) {
            ...
            final Text fifthTotals =
                    new Text(textCoords[4][2], textCoords[4][3], (averageData[4] == 0.0 ? "" : Double.toString(averageData[4])));
