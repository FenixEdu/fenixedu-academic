...
public class BranchCourseGroupManagementBackingBean extends CourseGroupManagementBackingBean {
	...
	try {
	    executeCreation(getDegreeCurricularPlanID(), getParentCourseGroupID(), getName(), getNameEn(), 
    ...
    private void executeCreation(final Integer degreeCurricularPlanID, final Integer parentCourseGroupID, final String name,
	    final String nameEn, final BranchType branchType, final Integer beginExecutionPeriodID, final Integer endExecutionPeriodID)
	...
	degreeCurricularPlan.createBranchCourseGroup(parentCourseGroup, name, nameEn, branchType, beginExecutionPeriod, endExecutionPeriod);
    }
