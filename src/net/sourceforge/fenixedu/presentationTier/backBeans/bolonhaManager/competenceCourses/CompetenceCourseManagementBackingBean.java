...
public class CompetenceCourseManagementBackingBean extends FenixBackingBean {
	...
	return (bibliographicReferenceID == null) ? (bibliographicReferenceID = getAndHoldIntegerParameter("bibliographicReferenceID"))
		: bibliographicReferenceID;
    }
	...
	return (getCompetenceCourse().getBibliographicReferences(getAssociatedExecutionPeriod()) == null) ? null
		: getCompetenceCourse().getBibliographicReferences(getAssociatedExecutionPeriod())
	...
	try {
	    if (isCompetenceCourseLevelValid()) {
		final Object args[] = { getCompetenceCourseID(), getName(), getNameEn(), getBasic(),
	...
	final Object args[] = { getCompetenceCourseID(), getObjectives(), getProgram(), getEvaluationMethod(), getObjectivesEn(),
	...
	try {
	    final Object[] args = { getCompetenceCourseID(), getYear(), getTitle(), getAuthor(), getReference(),
	...
	try {
	    final Object[] args = { getCompetenceCourseID(), getBibliographicReferenceID(), getYear(), getTitle(), getAuthor(),
	...
	try {
	    CurricularStage changed = (getCompetenceCourse().getCurricularStage().equals(CurricularStage.PUBLISHED) ? CurricularStage.APPROVED
