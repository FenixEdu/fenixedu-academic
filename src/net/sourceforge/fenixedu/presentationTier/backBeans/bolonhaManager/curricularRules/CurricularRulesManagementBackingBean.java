...
public class CurricularRulesManagementBackingBean extends FenixBackingBean {
	...
	return (degreeModule == null) ? (degreeModule = rootDomainObject.readDegreeModuleByOID(getDegreeModuleID()))
		: degreeModule;
    }

    public DegreeCurricularPlan getDegreeCurricularPlan() {
	return (degreeCurricularPlan == null) ? (degreeCurricularPlan = rootDomainObject
		.readDegreeCurricularPlanByOID(getDegreeCurricularPlanID())) : degreeCurricularPlan;
    }
	...
	return (curricularRule == null) ? (curricularRule = rootDomainObject.readCurricularRuleByOID(getCurricularRuleID()))
		: curricularRule;
    }
	...
	if (getViewState().getAttribute("selectedDegreeID") == null) {
	    if (getCurricularRule() != null && getCurricularRule() instanceof AnyCurricularCourse) {
		AnyCurricularCourse anyCurricularCourse = (AnyCurricularCourse) getCurricularRule();
		setSelectedDegreeID(anyCurricularCourse.getDegree() != null ? anyCurricularCourse.getDegree().getIdInternal()
			: Integer.valueOf(0));
	    } else {
	...
	final ExecutionSemester currentExecutionPeriod = degreeModule != null ? degreeModule.getMinimumExecutionPeriod()
	...
	return (getViewState().getAttribute("endExecutionPeriodID") == null || getViewState()
		.getAttribute("endExecutionPeriodID").equals(NO_SELECTION_INTEGER)) ? null : (Integer) getViewState()
		.getAttribute("endExecutionPeriodID");
    }
	...
	parametersDTO.setContextCourseGroupID((getSelectedContextCourseGroupID() == null || getSelectedContextCourseGroupID()
		.equals(NO_SELECTION_INTEGER)) ? null : getSelectedContextCourseGroupID());
	...
	parametersDTO
		.setSelectedDegreeID((getSelectedDegreeID() == null || getSelectedDegreeID().equals(NO_SELECTION_INTEGER)) ? null
			: getSelectedDegreeID());
	parametersDTO.setSelectedDepartmentUnitID((getSelectedDepartmentUnitID() == null || getSelectedDepartmentUnitID().equals(
		NO_SELECTION_INTEGER)) ? null : getSelectedDepartmentUnitID());
	parametersDTO
		.setDegreeType((getSelectedDegreeType() == null || getSelectedDegreeType().equals(NO_SELECTION_STRING)) ? null
			: DegreeType.valueOf(getSelectedDegreeType()));
