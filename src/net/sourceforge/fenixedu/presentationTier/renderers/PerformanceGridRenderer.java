...
public class PerformanceGridRenderer extends OutputRenderer {
	...
	protected HtmlComponent getComponent(int rowIndex, int columnIndex) {
		...
		double approvedSemesterECTS = (getSemester(columnIndex) == 1 ? yearBean.getApprovedFirstSemesterECTS() : yearBean
			.getApprovedSecondSemesterECTS());
		double enrolledSemesterECTS = (getSemester(columnIndex) == 1 ? yearBean.getEnrolledFirstSemesterECTS() : yearBean
		...
		if (enrolledSemesterECTS > 0.0) {
		    HtmlText textECTS = new HtmlText("<br/> " + Double.toString(approvedSemesterECTS) + " / "
