 ...
 * presented as
 * a simple string. The string to be presented is determined by the logic in {@link MultiLanguageString#getContent()}.
 * Additionally you can override the
 * language in which the content is to be displayed with the {@link #setLanguage(String) language} property. In this case the
 * content to
 * be presented will be determined by {@link MultiLanguageString#getContent(Language)}
 * 
 * @author cfgi
 * @author cgmp
 */
public class MultiLanguageStringRenderer extends StringRenderer {
	...
	/**
	 * Allows you to override the language in wich the <tt>MultiLanguageString</tt> content will be presented.
	 * 
	 * @property
	 */
