...
public class TestElementSummaryRenderer extends Renderer {
    ...
    static {
	templateMap.put(NewAtomicQuestion.class, "/teacher/tests/templates/questionBank/simpleAtomicQuestionTemplate.jsp");
	...
	templateMap.put(NewChoice.class, "/teacher/tests/templates/questionBank/simpleChoiceTemplate.jsp");
	templateMap.put(NewQuestionGroup.class, "/teacher/tests/templates/questionBank/simpleQuestionGroupTemplate.jsp");
	templateMap.put(NewAllGroup.class, "/teacher/tests/templates/questionBank/simpleAllGroupTemplate.jsp");
    }
