...
public class ModelRestrictionSortRenderer extends Renderer {
    ...
    static {
	templateMap.put(NewModelGroup.class, "/teacher/tests/templates/testModel/sort/modelGroup.jsp");
	templateMap.put(NewModelRestriction.class, "/teacher/tests/templates/testModel/sort/modelRestriction.jsp");
	templateMap.put(NewTestModel.class, "/teacher/tests/templates/testModel/sort/testModel.jsp");
    }
