...
/**
 * This renderer provides a way of asking the user for a color using a color
 * picker.
 * 
 * @author cfgi
 */
public class ColorInputRenderer extends StringInputRenderer {
	...
	script.setScript(String.format("new Control.ColorPicker('%s', { IMAGE_BASE : '%s' });", input.getId(), link
		.calculateUrl()));
