...
public class VigilantsInGroupRender extends InputRenderer {
	...
	protected HtmlComponent getComponent(int rowIndex, int columnIndex) {
		...
		if (bean.isBounded()) {
			...
			HtmlText text = new HtmlText(RenderUtils.getResourceString("VIGILANCY_RESOURCES", ((vigilantWrapper
				.getConvokable())) ? "label.vigilancy.convokable.abbr" : "label.vigilancy.notConvokable.abbr"),
				false);
