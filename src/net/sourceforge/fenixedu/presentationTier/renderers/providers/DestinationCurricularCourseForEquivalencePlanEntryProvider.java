...
public class DestinationCurricularCourseForEquivalencePlanEntryProvider implements DataProvider {
	...
	curricularCourses.removeAll(courseEquivalencePlanEntryCreator.getDestinationCurricularCourses());
