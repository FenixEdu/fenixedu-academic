...
public class MultiLanguageRichTextInputRenderer extends MultiLanguageTextInputRenderer {
	...
	if (isShowEditorOptions()) {
	    ...
	    this.useEditor = radioList.addOption(new HtmlText(RenderUtils.getResourceString("renderers.rich-text.editor.add")),
		    "activate");
	    this.removeEditor = radioList.addOption(new HtmlText(RenderUtils
