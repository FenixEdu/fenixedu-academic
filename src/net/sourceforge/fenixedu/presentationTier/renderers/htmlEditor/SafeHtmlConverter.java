...
public class SafeHtmlConverter extends TidyConverter {
	...
	List<String> forbiddenElements = Arrays.asList(new String[] { "script", "iframe", "element", "applet", "form", "frame",
		"frameset", "link", "style", "embed" });
	...
	List<String> eventsAttributes = Arrays.asList(new String[] { "onabort", "onblur", "onchange", "onclick", "ondblclick",
