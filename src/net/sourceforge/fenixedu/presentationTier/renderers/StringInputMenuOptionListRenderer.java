...
/**
 * This renderer allows you to choose one string from a list of strings by using
 * a menu. It also offers an option to manually insert a new value through a
 * text field.
 * <p>
 * Example: <select> <option>-</option> <option>a</option> <option>b</option>
 * <option>c</option> <option selected="selected">other</option> </select>
 * <input type="text"/>
 * 
 * @author cfgi
 */
