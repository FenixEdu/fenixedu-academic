...
public class FenixGWTServlet extends RemoteServiceServlet {
	...
	try {
	     ...
	     * to determine the <code>SerializationPolicy</code>. Eventual overrides of <code>onAfterRequestDeserialized(rpcRequest);</code>
	     * should be implemented in this class.
	     */
	    String result = RPC.invokeAndEncodeResponse(remoteService, rpcRequest.getMethod(),
