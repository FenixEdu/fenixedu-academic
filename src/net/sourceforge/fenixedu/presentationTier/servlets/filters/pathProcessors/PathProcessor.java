...
public abstract class PathProcessor {
	 ...
	 * 
	 * @param forwardURI
	 *            the URI were the user will be forwarded by default when {@link #doForward(ProcessingContext, Object[])} is
	 *            called
	 */
	 ...
	 * forward the user to the desired page. This normally happens when {@link PathElementsProvider#hasNext()} is
	 * <code>false</code>, that is,
	...
	/**
	 * This method is a convenience method for {@link #doForward(ProcessingContext, String, Object[])} where the URI
	 ...
	 * given args. This allow you to have an URI like <code>"/path.do?id=%s"</code> and provide the value for the id parameter
	 * when redirecting.
	 * 
	 * @param context
	 *            the current context
