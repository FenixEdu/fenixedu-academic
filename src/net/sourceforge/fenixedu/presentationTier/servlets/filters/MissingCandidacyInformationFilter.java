...
public class MissingCandidacyInformationFilter implements Filter {
	...
	if (AccessControl.getPerson() != null && AccessControl.getPerson().hasStudent()) {
	    ...
	    final Boolean validCandidacyInformation = (Boolean) request.getSession()
		    .getAttribute(CANDIDACY_INFORMATION_VALID_KEY);
	    ...
	    final FilterFunctionalityContext context = new FilterFunctionalityContext((HttpServletRequest) servletRequest,
		    contents);
