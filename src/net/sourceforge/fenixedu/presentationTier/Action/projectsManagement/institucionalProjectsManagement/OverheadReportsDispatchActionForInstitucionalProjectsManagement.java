...
@Mapping(module = "institucionalProjectsManagement", path = "/overheadReport", attribute = "rubricForm", formBean = "rubricForm",
...
public class OverheadReportsDispatchActionForInstitucionalProjectsManagement extends
