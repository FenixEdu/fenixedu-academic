...
@Mapping(module = "istidProjectsManagement", path = "/projectReport", attribute = "rubricForm", formBean = "rubricForm", scope = "request", parameter = "method")
@Forwards(value = {
...
public class ProjectReportsDispatchActionForISTIDProjectsManagement extends net.sourceforge.fenixedu.presentationTier.Action.projectsManagement.ProjectReportsDispatchAction {
}