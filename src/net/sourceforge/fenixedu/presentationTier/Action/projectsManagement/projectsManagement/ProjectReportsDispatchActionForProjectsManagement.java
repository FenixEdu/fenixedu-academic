...
@Mapping(module = "projectsManagement", path = "/projectReport", attribute = "rubricForm", formBean = "rubricForm", scope = "request", parameter = "method")
@Forwards(value = {
...
public class ProjectReportsDispatchActionForProjectsManagement extends net.sourceforge.fenixedu.presentationTier.Action.projectsManagement.ProjectReportsDispatchAction {
}