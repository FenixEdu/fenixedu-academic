...
public class SpecialSeasonStatusTrackerRegisterBean implements Serializable{
    ...
    public static final Comparator<SpecialSeasonStatusTrackerRegisterBean> COMPARATOR_STUDENT_NUMBER = new Comparator<SpecialSeasonStatusTrackerRegisterBean>() {

	@Override
	public int compare(final SpecialSeasonStatusTrackerRegisterBean es1, final SpecialSeasonStatusTrackerRegisterBean es2) {
    ...
    public static final Comparator<SpecialSeasonStatusTrackerRegisterBean> COMPARATOR_STUDENT_NAME = new Comparator<SpecialSeasonStatusTrackerRegisterBean>() {
    ...
    public static final Comparator<SpecialSeasonStatusTrackerRegisterBean> COMPARATOR_DEGREE = new Comparator<SpecialSeasonStatusTrackerRegisterBean>() {
    ...
    public static final Comparator<SpecialSeasonStatusTrackerRegisterBean> COMPARATOR_COURSE = new Comparator<SpecialSeasonStatusTrackerRegisterBean>() {
