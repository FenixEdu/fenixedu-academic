...
@Forwards({
	@Forward(name = "selectCourse", path = "/departmentAdmOffice/lists/specialSeason/selectCourse.jsp", tileProperties = @Tile(title = "private.administrationofcreditsofdepartmentteachers.lists.enrollmentsinspecialseason")),
	@Forward(name = "listStudents", path = "/departmentAdmOffice/lists/specialSeason/listStudents.jsp", tileProperties = @Tile(title = "private.administrationofcreditsofdepartmentteachers.lists.enrollmentsinspecialseason")) })
