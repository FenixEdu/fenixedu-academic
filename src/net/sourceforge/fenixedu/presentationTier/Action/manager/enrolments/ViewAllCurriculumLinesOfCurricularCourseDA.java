...
@Mapping(path = "/viewAllCurriculumLinesOfCurricularCourse", module = "manager")
@Forwards({ @Forward(name = "viewCurriculumLinesOfCurricularCourse", path = "/manager/bolonha/enrolments/information/viewCurriculumLinesOfCurricularCourse.jsp") })
