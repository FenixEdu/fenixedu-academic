...
@Mapping(module = "manager", path = "/insertDegreeCurricularPlan", input = "/insertDegreeCurricularPlan.do?method=prepareInsert&page=0", attribute = "degreeCurricularPlanForm", formBean = "degreeCurricularPlanForm", scope = "request", parameter = "method")
@Forwards(value = {
		@Forward(name = "insertDegreeCurricularPlan", path = "/manager/insertDegreeCurricularPlan_bd.jsp", tileProperties = @Tile(navLocal = "/manager/degreeNavLocalManager.jsp")),
