...
import net.sourceforge.fenixedu.applicationTier.Servico.manager.precedences.DeleteRestrictionFromDegreeCurricularPlan;
...
@Mapping(module = "manager", path = "/deleteRestriction", input = "df.page.manage.precedences", scope = "request")
@Forwards(value = { @Forward(name = "showPrecedences", path = "/manager/precedences/managePrecedences.jsp", tileProperties = @Tile(navLocal = "/manager/degreeCurricularPlanNavLocalManager.jsp")) })
