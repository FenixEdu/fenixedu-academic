...
@Mapping(
		module = "operator",
		path = "/curricularCoursesCompetenceCourse",
		attribute = "curricularCoursesCompetenceCourseForm",
		formBean = "curricularCoursesCompetenceCourseForm",
		scope = "request",
		parameter = "method")
@Forwards(value = { @Forward(name = "chooseCurricularCourses", path = "df.page.chooseCurricularCourses"),
...
public class CurricularCourseCompetenceCourseDispatchActionForOperator extends
