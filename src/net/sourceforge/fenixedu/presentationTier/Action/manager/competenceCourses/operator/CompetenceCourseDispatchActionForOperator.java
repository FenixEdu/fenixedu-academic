...
@Mapping(
		module = "operator",
		path = "/competenceCourseManagement",
		input = "/competenceCourseManagement.do?method=showAllCompetences",
		attribute = "competenceCourseForm",
		formBean = "competenceCourseForm",
		scope = "request",
		parameter = "method")
@Forwards(value = {
		@Forward(name = "readCompetenceCourses", path = "/competenceCourseManagement.do?method=showDepartmentCompetenceCourses"),
		@Forward(
				name = "showCompetenceCourses",
				path = "/manager/competenceCourse/showAllCompetenceCourses_bd.jsp",
				tileProperties = @Tile(navLocal = "/operator/competenceCourse/mainMenu.jsp")),
...
public class CompetenceCourseDispatchActionForOperator extends
