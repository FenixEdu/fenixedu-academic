...
@Mapping(module = "manager", path = "/competenceCourseManagement", input = "/competenceCourseManagement.do?method=showAllCompetences", attribute = "competenceCourseForm", formBean = "competenceCourseForm", scope = "request", parameter = "method")
@Forwards(value = {
...
public class CompetenceCourseDispatchActionForManager extends net.sourceforge.fenixedu.presentationTier.Action.manager.competenceCourses.CompetenceCourseDispatchAction {
}