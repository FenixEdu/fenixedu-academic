...
@Forwards(value = {
	@Forward(name = "visualizePersonalInformation", path = "/personnelSection/people/viewPerson.jsp", tileProperties = @Tile(title = "private.staffarea.interfacegiaf.interfacegiaf.searchpeople")),
	@Forward(name = "editPartyContact", path = "/manager/personManagement/contacts/editPartyContact.jsp", tileProperties = @Tile(title = "private.staffarea.interfacegiaf.interfacegiaf.searchpeople")),
	@Forward(name = "createPartyContact", path = "/manager/personManagement/contacts/createPartyContact.jsp", tileProperties = @Tile(title = "private.staffarea.interfacegiaf.interfacegiaf.searchpeople")) })
