...
public class ManageSitesDA extends SiteManagementDA {
    ...
    public ActionForward manageSite(ActionMapping mapping, ActionForm actionForm,
	...
	if (type == null) {
	    ...
	    Site site = (Site) ServiceUtils.executeService(getUserView(request),
		    "CreateSiteTemplateInstance", type);
    ...
    // public ActionForward prepareCreateFunctionalitySection(ActionMapping
    ...
    //            
    // request.setAttribute("creator", new
        // FunctionalitySectionCreator(site));
    // } else {
    // request.setAttribute("creator", new
        // FunctionalitySectionCreator(section));
    // }
    //
    // return mapping.findForward("chooseFunctionality");
    // }

    public ActionForward functionalitySection(ActionMapping mapping, ActionForm actionForm,
	    HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    public ActionForward editFunctionalitySection(ActionMapping mapping, ActionForm actionForm,
	    HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    public ActionForward prepareChooseBaseModule(ActionMapping mapping, ActionForm actionForm,
	    HttpServletRequest request, HttpServletResponse response) throws Exception {
