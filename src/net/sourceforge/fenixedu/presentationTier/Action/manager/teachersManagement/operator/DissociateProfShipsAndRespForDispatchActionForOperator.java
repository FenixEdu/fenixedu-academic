...
@Mapping(
		module = "operator",
		path = "/dissociateProfShipsAndRespFor",
		input = "/dissociateProfShipsAndRespFor.do?method=prepareDissociateEC&page=0",
...
@Forwards(
		value = {
				...
				@Forward(
						name = "prepareDissociateECShowProfShipsAndRespFor",
						path = "df.page.prepareDissociateECShowProfShipsAndRespFor") })
public class DissociateProfShipsAndRespForDispatchActionForOperator extends
