...
@Forwards(value = { @Forward(name = "readExecutionCourseTeachers", path = "/scientificCouncil/credits/readTeachers_bd.jsp", tileProperties = @Tile(title = "private.scientificcouncil.teachers")) })
