...
@Mapping(
		module = "manager",
		path = "/manageRegistrationState",
		input = "/manageRegistrationState.do?method=prepare",
		attribute = "deleteregistrationActualInfoForm",
		formBean = "deleteregistrationActualInfoForm",
		scope = "request",
		parameter = "method")
