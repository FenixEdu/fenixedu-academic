...
@Mapping(module = "manager", path = "/studentsManagement", input = "/studentsManagement.do?method=show&page=0", attribute = "studentCurricularPlanForm", formBean = "studentCurricularPlanForm", scope = "request", parameter = "method")
@Forwards(value = {
...
public class ManageStudentCurricularPlanDAForManager extends net.sourceforge.fenixedu.presentationTier.Action.manager.ManageStudentCurricularPlanDA {
}