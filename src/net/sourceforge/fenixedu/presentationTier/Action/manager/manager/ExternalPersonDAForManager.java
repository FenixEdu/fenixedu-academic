...
@Mapping(module = "manager", path = "/externalPerson", input = "/externalPerson.do?method=prepareCreate", scope = "request", parameter = "method")
@Forwards(value = {
		@Forward(name = "showCreateForm", path = "/manager/createExternalPerson.jsp"),
