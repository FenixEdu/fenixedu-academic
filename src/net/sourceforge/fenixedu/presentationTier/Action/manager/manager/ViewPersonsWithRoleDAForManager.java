...
@Mapping(module = "manager", path = "/viewPersonsWithRole", input = "/viewPersonsWithRole.do?method=prepare", scope = "request", validate = false, parameter = "method")
@Forwards(value = {
...
public class ViewPersonsWithRoleDAForManager extends net.sourceforge.fenixedu.presentationTier.Action.manager.ViewPersonsWithRoleDA {
}