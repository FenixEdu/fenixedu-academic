...
@Mapping(module = "manager", path = "/manageRoles", input = "/manageRoles.do?method=prepare&page=0", attribute = "rolesForm", formBean = "rolesForm", scope = "request", validate = false, parameter = "method")
@Forwards(value = {
		@Forward(name = "SelectUserPage", path = "/manager/manageRoles_bd.jsp"),
