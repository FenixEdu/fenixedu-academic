...
@Mapping(
		module = "manager",
		path = "/curricularCourseEquivalencies",
		input = "/curricularCourseEquivalencies.do?method=prepare&page=0",
		attribute = "curricularCourseEquivalenciesForm",
		formBean = "curricularCourseEquivalenciesForm",
		scope = "request",
		parameter = "method")
@Forwards(value = { @Forward(name = "showEquivalencies", path = "/manager/equivalences/curricularCourseEquivalencies.jsp"),
...
@Exceptions(value = { @ExceptionHandling(
		...
		scope = "request") })
public class CurricularCourseEquivalenciesDAForManager extends
