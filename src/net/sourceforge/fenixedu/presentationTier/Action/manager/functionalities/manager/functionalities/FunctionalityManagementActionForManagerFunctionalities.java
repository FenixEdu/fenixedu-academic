...
@Mapping(module = "manager/functionalities", path = "/private/functionality", scope = "session", parameter = "method")
@Forwards(value = {
		@Forward(name = "view.module", path = "/manager/functionalities/view-module.jsp"),
...
public class FunctionalityManagementActionForManagerFunctionalities extends net.sourceforge.fenixedu.presentationTier.Action.manager.functionalities.FunctionalityManagementAction {
}