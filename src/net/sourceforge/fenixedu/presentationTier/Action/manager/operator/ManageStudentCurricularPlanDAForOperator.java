...
@Mapping(
		...
		input = "/studentsManagement.do?method=show&page=0",
		attribute = "studentCurricularPlanForm",
...
@Forwards(value = {
		...
		@Forward(name = "show", path = "/manager/studentCurricularPlan.jsp", tileProperties = @Tile(
				title = "private.operator.personnelmanagement.studentmanagement")) })
@Exceptions(value = {
		@ExceptionHandling(
				type = net.sourceforge.fenixedu.applicationTier.Servico.exceptions.NonExistingServiceException.class,
				key = "exception.student.does.not.exist",
				handler = net.sourceforge.fenixedu.presentationTier.config.FenixErrorExceptionHandler.class,
				scope = "request"),
		@ExceptionHandling(
				type = net.sourceforge.fenixedu.applicationTier.Servico.exceptions.ExistingServiceException.class,
		...
		@ExceptionHandling(
				...
				handler = net.sourceforge.fenixedu.presentationTier.config.FenixErrorExceptionHandler.class,
				scope = "request") })
public class ManageStudentCurricularPlanDAForOperator extends
