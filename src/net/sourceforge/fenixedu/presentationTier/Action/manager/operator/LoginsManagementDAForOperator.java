...
@Forwards(value = {
	...
	@Forward(name = "prepareSearchPerson", path = "/manager/loginsManagement/searchPersonToManageLogins.jsp", tileProperties = @Tile(title = "private.operator.systemmanagement.managementlogins")),
