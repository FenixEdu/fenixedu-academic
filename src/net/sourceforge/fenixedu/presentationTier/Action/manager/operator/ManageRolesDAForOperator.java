...
@Mapping(module = "operator", path = "/manageRoles", input = "/manageRoles.do?method=prepare&page=0", attribute = "rolesForm", formBean = "rolesForm", scope = "request", validate = false, parameter = "method")
@Forwards(value = {
