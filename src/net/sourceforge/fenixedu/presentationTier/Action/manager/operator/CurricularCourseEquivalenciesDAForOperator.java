...
@Mapping(module = "operator", path = "/curricularCourseEquivalencies", input = "/curricularCourseEquivalencies.do?method=prepare&page=0", attribute = "curricularCourseEquivalenciesForm", formBean = "curricularCourseEquivalenciesForm", scope = "request", parameter = "method")
@Forwards(value = {
	@Forward(name = "showEquivalencies", path = "/manager/equivalences/curricularCourseEquivalencies.jsp", tileProperties = @Tile(title = "private.operator.equivalences.equivalences")),
