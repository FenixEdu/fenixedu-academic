...
@Forwards({
		...
		@Forward(name = "view-thesis", path = "/scientificCouncil/thesis/viewThesis.jsp", tileProperties = @Tile(
				title = "private.scientificcouncil.dissertations")),
		@Forward(
				name = "list-scientific-comission",
				path = "/scientificCouncil/thesis/listScientificComission.jsp",
				tileProperties = @Tile(title = "private.scientificcouncil.dissertations")),
		@Forward(
				name = "list-thesis-creation-periods",
				path = "/scientificCouncil/thesis/listThesisCreationPeriods.jsp",
				tileProperties = @Tile(title = "private.scientificcouncil.dissertations")),
		@Forward(name = "viewOperationsThesis", path = "/student/thesis/viewOperationsThesis.jsp", tileProperties = @Tile(
				title = "private.scientificcouncil.dissertations")),
		@Forward(
				name = "showDissertationsInfo",
				path = "/scientificCouncil/thesis/showDissertationsInfo.jsp",
				tileProperties = @Tile(title = "private.scientificcouncil.dissertations")),
		...
		@Forward(
				...
				path = "/scientificCouncil/thesis/changeInformationWithDocs.jsp",
				tileProperties = @Tile(title = "private.scientificcouncil.dissertations")),
