...
@Mapping(module = "scientificCouncil", path = "/showFullTeacherCreditsSheet", attribute = "teacherCreditsSheetForm", formBean = "teacherCreditsSheetForm", scope = "request", parameter = "method")
@Forwards(value = {
