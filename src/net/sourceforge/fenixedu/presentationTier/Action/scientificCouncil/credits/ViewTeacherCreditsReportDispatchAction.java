...
public class ViewTeacherCreditsReportDispatchAction extends FenixDispatchAction {
	...
	Map<Department, Map<Unit, List>> teachersCreditsByDepartment = getDetailedTeachersCreditsMap(request, userView,
		fromExecutionYearID, untilExecutionYearID, departmentID);
