...
@Mapping(
		...
		path = "/creditsReport",
		attribute = "creditsReportForm",
		formBean = "creditsReportForm",
		scope = "request",
		parameter = "method")
@Forwards(value = {
		@Forward(
				name = "showCreditsReport",
				path = "/scientificCouncil/credits/showTeachersCreditsReport.jsp",
				tileProperties = @Tile(title = "private.scientificcouncil.credits.report")),
		@Forward(
				name = "showDepartmentCreditsReport",
				path = "/scientificCouncil/credits/showDepartmentGlobalCreditsReport.jsp",
				tileProperties = @Tile(title = "private.scientificcouncil.credits.report")),
