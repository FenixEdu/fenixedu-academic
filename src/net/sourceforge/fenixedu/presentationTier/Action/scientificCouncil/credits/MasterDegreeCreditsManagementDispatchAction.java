...
@Mapping(
		...
		path = "/masterDegreeCreditsManagement",
		input = "/masterDegreeCreditsManagement.do?method=prepareEdit",
...
@Forwards(value = {
		@Forward(
				name = "showCreditsReport",
				path = "/scientificCouncil/credits/showMasterDegreeCreditsReport.jsp",
				tileProperties = @Tile(title = "private.scientificcouncil.credits.releasefor3rdcycle")),
		@Forward(
				name = "chooseMasterDegreeExecution",
				path = "/scientificCouncil/credits/chooseMasterDegreeExecution.jsp",
				tileProperties = @Tile(title = "private.scientificcouncil.credits.releasefor3rdcycle")),
		@Forward(
				name = "editMasterDegreeCredits",
				path = "/scientificCouncil/credits/editMasterDegreeCredits.jsp",
				tileProperties = @Tile(title = "private.scientificcouncil.credits.releasefor3rdcycle")),
		@Forward(
				name = "successfulEdit",
				path = "/masterDegreeCreditsManagement.do?method=viewMasterDegreeCredits",
				tileProperties = @Tile(title = "private.scientificcouncil.credits.releasefor3rdcycle")) })
@Exceptions(value = {
		@ExceptionHandling(
