...
@Forwards(value = {
		@Forward(
				...
				path = "/scientificCouncil/researchActivity/showJournalIssuesToMergeList.jsp",
				tileProperties = @Tile(title = "private.administrator.scientificactivities.mergejournalissues")),
		@Forward(
				name = "show-research-activity-merge-page",
				path = "/scientificCouncil/researchActivity/showJournalIssuesToMerge.jsp",
				tileProperties = @Tile(title = "private.administrator.scientificactivities.mergejournalissues")) })
