...
@Forwards({ @Forward(name = "intro", path = "/scientificCouncil/candidacy/secondCycle/mainCandidacyProcess.jsp", tileProperties = @Tile(  title = "private.scientificcouncil.applications")) })
