...
public class WebSiteAnnouncementManagement extends AnnouncementManagement {
    ...
    protected String getExtraRequestParameters(HttpServletRequest request) {
        return this.getAnnouncementBoardId(request) == null ? "" : "announcementBoardId="
                + this.getAnnouncementBoardId(request);
    }
    ...
    @Override
    public ActionForward viewAnnouncement(ActionMapping mapping, ActionForm actionForm, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
