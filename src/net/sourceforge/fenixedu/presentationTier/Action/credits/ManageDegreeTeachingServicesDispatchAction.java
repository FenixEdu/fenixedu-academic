...
public class ManageDegreeTeachingServicesDispatchAction extends FenixDispatchAction {
	...
	Iterator<TeachingServicePercentage> teachingServicePercentagesIterator = new OrderedIterator<TeachingServicePercentage>(
		teachingServicePercentages.iterator(), TEACHING_SERVICE_PERCENTAGE_COMPARATOR_BY_SHIFT);
