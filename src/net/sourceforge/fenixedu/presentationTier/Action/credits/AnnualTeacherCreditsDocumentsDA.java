...
@Forwards(value = { @Forward(
		name = "showAnnualTeacherCreditsDocument",
		path = "/credits/showAnnualTeacherCreditsDocument.jsp",
		tileProperties = @Tile(
				head = "/commons/blank.jsp",
				navGeral = "/commons/blank.jsp",
				navLocal = "/commons/blank.jsp",
				bodyContext = "/commons/blank.jsp",
				extend = "df.layout.blank")) })
