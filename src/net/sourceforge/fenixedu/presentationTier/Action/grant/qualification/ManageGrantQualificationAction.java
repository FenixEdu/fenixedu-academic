...
@Mapping(
		...
		path = "/manageGrantQualification",
		input = "/manageGrantQualification.do?page=0&method=prepareManageGrantQualificationForm",
		attribute = "voidForm",
		formBean = "voidForm",
		scope = "request",
		parameter = "method")
@Forwards(value = { @Forward(
		...
		path = "/facultyAdmOffice/grant/qualification/manageGrantQualification.jsp",
