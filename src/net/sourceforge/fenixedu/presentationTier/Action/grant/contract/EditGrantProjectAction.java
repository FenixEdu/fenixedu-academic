 ...
 * @author Pica
 */
@Mapping(module = "facultyAdmOffice", path = "/editGrantProject",
        input = "/editGrantProject.do?page=0&method=prepareEditGrantProjectForm", attribute = "editGrantProjectForm",
        formBean = "editGrantProjectForm", scope = "request", parameter = "method")
@Forwards(value = {
