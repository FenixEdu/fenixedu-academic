 ...
 * @author Pica
 */
@Mapping(module = "facultyAdmOffice", path = "/editGrantInsurance",
        input = "/editGrantInsurance.do?page=0&method=prepareEditGrantInsuranceForm", attribute = "editGrantInsuranceForm",
        formBean = "editGrantInsuranceForm", scope = "request", parameter = "method")
@Forwards(value = {
