 ...
 * @author Pica
 */
@Mapping(module = "facultyAdmOffice", path = "/editGrantType",
        input = "/editGrantType.do?page=0&method=prepareEditGrantTypeForm", attribute = "editGrantTypeForm",
        formBean = "editGrantTypeForm", scope = "request", parameter = "method")
@Forwards(value = {
