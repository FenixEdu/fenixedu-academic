 ...
 * @author Pica
 */
@Mapping(module = "facultyAdmOffice", path = "/editGrantPart",
        input = "/editGrantPart.do?page=0&method=prepareEditGrantPartForm", attribute = "editGrantPartForm",
        formBean = "editGrantPartForm", scope = "request", parameter = "method")
@Forwards(value = {
