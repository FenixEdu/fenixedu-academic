 ...
 * @author Pica
 */
@Mapping(module = "facultyAdmOffice", path = "/editGrantCostCenter",
        input = "/editGrantCostCenter.do?page=0&method=prepareEditGrantCostCenterForm", attribute = "editGrantCostCenterForm",
        formBean = "editGrantCostCenterForm", scope = "request", parameter = "method")
@Forwards(value = {
