...
@Forwards(value = {
	@Forward(name = "studentsGratuityList", path = "/coordinator/gratuity/studentsGratuityList.jsp", tileProperties = @Tile(title = "teste32")),
	@Forward(name = "choose", path = "/studentsGratuityList.do?method=chooseExecutionYear&page=0", tileProperties = @Tile(title = "teste33")),
	@Forward(name = "chooseStudentsGratuityList", path = "/coordinator/gratuity/chooseStudentsGratuityList.jsp", tileProperties = @Tile(title = "teste34")) })
