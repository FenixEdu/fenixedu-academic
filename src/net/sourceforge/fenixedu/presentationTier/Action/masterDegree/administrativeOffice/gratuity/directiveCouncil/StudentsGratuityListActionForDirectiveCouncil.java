...
@Forwards(value = {
	...
	@Forward(name = "choose", path = "/studentsGratuityList.do?method=chooseExecutionYear&page=0", tileProperties = @Tile(title = "teste36")),
	@Forward(name = "chooseStudentsGratuityList", path = "chooseStudentsGratuityList", tileProperties = @Tile(title = "teste37")) })
