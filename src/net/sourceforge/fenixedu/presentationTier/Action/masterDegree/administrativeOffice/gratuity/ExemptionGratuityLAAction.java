...
@Mapping(
		...
		path = "/manageExemptionGratuityLA",
		input = "/manageExemptionGratuity.do?method=readExemptionGratuity&page=0",
		attribute = "exemptionGratuityForm",
		formBean = "exemptionGratuityForm",
		scope = "request",
		parameter = "method")
@Forwards(value = { @Forward(
		name = "confirmationExemptionGratuity",
		path = "confirmationExemptionGratuity",
