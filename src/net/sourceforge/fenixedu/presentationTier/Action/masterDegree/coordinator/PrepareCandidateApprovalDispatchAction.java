...
@Forwards(value = { @Forward(name = "ExecutionDegreeChosen", path = "/displayListToSelectCandidates.do?method=prepareSelectCandidates", tileProperties = @Tile(title = "teste81")) })
