 ...
 * 
 */
@Mapping(module = "publico", path = "/viewClassTimeTableNew", input = "viewClassTimeTable", attribute = "chooseSearchContextForm", formBean = "chooseSearchContextForm", scope = "request", validate = false)
