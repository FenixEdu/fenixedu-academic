...
@Forwards(value = {
		@Forward(name = "startRequestLoginProcess", path = "start-request-login-process"),
...
public class LoginRequestManagement extends FenixDispatchAction {
	...
	LoginRequest loginRequest = (LoginRequest) RootDomainObject.readDomainObjectByOID(LoginRequest.class, Integer
		.valueOf(requestID));
