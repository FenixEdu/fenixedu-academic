...
@Mapping(
		path = "/candidacies/caseHandlingMobilityApplicationIndividualProcess",
		module = "publico",
...
@Forwards({
		...
		@Forward(
				name = "show-application-submission-conditions-for-stork",
		...
		@Forward(
				name = "bind-link-submited-individual-candidacy-with-stork",
