...
public class DegreeChangeIndividualCandidacyProcessDA extends IndividualCandidacyProcessPublicDA {
	...
	DegreeChangeIndividualCandidacyProcess individualCandidacyProcess = (DegreeChangeIndividualCandidacyProcess) request.getAttribute("individualCandidacyProcess");
	DegreeChangeIndividualCandidacyProcessBean bean = new DegreeChangeIndividualCandidacyProcessBean(individualCandidacyProcess);
	...
	bean.setPrecedentDegreeInformation(new CandidacyPrecedentDegreeInformationBean(individualCandidacyProcess.getCandidacyPrecedentDegreeInformation()));
	...
	try {
	    ...
	    DegreeChangeIndividualCandidacyProcessBean bean = (DegreeChangeIndividualCandidacyProcessBean) 
