...
@Forwards( {
	...
	@Forward(name = "begin-candidacy-process-intro-en", path = "degree.candidacy.for.graduated.person.candidacy.process.intro.en"),
	...
	@Forward(name = "edit-candidacy-habilitations", path = "degree.candidacy.for.graduated.person.edit.candidacy.habilitations"),
...
public class DegreeCandidacyForGraduatedPersonIndividualProcessRefactoredDA extends RefactoredIndividualCandidacyProcessPublicDA {
	...
	try {
	    ...
	    DegreeCandidacyForGraduatedPersonIndividualProcess process = (DegreeCandidacyForGraduatedPersonIndividualProcess) createNewPublicProcess(bean);
