 ...
 * @author jpvl
 */
@Mapping(module = "departmentAdmOffice", path = "/prepareListDepartmentTeachers", input = "/index.do", attribute = "searchTeachersDepartmentForm", formBean = "searchTeachersDepartmentForm", scope = "request")
