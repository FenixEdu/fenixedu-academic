...
import net.sourceforge.fenixedu.applicationTier.Servico.resourceAllocationManager.EditarTurno.InvalidFinalAvailabilityException;
import net.sourceforge.fenixedu.applicationTier.Servico.resourceAllocationManager.EditarTurno.InvalidNewShiftCapacity;
import net.sourceforge.fenixedu.applicationTier.Servico.resourceAllocationManager.EditarTurno.InvalidNewShiftExecutionCourse;
import net.sourceforge.fenixedu.applicationTier.Servico.resourceAllocationManager.EditarTurno.InvalidNewShiftType;
