...
public class VehicleManagementDA extends FenixDispatchAction {
    ...
    public ActionForward createAllocation(ActionMapping mapping, ActionForm form,	   	        
    ...
    public ActionForward prepareEditAllocation(ActionMapping mapping, ActionForm form,	   	        
	    HttpServletRequest request, HttpServletResponse response) throws InvalidArgumentException {
    ...
    public ActionForward deleteAllocation(ActionMapping mapping, ActionForm form,	   	        
	    HttpServletRequest request, HttpServletResponse response) throws InvalidArgumentException, FenixFilterException, FenixServiceException {
    ...
    public ActionForward seeVehicleAllocation(ActionMapping mapping, ActionForm form,	   	        
	    HttpServletRequest request, HttpServletResponse response) throws InvalidArgumentException {
