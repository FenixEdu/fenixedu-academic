...
@Mapping(module = "manager", path = "/markSheetManagement", input = "show.markSheetManagement.search.page",
        attribute = "markSheetManagementForm", formBean = "markSheetManagementForm", scope = "request", parameter = "method")
