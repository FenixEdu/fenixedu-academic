...
@Forwards(value = {
	@Forward(name = "view-registration-curriculum", path = "/student/curriculum/viewRegistrationCurriculum.jsp", tileProperties = @Tile(title = "private.alumni.academicpath.viewcurriculum")),
