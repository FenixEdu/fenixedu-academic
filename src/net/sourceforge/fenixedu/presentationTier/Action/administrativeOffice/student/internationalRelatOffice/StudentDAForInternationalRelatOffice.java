...
@Mapping(module = "internationalRelatOffice", path = "/student", attribute = "studentManagementForm", formBean = "studentManagementForm", scope = "request", parameter = "method")
@Forwards(value = {
...
public class StudentDAForInternationalRelatOffice extends net.sourceforge.fenixedu.presentationTier.Action.administrativeOffice.student.StudentDA {
}