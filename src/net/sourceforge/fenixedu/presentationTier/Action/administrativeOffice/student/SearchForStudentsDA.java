...
@Forwards({
	...
	@Forward(name = "search", path = "/academicAdminOffice/searchStudents.jsp", tileProperties = @Tile(title = "private.academicadministrativeoffice.studentoperations.viewstudents")) })
