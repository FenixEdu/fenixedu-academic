...
public class StudentOptionalEnrolmentsDA extends FenixDispatchAction {
	...
	StudentOptionalEnrolmentBean optionalEnrolmentBean = new StudentOptionalEnrolmentBean(rootDomainObject
		.readStudentCurricularPlanByOID(scpID), rootDomainObject.readExecutionSemesterByOID(executionPeriodID),
		(CurriculumGroup) rootDomainObject.readCurriculumModuleByOID(curriculumGroupID), rootDomainObject
			.readContextByOID(contextID));
	...
	StudentOptionalEnrolmentBean optionalEnrolmentBean = (StudentOptionalEnrolmentBean) RenderUtils.getViewState()
	...
	try {
	    ...
	    StudentOptionalEnrolmentBean optionalEnrolmentBean = new StudentOptionalEnrolmentBean(studentCurricularPlan,
		    executionSemester, curriculumGroup, context);
	    ...
	    optionalEnrolmentBean.setDegreeCurricularPlan(rootDomainObject.readDegreeCurricularPlanByOID(Integer.valueOf(request
		    .getParameter("dcpID"))));
	...
	enrolmentBean.setExecutionPeriod(executionSemester);
