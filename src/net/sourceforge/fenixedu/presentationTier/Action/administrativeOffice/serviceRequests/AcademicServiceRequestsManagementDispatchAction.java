...
@Mapping(
		path = "/academicServiceRequestsManagement",
...
@Forwards({
		...
		@Forward(
				name = "prepareConcludeDocumentRequest",
		...
		@Forward(
				name = "prepareCreateServiceRequest",
