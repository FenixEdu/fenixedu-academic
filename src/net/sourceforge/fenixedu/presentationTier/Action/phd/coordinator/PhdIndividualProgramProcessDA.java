...
@Mapping(
		path = "/phdIndividualProgramProcess",
		module = "coordinator",
...
@Forwards(tileProperties = @Tile(navLocal = "/coordinator/localNavigationBar.jsp"), value = {
		...
		@Forward(
				name = "viewProcessAlertMessages",
				path = "/phd/coordinator/viewProcessAlertMessages.jsp",
				tileProperties = @Tile(title = "private.coordinator.phdprocess")),

		@Forward(
				name = "viewProcessAlertMessageArchive",
				path = "/phd/coordinator/viewProcessAlertMessageArchive.jsp",
				tileProperties = @Tile(title = "private.coordinator.phdprocess")),
		...
		@Forward(
				name = "validateEnrolments",
				path = "/phd/coordinator/enrolments/validateEnrolments.jsp",
				tileProperties = @Tile(title = "private.coordinator.phdprocess")),
		...
		@Forward(
				name = "choosePhdEmailRecipients",
				path = "/phd/coordinator/email/choosePhdEmailRecipients.jsp",
				tileProperties = @Tile(title = "private.coordinator.phdprocess")),
