...
@Forwards({
		...
		@Forward(
				name = "editQualificationsAndJobsInformation",
		...
		@Forward(
				name = "managePhdIndividualProgramProcessState",
		...
		@Forward(
				name = "requestPublicPresentationSeminarComission",
				path = "/phd/academicAdminOffice/requestPublicPresentationSeminarComission.jsp"),
		@Forward(
				name = "exemptPublicPresentationSeminarComission",
		...
		@Forward(
				name = "managePhdIndividualProcessConfiguration",
		...
		@Forward(
				name = "createManualMigrationCandidacy",
		...
		@Forward(
				name = "uploadGuidanceAcceptanceDocument",
