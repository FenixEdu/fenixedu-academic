...
import net.sourceforge.fenixedu.domain.phd.PhdStudyPlanEntryType;
...
public class DegreesProviderForStudyPlanEntry extends AbstractDomainObjectProvider {
	...
	if (bean.getEntryType() == PhdStudyPlanEntryType.NORMAL && !bean.getStudyPlan().getDegree().isEmpty()) {
	    result.add(bean.getStudyPlan().getDegree());
	} else {
