...
@Forwards(value = { @Forward(name = "Success", path = "/viewCurriculum.do?method=prepare", tileProperties = @Tile(title = "private.academicadministrativeoffice.studentoperations.viewstudents")) })
