...
@Mapping(module = "researcher", path = "/viewStudentCurriculum", attribute = "studentCurricularPlanAndEnrollmentsSelectionForm", formBean = "studentCurricularPlanAndEnrollmentsSelectionForm", scope = "session", parameter = "method")
@Forwards(value = {
...
public class CurriculumDispatchActionForResearcher extends net.sourceforge.fenixedu.presentationTier.Action.commons.student.CurriculumDispatchAction {
}