...
@Forwards(value = {
	@Forward(name = "showDelegates", path = "/commons/delegates/showDelegates.jsp", tileProperties = @Tile(title = "private.delegate.view.delegates")),
	@Forward(name = "searchDelegates", path = "/commons/delegates/searchDelegates.jsp", tileProperties = @Tile(title = "private.delegate.view.delegates")) })
