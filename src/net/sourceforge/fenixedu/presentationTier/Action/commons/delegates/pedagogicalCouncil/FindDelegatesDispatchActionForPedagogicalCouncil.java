...
@Forwards(value = {
	@Forward(name = "showDelegates", path = "/commons/delegates/showDelegates.jsp", tileProperties = @Tile(title = "private.pedagogiccouncil.delegates.searchdelegates")),
	@Forward(name = "searchDelegates", path = "/commons/delegates/searchDelegates.jsp", tileProperties = @Tile(title = "private.pedagogiccouncil.delegates.searchdelegates")) })
