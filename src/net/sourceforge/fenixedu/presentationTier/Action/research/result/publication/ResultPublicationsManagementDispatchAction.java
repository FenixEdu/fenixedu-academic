...
public class ResultPublicationsManagementDispatchAction extends ResultsManagementAction {
	...
	public ActionForward goBackFromDetails(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) {
	...
	public ActionForward createJournalToAssociate(ActionMapping mapping, ActionForm form,
		...
		return createJournalWorkFlow(mapping, form, request, response, "editJournal",
				"ViewEditPublication", "editJournal", "EditResultPublication");
	}
	...
	public ActionForward createWrapper(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) throws FenixFilterException,
			FenixServiceException {
		if (getFromRequest(request, "new") != null) {
	...
	public ActionForward createJournal(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) throws FenixFilterException,
			FenixServiceException {
	...
	public ActionForward showAssociations(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) {
	...
	private ResearchResultPublication getResearchResultPublication(HttpServletRequest request) {
		...
		if (resultId != null) {
			result = (ResearchResultPublication) RootDomainObject.readDomainObjectByOID(
					ResearchResult.class, Integer.valueOf(resultId));
			request.setAttribute("resultId", result.getIdInternal());
		} else {
			result = (ResearchResultPublication) RootDomainObject.readDomainObjectByOID(
					ResearchResult.class, (Integer) request.getAttribute("resultId"));
		}
		return result;
	}
	...
	public ActionForward createEventWorkFlow(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response,
			ResultEventAssociationBean eventBean, ResultPublicationBean publicationBean,
		...
		if (isCurrentState(request, "goToNextStep")) {
			if (eventBean.getNewEventState() || eventBean.getNewEventEditionState()
				...
				return createEditPublication(mapping, form, request, response, eventBean,
						publicationBean, forwardOnFinish, forwardOnError, service);
			} else {
	...
	public ActionForward createEditPublication(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			EventEdition eventEdition = (eventBean.getEventEdition() == null ? (EventEdition) executeService(
					request, "CreateResearchEventEdition", args)
					: eventBean.getEventEdition());
	...
	public ActionForward createEventToAssociate(ActionMapping mapping, ActionForm form,
		...
		return createEventWorkFlow(mapping, form, request, response, eventBean, publicationBean,
				"editEvent", "ViewEditPublication", "editEvent", "EditResultPublication");
	}
