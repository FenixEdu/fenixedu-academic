...
@Mapping(
		module = "SpaceManager",
		path = "/managePersonSpaceOccupations",
		attribute = "managePersonSpaceOccupationsForm",
		formBean = "managePersonSpaceOccupationsForm",
		scope = "request",
		parameter = "method")
@Forwards(value = {
		@Forward(name = "ManageSpace", path = "/manageSpaces.do?method=manageSpace"),
		@Forward(
				name = "showSpaceOccupations",
				path = "/spaceManager/personSpaceOccupationsManagement.jsp",
