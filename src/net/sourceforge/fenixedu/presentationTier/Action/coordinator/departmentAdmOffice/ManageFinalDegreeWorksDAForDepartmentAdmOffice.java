...
@Mapping(
		...
		path = "/manageFinalDegreeWorks",
		input = "/manageFinalDegreeWorks.do?method=prepare&page=0",
		attribute = "manageFinalDegreeWorksForm",
		formBean = "manageFinalDegreeWorksForm",
		scope = "request",
		parameter = "method")
@Forwards(value = { @Forward(
		name = "show-final-degree-works-managment-page",
