...
public class DegreeChangeIndividualCandidacyProcessDA extends
	...
	request.setAttribute("seriesGrade", getProcess(request).getCandidacy().getDegreeChangeIndividualCandidacySeriesGradeForDegree(degreeCurricularPlan.getDegree()));
