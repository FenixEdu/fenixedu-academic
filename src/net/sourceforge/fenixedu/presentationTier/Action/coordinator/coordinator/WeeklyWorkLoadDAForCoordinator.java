...
@Forwards(value = { @Forward(name = "showWeeklyWorkLoad", path = "/coordinator/weeklyWorkLoad.jsp", tileProperties = @Tile(title = "private.coordinator.management.courses.students.weeklyeffort")) })
