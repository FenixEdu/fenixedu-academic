...
public class AllSummaryBean extends SummaryBean {
	...
	final String endDate = endOfCandidacyPeriodDateYearMonthDay == null ? NULL_LABEL : endOfCandidacyPeriodDateYearMonthDay
		.toString();
	...
	final String endDate = endOfProposalPeriodDateYearMonthDay == null ? NULL_LABEL : endOfProposalPeriodDateYearMonthDay
		.toString();
