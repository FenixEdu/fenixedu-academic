...
public class WeeklyWorkLoadDA extends FenixDispatchAction {
	...
	final ExecutionCourse selectedExecutionCourse = (ExecutionCourse) setDomainObjectInRequest(dynaActionForm, request,
		ExecutionCourse.class, "executionCourseID", "executionCourse");
	...
	final CurricularYear selecctedCurricularYear = (CurricularYear) setDomainObjectInRequest(dynaActionForm, request,
		CurricularYear.class, "curricularYearID", "selecctedCurricularYear");

	final DegreeCurricularPlan degreeCurricularPlan = (DegreeCurricularPlan) setDomainObjectInRequest(dynaActionForm,
		request, DegreeCurricularPlan.class, "degreeCurricularPlanID", "executionCourse");
	...
	final Integer domainObjectID = domainObjectIDString == null || domainObjectIDString.length() == 0 ? null : Integer
		.valueOf(domainObjectIDString);
