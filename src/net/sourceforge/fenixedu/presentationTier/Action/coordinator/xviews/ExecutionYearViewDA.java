...
public class ExecutionYearViewDA extends FenixDispatchAction {
	...
	for (Enrolment enrol : bean.getEnrolments()) {
	    BranchCourseGroup branch = enrol.getParentBranchCurriculumGroup() != null ? enrol.getParentBranchCurriculumGroup()
		    .getDegreeModule() : null;
	...
	for (StudentInquiriesTeachingResult teachingResult : teachingResults) {
	    BigDecimal converted = new BigDecimal(teachingResult.getAverage_P6_1() != null ? teachingResult.getAverage_P6_1() : 0);
