...
@Forwards(value = { @Forward(
		name = "viewScientificCommission",
		path = "/coordinator/scientificCommission/manageScientificCommission.jsp",
		tileProperties = @Tile(title = "private.coordinator.management.courses.management.scientificcommittee")) })
