...
public class DegreeJurisdictionManagementBean implements Serializable {
    ...
    private void init() {
        ...
        for (Degree degree : RootDomainObject.getInstance().getDegreesSet()) {
            ...
            case DEGREE: preBologna.add(degree); break;
            case MASTER_DEGREE: preBologna.add(degree); break;
            
            case BOLONHA_DEGREE: bachelors.add(degree); break;
            case BOLONHA_MASTER_DEGREE: masters.add(degree); break;
            case BOLONHA_INTEGRATED_MASTER_DEGREE: integratedMasters.add(degree); break;
            
            case BOLONHA_ADVANCED_FORMATION_DIPLOMA: dfas.add(degree); break;
            case BOLONHA_ADVANCED_SPECIALIZATION_DIPLOMA: deas.add(degree); break;
            case BOLONHA_SPECIALIZATION_DEGREE: specs.add(degree); break;
            case EMPTY: specs.add(degree); break;
            }
        }
