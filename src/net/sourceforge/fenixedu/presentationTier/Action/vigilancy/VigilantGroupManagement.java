...
public class VigilantGroupManagement extends FenixDispatchAction {
	...
	VigilantWrapper vigilantWrapper = (VigilantWrapper) RootDomainObject.readDomainObjectByOID(VigilantWrapper.class,
		idInternal);
	...
	VigilantGroupBean bean = (VigilantGroupBean) RenderUtils.getViewState("selectVigilantWrapper").getMetaObject()
		.getObject();
	VigilantGroup group = bean.getSelectedVigilantGroup();
	if (group != null) {
	...
	VigilantWrapper vigilantWrapper = (VigilantWrapper) RootDomainObject.readDomainObjectByOID(VigilantWrapper.class, Integer
		.valueOf(vigilantId));
