...
public class VigilantGroupManagement extends FenixDispatchAction {
    ...
    public ActionForward manageIncompatiblesOfVigilants(ActionMapping mapping, ActionForm form,
        ...
        putIncompatibilitiesInRequest(request);
    ...
    public ActionForward deleteIncompatibility(ActionMapping mapping, ActionForm form,
        ...
        Vigilant vigilant = (Vigilant) RootDomainObject
                .readDomainObjectByOID(Vigilant.class, idInternal);
    ...
    public ActionForward createVigilantGroup(ActionMapping mapping, ActionForm form,
        ...
        Object[] args = { beanWithName.getName(), beanWithName.getUnit(),
                beanWithName.getConvokeStrategy(), beanWithFirstPeriod.getBeginFirstUnavailablePeriod(),
    ...
    public ActionForward addVigilantsToGroup(ActionMapping mapping, ActionForm form,
        ...
        VigilantGroupBean bean = (VigilantGroupBean) RenderUtils.getViewState().getMetaObject()
                .getObject();
    ...
    public ActionForward removeVigilantsFromGroup(ActionMapping mapping, ActionForm form,
            HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            List<Vigilant> unableToRemove = (List<Vigilant>) executeService(request,
                    "RemoveVigilantsFromGroup", args);
    ...
    public ActionForward addVigilantToGroupByUsername(ActionMapping mapping, ActionForm form,
        ...
        VigilantGroupBean bean = (VigilantGroupBean) RenderUtils
                .getViewState("addExternalPersonToGroup").getMetaObject().getObject();
        ...
        if (user != null && (person = user.getPerson()) != null) {
            ...
            addActionMessage(request, "label.vigilancy.inexistingUsername", null);
        }
        prepareBeanForVigilantGroupEdition(request, group);
        return mapping.findForward("vigilants");
    }
