...
@Forwards(
        value = {
                @Forward(name = "editProfessionalCategory",
                ...
                @Forward(name = "showCardGenerationProblem",
                        path = "/identificationCardManager/cardGeneration/showCardGenerationProblem.jsp"),
                @Forward(name = "manageCardGenerationBatch",
                ...
                @Forward(name = "editCardGenerationBatch",
                ...
                @Forward(name = "showDegreeCodesAndLabels",
