...
@Forwards({
	@Forward(name = "selectRegistrationAgreement", path = "/directiveCouncil/manageExternalSupervision/selectRegistrationAgreement.jsp", tileProperties = @Tile(title = "private.steeringcouncil.externaloversight.managementofexternalsupervisors")),
	@Forward(name = "showSupervisors", path = "/directiveCouncil/manageExternalSupervision/showSupervisors.jsp", tileProperties = @Tile(title = "private.steeringcouncil.externaloversight.managementofexternalsupervisors")) })
public class ManageExternalSupervisionDA extends FenixDispatchAction {
	...
	RegistrationProtocol registrationProtocol = RegistrationProtocol.serveRegistrationProtocol(bean
