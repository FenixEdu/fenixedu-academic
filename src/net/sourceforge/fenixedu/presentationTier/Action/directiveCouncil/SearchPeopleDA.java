...
@Mapping(module = "directiveCouncil", path = "/searchPeople", scope = "session", parameter = "method")
@Forwards(value = { @Forward(name = "search", path = "/directiveCouncil/searchPeople.jsp") })
