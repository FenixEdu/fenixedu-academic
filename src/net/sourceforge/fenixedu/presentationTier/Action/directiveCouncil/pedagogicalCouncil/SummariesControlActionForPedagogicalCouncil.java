...
@Forwards(value = { @Forward(name = "success", path = "/pedagogicalCouncil/control/teachersSummariesControlList.jsp", tileProperties = @Tile(title = "private.pedagogiccouncil.control.controlbriefs")) })
