...
public class TSDProcessValuationAction extends
		FenixDispatchAction {
	...
	public ActionForward prepareForTSDProcessValuation(
	...
	public ActionForward loadTSDProcessPhase(
			ActionMapping mapping, 
			ActionForm form, 
			HttpServletRequest request,
			HttpServletResponse response) throws FenixFilterException, FenixServiceException {
	...
	public ActionForward loadTSDProcess(
			ActionMapping mapping, 
			ActionForm form, 
			HttpServletRequest request,
			HttpServletResponse response) throws FenixFilterException, FenixServiceException {
		...
		TeacherServiceDistribution selectedTSD = getSelectedTeacherServiceDistribution(userView, dynaForm, rootTeacherServiceDistribution);
		...
		if(getViewType(dynaForm).equals(VIEW_TEACHER_SERVICE_DISTRIBUTION_VALUATION_BY_COURSES)) {
			...
			List<TSDCourse> nonValuatedTSDCourses = new ArrayList(selectedTSD.getCompetenceCoursesWithoutActiveTSDCourses(selectedExecutionPeriodList));
	...
	public ActionForward exportTSDProcessValuationToExcel(
			ActionMapping mapping, 
			ActionForm form, 
			HttpServletRequest request,
			HttpServletResponse response) throws FenixFilterException, FenixServiceException {
		...
		TeacherServiceDistribution selectedTeacherServiceDistribution = getSelectedTeacherServiceDistribution(userView, dynaForm, selectedTSDProcessPhase.getRootTSD());
				
		List<TSDCourseDTOEntry> tsdCourseDTOEntryList = getTSDCourseDTOEntries(userView, selectedTSDProcessPhase, selectedTeacherServiceDistribution, selectedExecutionPeriod);
		List<TSDTeacherDTOEntry> tsdTeacherDTOEntryList = getTSDTeacherDTOEntries(userView, selectedTSDProcessPhase, selectedTeacherServiceDistribution, selectedExecutionPeriod);
		
        try {
			String filename = tsdProcess.getName() + "-" + tsdProcess.getExecutionYear().getYear() + "-" + selectedTSDProcessPhase.getName();
	...
	private ActionForward generateTSDProcessValuationChart(
			ActionMapping mapping, 
			ActionForm form, 
			HttpServletRequest request,
			HttpServletResponse response,
			TeacherServiceDistributionChart tsdProcessChart)  throws FenixFilterException, FenixServiceException {
	...
	public ActionForward generateValuatedHoursPerGrouping(
		...
		return generateTSDProcessValuationChart(mapping, form, request, response, TeacherServiceDistributionChart.generateValuatedHoursPerGroupingChart());
	}
	...
	public ActionForward generateValuatedNumberStudentsPerGrouping(
			...
			HttpServletRequest request,
			HttpServletResponse response) throws FenixFilterException, FenixServiceException {
		return generateTSDProcessValuationChart(mapping, form, request, response, TeacherServiceDistributionChart.generateValuatedNumberStudentsPerGroupingChart());	
	}
	...
	public ActionForward generateValuatedHoursPerGroupingPieChart(
			...
			HttpServletRequest request,
			HttpServletResponse response) throws FenixFilterException, FenixServiceException {
		return generateTSDProcessValuationChart(mapping, form, request, response, TeacherServiceDistributionChart.generateValuatedHoursPerGroupingPieChart());
	}
	...
	public ActionForward generateValuatedNumberStudentsPerGroupingPieChart(
			...
			HttpServletRequest request,
			HttpServletResponse response) throws FenixFilterException, FenixServiceException {
		return generateTSDProcessValuationChart(mapping, form, request, response, TeacherServiceDistributionChart.generateValuatedNumberStudentsPerGroupingPieChart());
	}
	
	private void exportToXls(
    		final List<TSDCourseDTOEntry> tsdCourseDTOEntryList,
    		final List<TSDTeacherDTOEntry> tsdTeacherDTOEntryList,
    		final String name,
	...
	private TeacherServiceDistribution getSelectedTeacherServiceDistribution(IUserView userView, DynaActionForm dynaForm, TeacherServiceDistribution rootTeacherServiceDistribution) throws FenixFilterException, FenixServiceException {
		...
		if(selectedTeacherServiceDistribution == null) return rootTeacherServiceDistribution;
		
		return selectedTeacherServiceDistribution;
	}

	private TSDProcessPhase getSelectedTSDProcessPhase(IUserView userView, DynaActionForm dynaForm) throws FenixFilterException, FenixServiceException {
	...
	public ActionForward prepareForTSDProcessValuationByTeachers(
			ActionMapping mapping, 
			ActionForm form, 
			HttpServletRequest request,
			HttpServletResponse response) throws FenixFilterException, FenixServiceException {
