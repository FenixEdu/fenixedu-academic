...
@Mapping(module = "departmentMember", path = "/globalTSDProcessValuation", attribute = "globalTSDProcessValuationForm", formBean = "globalTSDProcessValuationForm", scope = "request", parameter = "method")
@Forwards(value = {
...
public class GlobalTSDProcessValuationActionForDepartmentMember extends net.sourceforge.fenixedu.presentationTier.Action.departmentMember.teacherServiceDistribution.GlobalTSDProcessValuationAction {
}