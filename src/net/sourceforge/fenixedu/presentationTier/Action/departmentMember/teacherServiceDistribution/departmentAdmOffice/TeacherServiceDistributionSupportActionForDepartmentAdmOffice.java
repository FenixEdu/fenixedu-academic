...
@Mapping(module = "departmentAdmOffice", path = "/tsdSupport", input = "/tsdSupport.do?method=prepareForTeacherServiceDistributionSupportServices&page=0", attribute = "tsdSupportForm", formBean = "tsdSupportForm", scope = "request", parameter = "method")
@Forwards(value = {
...
public class TeacherServiceDistributionSupportActionForDepartmentAdmOffice extends net.sourceforge.fenixedu.presentationTier.Action.departmentMember.teacherServiceDistribution.TeacherServiceDistributionSupportAction {
}