...
@Mapping(module = "departmentAdmOffice", path = "/tsdCourseValuation", input = "/tsdCourseValuation.do?method=loadTSDCourses&page=0&fromValidation=1", attribute = "tsdCourseValuationForm", formBean = "tsdCourseValuationForm", scope = "request", parameter = "method")
@Forwards(value = {
...
public class TSDCourseValuationActionForDepartmentAdmOffice extends net.sourceforge.fenixedu.presentationTier.Action.departmentMember.teacherServiceDistribution.TSDCourseValuationAction {
}