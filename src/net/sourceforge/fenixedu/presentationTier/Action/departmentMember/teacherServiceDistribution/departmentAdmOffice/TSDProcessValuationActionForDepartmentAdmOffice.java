...
@Mapping(module = "departmentAdmOffice", path = "/tsdProcessValuation", attribute = "tsdProcessValuationForm", formBean = "tsdProcessValuationForm", scope = "request", parameter = "method")
@Forwards(value = {
		...
		@Forward(name = "showPlanning", path = "/departmentMember/teacherServiceDistribution/teacherServiceDistributionPlanning.jsp"),
...
public class TSDProcessValuationActionForDepartmentAdmOffice extends net.sourceforge.fenixedu.presentationTier.Action.departmentMember.teacherServiceDistribution.TSDProcessValuationAction {
}