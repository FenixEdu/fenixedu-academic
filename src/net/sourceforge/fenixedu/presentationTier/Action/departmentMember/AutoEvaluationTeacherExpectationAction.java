...
@Forwards(value = {
		@Forward(name = "editAutoEvaluation", path = "/departmentMember/expectationManagement/editTeachersExpectationAutoEvaluation.jsp"),
		@Forward(name = "showAutoEvaluation", path = "/departmentMember/expectationManagement/showTeachersExpectationAutoEvaluation.jsp") })
public class AutoEvaluationTeacherExpectationAction extends FenixDispatchAction {
	...
	if (executionYearID != null) {
	    ExecutionYear executionYear = (ExecutionYear) RootDomainObject.readDomainObjectByOID(ExecutionYear.class, Integer
		    .valueOf(executionYearID));
	...
	if (viewState != null) {
	    ...
	    year = id != null ? (ExecutionYear) RootDomainObject.readDomainObjectByOID(ExecutionYear.class, Integer.valueOf(id))
