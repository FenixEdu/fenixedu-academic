...
public class PersonalExpectationManagement extends FenixDispatchAction {
	...
	if (teacher != null) {
		...
		request
			.setAttribute("teacherPersonalExpectationBean",
				new TeacherPersonalExpectationBean(executionYear, teacher));
	    }
	}
	...
	try {
	    teacherPersonalExpectation = (TeacherPersonalExpectation) executeService("InsertTeacherPersonalExpectation",
		    new Object[] { bean });
	...
	TeacherPersonalExpectation teacherPersonalExpectation = (TeacherPersonalExpectation) viewState.getMetaObject()
		.getObject();
