...
@Mapping(module = "departmentMember", path = "/showFullTeacherCreditsSheet", attribute = "teacherCreditsForm",
        formBean = "teacherCreditsForm", scope = "request", parameter = "method")
