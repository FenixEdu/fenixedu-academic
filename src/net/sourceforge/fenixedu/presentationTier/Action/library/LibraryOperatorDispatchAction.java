...
@Forwards({
		...
		@Forward(
				name = "libraryUpdateCapacityAndLockers",
				path = "/library/operator/libraryUpdateCapacityAndLockers.jsp",
				tileProperties = @Tile(title = "private.library.updatecapacityandlockers")),
		@Forward(
				name = "libraryAddOrRemoveOperators",
				path = "/library/operator/libraryAddOrRemoveOperators.jsp",
