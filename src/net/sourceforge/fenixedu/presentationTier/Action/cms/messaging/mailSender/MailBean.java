...
/**
 * This <tt>MailBean</tt> can be used to collect, from the user, the information
 * required to send an email. This includes the basic mail information and other
 * information like the group of people that will receive the mail (or
