...
public class BeanInitializer {
     ...
     * 
     * @param studentsByEntryYearBean
     * @param tutorshipPeriodPartialBean
     * @param executionDegree
     * @param tutorship
     */
    public static void initializeBean(StudentsByEntryYearBean studentsByEntryYearBean,
	    TutorshipPeriodPartialBean tutorshipPeriodPartialBean, ExecutionDegree executionDegree, Person personStudent,
	    Partial endDate) {
	...
	studentsByEntryYearBean.setTeacher(tutorshipPeriodPartialBean.getTeacher().getTeacher());
