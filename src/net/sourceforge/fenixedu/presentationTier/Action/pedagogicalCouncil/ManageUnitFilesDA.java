...
@Forwards(value = {
		@Forward(name = "uploadFile", path = "pedagogical-upload-file", tileProperties = @Tile(
				title = "private.pedagogiccouncil.communication.files")),
		@Forward(name = "manageFiles", path = "pedagogical-manage-files", tileProperties = @Tile(
				title = "private.pedagogiccouncil.communication.files")),
		@Forward(name = "editUploaders", path = "pedagogical-edit-uploaders", tileProperties = @Tile(
				title = "private.pedagogiccouncil.communication.files")),
		@Forward(name = "managePersistedGroups", path = "manage-persisted-groups", tileProperties = @Tile(
				title = "private.pedagogiccouncil.communication.files")),
		@Forward(name = "editFile", path = "pedagogical-edit-file", tileProperties = @Tile(
				title = "private.pedagogiccouncil.communication.files")),
