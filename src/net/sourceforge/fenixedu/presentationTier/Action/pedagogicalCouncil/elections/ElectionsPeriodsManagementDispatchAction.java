...
@Forwards(
		value = {
				@Forward(
						...
						path = "/pedagogicalCouncil/delegates/showPossibleDelegates.jsp",
				...
				@Forward(
						...
						tileProperties = @Tile(title = "private.pedagogiccouncil.delegates.candidacies")),
				@Forward(
						name = "createEditVotingPeriods",
						path = "/pedagogicalCouncil/elections/createEditVotingPeriods.jsp",
				...
				@Forward(
						name = "showCandidates",
						path = "/pedagogicalCouncil/elections/showCandidates.jsp",
						tileProperties = @Tile(title = "private.pedagogiccouncil.delegates.candidacies")),
				@Forward(
						...
						tileProperties = @Tile(title = "private.pedagogiccouncil.delegates.candidacies")),
				@Forward(
						name = "showVotingResults",
						path = "/pedagogicalCouncil/elections/showVotingResults.jsp",
						tileProperties = @Tile(title = "private.pedagogiccouncil.delegates.candidacies")),
				@Forward(
						name = "showCandidacyPeriods",
						path = "/pedagogicalCouncil/elections/showCandidacyPeriods.jsp",
				...
				@Forward(
						...
						tileProperties = @Tile(title = "private.pedagogiccouncil.delegates.candidacies")),
				@Forward(
						name = "showVotingPeriods",
						path = "/pedagogicalCouncil/elections/showVotingPeriods.jsp",
						tileProperties = @Tile(title = "private.pedagogiccouncil.delegates.votingresults")),
				@Forward(
						name = "secondRoundElections",
						path = "/pedagogicalCouncil/elections/secondRoundElections.jsp",
						tileProperties = @Tile(title = "private.pedagogiccouncil.delegates.candidacies")),
				@Forward(
						name = "createEditCandidacyPeriods",
