...
@Mapping(module = "messaging", path = "/announcements/manageUnitAnnouncementBoard", attribute = "unitAnnouncementBoardsManagementForm", formBean = "unitAnnouncementBoardsManagementForm", scope = "request", parameter = "method")
@Forwards(value = {
		...
		@Forward(name = "editAnnouncementBoardApprovers", path = "/messaging/announcements/editUnitAnnouncementBoardApprovers.jsp"),
...
public class UnitAnnouncementBoardsManagementForMessaging extends net.sourceforge.fenixedu.presentationTier.Action.messaging.UnitAnnouncementBoardsManagement {
}