...
@Mapping(
		module = "manager",
		path = "/announcements/manageExecutionCourseAnnouncementBoard",
		attribute = "unitAnnouncementBoardsManagementForm",
		formBean = "unitAnnouncementBoardsManagementForm",
		scope = "request")
@Forwards(value = { @Forward(
		name = "notAvailable",
		path = "/messaging/announcements/notAvailableYet.jsp",
