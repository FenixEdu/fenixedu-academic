...
public class SearchCoursesInformationAction extends SearchAction {
	...
	final Comparator comparator = new Comparator() {
		...
		final SortedSet<InfoCurricularCourseScope> result = new TreeSet<InfoCurricularCourseScope>(
	...
	for (final InfoSiteCourseInformation infoSiteCourseInformation : infoSiteCoursesInformation) {
		...
		if (infoDegreeCurricularPlan == null
			...
			String year = infoCurricularCourseScope.getInfoCurricularSemester().getInfoCurricularYear().getYear()
				.toString();
	...
	List infoExecutionDegrees = (List) ServiceUtils.executeService("ReadExecutionDegreesByExecutionYearAndDegreeType", args);
