...
public class StudentInfoByUsername extends FenixAction
{
			...
			HttpServletResponse response) throws FenixActionException
	{
		...
		try
		{
			...
			authenticate(state.studentUsername, state.studentPassword, requestURL);
	...
	private String transformResult(String result,State state)
	{
		...
		try
		{
			...
			javax.xml.transform.Transformer trans = transFact.newTransformer(new javax.xml.transform.stream.StreamSource(xsltStream));
			...
			FenixServiceException
	{
		Object args[] =
		{ username };
		return (Collection) ServiceManagerServiceFactory.executeService(null, "ReadStudentExternalInformation", args);
