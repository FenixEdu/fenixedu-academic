...
@Mapping(module = "teacher", path = "/summariesManagement", attribute = "summariesManagementForm", formBean = "summariesManagementForm", scope = "request", parameter = "method")
@Forwards(value = {
...
public class SummariesManagementDAForTeacher extends net.sourceforge.fenixedu.presentationTier.Action.teacher.SummariesManagementDA {
}