...
public class DownloadStudentsWithAttendsByExecutionCourseListWithGradesActionForTeacher extends FenixDispatchAction {
	...
	spreadsheet.setHeader(BundleUtil.getStringFromResourceBundle("resources.ApplicationResources", "label.attends.enrollmentState"));
	...
	for (final Evaluation evaluation : evaluations) {
		...
		spreadsheet.setHeader(BundleUtil.getStringFromResourceBundle("resources.ApplicationResources", "label.final.evaluation"));
		...
		spreadsheet.setHeader(BundleUtil.getStringFromResourceBundle("resources.ApplicationResources", exam.getSeason().getKey()));
	...
	for (final Attends attends : executionCourse.getOrderedAttends()) {
		...
		row.setCell(BundleUtil.getStringFromResourceBundle("resources.ApplicationResources", "label.attends.enrollmentState.notEnrolled"));
	    }
	    for (final Evaluation evaluation : evaluations) {
