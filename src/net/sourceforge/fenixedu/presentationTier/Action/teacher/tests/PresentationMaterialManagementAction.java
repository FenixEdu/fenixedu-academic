...
@Mapping(
		module = "teacher",
		path = "/tests/questionBank/presentationMaterial",
		attribute = "testForm",
		formBean = "testForm",
		scope = "request",
		parameter = "method")
@Forwards(value = {
		@Forward(
				name = "createPresentationMaterial",
				path = "/teacher/tests/questionBank/presentationMaterial/createPresentationMaterial.jsp",
				tileProperties = @Tile(navLocal = "/teacher/commons/navigationBarIndex.jsp")),
		@Forward(
				name = "editPresentationMaterials",
				path = "/teacher/tests/questionBank/presentationMaterial/editPresentationMaterials.jsp",
				tileProperties = @Tile(navLocal = "/teacher/commons/navigationBarIndex.jsp")),
		@Forward(
				name = "createPictureMaterial",
				path = "/teacher/tests/questionBank/presentationMaterial/createPictureMaterial.jsp",
				tileProperties = @Tile(navLocal = "/teacher/commons/navigationBarIndex.jsp")),
		@Forward(
				name = "deletePresentationMaterial",
				path = "/teacher/tests/questionBank/presentationMaterial/deletePresentationMaterial.jsp",
				tileProperties = @Tile(navLocal = "/teacher/commons/navigationBarIndex.jsp")) })
