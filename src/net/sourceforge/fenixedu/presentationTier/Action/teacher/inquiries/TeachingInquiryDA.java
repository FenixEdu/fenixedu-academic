...
@Forwards({
		...
		@Forward(
				...
				path = "/inquiries/showCourseInquiryResult.jsp",
				useTile = false,
				tileProperties = @Tile(title = "private.teacher.qucreportsandresults.teachers")),
		@Forward(
				name = "showCourseInquiryResult_v2",
				path = "/inquiries/showCourseInquiryResult_v2.jsp",
				useTile = false,
				tileProperties = @Tile(title = "private.teacher.qucreportsandresults.teachers")),
		@Forward(
				name = "showTeachingInquiryResult",
				path = "/inquiries/showTeachingInquiryResult.jsp",
				useTile = false,
				tileProperties = @Tile(title = "private.teacher.qucreportsandresults.teachers")),
		@Forward(
				name = "showTeachingInquiryResult_v2",
				path = "/inquiries/showTeachingInquiryResult_v2.jsp",
				useTile = false,
				tileProperties = @Tile(title = "private.teacher.qucreportsandresults.teachers")) })
