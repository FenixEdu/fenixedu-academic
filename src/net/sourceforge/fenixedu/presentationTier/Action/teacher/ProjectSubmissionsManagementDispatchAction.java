...
@Forwards(
		value = {
				@Forward(name = "editProjectObservations", path = "edit-project-observations", tileProperties = @Tile(
						title = "bolacha5")),
				@Forward(
						name = "viewLastProjectSubmissionForEachGroup",
						path = "view-last-project-submission-for-each-group",
						tileProperties = @Tile(title = "bolacha6")),
				@Forward(
						name = "viewProjectSubmissionsByGroup",
						path = "view-project-submissions-by-group",
