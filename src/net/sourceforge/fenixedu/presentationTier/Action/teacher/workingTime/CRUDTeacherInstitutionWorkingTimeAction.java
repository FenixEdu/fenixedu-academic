 ...
 *  
 */
package net.sourceforge.fenixedu.presentationTier.Action.teacher.workingTime;
...
public class CRUDTeacherInstitutionWorkingTimeAction extends CRUDActionByOID {
    ...
    protected void populateFormFromInfoObject(ActionMapping mapping, InfoObject infoObject,
        ...
        if (startTime != null || endTime != null) {
            ...
            if (startTime != null) {
                ...
                teacherInstitutionWorkTimeForm.set("startTimeHour", String.valueOf(time
                        .get(Calendar.HOUR_OF_DAY)));
                teacherInstitutionWorkTimeForm.set("startTimeMinutes", String.valueOf(time
                        .get(Calendar.MINUTE)));
            }
            if (endTime != null) {
                time.setTime(endTime);
                teacherInstitutionWorkTimeForm.set("endTimeHour", String.valueOf(time
                        .get(Calendar.HOUR_OF_DAY)));
                teacherInstitutionWorkTimeForm.set("endTimeMinutes", String.valueOf(time
                        .get(Calendar.MINUTE)));
            }
        }
    }
    ...
    protected InfoObject populateInfoObjectFromForm(ActionForm form, CRUDMapping mapping)
        ...
        infoTeacherInstitutionWorkTime.setIdInternal((Integer) teacherInstitutionWorkTimeForm
                .get("idInternal"));
        InfoTeacher infoTeacher = new InfoTeacher(Integer
                .valueOf((String) teacherInstitutionWorkTimeForm.get("teacherId")));
        infoTeacherInstitutionWorkTime.setInfoTeacher(infoTeacher);

        InfoExecutionPeriod infoExecutionPeriod = new InfoExecutionPeriod(Integer
                .valueOf((String) teacherInstitutionWorkTimeForm.get("executionPeriodId")));
        ...
        setHoursAndMinutes(calendar, Integer.valueOf((String) teacherInstitutionWorkTimeForm
                .get("startTimeHour")), Integer.valueOf((String) teacherInstitutionWorkTimeForm
                .get("startTimeMinutes")));
        infoTeacherInstitutionWorkTime.setStartTime(new Date(calendar.getTimeInMillis()));

        setHoursAndMinutes(calendar, Integer.valueOf((String) teacherInstitutionWorkTimeForm
                .get("endTimeHour")), Integer.valueOf((String) teacherInstitutionWorkTimeForm
                .get("endTimeMinutes")));
    ...
    protected void prepareFormConstants(ActionMapping mapping, ActionForm form,
        ...
        Integer executionPeriodId = Integer.valueOf((String) teacherInstitutionWorkTimeForm
