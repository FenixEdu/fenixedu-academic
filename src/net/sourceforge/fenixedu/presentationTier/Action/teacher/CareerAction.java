 ...
 * 
 */
@Mapping(module = "teacher", path = "/teachingCareer", input = "/teachingCareer.do?page=0&method=prepareEdit", attribute = "teachingCareerForm", formBean = "teachingCareerForm", scope = "request", parameter = "method", customMappingClass = net.sourceforge.fenixedu.presentationTier.mapping.framework.CRUDMapping.class, customMappingProperties = {
	"editService", "EditCareer", "deleteService", "DeleteCareer", "readService", "ReadCareer", "oidProperty", "idInternal",
	"requestAttribute", "infoTeachingCareer", "infoObjectClassName",
