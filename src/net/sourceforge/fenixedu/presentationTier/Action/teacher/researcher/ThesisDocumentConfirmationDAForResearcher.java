...
@Forwards(value = {
	@Forward(name = "viewThesis", path = "/teacher/viewThesis.jsp", tileProperties = @Tile(  title = "private.curriculum.dissertations.confirmationdocuments")),
	@Forward(name = "showThesisList", path = "/teacher/showThesisList.jsp", tileProperties = @Tile(  title = "private.curriculum.dissertations.confirmationdocuments")) })
