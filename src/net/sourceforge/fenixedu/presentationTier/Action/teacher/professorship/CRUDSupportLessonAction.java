...
public class CRUDSupportLessonAction extends CRUDActionByOID {
	...
	supportLessonForm.set("infoProfessorshipId", infoSupportLesson.getInfoProfessorship().getIdInternal());
	...
	final Professorship professorship = rootDomainObject.readProfessorshipByOID((Integer) supportLessonForm
	...
	InfoProfessorship infoProfessorship = (InfoProfessorship) ServiceUtils.executeService("ReadProfessorshipByOID",
