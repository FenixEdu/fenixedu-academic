...
public class CRUDSupportLessonAction extends CRUDActionByOID {
	...
	protected InfoObject populateInfoObjectFromForm(ActionForm form, CRUDMapping mapping) {
		...
		final Professorship professorship =
				rootDomainObject.readProfessorshipByOID((Integer) supportLessonForm.get("infoProfessorshipId"));
	...
	protected void prepareFormConstants(ActionMapping mapping, ActionForm form, HttpServletRequest request)
		...
		InfoProfessorship infoProfessorship =
				(InfoProfessorship) ServiceUtils.executeService("ReadProfessorshipByOID", new Object[] { professorshipId });
