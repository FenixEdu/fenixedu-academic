 ...
 * PrinterWriter} returned by the response will write to the provided stream
 * ratter than to the wrapped response. If the response is of type
 * <tt>"text/html"</tt> then an intermediary
