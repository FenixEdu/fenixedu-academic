...
@Mapping(module = "teacher", path = "/weeklyWorkLoad", input = "/weeklyWorkLoad.do?method=prepare", scope = "session", parameter = "method")
@Forwards(value = { @Forward(name = "showWeeklyWorkLoad", path = "/teacher/weeklyWorkLoad.jsp", tileProperties = @Tile(navLocal = "/teacher/commons/executionCourseAdministrationNavbar.jsp")) })
