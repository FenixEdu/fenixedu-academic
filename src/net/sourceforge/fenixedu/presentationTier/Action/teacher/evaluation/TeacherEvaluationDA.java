...
@Forwards({
	...
	@Forward(name = "viewManagementInterface", path = "/teacher/evaluation/viewManagementInterface.jsp", tileProperties = @Tile(bundle = "TITLES_RESOURCES", title = "private.operator.personnelmanagement.managementfaculty.teacherevaluation")) })
