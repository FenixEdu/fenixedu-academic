...
@Forwards(value = {
		@Forward(name = "manageGroups", path = "/departmentAdmOffice/teacher/teacherPersonalExpectationsManagement/manageExpectationEvaluationGroups.jsp"),
		@Forward(name = "listGroups", path = "/departmentAdmOffice/teacher/teacherPersonalExpectationsManagement/seeExpectationEvaluationGroups.jsp") })
public class ExpectationsEvaluationGroupsDA extends FenixDispatchAction {
	...
	request.setAttribute("evaluatedTeacherGroups", bean.getAppraiser().getEvaluatedExpectationEvaluationGroups(
	...
	Department employeeDepartment = getDepartment(request);
	Department appraiserDepartment = appraiser.getLastWorkingDepartment(executionYear.getBeginDateYearMonthDay(),
		executionYear.getEndDateYearMonthDay());
	...
	Map<Teacher, List<ExpectationEvaluationGroup>> result = new TreeMap<Teacher, List<ExpectationEvaluationGroup>>(
		Teacher.TEACHER_COMPARATOR_BY_CATEGORY_AND_NUMBER);
	if (executionYear != null && department != null) {
	    List<Teacher> currentTeachers = department.getAllTeachers(executionYear.getBeginDateYearMonthDay(), executionYear
