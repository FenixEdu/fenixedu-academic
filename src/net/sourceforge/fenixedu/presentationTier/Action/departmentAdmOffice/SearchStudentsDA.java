...
@Forwards(value = { @Forward(name = "searchStudents", path = "/departmentAdmOffice/searchStudents.jsp", tileProperties = @Tile(title = "private.administrationofcreditsofdepartmentteachers.students.studentslistold")) })
