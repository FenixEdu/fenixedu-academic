...
@Mapping(module = "coordinator", path = "/courseInformation", input = "/courseInformation.do",
        attribute = "courseInformationForm", formBean = "courseInformationForm", scope = "request")
