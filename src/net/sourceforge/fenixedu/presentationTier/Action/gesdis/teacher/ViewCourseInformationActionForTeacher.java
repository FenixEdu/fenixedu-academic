...
@Mapping(
		module = "teacher",
		path = "/viewCourseInformation",
		input = "/teacherAdministrationViewer.do?method=instructions",
		attribute = "viewCourseInformationForm",
		formBean = "viewCourseInformationForm",
		scope = "request")
