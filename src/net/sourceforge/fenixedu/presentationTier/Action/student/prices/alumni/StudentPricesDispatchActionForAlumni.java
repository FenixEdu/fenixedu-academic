...
@Forwards(value = { @Forward(name = "viewPrices", path = "/alumni/administrativeOfficeServices/prices/viewPrices.jsp", tileProperties = @Tile(  title = "private.alumni.academicservices.pricing")) })
