...
@Forwards(value = {
	@Forward(name = "showDissertationsInfo", path = "/student/finalDegreeWork/dissertations.jsp", tileProperties = @Tile(title = "private.student.finalists.dissertations" )),
	@Forward(name = "showSelectProposalsForm", path = "/student/finalDegreeWork/selectProposals.jsp", tileProperties = @Tile(title = "private.student.finalists.application" )),
	@Forward(name = "showCandidacyForm", path = "/student/finalDegreeWork/candidacy.jsp", tileProperties = @Tile(title = "private.student.finalists.application" )) })
@Exceptions(value = {
	...
	@ExceptionHandling(type = net.sourceforge.fenixedu.applicationTier.Servico.student.CheckCandidacyConditionsForFinalDegreeWork.EnrolmentInDissertationIsRequired.class, key = "error.message.EnrolmentInDissertationIsRequired", handler = net.sourceforge.fenixedu.presentationTier.config.FenixErrorExceptionHandler.class, scope = "request"),
