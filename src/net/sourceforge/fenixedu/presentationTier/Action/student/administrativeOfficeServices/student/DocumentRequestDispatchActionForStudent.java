...
@Forwards(value = {
		@Forward(
				...
				path = "df.page.documentRequest.createDocumentRequests",
		...
		@Forward(
				...
				path = "df.page.documentRequest.viewDocumentRequestsToCreate",
				tileProperties = @Tile(title = "private.student.view.academicservices.certificaterequest")),
		...
		@Forward(
				...
				path = "df.page.documentRequest.prepareCancelAcademicServiceRequest",
				tileProperties = @Tile(title = "private.student.view.academicservices.certificaterequest")),
