...
@Mapping(
		module = "student",
		path = "/studentTests",
		input = "/studentTests.do?method=prepareToDoTest",
		attribute = "studentTestForm",
		formBean = "studentTestForm",
		scope = "request",
		validate = false,
		parameter = "method")
@Forwards(value = {
		...
		@Forward(
				name = "viewStudentExecutionCoursesWithTests",
				path = "/student/onlineTests/viewStudentExecutionCoursesWithTests_bd.jsp",
				tileProperties = @Tile(title = "private.student.submit.worksheets")),
