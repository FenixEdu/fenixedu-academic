...
@Mapping(
		module = "student",
		path = "/bolonhaStudentEnrollment",
		attribute = "bolonhaEnrollmentForm",
		formBean = "bolonhaEnrollmentForm",
		scope = "request",
		parameter = "method")
@Forwards(value = {
		...
		@Forward(
				name = "chooseOptionalCurricularCourseToEnrol",
		...
		@Forward(
				...
				path = "/student/enrollment/bolonha/showDegreeModulesToEnrol.jsp",
				tileProperties = @Tile(title = "private.academicadministrativeoffice.studentoperations.viewstudents")),
		@Forward(
				...
				tileProperties = @Tile(title = "private.academicadministrativeoffice.studentoperations.viewstudents")),
		@Forward(
				name = "chooseCycleCourseGroupToEnrol",
				path = "/student/enrollment/bolonha/chooseCycleCourseGroupToEnrol.jsp",
				tileProperties = @Tile(title = "private.academicadministrativeoffice.studentoperations.viewstudents")),
