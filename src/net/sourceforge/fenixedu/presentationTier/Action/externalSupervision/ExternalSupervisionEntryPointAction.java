...
@Forwards( {
    	@Forward(name = "welcome", path = "/externalSupervision/externalSupervisionGreetings.jsp"),
...
public class ExternalSupervisionEntryPointAction extends FenixDispatchAction{
	...
	case AFA: return mapping.findForward("welcome_AFA");
	
	case MA: return mapping.findForward("welcome_MA");
	
	default: return mapping.findForward("welcome"); 
	}
    }
