...
public class DMLClassDescriptor {
	...
	for (final Iterator iterator = objectReferenceDescriptors.iterator(); iterator.hasNext();) {
	    ...
	    final DMLRelationDescriptor dmlRelationDescriptor = new DMLRelationDescriptor(classDescriptor,
	...
	// objectReferenceDescriptors.values().iterator(); iterator
	// .hasNext();)
	// {
	// final DMLObjectReferenceDescriptor dmlObjectReferenceDescriptor =
	// (DMLObjectReferenceDescriptor) iterator
	// .next();
	// dmlObjectReferenceDescriptor.appendDMLDescription(stringBuffer);
	// }
	//
	// for (final Iterator iterator =
	// collectionDescriptors.values().iterator(); iterator.hasNext();)
	// {
	// final DMLCollectionDescriptor dmlCollectionDescriptor =
	// (DMLCollectionDescriptor) iterator
	// .next();
	...
	final DMLCollectionDescriptor dmlCollectionDescriptor = new DMLCollectionDescriptor(collectionDescriptor);
