...
public class InlinedCaller extends PatternReplacer {
    public InlinedCaller(Map<String, IServiceDefinition> services) {
	super(SERVICE_MANAGER_EXPRESSION + "\\(\\s*\"([\\w|\\.]*)\",\\s*new\\s+Object\\[\\]\\s*\\{([^\\}]*)\\}\\)",
		Pattern.DOTALL, services);
    }
