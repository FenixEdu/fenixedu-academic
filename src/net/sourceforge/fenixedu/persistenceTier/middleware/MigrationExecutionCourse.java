 ...
 *
 */
package net.sourceforge.fenixedu.persistenceTier.middleware;
...
public class MigrationExecutionCourse {
    ...
    private double theoreticalHours, practicalHours, theoreticalPraticalHours, laboratoryHours;
    ...
    public void addExecutionDegreeSopCourseRelation(String degreeInitials, String courseInitials,
            Integer curricularYear) {

        CourseCurricularYearPair courseCurricularYearPair = new CourseCurricularYearPair(courseInitials,
                curricularYear);
    ...
    public boolean equals(Object obj) {
        return getInitials().equals(((MigrationExecutionCourse) obj).getInitials());
    }
    ...
    public String toString() {
        ...
        stringBuffer.append("Disciplina Execução (Code: ").append(getInitials()).append(")").append(
                ...
                .append(getTheoreticalPraticalHours()).append(")").append("(L:").append(
                        getLaboratoryHours()).append(")").append("(T:").append(getTheoreticalHours())
                .append(")").append("(P:").append(getPracticalHours()).append(")").append("\r\n");
        ...
        while (iteratorDegrees.hasNext()) {
            ...
            while (courseIterator.hasNext()) {
                CourseCurricularYearPair pair = (CourseCurricularYearPair) courseIterator.next();
                stringBuffer.append("\t(").append(pair.getCourseInitials()).append(" - ").append(
                        pair.getCurricularYear()).append("º ano").append(")");
            }
            stringBuffer.append("\r\n");
        }
     ...
     * 
     * @param theoreticalPraticalHours
     *            The theoreticalPraticalHours to set
     */
