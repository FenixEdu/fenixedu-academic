...
public class SQL2JavaConverters {
    ...
    public static FieldConversion teacherServiceDistribution$TSDProcessPhaseStatus2SqlTSDProcessPhaseStatusConversion = new net.sourceforge.fenixedu.persistenceTier.Conversores.teacherServiceDistribution.TSDProcessPhaseStatus2SqlTSDProcessPhaseStatusConversion();
    public static FieldConversion teacherServiceDistribution$TSDValueType2SqlTSDValueTypeConversion = new net.sourceforge.fenixedu.persistenceTier.Conversores.teacherServiceDistribution.TSDValueType2SqlTSDValueTypeConversion();
    ...
    public static FieldConversion accounting$JavaGratuityExemptionJustificationType2SqlGratuityExemptionJustificationTypeFieldConversion = new net.sourceforge.fenixedu.persistenceTier.Conversores.accounting.JavaGratuityExemptionJustificationType2SqlGratuityExemptionJustificationTypeFieldConversion();
    ...
    public static FieldConversion ThesisVisibilityType2SqlConversion = new net.sourceforge.fenixedu.persistenceTier.Conversores.ThesisVisibilityType2SqlConversion();
    ...
    public static FieldConversion ResearchActivityStage2SqlConversion = new net.sourceforge.fenixedu.persistenceTier.Conversores.ResearchActivityStage2SqlConversion();
    ...
    public static FieldConversion SchoolClassCalculationMethodConversion = new net.sourceforge.fenixedu.persistenceTier.Conversores.SchoolClassCalculationMethodConversion();
}
