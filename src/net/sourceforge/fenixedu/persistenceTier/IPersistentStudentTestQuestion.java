...
public interface IPersistentStudentTestQuestion extends IPersistentObject {
    ...
    public abstract IStudentTestQuestion readByQuestionAndStudentAndDistributedTest(IQuestion question,
    ...
    public abstract int countResponses(Integer order, String response, IDistributedTest distributedTest)
            throws ExcepcaoPersistencia;

    public abstract List getResponses(Integer order, IDistributedTest distributedTest)
            throws ExcepcaoPersistencia;

    public abstract int countByResponse(String response, Integer order, IDistributedTest distributedTest)
            throws ExcepcaoPersistencia;

    public int countResponsedOrNotResponsed(Integer order, boolean responsed,
            IDistributedTest distributedTest) throws ExcepcaoPersistencia;

    public int countCorrectOrIncorrectAnswers(Integer order, Double mark, boolean equal,
            IDistributedTest distributedTest) throws ExcepcaoPersistencia;
    ...
    public abstract int countByQuestion(IQuestion question) throws ExcepcaoPersistencia;
