...
public class JavaYearMonthDay2SqlStringFieldConversion implements
		FieldConversion {
	...
	public Object javaToSql(Object object) {
		if (object != null) {
			...
			return String.format("%d-%02d-%02d", yearMonthDay
					.get(DateTimeFieldType.year()), yearMonthDay
					.get(DateTimeFieldType.monthOfYear()), yearMonthDay
