...
public class CurricularYearVO extends VersionedObjectsBase implements
	...
	public CurricularYear readCurricularYearByYear(final Integer year)
			throws ExcepcaoPersistencia {

		List curricularYears = (List) readAll(CurricularYear.class);
		
		return (CurricularYear) CollectionUtils.find(curricularYears,new Predicate() {
			public boolean evaluate (Object o) {
				
				return ((CurricularYear)o).getYear().equals(year);
			}
		});
	}
