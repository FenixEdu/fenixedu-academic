 ...
 */
public class StudentTestQuestionOJB extends PersistentObjectOJB implements
    ...
    public IStudentTestQuestion readByQuestionAndStudentAndDistributedTest(IQuestion question,
            IStudent student, IDistributedTest distributedTest) throws ExcepcaoPersistencia {
        Criteria criteria = new Criteria();
        criteria.addEqualTo("keyQuestion", question.getIdInternal());
        criteria.addEqualTo("keyStudent", student.getIdInternal());
        criteria.addEqualTo("keyDistributedTest", distributedTest.getIdInternal());
    ...
    public List readByOrderAndDistributedTest(Integer order, IDistributedTest distributedTest)
            throws ExcepcaoPersistencia {
        Criteria criteria = new Criteria();
    ...
    public List readStudentsByDistributedTest(IDistributedTest distributedTest)
        ...
        for (int i = 0; i < result.size(); i++) {
            IStudentTestQuestion studentTestQuestion = (IStudentTestQuestion) result.get(i);
    ...
    public Double getMaximumDistributedTestMark(IDistributedTest distributedTest) {
        ...
        for (int i = 0; i < studentTestQuestionList.size(); i++)
            result = result
                    + ((IStudentTestQuestion) studentTestQuestionList.get(i)).getTestQuestionValue()
                            .doubleValue();
    ...
    public Double readStudentTestFinalMark(Integer distributedTestId, Integer studentId)
            throws ExcepcaoPersistencia {
        Criteria criteria = new Criteria();
        ...
        while (it.hasNext())
            result = new Double(result.doubleValue()
                    + ((IStudentTestQuestion) it.next()).getTestQuestionMark().doubleValue());
        return result;
    }

    public List readDistributedTestsByTestQuestion(IQuestion question) throws ExcepcaoPersistencia {
        Criteria criteria = new Criteria();
        criteria.addEqualTo("keyQuestion", question.getIdInternal());
        List studentTestQuestions = queryList(StudentTestQuestion.class, criteria);
        Iterator it = studentTestQuestions.iterator();
        ...
        while (it.hasNext()) {
            IDistributedTest distributedTest = ((IStudentTestQuestion) it.next()).getDistributedTest();
    ...
    public List getResponses(Integer order, IDistributedTest distributedTest) {
        ...
        Iterator iterator = result.iterator();
        while (iterator.hasNext()) {
            resultList.add(((IStudentTestQuestion) iterator.next()).getResponse());
        }
        return resultList;
    }
