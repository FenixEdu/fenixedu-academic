...
public class ManageResearchUnitPersistentGroup extends Filtro {
	...
	public void execute(ServiceRequest request, ServiceResponse response) throws Exception {
		...
		if (!(unit instanceof ResearchUnit && ((ResearchUnit) unit).getSite() != null && ((ResearchUnit) unit)
				.getSite().hasManagers(person))) {
