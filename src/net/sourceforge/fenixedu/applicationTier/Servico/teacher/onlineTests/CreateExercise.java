...
public class CreateExercise implements IService {
    ...
    public boolean run(Integer executionCourseId, Integer metadataId, String author, String description,
            ...
            InfoQuestion infoQuestion, String questionText, String secondQuestionText, String[] options, String[] correctOptions, String[] shuffle,
        ...
        try {
            ...
            try {
                question.setXmlFile(getQuestion(infoQuestion, questionText, secondQuestionText, options, shuffle, correctFeedbackText,
    ...
    private String getQuestion(InfoQuestion infoQuestion, String questionText, String secondQuestionText, String[] options, String[] shuffle,
        ...
        xmlFile = new String(xmlQuestion.getXmlQuestion(questionText, secondQuestionText, infoQuestion.getQuestionType(), options, shuffle,
