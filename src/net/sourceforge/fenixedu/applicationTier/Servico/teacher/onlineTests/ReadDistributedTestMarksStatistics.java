...
public class ReadDistributedTestMarksStatistics extends Service {
	...
	for (StudentTestQuestion studentTestQuestion : studentTestQuestions) {
		...
		correctAnswersPercentageList.add(df.format(distributedTest.countAnsweres(studentTestQuestion
			.getTestQuestionOrder(), studentTestQuestion.getTestQuestionValue(), true)
		...
		int partially = distributedTest.countPartiallyCorrectAnswers(studentTestQuestion.getTestQuestionOrder(),
