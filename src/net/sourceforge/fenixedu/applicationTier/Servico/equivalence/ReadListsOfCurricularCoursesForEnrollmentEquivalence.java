...
public class ReadListsOfCurricularCoursesForEnrollmentEquivalence extends
    ...
    protected Object convertDataOutput(Object object) {
        ...
        infoEquivalenceContext
                .setInfoEnrolmentsToGiveEquivalence(cloneEnrolmentsToInfoEnrolments(enrollmentsThatMayGiveEquivalences));
    ...
    protected Object execute(Object object) throws FenixServiceException {
        ...
        try {
            ...
            final IStudentCurricularPlan fromStudentCurricularPlan = (IStudentCurricularPlan) studentCurricularPlanDAO
                    .readByOID(StudentCurricularPlan.class, fromStudentCurricularPlanID);

            final IStudentCurricularPlan toStudentCurricularPlan = (IStudentCurricularPlan) studentCurricularPlanDAO
            ...
            List curricularCoursesThatMayGetEquivalences = (List) CollectionUtils.select(
                    toStudentCurricularPlan.getDegreeCurricularPlan().getCurricularCourses(),
                    new Predicate() {
                        public boolean evaluate(Object obj) {
