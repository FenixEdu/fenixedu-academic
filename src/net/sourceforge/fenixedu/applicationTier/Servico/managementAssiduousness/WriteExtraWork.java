...
public class WriteExtraWork implements IService {
	...
	public List run(String usernameWho, List infoExtraWorkList, Integer employeeNumber,
		...
		infoExtraWorkListAfterWrite = (List) CollectionUtils.collect(extraWorkList, new Transformer() {
