...
public class AddNewDelegate extends Service {
	...
	/* Year Delegates */
	public void run(Student student, YearDelegateElection election) throws FenixServiceException, ExcepcaoPersistencia {
	...
	/* Year Delegates */
	public void run(Student student, CurricularYear curricularYear, Degree degree) throws FenixServiceException, ExcepcaoPersistencia {
	...
	/* All other delegates */
	public void run(Student student, Degree degree, FunctionType delegateFunctionType) throws FenixServiceException, ExcepcaoPersistencia {
		final DegreeUnit degreeUnit = degree.getUnit();
		final Person studentPerson = student.getPerson();
