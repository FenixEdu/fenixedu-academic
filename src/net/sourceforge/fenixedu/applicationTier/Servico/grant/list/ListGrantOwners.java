...
public class ListGrantOwners extends Service {
    ...
    public Object[] run(InfoSpanListGrantOwner infoSpanListGrantOwner) throws FenixServiceException,
        ...
        grantOwnerBySpan = GrantOwner.readAllGrantOwnersBySpan(infoSpanListGrantOwner.getSpanNumber(),
                SessionConstants.NUMBER_OF_ELEMENTS_IN_SPAN, propertyOrderBy(infoSpanListGrantOwner
                        .getOrderBy()));
