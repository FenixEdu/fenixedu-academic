...
public class ReadAllContractsByGrantOwner extends FenixService {
    ...
    public static List run(Integer grantOwnerId) throws FenixServiceException {
        ...
        for (final GrantContract grantContract : contracts) {
            ...
            final InfoGrantContract infoGrantContract =
                    InfoGrantContractWithGrantOwnerAndGrantType.newInfoFromDomain(grantContract);
            final InfoGrantOrientationTeacher infoOrientationTeacher =
                    InfoGrantOrientationTeacherWithTeacherAndGrantContract.newInfoFromDomain(grantContract
            ...
            if (grantContract.getGrantCostCenter() != null) {
                final InfoGrantCostCenter infoGrantCostCenter =
                        InfoGrantCostCenter.newInfoFromDomain(grantContract.getGrantCostCenter());
            ...
            if (infoGrantContract.getEndContractMotiveSet()) {
                ...
                GrantContractRegime grantContractRegime = (GrantContractRegime) grantContractRegimeActual.get(0);
