...
public class CreatePortal extends Service {
    ...
    public void run(Container container, MultiLanguageString name, String prefix) {
    ...
    private void configurePortal(Portal portal, MultiLanguageString name, String prefix) {
	portal.setName(name);
