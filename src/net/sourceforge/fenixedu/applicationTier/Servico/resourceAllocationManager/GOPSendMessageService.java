...
public class GOPSendMessageService {
    ...
    //
    // final String SUBJECT_FORMAT = "Altera��o de salas : [%s] para [%s]";
    // final String SUBJECT_ONLY1_FORMAT = "Altera��o de salas : [%s]";
    // final String BODY_FORMAT =
    // "Para a prova de avalia��o escrita %s no dia %s das %s �s %s, as salas : \n";
