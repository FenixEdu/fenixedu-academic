...
public class ChangeStudentsShift {
	...
	final String groupName = MessageFormat
		.format(bundle.getString("changeStudentsShift.email.groupName"), oldShift.getNome());

	final String messagePrefix = MessageFormat.format(bundle.getString("changeStudentsShift.email.body"), oldShift.getNome());

	final String messagePosfix = newShift == null ? bundle.getString("changeStudentsShift.email.body.notNewShift")
		: MessageFormat.format(bundle.getString("changeStudentsShift.email.body.newShift"), oldShift.getNome());
