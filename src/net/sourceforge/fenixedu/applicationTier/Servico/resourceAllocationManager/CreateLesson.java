    ...
    public InfoLessonServiceResult run(DiaSemana weekDay, Calendar begin, Calendar end, Integer frequency, 
        ...
        if (result.isSUCESS()) {
                ...
                if (infoShiftServiceResult.isSUCESS()) {
                    ...
                    Lesson aula = new Lesson(weekDay, begin, end, infoShift.getTipo(), shift, weekOfQuinzenalStart, frequency, executionPeriod);
                	...
                	try {
                	    new LessonSpaceOccupation(sala, HourMinuteSecond.fromCalendarFields(infoRoomOccupation.getStartTime()), 
                    		HourMinuteSecond.fromCalendarFields(infoRoomOccupation.getEndTime()),
                    		infoRoomOccupation.getDayOfWeek(), period, aula);   
