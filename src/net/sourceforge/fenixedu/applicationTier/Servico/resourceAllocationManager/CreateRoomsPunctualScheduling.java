...
public class CreateRoomsPunctualScheduling extends Service {
	...
	if (!selectedRooms.isEmpty()) {
	    ...
	    HourMinuteSecond beginTime = new HourMinuteSecond(bean.getBeginTime().get(DateTimeFieldType.hourOfDay()), bean
		    .getBeginTime().get(DateTimeFieldType.minuteOfHour()), 0);
