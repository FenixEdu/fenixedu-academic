...
public class ReadProjectAccesses extends Service {
    ...
    public List run(String username, String costCenter, String userNumber) throws FenixServiceException,
        ...
        List<ProjectAccess> projectAcessesList = ProjectAccess.getAllByCoordinator(new Integer(
                userNumber));
        ...
        for (ProjectAccess projectAccess : projectAcessesList) {
            ...
            infoProjectAccess.setInfoProject(InfoProject.newInfoFromDomain(persistentSupportOracle
                    .getIPersistentProject().readProject(infoProjectAccess.getKeyProject())));
    ...
    public List run(String userView, String costCenter, String username, String userNumber)
            throws FenixServiceException, ExcepcaoPersistencia {
        Integer personCoordinator = new Integer(userNumber);
        List<InfoProjectAccess> infoProjectAcessesList = new ArrayList<InfoProjectAccess>();
        final Person person = Person.readPersonByUsername(username);
        if (person != null) {
            List<ProjectAccess> projectAcessesList = person
    ...
    public InfoProjectAccess run(String username, String costCenter, Integer personCode,
