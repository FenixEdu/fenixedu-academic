...
public class ReadStudentCurricularPlanForEnrollments extends Service {
    ...
    public StudentCurricularPlan run(Integer executionDegreeId, Registration registration)
	    throws FenixServiceException {
	return findStudentCurricularPlan(registration);
    }

    protected StudentCurricularPlan findStudentCurricularPlan(final Registration registration)
