 ...
 */
public class ReadDegreeInfoByDegreeAndExecutionPeriod implements IService {

    public InfoDegreeInfo run(Integer executionPeriodId, Integer degreeId) throws FenixServiceException, ExcepcaoPersistencia {
        ...
        List degreeInfoList = persistentDegreeInfo.readDegreeInfoByDegreeAndExecutionYear(degree.getIdInternal(),
        ...
        if (degreeInfoList == null || degreeInfoList.size() <= 0) {
            ...
            degreeInfoList = degree.getDegreeInfos();
            if (degreeInfoList == null || degreeInfoList.size() <= 0) {
                throw new FenixServiceException("error.impossibleDegreeSite");
            }
        }
