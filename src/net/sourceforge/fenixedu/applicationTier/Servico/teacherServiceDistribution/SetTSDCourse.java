...
public class SetTSDCourse extends Service {
	...
	String weightFirstTimeEnrolledStudentsPerShiftTypeStr = (String) tsdCourseParameters
	...
	if (firstTimeEnrolledStudentsTypeStr != null) {
	    ...
	    TSDValueType firstTimeEnrolledStudentsType = (firstTimeEnrolledStudentsTypeStr == null || firstTimeEnrolledStudentsTypeStr
		    .equals("")) ? TSDValueType.MANUAL_VALUE : TSDValueType.valueOf(firstTimeEnrolledStudentsTypeStr);
	    TSDValueType secondTimeEnrolledStudentsType = (secondTimeEnrolledStudentsTypeStr == null || secondTimeEnrolledStudentsTypeStr
		    .equals("")) ? TSDValueType.MANUAL_VALUE : TSDValueType.valueOf(secondTimeEnrolledStudentsTypeStr);

	    Integer firstTimeEnrolledStudentsManual = (firstTimeEnrolledStudentsType == TSDValueType.MANUAL_VALUE) ? (Integer) tsdCourseParameters
		    .get("firstTimeEnrolledStudentsManual")
		    : tsdCourse.getFirstTimeEnrolledStudentsManual();
	    Integer secondTimeEnrolledStudentsManual = (secondTimeEnrolledStudentsType == TSDValueType.MANUAL_VALUE) ? (Integer) tsdCourseParameters
		    .get("secondTimeEnrolledStudentsManual")
		    : tsdCourse.getSecondTimeEnrolledStudentsManual();
	 ...
	 * 
	 * TSDCurricularLoad tsdLoad =
	 * tsdCourse.getTSDCurricularLoadByShiftType(shiftType);
	 * 
	 * if(tsdLoad != null){ tsdLoad.delete(); } }
	 */

	// Weights Valuation
	if (weightFirstTimeEnrolledStudentsPerShiftTypeStr != null) {
	    String weightSecondTimeEnrolledStudentsPerShiftTypeStr = (String) tsdCourseParameters
		    .get("weightSecondTimeEnrolledStudentsPerShiftType");

	    TSDValueType weightFirstTimeEnrolledStudentsPerShiftType = weightFirstTimeEnrolledStudentsPerShiftTypeStr.equals("") ? TSDValueType.MANUAL_VALUE
		    : TSDValueType.valueOf(weightFirstTimeEnrolledStudentsPerShiftTypeStr);
	    TSDValueType weightSecondTimeEnrolledStudentsPerShiftType = (weightSecondTimeEnrolledStudentsPerShiftTypeStr == null || weightSecondTimeEnrolledStudentsPerShiftTypeStr
		    .equals("")) ? TSDValueType.MANUAL_VALUE : TSDValueType
		    .valueOf(weightSecondTimeEnrolledStudentsPerShiftTypeStr);

	    String shiftTypeStr = (String) tsdCourseParameters.get("shiftType");
	    ShiftType shiftType = ShiftType.valueOf(shiftTypeStr);
	    TSDCurricularLoad tsdLoad = tsdCourse.getTSDCurricularLoadByShiftType(shiftType);

	    Double weightFirstTimeEnrolledStudentsPerShiftManual = (weightFirstTimeEnrolledStudentsPerShiftType == TSDValueType.MANUAL_VALUE) ? (Double) tsdCourseParameters
		    .get("weightFirstTimeEnrolledStudentsPerShiftManual")
		    : tsdLoad.getWeightFirstTimeEnrolledStudentsPerShiftManual();
	    Double weightSecondTimeEnrolledStudentsPerShiftManual = (weightSecondTimeEnrolledStudentsPerShiftType == TSDValueType.MANUAL_VALUE) ? (Double) tsdCourseParameters
		    .get("weightSecondTimeEnrolledStudentsPerShiftManual")
		    : tsdLoad.getWeightSecondTimeEnrolledStudentsPerShiftManual();
	...
	if (hoursTypeStr != null) {
	    ...
	    Double hoursManual = (hoursType == TSDValueType.MANUAL_VALUE) ? (Double) tsdCourseParameters.get("hoursManual")
		    : tsdLoad.getHoursManual();
	    Double hoursPerShift = (Double) tsdCourseParameters.get("hoursPerShift");
	    // Integer timeTableSlots = (Integer)
	    // tsdCourseParameters.get("timeTableSlots");

	    Integer studentsPerShiftManual = (studentsPerShiftType == TSDValueType.MANUAL_VALUE) ? (Integer) tsdCourseParameters
		    .get("studentsPerShiftManual") : tsdCourse.getStudentsPerShiftManual(shiftType);
