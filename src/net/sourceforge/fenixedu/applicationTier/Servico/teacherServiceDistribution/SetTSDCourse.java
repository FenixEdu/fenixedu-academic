...
public class SetTSDCourse extends FenixService {
	public void run(Integer tsdCourseId, Map<String, Object> tsdCourseParameters) {
		...
		String weightFirstTimeEnrolledStudentsPerShiftTypeStr =
				(String) tsdCourseParameters.get("weightFirstTimeEnrolledStudentsPerShiftType");
		...
		if (firstTimeEnrolledStudentsTypeStr != null) {
			...
			TSDValueType firstTimeEnrolledStudentsType =
					(firstTimeEnrolledStudentsTypeStr == null || firstTimeEnrolledStudentsTypeStr.equals("")) ? TSDValueType.MANUAL_VALUE : TSDValueType
							.valueOf(firstTimeEnrolledStudentsTypeStr);
			TSDValueType secondTimeEnrolledStudentsType =
					(secondTimeEnrolledStudentsTypeStr == null || secondTimeEnrolledStudentsTypeStr.equals("")) ? TSDValueType.MANUAL_VALUE : TSDValueType
							.valueOf(secondTimeEnrolledStudentsTypeStr);

			Integer firstTimeEnrolledStudentsManual =
					(firstTimeEnrolledStudentsType == TSDValueType.MANUAL_VALUE) ? (Integer) tsdCourseParameters
							.get("firstTimeEnrolledStudentsManual") : tsdCourse.getFirstTimeEnrolledStudentsManual();
			Integer secondTimeEnrolledStudentsManual =
					(secondTimeEnrolledStudentsType == TSDValueType.MANUAL_VALUE) ? (Integer) tsdCourseParameters
							.get("secondTimeEnrolledStudentsManual") : tsdCourse.getSecondTimeEnrolledStudentsManual();
		...
		if (weightFirstTimeEnrolledStudentsPerShiftTypeStr != null) {
			String weightSecondTimeEnrolledStudentsPerShiftTypeStr =
					(String) tsdCourseParameters.get("weightSecondTimeEnrolledStudentsPerShiftType");

			TSDValueType weightFirstTimeEnrolledStudentsPerShiftType =
					weightFirstTimeEnrolledStudentsPerShiftTypeStr.equals("") ? TSDValueType.MANUAL_VALUE : TSDValueType
							.valueOf(weightFirstTimeEnrolledStudentsPerShiftTypeStr);
			TSDValueType weightSecondTimeEnrolledStudentsPerShiftType =
					(weightSecondTimeEnrolledStudentsPerShiftTypeStr == null || weightSecondTimeEnrolledStudentsPerShiftTypeStr
			...
			Double weightFirstTimeEnrolledStudentsPerShiftManual =
					(weightFirstTimeEnrolledStudentsPerShiftType == TSDValueType.MANUAL_VALUE) ? (Double) tsdCourseParameters
							.get("weightFirstTimeEnrolledStudentsPerShiftManual") : tsdLoad
							.getWeightFirstTimeEnrolledStudentsPerShiftManual();
			Double weightSecondTimeEnrolledStudentsPerShiftManual =
					(weightSecondTimeEnrolledStudentsPerShiftType == TSDValueType.MANUAL_VALUE) ? (Double) tsdCourseParameters
							.get("weightSecondTimeEnrolledStudentsPerShiftManual") : tsdLoad
							.getWeightSecondTimeEnrolledStudentsPerShiftManual();
		...
		if (hoursTypeStr != null) {
			...
			Double hoursManual =
					(hoursType == TSDValueType.MANUAL_VALUE) ? (Double) tsdCourseParameters.get("hoursManual") : tsdLoad
							.getHoursManual();
			...
			Integer studentsPerShiftManual =
					(studentsPerShiftType == TSDValueType.MANUAL_VALUE) ? (Integer) tsdCourseParameters
