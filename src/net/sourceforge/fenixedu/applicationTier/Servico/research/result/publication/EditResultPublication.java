...
public class EditResultPublication extends ResultPublicationService {
	...
	if (publication instanceof Book) {
	    ((Book) publication).setEditAll(bean.getTitle(), bean.getKeywords(), bean.getPublisher(), bean.getYear(), bean
		    .getVolume(), bean.getSeries(), bean.getAddress(), bean.getEdition(), bean.getIsbn(), bean.getNumberPages(),
		    bean.getLanguage(), bean.getCountry(), bean.getScope(), bean.getNote(), bean.getMonth(), bean.getUrl());
	...
	if (publication instanceof BookPart) {
	    ((BookPart) publication).setEditAll(bean.getTitle(), bean.getKeywords(), bean.getBookTitle(), bean.getChapter(), bean
		    .getFirstPage(), bean.getLastPage(), bean.getPublisher(), bean.getYear(), bean.getVolume(), bean.getSeries(),
		    bean.getEdition(), bean.getCountry(), bean.getAddress(), bean.getNote(), bean.getMonth(), bean.getUrl());
	    finalPublication = publication;
	...
	if (publication instanceof Inproceedings) {
	    ...
	    ((Inproceedings) publication).setEditAll(bean.getTitle(), bean.getKeywords(), bean.getEventEdition(), bean
		    .getPublisher(), bean.getAddress(), bean.getFirstPage(), bean.getLastPage(), bean.getNote(), bean
	...
	if (publication instanceof Proceedings) {
	    ...
	    ((Proceedings) publication).setEditAll(bean.getTitle(), bean.getKeywords(), bean.getEventEdition(), bean
		    .getPublisher(), bean.getAddress(), bean.getNote(), bean.getUrl());
	    finalPublication = publication;
	...
	if (publication instanceof Manual) {
	    ((Manual) publication).setEditAll(bean.getTitle(), bean.getKeywords(), bean.getOrganization(), bean.getYear(), bean
	...
	if (publication instanceof TechnicalReport) {
	    ((TechnicalReport) publication).setEditAll(bean.getTitle(), bean.getKeywords(), bean.getOrganization(), bean
		    .getYear(), bean.getTechnicalReportType(), bean.getNumber(), bean.getAddress(), bean.getNote(), bean
	...
	if (publication instanceof OtherPublication) {
	    ((OtherPublication) publication).setEditAll(bean.getTitle(), bean.getKeywords(), bean.getPublisher(), bean.getYear(),
		    bean.getHowPublished(), bean.getNote(), bean.getAddress(), bean.getOtherPublicationType(), bean
			    .getNumberPages(), bean.getLanguage(), bean.getCountry(), bean.getMonth(), bean.getUrl());
	    finalPublication = publication;
