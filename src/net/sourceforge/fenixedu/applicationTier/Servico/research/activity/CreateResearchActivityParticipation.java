...
public class CreateResearchActivityParticipation extends Service {
    ...
    public void run(ScientificJournal journal, ParticipantBean bean) throws FenixServiceException {
    ...
    public void run(ResearchEvent event, ParticipantBean bean) throws FenixServiceException {
    ...
    public void run(ResearchCooperationCreationBean cooperationBean, Person person) throws FenixServiceException {
