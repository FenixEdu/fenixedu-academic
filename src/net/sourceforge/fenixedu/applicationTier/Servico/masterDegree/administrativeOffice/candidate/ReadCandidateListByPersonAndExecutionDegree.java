...
public class ReadCandidateListByPersonAndExecutionDegree extends FenixService {

    public InfoMasterDegreeCandidate run(InfoExecutionDegree infoExecutionDegree, InfoPerson infoPerson, Integer number)
