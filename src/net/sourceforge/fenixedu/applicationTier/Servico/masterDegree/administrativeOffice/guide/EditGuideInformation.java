		...
		if (infoGuide.getInfoGuideSituation().getSituation().equals(GuideState.NON_PAYED)) {
			...
			if (change) {
				...
				while (entryIterator.hasNext()) {
					...
					IGuideEntry guideEntry =  (IGuideEntry) sp.getIPersistentGuideEntry().readByOID(GuideEntry.class, infoGuideEntry.getIdInternal());
					...
					sp.getIPersistentGuideEntry().deleteByOID(GuideEntry.class,infoGuideEntry.getIdInternal());
				}
