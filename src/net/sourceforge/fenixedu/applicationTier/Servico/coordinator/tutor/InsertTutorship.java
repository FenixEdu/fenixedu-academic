...
public class InsertTutorship extends TutorshipManagement {
	...
	Registration registration = Registration.readRegisteredRegistrationByNumberAndDegreeType(studentNumber, executionDegree
	...
	for (StudentCurricularPlan studentCurricularPlan : students) {
		...
		createTutorship(teacher, studentCurricularPlan, bean.getTutorshipEndMonth().getNumberOfMonth(), bean
			.getTutorshipEndYear());
