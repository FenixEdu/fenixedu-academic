...
public class TransferTutorship extends TutorshipManagement {
	...
	Partial tutorshipEndDateDueToTransfer = new Partial(new DateTimeFieldType[] { DateTimeFieldType.year(),
		DateTimeFieldType.monthOfYear() }, new int[] { currentDate.year().get(), currentDate.monthOfYear().get() });
