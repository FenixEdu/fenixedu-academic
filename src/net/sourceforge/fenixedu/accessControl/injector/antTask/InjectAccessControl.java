...
package net.sourceforge.fenixedu.accessControl.injector.antTask;
...
import net.sourceforge.fenixedu.accessControl.injector.AccesControlChecksInjector;
import net.sourceforge.fenixedu.accessControl.injector.AccessControlCodeGenerator;
import net.sourceforge.fenixedu.accessControl.injector.AccesControlChecksInjector.InvalidReturnTypeForGetter;
import net.sourceforge.fenixedu.accessControl.injector.AccesControlChecksInjector.NoGetterAvaliableForSpecifiedSlot;
 ...
 * @version $Id$
 */
public class InjectAccessControl extends Task
{
	...
	public String getAccessControlAnnotation()
	{
		return accessControlAnnotation;
	}

	public void setAccessControlAnnotation(String accessControlAnnotation)
	{
	...
	private AccessControlCodeGenerator producerClassByName() throws ClassNotFoundException,
	...
	public void execute()
	{
		...
		AccesControlChecksInjector injector;
		try
		{
			injector = new AccesControlChecksInjector(this.verbose, searchPaths);
		}
		...
		System.out.printf("\nProcessed %d file%s. %d class%s re-written (%s).\nDone.", processedFiles, processedFiles == 0
				|| processedFiles > 1 ? "s" : "", changedFiles, changedFiles == 0 || changedFiles > 1 ? "es were"
				: " was", this.calcHMS((after - before) / 1000));
	}
	...
	{
		if (this.codeProducerClassName == null) throw new BuildException("codeProducerClassName is a mandatory attribute");
		if (this.accessControlAnnotation == null) throw new BuildException("accessControlAnnotation is a mandatory attribute");
		if (this.targetClassesDir == null) throw new BuildException("targetClassesDir is a mandatory attribute");
	}
