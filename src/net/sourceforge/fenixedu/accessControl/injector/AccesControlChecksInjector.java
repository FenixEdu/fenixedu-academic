...
public class AccesControlChecksInjector
{
			...
			throws ClassNotFoundException, NoGetterAvaliableForSpecifiedSlot, InvalidReturnTypeForGetter
	{
		...
		try
		{
			...
			if (!IUserGroup.class.isAssignableFrom(returnType))
			{
				throw new InvalidReturnTypeForGetter(m.getName() + " must return an instance of " + IUserGroup.class.getName()+ " and its returning an instance of " + returnType.getClass().getName());
			}
		}
