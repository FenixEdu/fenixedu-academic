...
public class PersistentExpensesReport extends PersistentReport implements IPersistentExpensesReport {
	...
	@Override
	public List<IExpensesReportLine> getReportByRubric(ReportType reportType, String projectCode, String rubric,
	...
	@Override
	public List<LabelValueBean> getRubricList(ReportType reportType, String projectCode, final BackendInstance instance)
			throws ExcepcaoPersistencia {
