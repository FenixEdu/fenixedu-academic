...
public class PersistentProject {
	...
	public List<InfoProject> readByProjectsCodes(List<String> projectCodes, final BackendInstance instance)
	...
	public List<InfoProject> readByCoordinatorAndNotProjectsCodes(Integer coordinatorId, List projectCodes,
	...
	public boolean isUserProject(Integer userCode, String projectCode, final BackendInstance instance)
			throws ExcepcaoPersistencia {
		boolean result = false;
		String query =
				" select count(*) from web_user_projs up where up.login='" + userCode + "' and up.id_proj='" + projectCode + "'";
