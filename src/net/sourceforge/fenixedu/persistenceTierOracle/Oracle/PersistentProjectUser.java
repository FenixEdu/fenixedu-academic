...
public class PersistentProjectUser {
	...
	public List<IRubric> getInstitucionalProjectCoordId(Integer userCode, final BackendInstance instance)
	...
	public List<IRubric> getInstitucionalProjectByCCIDs(Integer ccCode, final BackendInstance instance)
			throws ExcepcaoPersistencia {
	...
	public List<IRubric> getInstitucionalProjectByCCIDs(List<Integer> ccCodes, final BackendInstance instance)
			throws ExcepcaoPersistencia {
		List<IRubric> result = new ArrayList<IRubric>();
	...
	public String getCCNameByCoordinatorAndCC(Integer userNumber, Integer costCenter, final BackendInstance instance)
			throws ExcepcaoPersistencia {
