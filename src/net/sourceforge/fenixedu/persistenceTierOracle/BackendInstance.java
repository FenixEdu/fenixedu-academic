...
public enum BackendInstance {
    ...
    IST(RoleType.PROJECTS_MANAGER, RoleType.INSTITUCIONAL_PROJECTS_MANAGER), IT(RoleType.IT_PROJECTS_MANAGER, null), IST_ID(
            RoleType.ISTID_PROJECTS_MANAGER, RoleType.ISTID_INSTITUCIONAL_PROJECTS_MANAGER), ADIST(
            RoleType.ADIST_PROJECTS_MANAGER, RoleType.ADIST_INSTITUCIONAL_PROJECTS_MANAGER);
