...
public class ParseMetadata extends DefaultHandler {
    ...
    private IMetadata vector2Metadata(Vector vector, IMetadata metadata) {
        ...
        boolean difficulty = false, description = false, mainsubject = false, secondarysubject = false, level = false, author = false, members = false, value = false, typicallearningtime = false;
