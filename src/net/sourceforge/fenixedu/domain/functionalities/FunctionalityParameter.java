...
/**
 * The <code>FunctionalityParameter</code> reifies a parameters that is
 * required by a functionality. A parameter is identified by it's name, that is,
 * there are no two parameters, for the same functionality, with the same name.
 * 
 * @author cfgi
 */
