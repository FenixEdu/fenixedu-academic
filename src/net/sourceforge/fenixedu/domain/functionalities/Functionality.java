...
public class Functionality extends Functionality_Base implements IFunctionality {
    ...
    /**
         * Generates an identifier that identifies a functionality in all
         * systems during the it's entire lifetime. The idea is that when
         * functionalities refer to each other during the exporting/importing
         * operation we cannot rely on database dependant information like the
         * internal id of the functionality. The UUID will be used instead and,
         * since it's part of the functionality, will be unique and unchanged in
         * all systems unless manually tampered with.
         * 
    ...
    /**
         * The functionality, as a content, can have multiple parents but can
         * have only one module. This method finds and returns that module.
         * 
    ...
    /**
         * Checks that the public of this functionality does not conflict with
         * the public path of other functionalities.
         * 
         * @exception MatchPathConflictException
         *                    when the public path of this functionality
         *                    conflicts with the public path of another
         *                    functionality, that is, when there are two public
         *                    paths that are equal
         */
    ...
    /**
         * The method follows the hierarchy of the functionalities to determine
         * the final public path through which the functionality is available.
         * This takes in account the module structure and if functionalities are
         * relative or not, that is, if the path is relative the the parent
         * structure or not.
         * 
         * @return the path that should be publicly used to access the
         *         functionality or <code>null</code> if there is no path
         *         defined
         * 
         * @see #getModule()
         * @see #isRelative()
    ...
    /**
         ...
         * {@link #getPublicPath() public path} used to match agains the
         * requested path.
         * 
         * @return the path that should be used to match this functionality
         *         against the requested path or <code>null</code> if it does
         *         not have one
         */
    ...
    /**
         * Convenience method that receives the parameters as a list an converts
         * the list to a string were parameters are separated by commas before
    ...
    /**
         * Determines if this functionality is parameterized, that is, if it
         * expects any parameters to be passed in order to work properly.
         * 
    ...
    /**
         ...
         * module. If the holding module is a top level module this
         * functionality isn't moved.
         * 
    ...
    /**
         ...
         * <code>null</code> this functionality becomes a top level
         * functionality.
         * 
         * @param module
    ...
    /**
         ...
         * sibling module. If there are no sibling modules then this
         * functionality isn't moved. If there are two modules next to the
         * functionality the one above (acording to the functionality order) is
         * choosen.
         * 
         * @throws NullPointerException
         *                 when {@link #getModule()} is <code>null</code>
    ...
    /**
         * Checks is this functionality is available in the given context, that
         * is, if the person hold in the context may start the usecase pointed
         ...
         * <li>all the parameters defined for the functionality are available
         * in the context;</li>
         * <li>all the parent modules are available;</li>
         * <li>the defined availability policy allows the given person to
         * access the functionality;</li>
         * </ul>
         * 
         * @param context
    ...
    /**
         ...
         * @return <code>true</code> if the functionality is not parameterized
         *         or if the current request, available from the given context,
    ...
    /**
         ...
         * {@link #getTopLevelFunctionalities() previous one} but sorts the set
         * of functionalities.
         * 
    ...
    /**
         ...
         * @return the functionality with the given <tt>uuid</tt> if it exists
         *         or <code>null</code> in all the other cases
         */
