...
public enum Gender {
	...
	/**
	 * This method has been deprecated, as it is only a proxy to @see GenderHelper#getSexLabelValues(Locale)
	 * It is strange that an enum belonging to the domain model objects should be dependent on
	 * struts as it is...
	 * @deprecated 
	 * 
	 * @param locale The locale for the localized labels
	 * @return an array of LabelValueBean containing the name of the Gender and its localized string version
	 */
	 ...
	 * 
	 * @param locale The Locale for which to get the localized version
	 ...
	 * 
	 * @param name The enum's member name
