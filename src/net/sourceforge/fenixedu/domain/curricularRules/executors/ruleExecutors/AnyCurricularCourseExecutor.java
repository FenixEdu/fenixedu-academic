...
public class AnyCurricularCourseExecutor extends CurricularRuleExecutor {
	...
	return result ? RuleResult.createTrue(sourceDegreeModuleToEvaluate.getDegreeModule()) : RuleResult
		.createFalseWithLiteralMessage(sourceDegreeModuleToEvaluate.getDegreeModule(), CurricularRuleLabelFormatter
			.getLabel(rule));
    }
