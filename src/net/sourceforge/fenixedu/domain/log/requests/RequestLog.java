...
public class RequestLog extends RequestLog_Base {
    ...
    public RequestLog(String queryString, String user, String requestAttributes, String sessionAttributes, String path,
	    String... parameters) {
	this();
    ...
    public static RequestLog registerError(String path, String[] parameters, String queryString, String user,
	    String requestAttributes, String sessionAttributes, String stackTrace, String exceptionType) {

	RequestLog requestLog = new RequestLog(queryString, user, requestAttributes, sessionAttributes, path, parameters);
