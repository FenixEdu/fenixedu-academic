...
//    // Enrolments para guardar histórico, não usar para mais nada!
//
//    public static final EnrolmentEvaluationType NORMAL_OBJ = new EnrolmentEvaluationType(
//            EnrolmentEvaluationType.NORMAL);
//
//    public static final EnrolmentEvaluationType IMPROVEMENT_OBJ = new EnrolmentEvaluationType(
//            EnrolmentEvaluationType.IMPROVEMENT);
//
//    public static final EnrolmentEvaluationType SPECIAL_SEASON_OBJ = new EnrolmentEvaluationType(
//            EnrolmentEvaluationType.SPECIAL_SEASON);
//
//    public static final EnrolmentEvaluationType EXTERNAL_OBJ = new EnrolmentEvaluationType(
//            EnrolmentEvaluationType.EXTERNAL);
//
//    public static final EnrolmentEvaluationType EQUIVALENCE_OBJ = new EnrolmentEvaluationType(
//            EnrolmentEvaluationType.EQUIVALENCE);
//
//    public static final EnrolmentEvaluationType CLOSED_OBJ = new EnrolmentEvaluationType(
//            EnrolmentEvaluationType.CLOSED);
//
//    public static final EnrolmentEvaluationType FIRST_SEASON_OBJ = new EnrolmentEvaluationType(
//            EnrolmentEvaluationType.FIRST_SEASON);
//
//    public static final EnrolmentEvaluationType SECOND_SEASON_OBJ = new EnrolmentEvaluationType(
//            EnrolmentEvaluationType.SECOND_SEASON);
//
//    public static final EnrolmentEvaluationType NO_SEASON_OBJ = new EnrolmentEvaluationType(
//            EnrolmentEvaluationType.NO_SEASON);
//
