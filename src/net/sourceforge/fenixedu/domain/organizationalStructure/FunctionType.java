...
public enum FunctionType {
    ...
    PRESIDENT, VICE_PRESIDENT, ASSISTANCE_PRESIDENT, DIRECTOR, ASSOCIATE_DIRECTOR, COORDINATOR, VICE_COORDINATOR, ASSOCIATE_COORDINATOR, CHIEF, RESPONSIBLE, TEACHER, EMPLOYEE, NON_TEACHING_EMPLOYEE, TEACHER_MEMBER, EMPLOYEE_MEMBER, STUDENT_MEMBER, TEACER_VOWEL, VOWEL, SECRETARY, REPRESENTATIVE, MEMBER, ASSIDUOUSNESS_RESPONSIBLE, PRINCIPAL, PRO_PRINCIPAL, MANAGER, ADVISER,
