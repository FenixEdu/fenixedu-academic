...
import net.sourceforge.fenixedu.domain.candidacy.workflow.form.PasswordForm;
...
public class FillPersonalDataOperation extends CandidacyOperation {
    ...
    public FillPersonalDataOperation(final Set<RoleType> roleTypes, final DegreeCandidacy degreeCandidacy) {
        ...
        setPasswordForm(PasswordForm.createFromPerson(getPerson()));
        addForm(getPasswordForm());
    ...
    protected void fillPassword(final Person person) {
        person.setPassword(PasswordEncryptor.encryptPassword(getPasswordForm().getNewPassword()));
    }
