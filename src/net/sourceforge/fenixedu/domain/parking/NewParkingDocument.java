...
public class NewParkingDocument extends NewParkingDocument_Base {
	...
	final ParkingFile parkingFile = new ParkingFile(getFilePath(vehicle), getParkingFile().getFilename(), getParkingFile()
		.getFilename(), getParkingFile().getContents(), getParkingFile().getPermittedGroup());
