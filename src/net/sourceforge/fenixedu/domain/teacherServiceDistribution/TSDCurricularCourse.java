...
public class TSDCurricularCourse extends TSDCurricularCourse_Base {
    ...
    public TSDCurricularCourse(TeacherServiceDistribution tsd, CurricularCourse curricularCourse,
	...
	for (ShiftType shiftType : lecturedShiftTypes) {
	    TSDValueType valueType = shiftType.equals(ShiftType.TEORICA) || shiftType.equals(ShiftType.PRATICA)
		    || shiftType.equals(ShiftType.TEORICO_PRATICA) || shiftType.equals(ShiftType.LABORATORIAL) ? TSDValueType.OMISSION_VALUE
		    : TSDValueType.MANUAL_VALUE;

	    tsdLoad = new TSDCurricularLoad(this, shiftType, 0d, TSDValueType.MANUAL_VALUE, 0, valueType, 1d, valueType, 1d,
		    valueType);
