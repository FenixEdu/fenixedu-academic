...
public class MissingClocking extends MissingClocking_Base {
	...
	private void correctOldAssiduousnessClosedDay(DateTime oldDay, ClosedMonth correctionClosedMonth,
		...
		if (oldAssiduousnessClosedDay != null && oldAssiduousnessClosedDay.getIsCorrection()
				&& oldAssiduousnessClosedDay.getCorrectedOnClosedMonth().equals(correctionClosedMonth)) {
