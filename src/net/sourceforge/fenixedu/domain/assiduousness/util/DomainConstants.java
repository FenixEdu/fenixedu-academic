...
public class DomainConstants {
    ...
    //    
    // public final static String ERROR_DURATION_RS_EXCEEDS_CONSECUTIVE_WORK =
    // "errorDurationRSExceedsConsecutiveWork";
    // public final static String ERROR_DURATION_RS_EXCEEDS_CONSECUTIVE_WORK_MSG =
    // "error.durationRSExceedsConsecutiveWork";
    // // public final static String ERROR_DURATION_RS2_EXCEEDS_CONSECUTIVE_WORK =
    // "errorDurationRS1ExceedsConsecutiveWork";
    // // public final static String ERROR_DURATION_RS2_EXCEEDS_CONSECUTIVE_WORK_MSG =
    // "error.durationRS2ExceedsConsecutiveWork";
    //    
    ...
    //    
    // /*** Domain constants ****/
    // public static final Duration DURATION_MAXIMUM_WEEK_WORK = new Duration(35 * 3600 * 1000); //35
    // horas em milliseccs

    // /* Expediente */
    // public static final int MINIMUM_WORKDAY_MILLISECS = 7 * 3600 * 1000; // 7 hours per day in
    // millisecs
    // public static final long MAXIMUM_WORKDAY_MILLISECS = (30 * 3600 + 30 * 60) * 1000; // 30 hours and
    // 30 minutes in millisecs
    //	
    ...
    // public final static Duration MANDATORY_MEAL_DISCOUNT = new
    // Duration(MANDATORY_MEAL_DISCOUNT_MILLISECS);
    ...
    // public static final String REGIME_FILHOSDEFICIENTES_MENORES1 = new
    // String("filhosDeficientesMenores1");
    ...
    //    
    // /* Flexible Timetable */
    // // public static final int FLEXIBLE_WEEK_DAYS = 5; // 5 working days per week TODO verify if this
    // is necessary
    // public static final long FLEXIBLE_HOURS_PER_DAY = 7 * 3600 * 1000; // 7 hours per day
    //    

    // public static final Duration FLEXIBLE_WEEK_HOURS_DURATION = new Duration(35 * 3600 * 1000); // 35
    // hours per week in millisecs
    // // public static final Duration FLEXIBLE_WEEK_HOURS_DURATION = Duration.hours(35); // 35 hours per
    // week
    // public static final Duration FLEXIBLE_DAY_DURATION = new Duration(FLEXIBLE_HOURS_PER_DAY); // (35
    // hours)/(5 days) => 7 hours per day
    // public static final Duration FLEXIBLE_PLATFORMS_DURATION = new Duration(4 * 3600 * 1000); //4
    // hours per day

    // /* Continuous Journey Timetable */
    // public static final Duration MIN_DURATION_CJ_WEEK_HOURS = new Duration(30 * 3600 * 1000); // 30
    // hours per week
    // public static final Duration MAX_DURATION_CJ_WEEK_HOURS = new Duration(35 * 3600 * 1000); // 35
    // hours per week
    // public static final Duration MIN_DURATION_CJ_DAY = new Duration(6 * 3600 * 1000); // (30 hours)/(5
    // days) => 6 hours per day
    // public static final Duration MAX_DURATION_CJ_DAY = new Duration(7 * 3600 * 1000); // (35 hours)/(5
    // days) =>7 hours per day
    // public static final Duration CJ_PLATFORMS_DURATION = new Duration(4 * 3600 * 1000); // 4 hours per
    // day

    // /* Exemption Timetable*/
    // public static final int EXEMPTION_WEEK_DAYS = 5; // 5 days per week TODO verify if this is needed

    // public static final Duration EXEMPTION_DAY_DURATION = new Duration(7* 3600 * 1000); // (35
    // hours)/(5 days) => 7 hours per day
    // public static final Duration EXEMPTION_WEEK_HOURS_DURATION = new Duration(35 * 3600 * 1000); // 35
    // hours per week

    // /* Isencao 1 hora Timetable*/
    // public static final int EXEMPTION_1HOUR_WEEK_DAYS = 5; // 5 days per week TODO verify if this is
    // needed
    // public static final Duration EXEMPTION_1HOUR_WEEK_HOURS_DURATION = new Duration(30* 3600 * 1000);
    // // 30 hours per week
    // public static final Duration EXEMPTION_1HOUR_DAY_DURATION = new Duration(6* 3600 * 1000); // (30
    // hours)/(5 days) => 6 hours per day
    ...
    // public static final Duration EXEMPTION_2HOURS_WEEK_HOURS_DURATION = new Duration(25* 3600 * 1000);
    // // 25 hours per week
    ...
    // // TODO verificar isto!
    // public static final Duration HALFTIME_WEEK_HOURS_DURATION = new Duration(17* 3600 * 1000 + 30 *
    // 3600 * 1000); // 17.5 hours per week
    ...
    // public final static TimeInterval NIGHT_SHIFT_PERIOD = new TimeInterval(NIGHT_SHIFT_START,
    // NIGHT_SHIFT_END, true);
