...
public class TimeInterval implements Serializable {
    ...
    // TimeInterval e' antes de timeOfDay? Se timeinterval nao esta definido no dia seguinte e timeofday
    ...
    // Overlaps the clocking interval with the working (fixed period/lunch/whatever) interval and
