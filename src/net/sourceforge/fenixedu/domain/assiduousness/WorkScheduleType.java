...
public class WorkScheduleType extends WorkScheduleType_Base {
    ...
    public boolean isNocturnal() {
        TimeOfDay endTime = getNormalWorkPeriod().getEndSecondPeriod() != null ? getNormalWorkPeriod()
                .getEndSecondPeriod() : getNormalWorkPeriod().getEndFirstPeriod();
        return endTime.isAfter(Assiduousness.defaultStartNightWorkDay)
                || endTime.isBefore(Assiduousness.defaultEndNightWorkDay);
    }
}
