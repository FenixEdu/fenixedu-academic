...
public class GrantInsurance extends GrantInsurance_Base {
    ...
    public void setDateBeginInsurance(java.util.Date date) {
        if (date == null) {
            setDateBeginInsuranceYearMonthDay(null);
        } else {
            setDateBeginInsuranceYearMonthDay(org.joda.time.YearMonthDay.fromDateFields(date));
        }
    }
    ...
    public void setDateEndInsurance(java.util.Date date) {
        if (date == null) {
            setDateEndInsuranceYearMonthDay(null);
        } else {
            setDateEndInsuranceYearMonthDay(org.joda.time.YearMonthDay.fromDateFields(date));
        }
    }
