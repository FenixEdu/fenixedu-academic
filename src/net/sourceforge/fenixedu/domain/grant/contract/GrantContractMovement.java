...
public class GrantContractMovement extends GrantContractMovement_Base {
	...
	public void setArrivalDate(java.util.Date date) {
		if (date == null) {
			setArrivalDateYearMonthDay(null);
		} else {
			setArrivalDateYearMonthDay(org.joda.time.YearMonthDay.fromDateFields(date));
		}
	}
	...
	public void setDepartureDate(java.util.Date date) {
		if (date == null) {
			setDepartureDateYearMonthDay(null);
		} else {
			setDepartureDateYearMonthDay(org.joda.time.YearMonthDay.fromDateFields(date));
		}
	}
