...
public class GrantSubsidy extends GrantSubsidy_Base {
	...
	public void setDateBeginSubsidy(java.util.Date date){
		if(date == null) setDateBeginSubsidyYearMonthDay(null);
		else setDateBeginSubsidyYearMonthDay(org.joda.time.YearMonthDay.fromDateFields(date));
	}
	...
	public void setDateEndSubsidy(java.util.Date date){
		if(date == null) setDateEndSubsidyYearMonthDay(null);
		else setDateEndSubsidyYearMonthDay(org.joda.time.YearMonthDay.fromDateFields(date));
	}
