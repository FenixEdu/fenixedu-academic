...
public class EPFLCandidatesReport extends PhdReport {
	...
	String focusArea = process.getPhdProgramFocusArea() != null ? process.getPhdProgramFocusArea().getName().getContent()
		: "";

	String externalPhdProgram = process.getExternalPhdProgram() != null ? process.getExternalPhdProgram().getName()
		.getContent() : "";
