...
public class EctsLabelCurricularCourseReportFile extends EctsLabelCurricularCourseReportFile_Base {
	...
	spreadsheet.setHeader("Nome Disciplina (ingl�s)");
	spreadsheet.setHeader("C�digo Disciplina");
	...
	spreadsheet.setHeader("Objectivos (ingl�s)");
	spreadsheet.setHeader("Programa");
	spreadsheet.setHeader("Programa (ingl�s)");
	spreadsheet.setHeader("Bibliografia Principal");
	spreadsheet.setHeader("Bibliografia Secund�ria (ingl�s)");
	spreadsheet.setHeader("Avalia��o");
	spreadsheet.setHeader("Avalia��o (ingl�s)");
