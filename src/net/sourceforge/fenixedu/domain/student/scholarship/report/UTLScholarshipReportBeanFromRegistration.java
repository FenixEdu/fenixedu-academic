...
public class UTLScholarshipReportBeanFromRegistration implements Serializable, IUTLScholarshipReportResult {
	...
	return ratio.compareTo(new BigDecimal(0.5f)) == 1 ? ACADEMIC_OFFICE_RESOURCE_BUNDLE
		.getString("label.yes") : ACADEMIC_OFFICE_RESOURCE_BUNDLE.getString("label.no");
    }
	...
	GratuityEventWithPaymentPlan event = lastStudentCurricularPlan.getGratuityEvent(readCurrentExecutionYear(),
	...
	return STUDENTS_WITH_CET.contains(registration.getNumber()) ? ACADEMIC_OFFICE_RESOURCE_BUNDLE.getString("label.yes")
		: ACADEMIC_OFFICE_RESOURCE_BUNDLE.getString("label.no");
    }
