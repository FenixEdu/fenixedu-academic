...
public class ResourceAllocationRole extends ResourceAllocationRole_Base {
	...
	SCHEDULES_ACCESS_GROUP("schedulesAccessGroup"),
	SPACES_ACCESS_GROUP("spacesAccessGroup"),
	MATERIALS_ACCESS_GROUP("materialsAccessGroup"),
	VEHICLES_ACCESS_GROUP("vehiclesAccessGroup");
    ...
    public void addOrRemovePersonFromAccessGroup(String expression, ResourceAllocationAccessGroupType accessGroupType, boolean toAdd) {	
