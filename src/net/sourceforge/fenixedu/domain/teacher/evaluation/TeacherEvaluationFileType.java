...
public enum TeacherEvaluationFileType {
    AUTO_ACTIVITY_DESCRIPTION(true), AUTO_CURRICULAR_EVALUATION_EXCEL(true), AUTO_MULTI_CRITERIA_EXCEL(true), CURRICULAR_EVALUATION_EXCEL(
	    false), MULTI_CRITERIA_EXCEL(false);
