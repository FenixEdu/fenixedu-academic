...
public class BolonhaPhdProgramDiplomaRequestEvent extends BolonhaPhdProgramDiplomaRequestEvent_Base {
    ...
    public BolonhaPhdProgramDiplomaRequestEvent(final AdministrativeOffice administrativeOffice, final EventType eventType, final Person person, final DiplomaRequest diplomaRequest) {
	this();
