...
public class BolonhaAdvancedFormationDiplomaRequestEvent extends BolonhaPhdProgramDiplomaRequestEvent_Base {
    ...
    public BolonhaAdvancedFormationDiplomaRequestEvent(final AdministrativeOffice administrativeOffice, final EventType eventType, final Person person, final DiplomaRequest diplomaRequest) {
	this();
