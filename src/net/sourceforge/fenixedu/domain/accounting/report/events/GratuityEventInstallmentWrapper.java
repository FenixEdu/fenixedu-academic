...
public class GratuityEventInstallmentWrapper implements InstallmentWrapper {
	...
	String label = bundle
		.getString("label.net.sourceforge.fenixedu.domain.accounting.report.events.EventReportQueueJob.installment.expiration.date");
	...
	ResourceBundle bundle = ResourceBundle.getBundle("resources.AcademicAdminOffice");
	String label = bundle
		.getString("label.net.sourceforge.fenixedu.domain.accounting.report.events.EventReportQueueJob.installment.expiration.amountToPay");
	return String.format(label, this.installment.getOrder());
    }
	...
	ResourceBundle bundle = ResourceBundle.getBundle("resources.AcademicAdminOffice");
	String label = bundle
		.getString("label.net.sourceforge.fenixedu.domain.accounting.report.events.EventReportQueueJob.installment.expiration.remainingAmount");
	return String.format(label, this.installment.getOrder());
    }
	...
	Map<Installment, Money> calculateInstallmentRemainingAmounts = event.getGratuityPaymentPlan()
		.calculateInstallmentRemainingAmounts(event, new DateTime(),
