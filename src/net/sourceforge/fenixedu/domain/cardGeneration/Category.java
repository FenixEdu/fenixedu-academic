...
public enum Category {
    ...
    CODE_71(71, LineLayout.EMPLOYEE, newDegreeTypeSet()), CODE_72(72, LineLayout.EMPLOYEE, newDegreeTypeSet()), CODE_73(73,
	    ...
	    newDegreeTypeSet(DegreeType.BOLONHA_ADVANCED_SPECIALIZATION_DIPLOMA)), CODE_96(96, LineLayout.MULTIPE,
	    newDegreeTypeSet()), CODE_97(97, LineLayout.STUDENT, newDegreeTypeSet(DegreeType.BOLONHA_ADVANCED_FORMATION_DIPLOMA)), CODE_98(
	    98, LineLayout.STUDENT, newDegreeTypeSet(DegreeType.BOLONHA_SPECIALIZATION_DEGREE)), CODE_99(99, LineLayout.STUDENT,
	    newDegreeTypeSet(DegreeType.EMPTY));
