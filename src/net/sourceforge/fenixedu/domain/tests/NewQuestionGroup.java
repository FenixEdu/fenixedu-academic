...
public class NewQuestionGroup extends NewQuestionGroup_Base {
	...
	List<NewQuestionGroup> questionGroups = (List<NewQuestionGroup>) CollectionUtils.select(getChildQuestions(),
		COMPOSITE_QUESTION_PREDICATE);
	...
	List<NewQuestion> questions = (List<NewQuestion>) CollectionUtils.selectRejected(getChildQuestions(),
		COMPOSITE_QUESTION_PREDICATE);
