...
public class Recipient extends Recipient_Base {
	...
	@Service
	public static Recipient createNewRecipient(final String toName,
			final Group members) {
		return new Recipient(toName, members);
	}

	public static List<Recipient> createNewRecipient(final List<Group> groups) {
		List<Recipient> recipients = new ArrayList<Recipient>();
		for (Group group : groups) {
			recipients
					.add(Recipient.createNewRecipient(group.getName(), group));
		}
		return recipients;
	}
