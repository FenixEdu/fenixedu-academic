...
public class OccupationPeriodReference extends OccupationPeriodReference_Base {
    ...
    public static Function<OccupationPeriodReference, OccupationPeriod> FUNCTION_TO_PERIOD = new Function<OccupationPeriodReference, OccupationPeriod>() {
    ...
    public static Function<OccupationPeriodReference, ExecutionDegree> FUNCTION_TO_DEGREE = new Function<OccupationPeriodReference, ExecutionDegree>() {
