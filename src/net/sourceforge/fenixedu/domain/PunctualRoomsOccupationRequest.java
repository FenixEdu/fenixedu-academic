...
public class PunctualRoomsOccupationRequest extends PunctualRoomsOccupationRequest_Base {
	...
	SortedSet<PunctualRoomsOccupationComment> result = new TreeSet<PunctualRoomsOccupationComment>(
		PunctualRoomsOccupationComment.COMPARATOR_BY_INSTANT);
	...
	Set<PunctualRoomsOccupationRequest> result = new TreeSet<PunctualRoomsOccupationRequest>(
		PunctualRoomsOccupationRequest.COMPARATOR_BY_INSTANT);
	...
	Set<PunctualRoomsOccupationComment> result = new TreeSet<PunctualRoomsOccupationComment>(
		PunctualRoomsOccupationComment.COMPARATOR_BY_INSTANT);
	for (PunctualRoomsOccupationComment comment : getComments()) {
	    if (!comment.getInstant().isEqual(getInstant())) {
		result.add(comment);
	...
	SortedSet<PunctualRoomsOccupationStateInstant> result = new TreeSet<PunctualRoomsOccupationStateInstant>(
		PunctualRoomsOccupationStateInstant.COMPARATOR_BY_INSTANT);
	...
	SortedSet<PunctualRoomsOccupationRequest> result = new TreeSet<PunctualRoomsOccupationRequest>(
		PunctualRoomsOccupationRequest.COMPARATOR_BY_IDENTIFICATION);
	...
	for (PunctualRoomsOccupationRequest request : requests) {
	    ...
	    if (firstComment.getSubject().compareTo(subject) == 0 && firstComment.getDescription() != null && firstComment.getDescription().compareTo(description) == 0) {
