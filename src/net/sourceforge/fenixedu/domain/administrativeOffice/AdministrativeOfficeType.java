...
/**
 * The {@link AdministrativeOfficeType} was used as a selector for the
 * {@link AdministrativeOffice} from a given context (e.g. a Degree, an
 * AcademicServiceRequest, etc). Offices now have a direct link for the
 * {@link AcademicProgram}s they manage, rendering this class useless. To select
 * the office of your context you must traverse to the associated
 * {@link AcademicProgram}.
 */
@Deprecated
