...
public class StudentCurricularPlanLEM extends StudentCurricularPlanLEM_Base {
    ...
    protected void selectOptionalCoursesToBeRemoved(List curricularCoursesToRemove,
        ...
        CurricularCourseGroup ccgProd5Year1Sem = getCurricularCourseGroup(FITH_YEAR_1SEM_OPTIONAL_GROUP);
        CurricularCourseGroup ccgProd4Year1Sem = getCurricularCourseGroup(FOURTH_YEAR_1SEM_OPTIONAL_GROUP);
