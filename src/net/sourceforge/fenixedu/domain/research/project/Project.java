...
/**
 * This class represents the research project. The research Project is inserted in
 * the investigation and intelectual production module. It is intended to represent all
 * the projects allready existent in the institution in other applications other than
 * fenix and the new projects created in the fenix interface.
 */
public class Project extends Project_Base {
    
    /**
     * The constructor for this class. It is only used when a project is being created
     * in the interface. If your intention is to import projects from other applications
    ...
    /**
     * This method removes any existing connection from any other entity to the project
     * and in the end it deletes the object.
     */
    public void delete(){
     ...
     * if not, the delete method is called.
     */
    public void sweep(){
    ...
    /**
     * Method responsible for searching all the projects trying to match it with a given string
     * @param searchedTitle the title of the projects to search
     * @return a list containing all the projects that in its title contain the string 'searchedTitle'
     */
