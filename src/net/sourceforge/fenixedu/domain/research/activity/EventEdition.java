...
public class EventEdition extends EventEdition_Base {
     ...
     */
    public void delete(){
    	for (; !this.getEventConferenceArticlesAssociations().isEmpty(); this.getEventConferenceArticlesAssociations().get(0).delete());
     ...
     */
    public void sweep(){
        if (!(this.hasAnyAssociatedProjects() || this.hasAnyResultEventAssociations() || this.hasAnyEventConferenceArticlesAssociations())){
        	this.delete();
        }
    }
