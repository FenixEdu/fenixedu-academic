...
/**
 * This exception is thrown from a {@link net.sourceforge.fenixedu.domain.accessControl.groups.language.GroupContext
 * group context} when a requested variable is not defined in the context.
 * 
 * @author cfgi
 */
