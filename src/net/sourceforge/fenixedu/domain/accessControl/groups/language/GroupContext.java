 ...
 * 
 * <p>
 * A group context provides an abstraction to the current request and defines a
 * series of variables that can be used in the {@link ExpressionGroup}. Each
 * context can define it's variables
 * 
 * @author cfgi
 */
