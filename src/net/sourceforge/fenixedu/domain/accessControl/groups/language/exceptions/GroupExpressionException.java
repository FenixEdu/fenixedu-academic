 ...
 * with the expression and in some cases it gives information about the line and
 * column were is problem occured. The line and column information can even be
 * given as a range, that is, the error is reported for a region of an
 * expression.
 * 
 * @author cfgi
 */
public class GroupExpressionException extends DomainException {
     ...
     * 
     * <p>
     * This is needed because some parser messages are not localized and as such
     * are reported directly in it's original form.
     * 
