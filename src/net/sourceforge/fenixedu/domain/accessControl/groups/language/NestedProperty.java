...
/**
 * This class represents a property of a dynamic argument. Each property can be
 * applied to the dynamic argument's main value to obtain a sub value just like
