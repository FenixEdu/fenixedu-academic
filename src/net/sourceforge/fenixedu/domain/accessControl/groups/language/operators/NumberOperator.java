...
/**
 * The <code>$N</code> operator converts value into a number. Optionally the
 * operator can receive a second argument indicating the type of the number.
 * Supported types are:
 * 
 * <ul>
 ...
 * 
 * <code>$N(1) = 1</code> and <code>$N($P(section)) = 1</code> and
