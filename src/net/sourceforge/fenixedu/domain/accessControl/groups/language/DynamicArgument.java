...
public abstract class DynamicArgument extends Argument {
    ...
    /**
     * Adds a new nested property to this dynamic argument and makes this
     * argument the context provider for the property.
     * 
     * @param property
     *            the property to add
     */
    ...
    /**
     * Obtains the list of properties that are applied to the main value of this
     * argument.
     * 
     ...
     * argument and them by applying all the properties of this argument to a
     * sequence of values starting from the main value.
     * 
    ...
    /**
     * Obtains the main value of the argument. The main value is the value that
     * makes this argument dynamic.
     * 
