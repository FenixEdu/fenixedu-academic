...
public class EnrolmentPeriodInCurricularCoursesFlunkedSeason extends EnrolmentPeriodInCurricularCoursesFlunkedSeason_Base {
    ...
    public static final Comparator<EnrolmentPeriodInCurricularCoursesFlunkedSeason> COMPARATOR_BY_START = new Comparator<EnrolmentPeriodInCurricularCoursesFlunkedSeason>() {

	@Override
	public int compare(EnrolmentPeriodInCurricularCoursesFlunkedSeason o1, EnrolmentPeriodInCurricularCoursesFlunkedSeason o2) {
