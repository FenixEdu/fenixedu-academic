...
public class CentroCusto extends DomainObject {
    ...
    public CentroCusto(int codigoInterno, String sigla, String departamento, String seccao1,
            String seccao2) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Regime) {
            ...
            resultado = (this.getCodigoInterno() == centroCusto.getCodigoInterno()
                    ...
                    && this.getSeccao1() == centroCusto.getSeccao1() && this.getSeccao2() == centroCusto
                    .getSeccao2());
        }
        return resultado;
    }
