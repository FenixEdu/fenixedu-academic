...
public class FuncNaoDocente extends DomainObject {
	...
	public boolean equals(Object obj) {
		...
		return (
			(obj instanceof FuncNaoDocente)
				&& (codigoInterno == ((FuncNaoDocente) obj).getCodigoInterno())
				&& (chaveFuncionario == ((FuncNaoDocente) obj).getChaveFuncionario()));
	}
	 ...
	 * @param chaveFuncionario New value of property chaveFuncionario.
	 *
	 */
