...
public class RoomOccupation extends DomainObject implements IRoomOccupation
{
    ...
    {
        if (obj instanceof RoomOccupation)
        {
            RoomOccupation roomOccupationObj = (RoomOccupation) obj;
			System.out.println("-----------------------------------------------------------");
			System.out.println("TOU A COMPARAR " + this);
			System.out.println("COM " + roomOccupationObj);
			System.out.println("-----------------------------------------------------------");
            if ((startTime.get(Calendar.HOUR_OF_DAY) == roomOccupationObj.getStartTime().get(Calendar.HOUR_OF_DAY))
                && (startTime.get(Calendar.MINUTE) == roomOccupationObj.getStartTime().get(Calendar.MINUTE))
                && (endTime.get(Calendar.HOUR_OF_DAY) == roomOccupationObj.getEndTime().get(Calendar.HOUR_OF_DAY))
            ...
            {
            	System.out.println("VOU DEVOLVER TRUE");
                return true;
            }
            else
            {
