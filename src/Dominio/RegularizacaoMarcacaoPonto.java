...
public class RegularizacaoMarcacaoPonto {
  ...
  public RegularizacaoMarcacaoPonto(int codigoInterno, int chaveMarcacaoPonto, int chaveParamRegularizacao, int quem, Timestamp quando) {
  ...
  public boolean equals(Object obj){
    ...
    if(obj instanceof RegularizacaoMarcacaoPonto){
      ...
      (this.getChaveMarcacaoPonto() == regularizacaoMarcacaoPonto.getChaveMarcacaoPonto()) &&
      (this.getChaveParamRegularizacao() == regularizacaoMarcacaoPonto.getChaveParamRegularizacao()) &&
      (this.getQuem() == regularizacaoMarcacaoPonto.getQuem()) &&
      (this.getQuando() == regularizacaoMarcacaoPonto.getQuando()));
    }
    return resultado;
  }
}