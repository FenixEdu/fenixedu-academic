...
public class Especifico implements IStrategyHorarios {
        ...
        try {
            ...
            if ((formHorario.getInicioHN1Horas().length() < 1)
                ...
                if ((formHorario.getInicioHN2Horas().length() < 1)
                    ...
                    timeHNPeriodo = ((new Float(duracaoSemanal / Constants.SEMANA_TRABALHO_ESPECIFICO)
                            .intValue() * 3600 * 1000) + new Float(
                            (new Float(duracaoSemanal / Constants.SEMANA_TRABALHO_ESPECIFICO)
                                    .floatValue() - new Float(duracaoSemanal
                                    / Constants.SEMANA_TRABALHO_ESPECIFICO).intValue()) * 3600 * 1000)
                            .longValue());

                    if (totalHN != timeHNPeriodo) {
                        errors.add("duracaoTrabalho", new ActionError(
                                "error.duracaoSemanal.horarioNormal"));
                    }
                    ...
                    if ((formHorario.getTrabalhoConsecutivoHoras().length() < 1)
                        ...
                        errors.add("Trabalho Consecutivo", new ActionError(
                                "error.trabalhoConsecutivo.obrigatorio"));
                    } else {
                        try {
                            trabalhoConsecutivoHoras = new Integer(formHorario
                                    .getTrabalhoConsecutivoHoras()).intValue();
                            trabalhoConsecutivoMinutos = new Integer(formHorario
                                    .getTrabalhoConsecutivoMinutos()).intValue();
                        } catch (java.lang.NumberFormatException e) {
                            errors.add("numero", new ActionError("error.numero.naoInteiro"));
                        }
                        calendar.clear();
                        calendar.set(1970, 0, 1, trabalhoConsecutivoHoras, trabalhoConsecutivoMinutos,
                                00);
                    ...
                    // 2 Periodos de trabalho diario, logo deve-se cumprir
                    ...
                    if ((formHorario.getInicioRefeicaoHoras().length() < 1)
                        ...
                        errors.add("Intervalo de Refeicao",
                                new ActionError("error.refeicao.obrigatorio"));
                    } else {
                        try {
                            inicioRefeicaoHoras = new Integer(formHorario.getInicioRefeicaoHoras())
                                    .intValue();
                            inicioRefeicaoMinutos = new Integer(formHorario.getInicioRefeicaoMinutos())
                                    .intValue();
                            fimRefeicaoHoras = new Integer(formHorario.getFimRefeicaoHoras()).intValue();
                            fimRefeicaoMinutos = new Integer(formHorario.getFimRefeicaoMinutos())
                                    .intValue();
                        } catch (java.lang.NumberFormatException e) {
                            errors.add("numero", new ActionError("error.numero.naoInteiro"));
                        }
                    ...
                    if ((formHorario.getIntervaloMinimoHoras().length() < 1)
                        ...
                        errors.add("Intervalo de Refeicao", new ActionError(
                                "error.refeicao.intervaloEDesconto.obrigatorios"));
                    } else {
                        try {
                    ...
                    if ((formHorario.getInicioPF1Horas().length() < 1)
                        ...
                        if ((formHorario.getInicioHN2Horas().length() < 1)
                            ...
                            if (!((formHorario.getInicioPF2Horas().length() < 1)
                                    ...
                                    || (formHorario.getFimPF2Horas().length() < 1) || (formHorario
                                    .getFimPF2Minutos().length() < 1))) {
                                errors.add("periodoFixo", new ActionError(
                                        "error.PeriodoFixo2.naoPermitido"));
                            }
                            ...
                            if ((formHorario.getInicioPF2Horas().length() < 1)
                                ...
                                errors.add("periodoFixo", new ActionError(
                                        "error.PeriodoFixo2.obrigatorio"));
                            } else {
                                try {
                                    inicioPF2Horas = (new Integer(formHorario.getInicioPF2Horas()))
                                            .intValue();
                                    inicioPF2Minutos = (new Integer(formHorario.getInicioPF2Minutos()))
                                            .intValue();
                                    fimPF2Horas = (new Integer(formHorario.getFimPF2Horas())).intValue();
                                    fimPF2Minutos = (new Integer(formHorario.getFimPF2Minutos()))
                                            .intValue();
                                } catch (java.lang.NumberFormatException e) {
                                    errors.add("numero", new ActionError("error.numero.naoInteiro"));
                                }
                                ...
                                if (!((timeInicioPF1 < timeFimPF1) && (timeFimPF1 < timeInicioPF2) && (timeInicioPF2 < timeFimPF2))) {
                                    ...
                                    // 2 plataformas fixas nao inferiores a 4
                                    // horas no total
                                    timePFPeriodo = Constants.PLATAFORMAS_FIXAS_ESPECIFICO;

                                    if (!(((timeFimPF1 - timeInicioPF1) + (timeFimPF2 - timeInicioPF2)) == timePFPeriodo)) {
                                        errors.add("PFPeriodo", new ActionError(
                                                "error.PeriodoFixo.duracao"));
                                    }

                                    if (!((timeInicioHN1 <= timeInicioPF1) && (timeFimPF1 <= timeFimHN1)
                                            && (timeInicioHN2 <= timeInicioPF2) && (timeFimPF2 <= timeFimHN2))) {
                                        errors.add("HNPF", new ActionError(
                                                "error.HorarioNormalPeriodoFixo.inconsistentes"));
            ...
            // ActionError("error.dataValidade.obrigatoria"));
            //					} else {
            //						try {
            ...
            //									errors.add("datas", new
            // ActionError("error.dataValidade.incorrecta"));
            //								}
            //							}
            //						}
            //					}
    ...
    public void setHorario(Horario horario, ActionForm form) {
        ...
        if ((formHorario.getIntervaloMinimoHoras() != null)
            ...
            calendar.clear();
            calendar.set(1970, 0, 1, new Integer(formHorario.getIntervaloMinimoHoras()).intValue(),
                    new Integer(formHorario.getIntervaloMinimoMinutos()).intValue(), 00);
            horario.setIntervaloMinimoRefeicao(new Time(calendar.getTimeInMillis()));
        }
        if ((formHorario.getDescontoObrigatorioHoras() != null)
                && (formHorario.getDescontoObrigatorioHoras().length() > 0)) {
            calendar.clear();
            calendar.set(1970, 0, 1, new Integer(formHorario.getDescontoObrigatorioHoras()).intValue(),
                    new Integer(formHorario.getDescontoObrigatorioMinutos()).intValue(), 00);
            horario.setDescontoObrigatorioRefeicao(new Time(calendar.getTimeInMillis()));
        }

        // trabalho consecutivo
        if ((formHorario.getTrabalhoConsecutivoHoras() != null)
                && (formHorario.getTrabalhoConsecutivoHoras().length() > 0)) {
            calendar.clear();
            calendar.set(1970, 0, 1, new Integer(formHorario.getTrabalhoConsecutivoHoras()).intValue(),
                    new Integer(formHorario.getTrabalhoConsecutivoMinutos()).intValue(), 00);
            horario.setTrabalhoConsecutivo(new Time(calendar.getTimeInMillis()));
        }
        if (!((formHorario.getInicioRefeicaoHoras().length() < 1)
                && (formHorario.getInicioRefeicaoMinutos().length() < 1)
                && (formHorario.getFimRefeicaoHoras().length() < 1) && (formHorario
                .getFimRefeicaoMinutos().length() < 1))) {
            // Intervalo de Refeicao
            calendar.clear();
            if (formHorario.getDiaAnteriorRefeicao().length() < 1) {
                calendar.set(1970, 0, 1, new Integer(formHorario.getInicioRefeicaoHoras()).intValue(),
                        new Integer(formHorario.getInicioRefeicaoMinutos()).intValue(), 00);
            } else {
                //contagem no dia anterior
                calendar.set(1969, 11, 31, (new Integer(formHorario.getInicioRefeicaoHoras()))
                        .intValue(), (new Integer(formHorario.getInicioRefeicaoMinutos())).intValue(),
                        00);
            }
            ...
            calendar.clear();
            if (formHorario.getDiaSeguinteRefeicao().length() < 1) {
                calendar.set(1970, 0, 1, new Integer(formHorario.getFimRefeicaoHoras()).intValue(),
                        new Integer(formHorario.getFimRefeicaoMinutos()).intValue(), 00);
            } else {
                //contagem no dia seguinte
                calendar.set(1970, 0, 2, (new Integer(formHorario.getFimRefeicaoHoras())).intValue(),
                        (new Integer(formHorario.getFimRefeicaoMinutos())).intValue(), 00);
            }
        ...
        if (!((formHorario.getInicioHN2Horas().length() < 1)
                && (formHorario.getInicioHN2Minutos().length() < 1)
                && (formHorario.getFimHN2Horas().length() < 1) && (formHorario.getFimHN2Minutos()
                .length() < 1))) {
            calendar.clear();
            if (formHorario.getDiaAnteriorHN2().length() < 1) {
                calendar.set(1970, 0, 1, (new Integer(formHorario.getInicioHN2Horas())).intValue(),
                        (new Integer(formHorario.getInicioHN2Minutos())).intValue(), 00);
            } else {
                //contagem no dia anterior
                calendar.set(1969, 11, 31, (new Integer(formHorario.getInicioHN2Horas())).intValue(),
                        (new Integer(formHorario.getInicioHN2Minutos())).intValue(), 00);
            }
            ...
            calendar.clear();
            if (formHorario.getDiaSeguinteHN2().length() < 1) {
                calendar.set(1970, 0, 1, (new Integer(formHorario.getFimHN2Horas())).intValue(),
                        (new Integer(formHorario.getFimHN2Minutos())).intValue(), 00);
            } else {
                //contagem no dia seguinte
                calendar.set(1970, 0, 2, (new Integer(formHorario.getFimHN2Horas())).intValue(),
                        (new Integer(formHorario.getFimHN2Minutos())).intValue(), 00);
            }
        ...
        if (!listaRegime.contains(Constants.REGIME_IPF)) {
            ...
            if (!((formHorario.getInicioPF2Horas().length() < 1)
                    && (formHorario.getInicioPF2Minutos().length() < 1)
                    && (formHorario.getFimPF2Horas().length() < 1) && (formHorario.getFimPF2Minutos()
                    .length() < 1))) {
                calendar.clear();
                if (formHorario.getDiaAnteriorPF2().length() < 1) {
                    calendar.set(1970, 0, 1, (new Integer(formHorario.getInicioPF2Horas())).intValue(),
                            (new Integer(formHorario.getInicioPF2Minutos())).intValue(), 00);
                } else {
                    //contagem no dia anterior
                    calendar.set(1969, 11, 31,
                            (new Integer(formHorario.getInicioPF2Horas())).intValue(), (new Integer(
                                    formHorario.getInicioPF2Minutos())).intValue(), 00);
                }
                horario.setInicioPF2(new Timestamp(calendar.getTimeInMillis()));

                calendar.clear();
                if (formHorario.getDiaSeguintePF2().length() < 1) {
                    calendar.set(1970, 0, 1, (new Integer(formHorario.getFimPF2Horas())).intValue(),
                            (new Integer(formHorario.getFimPF2Minutos())).intValue(), 00);
                } else {
                    //contagem no dia seguinte
                    calendar.set(1970, 0, 2, (new Integer(formHorario.getFimPF2Horas())).intValue(),
                            (new Integer(formHorario.getFimPF2Minutos())).intValue(), 00);
                }
    ...
    public void setFormAssociarHorarioConfirmar(Locale locale, ActionForm form, Pessoa pessoa,
        ...
        if ((horario.getIntervaloMinimoRefeicao() != null)
            ...
            formHorario.setIntervaloMinimoHoras((new Integer(calendar.get(Calendar.HOUR_OF_DAY)))
                    .toString());
            if (calendar.get(Calendar.MINUTE) < 10) {
                formHorario.setIntervaloMinimoMinutos("0"
                        + (new Integer(calendar.get(Calendar.MINUTE))).toString());
            } else {
                formHorario.setIntervaloMinimoMinutos((new Integer(calendar.get(Calendar.MINUTE)))
                        .toString());
            }
            calendar.clear();
            calendar.setTimeInMillis((horario.getDescontoObrigatorioRefeicao()).getTime());
            formHorario.setDescontoObrigatorioHoras((new Integer(calendar.get(Calendar.HOUR_OF_DAY)))
                    .toString());
            if (calendar.get(Calendar.MINUTE) < 10) {
                formHorario.setDescontoObrigatorioMinutos("0"
                        + (new Integer(calendar.get(Calendar.MINUTE))).toString());
            } else {
                formHorario.setDescontoObrigatorioMinutos((new Integer(calendar.get(Calendar.MINUTE)))
                        .toString());
            }
        } else {
        ...
        if (horario.getTrabalhoConsecutivo() != null) {
            ...
            formHorario.setTrabalhoConsecutivoHoras((new Integer(calendar.get(Calendar.HOUR_OF_DAY)))
                    .toString());
            if (calendar.get(Calendar.MINUTE) < 10) {
                formHorario.setTrabalhoConsecutivoMinutos("0"
                        + (new Integer(calendar.get(Calendar.MINUTE))).toString());
            } else {
                formHorario.setTrabalhoConsecutivoMinutos((new Integer(calendar.get(Calendar.MINUTE)))
                        .toString());
            }
        } else {
        ...
        if ((horario.getInicioRefeicao() != null) && (horario.getFimRefeicao() != null)) {
            ...
            formHorario.setInicioRefeicaoHoras((new Integer(calendar.get(Calendar.HOUR_OF_DAY)))
                    .toString());
            if (calendar.get(Calendar.MINUTE) < 10) {
                formHorario.setInicioRefeicaoMinutos("0"
                        + (new Integer(calendar.get(Calendar.MINUTE))).toString());
            } else {
                formHorario.setInicioRefeicaoMinutos((new Integer(calendar.get(Calendar.MINUTE)))
                        .toString());
            }
            if (calendar.get(Calendar.DAY_OF_MONTH) != 1) {
                //contagem no Dia Anterior
            ...
            formHorario
                    .setFimRefeicaoHoras((new Integer(calendar.get(Calendar.HOUR_OF_DAY))).toString());
            if (calendar.get(Calendar.MINUTE) < 10) {
                formHorario.setFimRefeicaoMinutos("0"
                        + (new Integer(calendar.get(Calendar.MINUTE))).toString());
            } else {
                formHorario.setFimRefeicaoMinutos((new Integer(calendar.get(Calendar.MINUTE)))
                        .toString());
            }
            if (calendar.get(Calendar.DAY_OF_MONTH) != 1) {
                //contagem no Dia Seguinte
        ...
        if ((horario.getInicioHN2() == null) && (horario.getFimHN2() == null)) {
            ...
            if (calendar.get(Calendar.MINUTE) < 10) {
                formHorario.setInicioHN2Minutos("0"
                        + (new Integer(calendar.get(Calendar.MINUTE))).toString());
            } else {
            ...
            if (calendar.get(Calendar.MINUTE) < 10) {
                formHorario.setFimHN2Minutos("0"
                        + (new Integer(calendar.get(Calendar.MINUTE))).toString());
            } else {
        ...
        if (!listaRegime.contains(Constants.REGIME_IPF)) {
            ...
            if ((horario.getInicioPF2() == null) && (horario.getFimPF2() == null)) {
                ...
                formHorario.setInicioPF2Horas((new Integer(calendar.get(Calendar.HOUR_OF_DAY)))
                        .toString());
                if (calendar.get(Calendar.MINUTE) < 10) {
                    formHorario.setInicioPF2Minutos("0"
                            + (new Integer(calendar.get(Calendar.MINUTE))).toString());
                } else {
                    formHorario.setInicioPF2Minutos((new Integer(calendar.get(Calendar.MINUTE)))
                            .toString());
                }
                if (calendar.get(Calendar.DAY_OF_MONTH) != 1) {
                    //contagem no Dia Anterior
                ...
                if (calendar.get(Calendar.MINUTE) < 10) {
                    formHorario.setFimPF2Minutos("0"
                            + (new Integer(calendar.get(Calendar.MINUTE))).toString());
                } else {
                    formHorario
                            .setFimPF2Minutos((new Integer(calendar.get(Calendar.MINUTE))).toString());
                }
                if (calendar.get(Calendar.DAY_OF_MONTH) != 1) {
                    //contagem no Dia Seguinte
    ...
    public String descricaoHorario(Locale locale, Horario horario, List listaRegimes) {
        ...
        if ((horario.getInicioHN2() != null) && (horario.getFimHN2() != null)) {
            ...
            descricao = descricao.concat(" " + inicioHN1Horas + ":" + inicioHN1Minutos + " - "
                    + fimHN1Horas + ":" + fimHN1Minutos + " <> " + inicioHN2Horas + ":"
                    + inicioHN2Minutos + " - " + fimHN2Horas + ":" + fimHN2Minutos);
        } else {
            descricao = descricao.concat(" " + inicioHN1Horas + ":" + inicioHN1Minutos + " - "
        ...
        if (!listaRegimes.contains(Constants.REGIME_IPF)) {
            ...
            if (horarioTipo.getInicioPF2() != null && horarioTipo.getFimPF2() != null) {
                ...
                descricao = descricao.concat(" (" + inicioPF1Horas + ":" + inicioPF1Minutos + " - "
                        + fimPF1Horas + ":" + fimPF1Minutos + " <> " + inicioPF2Horas + ":"
                        + inicioPF2Minutos + " - " + fimPF2Horas + ":" + fimPF2Minutos + ")");
    ...
    public String periodoTrabalhoHorarioTipo(HorarioTipo horarioTipo) {
        ...
        if ((horarioTipo.getInicioHN2() != null) && (horarioTipo.getFimHN2() != null)) {
            ...
            periodoTrabalho = inicioHN1Horas + ":" + inicioHN1Minutos + " - " + fimHN1Horas + ":"
                    + fimHN1Minutos + " <> " + inicioHN2Horas + ":" + inicioHN2Minutos + " - "
                    + fimHN2Horas + ":" + fimHN2Minutos;
        } else {
            periodoTrabalho = inicioHN1Horas + ":" + inicioHN1Minutos + " - " + fimHN1Horas + ":"
                    + fimHN1Minutos;
        }
    ...
    public void setSaldosHorarioVerbeteBody(Horario horario, List listaRegimes,
        ...
        if (horario.getInicioHN2() != null) {
            ...
            if (iterador.hasNext()) {
                // saldo da refeicao
                // o intervalo para refeicao deve ser feito no meio de dois
                // periodos de trabalho.
                // por isso conta o primeiro intervalo que estiver contido no
                // intervalo para refeicao
                // estipulado para este horario.
                entrada = (MarcacaoPonto) iterador.next(); // primeira entrada

                // se a primeira entrada do dia está contida no intervalo de
                // refeicao é como se
                ...
                if (entrada.getData().getTime() > horario.getInicioRefeicao().getTime()
                    ...
                    intervaloRefeicao = entrada.getData().getTime()
                    ...
                    if (listaMarcacoesPonto.size() >= 3) {
                        while (iterador.hasNext()) {
                            ...
                            long saldoEntreMarcacoes = saida.getData().getTime()
                                    - entrada.getData().getTime();

                            // saldo que pode ser utilizado caso nao tenha
                            // havido intervalo para refeicao no periodo
                            // estipulado
                            if (saida.getData().getTime() < horario.getFimRefeicao().getTime()) {
                                saldoPenalizacaoAusenciaRefeicao = saldoPenalizacaoAusenciaRefeicao
                                        + saldoEntreMarcacoes;
                            } else if (entrada.getData().getTime() < horario.getFimRefeicao().getTime()) {
                                saldoPenalizacaoAusenciaRefeicao = saldoPenalizacaoAusenciaRefeicao
                            ...
                            // saldo que pode ser utilizado caso tenha havido
                            // irregularidades no intervalo para refeicao
                            saldoPenalizacaoMinimoRefeicao = saldoPenalizacaoMinimoRefeicao
                                    + saldoEntreMarcacoes;

                            if (entrada.getNumFuncionario() == 0 && intervaloRefeicaoJustificado == 0) {
                                // se for uma justificacao
                                intervaloRefeicaoJustificado = encontrarIntervaloRefeicaoJustificado(
                            ...
                            if (iterador.hasNext()) {
                                ...
                                if (saida.getData().getTime() >= horario.getInicioRefeicao().getTime()
                                        && saida.getData().getTime() < horario.getFimRefeicao()
                                                .getTime()) {
                                    intervaloRefeicao = horario.getFimRefeicao().getTime()
                                            - saida.getData().getTime();
                                    horario.setInicioRefeicao(new Timestamp(saida.getData().getTime()));
                                } else if (saida.getData().getTime() < horario.getInicioRefeicao()
                                        .getTime()) {
                                    intervaloRefeicao = horario.getFimRefeicao().getTime()
                                            - horario.getInicioRefeicao().getTime();
                                }
                                // testar a entrada
                                if (entrada.getData().getTime() > horario.getInicioRefeicao().getTime()
                                        && entrada.getData().getTime() <= horario.getFimRefeicao()
                                                .getTime()) {
                                    intervaloRefeicao = intervaloRefeicao
                                            + (entrada.getData().getTime() - horario.getFimRefeicao()
                                                    .getTime());
                                    horario.setFimRefeicao(new Timestamp(entrada.getData().getTime()));
                                } else if (entrada.getData().getTime() <= horario.getInicioRefeicao()
                                        .getTime()) {
                                    intervaloRefeicao = intervaloRefeicao
                                            - (horario.getFimRefeicao().getTime() - horario
                                                    .getInicioRefeicao().getTime());
                                }
                            } else {
                                if (saida.getData().getTime() > horario.getInicioRefeicao().getTime()
                                        && saida.getData().getTime() < horario.getFimRefeicao()
                            ...
                            if (intervaloRefeicao > 0) {
                                // encontrou o intervalo de refeicao entao sai
                                // do ciclo
                                break;
                            }
                        }
                    } else {
                        // valor que seja diferente de zero para o caso de duas
                        // marcacoes que nao estao contidas no intervalo de
                        // refeicao.
                        ...
                        if ((listaMarcacoesPonto.size() == 2)) {
                            ...
                            if (saida.getData().getTime() > horario.getInicioRefeicao().getTime()
                                ...
                                //logo deve haver penalizacao, mas só se o
                                // funcionário efectuou trabalho em todo o
                                // periodo de refeição
                                if (entrada.getData().getTime() < horario.getInicioRefeicao().getTime()
                                        && saida.getData().getTime() > horario.getFimRefeicao()
                                                .getTime()) {
                                    saldoPenalizacaoAusenciaRefeicao = horario.getFimRefeicao()
                                            .getTime()
                                            - entrada.getData().getTime()
                                            - horario.getDescontoObrigatorioRefeicao().getTime();
                                }
                ...
                // se a refeicao esta contida na justificacao tera que haver
                // desconto obrigatorio de refeicao
                if (intervaloRefeicaoJustificado > 0 && intervaloRefeicao == 0) {
                    saldo = saldo - horario.getDescontoObrigatorioRefeicao().getTime();

                } else {
                    if (intervaloRefeicao == 0) {
                        // nao houve periodo de refeicao, logo tem que haver
                        // penalizacao
                        // que consiste em contar para saldo apenas o periodo de
                        // trabalho
                    ...
                    if (intervaloRefeicao < horario.getIntervaloMinimoRefeicao().getTime()
                            && intervaloRefeicao != 0 && !refeicaoAntesEntrada) {
                        // o periodo de refeicao é menor que o obrigatorio logo
                        // a penalizacao é contar o período
                        // de trabalho efectuado até à saída para a refeicao
                        if (saldo > saldoPenalizacaoMinimoRefeicao
                                && saldoPenalizacaoMinimoRefeicao != 0) {
                    ...
                    if (intervaloRefeicao >= horario.getIntervaloMinimoRefeicao().getTime()
                            ...
                            && intervaloRefeicao < horario.getDescontoObrigatorioRefeicao().getTime()
                            && intervaloRefeicao != 0) {
                        // periodo de refeicao dentro dos limites do periodo de
                        // refeicao ou refeicao antes da entrada
                        // procedimento normal: descontar o resto ate fazer o
                        // desconto obrigatorio
                        saldo = saldo
                                - (horario.getDescontoObrigatorioRefeicao().getTime() - intervaloRefeicao);
                    }
                }
            }
        }
                ...
                if (iterador.hasNext()) {
                    ...
                    if (horario.getInicioPF2() != null) {
                        if (entrada.getData().getTime() >= horario.getInicioPF2().getTime()
                            ...
                            trabalhouPF = trabalhouPF
                                    + (horario.getFimPF2().getTime() - entrada.getData().getTime());
                        } else if (entrada.getData().getTime() < horario.getInicioPF2().getTime()) {
                            trabalhouPF = trabalhouPF
                                    + (horario.getFimPF2().getTime() - horario.getInicioPF2().getTime());
                        }
    ...
    private long encontrarIntervaloRefeicaoJustificado(Horario horario, MarcacaoPonto entrada,
            MarcacaoPonto saida) {
        ...
        // testar a entrada
        if (entrada.getData().getTime() >= inicioRefeicao.getTime()
                && entrada.getData().getTime() < fimRefeicao.getTime()) {
        ...
        // testar a saida
        if (saida.getData().getTime() > inicioRefeicao.getTime()
                && saida.getData().getTime() <= fimRefeicao.getTime()) {
    ...
    public long duracaoDiaria(Horario horario) {
        return ((new Float(horario.getDuracaoSemanal() / Constants.SEMANA_TRABALHO_ESPECIFICO)
                .intValue() * 3600 * 1000) + new Float((new Float(horario.getDuracaoSemanal()
                / Constants.SEMANA_TRABALHO_ESPECIFICO).floatValue() - new Float(horario
                .getDuracaoSemanal()
                / Constants.SEMANA_TRABALHO_ESPECIFICO).intValue()) * 3600 * 1000).longValue());
    } /* duracaoDiaria */
