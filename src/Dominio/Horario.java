...
public class Horario {
	...
	public Horario(
		...
		Timestamp inicioHN2,
		Timestamp fimHN2,
		Timestamp inicioRefeicao,
		Timestamp fimRefeicao,
	...
	/* Construtores auxiliares para a leitura das rotacoes do horario na BD Oracle */
	public Horario(
		int chaveHorarioTipo,
		String sigla,
		String modalidade,
	...
	public Horario(int chaveHorarioTipo, int chaveFuncionario, Date dataInicio, Date dataFim, int numDias, int posicao) {
	 ...
	 * @param chaveHorarioTipo The chaveHorarioTipo to set
	 */
	 ...
	 * @param dataCumprir The dataCumprir to set
	 */
	 ...
	 * @param descontoMinimo The descontoMinimo to set
	 */
	 ...
	 * @param descontoObrigatorioRefeicao The descontoObrigatorioRefeicao to set
	 */
	 ...
	 * @param duracaoSemanal The duracaoSemanal to set
	 */
	 ...
	 * @param fimExpediente The fimExpediente to set
	 */
	...
	/**
	 * Sets the fimHN1.
	 * @param fimHN1 The fimHN1 to set
	 */
	...
	/**
	 * Sets the fimHN2.
	 * @param fimHN2 The fimHN2 to set
	 */
	...
	/**
	 * Sets the fimPF1.
	 * @param fimPF1 The fimPF1 to set
	 */
	...
	/**
	 * Sets the fimPF2.
	 * @param fimPF2 The fimPF2 to set
	 */
	 ...
	 * @param fimRefeicao The fimRefeicao to set
	 */
	 ...
	 * @param inicioExpediente The inicioExpediente to set
	 */
	...
	/**
	 * Sets the inicioHN1.
	 * @param inicioHN1 The inicioHN1 to set
	 */
	...
	/**
	 * Sets the inicioHN2.
	 * @param inicioHN2 The inicioHN2 to set
	 */
	...
	/**
	 * Sets the inicioPF1.
	 * @param inicioPF1 The inicioPF1 to set
	 */
	...
	/**
	 * Sets the inicioPF2.
	 * @param inicioPF2 The inicioPF2 to set
	 */
	 ...
	 * @param inicioRefeicao The inicioRefeicao to set
	 */
	...
	*/
	public boolean equals(Object obj) {
		...
		if (obj instanceof Horario) {
			...
			resultado =
				((this.getCodigoInterno() == horario.getCodigoInterno())
		...
		if (this.getChaveHorarioTipo() != 0) {
			...
			if ((this.getSigla() != null)
				&& (this.getSigla().equals(Constants.DS)
					|| this.getSigla().equals(Constants.DSC)
					|| this.getSigla().equals(Constants.FERIADO))) {
