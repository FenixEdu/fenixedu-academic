...
public abstract class SelectionUponMaximumNumberEnrollmentRule
{
	...
	protected List sortCurricularCourseByCurricularYear(List curricularCourses)
	{
		Collections.sort(curricularCourses, new Comparator()
		{
			public int compare(Object obj1, Object obj2)
			{
				...
				ICurricularYear curricularYear1 = curricularCourse1.getCurricularYearByBranchAndSemester(studentBranch, executionPeriod
					.getSemester());
				ICurricularYear curricularYear2 = curricularCourse2.getCurricularYearByBranchAndSemester(studentBranch, executionPeriod
					.getSemester());
	...
	protected List getCurricularCoursesFromPreviousAndCurrentYear(List curricularCourses, int iteratorToStart)
	{
		...
		ICurricularYear minYear = curricularCourse.getCurricularYearByBranchAndSemester(studentBranch, executionPeriod.getSemester());
		...
		for (; iterator < size; iterator++)
		{
			...
			actuarYear = curricularCourse.getCurricularYearByBranchAndSemester(studentBranch, executionPeriod.getSemester());
