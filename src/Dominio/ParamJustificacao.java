...
public class ParamJustificacao {
  ...
  /* Construtores */
  public ParamJustificacao(String sigla, String descricao, String tipo,
  String grupo, int quem, Timestamp quando) {
	...
	public ParamJustificacao(String sigla, String descricao, String tipo, String tipoDias,
	String grupo, int quem, Timestamp quando) {
		this.codigoInterno = 0;
		this.sigla = sigla;
		this.descricao = descricao;
  ...
  String grupo, int quem, Timestamp quando) {
	...
	public ParamJustificacao(int codigoInterno, String sigla, String descricao, String tipo, String tipoDias,
	String grupo, int quem, Timestamp quando) {
		this.codigoInterno = codigoInterno;
		this.sigla = sigla;
		this.descricao = descricao;
  ...
  public boolean equals(Object obj){
    ...
    if(obj instanceof ParamJustificacao){
      ...
      (this.getQuem() == paramJustificacao.getQuem()) &&
      (this.getQuando() == paramJustificacao.getQuando()));
    }
    return resultado;
  }  
	/**
	...
	/**
	 * Sets the tipoDias.
	 * @param tipoDias The tipoDias to set
	 */
