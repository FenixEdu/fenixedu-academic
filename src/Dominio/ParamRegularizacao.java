...
public class ParamRegularizacao {
  ...
  public ParamRegularizacao(int codigoInterno, String sigla, String descricao, 
  ...
  public boolean equals(Object obj){
    ...
    if(obj instanceof ParamRegularizacao){
      ...
      (this.getQuem() == paramRegularizacao.getQuem()) &&
      (this.getQuando() == paramRegularizacao.getQuando()));
    }
    return resultado;
  }  
}