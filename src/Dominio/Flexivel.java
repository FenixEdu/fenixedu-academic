        ...
        try
        {
            ...
            } else
            {
                ...
                { //Regime:new String("isencaoPeriodoFixo")
                    ...
                    /*  Para horários com IPF não existe intervalo obrigatorio para almoço
                     
                    // Marcações de ponto para a hora do almoço 
                    calendar.clear();
                    calendar.set(1970, 0, 1, fimHN1Horas, fimHN1Minutos, 00);
                    timeFimHN1 = calendar.getTimeInMillis();
                    ...
                    while (iterador.hasNext())
                    {
                        ...
                        if (iterador.hasNext())
                        {
                                ...
                                && saida.getData().getTime() < horario.getFimRefeicao().getTime())
                            {
                                ...
                                saida.getData().getTime() < horario.getInicioRefeicao().getTime())
                            {
                                intervaloRefeicao =
                                    horario.getFimRefeicao().getTime()
