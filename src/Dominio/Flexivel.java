...
public class Flexivel implements IStrategyHorarios
{
		...
		try
		{
			...
			} else
			{
				...
				{ //Regime:new String("isencaoPeriodoFixo")
					...
					/*
					 * Para horários com IPF não existe intervalo obrigatorio para almoço // Marcações
					 * de ponto para a hora do almoço calendar.clear(); calendar.set(1970, 0, 1,
					 * fimHN1Horas, fimHN1Minutos, 00); timeFimHN1 = calendar.getTimeInMillis();
					 * 
					 * calendar.clear(); calendar.set(1970, 0, 1, inicioHN2Horas, inicioHN2Minutos, 00);
					 * timeInicioHN2 = calendar.getTimeInMillis();
					 * 
					 * if ((timeFimHN1 < Constants.INICIO_REFEICAO_IPF) || (timeInicioHN2 >
					 * Constants.FIM_REFEICAO_IPF)) { errors.add("almoco", new
	...
	public void setHorario(Horario horario, ActionForm form)
	{
		...
		listaRegime = Arrays.asList(formHorario.getRegime());
		if (!listaRegime.contains(Constants.REGIME_IPF))
		{ //Regimes: new String("isencaoPeriodoFixo")
			if (formHorario.getDiaAnteriorPF1().length() < 1)
			{
	...
	public void setHorarioTipoRotativo(Horario horario, ActionForm form)
	{
		...
		horario.setChaveHorarioTipo(Constants.CHAVE_HTIPO); // para revelar que é um horário tipo
	...
	public void setFormAssociarHorarioConfirmar(Locale locale, ActionForm form, Pessoa pessoa,
			Funcionario funcionario, Horario horario, ArrayList listaRegime, boolean isExcepcaoHorario,
			String alterar)
	{
	...
	public void setFormAssociarHorarioTipoConfirmar(Locale locale, ActionForm form, Pessoa pessoa,
			Funcionario funcionario, HorarioTipo horarioTipo, Horario horario, ArrayList listaRegime,
	...
	public void setSaldosHorarioVerbeteBody(Horario horario, ArrayList listaRegimes,
			ArrayList listaParamJustificacoes, ArrayList listaMarcacoesPonto, ArrayList listaSaldos)
	{
		...
		if (iterador.hasNext())
		{
			...
			} else
			{
				...
				{
					// se no intervalo de uma saida do dia com uma entrada está contida no intervalo de
					// refeicao é como se
					...
					while (iterador.hasNext())
					{
						...
						// saldo que pode ser utilizado caso nao tenha havido intervalo para refeicao no
						// periodo estipulado
						...
						// saldo que pode ser utilizado caso tenha havido irregularidades no intervalo
						// para refeicao
				...
				} else
				{
					...
					{ //apenas com duas marcaçoes
						...
						} else
						{
							...
							//logo deve haver penalizacao, mas só se o funcionário efectuou trabalho em
			...
			// se a refeicao esta contida na justificacao tera que haver desconto obrigatorio de
			// refeicao
			...
			} else
			{
				...
				if (intervaloRefeicao >= horario.getIntervaloMinimoRefeicao().getTime()
						...
						&& intervaloRefeicao != 0)
				{
					// periodo de refeicao dentro dos limites do periodo de refeicao ou refeicao antes
					// da entrada
		...
		//if(!listaRegimes.contains("isencaoPeriodoFixo")){ quando estiver a funcionar a nossa base de
		// dados
	...
	public long calcularTrabalhoNocturno(Horario horario, MarcacaoPonto entrada, MarcacaoPonto saida)
	{
		...
		// calculo do trabalho nocturno normal para os horario que ultrapassem o inicio do trabalho
		// nocturno
	...
	public void calcularHorasExtraordinarias(Horario horario, ArrayList listaMarcacoesPonto,
