...
public class CreditsEvent extends ValuedEnum {
    ...
    public static final CreditsEvent MASTER_DEGREE_LESSONS = new CreditsEvent("master", MASTER_DEGREE_LESSONS_VALUE);
    public static final CreditsEvent OTHER_CREDIT = new CreditsEvent("others", OTHER_CREDIT_VALUE);
    public static final CreditsEvent MANAGEMENT_POSITION = new CreditsEvent("management position", MANAGEMENT_POSITION_VALUE);
    public static final CreditsEvent SERVICE_EXEMPTION = new CreditsEvent("service exemption", SERVICE_EXEMPTION_VALUE);
    public static final CreditsEvent WORKING_TIME = new CreditsEvent("working time", WORKING_TIME_VALUE);
    public static final CreditsEvent DEGREE_FINAL_PROJECT_STUDENT = new CreditsEvent("degree final project", DEGREE_FINAL_PROJECT_STUDENT_VALUE);
