...
public class GroupProposal extends DomainObject implements IGroupProposal {
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof IGroupProposal) {
			...
			result = getIdInternal() != null && groupProposal != null && getIdInternal().equals(groupProposal.getIdInternal());
...
*/
    ...
    /**
     * @param keyFinalDegreeWorkProposal The keyFinalDegreeWorkProposal to set.
     */
    ...
    /**
     * @param orderOfPreference The orderOfPreference to set.
     */
