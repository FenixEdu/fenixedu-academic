 ...
 */
public class MasterDegreeThesisDataVersion extends DomainObject implements IMasterDegreeThesisDataVersion {
	...
	public MasterDegreeThesisDataVersion(IMasterDegreeThesis masterDegreeThesis, IEmployee responsibleEmployee, String dissertationTitle,
	 ...
	 * @param currentState
	 */
	public MasterDegreeThesisDataVersion(IMasterDegreeThesis masterDegreeThesis, List externalAssistentGuiders, List assistentGuiders, List guiders,
			IEmployee responsibleEmployee, String dissertationTitle, Timestamp lastModification, State currentState) {
		this.masterDegreeThesis = masterDegreeThesis;
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof IMasterDegreeThesisDataVersion) {
			...
			result = this.masterDegreeThesis.equals(masterDegreeThesisDataVersion.getMasterDegreeThesis())
