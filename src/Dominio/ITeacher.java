...
public interface ITeacher extends IDomainObject {
	...
	/**
	 * This method returns the credits info for an execution period. It should cache execution period info. 
	 * @param executionPeriod
	 * @return
	 */
	public InfoCredits getExecutionPeriodCredits(IExecutionPeriod executionPeriod);
	
	public void notifyCreditsChange(CreditsEvent creditsEvent, ICreditsEventOriginator creditsEventOriginator);
}