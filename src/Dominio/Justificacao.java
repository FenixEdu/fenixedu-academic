...
public class Justificacao {
	...
	public Justificacao(int chaveParamJustificacao, int chaveFuncionario, java.util.Date diaInicio, Time horaInicio, Time horaFim, String observacao, int quem, Timestamp quando) {
		_codigoInterno = 0;
		_chaveParamJustificacao = chaveParamJustificacao;
		_chaveFuncionario = chaveFuncionario;
		_diaInicio = diaInicio;
		_horaInicio = horaInicio;
		_diaFim = diaInicio; // para o caso em que a justificacao é apenas de horas no mesmo dia
		_horaFim = horaFim;
		_observacao = observacao;
		_quem = quem;
		_quando = quando;
	}
	public Justificacao(java.util.Date diaInicio, Time horaInicio, java.util.Date diaFim, Time horaFim, String observacao) {
		_codigoInterno = 0;
		_chaveParamJustificacao = 0;
		_chaveFuncionario = 0;
		_diaInicio = diaInicio;
	...
	public Justificacao(int chaveParamJustificacao, java.util.Date diaInicio, Time horaInicio, java.util.Date diaFim, Time horaFim, String observacao) {
		_codigoInterno = 0;
		_chaveParamJustificacao = chaveParamJustificacao;
		_chaveFuncionario = 0;
		_diaInicio = diaInicio;
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof Justificacao) {
			...
			resultado =
				((this.getCodigoInterno() == justificacao.getCodigoInterno())
					...
					&& (this.getQuem() == justificacao.getQuem())
					&& (this.getQuando() == justificacao.getQuando()));
		}
		return resultado;
	}
}