...
public class Turnos implements IStrategyHorarios {
    ...
    public ActionErrors validateAssociarHorario(ActionForm form) {
        ...
        try {
            if (formHorario.getDuracaoSemanal().length() < 1) {
                errors
                        .add("DuracaoSemanal-HTurnos", new ActionError(
                ...
                if (duracaoSemanal != Constants.DURACAO_SEMANAL_TURNOS) {
                    errors.add("DuracaoSemanal-HTurnos", new ActionError("error.duracaoSemanal"));
                }
            }
            ...
            if ((formHorario.getInicioHN1Horas().length() < 1)
                ...
                if (!(timeInicioHN1 < timeFimHN1)) {
                    ...
                    timeHNPeriodo = ((new Float(Constants.DURACAO_SEMANAL_TURNOS
                            ...
                            (new Float(Constants.DURACAO_SEMANAL_TURNOS
                                    ...
                                    Constants.DURACAO_SEMANAL_TURNOS / Constants.SEMANA_TRABALHO_TURNOS)
    ...
    public void setSaldosHorarioVerbeteBody(Horario horario, List listaRegimes,
        ...
        Float duracaoDiaria = new Float(horario.getDuracaoSemanal() / Constants.SEMANA_TRABALHO_TURNOS);
    ...
    public long duracaoDiaria(Horario horario) {
        return ((new Float(Constants.DURACAO_SEMANAL_TURNOS / Constants.SEMANA_TRABALHO_TURNOS)
                .intValue() * 3600 * 1000) + new Float(
                (new Float(Constants.DURACAO_SEMANAL_TURNOS / Constants.SEMANA_TRABALHO_TURNOS)
                        .floatValue() - new Float(Constants.DURACAO_SEMANAL_TURNOS
                        / Constants.SEMANA_TRABALHO_TURNOS).intValue()) * 3600 * 1000).longValue());
    } /* duracaoDiaria */
