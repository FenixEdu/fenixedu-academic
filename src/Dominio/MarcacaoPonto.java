...
public class MarcacaoPonto {
	...
	public MarcacaoPonto(int unidade, String sigla, Timestamp data, int numCartao, int numFuncionario, String estado) {
		_codigoInterno = 0;
		_unidade = unidade;
		_siglaUnidade = sigla;
		_data = data;
	...
	public MarcacaoPonto(int codigoInterno, String sigla, Timestamp data, int numCartao, int numFuncionario) {
		_codigoInterno = codigoInterno;
		_unidade = 0;
		_siglaUnidade = sigla;
		_data = data;
	...
	public MarcacaoPonto(int codigoInterno, int unidade, String sigla, Timestamp data, int numCartao, int numFuncionario) {
		_codigoInterno = codigoInterno;
		_unidade = unidade;
		_siglaUnidade = sigla;
		_data = data;
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof MarcacaoPonto) {
			...
			resultado =
				((this.getCodigoInterno() == marcacaoPonto.getCodigoInterno())
					...
					&& (this.getNumFuncionario() == marcacaoPonto.getNumFuncionario())
