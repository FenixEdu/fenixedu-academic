...
public class Ferias {
  ...
  public Ferias(int codigoInterno, int chaveFuncionario, int anoCorrente, int diasNormais, int diasEpocaBaixa,
  int diasHorasExtras, int diasAntiguidade, int diasMeioDia, int diasDispensaServico, int diasTolerancia,
  int diasTransferidos, int diasTransHorasExtras, int diasTransAntiguidade) {
