...
public class JustificacaoHoras implements IStrategyJustificacoes
{
    ...
    public void completaListaMarcacoes(
        ...
        ArrayList listaMarcacoesPonto)
    {
        ...
        MarcacaoPonto entrada =
            new MarcacaoPonto(
                0,
                new Timestamp(
                    dataConsulta.getTime() + justificacao.getHoraInicio().getTime() + 3600 * 1000),
                0,
                0);
        MarcacaoPonto saida =
            new MarcacaoPonto(
                0,
                new Timestamp(
                    dataConsulta.getTime() + justificacao.getHoraFim().getTime() + 3600 * 1000),
                0,
                0);
    ...
    public void setListaJustificacoesBody(
        ParamJustificacao paramJustificacao,
        Justificacao justificacao,
        ArrayList listaJustificacoesBody)
    {
        Calendar calendario = Calendar.getInstance();
        ...
        ArrayList listaSaldos)
    {
        ...
        long saldoJustificacao =
            justificacao.getHoraFim().getTime() - justificacao.getHoraInicio().getTime();
