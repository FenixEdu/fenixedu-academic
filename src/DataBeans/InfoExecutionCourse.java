...
public class InfoExecutionCourse {
  ...
  public boolean equals(Object obj) {
    ...
    if (obj instanceof InfoExecutionCourse) {
      InfoExecutionCourse iDE = (InfoExecutionCourse)obj;
      resultado = (getSigla().equals(iDE.getSigla())) &&
                  (getInfoLicenciaturaExecucao().equals(iDE.getInfoLicenciaturaExecucao()));
    }
    return resultado;
  }
