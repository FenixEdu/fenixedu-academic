...
public abstract class Cloner
{
    ...
    public static InfoObject get(IDomainObject domainObject)
    {
        ...
        {
			System.out.println("Could not find method for copying: " + domainObject.getClass().getName());
            throw new RuntimeException(e);
        }
    ...
    public static InfoGrantProject copyIGrantProject2InfoGrantProject(IGrantProject grantProject)
    {
    	...
    	if(grantProject != null)
    	{
    		...
    		InfoTeacher infoResponsibleTeacher = Cloner.copyITeacher2InfoTeacher(grantProject.getResponsibleTeacher());
    ...
    public static IGrantProject copyInfoGrantProject2IGrantProject(InfoGrantProject infoGrantProject)
    {
        ...
        if(infoGrantProject != null)
        {
            ...
            ITeacher responsibleTeacher = Cloner.copyInfoTeacher2Teacher(infoGrantProject.getInfoResponsibleTeacher());
    ...
    public static InfoGrantPaymentEntity copyIGrantPaymentEntity2InfoGrantPaymentEntity(IGrantPaymentEntity grantPaymentEntity)
    {
        ...
        {
            infoGrantPaymentEntity = new InfoGrantPaymentEntity();
    ...
    public static IGrantPaymentEntity copyInfoGrantPaymentEntity2IGrantPaymentEntity(InfoGrantPaymentEntity infoGrantPaymentEntity)
    {
        ...
        {
            grantPaymentEntity = new GrantPaymentEntity();
    ...
    public static InfoGrantPart copyIGrantPart2InfoGrantPart(IGrantPart grantPart)
    {
        ...
        if(grantPart != null)
        {
            ...
            InfoGrantPaymentEntity infoGrantPaymentEntity = Cloner.copyIGrantPaymentEntity2InfoGrantPaymentEntity(grantPart.getGrantPaymentEntity());
            InfoGrantSubsidy infoGrantSubsidy = Cloner.copyIGrantSubsidy2InfoGrantSubsidy(grantPart.getGrantSubsidy());
            InfoTeacher infoResponsibleTeacher = Cloner.copyITeacher2InfoTeacher(grantPart.getResponsibleTeacher());
    ...
    public static IGrantPart copyInfoGrantPart2IGrantPart(InfoGrantPart infoGrantPart)
    {
        ...
        if(infoGrantPart != null)
        {
            ...
            IGrantPaymentEntity grantPaymentEntity = Cloner.copyInfoGrantPaymentEntity2IGrantPaymentEntity(infoGrantPart.getInfoGrantPaymentEntity());
            IGrantSubsidy grantSubsidy = Cloner.copyInfoGrantSubsidy2IGrantSubsidy(infoGrantPart.getInfoGrantSubsidy());
            ITeacher responsibleTeacher = Cloner.copyInfoTeacher2Teacher(infoGrantPart.getInfoResponsibleTeacher());
    ...
    public static InfoGrantSubsidy copyIGrantSubsidy2InfoGrantSubsidy(IGrantSubsidy grantSubsidy)
    {
        ...
        if(grantSubsidy != null)
        {
            ...
            InfoGrantContract infoGrantContract = Cloner.copyIGrantContract2InfoGrantContract(grantSubsidy.getGrantContract());
    ...
    public static IGrantSubsidy copyInfoGrantSubsidy2IGrantSubsidy(InfoGrantSubsidy infoGrantSubsidy)
    {
        ...
        if(infoGrantSubsidy != null)
        {
            ...
            IGrantContract grantContract = Cloner.copyInfoGrantContract2IGrantContract(infoGrantSubsidy.getInfoGrantContract());
    ...
    public static IStudentCurricularPlan copyInfoStudentCurricularPlan2IStudentCurricularPlan(InfoStudentCurricularPlan infoStudentCurricularPlan)
    {
        ...
        IBranch secundaryBranch = Cloner.copyInfoBranch2IBranch(infoStudentCurricularPlan.getInfoSecundaryBranch());
        IDegreeCurricularPlan degreeCurricularPlan =
            Cloner.copyInfoDegreeCurricularPlan2IDegreeCurricularPlan(
    ...
    public static InfoStudentCurricularPlan copyIStudentCurricularPlan2InfoStudentCurricularPlan(IStudentCurricularPlan studentCurricularPlan)
    {
        ...
        InfoBranch infoSecundaryBranch = Cloner.copyIBranch2InfoBranch(studentCurricularPlan.getSecundaryBranch());
        InfoDegreeCurricularPlan infoDegreeCurricularPlan =
            Cloner.copyIDegreeCurricularPlan2InfoDegreeCurricularPlan(
