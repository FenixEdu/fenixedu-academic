        ...
        throws IllegalAccessException, InvocationTargetException, NoSuchMethodException
    {
        ...
        for (int i = 0; i < fields.length; i++)
        {
                ...
                && !propertyDescriptor.getName().equals("class"))
            {
                ...
                // FIXME: Temporary workaround, because OJB RC5 (CVS_HEAD) does not generate sequence
                // numbers if idInternal is equal to 0. Check if future versions of OJB have the same
                // problem.
                    ...
                    && ((value == null) || (((Integer) value).intValue() == 0)))
                {
                    ...
                    //BeanUtils.setProperty(destinationBean, propertyDescriptor.getName(), null);
                    String propertySetMethodName =
                        "set" + StringUtils.capitalize(propertyDescriptor.getName());
                    Class[] paramTypes = { Integer.class };
                    Method propertySetMethod =
                        destinationBean.getClass().getMethod(propertySetMethodName, paramTypes);
                    Object[] args = { null };
