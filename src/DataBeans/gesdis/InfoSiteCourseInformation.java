...
public class InfoSiteCourseInformation
	...
	/**
	 * @param infoCourseReport The infoCourseReport to set.
	 */
	...
	/**
	 * @param infoBibliographicReferences The infoBibliographicReferences to set.
	 */
	...
	/**
	 * @param infoCurricularCourses The infoCurricularCourses to set.
	 */
	...
	/**
	 * @param infoCurriculums The infoCurriculums to set.
	 */
	...
	/**
	 * @param infoResponsibleTeachers The infoResponsibleTeachers to set.
	 */
