 ...
 *
 */
public class ComparatorByLessonTypeForInfoShiftWithAssociatedInfoClassesAndInfoLessons implements Comparator {
	...
	public int compare(Object obj1, Object obj2){
		...
		return (infoShift1.getInfoShift().getTipo().getTipo().intValue() - infoShift2.getInfoShift().getTipo().getTipo().intValue());
	}
