...
public class ParamRegularizacaoRelacional implements IParamRegularizacaoPersistente {
  ...
  public boolean alterarParamRegularizacao(ParamRegularizacao paramRegularizacao) {
    ...
    try {
      ...
      UtilRelacional.prepararComando("UPDATE ass_PARAM_REGULARIZACAO SET " +
      "codigoInterno = ? , " +
      "sigla = ? , " +
      "descricao = ? , " +
      "quem = ? , " +
      ...
      System.out.println("ParamRegularizacaoRelacional.alterarParamRegularizacao: " + e.toString());
    }
    finally {
      return resultado;
    }
  ...
  public boolean apagarParamRegularizacao(String sigla) {
    ...
    try {
      PreparedStatement sql =
      UtilRelacional.prepararComando("DELETE FROM ass_PARAM_REGULARIZACAO " +
      "WHERE sigla = ?");
  ...
  public boolean escreverParamRegularizacao(ParamRegularizacao paramRegularizacao) {
    ...
    try {
      PreparedStatement sql =
      UtilRelacional.prepararComando("INSERT INTO ass_PARAM_REGULARIZACAO " +
      "VALUES (?, ?, ?, ?, ?)");
      ...
      System.out.println("ParamRegularizacaoRelacional.escreverParamRegularizacao: " + e.toString());
    }
    finally {
      return resultado;
    }
  ...
  public ParamRegularizacao lerParamRegularizacao(int chaveParamRegularizacao) {
    ...
    try {
      PreparedStatement sql =
      UtilRelacional.prepararComando("SELECT * FROM ass_PARAM_REGULARIZACAO " +
      "WHERE codigoInterno = ?");
      ...
      if (resultado.next()) {
        paramRegularizacao = new ParamRegularizacao(resultado.getInt("codigoInterno"),
  ...
  public ArrayList lerTodasParamRegularizacoes() {
    ...
    try {
      ...
      System.out.println("ParamRegularizacaoRelacional.lerTodasParamRegularizacoes: " + e.toString());
    }
    finally {
