...
public class JustificacaoRelacional implements IJustificacaoPersistente
{
    ...
    public boolean apagarJustificacao(int codigoInterno)
    {
        ...
        try
        {
            PreparedStatement sql =
                UtilRelacional.prepararComando(
                    "DELETE FROM ass_JUSTIFICACAO " + "WHERE codigoInterno=?");
        ...
        try
        {
            ...
            if (listaChaveParamJustificacoes != null)
            {
                if (listaChaveParamJustificacoes.size() > 0)
                {
                    ...
                    ListIterator iterListaParamJustificacoes =
                        listaChaveParamJustificacoes.listIterator();
            ...
            PreparedStatement sql2 =
                UtilRelacional.prepararComando(
                    "SELECT tipo FROM ass_PARAM_JUSTIFICACAO WHERE codigoInterno= ?");
    ...
    public boolean escreverJustificacao(Justificacao justificacao)
    {
        ...
        try
        {
            PreparedStatement sql =
                UtilRelacional.prepararComando(
                    "INSERT INTO ass_JUSTIFICACAO " + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    public Justificacao lerJustificacao(int codigoInterno)
    {
        ...
        try
        {
            PreparedStatement sql =
                UtilRelacional.prepararComando(
                    "SELECT * FROM ass_JUSTIFICACAO " + "WHERE codigoInterno=?");
    ...
    public ArrayList lerJustificacoesHoras(int chaveFuncionario, Timestamp data)
    {
        ...
        try
        {
            ...
            PreparedStatement sql2 =
                UtilRelacional.prepararComando(
                    "SELECT * FROM ass_PARAM_JUSTIFICACAO " + "WHERE codigoInterno=? AND tipo = ?");
            ResultSet resultado2 = null;
            listaJustificacoes = new ArrayList();
            while (resultado.next())
            {
        ...
        java.util.Date diaFim)
    {
        ...
        {
            System.out.println(
                "JustificacaoRelacional.lerJustificacoesFuncionarioComValidade: " + e.toString());
            return null;
        }
        return listaJustificacoes;
