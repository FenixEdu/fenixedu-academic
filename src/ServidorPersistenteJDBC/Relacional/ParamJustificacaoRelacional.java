...
public class ParamJustificacaoRelacional implements IParamJustificacaoPersistente {
	...
	public boolean apagarParamJustificacao(String sigla) {
		...
		try {
			PreparedStatement sql = UtilRelacional.prepararComando("DELETE FROM ass_PARAM_JUSTIFICACAO " + "WHERE sigla = ?");
	...
	public boolean escreverParamJustificacao(ParamJustificacao paramJustificacao) {
		...
		try {
			PreparedStatement sql =
				UtilRelacional.prepararComando("INSERT INTO ass_PARAM_JUSTIFICACAO " + "VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
	...
	public ArrayList lerGruposParamJustificacoes() {
		...
		try {
			PreparedStatement sql = UtilRelacional.prepararComando("SELECT DISTINCT grupo FROM ass_PARAM_JUSTIFICACAO");
			...
			System.out.println("ParamJustificacaoRelacional.lerGruposParamJustificacoes: " + e.toString());
		} finally {
	...
	public ParamJustificacao lerParamJustificacao(int codigoInterno) {
		...
		try {
			PreparedStatement sql = UtilRelacional.prepararComando("SELECT * FROM ass_PARAM_JUSTIFICACAO " + "WHERE codigoInterno = ?");
	...
	public ParamJustificacao lerParamJustificacao(String sigla) {
		...
		try {
			PreparedStatement sql = UtilRelacional.prepararComando("SELECT * FROM ass_PARAM_JUSTIFICACAO " + "WHERE sigla = ?");
	...
	public ArrayList lerSiglasJustificacao() {
		...
		try {
			PreparedStatement sql = UtilRelacional.prepararComando("SELECT sigla FROM ass_PARAM_JUSTIFICACAO");
	...
	public ArrayList lerTipoDiasParamJustificacoes() {
		...
		try {
			PreparedStatement sql = UtilRelacional.prepararComando("SELECT DISTINCT tipoDias FROM ass_PARAM_JUSTIFICACAO");
			ResultSet resultado = sql.executeQuery();
			...
			System.out.println("ParamJustificacaoRelacional.lerTipoDiasParamJustificacoes: " + e.toString());
		} finally {
	...
	public ArrayList lerTiposParamJustificacoes() {
		...
		try {
			PreparedStatement sql = UtilRelacional.prepararComando("SELECT DISTINCT tipo FROM ass_PARAM_JUSTIFICACAO");
			ResultSet resultado = sql.executeQuery();
			...
			System.out.println("ParamJustificacaoRelacional.lerTiposParamJustificacoes: " + e.toString());
		} finally {
	...
	public ArrayList lerTodasParamJustificacoes(String ordem) {
		...
		try {
			...
			System.out.println("ParamJustificacaoRelacional.lerTodasParamJustificacoes: " + e.toString());
		} finally {
			return listaJustificacoes;
		}
