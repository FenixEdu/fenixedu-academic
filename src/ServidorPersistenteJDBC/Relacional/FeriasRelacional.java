...
import ServidorPersistenteJDBC.IFeriasPersistente;
...
public class FeriasRelacional implements IFeriasPersistente {
  ...
  public boolean alterarFerias(Ferias ferias) {
    ...
    try {
      ...
      UtilRelacional.prepararComando("UPDATE ass_FERIAS SET " +
      "codigoInterno = ? , " +
      "chaveFuncionario = ? , " +
      "anoCorrente = ?, " +
      "diasNormais = ?, " +
      ...
      "diasTolerancia = ?, " +
      "diasTransferidos = ?, " +
      "diasTransHorasExtras = ?, " +
      "diasTransAntiguidade = ?, " +
      "WHERE codigoInterno = ? ");
  ...
  public boolean apagarFerias(int codigoInterno) {
    ...
    try {
      PreparedStatement sql =
      UtilRelacional.prepararComando("DELETE FROM ass_FERIAS " +
      "WHERE codigoInterno = ?");
  ...
  public boolean escreverFerias(Ferias ferias) {
    ...
    try {
      PreparedStatement sql =
      UtilRelacional.prepararComando("INSERT INTO ass_FERIAS " +
      "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
  ...
  public ArrayList HistoricoFeriasPorFuncionario(int numFuncionario) {
    ArrayList historico= null;
    
    try {
      PreparedStatement sql = UtilRelacional.prepararComando("SELECT codigoInterno FROM ass_FUNCIONARIO "
      ...
      sql =
      UtilRelacional.prepararComando("SELECT * FROM ass_FERIAS WHERE chaveFuncionario = ?");      
      sql.setInt(1, chaveFuncionario);
      
      resultado = sql.executeQuery();
      historico = new ArrayList();
      while(resultado.next()) {
        historico.add(new Ferias(resultado.getInt("codigoInterno"),
        resultado.getInt("chaveFuncionario"),
        resultado.getInt("anoCorrente"),
        resultado.getInt("diasNormais"),
        resultado.getInt("diasEpocaBaixa"),
        resultado.getInt("diasHorasExtras"),
        resultado.getInt("diasAntiguidade"),
        resultado.getInt("diasMeioDia"),
        resultado.getInt("diasDispensaServico"),
        resultado.getInt("diasTolerancia"),
        resultado.getInt("diasTransferidos"),
        resultado.getInt("diasTransHorasExtras"),
        resultado.getInt("diasTransAntiguidade")));
      }
      sql.close();
    }
    catch(Exception e) {
  ...
  public Ferias lerFerias(int codigoInterno) {
    ...
    try {
      PreparedStatement sql =
      UtilRelacional.prepararComando("SELECT * FROM ass_FERIAS " +
      "WHERE codigoInterno = ?");
      ...
      ResultSet resultado = sql.executeQuery();
      if (resultado.next()) {
        ferias = new Ferias(resultado.getInt("codigoInterno"),
        resultado.getInt("chaveFuncionario"),
        resultado.getInt("anoCorrente"),
        resultado.getInt("diasNormais"),
        resultado.getInt("diasEpocaBaixa"),
  ...
  public ArrayList lerFeriasPorAno(int ano) {
    ...
    try {
      ...
      while(resultado.next()) {
        listaFerias.add(new Ferias(resultado.getInt("codigoInterno"),
        resultado.getInt("chaveFuncionario"),
        resultado.getInt("anoCorrente"),
        resultado.getInt("diasNormais"),
        resultado.getInt("diasEpocaBaixa"),
