...
public class FeriasRelacional implements IFeriasPersistente
{
    ...
    public boolean apagarFerias(int codigoInterno)
    {
        ...
        {
            PreparedStatement sql =
                UtilRelacional.prepararComando("DELETE FROM ass_FERIAS " + "WHERE codigoInterno = ?");
    ...
    public Ferias lerFerias(int codigoInterno)
    {
        ...
        {
            PreparedStatement sql =
                UtilRelacional.prepararComando("SELECT * FROM ass_FERIAS " + "WHERE codigoInterno = ?");
    ...
    public Ferias lerFeriasAnoPorFuncionario(int ano, int numMecanografico)
    {
        ...
        try
        {
            ...
            sql =
                UtilRelacional.prepararComando(
                    "SELECT * FROM ass_FERIAS WHERE chaveFuncionario = ? "
    ...
    public ArrayList lerFeriasPorAno(int ano)
    {
        ...
        {
            PreparedStatement sql =
                UtilRelacional.prepararComando("SELECT * FROM ass_FERIAS " + "WHERE anoCorrente = ?");
