...
public class FuncionarioRelacional implements IFuncionarioPersistente {
    ...
    public boolean alterarFuncionario(Funcionario funcionario) {
        ...
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("UPDATE ass_FUNCIONARIO SET " + "codigoInterno = ? , "
                            + "chavePessoa = ? , " + "numeroMecanografico = ? , "
                            + "chaveHorarioActual = ?, " + "antiguidade = ? "
    ...
    public boolean alterarFuncionarioPorCodigoInterno(Funcionario funcionario) {
        ...
        try {
            PreparedStatement sql = UtilRelacional.prepararComando("UPDATE ass_FUNCIONARIO SET "
                    + "chavePessoa = ? , " + "numeroMecanografico = ? , " + "chaveHorarioActual = ?, "
                    + "antiguidade = ? " + "WHERE codigoInterno = ? ");
    ...
    public boolean alterarHistoricoFuncionario(Funcionario funcionario) {
        ...
        try {
            ...
            sql = UtilRelacional
                    .prepararComando("SELECT * FROM ass_FUNCIONARIO_HISTORICO WHERE chaveFuncionario = ?");
            sql.setInt(1, chaveFuncionario);
            resultadoQuery = sql.executeQuery();

            if (resultadoQuery.last()) { //ultimo record deste funcionário,
                // porque contem a informação actual

                PreparedStatement sql2 = UtilRelacional
                        .prepararComando("UPDATE ass_FUNCIONARIO_HISTORICO SET "
                                + "chaveFuncResponsavel = ? ," + "chaveCCLocalTrabalho = ? ,"
                                + "chaveCCCorrespondencia = ? ," + "chaveCCVencimento = ? ,"
                                + "calendario = ? ," + "chaveStatus = ? ," + "dataInicio = ? ,"
                                + "dataFim = ? ," + "quem = ? ," + "quando = ? "
    ...
    public boolean alterarFuncResponsavel(Funcionario funcionario) {
        ...
        try {
            ...
            sql = UtilRelacional
                    .prepararComando("SELECT * FROM ass_FUNCIONARIO_HISTORICO WHERE chaveFuncionario = ? AND chaveFuncResponsavel IS NOT NULL");
            sql.setInt(1, chaveFuncionario);
            resultadoQuery = sql.executeQuery();
            ...
            if (resultadoQuery.last()) { //ultimo record deste funcionário,
                ...
                PreparedStatement sql2 = UtilRelacional
                        .prepararComando("UPDATE ass_FUNCIONARIO_HISTORICO SET "
                                + "chaveFuncResponsavel = ? ," + "dataInicio = ? ," + "dataFim = ? ,"
    ...
    public boolean alterarCCCorrespondenciaFuncionario(Funcionario funcionario) {
        ...
        try {
            ...
            sql = UtilRelacional
                    .prepararComando("SELECT * FROM ass_FUNCIONARIO_HISTORICO WHERE chaveFuncionario = ?  AND chaveCCCorrespondencia IS NOT NULL");
            sql.setInt(1, chaveFuncionario);
            resultadoQuery = sql.executeQuery();
            ...
            if (resultadoQuery.last()) { //ultimo record deste funcionário,
                ...
                PreparedStatement sql2 = UtilRelacional
                        .prepararComando("UPDATE ass_FUNCIONARIO_HISTORICO SET "
                                + "chaveCCCorrespondencia = ? ," + "dataInicio = ? ," + "dataFim = ? ,"
                                + "quem = ? ," + "quando = ? " + "WHERE codigoInterno = ? ");
            ...
            e.printStackTrace();
            System.out.println("FuncionarioRelacional.alterarCCCorrespondenciaFuncionario: "
                    + e.toString());
        }
        return resultado;
    ...
    public boolean alterarCCLocalTrabalhoFuncionario(Funcionario funcionario) {
        ...
        try {
            ...
            sql = UtilRelacional
                    .prepararComando("SELECT * FROM ass_FUNCIONARIO_HISTORICO WHERE chaveFuncionario = ? AND chaveCCLocalTrabalho IS NOT NULL");
            sql.setInt(1, chaveFuncionario);
            resultadoQuery = sql.executeQuery();
            ...
            if (resultadoQuery.last()) { //ultimo record deste funcionário,
                ...
                PreparedStatement sql2 = UtilRelacional
                        .prepararComando("UPDATE ass_FUNCIONARIO_HISTORICO SET "
                                + "chaveCCLocalTrabalho = ? ," + "dataInicio = ? ," + "dataFim = ? ,"
                                + "quem = ? ," + "quando = ? " + "WHERE codigoInterno = ? ");
            ...
            e.printStackTrace();
            System.out.println("FuncionarioRelacional.alterarCCLocalTrabalhoFuncionario: "
                    + e.toString());
        }
        return resultado;
    ...
    public boolean alterarCCVencimento(Funcionario funcionario) {
        ...
        try {
            ...
            sql = UtilRelacional
                    .prepararComando("SELECT * FROM ass_FUNCIONARIO_HISTORICO WHERE chaveFuncionario = ? AND chaveCCVencimento IS NOT NULL");
            sql.setInt(1, chaveFuncionario);
            resultadoQuery = sql.executeQuery();
            ...
            if (resultadoQuery.last()) { //ultimo record deste funcionário,
                ...
                PreparedStatement sql2 = UtilRelacional
                        .prepararComando("UPDATE ass_FUNCIONARIO_HISTORICO SET "
                                + "chaveCCVencimento = ? ," + "dataInicio = ? ," + "dataFim = ? ,"
                                + "quem = ? ," + "quando = ? " + "WHERE codigoInterno = ? ");
    ...
    public boolean alterarCalendario(Funcionario funcionario) {
        ...
        try {
            ...
            sql = UtilRelacional
                    .prepararComando("SELECT * FROM ass_FUNCIONARIO_HISTORICO WHERE chaveFuncionario = ? AND calendario IS NOT NULL");
            sql.setInt(1, chaveFuncionario);
            resultadoQuery = sql.executeQuery();
            ...
            if (resultadoQuery.last()) { //ultimo record deste funcionário,
                // porque contem a informação actual
                PreparedStatement sql2 = UtilRelacional
                        .prepararComando("UPDATE ass_FUNCIONARIO_HISTORICO SET " + "calendario = ? ,"
                                + "dataInicio = ? ," + "dataFim = ? ," + "quem = ? ," + "quando = ? "
                                + "WHERE codigoInterno = ? ");
    ...
    public boolean alterarStatusAssiduidade(Funcionario funcionario) {
        ...
        try {
            ...
            sql = UtilRelacional
                    .prepararComando("SELECT * FROM ass_FUNCIONARIO_HISTORICO WHERE chaveFuncionario = ? AND chaveStatus IS NOT NULL");
            sql.setInt(1, chaveFuncionario);
            resultadoQuery = sql.executeQuery();
            ...
            if (resultadoQuery.last()) { //ultimo record deste funcionário,
                // porque contem a informação actual
                PreparedStatement sql2 = UtilRelacional
                        .prepararComando("UPDATE ass_FUNCIONARIO_HISTORICO SET " + "chaveStatus = ? ,"
                                + "dataInicio = ? ," + "dataFim = ? ," + "quem = ? ," + "quando = ? "
                                + "WHERE codigoInterno = ? ");
    ...
    public boolean alterarFimValidade(int codigoInterno, Date dataFim) {
        ...
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("UPDATE ass_FUNCIONARIO_HISTORICO SET " + "dataFim = ? "
    ...
    public boolean apagarFuncionario(int numero) {
        ...
        try {
            ...
            if (resultadoQuery.next()) {
                ...
                PreparedStatement sql2 = UtilRelacional
                        .prepararComando("DELETE FROM ass_FUNCIONARIO_HISTORICO WHERE chaveFuncionario = ?");
                ...
                sql2 = UtilRelacional
                        .prepararComando("DELETE FROM ass_FUNCIONARIO WHERE numeroMecanografico = ?");
    ...
    public boolean escreverFuncionario(Funcionario funcionario) {
        ...
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("INSERT INTO ass_FUNCIONARIO "
    ...
    public boolean escreverHistoricoFuncionario(Funcionario funcionario) {
        ...
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("INSERT INTO ass_FUNCIONARIO_HISTORICO "
                            + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 1)");
    ...
    public boolean escreverFimFuncResponsavel(int numMecanografico, Date fim) {
        ...
        try {
            ...
            //escreve a data fim de assiduidade nos actuais registos do
            // histórico
            sql = UtilRelacional
                    .prepararComando("UPDATE ass_FUNCIONARIO_HISTORICO SET "
                            + "dataFim = ? "
    ...
    public boolean escreverFimCalendario(int numMecanografico, Date fim) {
        ...
        try {
            ...
            //escreve a data fim de assiduidade nos actuais registos do
            // histórico
            sql = UtilRelacional.prepararComando("UPDATE ass_FUNCIONARIO_HISTORICO SET "
                    + "dataFim = ? "
    ...
    public boolean existeHistoricoCCCorrespondencia(Funcionario funcionario) {
        ...
        try {
            ...
            e.printStackTrace();
            System.out
                    .println("FuncionarioRelacional.existeHistoricoCCCorrespondencia: " + e.toString());
        }
        return existeHistorico;
    ...
    public boolean existeHistoricoStatusAssiduidade(Funcionario funcionario) {
        ...
        try {
            ...
            e.printStackTrace();
            System.out
                    .println("FuncionarioRelacional.existeHistoricoStatusAssiduidade: " + e.toString());
        }
        {
            return existeHistorico;
        }
    ...
    public Funcionario lerFuncionarioPorFuncNaoDocente(int chaveFuncNaoDocente, Date dataConsulta) {
        ...
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("SELECT chaveFuncionario FROM ass_FUNC_NAO_DOCENTE WHERE codigoInterno = ?");
        ...
        try {
            ...
            if (resultado.next()) {
                ...
                if (resultado2.next()) {
                    ...
                    funcionario = new Funcionario(resultado2.getInt("codigoInterno"), resultado2
                            .getInt("chavePessoa"), resultado2.getInt("numeroMecanografico"), resultado2
                            .getInt("chaveHorarioActual"), antiguidade, codigoInterno,
                            (Integer) resultado.getObject("chaveFuncResponsavel"), (Integer) resultado
                                    .getObject("chaveCCLocalTrabalho"), (Integer) resultado
                                    .getObject("chaveCCCorrespondencia"), (Integer) resultado
                                    .getObject("chaveCCVencimento"), resultado.getString("calendario"),
                            (Integer) resultado.getObject("chaveStatus"), dataInicio, dataFim, resultado
                                    .getInt("quem"), dataQuando);
                }
                sql2.close();
            }
            sql.close();
        ...
        try {
            ...
            if (resultado.next()) {
                ...
                while (resultado2.next()) {
                    ...
                    listaHistoricosFuncionario.add(new Funcionario(resultado.getInt("codigoInterno"),
                            resultado.getInt("chavePessoa"), resultado.getInt("numeroMecanografico"),
                            resultado.getInt("chaveHorarioActual"), antiguidade, resultado2
                                    .getInt("codigoInterno"), (Integer) resultado2
    ...
    public List lerFuncionariosCCLocalTrabalho(int chaveCCLocalTrabalho, Date data) {
        ...
        try {
            ...
            PreparedStatement sql2 = UtilRelacional.prepararComando("SELECT * FROM ass_FUNCIONARIO "
                    + "WHERE codigoInterno=? ");
            ...
            while (resultado.next()) {
                ...
                if (resultado2.next()) {
                    ...
                    listaFuncionarios.add(new Funcionario(resultado2.getInt("codigoInterno"), resultado2
                            .getInt("chavePessoa"), resultado2.getInt("numeroMecanografico"), resultado2
                            .getInt("chaveHorarioActual"), antiguidade, (Integer) resultado
                            .getObject("chaveFuncResponsavel"), (Integer) resultado
                            .getObject("chaveCCLocalTrabalho"), (Integer) resultado
                            .getObject("chaveCCCorrespondencia"), (Integer) resultado
                            .getObject("chaveCCVencimento"), resultado.getString("calendario"),
                            (Integer) resultado.getObject("chaveStatus"), dataInicio, dataFim, resultado
            ...
            while (resultado.next()) {
                ...
                if (resultado2.next()) {
                    ...
                    if (resultado3.last()) {
                        ...
                        listaFuncionarios.add(new Funcionario(resultado.getInt("codigoInterno"),
                                resultado.getInt("chavePessoa"),
                                resultado.getInt("numeroMecanografico"), resultado
                                        .getInt("chaveHorarioActual"), antiguidade, (Integer) resultado3
                                        .getObject("chaveFuncResponsavel"), (Integer) resultado3
                                        .getObject("chaveCCLocalTrabalho"), (Integer) resultado3
                                        .getObject("chaveCCCorrespondencia"), (Integer) resultado3
                                        .getObject("chaveCCVencimento"), resultado3
                                        .getString("calendario"), (Integer) resultado3
                                        .getObject("chaveStatus"), dataInicio, dataFim, resultado3
                                        .getInt("quem"), dataQuando));
                    }
                }
            }
    ...
    public List lerTodosNumeros() {
        List listaNumeros = null;
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("SELECT numeroMecanografico FROM ass_FUNCIONARIO");
            ResultSet resultado = sql.executeQuery();
    ...
    public List lerTodosNumerosAssiduidade() {
        ...
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("SELECT DISTINCT chaveFuncionario FROM ass_HORARIO");
            ResultSet resultado = sql.executeQuery();
            PreparedStatement sqlChaveFuncionario = UtilRelacional
                    .prepararComando("SELECT numeroMecanografico FROM ass_FUNCIONARIO "
                            + "WHERE codigoInterno = ?");
            ResultSet resultadoChaveFuncionario = null;
            listaNumeros = new ArrayList();
            while (resultado.next()) { //chave do Funcionario
                ...
                if (resultadoChaveFuncionario.next()) {
                    listaNumeros
                            .add(new Integer(resultadoChaveFuncionario.getInt("numeroMecanografico")));
                }
            }
    ...
    public List lerTodosNumerosAssiduidade(Timestamp dataInicioConsulta) {
        ...
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("SELECT numeroMecanografico FROM ass_FUNCIONARIO ORDER BY numeroMecanografico");
            ResultSet resultado = sql.executeQuery();
            PreparedStatement sqlChaveFuncionario = UtilRelacional
                    .prepararComando("SELECT codigoInterno FROM ass_FUNCIONARIO "
                            + "WHERE numeroMecanografico = ?");
            ResultSet resultadoChaveFuncionario = null;
            PreparedStatement sqlAssiduidade = UtilRelacional
                    .prepararComando("SELECT * FROM ass_HORARIO "
                            + "WHERE chaveFuncionario = ? AND "
    ...
    public List lerTodosNumerosFuncNaoDocentes() {
        ...
        try {
            ...
            while (resultado.next()) {
                sql2.setInt(1, resultado.getInt("codigoInterno"));
                resultado2 = sql2.executeQuery();
                if (resultado2.next()) { //funcionario a cumprir assiduidade
                    listaNumeros.add(new Integer(resultado.getInt("numeroMecanografico")));
                }
            }
            sql2.close();
    ...
    public boolean sobreposicaoHistoricos(int codigoInterno, Date dataInicio, Date dataFim) {
        ...
        try {
            ...
            if (dataFim == null) {
                ...
                sql = UtilRelacional.prepararComando("SELECT * FROM ass_FUNCIONARIO_HISTORICO "
                        + "WHERE chaveFuncionario = ? AND ((dataInicio BETWEEN ? AND ?) "
                        + "OR (dataFim IS NOT NULL AND dataFim BETWEEN ? AND ?) "
                        + "OR (dataInicio <= ? AND dataFim IS NOT NULL AND dataFim >= ?) "
                        + "OR (dataInicio >= ? AND dataFim IS NULL))");
    ...
    public int ultimoCodigoInterno() {
        ...
        try {
            PreparedStatement sql = UtilRelacional
                    .prepararComando("SELECT max(codigoInterno) FROM ass_FUNCIONARIO");
            ResultSet resultado = sql.executeQuery();
            if (resultado.next())
    ...
    public boolean escreverFimAssiduidade(int numMecanografico, Date fimAssiduidade) {
        ...
        try {
            ...
            if (dataAssiduidade != null) {
                //escreve a data fim de assiduidade nos actuais registos do
                // horário
                sql = UtilRelacional.prepararComando("UPDATE ass_HORARIO SET " + "dataFim = ? "
            ...
            // histórico
            sql = UtilRelacional.prepararComando("UPDATE ass_FUNCIONARIO_HISTORICO SET "
                    + "dataFim = ? " + " WHERE chaveFuncionario = ? "
            ...
            //escreve a data fim de assiduidade no registo de cartão de
            // funcionário
            sql = UtilRelacional.prepararComando("UPDATE ass_CARTAO SET " + "dataFim = ? "
                    + " WHERE chaveFuncionario = ? " + " AND dataFim > ?");
            sql.setDate(1, new java.sql.Date(fimAssiduidade.getTime()));
            sql.setInt(2, chaveFuncionario);
            sql.setDate(3, new java.sql.Date(fimAssiduidade.getTime()));
    ...
    public boolean verificaFimAssiduidade(int numMecanografico, Date dataFimAssiduidade) {
        ...
        try {
            ...
            if (dataAssiduidade == null) {
                sql = UtilRelacional
                        .prepararComando("SELECT MAX(dataInicio) FROM ass_FUNCIONARIO_HISTORICO "
                                + "WHERE chaveFuncionario = ?");
                sql.setInt(1, chaveFuncionario);
            ...
            //verifica se a data fim de assiduidade está contida nos registos
            // do funcionario
