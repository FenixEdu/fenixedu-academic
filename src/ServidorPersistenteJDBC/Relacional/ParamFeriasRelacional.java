...
public class ParamFeriasRelacional implements IParamFeriasPersistente {
  ...
  public boolean alterarParamFerias(ParamFerias tipoFerias) {
    ...
    try {
      ...
      UtilRelacional.prepararComando("UPDATE ass_PARAM_FERIAS SET " +
      "codigoInterno = ? , " +
      "sigla = ? , " +
      "designacao = ? " +
      "WHERE codigoInterno = ? ");
  ...
  public ParamFerias lerParamFerias(int codigoInterno) {
    ...
    try {
      ...
      if (resultado.next()) {
        tipoFerias = new ParamFerias(resultado.getInt("codigoInterno"),
  ...
  public ArrayList lerTodosParamFerias() {
    ...
    try{
      ...
      while(resultado.next()){
        listaTiposFerias.add(new ParamFerias(resultado.getInt("codigoInterno"), 
        resultado.getString("sigla"), 
        resultado.getString("designacao")));
      }
    } catch (Exception e){
