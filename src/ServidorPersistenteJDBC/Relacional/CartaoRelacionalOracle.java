		...
		try {
			...
			try {
				...
				while (resultado.next()) {
					listaCartoesTeleponto.add(new Cartao(resultado.getInt("CARTNO_CART"), resultado.getInt("EMP_NUM"),
					// só pode levar o numero de funcionario, e no servico vamos descobrir qual a chave do funcionario
