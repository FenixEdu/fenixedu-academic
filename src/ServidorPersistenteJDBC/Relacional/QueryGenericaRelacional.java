...
/** classe que executa operacoes de leitura e escrita de registos
 * a partir da estrutura das mesmas
 * @author Ivo Brandão
 */
public class QueryGenericaRelacional {
    ...
    /** gera as clausulas Where com a chave de uma Query; usado por queryLeitura, queryApagar, queryAlteracao */
    ...
    private PreparedStatement queryEscrita(String nomeTabela, Hashtable atributos,
        Hashtable valores) throws Exception {
    ...
    private PreparedStatement queryAlteracao(String nomeTabela, Hashtable atributos,
        Hashtable valores, Hashtable chave) throws Exception {
    ...
    private Hashtable constroiResultadoLeitura(Hashtable atributos, ResultSet resultadoSQL) throws Exception{
    ...
    public Boolean alterar(String nomeTabela, Hashtable atributos, Hashtable valores, 
        Hashtable chave){
        PreparedStatement querySQL = null;
        Boolean resultado = new Boolean(false);
