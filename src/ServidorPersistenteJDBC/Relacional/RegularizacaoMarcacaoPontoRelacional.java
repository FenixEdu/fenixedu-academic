...
public class RegularizacaoMarcacaoPontoRelacional implements IRegularizacaoMarcacaoPontoPersistente
{
    ...
    public boolean apagarRegularizacaoMarcacaoPonto(int chaveMarcacaoPonto)
    {
        ...
        try
        {
            PreparedStatement sql =
                UtilRelacional.prepararComando(
                    "DELETE FROM ass_REGULARIZACAO_MARCACAO " + "WHERE chaveMarcacaoPonto=?");
    ...
    public boolean apagarRegularizacoesMarcacoesPonto()
    {
        ...
        {
            PreparedStatement sql =
                UtilRelacional.prepararComando("DELETE FROM ass_REGULARIZACAO_MARCACAO");
            sql.executeUpdate();
            sql.close();
            /*
			 * sql = UtilRelacional.prepararComando("ALTER TABLE ass_REGULARIZACAO_MARCACAO
    ...
    public boolean existeRegularizacaoMarcacaoPonto(RegularizacaoMarcacaoPonto regularizacao)
    {
        ...
        {
            System.out.println(
                "RegularizacaoMarcacaoPontoRelacional.existeRegularizacaoMarcacaoPonto : "
                    + e.toString());
            e.printStackTrace();
        }
        finally
    ...
    public ArrayList lerTodasRegularizacoes()
    {
        ...
        {
            System.out.println(
                "RegularizacaoMarcacaoPontoRelacional.lerTodasRegularizacoes: " + e.toString());
        }
