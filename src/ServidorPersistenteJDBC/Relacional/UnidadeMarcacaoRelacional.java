...
public class UnidadeMarcacaoRelacional implements IUnidadeMarcacaoPersistente{
  ...
  public UnidadeMarcacao lerUnidadeMarcacao(String sigla) {
    ...
    try {
      ...
      if (resultado.next()) {
        unidadeMarcacao = new UnidadeMarcacao(resultado.getInt("codigoInterno"),
  ...
  public UnidadeMarcacao lerUnidadeMarcacao(int codigoInterno) {    
    ...
    try {
      PreparedStatement sql =
      UtilRelacional.prepararComando("SELECT * FROM ass_UNIDADE_MARCACAO WHERE codigoInterno = ?");
  ...
  public UnidadeMarcacao lerUnidadeMarcacaoPorDescricao(String descricao) {
    ...
    try {
      ...
      System.out.println("UnidadeMarcacaoRelacional.lerUnidadeMarcacaoPorDescricao: " + e.toString());
    }
    finally {
      return unidadeMarcacao;
    }
  ...
  public ArrayList lerUnidadesMarcacao() {
    ...
    try {
      PreparedStatement sql =
      UtilRelacional.prepararComando("SELECT * FROM ass_UNIDADE_MARCACAO");
      
      ResultSet resultado = sql.executeQuery();
      unidades = new ArrayList();
      while(resultado.next()) {
        unidades.add(new UnidadeMarcacao(resultado.getInt("codigoInterno"), 
        resultado.getString("sigla"), 
        resultado.getString("descricao"), 
        resultado.getInt("id")));
      }
