...
public class PeriodoFeriasRelacional implements IPeriodoFeriasPersistente {
  ...
  public boolean alterarPeriodoFerias(PeriodoFerias periodoFerias) {
    ...
    try {
      ...
      UtilRelacional.prepararComando("UPDATE ass_PERIODO_FERIAS SET " +
      "codigoInterno = ? , " +
      "chaveFuncionario = ? , " +
      "dataInicio = ? , " +
      "dataFim = ? , " +
  ...
  public boolean escreverPeriodoFerias(PeriodoFerias periodoFerias) {
    ...
    try {
      PreparedStatement sql =
      UtilRelacional.prepararComando("INSERT INTO ass_PERIODO_FERIAS VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
  ...
  public ArrayList historicoFeriasPorFuncionario(int numFuncionario) {
    ...
    try{
      ...
      sql = UtilRelacional.prepararComando("SELECT * FROM ass_PERIODO_FERIAS WHERE chaveFuncionario = ?");      
      ...
      while(resultado.next()){
        ...
        listaFerias.add(new PeriodoFerias(resultado.getInt("codigoInterno"),
  ...
  public PeriodoFerias lerPeriodoFerias(int codigoInterno) {
    ...
    try {
      PreparedStatement sql =
      UtilRelacional.prepararComando("SELECT * FROM ass_PERIODO_FERIAS " +
      "WHERE codigoInterno = ?");
      ...
      if (resultado.next()) {
        ...
        periodoFerias = new PeriodoFerias(resultado.getInt("codigoInterno"),
        resultado.getInt("chaveFuncionario"),
        java.sql.Date.valueOf(resultado.getString("dataInicio")),
        dataFim,
        resultado.getInt("numDiasUteis"),
  ...
  public ArrayList lerFuncionariosComFerias(Timestamp dataFerias) {
    ...
    try{
      ...
      PreparedStatement sql2 = UtilRelacional.prepararComando("SELECT numeroMecanografico FROM ass_FUNCIONARIO " 
      + "WHERE codigoInterno = ?");
  ...
  public ArrayList lerFeriasPorTipo(String tipoFerias) {
    ...
    try{
      PreparedStatement sql = UtilRelacional.prepararComando("SELECT codigoInterno FROM ass_TIPO_FERIAS WHERE sigla = ?");
      ...
      sql = UtilRelacional.prepararComando("SELECT * FROM ass_PERIODO_FERIAS WHERE tipoFerias = ?");         
