...
public class MarcacaoPontoRelacionalOracle implements IMarcacaoPontoPersistente
{
    ...
    +"ASS_MARWHEN = ?, " + "ASS_MARWHO = ? " + "WHERE ASS_MARSEQ = ? ");
            ...
            catch (SQLException SQLe)
            {
                ...
                System.out.println(
                    "MarcacaoPontoRelacionalOracle.alterarMarcacaoPonto: " + SQLe.toString());
                return false;
            }
    ...
    +"(ASS_MARDHMARCA BETWEEN ? AND ?))");
                ...
                PreparedStatement sql2 =
                    UtilRelacionalOracle.prepararComando(
                        "SELECT * FROM ASS_MARREG WHERE ASS_MARREGMARCAS = ? AND "
                            + "ASS_MARREGREGUL = 'MA'");
            ...
            catch (SQLException SQLe)
            {
                SuportePersistenteOracle.getInstance().cancelarTransaccao();
                System.out.println(
                    "MarcacaoPontoRelacionalOracle.consultarMarcacoesPonto: " + SQLe.toString());
                return null;
            }
            SuportePersistenteOracle.getInstance().confirmarTransaccao();
        }
    ...
    public ArrayList lerMarcacoesPonto()
    {
        ...
        try
        {
            ...
            catch (SQLException SQLe)
            {
                SuportePersistenteOracle.getInstance().cancelarTransaccao();
                System.out.println(
                    "MarcacaoPontoRelacionalOracle.lerMarcacoesPonto: " + SQLe.toString());
                return null;
            }
            SuportePersistenteOracle.getInstance().confirmarTransaccao();
        }
    ...
    public ArrayList obterMarcacoesPonto(int numFuncionario, int numCartao, Timestamp dataFim)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                //"ASS_MARDHMARCA>=TO_DATE(?, 'YYYY-MM-DD HH24:MI:SS') AND ASS_MARPESSOA=? AND
                // ASS_MARCARTAO=?");
            ...
            catch (SQLException SQLe)
            {
                SuportePersistenteOracle.getInstance().cancelarTransaccao();
                System.out.println(
                    "MarcacaoPontoRelacionalOracle.obterMarcacoesPonto: " + SQLe.toString());
                return null;
            }
            SuportePersistenteOracle.getInstance().confirmarTransaccao();
        }
    ...
    public ArrayList obterMarcacoesPonto(int numCartao, Timestamp dataInicio, Timestamp dataFim)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                //+ "ASS_MARDHMARCA>=TO_DATE(?, 'YYYY-MM-DD HH24:MI:SS') AND ASS_MARDHMARCA<=TO_DATE(?,
                // 'YYYY-MM-DD HH24:MI:SS')");
    ...
    public int ultimoCodigoInterno()
    {
        ...
        try
        {
            ...
            {
                PreparedStatement sql =
                    UtilRelacional.prepararComando("SELECT MAX(ASS_MARSEQ) FROM ASS_MARCAS");
            ...
            catch (SQLException SQLe)
            {
                SuportePersistenteOracle.getInstance().cancelarTransaccao();
                System.out.println(
                    "MarcacaoPontoRelacionalOracle.ultimoCodigoInterno: " + SQLe.toString());
                return 0;
            }
            SuportePersistenteOracle.getInstance().confirmarTransaccao();
        }
