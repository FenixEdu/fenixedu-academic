...
public class PublicationTeacherTeacher extends PublicationTeacherTeacher_Base {
    ...
    public static void add(net.sourceforge.fenixedu.domain.publication.IPublicationTeacher teacherPublications, net.sourceforge.fenixedu.domain.ITeacher teacher) throws DomainException {
