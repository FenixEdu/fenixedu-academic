...
public class FilterDiscriptorProperty2XML extends FileUtil {
	...
	public static void main(String[] args) {
		FilterDiscriptorProperty2XML instance =
			new FilterDiscriptorProperty2XML();
	...
	public static HashMap exec(
		...
		FilterDiscriptorProperty2XML instance) {
		FilterDiscriptorProperty2XML.inputFile = inputFile;
		FilterDiscriptorProperty2XML.outputFile = outputFile;
		FilterDiscriptorProperty2XML.implementationClassPackage =
	...
	protected String processLine(Integer i, String line) {
		if (line != null) {
			if (i.intValue() == 1) {
				...
				filterDescriptor += "\t\t<implementationClass>"
					+ implementationClassPackage
					+ "."
				...
				filterDescriptor += "\t\t<description>"
					+ discription
					+ "</description>\n";
				filterDescriptor += "\t\t<isTransactional>"
					+ isTransactional
					+ "</isTransactional>\n";
