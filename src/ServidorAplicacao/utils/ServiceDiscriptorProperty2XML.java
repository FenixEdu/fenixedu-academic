...
public class ServiceDiscriptorProperty2XML extends FileUtil {
	...
	public static void main(String[] args) {
		filterChainIDs =
			FilterChainDiscriptorProperty2XML.exec(
				args[3],
				args[4],
				args[5],
		...
		ServiceDiscriptorProperty2XML instance =
			new ServiceDiscriptorProperty2XML();
	...
	protected String processLine(Integer i, String line) {
		if (line != null && !StringUtils.trim(line).equals("")) {
			...
			try
			{
				Class service = Class.forName(implementationClassPackage + "." + implementationClassName);
