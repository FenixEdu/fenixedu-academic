...
public class ServicoSeguroLerHorario extends ServicoSeguro {
	...
	public ServicoSeguroLerHorario(ServicoAutorizacao servicoAutorizacaoLer, int numMecanografico, Timestamp dataConsulta) {
	...
	public void execute() throws NotExecuteException {
		...
		if (_horario.getChaveHorarioTipo() == 0) {
			...
			//é um horário tipo
			IHorarioTipoPersistente iHorarioTipoPersistente = SuportePersistente.getInstance().iHorarioTipoPersistente();
