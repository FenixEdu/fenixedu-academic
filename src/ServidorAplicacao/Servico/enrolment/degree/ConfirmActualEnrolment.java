    ...
    private void writeTemporaryEnrolment(EnrolmentContext enrolmentContext) throws ExcepcaoPersistencia
    {
        ...
        try
        {
            ...
            Integer studentNumber =
                enrolmentContext.getStudentActiveCurricularPlan().getStudent().getNumber();
            ...
            IExecutionPeriod executionPeriod =
                (IExecutionPeriod) persistentExecutionPeriod.readDomainObjectByCriteria(
            ...
            List doingCurricularCoursesRead =
                (List) CollectionUtils.collect(doingEnrolmentsRead, new Transformer()
            {
            ...
            while (iterator.hasNext())
            {
                ...
                ICurricularCourse curricularCourseChosen = (ICurricularCourse) iterator.next();
                ...
                ICurricularCourse curricularCourse2Write =
                    persistentCurricularCourse.readCurricularCourseByDegreeCurricularPlanAndNameAndCode(
                        curricularCourseChosen.getDegreeCurricularPlan().getIdInternal(),
                        curricularCourseChosen.getName(),
                        curricularCourseChosen.getCode());
                ...
                //if (!doingCurricularCoursesRead
                //    .contains(curricularCourseScopeToWrite.getCurricularCourse()))
                if (!doingCurricularCoursesRead.contains(curricularCourse2Write))
                {
                    ...
                    enrolmentToWrite.setCurricularCourse(curricularCourse2Write);
            ...
            while (iterator2.hasNext())
            {
                ...
                //					(IEnrolmentInOptionalCurricularCourse) persistentEnrolment.readByStudentCurricularPlanAndCurricularCourseScopeAndExecutionPeriod(
                //						enrolmentInOptionalCurricularCourse.getStudentCurricularPlan(),
                ...
                ICurricularCourse optionalCurricularCourse2Write =
                    enrolmentInOptionalCurricularCourse.getCurricularCourse();
                if (enrolment == null)
                {
