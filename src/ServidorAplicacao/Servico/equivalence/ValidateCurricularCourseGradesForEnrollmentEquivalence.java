...
public class ValidateCurricularCourseGradesForEnrollmentEquivalence extends EnrollmentEquivalenceServiceUtils implements IService
{
	public ValidateCurricularCourseGradesForEnrollmentEquivalence()
	{
	}

	public String run(Integer studentNumber, TipoCurso degreeType, InfoStudentCurricularPlan infoStudentCurricularPlan,
		List infoCurricularCourseGrades) throws FenixServiceException
	{
	...
	protected Object convertDataInput(Object object)
	{
		...
		IDegreeCurricularPlan degreeCurricularPlan = Cloner
			.copyInfoDegreeCurricularPlan2IDegreeCurricularPlan(infoStudentCurricularPlan.getInfoDegreeCurricularPlan());
	...
	protected Object execute(Object object) throws FenixServiceException
	{
        ...
        if ((infoCurricularCourseGrades != null) && (!infoCurricularCourseGrades.isEmpty()))
		{
			...
			for (int i = 0; i < infoCurricularCourseGrades.size(); i++)
			{
				...
				if ((infoCurricularCourseGrade.getGrade() == null) || (infoCurricularCourseGrade.getGrade().equals("")))
				{
