...
public class ReadExecutionDegreeByCandidateID implements IServico {
	...
	public InfoExecutionDegree run(Integer candidateID) throws NonExistingServiceException {
	  ...
	  try {
		...
		executionDegreeTemp.setIdInternal(masterDegreeCandidate.getExecutionDegree().getIdInternal());
		
		executionDegree = (ICursoExecucao) sp.getICursoExecucaoPersistente().readByOId(executionDegreeTemp, false); 
