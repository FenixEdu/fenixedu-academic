...
public class ReadExecutionDegreeByExecutionYearAndDegreeCode implements IServico {
	...
	private static ReadExecutionDegreeByExecutionYearAndDegreeCode service = new ReadExecutionDegreeByExecutionYearAndDegreeCode();
	/**
	...
	public InfoExecutionDegree run(String executionDegreeString, String degreeCode) throws FenixServiceException {
		...
		try {
			...
			ICursoExecucao executionDegree = (ICursoExecucao) executionDegreeDAO.readByDegreeCodeAndExecutionYear(degreeCode, executionYear);
