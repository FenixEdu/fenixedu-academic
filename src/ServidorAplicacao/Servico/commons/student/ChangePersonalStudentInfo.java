...
public class ChangePersonalStudentInfo implements IServico {
    
    private static ChangePersonalStudentInfo servico = new ChangePersonalStudentInfo();
    
    /**
     * The singleton access method of this class.
     **/
    public static ChangePersonalStudentInfo getService() {
        return servico;
    }
     ...
     **/
    private ChangePersonalStudentInfo() { 
    }
    ...
    public final String getNome() {
        return "ChangePersonalStudentInfo";
    }
    
    
    public InfoPerson  run(InfoPerson newInfoPerson) 
		...
		if ((newInfoPerson.getInfoPais() == null) || (newInfoPerson.getInfoPais().getNationality().length() == 0))
			...
			try {
				if ((person.getPais() == null) || (!newInfoPerson.getInfoPais().getNationality().equals(person.getPais().getNationality()))) {
