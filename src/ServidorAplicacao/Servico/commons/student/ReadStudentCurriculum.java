...
//			enrollmentEvaluations.addAll(enrolmentTemp.getEvaluations());
//			if (enrollmentEvaluations != null && enrollmentEvaluations.size() > 0)
//			{
//				if (enrollmentEvaluations.size() == 1)
//				{
//					IEnrolmentEvaluation enrollmentEvaluation =
//						(IEnrolmentEvaluation) enrollmentEvaluations.get(0);
//					infoEnrolmentEvaluation =
//						Cloner.copyIEnrolmentEvaluation2InfoEnrolmentEvaluation(enrollmentEvaluation);
//				}
//				else
//				{
...
//
//                    IEnrolmentEvaluation enrollmentEvaluation = (IEnrolmentEvaluation)
