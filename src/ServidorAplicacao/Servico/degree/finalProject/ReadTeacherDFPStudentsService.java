...
public class ReadTeacherDFPStudentsService implements IService {
    ...
    public TeacherDegreeFinalProjectStudentsDTO run(InfoTeacher infoTeacher,
        ...
        try {
            ...
            List teacherDFPStudentList = teacherDfpStudentDAO
                    .readByTeacherAndExecutionPeriod(teacher, executionPeriod);

            List infoteacherDFPStudentList = (List) CollectionUtils.collect(
                    teacherDFPStudentList, new Transformer() {
            ...
            teacherDfpStudentsDTO
                    .setInfoTeacherDegreeFinalProjectStudentList(infoteacherDFPStudentList);
