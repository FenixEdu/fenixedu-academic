...
public class EditTeacherDegreeFinalProjectStudentByOID extends EditDomainObjectService
{
    ...
    private static EditTeacherDegreeFinalProjectStudentByOID service =
        ...
        throws FenixServiceException
    {
        try
        {
            ...
            executionPeriod =
                (IExecutionPeriod) executionPeriodDAO.readByOId(executionPeriod, false);
            ...
            List teacherDegreeFinalProjectStudentList =
                teacherDegreeFinalProjectStudentDAO.readByStudentAndExecutionPeriod(student, executionPeriod);

            double requestedPercentage =
                ((InfoTeacherDegreeFinalProjectStudent) infoObject).getPercentage().doubleValue();
            ...
            while (iterator.hasNext())
            {
                ...
                if (teacherDegreeFinalProjectStudent.getTeacher().getIdInternal().intValue()
                    != infoTeacherDegreeFinalProjectStudent.getInfoTeacher().getIdInternal().intValue())
                {
                ...
                List infoTeacherDegreeFinalProjectStudentList =
                    (
                        List) CollectionUtils
                            .collect(teacherDegreeFinalProjectStudentList, new Transformer()
                {
    ...
    {
        ITeacherDegreeFinalProjectStudent teacherDegreeFinalProjectStudent =
            (ITeacherDegreeFinalProjectStudent) domainObjectLocked;
        ...
        try
        {
            Double dfpStudentsCredits = creditsCalculator.calcuteDegreeFinalProjectStudentAfterInsert(teacher, executionPeriod, teacherDegreeFinalProjectStudent, sp);
