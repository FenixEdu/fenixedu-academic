...
public class ChangeGratuityState implements IServico {

	private static ChangeGratuityState servico = new ChangeGratuityState();

	/**
	 * The singleton access method of this class.
	 **/
	public static ChangeGratuityState getService() {
		return servico;
	}
	...
	public final String getNome() {
		return "ChangeGratuityState";
	}

	public void run(Integer studentCurricularPlanID, GratuityState gratuityState, String othersRemarks) throws FenixServiceException {
		...
		if (gratuity != null){
			...
			try {
				sp.getIPersistentGratuity().lockWrite(gratuity);
		...
		try {
			sp.getIPersistentGratuity().lockWrite(newGratuity);
