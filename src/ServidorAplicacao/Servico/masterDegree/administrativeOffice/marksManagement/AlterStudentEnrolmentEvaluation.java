...
public class AlterStudentEnrolmentEvaluation implements IService
{
     ...
     */
    public AlterStudentEnrolmentEvaluation()
    {
    }
            ...
            throws FenixServiceException
    {
        ...
        try
        {
                    ...
                    || (infoEnrolmentEvaluation.getGrade().length() < 0))
            {
                ...
                IEnrolmentEvaluation enrolmentEvaluationCopy = new EnrolmentEvaluation();
                enrolmentEvaluationCopy.setIdInternal(enrolmentEvaluationCode);
                enrolmentEvaluationCopy = (IEnrolmentEvaluation) persistentEnrolmentEvaluation
                        .readByOId(enrolmentEvaluationCopy, false);

                //enrolmentEvaluationCopy =
                //	 Cloner.copyInfoEnrolmentEvaluation2IEnrolmentEvaluation(infoEnrolmentEvaluation);
                ISuportePersistente persistentSuport = SuportePersistenteOJB.getInstance();
                //IPersistentEnrolmentEvaluation enrollmentEvaluationDAO =
                // persistentSuport.getIPersistentEnrolmentEvaluation();
                IEnrolmentEvaluation enrolmentEvaluation = new EnrolmentEvaluation();
                persistentEnrolmentEvaluation.simpleLockWrite(enrolmentEvaluation);

                enrolmentEvaluation.setEnrolment(enrolmentEvaluationCopy.getEnrolment());
                ...
                enrolmentEvaluation.setObservation(enrolmentEvaluationCopy.getObservation());
            ...
            else
            {
                ...
                else
                {
                    ...
                    iEnrolmentEvaluation = (IEnrolmentEvaluation) persistentEnrolmentEvaluation
                            .readByOId(iEnrolmentEvaluation, false);
                    ...
                    if (!enrolmentEvaluation.getGrade().equals(iEnrolmentEvaluation.getGrade()))
                    {
                        try
                        {
                            ...
                            iEnrolmentEvaluation.getEnrolment()
                                    .setEnrolmentState(EnrolmentState.APROVED);
                        }
                        catch (NumberFormatException e)
                        {
                            if (enrolmentEvaluation.getGrade().equals("RE"))
                                iEnrolmentEvaluation.getEnrolment().setEnrolmentState(
                        ...
                        enrolment.setCurricularCourse(iEnrolmentEvaluation.getEnrolment()
                                .getCurricularCourse());
                        //enrolment.setCurricularCourseScope(
                        //    iEnrolmentEvaluation.getEnrolment().getCurricularCourseScope());
                        enrolment.setEnrolmentEvaluationType(iEnrolmentEvaluation.getEnrolment()
                                .getEnrolmentEvaluationType());
                        enrolment.setExecutionPeriod(iEnrolmentEvaluation.getEnrolment()
                                .getExecutionPeriod());
                        enrolment.setStudentCurricularPlan(iEnrolmentEvaluation.getEnrolment()
                                .getStudentCurricularPlan());
                        enrolment.setIdInternal(iEnrolmentEvaluation.getEnrolment().getIdInternal());
                        enrolment.setEnrolmentState(iEnrolmentEvaluation.getEnrolment()
                                .getEnrolmentState());
