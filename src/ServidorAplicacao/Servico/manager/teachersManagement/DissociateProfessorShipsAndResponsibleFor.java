...
public class DissociateProfessorShipsAndResponsibleFor implements IServico {
    private static DissociateProfessorShipsAndResponsibleFor service = new DissociateProfessorShipsAndResponsibleFor();
    ...
    public HashMap run(Integer teacherNumber, List professorships,
            List responsibleFors) throws FenixServiceException {
        ...
        try {
            ...
            IPersistentSupportLesson persistentSupportLesson = sp
            ...
            if (professorships != null && responsibleFors != null) {
                ...
                while (iterProfessorships.hasNext()) {
                    Integer professorshipId = (Integer) iterProfessorships
                            .next();

                    IProfessorship professorship = (IProfessorship) persistentProfessorship
                            .readByOID(Professorship.class, professorshipId);
                ...
                while (iterResponsibleFor.hasNext()) {
                    Integer responsibleForId = (Integer) iterResponsibleFor
                            .next();
                ...
                while (iterProfessorships.hasNext()) {
                    IProfessorship professorship = (IProfessorship) iterProfessorships
                            .next();
                    ...
                    if ((shiftProfessorships == null || shiftProfessorships
                            .size() == 0)
                ...
                while (iterResponsibleFor.hasNext()) {
                    IResponsibleFor responsibleFor = (IResponsibleFor) iterResponsibleFor
                            .next();
        ...
        if (professorshipsWithSupportLessons.size() > 0
                || professorshipsWithShifts.size() > 0) {
            professorshipsNotRemoved.put(new String("supportLessons"),
                    professorshipsWithSupportLessons);
            professorshipsNotRemoved.put(new String("shifts"),
                    professorshipsWithShifts);
        }
