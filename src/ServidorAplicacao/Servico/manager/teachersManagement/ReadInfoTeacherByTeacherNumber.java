 ...
 *  
 */
public class ReadInfoTeacherByTeacherNumber implements IServico
{
	private static ReadInfoTeacherByTeacherNumber service = new ReadInfoTeacherByTeacherNumber();
	/**
	 * The singleton access method of this class.
	 */
	public static ReadInfoTeacherByTeacherNumber getService()
	{
		return service;
	}
