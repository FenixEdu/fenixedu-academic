...
public class CreateUpdateDeleteEnrollmentsInCurrentStudentCurricularPlans extends CreateUpdateDeleteEnrollments implements IService
{
	...
	public CreateUpdateDeleteEnrollmentsInCurrentStudentCurricularPlans()
	{
		try
		{
		...
		this.maximumNumberOfElementsToConsider = 500;
	}
...
//					this.enrollmentEvaluationsCreated.clear();
		...
		throws Throwable
	{
		...
		while (iterator.hasNext())
		{
			...
			if (mwEnrolment.getCurricularcoursesemester().equals(this.executionPeriod.getSemester()))
			{
		...
		throws Throwable
	{
		...
		{
			super.out.println("[ERROR 104] the degree has no execution in [" + executionPeriod.getExecutionYear().getYear() + "]!");
			return null;
		} else
		{
