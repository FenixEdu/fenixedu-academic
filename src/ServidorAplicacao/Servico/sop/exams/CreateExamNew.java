...
public class CreateExamNew implements IServico
{
        ...
        throws FenixServiceException
    {
        ...
        try
        {
            ...
            Period period = new Period(examDate, examDate);
            try
            {
            ...
            try
            {
                for (int i = 0; i < roomIDArray.length; i++)
                {
                    ...
                    roomsList.add(sala);
                    DiaSemana dia = new DiaSemana(examDate.get(Calendar.DAY_OF_WEEK));

                    RoomOccupation roomOccupation =
                        new RoomOccupation(sala, examStartTime, examEndTime, dia);
