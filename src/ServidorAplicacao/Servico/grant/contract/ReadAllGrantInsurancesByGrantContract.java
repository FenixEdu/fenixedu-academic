 ...
 * @author Pica
 */
public class ReadAllGrantInsurancesByGrantContract implements IService {

    public ReadAllGrantInsurancesByGrantContract() {
    }
	...
	public List run(Integer idContract) throws FenixServiceException
	{
		...
		try
		{
			...
			insurances = persistentGrantInsurance.readGrantInsuranceByGrantContract(idContract);
		}
