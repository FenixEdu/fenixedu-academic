...
public class EditGrantContractRegime extends EditDomainObjectService {
    ...
    protected IDomainObject readObjectByUnique(IDomainObject domainObject,
        ...
        return persistentGrantContractRegime.readByOID(
                GrantContractRegime.class, grantContractRegime.getIdInternal());
    }

    public void run(InfoGrantContractRegime infoGrantContractRegime)
    ...
    private IGrantContractRegime copyInfoGrantContractRegime2IGrantContractRegime(
        ...
        if (infoGrantContractRegime != null) {
            ...
            grantContractRegime.setIdInternal(infoGrantContractRegime
                    .getIdInternal());
            ...
            if (infoGrantContractRegime.getInfoTeacher() != null) {
                ...
                teacher = Cloner
                        .copyInfoTeacher2Teacher(infoGrantContractRegime
                                .getInfoTeacher());
                grantContractRegime.setTeacher(teacher);
            }

            IGrantContract grantContract = null;
            grantContract = Cloner
                    .copyInfoGrantContract2IGrantContract(infoGrantContractRegime
    ...
    protected void doAfterLock(IDomainObject domainObjectLocked,
        ...
        if (infoGrantContractRegime.getState().equals(new Integer(1))) //Active
                                                                       // Contract
                                                                       // Regime
        {
            ...
            try {
                ...
                grantContract.setIdInternal(infoGrantContractRegime
                ...
                persistentGrantOrientationTeacher
                        .simpleLockWrite(grantOrientationTeacher);
                ...
                if (infoGrantContractRegime.getInfoTeacher() != null) {
                    ...
                    grantOrientationTeacher.setOrientationTeacher(Cloner
                            .copyInfoTeacher2Teacher(infoGrantContractRegime
                                    .getInfoTeacher()));
                } else //if grantOrientationTeacher is not filled in
                       // grantContractRegime
                {
                    //Copy old values from grant orientation teacher do grant
                    // contract regime
                    grantContractRegime.setTeacher(grantOrientationTeacher
                            .getOrientationTeacher());
                }
                grantOrientationTeacher.setBeginDate(infoGrantContractRegime
                        .getDateBeginContract());
                grantOrientationTeacher.setEndDate(infoGrantContractRegime
                        .getDateEndContract());

            } catch (ExcepcaoPersistencia persistentException) {
                throw new FenixServiceException(persistentException
                        .getMessage());
            }
        }
