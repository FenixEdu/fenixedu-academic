...
public class ReadOtherCoursesWithShifts implements IServico
{
    ...
    /**
	 * @author tfc130 :FIXME: é preciso dar outras voltas... Isto assim ficou
	 *         mal depois das alterações
	 */
    public Object run(InfoStudent infoStudent)
    {
        ...
        try
        {
            ...
            for (int i = 0; i < ldE.size(); i++)
            {
				 ...
				 * iEC.getSigla(),
				 * iEC.getInfoLicenciaturaExecucao().getAnoLectivo(), iEC
				 * .getInfoLicenciaturaExecucao() .getInfoLicenciatura()
				 */
