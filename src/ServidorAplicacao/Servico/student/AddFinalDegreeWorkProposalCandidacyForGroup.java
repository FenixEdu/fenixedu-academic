...
public class AddFinalDegreeWorkProposalCandidacyForGroup implements IService
{
    	...
    	throws ExcepcaoPersistencia, FenixServiceException
    {
        ...
        IProposal proposal = (IProposal) persistentFinalDegreeWork.readByOID(Proposal.class, proposalOID);
        if (group != null
                && group.getGroupProposals() != null
                /*&& !CollectionUtils.exists(group.getStudents(), )*/)
        {
            IScheduleing scheduleing = persistentFinalDegreeWork.readFinalDegreeWorkScheduleing(group.getExecutionDegree().getIdInternal());
            ...
            {
                throw new MaximumNumberOfProposalCandidaciesPerGroupReachedException(scheduleing.getMaximumNumberOfProposalCandidaciesPerGroup().toString());
            }
