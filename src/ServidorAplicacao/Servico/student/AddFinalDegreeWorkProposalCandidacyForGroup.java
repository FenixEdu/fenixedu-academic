...
public class AddFinalDegreeWorkProposalCandidacyForGroup implements IService {
    ...
    public boolean run(Integer groupOID, Integer proposalOID)
        ...
        IProposal proposal = (IProposal) persistentFinalDegreeWork.readByOID(
                Proposal.class, proposalOID);
        ...
        /* && !CollectionUtils.exists(group.getStudents(), ) */) {
            ...
            if (scheduleing == null
                ...
                throw new MaximumNumberOfProposalCandidaciesPerGroupUndefinedException();
                    ...
                    .getMaximumNumberOfProposalCandidaciesPerGroup().intValue() <= group
                    .getGroupProposals().size()) {
                throw new MaximumNumberOfProposalCandidaciesPerGroupReachedException(
                        scheduleing
                                .getMaximumNumberOfProposalCandidaciesPerGroup()
                                .toString());
            }
            if (scheduleing == null
                    || scheduleing.getMinimumNumberOfStudents() == null) {
                throw new MinimumNumberOfStudentsUndefinedException();
            } else if (scheduleing.getMinimumNumberOfStudents().intValue() > group
                    .getGroupStudents().size()) {
                throw new MinimumNumberOfStudentsNotReachedException(
                        scheduleing.getMinimumNumberOfStudents().toString());
            }
            ...
            groupProposal.setOrderOfPreference(new Integer(group
                    .getGroupProposals().size() + 1));
            return true;
        }
    ...
    public class MaximumNumberOfProposalCandidaciesPerGroupUndefinedException
    ...
    public class MaximumNumberOfProposalCandidaciesPerGroupReachedException
            extends FenixServiceException {
    ...
    public class MinimumNumberOfStudentsUndefinedException extends
        ...
        public MinimumNumberOfStudentsUndefinedException(String message,
                Throwable cause) {
            super(message, cause);
        }
    }

    public class MinimumNumberOfStudentsNotReachedException extends
            FenixServiceException {
        ...
        public MinimumNumberOfStudentsNotReachedException(String message,
                Throwable cause) {
            super(message, cause);
        }
    }
