				...
				while (studentTestQuestionIt.hasNext()) {
					...
					while (studentIt.hasNext()) {
						...
						if (persistentSuport
							...
							studentTestQuestion.setDistributedTest(
								distributedTest);
							...
							try {
								studentTestQuestion.setOptionShuffle(p.shuffleQuestionOptions(studentTestQuestion.getQuestion().getXmlFile(),path));
							} catch (Exception e) {
