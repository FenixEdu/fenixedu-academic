...
public class ValidateSubmitMarks implements IServico
{
    ...
    private void verifyYetSubmitMarks(IEnrolment enrolment) throws FenixServiceException
    {
        ...
        try
        {
            ...
            {
                List enrolmentEvaluationListWithGrade =
                    (List) CollectionUtils.select(enrolmentEvaluationList, new Predicate()
                {
                    public boolean evaluate(Object obj)
                    {
                        ...
                        return (
                            enrolmentEvaluation.getGrade() != null
                                && enrolmentEvaluation.getGrade().length() > 0);
                    }
                });
