    ...
    private static ReadStudentsByStudentGroupID _servico = new ReadStudentsByStudentGroupID();
         ...
         public List run(Integer executionCourseId,Integer groupId) throws FenixServiceException {
           ...
           try {
             ...
             IStudentGroup studentGroup = (IStudentGroup) persistentStudentGroup.readByOID(Dominio.StudentGroup.class,groupId);
             List studentGroupAttendacies = persistentStudentGroupAttend.readAllByStudentGroup(studentGroup);
             for (Iterator iter= studentGroupAttendacies.iterator(); iter.hasNext();)
			{
                ...
                IStudent student = (IStudent) persistentStudent.readByOID(Dominio.Student.class,studentID);
