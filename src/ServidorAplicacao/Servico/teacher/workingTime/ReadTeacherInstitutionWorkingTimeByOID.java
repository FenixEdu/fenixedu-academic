...
{
    private static ReadTeacherInstitutionWorkingTimeByOID service =
        new ReadTeacherInstitutionWorkingTimeByOID();
    ...
    {
        return Cloner.copyITeacherInstitutionWorkingTime2InfoTeacherInstitutionWorkTime(
