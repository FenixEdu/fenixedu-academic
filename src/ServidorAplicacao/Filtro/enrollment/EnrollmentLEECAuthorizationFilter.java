 ...
 *  
 */
public class EnrollmentLEECAuthorizationFilter extends
    ...
    private IStudent readStudent(IUserView id, ISuportePersistente sp)
            throws ExcepcaoPersistencia {
    ...
    private IStudent readStudent(Object[] arguments, ISuportePersistente sp)
            throws ExcepcaoPersistencia {
        IStudentCurricularPlan studentCurricularPlan = readStudentCurricularPlan(
                arguments, sp);
     ...
     * @return
     */
    private ITutor verifyStudentWithTutor(IStudent student,
    ...
    private ITeacher readTeacher(IUserView id, ISuportePersistente sp)
            throws ExcepcaoPersistencia {
