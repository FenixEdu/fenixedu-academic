...
public class ExecutionCourseSiteComponentBuilder {
	...
	public ISiteComponent getComponent(ISiteComponent component, ISite site, ISiteComponent commonComponent, Integer sectionIndex, Integer curricularCourseId) throws FenixServiceException {
		...
		if (component instanceof InfoSiteCommon) {
			...
			return getInfoSiteCurricularCoursesAndAssociatedShiftsAndClasses((InfoSiteCurricularCoursesAndAssociatedShiftsAndClasses) component, site);
	...
	private ISiteComponent getInfoSiteSummaries(InfoSiteSummaries component, ISite site) throws FenixServiceException {
		try {
			...
			List summaries = persistentSummary.readByExecutionCourse(executionCourse);
	 ...
	 * @return
	 */
	private ISiteComponent getInfoSiteSection(InfoSiteSection component, ISite site, InfoSiteCommon commonComponent, Integer sectionIndex) throws FenixServiceException {
	 ...
	 * @return
	 */
	private ISiteComponent getInfoSiteAssociatedCurricularCourses(InfoSiteAssociatedCurricularCourses component, ISite site) throws FenixServiceException {
	...
	private List readLecturingTeachers(ISuportePersistente persistentSupport, IDisciplinaExecucao executionCourse) throws ExcepcaoPersistencia {
	...
	private List readResponsibleTeachers(ISuportePersistente persistentSupport, IDisciplinaExecucao executionCourse) throws ExcepcaoPersistencia {
	...
	private InfoAnnouncement readLastAnnouncement(ISuportePersistente persistentSupport, IDisciplinaExecucao executionCourse) throws ExcepcaoPersistencia {
	...
	private InfoSiteCurricularCoursesAndAssociatedShiftsAndClasses getInfoSiteCurricularCoursesAndAssociatedShiftsAndClasses(
		...
		try {
			...
			if (shifts == null || shifts.isEmpty()) {
				...
				for (int i = 0; i < shifts.size(); i++) {
					ITurno shift = (ITurno) shifts.get(i);
					shiftWithAssociatedClassesAndLessons = new InfoShiftWithAssociatedInfoClassesAndInfoLessons(Cloner.copyShift2InfoShift(shift), null, null);
