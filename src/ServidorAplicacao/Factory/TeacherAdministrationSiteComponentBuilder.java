...
public class TeacherAdministrationSiteComponentBuilder {
    ...
    public List readExecutionCourseProjects(Integer executionCourseCode) throws ExcepcaoInexistente,
        ...
        try {
            ...
            while (iterator.hasNext()) {
                //projects
                //.add(Cloner
                //.copyIGroupProperties2InfoGroupProperties((IGroupProperties)
                // iterator
                //.next()));
                projects.add(InfoGroupProperties.newInfoFromDomain((IGroupProperties) iterator.next()));
            }
        } catch (ExcepcaoPersistencia e) {
            e.printStackTrace();
                ...
                while (iter.hasNext()) {
                    ...
                    if (allStudentGroups.size() != 0) {
                        ...
                        while (iterGroups.hasNext()) {
                            ...
                            //.copyIStudentGroup2InfoStudentGroup((IStudentGroup)
                            // iterGroups
                            //.next());
    ...
    private ISiteComponent getInfoSiteStudentGroup(InfoSiteStudentGroup component,
        ...
        while (iter.hasNext()) {
            ...
            //.copyIStudentGroupAttend2InfoStudentGroupAttend((IStudentGroupAttend)
            // iter
            //.next());
    ...
    private ISiteComponent getInfoSiteShifts(InfoSiteShifts component, Integer groupPropertiesCode,
                ...
                for (int i = 0; i < shifts.size(); i++) {
                    ...
                    if (strategy.checkShiftType(groupProperties, shift)) {
                        ...
                        for (int j = 0; j < lessons.size(); j++)
                            ...
                            //.get(j)));
                            infoLessons.add(InfoLesson.newInfoFromDomain((IAula) lessons.get(j)));
                        ...
                        for (int j = 0; j < classesShifts.size(); j++)
                            ...
                            //.get(j)).getTurma()));
                            infoClasses.add(InfoClass.newInfoFromDomain(((ITurmaTurno) classesShifts
                                    .get(j)).getTurma()));
        ...
        component.setInfoExecutionYearName(executionCourse.getExecutionPeriod().getExecutionYear()
                .getYear());
        return component;
    }
