...
public class TeacherAdministrationSiteComponentBuilder
{
        ...
        throws FenixServiceException
    {
        ...
        else if (component instanceof InfoSiteEvaluationExecutionCourses)
        {
            return getInfoSiteEvaluationExecutionCourses(
                (InfoSiteEvaluationExecutionCourses) component,
                site,
                (Integer) obj1);
        }
        ...
        throws FenixServiceException
    {
        try
        {
            ...
            IAnnouncement iAnnouncement =
                (IAnnouncement) sp.getIPersistentAnnouncement().readByOId(announcement, false);
        ...
        try
        {
            ...
            while (iter.hasNext())
            {
                ...
                if (curriculum != null)
                {
                    ...
                    infoCurriculum.setInfoCurricularCourse(
                        Cloner.copyCurricularCourse2InfoCurricularCourse(curricularCourse));
        ...
        throws FenixServiceException
    {
        try
        {
            ...
            ISection iSuperiorSection =
                (ISection) persistentSection.readByOId(new Section(sectionCode), false);
        ...
        throws FenixServiceException
    {
        ...
        List infoGroupPropertiesList =
            readExecutionCourseProjects(site.getExecutionCourse().getIdInternal());
        ...
        throws ExcepcaoInexistente, FenixServiceException
    {
        ...
        try
        {
            ...
            List executionCourseProjects =
                sp.getIPersistentGroupProperties().readAllGroupPropertiesByExecutionCourse(
                    executionCourse);
            ...
            {
                projects.add(
                    Cloner.copyIGroupProperties2InfoGroupProperties((IGroupProperties) iterator.next()));
    ...
    private ISiteComponent getInfoSiteShiftsAndGroups(
        InfoSiteShiftsAndGroups component,
        ...
        throws FenixServiceException
    {
        ...
        while (iter.hasNext())
        {
            ...
            infoStudentGroupAttend =
                Cloner.copyIStudentGroupAttend2InfoStudentGroupAttend((IStudentGroupAttend) iter.next());

            infoSiteStudentInformation.setNumber(
                infoStudentGroupAttend.getInfoAttend().getAluno().getNumber());

            infoSiteStudentInformation.setName(
                infoStudentGroupAttend.getInfoAttend().getAluno().getInfoPerson().getNome());

            infoSiteStudentInformation.setEmail(
                infoStudentGroupAttend.getInfoAttend().getAluno().getInfoPerson().getEmail());

            infoSiteStudentInformation.setUsername(
                infoStudentGroupAttend.getInfoAttend().getAluno().getInfoPerson().getUsername());
    ...
    private ISiteComponent getInfoSiteGroupProperties(
        InfoSiteGroupProperties component,
        Integer groupPropertiesCode)
        throws FenixServiceException
    {
        ...
        try
        {
            ...
            else
            {
                ...
                IGroupEnrolmentStrategy strategy =
                    enrolmentGroupPolicyStrategyFactory.getGroupEnrolmentStrategyInstance(
                        groupProperties);
