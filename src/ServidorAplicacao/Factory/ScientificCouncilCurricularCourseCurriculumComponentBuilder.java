...
public class ScientificCouncilCurricularCourseCurriculumComponentBuilder {
	...
	private static ScientificCouncilCurricularCourseCurriculumComponentBuilder instance =
		null;
	...
	public static ScientificCouncilCurricularCourseCurriculumComponentBuilder getInstance() {
		if (instance == null) {
			instance =
				new ScientificCouncilCurricularCourseCurriculumComponentBuilder();
		}
		return instance;
	}
	 ...
	 * @return
	 */
	private ISiteComponent getInfoSiteCurriculum(InfoSiteCurriculum component, Integer curricularCourseId) throws FenixServiceException {
		try {
			...
			component.setInfoCurricularCourse(Cloner.copyCurricularCourse2InfoCurricularCourse(curricularCourse));
