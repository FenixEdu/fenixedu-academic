...
import net.sourceforge.fenixedu.presentationTier.Action.publico.ViewResearchUnitSiteDA;
...
@Mapping(module = "publico", path = "/researchSite/viewResearchUnitSiteResearch")
@Forwards({ @Forward(name = "showPublications", path = "/publico/researchUnitSite/showPublications.jsp", tileProperties = @Tile(
        extend = "definition.public.researchUnit")) })
public class ResearchUnitSiteResearchDA extends ViewResearchUnitSiteDA {
