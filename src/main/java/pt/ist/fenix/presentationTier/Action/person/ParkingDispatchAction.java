package pt.ist.fenix.presentationTier.Action.person;
...
import pt.ist.fenix.applicationTier.Servico.person.parking.AcceptRegulation;
import pt.ist.fenix.applicationTier.Servico.person.parking.CreateParkingParty;
import pt.ist.fenix.applicationTier.Servico.person.parking.RenewUnlimitedParkingRequest;
import pt.ist.fenix.domain.parking.DocumentDeliveryType;
import pt.ist.fenix.domain.parking.ParkingDocumentState;
import pt.ist.fenix.domain.parking.ParkingFile;
...
import pt.ist.fenix.domain.parking.ParkingRequest.ParkingRequestFactoryCreator;
import pt.ist.fenix.domain.parking.ParkingRequest.ParkingRequestFactoryEditor;
...
@Forwards(value = {
        @Forward(name = "prepareParking", path = "/person/parking/parkingRequest.jsp", tileProperties = @Tile(
