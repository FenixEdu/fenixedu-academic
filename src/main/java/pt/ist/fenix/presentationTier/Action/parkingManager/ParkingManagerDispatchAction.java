package pt.ist.fenix.presentationTier.Action.parkingManager;
...
import pt.ist.fenix.applicationTier.Servico.parking.SearchPartyCarPlate;
import pt.ist.fenix.applicationTier.Servico.parking.UpdateParkingParty;
import pt.ist.fenix.dataTransferObject.parking.ParkingPartyBean;
import pt.ist.fenix.dataTransferObject.parking.SearchParkingPartyBean;
import pt.ist.fenix.dataTransferObject.parking.VehicleBean;
import pt.ist.fenix.domain.parking.ParkingGroup;
import pt.ist.fenix.domain.parking.ParkingParty;
import pt.ist.fenix.domain.parking.ParkingPartyHistory;
import pt.ist.fenix.domain.parking.ParkingRequest;
import pt.ist.fenix.domain.parking.ParkingRequestSearch;
import pt.ist.fenix.domain.parking.ParkingRequestState;
...
public class ParkingManagerDispatchAction extends FenixDispatchAction {
    ...
    public ActionForward prepareSearchParty(ActionMapping mapping, ActionForm actionForm, HttpServletRequest request,
            HttpServletResponse response) throws Exception {
        request.setAttribute("SearchParkingPartyBean", new SearchParkingPartyBean());
    ...
    public ActionForward showParkingPartyRequests(ActionMapping mapping, ActionForm actionForm, HttpServletRequest request,
        ...
        IViewState viewState = RenderUtils.getViewState("SearchParkingPartyBean");
        ...
        if (SearchParkingPartyBean != null) {
            ...
            List<Party> partyList =
                    SearchPartyCarPlate.run(SearchParkingPartyBean.getPartyName(), SearchParkingPartyBean.getCarPlateNumber(),
                            SearchParkingPartyBean.getParkingCardNumber());
            request.setAttribute("SearchParkingPartyBean", SearchParkingPartyBean);
    ...
    private void setupParkingRequests(HttpServletRequest request, Party party, String carPlateNumber, Long parkingCardNumber)
        ...
        request.setAttribute("SearchParkingPartyBean", new SearchParkingPartyBean(party, carPlateNumber, parkingCardNumber));
    }
