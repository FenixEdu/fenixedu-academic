    ...
    private static void initialize() {
     ...
     // DEBUG: tldNode x823 1198295917755 null
        ...
        x823.setNormalizedName(MultiLanguageString.importFromString("en4:rootpt4:raiz"));
           ...
           Module x829 = new Module(MultiLanguageString.importFromString("pt8:Doc�ncia"),"/teacher");
           x823.addChild(x829);
           ...
           x829.setVisible(true);
              Functionality x828 = new Functionality(MultiLanguageString.importFromString("pt8:Doc�ncia"));
              x829.addChild(x828);
              x828.setTitle(MultiLanguageString.importFromString("pt8:Doc�ncia"));
           ...
           Module x835 = new Module(MultiLanguageString.importFromString("pt18:Gest�o de Recursos"),"/resourceAllocationManager");
           x823.addChild(x835);
           ...
           x835.setVisible(true);
              Functionality x834 = new Functionality(MultiLanguageString.importFromString("pt18:Gest�o de Recursos"));
              x835.addChild(x834);
              x834.setTitle(MultiLanguageString.importFromString("pt18:Gest�o de Recursos"));
           ...
           Module x838 = new Module(MultiLanguageString.importFromString("pt36:Portal do Candidato a P�s-Gradua��es"),"/masterDegreeCandidate");
           x823.addChild(x838);
           ...
           x838.setVisible(true);
              Functionality x837 = new Functionality(MultiLanguageString.importFromString("pt36:Portal do Candidato a P�s-Gradua��es"));
              x838.addChild(x837);
              x837.setTitle(MultiLanguageString.importFromString("pt36:Portal do Candidato a P�s-Gradua��es"));
           ...
           Module x841 = new Module(MultiLanguageString.importFromString("pt35:Portal de Servi�os de P�s-Gradua��o"),"/masterDegreeAdministrativeOffice");
           x823.addChild(x841);
           ...
           x841.setVisible(true);
              Functionality x840 = new Functionality(MultiLanguageString.importFromString("pt35:Portal de Servi�os de P�s-Gradua��o"));
              x841.addChild(x840);
              x840.setTitle(MultiLanguageString.importFromString("pt35:Portal de Servi�os de P�s-Gradua��o"));
           ...
           Module x847 = new Module(MultiLanguageString.importFromString("pt11:Funcion�rio"),"/employee");
           x823.addChild(x847);
           ...
           x847.setVisible(true);
              Functionality x846 = new Functionality(MultiLanguageString.importFromString("pt11:Funcion�rio"));
              x847.addChild(x846);
              x846.setTitle(MultiLanguageString.importFromString("pt11:Funcion�rio"));
           ...
           Module x851 = new Module(MultiLanguageString.importFromString("pt15:�rea de Pessoal"),"/personnelSection");
           x823.addChild(x851);
           ...
           x851.setVisible(true);
              Module x850 = new Module(MultiLanguageString.importFromString("pt25:Consultas por Funcion�rio"),"/");
              x851.addChild(x850);
              ...
              x850.setVisible(true);
                 ...
                 Functionality x852 = new Functionality(MultiLanguageString.importFromString("pt7:Hor�rio"));
                 x850.addChild(x852);
                 x852.setTitle(MultiLanguageString.importFromString("pt7:Hor�rio"));
                 ...
                 Functionality x853 = new Functionality(MultiLanguageString.importFromString("pt9:Marca��es"));
                 x850.addChild(x853);
                 x853.setTitle(MultiLanguageString.importFromString("pt9:Marca��es"));
                 ...
                 Functionality x854 = new Functionality(MultiLanguageString.importFromString("pt13:Justifica��es"));
                 x850.addChild(x854);
                 x854.setTitle(MultiLanguageString.importFromString("pt13:Justifica��es"));
                 ...
                 Functionality x856 = new Functionality(MultiLanguageString.importFromString("pt6:F�rias"));
                 x850.addChild(x856);
                 x856.setTitle(MultiLanguageString.importFromString("pt6:F�rias"));
                 ...
                 Functionality x858 = new Functionality(MultiLanguageString.importFromString("en13:Vacations Mappt14:Mapa de F�rias"));
                 x850.addChild(x858);
                 x858.setTitle(MultiLanguageString.importFromString("en13:Vacations Mappt14:Mapa de F�rias"));
              ...
              ExpressionGroupAvailability x1614 = new ExpressionGroupAvailability(x850, "assiduousnessSectionStaff || assiduousnessManagers");
              x1614.setTargetGroup(Group.fromString("assiduousnessSectionStaff || assiduousnessManagers"));
              x850.setAvailabilityPolicy(x1614);
              Module x861 = new Module(MultiLanguageString.importFromString("pt21:Todos os Funcion�rios"),"/");
              x851.addChild(x861);
              x861.setTitle(MultiLanguageString.importFromString("pt21:Todos os Funcion�rios"));
              ...
              x861.setVisible(true);
                 Functionality x860 = new Functionality(MultiLanguageString.importFromString("pt20:Inserir Justifica��o"));
                 x861.addChild(x860);
                 x860.setTitle(MultiLanguageString.importFromString("pt20:Inserir Justifica��o"));
              ...
              x864.setVisible(true);
                 Functionality x863 = new Functionality(MultiLanguageString.importFromString("pt8:Hor�rios"));
                 x864.addChild(x863);
                 x863.setTitle(MultiLanguageString.importFromString("pt8:Hor�rios"));
                 ...
                 Functionality x865 = new Functionality(MultiLanguageString.importFromString("pt13:Justifica��es"));
                 x864.addChild(x865);
                 x865.setTitle(MultiLanguageString.importFromString("pt13:Justifica��es"));
                 ...
                 Functionality x866 = new Functionality(MultiLanguageString.importFromString("pt14:Regulariza��es"));
                 x864.addChild(x866);
                 x866.setTitle(MultiLanguageString.importFromString("pt14:Regulariza��es"));
                 ...
                 Functionality x867 = new Functionality(MultiLanguageString.importFromString("pt11:Toler�ncias"));
                 x864.addChild(x867);
                 x867.setTitle(MultiLanguageString.importFromString("pt11:Toler�ncias"));
              ...
              ExpressionGroupAvailability x1616 = new ExpressionGroupAvailability(x864, "assiduousnessSectionStaff || assiduousnessManagers");
              ...
              x871.setVisible(true);
                 ...
                 Functionality x873 = new Functionality(MultiLanguageString.importFromString("pt22:Exportar Justifica��es"));
                 x871.addChild(x873);
                 x873.setTitle(MultiLanguageString.importFromString("pt22:Exportar Justifica��es"));
                 ...
                 Functionality x876 = new Functionality(MultiLanguageString.importFromString("pt15:Exportar F�rias"));
                 x871.addChild(x876);
                 x876.setTitle(MultiLanguageString.importFromString("pt15:Exportar F�rias"));
              ...
              ExpressionGroupAvailability x1617 = new ExpressionGroupAvailability(x871, "assiduousnessSectionStaff || assiduousnessManagers");
              x1617.setTargetGroup(Group.fromString("assiduousnessSectionStaff || assiduousnessManagers"));
              x871.setAvailabilityPolicy(x1617);
              Module x879 = new Module(MultiLanguageString.importFromString("pt12:Fecho do M�s"),"/");
              x851.addChild(x879);
              x879.setTitle(MultiLanguageString.importFromString("pt12:Fecho do M�s"));
              x879.setNormalizedName(MultiLanguageString.importFromString("pt12:fecho-do-mes"));
              x879.setExecutionPath("");
              x879.setVisible(true);
                 Functionality x878 = new Functionality(MultiLanguageString.importFromString("pt21:Fechar M�s e Exportar"));
                 x879.addChild(x878);
                 x878.setTitle(MultiLanguageString.importFromString("pt21:Fechar M�s e Exportar"));
              ...
              Module x882 = new Module(MultiLanguageString.importFromString("pt23:Trabalho Extraordin�rio"),"/");
              x851.addChild(x882);
              x882.setTitle(MultiLanguageString.importFromString("pt23:Trabalho Extraordin�rio"));
              ...
              x882.setVisible(true);
                 Functionality x881 = new Functionality(MultiLanguageString.importFromString("pt19:Inserir Autoriza��o"));
                 x882.addChild(x881);
                 x881.setTitle(MultiLanguageString.importFromString("pt19:Inserir Autoriza��o"));
                 ...
                 Functionality x883 = new Functionality(MultiLanguageString.importFromString("pt16:Ver Autoriza��es"));
                 x882.addChild(x883);
                 x883.setTitle(MultiLanguageString.importFromString("pt16:Ver Autoriza��es"));
                 ...
                 Functionality x886 = new Functionality(MultiLanguageString.importFromString("pt26:Fechar Trab Extraordin�rio"));
                 x882.addChild(x886);
                 x886.setTitle(MultiLanguageString.importFromString("pt27:Fechar Trab. Extraordin�rio"));
                 ...
                 Functionality x887 = new Functionality(MultiLanguageString.importFromString("pt25:Exportar por Funcion�rios"));
                 x882.addChild(x887);
                 x887.setTitle(MultiLanguageString.importFromString("pt25:Exportar por Funcion�rios"));
                 ...
                 x882.addChild(x889);
                 x889.setTitle(MultiLanguageString.importFromString("pt31:Verbete Trabalho Extraordin�rio"));
              ...
              Module x892 = new Module(MultiLanguageString.importFromString("pt5:B�nus"),"/");
              x851.addChild(x892);
              x892.setTitle(MultiLanguageString.importFromString("pt5:B�nus"));
              x892.setNormalizedName(MultiLanguageString.importFromString("pt5:bonus"));
              x892.setExecutionPath("");
              x892.setVisible(true);
                 Functionality x891 = new Functionality(MultiLanguageString.importFromString("pt17:Presta��es Anuais"));
                 x892.addChild(x891);
                 x891.setTitle(MultiLanguageString.importFromString("pt17:Presta��es Anuais"));
                 ...
                 Functionality x893 = new Functionality(MultiLanguageString.importFromString("pt14:Importar B�nus"));
                 x892.addChild(x893);
                 x893.setTitle(MultiLanguageString.importFromString("pt14:Importar B�nus"));
                 ...
                 Functionality x894 = new Functionality(MultiLanguageString.importFromString("pt15:Consultar B�nus"));
                 x892.addChild(x894);
                 x894.setTitle(MultiLanguageString.importFromString("pt15:Consultar B�nus"));
              ...
              Functionality x896 = new Functionality(MultiLanguageString.importFromString("pt17:Sec��o de Pessoal"));
              x851.addChild(x896);
              x896.setTitle(MultiLanguageString.importFromString("pt17:Sec��o de Pessoal"));
              ...
              Module x898 = new Module(MultiLanguageString.importFromString("pt6:F�rias"),"/");
              x851.addChild(x898);
              x898.setTitle(MultiLanguageString.importFromString("pt6:F�rias"));
              ...
              ExpressionGroupAvailability x1621 = new ExpressionGroupAvailability(x898, "assiduousnessSectionStaff || assiduousnessManagers");
              x1621.setTargetGroup(Group.fromString("assiduousnessSectionStaff || assiduousnessManagers"));
              x898.setAvailabilityPolicy(x1621);
              Module x901 = new Module(MultiLanguageString.importFromString("pt11:Comunica��o"),"/");
              x851.addChild(x901);
              ...
              x905.setNormalizedName(MultiLanguageString.importFromString("pt14:interface-giaf"));
                 Functionality x904 = new Functionality(MultiLanguageString.importFromString("pt18:Obter Sal�rio Hora"));
                 x905.addChild(x904);
                 x904.setTitle(MultiLanguageString.importFromString("pt18:Obter Sal�rio Hora"));
                 ...
                 Functionality x906 = new Functionality(MultiLanguageString.importFromString("pt30:Inserir Dias de F�rias por A17"));
                 x905.addChild(x906);
                 x906.setTitle(MultiLanguageString.importFromString("pt30:Inserir Dias de F�rias por A17"));
                 ...
                 Functionality x907 = new Functionality(MultiLanguageString.importFromString("pt23:Situa��es Profissionais"));
                 x905.addChild(x907);
                 x907.setTitle(MultiLanguageString.importFromString("pt23:Situa��es Profissionais"));
                 ...
                 Functionality x909 = new Functionality(MultiLanguageString.importFromString("pt23:Equipara��es a Bolseiro"));
                 x905.addChild(x909);
                 x909.setTitle(MultiLanguageString.importFromString("pt23:Equipara��es a Bolseiro"));
                 ...
                 Functionality x910 = new Functionality(MultiLanguageString.importFromString("pt20:Dispensas de Servi�o"));
                 x905.addChild(x910);
                 x910.setTitle(MultiLanguageString.importFromString("pt20:Dispensas de Servi�o"));
              ...
              ExpressionGroupAvailability x1626 = new ExpressionGroupAvailability(x905, "assiduousnessSectionStaff || assiduousnessManagers");
           ...
           x914.setVisible(true);
              Functionality x913 = new Functionality(MultiLanguageString.importFromString("pt16:P�gina Principal"));
              x914.addChild(x913);
              ...
              x916.setVisible(true);
                 ...
                 Functionality x917 = new Functionality(MultiLanguageString.importFromString("pt16:Gest�o de Avisos"));
                 x916.addChild(x917);
                 ...
                 Functionality x918 = new Functionality(MultiLanguageString.importFromString("pt16:Gest�o de Boards"));
                 x916.addChild(x918);
              ...
              Module x921 = new Module(MultiLanguageString.importFromString("pt34:Gest�o da Estrutura Organizacional"),"/");
              x914.addChild(x921);
              ...
              x921.setVisible(true);
                 Functionality x920 = new Functionality(MultiLanguageString.importFromString("pt27:Gest�o de Unidades e Cargos"));
                 x921.addChild(x920);
                 ...
                 Functionality x923 = new Functionality(MultiLanguageString.importFromString("en20:Unit Site Managementpt26:Gest�o de Sites de Unidade"));
                 x921.addChild(x923);
                 ...
                 Module x925 = new Module(MultiLanguageString.importFromString("pt27:Gest�o de Unidades e Cargos"),"/organizationalStructureManagament");
                 x921.addChild(x925);
              ...
              Module x938 = new Module(MultiLanguageString.importFromString("pt29:Gest�o da Estrutura de Ensino"),"/");
              x914.addChild(x938);
              ...
              x938.setVisible(true);
                 ...
                 Functionality x939 = new Functionality(MultiLanguageString.importFromString("pt23:Compet�ncia Pr�-Bolonha"));
                 x938.addChild(x939);
                 ...
                 Functionality x941 = new Functionality(MultiLanguageString.importFromString("pt20:Compet�ncias Bolonha"));
                 x938.addChild(x941);
                 ...
                 x944.setVisible(false);
                    ...
                    x947.setVisible(true);
                       ...
                       x951.setVisible(true);
                          ...
                          Functionality x953 = new Functionality(MultiLanguageString.importFromString("pt15:Gest�o de Ramos"));
                          x951.addChild(x953);
                          ...
                          Functionality x954 = new Functionality(MultiLanguageString.importFromString("pt44:Gest�o de Grupos de Disciplinas Curriculares"));
                          x951.addChild(x954);
                          ...
                          Module x956 = new Module(MultiLanguageString.importFromString("pt22:Gest�o de Preced�ncias"),"/");
                          x951.addChild(x956);
                          ...
                          x956.setVisible(true);
                             Functionality x955 = new Functionality(MultiLanguageString.importFromString("pt25:Criar Preced�ncia Simples"));
                             x956.addChild(x955);
                             ...
                             Functionality x957 = new Functionality(MultiLanguageString.importFromString("pt31:Criar Conjun��o de Preced�ncias"));
                             x956.addChild(x957);
                             ...
                             Functionality x958 = new Functionality(MultiLanguageString.importFromString("pt18:Apagar Preced�ncia"));
                             x956.addChild(x958);
                          ...
                          x961.setVisible(true);
                             ...
                             Functionality x962 = new Functionality(MultiLanguageString.importFromString("pt14:Inserir �mbito"));
                             x961.addChild(x962);
                             ...
                             Functionality x963 = new Functionality(MultiLanguageString.importFromString("en30:Editing Curricular Informationpt31:Edi��o de Informa��o Curricular"));
                             x961.addChild(x963);
                             x963.setNormalizedName(MultiLanguageString.importFromString("en30:editing-curricular-informationpt31:edicao-de-informacao-curricular"));
                             ...
                             Functionality x965 = new Functionality(MultiLanguageString.importFromString("pt13:Editar �mbito"));
                             x961.addChild(x965);
                             ...
                             Functionality x966 = new Functionality(MultiLanguageString.importFromString("pt14:Inserir �mbito"));
                             x961.addChild(x966);
                             ...
                             Functionality x967 = new Functionality(MultiLanguageString.importFromString("pt15:Terminar �mbito"));
                             x961.addChild(x967);
                             ...
                             Functionality x968 = new Functionality(MultiLanguageString.importFromString("pt13:Apagar �mbito"));
                             x961.addChild(x968);
                             ...
                             Functionality x969 = new Functionality(MultiLanguageString.importFromString("pt27:Visualizar todos os �mbitos"));
                             x961.addChild(x969);
                             ...
                             Module x971 = new Module(MultiLanguageString.importFromString("pt28:Associar disciplina execu��o"),"/");
                             x961.addChild(x971);
                             ...
                             x971.setVisible(true);
                                Functionality x970 = new Functionality(MultiLanguageString.importFromString("pt28:Escolher Periodo de Execu��o"));
                                x971.addChild(x970);
                                ...
                                Functionality x972 = new Functionality(MultiLanguageString.importFromString("pt28:Escolher Disciplina Execu��o"));
                                x971.addChild(x972);
                             ...
                             x975.setVisible(true);
                                ...
                                Functionality x976 = new Functionality(MultiLanguageString.importFromString("pt37:Associar docente n�o vinculado ao IST"));
                                x975.addChild(x976);
                                ...
                                Functionality x977 = new Functionality(MultiLanguageString.importFromString("pt18:Guardar Altera��es"));
                                x975.addChild(x977);
                 ...
                 Module x984 = new Module(MultiLanguageString.importFromString("pt23:Compet�ncia Pr�-Bolonha"),"/");
                 x938.addChild(x984);
                 ...
                 x984.setVisible(false);
                    Functionality x983 = new Functionality(MultiLanguageString.importFromString("pt37:Inserir-Editar Disciplina Compet�ncia"));
                    x984.addChild(x983);
                    ...
                    Functionality x985 = new Functionality(MultiLanguageString.importFromString("pt33:Criar Nova Disciplina Compet�ncia"));
                    x984.addChild(x985);
                 ...
                 Module x988 = new Module(MultiLanguageString.importFromString("pt20:Compet�ncias Bolonha"),"/bolonha/competenceCourses/");
                 x938.addChild(x988);
                 ...
                 x988.setVisible(false);
                    Functionality x987 = new Functionality(MultiLanguageString.importFromString("pt26:Ver Disciplina Compet�ncia"));
                    x988.addChild(x987);
                    ...
                    Functionality x989 = new Functionality(MultiLanguageString.importFromString("pt29:Editar Disciplina Compet�ncia"));
                    x988.addChild(x989);
                    ...
                    Functionality x990 = new Functionality(MultiLanguageString.importFromString("pt29:Editar Disciplina Compet�ncia"));
                    x988.addChild(x990);
              ...
              Module x994 = new Module(MultiLanguageString.importFromString("pt19:Gest�o de Execu��es"),"/");
              x914.addChild(x994);
              ...
              x994.setVisible(true);
                 Functionality x993 = new Functionality(MultiLanguageString.importFromString("pt17:Periodos Execu��o"));
                 x994.addChild(x993);
                 ...
                 Functionality x995 = new Functionality(MultiLanguageString.importFromString("pt19:Curr�culos Execu��o"));
                 x994.addChild(x995);
                 ...
                 Functionality x996 = new Functionality(MultiLanguageString.importFromString("pt35:P�gina Inicial Disciplinas Execu��o"));
                 x994.addChild(x996);
                 ...
                 Functionality x997 = new Functionality(MultiLanguageString.importFromString("pt22:Periodos de Inscri��es"));
                 x994.addChild(x997);
                 ...
                 Module x999 = new Module(MultiLanguageString.importFromString("pt19:Curr�culos Execu��o"),"/");
                 x994.addChild(x999);
                 ...
                 x999.setVisible(false);
                    Functionality x998 = new Functionality(MultiLanguageString.importFromString("pt16:P�gina Principal"));
                    x999.addChild(x998);
                    ...
                    Module x1001 = new Module(MultiLanguageString.importFromString("pt29:Gest�o de Curr�culos Execu��o"),"/");
                    x999.addChild(x1001);
                    ...
                    x1001.setVisible(true);
                       Functionality x1000 = new Functionality(MultiLanguageString.importFromString("pt25:Criar Curr�culos Execu��o"));
                       ...
                       Functionality x1002 = new Functionality(MultiLanguageString.importFromString("pt26:Editar Curr�culos Execu��o"));
                       ...
                       Functionality x1004 = new Functionality(MultiLanguageString.importFromString("pt25:Curr�culo Execu��o Criado"));
                 ...
                 Module x1008 = new Module(MultiLanguageString.importFromString("pt20:Disciplinas Execu��o"),"/");
                 x994.addChild(x1008);
                 ...
                 x1008.setVisible(false);
                    Functionality x1007 = new Functionality(MultiLanguageString.importFromString("pt14:P�gina Inicial"));
                    ...
                    Module x1010 = new Module(MultiLanguageString.importFromString("pt20:Disciplinas Execu��o"),"/");
                    ...
                    x1010.setVisible(true);
                       Functionality x1009 = new Functionality(MultiLanguageString.importFromString("pt27:Inserir Disciplina Execu��o"));
                       ...
                       Functionality x1011 = new Functionality(MultiLanguageString.importFromString("pt26:Editar Disciplina Execu��o"));
                       ...
                       Functionality x1012 = new Functionality(MultiLanguageString.importFromString("pt27:Juntar Disciplinas Execu��o"));
                       ...
                       Functionality x1013 = new Functionality(MultiLanguageString.importFromString("pt28:Criar Relat�rios de Doc�ncia"));
                       ...
                       Functionality x1014 = new Functionality(MultiLanguageString.importFromString("pt29:Criar Disciplinas de Execu��o"));
                       ...
                       Functionality x1015 = new Functionality(MultiLanguageString.importFromString("pt28:Editar Disciplina Execu��o 1"));
                       ...
                       Functionality x1016 = new Functionality(MultiLanguageString.importFromString("pt28:Editar Disciplina Execu��o 2"));
                       ...
                       Functionality x1018 = new Functionality(MultiLanguageString.importFromString("pt27:Separar Disciplina Execu��o"));
                       ...
                       Functionality x1019 = new Functionality(MultiLanguageString.importFromString("pt29:Juntar Disciplinas Execu��o 2"));
              ...
              Module x1024 = new Module(MultiLanguageString.importFromString("pt17:Gest�o de Pessoal"),"/");
              x914.addChild(x1024);
              ...
              x1024.setVisible(true);
                 Functionality x1023 = new Functionality(MultiLanguageString.importFromString("pt18:Gest�o de Docentes"));
                 ...
                 Functionality x1025 = new Functionality(MultiLanguageString.importFromString("pt16:Gest�o de Alunos"));
                 ...
                 Functionality x1026 = new Functionality(MultiLanguageString.importFromString("pt17:Gest�o de Pessoas"));
                 ...
                 Functionality x1027 = new Functionality(MultiLanguageString.importFromString("pt18:Gest�o de Feriados"));
                 ...
                 Module x1029 = new Module(MultiLanguageString.importFromString("pt18:Gest�o de Docentes"),"/");
                 ...
                 x1029.setVisible(false);
                    Functionality x1028 = new Functionality(MultiLanguageString.importFromString("pt14:P�gina Inicial"));
                    ...
                    Module x1031 = new Module(MultiLanguageString.importFromString("pt18:Gest�o de Docentes"),"/");
                    ...
                    x1031.setVisible(true);
                       ...
                       Functionality x1032 = new Functionality(MultiLanguageString.importFromString("pt32:Desassociar Disciplinas Execu��o"));
                 ...
                 Module x1036 = new Module(MultiLanguageString.importFromString("pt16:Gest�o de Alunos"),"/");
                 ...
                 x1036.setVisible(false);
                    Functionality x1035 = new Functionality(MultiLanguageString.importFromString("pt20:Criar Classifica��es"));
                 ...
                 Module x1039 = new Module(MultiLanguageString.importFromString("pt17:Gest�o de Pessoas"),"/");
                 ...
                 x1039.setVisible(false);
                    Functionality x1038 = new Functionality(MultiLanguageString.importFromString("pt14:P�gina Inicial"));
                    ...
                    Module x1041 = new Module(MultiLanguageString.importFromString("pt17:Gest�o de Pessoas"),"/");
                    ...
                    x1041.setVisible(true);
                       ...
                       Functionality x1043 = new Functionality(MultiLanguageString.importFromString("pt21:Gest�o de Privil�gios"));
                       ...
                       Functionality x1045 = new Functionality(MultiLanguageString.importFromString("pt16:Cargos de Gest�o"));
                       ...
                       Functionality x1046 = new Functionality(MultiLanguageString.importFromString("pt16:Cargos de Gest�o"));
                       ...
                       Functionality x1047 = new Functionality(MultiLanguageString.importFromString("pt16:Cargos de Gest�o"));
                       ...
                       Functionality x1049 = new Functionality(MultiLanguageString.importFromString("pt16:Cargos de Gest�o"));
                       ...
                       Functionality x1050 = new Functionality(MultiLanguageString.importFromString("pt16:Cargos de Gest�o"));
                       x1041.addChild(x1050);
                       x1050.setTitle(MultiLanguageString.importFromString("pt11:Confirma��o"));
                       ...
                       Functionality x1051 = new Functionality(MultiLanguageString.importFromString("pt16:Cargos de Gest�o"));
                       x1041.addChild(x1051);
                       x1051.setTitle(MultiLanguageString.importFromString("pt22:Apagar Cargo de Gest�o"));
                       ...
                       x1054.setVisible(true);
                          ...
                          Functionality x1055 = new Functionality(MultiLanguageString.importFromString("pt18:Gest�o de Convites"));
                 ...
                 Functionality x1059 = new Functionality(MultiLanguageString.importFromString("en15:Role Managementpt15:Gest�o de Roles"));
                 x1024.addChild(x1059);
                 x1059.setTitle(MultiLanguageString.importFromString("en15:Role Managementpt15:Gest�o de Roles"));
              ...
              Module x1062 = new Module(MultiLanguageString.importFromString("pt13:Equival�ncias"),"/");
              x914.addChild(x1062);
              ...
              x1062.setVisible(true);
                 Functionality x1061 = new Functionality(MultiLanguageString.importFromString("pt22:N�o necessita de fazer"));
                 ...
                 Functionality x1063 = new Functionality(MultiLanguageString.importFromString("pt13:Equival�ncias"));
              ...
              Module x1066 = new Module(MultiLanguageString.importFromString("pt19:Gest�o de Ficheiros"),"/");
              x914.addChild(x1066);
              ...
              x1066.setVisible(false);
                 Functionality x1065 = new Functionality(MultiLanguageString.importFromString("pt20:Gera��o de Ficheiros"));
                 ...
                 Module x1069 = new Module(MultiLanguageString.importFromString("pt20:Gera��o de Ficheiros"),"/");
                 ...
                 x1069.setVisible(false);
                    Functionality x1068 = new Functionality(MultiLanguageString.importFromString("pt16:P�gina Principal"));
                    ...
                    Module x1071 = new Module(MultiLanguageString.importFromString("pt20:Gera��o de Ficheiros"),"/");
                 ...
                 x1076.setVisible(false);
                    Functionality x1075 = new Functionality(MultiLanguageString.importFromString("pt16:P�gina Principal"));
                    ...
                    Module x1078 = new Module(MultiLanguageString.importFromString("pt19:Gest�o de Ficheiros"),"/");
              ...
              Module x1083 = new Module(MultiLanguageString.importFromString("pt17:Gest�o Financeira"),"/");
              x914.addChild(x1083);
              ...
              x1083.setVisible(true);
                 Functionality x1082 = new Functionality(MultiLanguageString.importFromString("pt15:Gest�o de Guias"));
                 ...
                 Functionality x1084 = new Functionality(MultiLanguageString.importFromString("pt31:Actualizar Situa��es de Propina"));
                 ...
                 Module x1086 = new Module(MultiLanguageString.importFromString("pt15:Gest�o de Guias"),"/");
                 ...
                 x1086.setVisible(false);
                    Functionality x1085 = new Functionality(MultiLanguageString.importFromString("pt16:P�gina Principal"));
                    ...
                    Module x1088 = new Module(MultiLanguageString.importFromString("pt15:Gest�o de Guias"),"/");
                    ...
                    x1088.setVisible(true);
                       Functionality x1087 = new Functionality(MultiLanguageString.importFromString("pt15:Edi��o de Guias"));
              ...
              Module x1093 = new Module(MultiLanguageString.importFromString("pt13:Gest�o de CMS"),"/");
              x914.addChild(x1093);
              ...
              x1093.setVisible(true);
                 ...
                 Functionality x1094 = new Functionality(MultiLanguageString.importFromString("pt13:Configura��es"));
                 ...
                 Functionality x1095 = new Functionality(MultiLanguageString.importFromString("pt22:P�ginas de Disciplinas"));
              ...
              Module x1098 = new Module(MultiLanguageString.importFromString("pt17:Gest�o do Suporte"),"/");
              x914.addChild(x1098);
              ...
              x1098.setVisible(true);
                 Functionality x1097 = new Functionality(MultiLanguageString.importFromString("pt19:Gest�o de Gloss�rio"));
                 ...
                 Functionality x1099 = new Functionality(MultiLanguageString.importFromString("pt15:Gest�o de FAQ s"));
                 ...
                 Functionality x1100 = new Functionality(MultiLanguageString.importFromString("pt15:Gest�o de FAQ s"));
              ...
              Module x1103 = new Module(MultiLanguageString.importFromString("pt18:Gest�o de Objectos"),"/");
              x914.addChild(x1103);
              ...
              x1103.setVisible(true);
                 Functionality x1102 = new Functionality(MultiLanguageString.importFromString("pt15:Gest�o da Cache"));
                 ...
                 Functionality x1104 = new Functionality(MultiLanguageString.importFromString("pt26:Formata��o de Propriedades"));
                 ...
                 Functionality x1105 = new Functionality(MultiLanguageString.importFromString("pt17:Fus�o de Objectos"));
                 ...
                 Functionality x1106 = new Functionality(MultiLanguageString.importFromString("pt18:Edi��o de Objectos"));
                 ...
                 Functionality x1107 = new Functionality(MultiLanguageString.importFromString("pt16:Fus�o de Pessoas"));
                 x1103.addChild(x1107);
                 x1107.setTitle(MultiLanguageString.importFromString("pt16:Fus�o de Pessoas"));
                 x1107.setDescription(MultiLanguageString.importFromString("pt16:Fus�o de Pessoas"));
              ...
              Module x1110 = new Module(MultiLanguageString.importFromString("pt17:Gest�o do Sistema"),"/");
              x914.addChild(x1110);
              ...
              x1110.setVisible(true);
                 Functionality x1109 = new Functionality(MultiLanguageString.importFromString("pt25:Monitoriza��o de Servi�os"));
                 ...
                 Functionality x1111 = new Functionality(MultiLanguageString.importFromString("pt24:Monitoriza��o de Pedidos"));
                 ...
                 Functionality x1112 = new Functionality(MultiLanguageString.importFromString("pt29:Monitoriza��o de Utilizadores"));
                 ...
                 Functionality x1113 = new Functionality(MultiLanguageString.importFromString("pt22:Informa��es do Sistema"));
                 ...
                 Functionality x1117 = new Functionality(MultiLanguageString.importFromString("pt22:Sistema de Transac��es"));
                 ...
                 Functionality x1118 = new Functionality(MultiLanguageString.importFromString("pt16:Gest�o de Logins"));
              ...
              Module x1122 = new Module(MultiLanguageString.importFromString("pt25:Gest�o de Funcionalidades"),"/functionalities");
              x914.addChild(x1122);
              ...
              x1122.setVisible(true);
                 ...
                 x1128.setVisible(false);
                    ...
                    x1137.setVisible(true);
                       ...
                       Functionality x1143 = new Functionality(MultiLanguageString.importFromString("pt40:Interpretar express�o de disponibilidade"));
              ...
              x1155.setVisible(true);
                 ...
                 x1161.setVisible(true);
                    ...
                    Functionality x1162 = new Functionality(MultiLanguageString.importFromString("pt28:Reler Configura��o Renderers"));
                    ...
                    x1165.setVisible(false);
                       Functionality x1164 = new Functionality(MultiLanguageString.importFromString("pt41:The first situation: presenting the world"));
                       ...
                       Functionality x1167 = new Functionality(MultiLanguageString.importFromString("pt38:The third situation: input on steroids"));
                       ...
                       Functionality x1168 = new Functionality(MultiLanguageString.importFromString("pt44:The fourth situation: renderers meet actions"));
              ...
              x1175.setVisible(true);
                 ...
                 Functionality x1178 = new Functionality(MultiLanguageString.importFromString("en13:Payment Codespt7:C�digos"));
                 x1175.addChild(x1178);
                 x1178.setTitle(MultiLanguageString.importFromString("en13:Payment Codespt7:C�digos"));
                 ...
                 Functionality x1179 = new Functionality(MultiLanguageString.importFromString("en7:Reportspt10:Relat�rios"));
                 x1175.addChild(x1179);
                 x1179.setTitle(MultiLanguageString.importFromString("en20:Sibs payment reportspt28:Relat�rios de pagamento sibs"));
                 ...
                 Functionality x1180 = new Functionality(MultiLanguageString.importFromString("pt21:Relat�rio de propinas"));
                 x1175.addChild(x1180);
                 x1180.setTitle(MultiLanguageString.importFromString("pt21:Relat�rio de propinas"));
                 x1180.setDescription(MultiLanguageString.importFromString("pt21:Relat�rio de propinas"));
                 ...
                 Functionality x1181 = new Functionality(MultiLanguageString.importFromString("pt25:Exporta��o de refer�ncias"));
                 x1175.addChild(x1181);
                 x1181.setTitle(MultiLanguageString.importFromString("pt25:Exporta��o de refer�ncias"));
                 x1181.setDescription(MultiLanguageString.importFromString("pt25:Exporta��o de refer�ncias"));
                 ...
                 Functionality x1182 = new Functionality(MultiLanguageString.importFromString("pt20:Relat�rio de Dividas"));
                 x1175.addChild(x1182);
                 x1182.setTitle(MultiLanguageString.importFromString("pt20:Relat�rio de Dividas"));
                 x1182.setDescription(MultiLanguageString.importFromString("pt20:Relat�rio de Dividas"));
              ...
              Module x1185 = new Module(MultiLanguageString.importFromString("pt21:Gest�o de Calend�rios"),"/");
              x914.addChild(x1185);
              ...
              x1185.setVisible(true);
                 Functionality x1184 = new Functionality(MultiLanguageString.importFromString("pt22:Calend�rios Acad�micos"));
                 ...
                 Functionality x1186 = new Functionality(MultiLanguageString.importFromString("pt26:Criar Calend�rio Acad�mico"));
              ...
              Module x1189 = new Module(MultiLanguageString.importFromString("pt23:Actividades Cient�ficas"),"/");
              x914.addChild(x1189);
              x1189.setTitle(MultiLanguageString.importFromString("pt23:Actividades Cient�ficas"));
              ...
              x1189.setVisible(true);
                 ...
                 Functionality x1194 = new Functionality(MultiLanguageString.importFromString("pt24:Juntar Edi��es de Evento"));
                 x1189.addChild(x1194);
                 x1194.setTitle(MultiLanguageString.importFromString("pt24:Juntar Edi��es de Evento"));
                 ...
                 Functionality x1196 = new Functionality(MultiLanguageString.importFromString("pt24:Juntar Edi��es de Evento"));
              ...
              Module x1202 = new Module(MultiLanguageString.importFromString("pt20:Transi��o de Bolonha"),"/");
              x914.addChild(x1202);
              ...
              x1202.setVisible(true);
                 Functionality x1201 = new Functionality(MultiLanguageString.importFromString("pt30:Planos de Equival�ncia Globais"));
                 ...
                 Functionality x1203 = new Functionality(MultiLanguageString.importFromString("pt29:Planos de Equival�ncia Locais"));
                 ...
                 Functionality x1204 = new Functionality(MultiLanguageString.importFromString("pt18:Curr�culo do Aluno"));
              ...
              x1207.setVisible(true);
                 ...
                 Functionality x1208 = new Functionality(MultiLanguageString.importFromString("pt16:Mover Inscri��es"));
                 ...
                 Functionality x1209 = new Functionality(MultiLanguageString.importFromString("pt19:Gest�o de Dispensas"));
                 ...
                 Functionality x1210 = new Functionality(MultiLanguageString.importFromString("pt23:Gest�o de Substitui��es"));
                 ...
                 Functionality x1211 = new Functionality(MultiLanguageString.importFromString("pt23:Gest�o de Equival�ncias"));
                 ...
                 Functionality x1212 = new Functionality(MultiLanguageString.importFromString("pt18:Gest�o de Cr�ditos"));
                 ...
                 Functionality x1213 = new Functionality(MultiLanguageString.importFromString("pt20:Gest�o de Apuramento"));
                 ...
                 Functionality x1214 = new Functionality(MultiLanguageString.importFromString("pt17:Gest�o de Estados"));
                 ...
                 Functionality x1216 = new Functionality(MultiLanguageString.importFromString("pt18:Importa��o da DGES"));
                 x1207.addChild(x1216);
                 x1216.setTitle(MultiLanguageString.importFromString("pt18:Importa��o da DGES"));
                 x1216.setDescription(MultiLanguageString.importFromString("pt18:Importa��o da DGES"));
                 ...
                 Functionality x1217 = new Functionality(MultiLanguageString.importFromString("pt28:Inscri��es em �poca Especial"));
                 ...
                 Functionality x1218 = new Functionality(MultiLanguageString.importFromString("pt27:Sum�rio Candidaturas 1� vez"));
                 x1207.addChild(x1218);
                 x1218.setTitle(MultiLanguageString.importFromString("pt27:Sum�rio Candidaturas 1� vez"));
              ...
              Module x1235 = new Module(MultiLanguageString.importFromString("pt23:N�cleo de P�s Gradua��o"),"/");
              x914.addChild(x1235);
              x1235.setTitle(MultiLanguageString.importFromString("pt23:N�cleo de P�s Gradua��o"));
              x1235.setDescription(MultiLanguageString.importFromString("pt23:N�cleo de P�s Gradua��o"));
           ...
           Module x1243 = new Module(MultiLanguageString.importFromString("pt40:Sec��o de Pessoal Docente e Investigador"),"/facultyAdmOffice");
           x823.addChild(x1243);
           ...
           x1243.setVisible(true);
              Functionality x1242 = new Functionality(MultiLanguageString.importFromString("pt40:Sec��o de Pessoal Docente e Investigador"));
              x1243.addChild(x1242);
              x1242.setTitle(MultiLanguageString.importFromString("pt40:Sec��o de Pessoal Docente e Investigador"));
           ...
           Module x1246 = new Module(MultiLanguageString.importFromString("pt53:Administra��o de cr�ditos de docentes do departamento"),"/departmentAdmOffice");
           x823.addChild(x1246);
           x1246.setNormalizedName(MultiLanguageString.importFromString("pt53:administracao-de-creditos-de-docentes-do-departamento"));
           x1246.setExecutionPath("/departmentAdmOffice/index.do");
           x1246.setVisible(true);
              Functionality x1245 = new Functionality(MultiLanguageString.importFromString("pt53:Administra��o de cr�ditos de docentes do departamento"));
              x1246.addChild(x1245);
              x1245.setTitle(MultiLanguageString.importFromString("pt53:Administra��o de cr�ditos de docentes do departamento"));
              x1245.setNormalizedName(MultiLanguageString.importFromString("pt53:administracao-de-creditos-de-docentes-do-departamento"));
           ...
           Module x1249 = new Module(MultiLanguageString.importFromString("pt19:Conselho Cient�fico"),"/scientificCouncil");
           x823.addChild(x1249);
           ...
           x1249.setVisible(true);
              Functionality x1248 = new Functionality(MultiLanguageString.importFromString("pt19:Conselho Cient�fico"));
              x1249.addChild(x1248);
              x1248.setTitle(MultiLanguageString.importFromString("pt19:Conselho Cient�fico"));
           ...
           Module x1255 = new Module(MultiLanguageString.importFromString("pt10:Semin�rios"),"/teacher");
           x823.addChild(x1255);
           ...
           x1255.setVisible(true);
              Functionality x1254 = new Functionality(MultiLanguageString.importFromString("pt10:Semin�rios"));
              x1255.addChild(x1254);
              x1254.setTitle(MultiLanguageString.importFromString("pt10:Semin�rios"));
           ...
           Module x1261 = new Module(MultiLanguageString.importFromString("pt26:Secretaria de Departamento"),"/departmentAdmOffice");
           x823.addChild(x1261);
           ...
           Module x1276 = new Module(MultiLanguageString.importFromString("pt24:Projectos Institucionais"),"/institucionalProjectsManagement");
           x823.addChild(x1276);
           ...
           Module x1282 = new Module(MultiLanguageString.importFromString("pt17:Gest�o de Espa�os"),"/SpaceManager");
           x823.addChild(x1282);
           ...
           x1282.setVisible(true);
              Functionality x1281 = new Functionality(MultiLanguageString.importFromString("pt17:Gest�o de Espa�os"));
              x1282.addChild(x1281);
              x1281.setTitle(MultiLanguageString.importFromString("pt17:Gest�o de Espa�os"));
           ...
           Module x1285 = new Module(MultiLanguageString.importFromString("pt12:Investiga��o"),"/researcher");
           x823.addChild(x1285);
           ...
           x1285.setVisible(true);
              Functionality x1284 = new Functionality(MultiLanguageString.importFromString("pt12:Investiga��o"));
              x1285.addChild(x1284);
              x1284.setTitle(MultiLanguageString.importFromString("pt12:Investiga��o"));
              ...
              Functionality x1286 = new Functionality(MultiLanguageString.importFromString("pt21:Avalia��o de Docentes"));
           ...
           Module x1292 = new Module(MultiLanguageString.importFromString("pt19:Conselho Pedag�gico"),"/pedagogicalCouncil");
           x823.addChild(x1292);
           ...
           x1292.setVisible(true);
              Functionality x1291 = new Functionality(MultiLanguageString.importFromString("pt19:Conselho Pedag�gico"));
              x1292.addChild(x1291);
              x1291.setTitle(MultiLanguageString.importFromString("pt19:Conselho Pedag�gico"));
           ...
           Module x1298 = new Module(MultiLanguageString.importFromString("en9:Messagingpt11:Comunica��o"),"/messaging");
           x823.addChild(x1298);
           ...
           x1298.setVisible(true);
              Functionality x1297 = new Functionality(MultiLanguageString.importFromString("pt11:Comunica��o"));
              x1298.addChild(x1297);
              x1297.setTitle(MultiLanguageString.importFromString("pt11:Comunica��o"));
           ...
           Module x1303 = new Module(MultiLanguageString.importFromString("pt7:P�blico"),"/publico");
           x823.addChild(x1303);
           ...
           x1303.setVisible(false);
              ...
              x1302.setVisible(false);
                 Module x1301 = new Module(MultiLanguageString.importFromString("pt19:Disciplina Execu��o"),"/");
                 ...
                 x1301.setVisible(false);
                    Functionality x1300 = new Functionality(MultiLanguageString.importFromString("en12:Initial Pagept14:P�gina Inicial"));
                    ...
                    Functionality x1304 = new Functionality(MultiLanguageString.importFromString("en13:Announcementspt8:An�ncios"));
                    ...
                    Functionality x1306 = new Functionality(MultiLanguageString.importFromString("en9:Summariespt8:Sum�rios"));
                    ...
                    Functionality x1309 = new Functionality(MultiLanguageString.importFromString("en17:Evaluation Methodpt19:M�todo de Avalia��o"));
                    ...
                    Functionality x1311 = new Functionality(MultiLanguageString.importFromString("en9:Timesheetpt7:Hor�rio"));
                    ...
                    Functionality x1313 = new Functionality(MultiLanguageString.importFromString("en10:Evaluationpt9:Avalia��o"));
                    ...
                    Functionality x1315 = new Functionality(MultiLanguageString.importFromString("pt10:Ver Sec��o"));
                    ...
                    x1316.setTitle(MultiLanguageString.importFromString("en15:Search Contentspt19:Pesquisar Conte�dos"));
                 ...
                 x1320.setVisible(true);
                    Functionality x1319 = new Functionality(MultiLanguageString.importFromString("en12:Presentationpt12:Apresenta��o"));
                    x1320.addChild(x1319);
                    x1319.setTitle(MultiLanguageString.importFromString("en12:Presentationpt12:Apresenta��o"));
                    ...
                    Functionality x1321 = new Functionality(MultiLanguageString.importFromString("en18:Research Interestspt22:Interesses Cient�ficos"));
                    ...
                    Functionality x1322 = new Functionality(MultiLanguageString.importFromString("en12:Publicationspt11:Publica��es"));
                    x1320.addChild(x1322);
                    x1322.setTitle(MultiLanguageString.importFromString("en12:Publicationspt11:Publica��es"));
                    ...
                    Functionality x1325 = new Functionality(MultiLanguageString.importFromString("en6:Prizespt7:Pr�mios"));
                    x1320.addChild(x1325);
                    x1325.setTitle(MultiLanguageString.importFromString("en6:Prizespt7:Pr�mios"));
                 ...
                 x1328.setVisible(true);
                    Functionality x1327 = new Functionality(MultiLanguageString.importFromString("en11:Descriptionpt9:Descri��o"));
                    ...
                    Functionality x1329 = new Functionality(MultiLanguageString.importFromString("en13:Announcementspt8:An�ncios"));
                    ...
                    Functionality x1330 = new Functionality(MultiLanguageString.importFromString("en22:Admission Requirementspt16:Regime de Acesso"));
                    ...
                    Functionality x1331 = new Functionality(MultiLanguageString.importFromString("en19:Professional Statuspt21:Estatuto Profissional"));
                    ...
                    Functionality x1332 = new Functionality(MultiLanguageString.importFromString("en15:Curricular Planpt16:Plano Curricular"));
                    ...
                    Functionality x1333 = new Functionality(MultiLanguageString.importFromString("en16:Course Web Pagespt22:P�ginas de Disciplinas"));
                    ...
                    Functionality x1334 = new Functionality(MultiLanguageString.importFromString("en15:Class timetablept18:Hor�rios por Turma"));
                    ...
                    Functionality x1335 = new Functionality(MultiLanguageString.importFromString("en11:Evaluationspt10:Avalia��es"));
                    ...
                    Functionality x1336 = new Functionality(MultiLanguageString.importFromString("en13:Dissertationspt12:Disserta��es"));
                 ...
                 x1339.setVisible(true);
                    Functionality x1338 = new Functionality(MultiLanguageString.importFromString("en13:Announcementspt8:An�ncios"));
                    ...
                    Functionality x1341 = new Functionality(MultiLanguageString.importFromString("en5:Staffpt12:Funcion�rios"));
                    ...
                    Functionality x1346 = new Functionality(MultiLanguageString.importFromString("en16:Scientific Areaspt17:�reas Cient�ficas"));
                    ...
                    Functionality x1347 = new Functionality(MultiLanguageString.importFromString("en13:Dissertationspt12:Disserta��es"));
                    ...
                    Functionality x1348 = new Functionality(MultiLanguageString.importFromString("en12:Publicationspt11:Publica��es"));
                    x1339.addChild(x1348);
                    x1348.setTitle(MultiLanguageString.importFromString("en12:Publicationspt11:Publica��es"));
                    ...
                    Functionality x1349 = new Functionality(MultiLanguageString.importFromString("en4:Homept6:In�cio"));
                    x1339.addChild(x1349);
                    x1349.setTitle(MultiLanguageString.importFromString("pt6:In�cio"));
                 ...
                 Module x1352 = new Module(MultiLanguageString.importFromString("en13:Research Sitept20:Site de Investiga��o"),"/researchSite");
                 ...
                 x1352.setVisible(true);
                    ...
                    Functionality x1353 = new Functionality(MultiLanguageString.importFromString("en13:Announcementspt8:An�ncios"));
                    x1352.addChild(x1353);
                    x1353.setTitle(MultiLanguageString.importFromString("en13:Announcementspt8:An�ncios"));
                    ...
                    Functionality x1355 = new Functionality(MultiLanguageString.importFromString("en12:Publicationspt11:Publica��es"));
                    x1352.addChild(x1355);
                    x1355.setTitle(MultiLanguageString.importFromString("en12:Publicationspt11:Publica��es"));
                    ...
                    Functionality x1358 = new Functionality(MultiLanguageString.importFromString("en4:Homept6:In�cio"));
                    x1352.addChild(x1358);
                    x1358.setTitle(MultiLanguageString.importFromString("pt6:In�cio"));
                 ...
                 Module x1361 = new Module(MultiLanguageString.importFromString("pt19:Conselho Pedag�gico"),"/pedagogicalCouncil");
                 ...
                 x1361.setVisible(true);
                    ...
                    Functionality x1362 = new Functionality(MultiLanguageString.importFromString("pt6:In�cio"));
                    x1361.addChild(x1362);
                    x1362.setTitle(MultiLanguageString.importFromString("pt6:In�cio"));
                 ...
                 Module x1365 = new Module(MultiLanguageString.importFromString("pt19:Conselho Cient�fico"),"/scientificCouncil");
                 ...
                 x1365.setVisible(true);
                    ...
                    Functionality x1366 = new Functionality(MultiLanguageString.importFromString("pt6:In�cio"));
                    x1365.addChild(x1366);
                    x1366.setTitle(MultiLanguageString.importFromString("pt6:In�cio"));
                 ...
                 Module x1369 = new Module(MultiLanguageString.importFromString("en14:ScientificAreapt15:�rea Cient�fica"),"/scientificArea");
                 ...
                 x1369.setVisible(true);
                    Functionality x1368 = new Functionality(MultiLanguageString.importFromString("en12:Publicationspt11:Publica��es"));
                    ...
                    Functionality x1371 = new Functionality(MultiLanguageString.importFromString("en13:Announcementspt8:An�ncios"));
                    ...
                    Functionality x1372 = new Functionality(MultiLanguageString.importFromString("en12:Organizationpt11:Organiza��o"));
                    ...
                    Functionality x1375 = new Functionality(MultiLanguageString.importFromString("en5:Staffpt12:Funcion�rios"));
                    ...
                    Functionality x1377 = new Functionality(MultiLanguageString.importFromString("en4:Homept6:In�cio"));
                    x1369.addChild(x1377);
                    x1377.setTitle(MultiLanguageString.importFromString("pt6:In�cio"));
                 ...
                 x1380.setNormalizedName(MultiLanguageString.importFromString("pt8:tutorado"));
                    Functionality x1379 = new Functionality(MultiLanguageString.importFromString("pt6:In�cio"));
                    x1380.addChild(x1379);
                    x1379.setTitle(MultiLanguageString.importFromString("pt6:In�cio"));
                 ...
                 x1383.setNormalizedName(MultiLanguageString.importFromString("pt9:alunos-cd"));
                    Functionality x1382 = new Functionality(MultiLanguageString.importFromString("pt14:P�gina Inicial"));
                    x1383.addChild(x1382);
                    x1382.setTitle(MultiLanguageString.importFromString("pt14:P�gina Inicial"));
                 ...
                 Module x1389 = new Module(MultiLanguageString.importFromString("pt22:Assembleia Estatut�ria"),"/aestatutaria");
                 x1302.addChild(x1389);
                 x1389.setTitle(MultiLanguageString.importFromString("pt22:Assembleia Estatut�ria"));
                 x1389.setNormalizedName(MultiLanguageString.importFromString("pt22:assembleia-estatutaria"));
                    Functionality x1388 = new Functionality(MultiLanguageString.importFromString("pt6:In�cio"));
                    x1389.addChild(x1388);
                    x1388.setTitle(MultiLanguageString.importFromString("pt6:In�cio"));
                 ...
                 Module x1392 = new Module(MultiLanguageString.importFromString("pt18:Conselho de Gest�o"),"/managementCouncilSite");
                 x1302.addChild(x1392);
                 x1392.setTitle(MultiLanguageString.importFromString("pt18:Conselho de Gest�o"));
                 x1392.setNormalizedName(MultiLanguageString.importFromString("pt18:conselho-de-gestao"));
                    Functionality x1391 = new Functionality(MultiLanguageString.importFromString("en4:Homept6:In�cio"));
                    x1392.addChild(x1391);
                    x1391.setTitle(MultiLanguageString.importFromString("en4:Homept6:In�cio"));
                 ...
                 x1395.setNormalizedName(MultiLanguageString.importFromString("pt17:sites-de-unidades"));
                    Functionality x1394 = new Functionality(MultiLanguageString.importFromString("en4:Homept6:In�cio"));
                    x1395.addChild(x1394);
                    x1394.setTitle(MultiLanguageString.importFromString("en4:Homept6:In�cio"));
              ...
              Functionality x1398 = new Functionality(MultiLanguageString.importFromString("pt19:Pesquisa de Espa�os"));
              x1303.addChild(x1398);
              x1398.setTitle(MultiLanguageString.importFromString("pt19:Pesquisa de Espa�os"));
              x1398.setDescription(MultiLanguageString.importFromString("pt19:Pesquisa de Espa�os"));
              ...
              Functionality x1399 = new Functionality(MultiLanguageString.importFromString("pt40:Consulta de Corpo Docente por Disciplina"));
              ...
              Functionality x1401 = new Functionality(MultiLanguageString.importFromString("pt24:Conclus�o Registo Alumni"));
              x1303.addChild(x1401);
              x1401.setTitle(MultiLanguageString.importFromString("pt24:Conclus�o Registo Alumni"));
              ...
              x1408.setNormalizedName(MultiLanguageString.importFromString("pt12:candidaturas"));
                 ...
                 x1413.setTitle(MultiLanguageString.importFromString("pt39:Titulares de cursos m�dios e superiores"));
                 x1413.setDescription(MultiLanguageString.importFromString("pt39:Titulares de cursos m�dios e superiores"));
           ...
           x1483.setVisible(true);
              Functionality x1482 = new Functionality(MultiLanguageString.importFromString("en12:Initial Pagept14:P�gina Inicial"));
              x1483.addChild(x1482);
              x1482.setTitle(MultiLanguageString.importFromString("en12:Initial Pagept14:P�gina Inicial"));
           ...
           x1487.setVisible(true);
              Functionality x1486 = new Functionality(MultiLanguageString.importFromString("en5:Startpt6:In�cio"));
              x1487.addChild(x1486);
              x1486.setTitle(MultiLanguageString.importFromString("en19:Portal inicial pagept24:P�gina inicial do portal"));
              ...
              Module x1489 = new Module(MultiLanguageString.importFromString("en6:Thesespt12:Disserta��es"),"/theses");
              ...
              x1489.setVisible(false);
                 Functionality x1488 = new Functionality(MultiLanguageString.importFromString("en10:Validationpt9:Valida��o"));
                 x1489.addChild(x1488);
                 x1488.setTitle(MultiLanguageString.importFromString("en17:Theses Validationpt25:Valida��o de Disserta��es"));
              ...
              Module x1492 = new Module(MultiLanguageString.importFromString("pt7:Cart�es"),"/");
              ...
              x1492.setVisible(true);
                 ...
                 x1491.setTitle(MultiLanguageString.importFromString("pt17:Cart�o Biblioteca"));
                 ...
                 Functionality x1493 = new Functionality(MultiLanguageString.importFromString("pt13:Gerar Cart�es"));
                 x1492.addChild(x1493);
                 x1493.setTitle(MultiLanguageString.importFromString("pt31:Gerar pdf para cart�es em falta"));
                 ...
                 Functionality x1495 = new Functionality(MultiLanguageString.importFromString("pt36:Gerar Cartas para Alunos e Bolseiros"));
              ...
              ExpressionGroupAvailability x1652 = new ExpressionGroupAvailability(x1498, "role(LIBRARY) && (libraryHigherClearanceGroup() || role(MANAGER))");
              ...
              ExpressionGroupAvailability x1653 = new ExpressionGroupAvailability(x1499, "role(LIBRARY) && (libraryHigherClearanceGroup() || role(MANAGER))");
           ...
           Module x1502 = new Module(MultiLanguageString.importFromString("pt20:Gest�o de Patrim�nio"),"/resourceManager");
           x823.addChild(x1502);
           x1502.setTitle(MultiLanguageString.importFromString("pt20:Gest�o de Patrim�nio"));
           ...
           x1502.setVisible(true);
              Functionality x1501 = new Functionality(MultiLanguageString.importFromString("pt20:Gest�o de Patrim�nio"));
              x1502.addChild(x1501);
              x1501.setTitle(MultiLanguageString.importFromString("pt20:Gest�o de Patrim�nio"));
           ...
           Module x1508 = new Module(MultiLanguageString.importFromString("pt17:Gest�o do WebSite"),"/webSiteManager");
           x823.addChild(x1508);
           ...
           x1508.setVisible(true);
              Functionality x1507 = new Functionality(MultiLanguageString.importFromString("pt17:Gest�o do WebSite"));
              x1508.addChild(x1507);
              x1507.setTitle(MultiLanguageString.importFromString("pt17:Gest�o do WebSite"));
           ...
           Module x1511 = new Module(MultiLanguageString.importFromString("pt9:Avalia��o"),"/examCoordination");
           x823.addChild(x1511);
           ...
           x1511.setVisible(true);
              Functionality x1510 = new Functionality(MultiLanguageString.importFromString("pt9:Avalia��o"));
              x1511.addChild(x1510);
              x1510.setTitle(MultiLanguageString.importFromString("pt9:Avalia��o"));
           ...
           Module x1514 = new Module(MultiLanguageString.importFromString("pt20:Secretaria Acad�mica"),"/academicAdminOffice");
           x823.addChild(x1514);
           ...
           x1514.setVisible(true);
              Functionality x1513 = new Functionality(MultiLanguageString.importFromString("pt20:Secretaria Acad�mica"));
              x1514.addChild(x1513);
              x1513.setTitle(MultiLanguageString.importFromString("pt20:Secretaria Acad�mica"));
           ...
           Module x1517 = new Module(MultiLanguageString.importFromString("pt35:Gabinete de Rela��es Internacionais"),"/internationalRelatOffice");
           x823.addChild(x1517);
           x1517.setTitle(MultiLanguageString.importFromString("pt35:Gabinete de Rela��es Internacionais"));
           ...
           Module x1532 = new Module(MultiLanguageString.importFromString("pt35:Gest�o da Cart�es de Indentifica��o"),"/identificationCardManager");
           x823.addChild(x1532);
           x1532.setNormalizedName(MultiLanguageString.importFromString("pt35:gestao-da-cartoes-de-indentificacao"));
              Functionality x1531 = new Functionality(MultiLanguageString.importFromString("pt14:P�gina Inicial"));
           ...
           Module x1536 = new Module(MultiLanguageString.importFromString("pt29:Gabinete de Rela��es P�blicas"),"/publicRelations");
           x823.addChild(x1536);
           x1536.setTitle(MultiLanguageString.importFromString("pt29:Gabinete de Rela��es P�blicas"));
           x1536.setNormalizedName(MultiLanguageString.importFromString("pt29:gabinete-de-relacoes-publicas"));
              Functionality x1535 = new Functionality(MultiLanguageString.importFromString("en5:Startpt6:In�cio"));
              x1536.addChild(x1535);
              x1535.setTitle(MultiLanguageString.importFromString("pt6:In�cio"));
              x1535.setNormalizedName(MultiLanguageString.importFromString("en5:startpt6:inicio"));
              x1535.setExecutionPath("/index.do");
              Functionality x1537 = new Functionality(MultiLanguageString.importFromString("en13:Announcementspt8:An�ncios"));
              x1536.addChild(x1537);
              x1537.setTitle(MultiLanguageString.importFromString("pt8:An�ncios"));
              ...
              Functionality x1541 = new Functionality(MultiLanguageString.importFromString("pt10:Inqu�ritos"));
              ...
              x1543.setNormalizedName(MultiLanguageString.importFromString("pt6:alumni"));
                 Functionality x1542 = new Functionality(MultiLanguageString.importFromString("pt12:Estat�sticas"));
                 x1543.addChild(x1542);
                 x1542.setTitle(MultiLanguageString.importFromString("pt12:Estat�sticas"));
           ...
           Module x1548 = new Module(MultiLanguageString.importFromString("pt21:N�cleo de Alojamentos"),"/residenceManagement");
           x823.addChild(x1548);
           x1548.setTitle(MultiLanguageString.importFromString("pt21:N�cleo de Alojamentos"));
           x1548.setNormalizedName(MultiLanguageString.importFromString("pt21:nucleo-de-alojamentos"));
              Functionality x1547 = new Functionality(MultiLanguageString.importFromString("pt14:P�gina Inicial"));
              x1548.addChild(x1547);
              x1547.setTitle(MultiLanguageString.importFromString("pt14:P�gina Inicial"));
              x1547.setNormalizedName(MultiLanguageString.importFromString("pt14:pagina-inicial"));
              x1547.setExecutionPath("/index.do");
              Functionality x1549 = new Functionality(MultiLanguageString.importFromString("pt13:Gerir D�vidas"));
              x1548.addChild(x1549);
              x1549.setTitle(MultiLanguageString.importFromString("pt13:Gerir D�vidas"));
              ...
              Functionality x1550 = new Functionality(MultiLanguageString.importFromString("pt21:Gest�o de Previl�gios"));
              x1548.addChild(x1550);
              x1550.setTitle(MultiLanguageString.importFromString("pt21:Gest�o de Previl�gios"));
           ...
           Module x1556 = new Module(MultiLanguageString.importFromString("pt18:Supervis�o Externa"),"/externalSupervision");
           x823.addChild(x1556);
           x1556.setNormalizedName(MultiLanguageString.importFromString("pt18:supervisao-externa"));
              Functionality x1555 = new Functionality(MultiLanguageString.importFromString("pt14:P�gina Inicial"));
           ...
           x1564.setNormalizedName(MultiLanguageString.importFromString("pt4:nape"));
              ...
              x1566.setNormalizedName(MultiLanguageString.importFromString("pt12:candidaturas"));
                 ...
                 Functionality x1568 = new Functionality(MultiLanguageString.importFromString("pt14:Transfer�ncias"));
                 x1566.addChild(x1568);
                 x1568.setTitle(MultiLanguageString.importFromString("pt14:Transfer�ncias"));
                 x1568.setDescription(MultiLanguageString.importFromString("pt14:Transfer�ncias"));
                 ...
                 Functionality x1569 = new Functionality(MultiLanguageString.importFromString("pt17:Mudan�as de curso"));
                 x1566.addChild(x1569);
                 x1569.setTitle(MultiLanguageString.importFromString("pt17:Mudan�as de curso"));
                 x1569.setDescription(MultiLanguageString.importFromString("pt17:Mudan�as de curso"));
                 ...
                 Functionality x1570 = new Functionality(MultiLanguageString.importFromString("pt45:Titulares de cursos de grau m�dio ou superior"));
                 x1566.addChild(x1570);
                 x1570.setTitle(MultiLanguageString.importFromString("pt45:Titulares de cursos de grau m�dio ou superior"));
                 x1570.setDescription(MultiLanguageString.importFromString("pt45:Titulares de cursos de grau m�dio ou superior"));
              ...
              x1573.setNormalizedName(MultiLanguageString.importFromString("pt10:matriculas"));
                 Functionality x1572 = new Functionality(MultiLanguageString.importFromString("pt33:Alunos Matriculados 1� ano 1� vez"));
                 x1573.addChild(x1572);
                 x1572.setTitle(MultiLanguageString.importFromString("pt33:Alunos Matriculados 1� ano 1� vez"));
                 x1572.setDescription(MultiLanguageString.importFromString("pt33:Alunos Matriculados 1� ano 1� vez"));
           ...
           x1590.setNormalizedName(MultiLanguageString.importFromString("pt16:micro-pagamentos"));
              Functionality x1589 = new Functionality(MultiLanguageString.importFromString("pt6:In�cio"));
           ...
           Module x1596 = new Module(MultiLanguageString.importFromString("pt34:Projectos Institucionais do IST-ID"),"/istidInstitucionalProjectsManagement");
           x823.addChild(x1596);
           ...
           Module x1602 = new Module(MultiLanguageString.importFromString("pt33:Projectos Institucionais da ADIST"),"/adistInstitucionalProjectsManagement");
           x823.addChild(x1602);
        ...
        Portal x3 = new Portal();
           ...
           Section x9 = new Section(x3, MultiLanguageString.importFromString("en7:Teacherpt8:Doc�ncia"));
           x9.setName(MultiLanguageString.importFromString("en7:Teacherpt8:Doc�ncia"));
           x9.setNormalizedName(MultiLanguageString.importFromString("en7:teacherpt8:docencia"));
           x9.setMaximizable(false);
              FunctionalityCall x8 = makeFunctionalityCall(x9, x828, "pt8:Doc�ncia", null, null, null, "pt8:docencia");
           ...
           Section x15 = new Section(x3, MultiLanguageString.importFromString("pt18:Gest�o de Recursos"));
           x15.setName(MultiLanguageString.importFromString("pt18:Gest�o de Recursos"));
           x15.setNormalizedName(MultiLanguageString.importFromString("pt18:gestao-de-recursos"));
              FunctionalityCall x14 = makeFunctionalityCall(x15, x834, "pt18:Gest�o de Recursos", null, null, null, "pt18:gestao-de-recursos");
           ...
           Section x18 = new Section(x3, MultiLanguageString.importFromString("pt36:Portal do Candidato a P�s-Gradua��es"));
           x18.setName(MultiLanguageString.importFromString("pt36:Portal do Candidato a P�s-Gradua��es"));
           x18.setNormalizedName(MultiLanguageString.importFromString("pt36:portal-do-candidato-a-pos-graduacoes"));
              FunctionalityCall x17 = makeFunctionalityCall(x18, x837, "pt36:Portal do Candidato a P�s-Gradua��es", null, null, null, "pt36:portal-do-candidato-a-pos-graduacoes");
           ...
           Section x21 = new Section(x3, MultiLanguageString.importFromString("pt35:Portal de Servi�os de P�s-Gradua��o"));
           x21.setName(MultiLanguageString.importFromString("pt35:Portal de Servi�os de P�s-Gradua��o"));
           x21.setNormalizedName(MultiLanguageString.importFromString("pt35:portal-de-servicos-de-pos-graduacao"));
              FunctionalityCall x20 = makeFunctionalityCall(x21, x840, "pt35:Portal de Servi�os de P�s-Gradua��o", null, null, null, "pt35:portal-de-servicos-de-pos-graduacao");
           ...
           Section x27 = new Section(x3, MultiLanguageString.importFromString("pt11:Funcion�rio"));
           x27.setName(MultiLanguageString.importFromString("pt11:Funcion�rio"));
           x27.setNormalizedName(MultiLanguageString.importFromString("pt11:funcionario"));
              FunctionalityCall x26 = makeFunctionalityCall(x27, x846, "pt11:Funcion�rio", null, null, null, "pt11:funcionario");
           ...
           Section x31 = new Section(x3, MultiLanguageString.importFromString("pt15:�rea de Pessoal"));
           x31.setName(MultiLanguageString.importFromString("pt15:�rea de Pessoal"));
           x31.setNormalizedName(MultiLanguageString.importFromString("pt15:area-de-pessoal"));
              Section x30 = new Section(x31, MultiLanguageString.importFromString("pt25:Consultas por Funcion�rio"));
              x30.setName(MultiLanguageString.importFromString("pt25:Consultas por Funcion�rio"));
              x30.setNormalizedName(MultiLanguageString.importFromString("pt25:consultas-por-funcionario"));
                 ...
                 FunctionalityCall x32 = makeFunctionalityCall(x30, x852, "pt7:Hor�rio", null, null, null, "pt7:horario");
                 FunctionalityCall x33 = makeFunctionalityCall(x30, x853, "pt9:Marca��es", null, null, null, "pt9:marcacoes");
                 FunctionalityCall x34 = makeFunctionalityCall(x30, x854, "pt13:Justifica��es", null, null, null, "pt13:justificacoes");
                 FunctionalityCall x35 = makeFunctionalityCall(x30, x855, "pt12:Resumo Saldo", null, null, null, "pt12:resumo-saldo");
                 FunctionalityCall x36 = makeFunctionalityCall(x30, x856, "pt6:F�rias", null, null, null, "pt6:ferias");
                 FunctionalityCall x37 = makeFunctionalityCall(x30, x857, "pt6:Status", null, null, null, "pt6:status");
              ExpressionGroupAvailability x1677 = new ExpressionGroupAvailability(x30, "assiduousnessSectionStaff || assiduousnessManagers");
              x1677.setTargetGroup(Group.fromString("assiduousnessSectionStaff || assiduousnessManagers"));
              x30.setAvailabilityPolicy(x1677);
              Section x40 = new Section(x31, MultiLanguageString.importFromString("pt21:Todos os Funcion�rios"));
              x40.setName(MultiLanguageString.importFromString("pt21:Todos os Funcion�rios"));
              x40.setNormalizedName(MultiLanguageString.importFromString("pt21:todos-os-funcionarios"));
                 FunctionalityCall x39 = makeFunctionalityCall(x40, x860, "pt20:Inserir Justifica��o", null, null, null, "pt20:inserir-justificacao");
              ...
              x43.setNormalizedName(MultiLanguageString.importFromString("pt9:consultas"));
                 FunctionalityCall x42 = makeFunctionalityCall(x43, x863, "pt8:Hor�rios", null, null, null, "pt8:horarios");
                 FunctionalityCall x44 = makeFunctionalityCall(x43, x865, "pt13:Justifica��es", null, null, null, "pt13:justificacoes");
                 FunctionalityCall x45 = makeFunctionalityCall(x43, x866, "pt14:Regulariza��es", null, null, null, "pt14:regularizacoes");
                 FunctionalityCall x46 = makeFunctionalityCall(x43, x867, "pt11:Toler�ncias", null, null, null, "pt11:tolerancias");
                 FunctionalityCall x47 = makeFunctionalityCall(x43, x868, "pt6:Status", null, null, null, "pt6:status");
              ExpressionGroupAvailability x1679 = new ExpressionGroupAvailability(x43, "assiduousnessSectionStaff || assiduousnessManagers");
              ...
              x50.setNormalizedName(MultiLanguageString.importFromString("pt8:exportar"));
                 FunctionalityCall x49 = makeFunctionalityCall(x50, x870, "pt17:Exportar Verbetes", null, null, null, "pt17:exportar-verbetes");
                 FunctionalityCall x51 = makeFunctionalityCall(x50, x872, "pt16:Exportar Resumos", null, null, null, "pt16:exportar-resumos");
                 FunctionalityCall x52 = makeFunctionalityCall(x50, x873, "pt22:Exportar Justifica��es", null, null, null, "pt22:exportar-justificacoes");
                 FunctionalityCall x53 = makeFunctionalityCall(x50, x874, "pt19:Exportar Destacados", null, null, null, "pt19:exportar-destacados");
                 FunctionalityCall x54 = makeFunctionalityCall(x50, x875, "pt14:Exportar ADIST", null, null, null, "pt14:exportar-adist");
                 FunctionalityCall x55 = makeFunctionalityCall(x50, x876, "pt15:Exportar F�rias", null, null, null, "pt15:exportar-ferias");
              ExpressionGroupAvailability x1680 = new ExpressionGroupAvailability(x50, "assiduousnessSectionStaff || assiduousnessManagers");
              x1680.setTargetGroup(Group.fromString("assiduousnessSectionStaff || assiduousnessManagers"));
              x50.setAvailabilityPolicy(x1680);
              Section x58 = new Section(x31, MultiLanguageString.importFromString("pt12:Fecho do M�s"));
              x58.setName(MultiLanguageString.importFromString("pt12:Fecho do M�s"));
              x58.setNormalizedName(MultiLanguageString.importFromString("pt12:fecho-do-mes"));
                 FunctionalityCall x57 = makeFunctionalityCall(x58, x878, "pt21:Fechar M�s e Exportar", null, null, null, "pt21:fechar-mes-e-exportar");
              ...
              Section x61 = new Section(x31, MultiLanguageString.importFromString("pt5:B�nus"));
              x61.setName(MultiLanguageString.importFromString("pt5:B�nus"));
              x61.setNormalizedName(MultiLanguageString.importFromString("pt5:bonus"));
                 FunctionalityCall x60 = makeFunctionalityCall(x61, x891, "pt17:Presta��es Anuais", null, null, null, "pt17:prestacoes-anuais");
                 FunctionalityCall x62 = makeFunctionalityCall(x61, x893, "pt14:Importar B�nus", null, null, null, "pt14:importar-bonus");
                 FunctionalityCall x63 = makeFunctionalityCall(x61, x894, "pt15:Consultar B�nus", null, null, null, "pt15:consultar-bonus");
              ...
              Section x66 = new Section(x31, MultiLanguageString.importFromString("pt6:F�rias"));
              x66.setName(MultiLanguageString.importFromString("pt6:F�rias"));
              x66.setNormalizedName(MultiLanguageString.importFromString("pt6:ferias"));
                 FunctionalityCall x65 = makeFunctionalityCall(x66, x897, "pt18:Calcular A17 e A18", null, null, null, "pt18:calcular-a17-e-a18");
              ExpressionGroupAvailability x1683 = new ExpressionGroupAvailability(x66, "assiduousnessSectionStaff || assiduousnessManagers");
              x1683.setTargetGroup(Group.fromString("assiduousnessSectionStaff || assiduousnessManagers"));
              x66.setAvailabilityPolicy(x1683);
              Section x70 = new Section(x31, MultiLanguageString.importFromString("pt23:Trabalho Extraordin�rio"));
              x70.setName(MultiLanguageString.importFromString("pt23:Trabalho Extraordin�rio"));
              x70.setNormalizedName(MultiLanguageString.importFromString("pt23:trabalho-extraordinario"));
              x70.setMaximizable(false);
                 Section x69 = new Section(x70, MultiLanguageString.importFromString("pt23:Trabalho Extraordin�rio"));
                 x69.setName(MultiLanguageString.importFromString("pt23:Trabalho Extraordin�rio"));
                 x69.setNormalizedName(MultiLanguageString.importFromString("pt23:trabalho-extraordinario"));
                 x69.setMaximizable(true);
                    FunctionalityCall x68 = makeFunctionalityCall(x69, x881, "pt19:Inserir Autoriza��o", null, null, null, "pt19:inserir-autorizacao");
                    FunctionalityCall x71 = makeFunctionalityCall(x69, x883, "pt16:Ver Autoriza��es", null, null, null, "pt16:ver-autorizacoes");
                    FunctionalityCall x72 = makeFunctionalityCall(x69, x884, "pt17:Pedidos Pagamento", null, null, null, "pt17:pedidos-pagamento");
                    FunctionalityCall x73 = makeFunctionalityCall(x69, x885, "pt19:Verbas Centro Custo", null, null, null, "pt19:verbas-centro-custo");
                    FunctionalityCall x74 = makeFunctionalityCall(x69, x886, "pt26:Fechar Trab Extraordin�rio", null, null, null, "pt26:fechar-trab-extraordinario");
                    FunctionalityCall x75 = makeFunctionalityCall(x69, x887, "pt25:Exportar por Funcion�rios", null, null, null, "pt25:exportar-por-funcionarios");
                    FunctionalityCall x76 = makeFunctionalityCall(x69, x888, "pt21:Exportar por Unidades", null, null, null, "pt21:exportar-por-unidades");
                    FunctionalityCall x77 = makeFunctionalityCall(x69, x896, "pt17:Sec��o de Pessoal", null, null, null, "pt17:seccao-de-pessoal");
              ...
              Section x82 = new Section(x31, MultiLanguageString.importFromString("en13:Communicationpt11:Comunica��o"));
              x82.setName(MultiLanguageString.importFromString("en13:Communicationpt11:Comunica��o"));
              x82.setNormalizedName(MultiLanguageString.importFromString("en13:communicationpt11:comunicacao"));
                 FunctionalityCall x81 = makeFunctionalityCall(x82, x900, "en6:Groupspt6:Grupos", null, null, null, "en6:groupspt6:grupos");
              ...
              x86.setMaximizable(false);
                 ...
                 x85.setMaximizable(true);
                    ...
                    // A previous node
                    x85.addChild(x906);
                 FunctionalityCall x87 = makeFunctionalityCall(x86, x907, "pt23:Situa��es Profissionais", null, null, null, "pt23:situacoes-profissionais");
                 ...
                 FunctionalityCall x88 = makeFunctionalityCall(x86, x908, "pt24:Categorias Profissionais", null, null, null, "pt24:categorias-profissionais");
                 ...
                 FunctionalityCall x89 = makeFunctionalityCall(x86, x909, "pt23:Equipara��es a Bolseiro", null, null, null, "pt23:equiparacoes-a-bolseiro");
                 ...
                 FunctionalityCall x90 = makeFunctionalityCall(x86, x910, "pt20:Dispensas de Servi�o", null, null, null, "pt20:dispensas-de-servico");
              ...
              ExpressionGroupAvailability x1690 = new ExpressionGroupAvailability(x86, "assiduousnessSectionStaff || assiduousnessManagers");
              x1690.setTargetGroup(Group.fromString("assiduousnessSectionStaff || assiduousnessManagers"));
              x86.setAvailabilityPolicy(x1690);
              FunctionalityCall x92 = makeFunctionalityCall(x31, x896, "pt17:Sec��o de Pessoal", null, null, null, "pt17:seccao-de-pessoal");
           ...
           x96.setMaximizable(false);
              ...
              x95.setNormalizedName(MultiLanguageString.importFromString("pt18:mensagens-e-avisos"));
                 FunctionalityCall x94 = makeFunctionalityCall(x95, x915, "pt16:Envio de E-mails", null, null, null, "pt16:envio-de-e-mails");
                 FunctionalityCall x97 = makeFunctionalityCall(x95, x917, "pt16:Gest�o de Avisos", null, null, null, "pt16:gestao-de-avisos");
                 FunctionalityCall x98 = makeFunctionalityCall(x95, x918, "pt16:Gest�o de Boards", null, null, null, "pt16:gestao-de-boards");
              Section x102 = new Section(x96, MultiLanguageString.importFromString("pt34:Gest�o da Estrutura Organizacional"));
              x102.setName(MultiLanguageString.importFromString("pt34:Gest�o da Estrutura Organizacional"));
              x102.setNormalizedName(MultiLanguageString.importFromString("pt34:gestao-da-estrutura-organizacional"));
                 Section x101 = new Section(x102, MultiLanguageString.importFromString("pt27:Gest�o de Unidades e Cargos"));
                 x101.setName(MultiLanguageString.importFromString("pt27:Gest�o de Unidades e Cargos"));
                 ...
                 x101.setMaximizable(true);
                    ...
                    FunctionalityCall x105 = makeFunctionalityCall(x101, x928, "pt16:Criar Novo Cargo", null, null, null, "pt16:criar-novo-cargo");
                    FunctionalityCall x106 = makeFunctionalityCall(x101, x929, "pt12:Editar Cargo", null, null, null, "pt12:editar-cargo");
                    FunctionalityCall x107 = makeFunctionalityCall(x101, x930, "pt16:Escolha do Cargo", null, null, null, "pt16:escolha-do-cargo");
                    FunctionalityCall x108 = makeFunctionalityCall(x101, x931, "pt20:Escolher Unidade Pai", null, null, null, "pt20:escolher-unidade-pai");
                    ...
                    FunctionalityCall x112 = makeFunctionalityCall(x101, x920, "pt27:Gest�o de Unidades e Cargos", null, null, null, "pt27:gestao-de-unidades-e-cargos");
                 ...
                 FunctionalityCall x115 = makeFunctionalityCall(x102, x923, "en20:Unit Site Managementpt26:Gest�o de Sites de Unidade", null, null, null, "en20:unit-site-managementpt26:gestao-de-sites-de-unidade");
              Section x122 = new Section(x96, MultiLanguageString.importFromString("pt29:Gest�o da Estrutura de Ensino"));
              x122.setName(MultiLanguageString.importFromString("pt29:Gest�o da Estrutura de Ensino"));
                 ...
                 x121.setMaximizable(true);
                    ...
                    x120.setNormalizedName(MultiLanguageString.importFromString("pt17:administrar-curso"));
                       ...
                       x119.setNormalizedName(MultiLanguageString.importFromString("pt28:administrar-plano-curricular"));
                          Section x118 = new Section(x119, MultiLanguageString.importFromString("pt22:Gest�o de Preced�ncias"));
                          x118.setName(MultiLanguageString.importFromString("pt22:Gest�o de Preced�ncias"));
                          x118.setNormalizedName(MultiLanguageString.importFromString("pt22:gestao-de-precedencias"));
                             FunctionalityCall x117 = makeFunctionalityCall(x118, x955, "pt25:Criar Preced�ncia Simples", null, null, null, "pt25:criar-precedencia-simples");
                             FunctionalityCall x123 = makeFunctionalityCall(x118, x957, "pt31:Criar Conjun��o de Preced�ncias", null, null, null, "pt31:criar-conjuncao-de-precedencias");
                             FunctionalityCall x124 = makeFunctionalityCall(x118, x958, "pt18:Apagar Preced�ncia", null, null, null, "pt18:apagar-precedencia");
                          ...
                          x128.setNormalizedName(MultiLanguageString.importFromString("pt33:administrar-disciplina-curricular"));
                             Section x127 = new Section(x128, MultiLanguageString.importFromString("pt28:Associar disciplina execu��o"));
                             x127.setName(MultiLanguageString.importFromString("pt28:Associar disciplina execu��o"));
                             x127.setNormalizedName(MultiLanguageString.importFromString("pt28:associar-disciplina-execucao"));
                                FunctionalityCall x126 = makeFunctionalityCall(x127, x970, "pt28:Escolher Periodo de Execu��o", null, null, null, "pt28:escolher-periodo-de-execucao");
                                FunctionalityCall x129 = makeFunctionalityCall(x127, x972, "pt28:Escolher Disciplina Execu��o", null, null, null, "pt28:escolher-disciplina-execucao");
                             ...
                             x132.setNormalizedName(MultiLanguageString.importFromString("pt20:editar-corpo-docente"));
                                FunctionalityCall x131 = makeFunctionalityCall(x132, x974, "pt16:Associar Docente", null, null, null, "pt16:associar-docente");
                                FunctionalityCall x133 = makeFunctionalityCall(x132, x976, "pt37:Associar docente n�o vinculado ao IST", null, null, null, "pt37:associar-docente-nao-vinculado-ao-ist");
                                FunctionalityCall x134 = makeFunctionalityCall(x132, x977, "pt18:Guardar Altera��es", null, null, null, "pt18:guardar-alteracoes");
                             FunctionalityCall x136 = makeFunctionalityCall(x128, x960, "pt28:Editar Disciplina Curricular", null, null, null, "pt28:editar-disciplina-curricular");
                             FunctionalityCall x137 = makeFunctionalityCall(x128, x962, "pt14:Inserir �mbito", null, null, null, "pt14:inserir-ambito");
                             FunctionalityCall x138 = makeFunctionalityCall(x128, x963, "en30:Editing Curricular Informationpt31:Edi��o de Informa��o Curricular", null, null, null, "en30:editing-curricular-informationpt31:edicao-de-informacao-curricular");
                             FunctionalityCall x139 = makeFunctionalityCall(x128, x964, "pt11:Criar Sitio", null, null, null, "pt11:criar-sitio");
                             FunctionalityCall x140 = makeFunctionalityCall(x128, x965, "pt13:Editar �mbito", null, null, null, "pt13:editar-ambito");
                             FunctionalityCall x141 = makeFunctionalityCall(x128, x966, "pt14:Inserir �mbito", null, null, null, "pt14:inserir-ambito");
                             FunctionalityCall x142 = makeFunctionalityCall(x128, x967, "pt15:Terminar �mbito", null, null, null, "pt15:terminar-ambito");
                             FunctionalityCall x143 = makeFunctionalityCall(x128, x968, "pt13:Apagar �mbito", null, null, null, "pt13:apagar-ambito");
                             FunctionalityCall x144 = makeFunctionalityCall(x128, x969, "pt27:Visualizar todos os �mbitos", null, null, null, "pt27:visualizar-todos-os-ambitos");
                          FunctionalityCall x146 = makeFunctionalityCall(x119, x950, "pt23:Editar plano curricular", null, null, null, "pt23:editar-plano-curricular");
                          FunctionalityCall x147 = makeFunctionalityCall(x119, x952, "pt29:Inserir disciplina curricular", null, null, null, "pt29:inserir-disciplina-curricular");
                          FunctionalityCall x148 = makeFunctionalityCall(x119, x953, "pt15:Gest�o de Ramos", null, null, null, "pt15:gestao-de-ramos");
                          FunctionalityCall x149 = makeFunctionalityCall(x119, x954, "pt44:Gest�o de Grupos de Disciplinas Curriculares", null, null, null, "pt44:gestao-de-grupos-de-disciplinas-curriculares");
                       FunctionalityCall x151 = makeFunctionalityCall(x120, x946, "pt12:Editar Curso", null, null, null, "pt12:editar-curso");
                       FunctionalityCall x152 = makeFunctionalityCall(x120, x948, "pt24:Inserir plano curricular", null, null, null, "pt24:inserir-plano-curricular");
                       FunctionalityCall x153 = makeFunctionalityCall(x120, x949, "pt26:Apagar Planos Curriculares", null, null, null, "pt26:apagar-planos-curriculares");
                    ...
                    FunctionalityCall x157 = makeFunctionalityCall(x121, x937, "pt26:Estrutura de Cursos Antiga", null, null, null, "pt26:estrutura-de-cursos-antiga");
                 Section x160 = new Section(x122, MultiLanguageString.importFromString("pt23:Compet�ncia Pr�-Bolonha"));
                 x160.setName(MultiLanguageString.importFromString("pt23:Compet�ncia Pr�-Bolonha"));
                 x160.setNormalizedName(MultiLanguageString.importFromString("pt23:competencia-pre-bolonha"));
                 x160.setMaximizable(true);
                    FunctionalityCall x159 = makeFunctionalityCall(x160, x983, "pt37:Inserir-Editar Disciplina Compet�ncia", null, null, null, "pt37:inserir-editar-disciplina-competencia");
                    FunctionalityCall x161 = makeFunctionalityCall(x160, x985, "pt33:Criar Nova Disciplina Compet�ncia", null, null, null, "pt33:criar-nova-disciplina-competencia");
                    FunctionalityCall x162 = makeFunctionalityCall(x160, x939, "pt23:Compet�ncia Pr�-Bolonha", null, null, null, "pt23:competencia-pre-bolonha");
                 Section x165 = new Section(x122, MultiLanguageString.importFromString("pt20:Compet�ncias Bolonha"));
                 x165.setName(MultiLanguageString.importFromString("pt20:Compet�ncias Bolonha"));
                 x165.setNormalizedName(MultiLanguageString.importFromString("pt20:competencias-bolonha"));
                 x165.setMaximizable(true);
                    FunctionalityCall x164 = makeFunctionalityCall(x165, x987, "pt26:Ver Disciplina Compet�ncia", null, null, null, "pt26:ver-disciplina-competencia");
                    FunctionalityCall x166 = makeFunctionalityCall(x165, x989, "pt29:Editar Disciplina Compet�ncia", null, null, null, "pt29:editar-disciplina-competencia");
                    FunctionalityCall x167 = makeFunctionalityCall(x165, x990, "pt29:Editar Disciplina Compet�ncia", null, null, null, "pt29:editar-disciplina-competencia");
                    FunctionalityCall x168 = makeFunctionalityCall(x165, x941, "pt20:Compet�ncias Bolonha", null, null, null, "pt20:competencias-bolonha");
                 FunctionalityCall x170 = makeFunctionalityCall(x122, x942, "pt29:Gerir Cursos de Departamentos", null, null, null, "pt29:gerir-cursos-de-departamentos");
                 FunctionalityCall x171 = makeFunctionalityCall(x122, x940, "pt19:Estrutura de Cursos", null, null, null, "pt19:estrutura-de-cursos");
              Section x176 = new Section(x96, MultiLanguageString.importFromString("pt19:Gest�o de Execu��es"));
              x176.setName(MultiLanguageString.importFromString("pt19:Gest�o de Execu��es"));
              x176.setNormalizedName(MultiLanguageString.importFromString("pt19:gestao-de-execucoes"));
                 Section x175 = new Section(x176, MultiLanguageString.importFromString("pt19:Curr�culos Execu��o"));
                 x175.setName(MultiLanguageString.importFromString("pt19:Curr�culos Execu��o"));
                 x175.setNormalizedName(MultiLanguageString.importFromString("pt19:curriculos-execucao"));
                 x175.setMaximizable(true);
                    Section x174 = new Section(x175, MultiLanguageString.importFromString("pt29:Gest�o de Curr�culos Execu��o"));
                    x174.setName(MultiLanguageString.importFromString("pt29:Gest�o de Curr�culos Execu��o"));
                    x174.setNormalizedName(MultiLanguageString.importFromString("pt29:gestao-de-curriculos-execucao"));
                       FunctionalityCall x173 = makeFunctionalityCall(x174, x1000, "pt25:Criar Curr�culos Execu��o", null, null, null, "pt25:criar-curriculos-execucao");
                       FunctionalityCall x177 = makeFunctionalityCall(x174, x1002, "pt26:Editar Curr�culos Execu��o", null, null, null, "pt26:editar-curriculos-execucao");
                       FunctionalityCall x178 = makeFunctionalityCall(x174, x1003, "pt28:Escolher Planos Curriculares", null, null, null, "pt28:escolher-planos-curriculares");
                       FunctionalityCall x179 = makeFunctionalityCall(x174, x1004, "pt25:Curr�culo Execu��o Criado", null, null, null, "pt25:curriculo-execucao-criado");
                    FunctionalityCall x181 = makeFunctionalityCall(x175, x998, "pt16:P�gina Principal", null, null, null, "pt16:pagina-principal");
                    FunctionalityCall x182 = makeFunctionalityCall(x175, x995, "pt19:Curr�culos Execu��o", null, null, null, "pt19:curriculos-execucao");
                 Section x186 = new Section(x176, MultiLanguageString.importFromString("pt20:Disciplinas Execu��o"));
                 x186.setName(MultiLanguageString.importFromString("pt20:Disciplinas Execu��o"));
                 x186.setNormalizedName(MultiLanguageString.importFromString("pt20:disciplinas-execucao"));
                 x186.setMaximizable(true);
                    Section x185 = new Section(x186, MultiLanguageString.importFromString("pt20:Disciplinas Execu��o"));
                    x185.setName(MultiLanguageString.importFromString("pt20:Disciplinas Execu��o"));
                    x185.setNormalizedName(MultiLanguageString.importFromString("pt20:disciplinas-execucao"));
                    x185.setMaximizable(false);
                       FunctionalityCall x184 = makeFunctionalityCall(x185, x1009, "pt27:Inserir Disciplina Execu��o", null, null, null, "pt27:inserir-disciplina-execucao");
                       FunctionalityCall x187 = makeFunctionalityCall(x185, x1011, "pt26:Editar Disciplina Execu��o", null, null, null, "pt26:editar-disciplina-execucao");
                       FunctionalityCall x188 = makeFunctionalityCall(x185, x1012, "pt27:Juntar Disciplinas Execu��o", null, null, null, "pt27:juntar-disciplinas-execucao");
                       FunctionalityCall x189 = makeFunctionalityCall(x185, x1013, "pt28:Criar Relat�rios de Doc�ncia", null, null, null, "pt28:criar-relatorios-de-docencia");
                       FunctionalityCall x190 = makeFunctionalityCall(x185, x1014, "pt29:Criar Disciplinas de Execu��o", null, null, null, "pt29:criar-disciplinas-de-execucao");
                       FunctionalityCall x191 = makeFunctionalityCall(x185, x1015, "pt28:Editar Disciplina Execu��o 1", null, null, null, "pt28:editar-disciplina-execucao-1");
                       FunctionalityCall x192 = makeFunctionalityCall(x185, x1016, "pt28:Editar Disciplina Execu��o 2", null, null, null, "pt28:editar-disciplina-execucao-2");
                       FunctionalityCall x193 = makeFunctionalityCall(x185, x1017, "pt30:Associar Disciplina Curricular", null, null, null, "pt30:associar-disciplina-curricular");
                       FunctionalityCall x194 = makeFunctionalityCall(x185, x1018, "pt27:Separar Disciplina Execu��o", null, null, null, "pt27:separar-disciplina-execucao");
                       FunctionalityCall x195 = makeFunctionalityCall(x185, x1019, "pt29:Juntar Disciplinas Execu��o 2", null, null, null, "pt29:juntar-disciplinas-execucao-2");
                    FunctionalityCall x197 = makeFunctionalityCall(x186, x1007, "pt14:P�gina Inicial", null, null, null, "pt14:pagina-inicial");
                    FunctionalityCall x198 = makeFunctionalityCall(x186, x996, "pt35:P�gina Inicial Disciplinas Execu��o", null, null, null, "pt35:pagina-inicial-disciplinas-execucao");
                 FunctionalityCall x200 = makeFunctionalityCall(x176, x993, "pt17:Periodos Execu��o", null, null, null, "pt17:periodos-execucao");
                 FunctionalityCall x201 = makeFunctionalityCall(x176, x997, "pt22:Periodos de Inscri��es", null, null, null, "pt22:periodos-de-inscricoes");
              Section x206 = new Section(x96, MultiLanguageString.importFromString("pt17:Gest�o de Pessoal"));
              x206.setName(MultiLanguageString.importFromString("pt17:Gest�o de Pessoal"));
              x206.setNormalizedName(MultiLanguageString.importFromString("pt17:gestao-de-pessoal"));
                 Section x205 = new Section(x206, MultiLanguageString.importFromString("pt18:Gest�o de Docentes"));
                 x205.setName(MultiLanguageString.importFromString("pt18:Gest�o de Docentes"));
                 x205.setNormalizedName(MultiLanguageString.importFromString("pt18:gestao-de-docentes"));
                 x205.setMaximizable(true);
                    Section x204 = new Section(x205, MultiLanguageString.importFromString("pt18:Gest�o de Docentes"));
                    x204.setName(MultiLanguageString.importFromString("pt18:Gest�o de Docentes"));
                    x204.setNormalizedName(MultiLanguageString.importFromString("pt18:gestao-de-docentes"));
                       FunctionalityCall x203 = makeFunctionalityCall(x204, x1030, "pt17:Editar Categorias", null, null, null, "pt17:editar-categorias");
                       FunctionalityCall x207 = makeFunctionalityCall(x204, x1032, "pt32:Desassociar Disciplinas Execu��o", null, null, null, "pt32:desassociar-disciplinas-execucao");
                       FunctionalityCall x208 = makeFunctionalityCall(x204, x1286, "pt21:Avalia��o de Docentes", null, null, null, "pt21:avaliacao-de-docentes");
                    ...
                    FunctionalityCall x210 = makeFunctionalityCall(x205, x1028, "pt14:P�gina Inicial", null, null, null, "pt14:pagina-inicial");
                    FunctionalityCall x211 = makeFunctionalityCall(x205, x1023, "pt18:Gest�o de Docentes", null, null, null, "pt18:gestao-de-docentes");
                 Section x214 = new Section(x206, MultiLanguageString.importFromString("pt16:Gest�o de Alunos"));
                 x214.setName(MultiLanguageString.importFromString("pt16:Gest�o de Alunos"));
                 x214.setNormalizedName(MultiLanguageString.importFromString("pt16:gestao-de-alunos"));
                 x214.setMaximizable(true);
                    FunctionalityCall x213 = makeFunctionalityCall(x214, x1035, "pt20:Criar Classifica��es", null, null, null, "pt20:criar-classificacoes");
                    FunctionalityCall x215 = makeFunctionalityCall(x214, x1025, "pt16:Gest�o de Alunos", null, null, null, "pt16:gestao-de-alunos");
                 Section x220 = new Section(x206, MultiLanguageString.importFromString("pt17:Gest�o de Pessoas"));
                 x220.setName(MultiLanguageString.importFromString("pt17:Gest�o de Pessoas"));
                 x220.setNormalizedName(MultiLanguageString.importFromString("pt17:gestao-de-pessoas"));
                 x220.setMaximizable(true);
                    Section x219 = new Section(x220, MultiLanguageString.importFromString("pt17:Gest�o de Pessoas"));
                    x219.setName(MultiLanguageString.importFromString("pt17:Gest�o de Pessoas"));
                    x219.setNormalizedName(MultiLanguageString.importFromString("pt17:gestao-de-pessoas"));
                       ...
                       x218.setNormalizedName(MultiLanguageString.importFromString("pt27:pessoas-externas-convidadas"));
                          FunctionalityCall x217 = makeFunctionalityCall(x218, x1053, "pt30:Criar Pessoa Externa-Convidada", null, null, null, "pt30:criar-pessoa-externa-convidada");
                          FunctionalityCall x221 = makeFunctionalityCall(x218, x1055, "pt18:Gest�o de Convites", null, null, null, "pt18:gestao-de-convites");
                       FunctionalityCall x223 = makeFunctionalityCall(x219, x1040, "pt13:Criar Pessoas", null, null, null, "pt13:criar-pessoas");
                       FunctionalityCall x224 = makeFunctionalityCall(x219, x1042, "pt15:Procurar Pessoa", null, null, null, "pt15:procurar-pessoa");
                       FunctionalityCall x225 = makeFunctionalityCall(x219, x1043, "pt21:Gest�o de Privil�gios", null, null, null, "pt21:gestao-de-privilegios");
                       FunctionalityCall x226 = makeFunctionalityCall(x219, x1044, "pt14:Gerar Password", null, null, null, "pt14:gerar-password");
                       FunctionalityCall x227 = makeFunctionalityCall(x219, x1045, "pt16:Cargos de Gest�o", null, null, null, "pt16:cargos-de-gestao");
                       FunctionalityCall x228 = makeFunctionalityCall(x219, x1046, "pt16:Cargos de Gest�o", null, null, null, "pt16:cargos-de-gestao");
                       FunctionalityCall x229 = makeFunctionalityCall(x219, x1047, "pt16:Cargos de Gest�o", null, null, null, "pt16:cargos-de-gestao");
                       FunctionalityCall x230 = makeFunctionalityCall(x219, x1048, "pt14:Activar Pessoa", null, null, null, "pt14:activar-pessoa");
                       FunctionalityCall x231 = makeFunctionalityCall(x219, x1049, "pt16:Cargos de Gest�o", null, null, null, "pt16:cargos-de-gestao");
                       FunctionalityCall x232 = makeFunctionalityCall(x219, x1050, "pt16:Cargos de Gest�o", null, null, null, "pt16:cargos-de-gestao");
                       FunctionalityCall x233 = makeFunctionalityCall(x219, x1051, "pt16:Cargos de Gest�o", null, null, null, "pt16:cargos-de-gestao");
                       FunctionalityCall x234 = makeFunctionalityCall(x219, x1052, "pt13:Editar Pessoa", null, null, null, "pt13:editar-pessoa");
                    FunctionalityCall x236 = makeFunctionalityCall(x220, x1038, "pt14:P�gina Inicial", null, null, null, "pt14:pagina-inicial");
                    FunctionalityCall x237 = makeFunctionalityCall(x220, x1026, "pt17:Gest�o de Pessoas", null, null, null, "pt17:gestao-de-pessoas");
                 FunctionalityCall x239 = makeFunctionalityCall(x206, x1027, "pt18:Gest�o de Feriados", null, null, null, "pt18:gestao-de-feriados");
                 FunctionalityCall x240 = makeFunctionalityCall(x206, x1059, "en15:Role Managementpt15:Gest�o de Roles", null, null, null, "en15:role-managementpt15:gestao-de-roles");
              Section x243 = new Section(x96, MultiLanguageString.importFromString("pt13:Equival�ncias"));
              x243.setName(MultiLanguageString.importFromString("pt13:Equival�ncias"));
              x243.setNormalizedName(MultiLanguageString.importFromString("pt13:equivalencias"));
                 FunctionalityCall x242 = makeFunctionalityCall(x243, x1061, "pt22:N�o necessita de fazer", null, null, null, "pt22:nao-necessita-de-fazer");
                 FunctionalityCall x244 = makeFunctionalityCall(x243, x1063, "pt13:Equival�ncias", null, null, null, "pt13:equivalencias");
              Section x249 = new Section(x96, MultiLanguageString.importFromString("pt19:Gest�o de Ficheiros"));
              x249.setName(MultiLanguageString.importFromString("pt19:Gest�o de Ficheiros"));
              x249.setNormalizedName(MultiLanguageString.importFromString("pt19:gestao-de-ficheiros"));
                 Section x248 = new Section(x249, MultiLanguageString.importFromString("pt20:Gera��o de Ficheiros"));
                 x248.setName(MultiLanguageString.importFromString("pt20:Gera��o de Ficheiros"));
                 x248.setNormalizedName(MultiLanguageString.importFromString("pt20:geracao-de-ficheiros"));
                 x248.setMaximizable(true);
                    Section x247 = new Section(x248, MultiLanguageString.importFromString("pt20:Gera��o de Ficheiros"));
                    x247.setName(MultiLanguageString.importFromString("pt20:Gera��o de Ficheiros"));
                    x247.setNormalizedName(MultiLanguageString.importFromString("pt20:geracao-de-ficheiros"));
                       FunctionalityCall x246 = makeFunctionalityCall(x247, x1070, "pt20:Ficheiro para a SIBS", null, null, null, "pt20:ficheiro-para-a-sibs");
                       FunctionalityCall x250 = makeFunctionalityCall(x247, x1072, "pt20:Ficheiro para Cartas", null, null, null, "pt20:ficheiro-para-cartas");
                    FunctionalityCall x252 = makeFunctionalityCall(x248, x1068, "pt16:P�gina Principal", null, null, null, "pt16:pagina-principal");
                    FunctionalityCall x253 = makeFunctionalityCall(x248, x1065, "pt20:Gera��o de Ficheiros", null, null, null, "pt20:geracao-de-ficheiros");
                 ...
                 x257.setMaximizable(true);
                    Section x256 = new Section(x257, MultiLanguageString.importFromString("pt19:Gest�o de Ficheiros"));
                    x256.setName(MultiLanguageString.importFromString("pt19:Gest�o de Ficheiros"));
                    x256.setNormalizedName(MultiLanguageString.importFromString("pt19:gestao-de-ficheiros"));
                       FunctionalityCall x255 = makeFunctionalityCall(x256, x1077, "pt16:Ficheiro da SIBS", null, null, null, "pt16:ficheiro-da-sibs");
                    FunctionalityCall x259 = makeFunctionalityCall(x257, x1075, "pt16:P�gina Principal", null, null, null, "pt16:pagina-principal");
                    FunctionalityCall x260 = makeFunctionalityCall(x257, x1067, "pt19:Upload de Ficheiros", null, null, null, "pt19:upload-de-ficheiros");
              Section x266 = new Section(x96, MultiLanguageString.importFromString("pt17:Gest�o Financeira"));
              x266.setName(MultiLanguageString.importFromString("pt17:Gest�o Financeira"));
              x266.setNormalizedName(MultiLanguageString.importFromString("pt17:gestao-financeira"));
                 Section x265 = new Section(x266, MultiLanguageString.importFromString("pt15:Gest�o de Guias"));
                 x265.setName(MultiLanguageString.importFromString("pt15:Gest�o de Guias"));
                 x265.setNormalizedName(MultiLanguageString.importFromString("pt15:gestao-de-guias"));
                 x265.setMaximizable(true);
                    Section x264 = new Section(x265, MultiLanguageString.importFromString("pt15:Gest�o de Guias"));
                    x264.setName(MultiLanguageString.importFromString("pt15:Gest�o de Guias"));
                    x264.setNormalizedName(MultiLanguageString.importFromString("pt15:gestao-de-guias"));
                       FunctionalityCall x263 = makeFunctionalityCall(x264, x1087, "pt15:Edi��o de Guias", null, null, null, "pt15:edicao-de-guias");
                    FunctionalityCall x268 = makeFunctionalityCall(x265, x1085, "pt16:P�gina Principal", null, null, null, "pt16:pagina-principal");
                    FunctionalityCall x269 = makeFunctionalityCall(x265, x1082, "pt15:Gest�o de Guias", null, null, null, "pt15:gestao-de-guias");
                 FunctionalityCall x271 = makeFunctionalityCall(x266, x1084, "pt31:Actualizar Situa��es de Propina", null, null, null, "pt31:actualizar-situacoes-de-propina");
              Section x274 = new Section(x96, MultiLanguageString.importFromString("pt13:Gest�o de CMS"));
              x274.setName(MultiLanguageString.importFromString("pt13:Gest�o de CMS"));
              x274.setNormalizedName(MultiLanguageString.importFromString("pt13:gestao-de-cms"));
                 FunctionalityCall x273 = makeFunctionalityCall(x274, x1092, "pt22:Grupos de Utilizadores", null, null, null, "pt22:grupos-de-utilizadores");
                 FunctionalityCall x275 = makeFunctionalityCall(x274, x1094, "pt13:Configura��es", null, null, null, "pt13:configuracoes");
                 FunctionalityCall x276 = makeFunctionalityCall(x274, x1095, "pt22:P�ginas de Disciplinas", null, null, null, "pt22:paginas-de-disciplinas");
              Section x279 = new Section(x96, MultiLanguageString.importFromString("pt17:Gest�o do Suporte"));
              x279.setName(MultiLanguageString.importFromString("pt17:Gest�o do Suporte"));
              x279.setNormalizedName(MultiLanguageString.importFromString("pt17:gestao-do-suporte"));
                 FunctionalityCall x278 = makeFunctionalityCall(x279, x1097, "pt19:Gest�o de Gloss�rio", null, null, null, "pt19:gestao-de-glossario");
                 FunctionalityCall x280 = makeFunctionalityCall(x279, x1099, "pt15:Gest�o de FAQ s", null, null, null, "pt15:gestao-de-faq s");
                 FunctionalityCall x281 = makeFunctionalityCall(x279, x1100, "pt15:Gest�o de FAQ s", null, null, null, "pt15:gestao-de-faq s");
              Section x284 = new Section(x96, MultiLanguageString.importFromString("pt18:Gest�o de Objectos"));
              x284.setName(MultiLanguageString.importFromString("pt18:Gest�o de Objectos"));
              x284.setNormalizedName(MultiLanguageString.importFromString("pt18:gestao-de-objectos"));
                 FunctionalityCall x283 = makeFunctionalityCall(x284, x1102, "pt15:Gest�o da Cache", null, null, null, "pt15:gestao-da-cache");
                 FunctionalityCall x285 = makeFunctionalityCall(x284, x1104, "pt26:Formata��o de Propriedades", null, null, null, "pt26:formatacao-de-propriedades");
                 FunctionalityCall x286 = makeFunctionalityCall(x284, x1105, "pt17:Fus�o de Objectos", null, null, null, "pt17:fusao-de-objectos");
                 FunctionalityCall x287 = makeFunctionalityCall(x284, x1106, "pt18:Edi��o de Objectos", null, null, null, "pt18:edicao-de-objectos");
                 FunctionalityCall x288 = makeFunctionalityCall(x284, x1107, "pt16:Fus�o de Pessoas", null, null, null, "pt16:fusao-de-pessoas");
              Section x291 = new Section(x96, MultiLanguageString.importFromString("pt17:Gest�o do Sistema"));
              x291.setName(MultiLanguageString.importFromString("pt17:Gest�o do Sistema"));
              x291.setNormalizedName(MultiLanguageString.importFromString("pt17:gestao-do-sistema"));
                 FunctionalityCall x290 = makeFunctionalityCall(x291, x1109, "pt25:Monitoriza��o de Servi�os", null, null, null, "pt25:monitorizacao-de-servicos");
                 FunctionalityCall x292 = makeFunctionalityCall(x291, x1111, "pt24:Monitoriza��o de Pedidos", null, null, null, "pt24:monitorizacao-de-pedidos");
                 FunctionalityCall x293 = makeFunctionalityCall(x291, x1112, "pt29:Monitoriza��o de Utilizadores", null, null, null, "pt29:monitorizacao-de-utilizadores");
                 FunctionalityCall x294 = makeFunctionalityCall(x291, x1113, "pt22:Informa��es do Sistema", null, null, null, "pt22:informacoes-do-sistema");
                 ...
                 FunctionalityCall x298 = makeFunctionalityCall(x291, x1117, "pt22:Sistema de Transac��es", null, null, null, "pt22:sistema-de-transaccoes");
                 FunctionalityCall x299 = makeFunctionalityCall(x291, x1118, "pt16:Gest�o de Logins", null, null, null, "pt16:gestao-de-logins");
                 FunctionalityCall x300 = makeFunctionalityCall(x291, x1119, "pt10:Queue jobs", null, null, null, "pt10:queue-jobs");
              Section x305 = new Section(x96, MultiLanguageString.importFromString("pt25:Gest�o de Funcionalidades"));
              x305.setName(MultiLanguageString.importFromString("pt25:Gest�o de Funcionalidades"));
              x305.setNormalizedName(MultiLanguageString.importFromString("pt25:gestao-de-funcionalidades"));
                 ...
                 x304.setNormalizedName(MultiLanguageString.importFromString("pt18:outros-mapeamentos"));
                    ...
                    x303.setNormalizedName(MultiLanguageString.importFromString("pt6:modulo"));
                       ...
                       FunctionalityCall x308 = makeFunctionalityCall(x303, x1131, "pt19:Organizar Estrutura", null, null, null, "pt19:organizar-estrutura");
                       FunctionalityCall x309 = makeFunctionalityCall(x303, x1132, "pt18:Exportar estrutura", null, null, null, "pt18:exportar-estrutura");
                       FunctionalityCall x310 = makeFunctionalityCall(x303, x1133, "pt18:Importar Estrutura", null, null, null, "pt18:importar-estrutura");
                       FunctionalityCall x311 = makeFunctionalityCall(x303, x1134, "pt18:Importar Estrutura", null, null, null, "pt18:importar-estrutura");
                    ...
                    x314.setNormalizedName(MultiLanguageString.importFromString("pt15:functionalidade"));
                       ...
                       FunctionalityCall x317 = makeFunctionalityCall(x314, x1140, "pt16:Confirmar Apagar", null, null, null, "pt16:confirmar-apagar");
                       FunctionalityCall x318 = makeFunctionalityCall(x314, x1141, "pt6:Apagar", null, null, null, "pt6:apagar");
                       FunctionalityCall x319 = makeFunctionalityCall(x314, x1142, "pt21:Gerir Disponibilidade", null, null, null, "pt21:gerir-disponibilidade");
                       FunctionalityCall x320 = makeFunctionalityCall(x314, x1143, "pt40:Interpretar express�o de disponibilidade", null, null, null, "pt40:interpretar-expressao-de-disponibilidade");
                    ...
                    x325.setNormalizedName(MultiLanguageString.importFromString("pt4:topo"));
                       ...
                       FunctionalityCall x326 = makeFunctionalityCall(x325, x1149, "pt19:Organizar Estrutura", null, null, null, "pt19:organizar-estrutura");
                       FunctionalityCall x327 = makeFunctionalityCall(x325, x1150, "pt18:Importar Estrutura", null, null, null, "pt18:importar-estrutura");
                 FunctionalityCall x330 = makeFunctionalityCall(x305, x1121, "pt19:Ver Funcionalidades", null, null, null, "pt19:ver-funcionalidades");
                 FunctionalityCall x331 = makeFunctionalityCall(x305, x1123, "pt13:Testar Filtro", null, null, null, "pt13:testar-filtro");
                 FunctionalityCall x332 = makeFunctionalityCall(x305, x1124, "pt20:Resultados do Filtro", null, null, null, "pt20:resultados-do-filtro");
                 FunctionalityCall x333 = makeFunctionalityCall(x305, x1125, "pt19:Linguagem de Grupos", null, null, null, "pt19:linguagem-de-grupos");
              ...
              x337.setNormalizedName(MultiLanguageString.importFromString("pt10:frameworks"));
                 ...
                 x336.setNormalizedName(MultiLanguageString.importFromString("pt6:struts"));
                    FunctionalityCall x335 = makeFunctionalityCall(x336, x1156, "pt14:Struts Example", null, null, null, "pt14:struts-example");
                    FunctionalityCall x338 = makeFunctionalityCall(x336, x1158, "pt27:Reload Struts Configuration", null, null, null, "pt27:reload-struts-configuration");
                 ...
                 x342.setNormalizedName(MultiLanguageString.importFromString("pt9:renderers"));
                    ...
                    x341.setNormalizedName(MultiLanguageString.importFromString("pt6:partes"));
                       FunctionalityCall x340 = makeFunctionalityCall(x341, x1164, "pt41:The first situation: presenting the world", null, null, null, "pt41:the-first-situation:-presenting-the-world");
                       FunctionalityCall x343 = makeFunctionalityCall(x341, x1166, "pt35:The second situation: give me input", null, null, null, "pt35:the-second-situation:-give-me-input");
                       FunctionalityCall x344 = makeFunctionalityCall(x341, x1167, "pt38:The third situation: input on steroids", null, null, null, "pt38:the-third-situation:-input-on-steroids");
                       FunctionalityCall x345 = makeFunctionalityCall(x341, x1168, "pt44:The fourth situation: renderers meet actions", null, null, null, "pt44:the-fourth-situation:-renderers-meet-actions");
                       FunctionalityCall x346 = makeFunctionalityCall(x341, x1169, "pt35:The fifth situation: a new renderer", null, null, null, "pt35:the-fifth-situation:-a-new-renderer");
                       FunctionalityCall x347 = makeFunctionalityCall(x341, x1170, "pt19:Appendix A: Schemas", null, null, null, "pt19:appendix-a:-schemas");
                    FunctionalityCall x349 = makeFunctionalityCall(x342, x1160, "pt18:Exemplos Renderers", null, null, null, "pt18:exemplos-renderers");
                    FunctionalityCall x350 = makeFunctionalityCall(x342, x1162, "pt28:Reler Configura��o Renderers", null, null, null, "pt28:reler-configuracao-renderers");
                    FunctionalityCall x351 = makeFunctionalityCall(x342, x1163, "pt30:Exemplo 1: Input from the user", null, null, null, "pt30:exemplo-1:-input-from-the-user");
                 FunctionalityCall x353 = makeFunctionalityCall(x337, x1154, "pt25:Java Server Faces Example", null, null, null, "pt25:java-server-faces-example");
              ...
              x356.setNormalizedName(MultiLanguageString.importFromString("pt10:pagamentos"));
                 FunctionalityCall x355 = makeFunctionalityCall(x356, x1174, "pt18:Upload de Ficheiro", null, null, null, "pt18:upload-de-ficheiro");
                 FunctionalityCall x357 = makeFunctionalityCall(x356, x1176, "pt16:Gerir Pagamentos", null, null, null, "pt16:gerir-pagamentos");
                 FunctionalityCall x358 = makeFunctionalityCall(x356, x1177, "pt20:Regras de Pagamentos", null, null, null, "pt20:regras-de-pagamentos");
                 FunctionalityCall x359 = makeFunctionalityCall(x356, x1178, "en13:Payment Codespt7:C�digos", null, null, null, "en13:payment-codespt21:mapeamento-de-codigos");
                 FunctionalityCall x360 = makeFunctionalityCall(x356, x1179, "en7:Reportspt10:Relat�rios", null, null, null, "en7:reportspt10:relatorios");
                 FunctionalityCall x361 = makeFunctionalityCall(x356, x1180, "pt21:Relat�rio de propinas", null, null, null, "pt21:relatorio-de-propinas");
                 FunctionalityCall x362 = makeFunctionalityCall(x356, x1181, "pt25:Exporta��o de refer�ncias", null, null, null, "pt25:exportacao-de-referencias");
                 FunctionalityCall x363 = makeFunctionalityCall(x356, x1182, "pt20:Relat�rio de Dividas", null, null, null, "pt20:relatorio-de-dividas");
              Section x366 = new Section(x96, MultiLanguageString.importFromString("pt21:Gest�o de Calend�rios"));
              x366.setName(MultiLanguageString.importFromString("pt21:Gest�o de Calend�rios"));
              x366.setNormalizedName(MultiLanguageString.importFromString("pt21:gestao-de-calendarios"));
                 FunctionalityCall x365 = makeFunctionalityCall(x366, x1184, "pt22:Calend�rios Acad�micos", null, null, null, "pt22:calendarios-academicos");
                 FunctionalityCall x367 = makeFunctionalityCall(x366, x1186, "pt26:Criar Calend�rio Acad�mico", null, null, null, "pt26:criar-calendario-academico");
              Section x370 = new Section(x96, MultiLanguageString.importFromString("pt23:Actividades Cient�ficas"));
              x370.setName(MultiLanguageString.importFromString("pt23:Actividades Cient�ficas"));
              x370.setNormalizedName(MultiLanguageString.importFromString("pt23:actividades-cientificas"));
                 FunctionalityCall x369 = makeFunctionalityCall(x370, x1188, "pt14:Editar Revista", null, null, null, "pt14:editar-revista");
                 FunctionalityCall x371 = makeFunctionalityCall(x370, x1190, "pt13:Editar Evento", null, null, null, "pt13:editar-evento");
                 FunctionalityCall x372 = makeFunctionalityCall(x370, x1191, "pt15:Juntar Revistas", null, null, null, "pt15:juntar-revistas");
                 FunctionalityCall x373 = makeFunctionalityCall(x370, x1192, "pt14:Juntar Eventos", null, null, null, "pt14:juntar-eventos");
                 FunctionalityCall x374 = makeFunctionalityCall(x370, x1193, "pt25:Juntar Volumes de Revista", null, null, null, "pt25:juntar-volumes-de-revista");
                 FunctionalityCall x375 = makeFunctionalityCall(x370, x1194, "pt24:Juntar Edi��es de Evento", null, null, null, "pt24:juntar-edicoes-de-evento");
                 FunctionalityCall x376 = makeFunctionalityCall(x370, x1195, "pt25:Juntar Volumes de Revista", null, null, null, "pt25:juntar-volumes-de-revista");
                 FunctionalityCall x377 = makeFunctionalityCall(x370, x1196, "pt24:Juntar Edi��es de Evento", null, null, null, "pt24:juntar-edicoes-de-evento");
              ...
              Section x383 = new Section(x96, MultiLanguageString.importFromString("pt20:Transi��o de Bolonha"));
              x383.setName(MultiLanguageString.importFromString("pt20:Transi��o de Bolonha"));
              x383.setNormalizedName(MultiLanguageString.importFromString("pt20:transicao-de-bolonha"));
                 FunctionalityCall x382 = makeFunctionalityCall(x383, x1201, "pt30:Planos de Equival�ncia Globais", null, null, null, "pt30:planos-de-equivalencia-globais");
                 FunctionalityCall x384 = makeFunctionalityCall(x383, x1203, "pt29:Planos de Equival�ncia Locais", null, null, null, "pt29:planos-de-equivalencia-locais");
                 FunctionalityCall x385 = makeFunctionalityCall(x383, x1204, "pt18:Curr�culo do Aluno", null, null, null, "pt18:curriculo-do-aluno");
              ...
              x388.setMaximizable(false);
                 ...
                 FunctionalityCall x389 = makeFunctionalityCall(x388, x1208, "pt16:Mover Inscri��es", null, null, null, "pt16:mover-inscricoes");
                 FunctionalityCall x390 = makeFunctionalityCall(x388, x1209, "pt19:Gest�o de Dispensas", null, null, null, "pt19:gestao-de-dispensas");
                 FunctionalityCall x391 = makeFunctionalityCall(x388, x1210, "pt23:Gest�o de Substitui��es", null, null, null, "pt23:gestao-de-substituicoes");
                 FunctionalityCall x392 = makeFunctionalityCall(x388, x1211, "pt23:Gest�o de Equival�ncias", null, null, null, "pt23:gestao-de-equivalencias");
                 FunctionalityCall x393 = makeFunctionalityCall(x388, x1212, "pt18:Gest�o de Cr�ditos", null, null, null, "pt18:gestao-de-creditos");
                 FunctionalityCall x394 = makeFunctionalityCall(x388, x1213, "pt20:Gest�o de Apuramento", null, null, null, "pt20:gestao-de-apuramento");
                 FunctionalityCall x395 = makeFunctionalityCall(x388, x1214, "pt17:Gest�o de Estados", null, null, null, "pt17:gestao-de-estados");
                 FunctionalityCall x396 = makeFunctionalityCall(x388, x1223, "pt17:Ver EnrolmentLogs", null, null, null, "pt17:ver-enrolmentlogs");
                 FunctionalityCall x397 = makeFunctionalityCall(x388, x1220, "pt12:Anular Pauta", null, null, null, "pt12:anular-pauta");
                 FunctionalityCall x398 = makeFunctionalityCall(x388, x1216, "pt18:Importa��o da DGES", null, null, null, "pt18:importacao-da-dges");
                 FunctionalityCall x399 = makeFunctionalityCall(x388, x1217, "pt28:Inscri��es em �poca Especial", null, null, null, "pt28:inscricoes-em-epoca-especial");
                 FunctionalityCall x400 = makeFunctionalityCall(x388, x1218, "pt27:Sum�rio Candidaturas 1� vez", null, null, null, "pt26:sumario-candidaturas-1-vez");
              FunctionalityCall x402 = makeFunctionalityCall(x96, x913, "pt16:P�gina Principal", null, null, null, "pt16:pagina-principal");
              ...
              x404.setMaximizable(false);
                 FunctionalityCall x403 = makeFunctionalityCall(x404, x1226, "pt19:Procurar Documentos", null, null, null, "pt19:procurar-documentos");
              ...
              Section x412 = new Section(x96, MultiLanguageString.importFromString("pt20:N�cleo P�s Gradua��o"));
              x412.setName(MultiLanguageString.importFromString("pt20:N�cleo P�s Gradua��o"));
              x412.setNormalizedName(MultiLanguageString.importFromString("pt20:nucleo-pos-graduacao"));
                 FunctionalityCall x411 = makeFunctionalityCall(x412, x1234, "pt25:Processos de doutoramento", null, null, null, "pt25:processos-de-doutoramento");
           ...
           Section x420 = new Section(x3, MultiLanguageString.importFromString("pt40:Sec��o de Pessoal Docente e Investigador"));
           x420.setName(MultiLanguageString.importFromString("pt40:Sec��o de Pessoal Docente e Investigador"));
           x420.setNormalizedName(MultiLanguageString.importFromString("pt40:seccao-de-pessoal-docente-e-investigador"));
              FunctionalityCall x419 = makeFunctionalityCall(x420, x1242, "pt40:Sec��o de Pessoal Docente e Investigador", null, null, null, "pt40:seccao-de-pessoal-docente-e-investigador");
           ...
           Section x423 = new Section(x3, MultiLanguageString.importFromString("pt53:Administra��o de cr�ditos de docentes do departamento"));
           x423.setName(MultiLanguageString.importFromString("pt53:Administra��o de cr�ditos de docentes do departamento"));
           x423.setNormalizedName(MultiLanguageString.importFromString("pt53:administracao-de-creditos-de-docentes-do-departamento"));
              FunctionalityCall x422 = makeFunctionalityCall(x423, x1245, "pt53:Administra��o de cr�ditos de docentes do departamento", null, null, null, "pt53:administracao-de-creditos-de-docentes-do-departamento");
           ...
           Section x426 = new Section(x3, MultiLanguageString.importFromString("en18:Scientific Councilpt19:Conselho Cient�fico"));
           x426.setName(MultiLanguageString.importFromString("en18:Scientific Councilpt19:Conselho Cient�fico"));
           ...
           x426.setMaximizable(false);
              FunctionalityCall x425 = makeFunctionalityCall(x426, x1248, "pt19:Conselho Cient�fico", null, null, null, "pt19:conselho-cientifico");
           ...
           Section x432 = new Section(x3, MultiLanguageString.importFromString("pt10:Semin�rios"));
           x432.setName(MultiLanguageString.importFromString("pt10:Semin�rios"));
           x432.setNormalizedName(MultiLanguageString.importFromString("pt10:seminarios"));
              FunctionalityCall x431 = makeFunctionalityCall(x432, x1254, "pt10:Semin�rios", null, null, null, "pt10:seminarios");
           ...
           x438.setNormalizedName(MultiLanguageString.importFromString("pt26:secretaria-de-departamento"));
              FunctionalityCall x437 = makeFunctionalityCall(x438, x1260, "pt26:Secretaria de Departamento", null, null, null, "pt26:secretaria-de-departamento");
           ...
           x441.setNormalizedName(MultiLanguageString.importFromString("pt33:gabinete-de-estudos-e-planeamento"));
              FunctionalityCall x440 = makeFunctionalityCall(x441, x1263, "pt33:Gabinete de Estudos e Planeamento", null, null, null, "pt33:gabinete-de-estudos-e-planeamento");
           ...
           x444.setMaximizable(false);
              FunctionalityCall x443 = makeFunctionalityCall(x444, x1266, "pt18:Conselho Directivo", null, null, null, "pt18:conselho-directivo");
           ...
           x453.setNormalizedName(MultiLanguageString.importFromString("pt24:projectos-institucionais"));
              FunctionalityCall x452 = makeFunctionalityCall(x453, x1275, "pt24:Projectos Institucionais", null, null, null, "pt24:projectos-institucionais");
           ...
           Section x459 = new Section(x3, MultiLanguageString.importFromString("en16:Space Managementpt17:Gest�o de Espa�os"));
           x459.setName(MultiLanguageString.importFromString("en16:Space Managementpt17:Gest�o de Espa�os"));
           ...
           x459.setMaximizable(false);
              FunctionalityCall x458 = makeFunctionalityCall(x459, x1281, "pt17:Gest�o de Espa�os", null, null, null, "pt17:gestao-de-espacos");
           ...
           x462.setMaximizable(false);
              FunctionalityCall x461 = makeFunctionalityCall(x462, x1284, "pt12:Investiga��o", null, null, null, "pt12:investigacao");
           ...
           Section x468 = new Section(x3, MultiLanguageString.importFromString("pt19:Conselho Pedag�gico"));
           x468.setName(MultiLanguageString.importFromString("pt19:Conselho Pedag�gico"));
           x468.setNormalizedName(MultiLanguageString.importFromString("pt19:conselho-pedagogico"));
              FunctionalityCall x467 = makeFunctionalityCall(x468, x1291, "pt19:Conselho Pedag�gico", null, null, null, "pt19:conselho-pedagogico");
           ...
           x471.setNormalizedName(MultiLanguageString.importFromString("pt19:portal-do-candidato"));
              FunctionalityCall x470 = makeFunctionalityCall(x471, x1294, "pt19:Portal do Candidato", null, null, null, "pt19:portal-do-candidato");
           ...
           Section x474 = new Section(x3, MultiLanguageString.importFromString("en9:Messagingpt11:Comunica��o"));
           x474.setName(MultiLanguageString.importFromString("en9:Messagingpt11:Comunica��o"));
           x474.setNormalizedName(MultiLanguageString.importFromString("en9:messagingpt11:comunicacao"));
              FunctionalityCall x473 = makeFunctionalityCall(x474, x1297, "pt11:Comunica��o", null, null, null, "pt11:comunicacao");
           ...
           Section x479 = new Section(x3, MultiLanguageString.importFromString("pt8:P�blicoX"));
           x479.setName(MultiLanguageString.importFromString("pt8:P�blicoX"));
           ...
           x479.setMaximizable(false);
              ...
              x478.setNormalizedName(MultiLanguageString.importFromString("pt5:sites"));
                 Section x477 = new Section(x478, MultiLanguageString.importFromString("pt19:Disciplina Execu��o"));
                 x477.setName(MultiLanguageString.importFromString("pt19:Disciplina Execu��o"));
                 x477.setNormalizedName(MultiLanguageString.importFromString("pt19:disciplina-execucao"));
                    FunctionalityCall x476 = makeFunctionalityCall(x477, x1300, "en12:Initial Pagept14:P�gina Inicial", null, null, null, "en12:initial-pagept14:pagina-inicial");
                    FunctionalityCall x480 = makeFunctionalityCall(x477, x1304, "en13:Announcementspt8:An�ncios", null, null, null, "en13:announcementspt8:anuncios");
                    FunctionalityCall x481 = makeFunctionalityCall(x477, x1305, "en8:Planningpt11:Planeamento", null, null, null, "en8:planningpt11:planeamento");
                    FunctionalityCall x482 = makeFunctionalityCall(x477, x1306, "en9:Summariespt8:Sum�rios", null, null, null, "en9:summariespt8:sumarios");
                    FunctionalityCall x483 = makeFunctionalityCall(x477, x1307, "en10:Objectivespt10:Objectivos", null, null, null, "en10:objectivespt10:objectivos");
                    FunctionalityCall x484 = makeFunctionalityCall(x477, x1308, "en7:Programpt8:Programa", null, null, null, "en7:programpt8:programa");
                    FunctionalityCall x485 = makeFunctionalityCall(x477, x1309, "en17:Evaluation Methodpt19:M�todo de Avalia��o", null, null, null, "en17:evaluation-methodpt19:metodo-de-avaliacao");
                    FunctionalityCall x486 = makeFunctionalityCall(x477, x1310, "en12:Bibliographypt12:Bibliografia", null, null, null, "en12:bibliographypt12:bibliografia");
                    FunctionalityCall x487 = makeFunctionalityCall(x477, x1311, "en9:Timesheetpt7:Hor�rio", null, null, null, "en9:timesheetpt7:horario");
                    FunctionalityCall x488 = makeFunctionalityCall(x477, x1312, "en6:Shiftspt6:Turnos", null, null, null, "en6:shiftspt6:turnos");
                    FunctionalityCall x489 = makeFunctionalityCall(x477, x1313, "en10:Evaluationpt9:Avalia��o", null, null, null, "en10:evaluationpt9:avaliacao");
                    ...
                    FunctionalityCall x491 = makeFunctionalityCall(x477, x1315, "pt10:Ver Sec��o", null, null, null, "pt10:ver-seccao");
                 ...
                 x495.setNormalizedName(MultiLanguageString.importFromString("pt12:site-pessoal"));
                    FunctionalityCall x494 = makeFunctionalityCall(x495, x1319, "en12:Presentationpt12:Apresenta��o", null, null, null, "en12:presentationpt12:apresentacao");
                    FunctionalityCall x496 = makeFunctionalityCall(x495, x1321, "en18:Research Interestspt22:Interesses Cient�ficos", null, null, null, "en18:research-interestspt22:interesses-cientificos");
                    FunctionalityCall x497 = makeFunctionalityCall(x495, x1322, "en12:Publicationspt11:Publica��es", null, null, null, "en12:publicationspt11:publicacoes");
                    ...
                    FunctionalityCall x500 = makeFunctionalityCall(x495, x1325, "en6:Prizespt7:Pr�mios", null, null, null, "en6:prizespt7:premios");
                 ...
                 x503.setNormalizedName(MultiLanguageString.importFromString("en6:degreept5:curso"));
                    FunctionalityCall x502 = makeFunctionalityCall(x503, x1327, "en11:Descriptionpt9:Descri��o", null, null, null, "en11:descriptionpt9:descricao");
                    FunctionalityCall x504 = makeFunctionalityCall(x503, x1329, "en13:Announcementspt8:An�ncios", null, null, null, "en13:announcementspt8:anuncios");
                    FunctionalityCall x505 = makeFunctionalityCall(x503, x1330, "en22:Admission Requirementspt16:Regime de Acesso", null, null, null, "en22:admission-requirementspt16:regime-de-acesso");
                    FunctionalityCall x506 = makeFunctionalityCall(x503, x1331, "en19:Professional Statuspt21:Estatuto Profissional", null, null, null, "en19:professional-statuspt21:estatuto-profissional");
                    FunctionalityCall x507 = makeFunctionalityCall(x503, x1332, "en15:Curricular Planpt16:Plano Curricular", null, null, null, "en15:curricular-planpt16:plano-curricular");
                    FunctionalityCall x508 = makeFunctionalityCall(x503, x1333, "en16:Course Web Pagespt22:P�ginas de Disciplinas", null, null, null, "en16:course-web-pagespt22:paginas-de-disciplinas");
                    FunctionalityCall x509 = makeFunctionalityCall(x503, x1334, "en15:Class timetablept18:Hor�rios por Turma", null, null, null, "en15:class-timetablept18:horarios-por-turma");
                    FunctionalityCall x510 = makeFunctionalityCall(x503, x1335, "en11:Evaluationspt10:Avalia��es", null, null, null, "en11:evaluationspt10:avaliacoes");
                    FunctionalityCall x511 = makeFunctionalityCall(x503, x1336, "en13:Dissertationspt12:Disserta��es", null, null, null, "en13:dissertationspt12:dissertacoes");
                 ...
                 x514.setNormalizedName(MultiLanguageString.importFromString("pt12:departamento"));
                    FunctionalityCall x513 = makeFunctionalityCall(x514, x1338, "en13:Announcementspt8:An�ncios", null, null, null, "en13:announcementspt8:anuncios");
                    FunctionalityCall x515 = makeFunctionalityCall(x514, x1340, "en7:Facultypt8:Docentes", null, null, null, "en7:facultypt8:docentes");
                    FunctionalityCall x516 = makeFunctionalityCall(x514, x1341, "en5:Staffpt12:Funcion�rios", null, null, null, "en5:staffpt12:funcionarios");
                    FunctionalityCall x517 = makeFunctionalityCall(x514, x1342, "en7:Coursespt11:Disciplinas", null, null, null, "en7:coursespt11:disciplinas");
                    FunctionalityCall x518 = makeFunctionalityCall(x514, x1343, "en6:Eventspt7:Eventos", null, null, null, "en6:eventspt7:eventos");
                    FunctionalityCall x519 = makeFunctionalityCall(x514, x1344, "en7:Degreespt6:Cursos", null, null, null, "en7:degreespt6:cursos");
                    FunctionalityCall x520 = makeFunctionalityCall(x514, x1345, "en12:Organizationpt9:Estrutura", null, null, null, "en12:organizationpt9:estrutura");
                    FunctionalityCall x521 = makeFunctionalityCall(x514, x1346, "en16:Scientific Areaspt17:�reas Cient�ficas", null, null, null, "en16:scientific-areaspt17:areas-cientificas");
                    FunctionalityCall x522 = makeFunctionalityCall(x514, x1347, "en13:Dissertationspt12:Disserta��es", null, null, null, "en13:dissertationspt12:dissertacoes");
                    FunctionalityCall x523 = makeFunctionalityCall(x514, x1348, "en12:Publicationspt11:Publica��es", null, null, null, "en12:publicationspt11:publicacoes");
                 Section x526 = new Section(x478, MultiLanguageString.importFromString("en13:Research Sitept20:Site de Investiga��o"));
                 x526.setName(MultiLanguageString.importFromString("en13:Research Sitept20:Site de Investiga��o"));
                 x526.setNormalizedName(MultiLanguageString.importFromString("en13:research-sitept20:site-de-investigacao"));
                    FunctionalityCall x525 = makeFunctionalityCall(x526, x1351, "en6:Eventspt7:Eventos", null, null, null, "en6:eventspt7:eventos");
                    FunctionalityCall x527 = makeFunctionalityCall(x526, x1353, "en13:Announcementspt8:An�ncios", null, null, null, "en13:announcementspt8:anuncios");
                    FunctionalityCall x528 = makeFunctionalityCall(x526, x1354, "en7:Memberspt7:Membros", null, null, null, "en7:memberspt7:membros");
                    FunctionalityCall x529 = makeFunctionalityCall(x526, x1355, "en12:Publicationspt11:Publica��es", null, null, null, "en12:publicationspt11:publicacoes");
                    FunctionalityCall x530 = makeFunctionalityCall(x526, x1356, "en12:Organizationpt9:Estrutura", null, null, null, "en12:organizationpt9:estrutura");
                    FunctionalityCall x531 = makeFunctionalityCall(x526, x1357, "en8:Subunitspt11:Subunidades", null, null, null, "en8:subunitspt11:subunidades");
                 Section x534 = new Section(x478, MultiLanguageString.importFromString("pt19:Conselho Pedag�gico"));
                 x534.setName(MultiLanguageString.importFromString("pt19:Conselho Pedag�gico"));
                 x534.setNormalizedName(MultiLanguageString.importFromString("pt19:conselho-pedagogico"));
                    FunctionalityCall x533 = makeFunctionalityCall(x534, x1360, "en12:Organizationpt9:Estrutura", null, null, null, "en12:organizationpt9:estrutura");
                 Section x537 = new Section(x478, MultiLanguageString.importFromString("pt19:Conselho Cient�fico"));
                 x537.setName(MultiLanguageString.importFromString("pt19:Conselho Cient�fico"));
                 x537.setNormalizedName(MultiLanguageString.importFromString("pt19:conselho-cientifico"));
                    FunctionalityCall x536 = makeFunctionalityCall(x537, x1364, "en12:Organizationpt9:Estrutura", null, null, null, "en12:organizationpt9:estrutura");
                 Section x540 = new Section(x478, MultiLanguageString.importFromString("en14:ScientificAreapt15:�rea Cient�fica"));
                 x540.setName(MultiLanguageString.importFromString("en14:ScientificAreapt15:�rea Cient�fica"));
                 x540.setNormalizedName(MultiLanguageString.importFromString("en14:scientificareapt15:area-cientifica"));
                    FunctionalityCall x539 = makeFunctionalityCall(x540, x1368, "en12:Publicationspt11:Publica��es", null, null, null, "en12:publicationspt11:publicacoes");
                    FunctionalityCall x541 = makeFunctionalityCall(x540, x1370, "en6:Eventspt7:Eventos", null, null, null, "en6:eventspt7:eventos");
                    FunctionalityCall x542 = makeFunctionalityCall(x540, x1371, "en13:Announcementspt8:An�ncios", null, null, null, "en13:announcementspt8:anuncios");
                    FunctionalityCall x543 = makeFunctionalityCall(x540, x1372, "en12:Organizationpt11:Organiza��o", null, null, null, "en12:organizationpt11:organizacao");
                    FunctionalityCall x544 = makeFunctionalityCall(x540, x1373, "en8:SubUnitspt11:SubUnidades", null, null, null, "en8:subunitspt11:subunidades");
                    FunctionalityCall x545 = makeFunctionalityCall(x540, x1374, "en7:Facultypt8:Docentes", null, null, null, "en7:facultypt8:docentes");
                    FunctionalityCall x546 = makeFunctionalityCall(x540, x1375, "en5:Staffpt12:Funcion�rios", null, null, null, "en5:staffpt12:funcionarios");
                    FunctionalityCall x547 = makeFunctionalityCall(x540, x1376, "en7:Coursespt11:Disciplinas", null, null, null, "en7:coursespt11:disciplinas");
           ...
           x556.setNormalizedName(MultiLanguageString.importFromString("en7:librarypt10:biblioteca"));
              Section x555 = new Section(x556, MultiLanguageString.importFromString("en6:Thesespt12:Disserta��es"));
              x555.setName(MultiLanguageString.importFromString("en6:Thesespt12:Disserta��es"));
              x555.setNormalizedName(MultiLanguageString.importFromString("en6:thesespt12:dissertacoes"));
              x555.setMaximizable(false);
                 FunctionalityCall x554 = makeFunctionalityCall(x555, x1488, "en10:Validationpt9:Valida��o", null, null, null, "en10:validationpt9:validacao");
              ...
              Section x559 = new Section(x556, MultiLanguageString.importFromString("pt7:Cart�es"));
              x559.setName(MultiLanguageString.importFromString("pt7:Cart�es"));
              x559.setNormalizedName(MultiLanguageString.importFromString("pt7:cartoes"));
              x559.setMaximizable(false);
                 FunctionalityCall x558 = makeFunctionalityCall(x559, x1491, "pt16:Listagem utentes", null, null, null, "pt16:listagem-utentes");
                 FunctionalityCall x560 = makeFunctionalityCall(x559, x1493, "pt13:Gerar Cart�es", null, null, null, "pt13:gerar-cartoes");
                 FunctionalityCall x561 = makeFunctionalityCall(x559, x1494, "pt12:Gerar Cartas", null, null, null, "pt12:gerar-cartas");
                 FunctionalityCall x562 = makeFunctionalityCall(x559, x1495, "pt36:Gerar Cartas para Alunos e Bolseiros", null, null, null, "pt36:gerar-cartas-para-alunos-e-bolseiros");
              ...
              FunctionalityCall x564 = makeFunctionalityCall(x556, x1486, "en5:Startpt6:In�cio", null, null, null, "en5:startpt6:inicio");
              FunctionalityCall x565 = makeFunctionalityCall(x556, x1497, "pt22:Operador de Biblioteca", null, null, null, "pt22:operador-de-biblioteca");
              ...
              FunctionalityCall x566 = makeFunctionalityCall(x556, x1498, "pt31:Actualizar Capacidade e Cacifos", null, null, null, "pt31:actualizar-capacidade-e-cacifos");
              ExpressionGroupAvailability x1718 = new ExpressionGroupAvailability(x566, "role(LIBRARY) && (libraryHigherClearanceGroup() || role(MANAGER))");
              ...
              FunctionalityCall x567 = makeFunctionalityCall(x556, x1499, "pt31:Adicionar ou Remover Operadores", null, null, null, "pt31:adicionar-ou-remover-operadores");
              ExpressionGroupAvailability x1719 = new ExpressionGroupAvailability(x567, "role(LIBRARY) && (libraryHigherClearanceGroup() || role(MANAGER))");
           ...
           Section x570 = new Section(x3, MultiLanguageString.importFromString("pt20:Gest�o de Patrim�nio"));
           x570.setName(MultiLanguageString.importFromString("pt20:Gest�o de Patrim�nio"));
           x570.setNormalizedName(MultiLanguageString.importFromString("pt20:gestao-de-patrimonio"));
              FunctionalityCall x569 = makeFunctionalityCall(x570, x1501, "pt20:Gest�o de Patrim�nio", null, null, null, "pt20:gestao-de-patrimonio");
           ...
           x573.setNormalizedName(MultiLanguageString.importFromString("pt14:estacionamento"));
              FunctionalityCall x572 = makeFunctionalityCall(x573, x1504, "pt14:Estacionamento", null, null, null, "pt14:estacionamento");
           ...
           Section x576 = new Section(x3, MultiLanguageString.importFromString("en18:Website Managementpt17:Gest�o do WebSite"));
           x576.setName(MultiLanguageString.importFromString("en18:Website Managementpt17:Gest�o do WebSite"));
           ...
           x576.setMaximizable(false);
              FunctionalityCall x575 = makeFunctionalityCall(x576, x1507, "pt17:Gest�o do WebSite", null, null, null, "pt17:gestao-do-website");
           ...
           Section x579 = new Section(x3, MultiLanguageString.importFromString("pt9:Avalia��o"));
           x579.setName(MultiLanguageString.importFromString("pt9:Avalia��o"));
           x579.setNormalizedName(MultiLanguageString.importFromString("pt9:avaliacao"));
              FunctionalityCall x578 = makeFunctionalityCall(x579, x1510, "pt9:Avalia��o", null, null, null, "pt9:avaliacao");
           ...
           Section x582 = new Section(x3, MultiLanguageString.importFromString("pt20:Secretaria Acad�mica"));
           x582.setName(MultiLanguageString.importFromString("pt20:Secretaria Acad�mica"));
           x582.setNormalizedName(MultiLanguageString.importFromString("pt20:secretaria-academica"));
              FunctionalityCall x581 = makeFunctionalityCall(x582, x1513, "pt20:Secretaria Acad�mica", null, null, null, "pt20:secretaria-academica");
           ...
           x585.setPrefix("");
              ...
              FunctionalityCall x586 = makeFunctionalityCall(x585, x1315, "pt10:Ver Sec��o", null, null, null, "pt10:ver-seccao");
              ...
              FunctionalityCall x588 = makeFunctionalityCall(x585, x1313, "en10:Evaluationpt9:Avalia��o", null, null, null, "en10:evaluationpt9:avaliacao");
              FunctionalityCall x589 = makeFunctionalityCall(x585, x1312, "en6:Shiftspt6:Turnos", null, null, null, "en6:shiftspt6:turnos");
              FunctionalityCall x590 = makeFunctionalityCall(x585, x1311, "en9:Timesheetpt7:Hor�rio", null, null, null, "en9:timesheetpt7:horario");
              FunctionalityCall x591 = makeFunctionalityCall(x585, x1310, "en12:Bibliographypt12:Bibliografia", null, null, null, "en12:bibliographypt12:bibliografia");
              FunctionalityCall x592 = makeFunctionalityCall(x585, x1309, "en17:Evaluation Methodpt19:M�todo de Avalia��o", null, null, null, "en17:evaluation-methodpt19:metodo-de-avaliacao");
              FunctionalityCall x593 = makeFunctionalityCall(x585, x1308, "en7:Programpt8:Programa", null, null, null, "en7:programpt8:programa");
              FunctionalityCall x594 = makeFunctionalityCall(x585, x1307, "en10:Objectivespt10:Objectivos", null, null, null, "en10:objectivespt10:objectivos");
              FunctionalityCall x595 = makeFunctionalityCall(x585, x1306, "en9:Summariespt8:Sum�rios", null, null, null, "en9:summariespt8:sumarios");
              FunctionalityCall x596 = makeFunctionalityCall(x585, x1305, "en8:Planningpt11:Planeamento", null, null, null, "en8:planningpt11:planeamento");
              FunctionalityCall x597 = makeFunctionalityCall(x585, x1304, "en13:Announcementspt8:An�ncios", null, null, null, "en13:announcementspt8:anuncios");
              FunctionalityCall x598 = makeFunctionalityCall(x585, x1300, "en12:Initial Pagept14:P�gina Inicial", null, null, null, "en12:initial-pagept14:pagina-inicial");
              FunctionalityCall x599 = makeFunctionalityCall(x585, x1317, "pt14:Resultados QUC", null, null, null, "pt14:resultados-quc");
           ...
           x602.setPrefix("");
              FunctionalityCall x601 = makeFunctionalityCall(x602, x1319, "en12:Presentationpt12:Apresenta��o", null, null, null, "en12:presentationpt12:apresentacao");
           ...
           x605.setPrefix("");
              FunctionalityCall x604 = makeFunctionalityCall(x605, x1327, "en11:Descriptionpt9:Descri��o", null, null, null, "en11:descriptionpt9:descricao");
              FunctionalityCall x606 = makeFunctionalityCall(x605, x1330, "en22:Admission Requirementspt16:Regime de Acesso", null, null, null, "en22:admission-requirementspt16:regime-de-acesso");
              FunctionalityCall x607 = makeFunctionalityCall(x605, x1331, "en19:Professional Statuspt21:Estatuto Profissional", null, null, null, "en19:professional-statuspt21:estatuto-profissional");
              FunctionalityCall x608 = makeFunctionalityCall(x605, x1332, "en15:Curricular Planpt16:Plano Curricular", null, null, null, "en15:curricular-planpt16:plano-curricular");
              FunctionalityCall x609 = makeFunctionalityCall(x605, x1333, "en16:Course Web Pagespt22:P�ginas de Disciplinas", null, null, null, "en16:course-web-pagespt22:paginas-de-disciplinas");
              FunctionalityCall x610 = makeFunctionalityCall(x605, x1334, "en15:Class timetablept18:Hor�rios por Turma", null, null, null, "en15:class-timetablept18:horarios-por-turma");
              FunctionalityCall x611 = makeFunctionalityCall(x605, x1335, "en11:Evaluationspt10:Avalia��es", null, null, null, "en11:evaluationspt10:avaliacoes");
              FunctionalityCall x612 = makeFunctionalityCall(x605, x1336, "en13:Dissertationspt12:Disserta��es", null, null, null, "en13:dissertationspt12:dissertacoes");
           ...
           x3.addChild(x616);
           x616.setName(MultiLanguageString.importFromString("en8:researchpt12:Investiga��o"));
           x616.setNormalizedName(MultiLanguageString.importFromString("en8:researchpt12:investigacao"));
           x616.setPrefix("");
              FunctionalityCall x615 = makeFunctionalityCall(x616, x1358, "en4:Homept6:In�cio", null, null, null, "en4:homept6:inicio");
           ...
           x619.setPrefix("");
              FunctionalityCall x618 = makeFunctionalityCall(x619, x1366, "pt6:In�cio", null, null, null, "pt6:inicio");
           ...
           x622.setPrefix("");
              FunctionalityCall x621 = makeFunctionalityCall(x622, x1362, "pt6:In�cio", null, null, null, "pt6:inicio");
           ...
           x625.setPrefix("");
              FunctionalityCall x624 = makeFunctionalityCall(x625, x1377, "en4:Homept6:In�cio", null, null, null, "en4:homept6:inicio");
           Section x628 = new Section(x3, MultiLanguageString.importFromString("pt35:Gabinete de Rela��es Internacionais"));
           x628.setName(MultiLanguageString.importFromString("pt35:Gabinete de Rela��es Internacionais"));
           x628.setNormalizedName(MultiLanguageString.importFromString("pt35:gabinete-de-relacoes-internacionais"));
              ...
              Section x630 = new Section(x628, MultiLanguageString.importFromString("pt23:Est�gios Internacionais"));
              x630.setName(MultiLanguageString.importFromString("pt23:Est�gios Internacionais"));
              ...
              x633.setNormalizedName(MultiLanguageString.importFromString("pt9:consultas"));
                 FunctionalityCall x632 = makeFunctionalityCall(x633, x1521, "pt17:Visualizar Alunos", null, null, null, "pt17:visualizar-alunos");
              ...
              x637.setNormalizedName(MultiLanguageString.importFromString("pt9:listagens"));
                 FunctionalityCall x636 = makeFunctionalityCall(x637, x1522, "pt16:Alunos Por Curso", null, null, null, "pt16:alunos-por-curso");
                 FunctionalityCall x638 = makeFunctionalityCall(x637, x1524, "pt21:Alunos por Disciplina", null, null, null, "pt21:alunos-por-disciplina");
           ...
           x645.setNormalizedName(MultiLanguageString.importFromString("pt8:tutorado"));
              FunctionalityCall x644 = makeFunctionalityCall(x645, x1379, "pt6:In�cio", null, null, null, "pt6:inicio");
           ...
           x648.setNormalizedName(MultiLanguageString.importFromString("pt18:conteudos-publicos"));
              FunctionalityCall x647 = makeFunctionalityCall(x648, x1398, "pt19:Pesquisa de Espa�os", null, null, null, "pt19:pesquisa-de-espacos");
              FunctionalityCall x649 = makeFunctionalityCall(x648, x1399, "pt40:Consulta de Corpo Docente por Disciplina", null, null, null, "pt40:consulta-de-corpo-docente-por-disciplina");
              FunctionalityCall x650 = makeFunctionalityCall(x648, x1400, "pt14:Registo Alumni", null, null, null, "pt14:registo-alumni");
              FunctionalityCall x651 = makeFunctionalityCall(x648, x1401, "pt24:Conclus�o Registo Alumni", null, null, null, "pt24:conclusao-registo-alumni");
              FunctionalityCall x652 = makeFunctionalityCall(x648, x1405, "pt26:Pesquisa de Resultados QUC", null, null, null, "pt26:pesquisa-de-resultados-quc");
              FunctionalityCall x653 = makeFunctionalityCall(x648, x1406, "en5:filespt9:ficheiros", null, null, null, "en5:filespt9:ficheiros");
           ...
           x656.setNormalizedName(MultiLanguageString.importFromString("pt9:alunos-cd"));
              FunctionalityCall x655 = makeFunctionalityCall(x656, x1382, "pt14:P�gina Inicial", null, null, null, "pt14:pagina-inicial");
           Section x659 = new Section(x3, MultiLanguageString.importFromString("pt24:Cart�es de Identifica��o"));
           x659.setName(MultiLanguageString.importFromString("pt24:Cart�es de Identifica��o"));
           x659.setNormalizedName(MultiLanguageString.importFromString("pt24:cartoes-de-identificacao"));
              FunctionalityCall x658 = makeFunctionalityCall(x659, x1531, "pt14:P�gina Inicial", null, null, null, "pt14:pagina-inicial");
           ...
           Section x663 = new Section(x3, MultiLanguageString.importFromString("en23:Public Relations Officept29:Gabinete de Rela��es P�blicas"));
           x663.setName(MultiLanguageString.importFromString("en23:Public Relations Officept29:Gabinete de Rela��es P�blicas"));
           ...
           x663.setMaximizable(false);
              ...
              FunctionalityCall x665 = makeFunctionalityCall(x663, x1541, "pt10:Inqu�ritos", null, null, null, "pt10:inqueritos");
           ...
           Section x669 = new Section(x3, MultiLanguageString.importFromString("en18:Housing Managementpt21:N�cleo de Alojamentos"));
           x669.setName(MultiLanguageString.importFromString("en18:Housing Managementpt21:N�cleo de Alojamentos"));
           ...
           x669.setMaximizable(false);
              FunctionalityCall x668 = makeFunctionalityCall(x669, x1547, "pt14:P�gina Inicial", null, null, null, "pt14:pagina-inicial");
              FunctionalityCall x670 = makeFunctionalityCall(x669, x1549, "pt13:Gerir D�vidas", null, null, null, "pt13:gerir-dividas");
              FunctionalityCall x671 = makeFunctionalityCall(x669, x1550, "pt21:Gest�o de Previl�gios", null, null, null, "pt21:gestao-de-previlegios");
           ...
           x674.setPrefix("");
              FunctionalityCall x673 = makeFunctionalityCall(x674, x1385, "en6:Thesispt11:Dissertacao", null, null, null, "en6:thesispt11:dissertacao");
           ...
           x683.setPrefix("");
              FunctionalityCall x682 = makeFunctionalityCall(x683, x1388, "pt6:In�cio", null, null, null, "pt6:inicio");
           Section x686 = new Section(x3, MultiLanguageString.importFromString("es12:applicationsen11:Candidaciespt12:Candidaturas"));
           ...
           x686.setMaximizable(false);
              ...
              x690.setNormalizedName(MultiLanguageString.importFromString("pt3:lic"));
                 FunctionalityCall x689 = makeFunctionalityCall(x690, x1411, "pt14:mudancas_curso", null, null, null, "pt14:mudancas_curso");
                 FunctionalityCall x691 = makeFunctionalityCall(x690, x1412, "pt8:transfer", null, null, null, "pt8:transfer");
                 FunctionalityCall x692 = makeFunctionalityCall(x690, x1413, "pt24:cursos_medios_superiores", null, null, null, "pt24:cursos_medios_superiores");
                 FunctionalityCall x693 = makeFunctionalityCall(x690, x1414, "pt18:maiores_vinte_tres", null, null, null, "pt18:maiores_vinte_tres");
                 FunctionalityCall x694 = makeFunctionalityCall(x690, x1415, "pt24:concurso_nacional_acesso", null, null, null, "pt24:concurso_nacional_acesso");
              ...
              x717.setMaximizable(false);
                 ...
                 FunctionalityCall x718 = makeFunctionalityCall(x717, x1423, "pt9:submissao", null, null, null, "en10:submissionpt9:submissao");
                 FunctionalityCall x719 = makeFunctionalityCall(x717, x1424, "pt10:preregisto", null, null, null, "en15:preregistrationpt10:preregisto");
              ...
              x723.setNormalizedName(MultiLanguageString.importFromString("pt7:erasmus"));
                 ...
                 FunctionalityCall x724 = makeFunctionalityCall(x723, x1450, "pt15:submission-type", null, null, null, "pt15:submission-type");
                 FunctionalityCall x725 = makeFunctionalityCall(x723, x1454, "pt14:returnFromPeps", null, null, null, "pt14:returnfrompeps");
                 FunctionalityCall x726 = makeFunctionalityCall(x723, x1455, "pt22:nationalCardSubmission", null, null, null, "pt22:nationalcardsubmission");
                 ...
                 FunctionalityCall x729 = makeFunctionalityCall(x723, x1451, "pt15:preregistration", null, null, null, "pt15:preregistration");
                 FunctionalityCall x730 = makeFunctionalityCall(x723, x1456, "pt29:nationalCardApplicationAccess", null, null, null, "pt29:nationalcardapplicationaccess");
                 FunctionalityCall x731 = makeFunctionalityCall(x723, x1457, "pt14:accessRecovery", null, null, null, "pt14:accessrecovery");
              ...
              x735.setNormalizedName(MultiLanguageString.importFromString("pt3:phd"));
                 ...
                 FunctionalityCall x738 = makeFunctionalityCall(x735, x1465, "en8:recoverypt11:recuperacao", null, null, null, "en8:recoverypt11:recuperacao");
                 FunctionalityCall x739 = makeFunctionalityCall(x735, x1466, "pt12:recomendacao", null, null, null, "en12:referee-formpt12:recomendacao");
                 FunctionalityCall x740 = makeFunctionalityCall(x735, x1467, "pt19:validateApplication", null, null, null, "pt19:validateapplication");
                 FunctionalityCall x741 = makeFunctionalityCall(x735, x1468, "en14:identification", null, null, null, "en14:identificationpt14:identification");
              ...
              x744.setNormalizedName(MultiLanguageString.importFromString("pt4:epfl"));
                 FunctionalityCall x743 = makeFunctionalityCall(x744, x1470, "en14:identificationpt13:identificacao", null, null, null, "en14:identificationpt13:identificacao");
                 FunctionalityCall x745 = makeFunctionalityCall(x744, x1472, "en10:submissionpt9:submissao", null, null, null, "en10:submissionpt9:submissao");
                 FunctionalityCall x746 = makeFunctionalityCall(x744, x1473, "en6:accesspt6:acesso", null, null, null, "en6:accesspt6:acesso");
                 FunctionalityCall x747 = makeFunctionalityCall(x744, x1474, "pt12:referee-form", null, null, null, "pt12:referee-form");
                 FunctionalityCall x748 = makeFunctionalityCall(x744, x1475, "en8:recoverypt11:recuperacao", null, null, null, "en8:recoverypt11:recuperacao");
           ...
           x752.setPrefix("");
              FunctionalityCall x751 = makeFunctionalityCall(x752, x1391, "en4:Homept6:In�cio", null, null, null, "en4:homept6:inicio");
           ...
           x755.setPrefix("");
              FunctionalityCall x754 = makeFunctionalityCall(x755, x1394, "en4:Homept6:In�cio", null, null, null, "en4:homept6:inicio");
           Section x761 = new Section(x3, MultiLanguageString.importFromString("pt18:Supervis�o Externa"));
           x761.setName(MultiLanguageString.importFromString("pt18:Supervis�o Externa"));
           x761.setNormalizedName(MultiLanguageString.importFromString("pt18:supervisao-externa"));
           x761.setMaximizable(false);
              FunctionalityCall x760 = makeFunctionalityCall(x761, x1555, "pt14:P�gina Inicial", null, null, null, "pt14:pagina-inicial");
           ...
           x769.setMaximizable(false);
              FunctionalityCall x768 = makeFunctionalityCall(x769, x1478, "en6:Accesspt6:Acesso", null, null, null, "en6:accesspt6:acesso");
           ...
           x773.setNormalizedName(MultiLanguageString.importFromString("pt28:nucleo-de-apoio-ao-estudante"));
              ...
              x775.setNormalizedName(MultiLanguageString.importFromString("pt12:candidaturas"));
                 ...
                 FunctionalityCall x777 = makeFunctionalityCall(x775, x1568, "pt14:Transfer�ncias", null, null, null, "pt14:transferencias");
                 FunctionalityCall x778 = makeFunctionalityCall(x775, x1569, "pt17:Mudan�as de curso", null, null, null, "pt17:mudancas-de-curso");
                 FunctionalityCall x779 = makeFunctionalityCall(x775, x1570, "pt45:Titulares de cursos de grau m�dio ou superior", null, null, null, "pt45:titulares-de-cursos-de-grau-medio-ou-superior");
              ...
              x782.setMaximizable(false);
                 FunctionalityCall x781 = makeFunctionalityCall(x782, x1572, "pt33:Alunos Matriculados 1� ano 1� vez", null, null, null, "pt31:alunos-matriculados-1-ano-1-vez");
           ...
           x790.setNormalizedName(MultiLanguageString.importFromString("pt3:phd"));
              ...
              x789.setNormalizedName(MultiLanguageString.importFromString("pt4:epfl"));
                 ...
                 x788.setNormalizedName(MultiLanguageString.importFromString("pt12:applications"));
                    ...
                    FunctionalityCall x795 = makeFunctionalityCall(x788, x1582, "pt18:candidateDocuments", null, null, null, "pt18:candidatedocuments");
           ...
           x802.setMaximizable(true);
              FunctionalityCall x801 = makeFunctionalityCall(x802, x1586, "pt15:Lotes Recebidos", null, null, null, "pt15:lotes-recebidos");
           ...
           x805.setMaximizable(false);
              FunctionalityCall x804 = makeFunctionalityCall(x805, x1589, "pt6:In�cio", null, null, null, "pt6:inicio");
