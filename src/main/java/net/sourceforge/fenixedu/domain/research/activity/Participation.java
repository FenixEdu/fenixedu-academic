...
public abstract class Participation extends Participation_Base {
    ...
    public enum ResearchActivityParticipationRole {
        ...
        Organizing_Chair, Organizing_Member, Program_Chair, Program_Member, Invited_Speaker, Reviewer, Editor_in_Chief,
        Associate_Editor, Editorial_Board, Guest_Editor, President, Vice_President, Secretary, Local_Chair,
        National_Representative, Visitor, Expert, Member;
