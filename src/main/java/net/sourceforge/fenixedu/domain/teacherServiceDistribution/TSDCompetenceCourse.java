...
public class TSDCompetenceCourse extends TSDCompetenceCourse_Base {
    ...
    public TSDCompetenceCourse(TeacherServiceDistribution tsd, CompetenceCourse competenceCourse,
    ...
    public String getName() {
        if (getCompetenceCourse().isBolonha()) {
            ...
            ResourceBundle bundleDepartementMember =
                    ResourceBundle.getBundle("resources.DepartmentMemberResources", Language.getLocale());
