...
public class TSDProcess extends TSDProcess_Base {
    ...
    public List<TSDProcessPhase> getOrderedTSDProcessPhases() {
        ...
        for (TSDProcessPhase firstTSDProcessPhase = getFirstTSDProcessPhase(); firstTSDProcessPhase != null; firstTSDProcessPhase =
                firstTSDProcessPhase.getNextTSDProcessPhase()) {
