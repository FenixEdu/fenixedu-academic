...
public class TSDFactory {
        ...
        for (Unit courseUnit : unitCoursesNewGrouping.keySet()) {
            ...
            if (scientificAreaGrouping == null) {
                if (teachersNewGrouping == null) {
                    scientificAreaGrouping =
                            new TeacherServiceDistribution(tsdPhase, scientificAreaUnit.getName(), rootTSD,
                                    new ArrayList<TSDTeacher>(), new ArrayList<TSDCourse>(),
                                    rootTSD.getCoursesValuationManagers(), rootTSD.getTeachersValuationManagers(),
    ...
    private void createChildUnitsGroupingsForTeachers(TSDProcessPhase tsdPhase, TSDTeacher tsdTeacher, Unit unit,
        ...
        if (newTSD == null) {
            ...
            newTSD =
                    new TeacherServiceDistribution(tsdPhase, unit.getName(), null, teachersList, emptyCourseList, null, null,
                            null, null);
    ...
    private void createChildCompetenceCourseGroupUnits(TSDProcessPhase tsdPhase, TSDCourse tsdCourse,
        ...
        if (newGrouping == null) {
            ...
            newGrouping =
                    new TeacherServiceDistribution(tsdPhase, competenceCourse.getCompetenceCourseGroupUnit().getName(), rootTSD,
                            emptyTSDTeacherList, courseList, null, null, null, null);
