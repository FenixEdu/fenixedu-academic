...
public class Module extends Module_Base implements IFunctionality {
     ...
     * 
     * <p>
     * A module is also visible when it has an accessible public path. So if the module has a public path but none of it's
     * children is visible then it is still visible to the user.
     */
