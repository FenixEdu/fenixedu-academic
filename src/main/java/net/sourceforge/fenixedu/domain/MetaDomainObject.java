...
/**
 * A <code>MetaDomainObject</code> represents the type of a specific <code>DomainObject</code>. It's the reification of the domain
 * object's type.
 * 
 * @author cfgi
 */
public class MetaDomainObject extends MetaDomainObject_Base {
     ...
     * 
     * <p>
     * Any MetaDomainObject returned by this method will return the given type as the result of {@link #getConcreteType()}.
     * 
     * @param type
     *            a class the extends {@link DomainObject}
     * 
     * @return a MetaDomainObject that is the reification of the given type of <code>null</code> if none is available
     */
