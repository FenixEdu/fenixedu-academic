    ...
    public Content processPath(String path) {
        ...
        if (pathElements.length > 0) {
            ...
            ExecutionCourse executionCourse =
                    executionInterval == null ? ExecutionCourse.readLastBySigla(pathElements[0]) : ExecutionCourse
                            .readLastByExecutionIntervalAndSigla(pathElements[0], executionInterval);
