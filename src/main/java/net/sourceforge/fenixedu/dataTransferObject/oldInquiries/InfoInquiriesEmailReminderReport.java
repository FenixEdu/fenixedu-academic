 ...
 * 
 */
public class InfoInquiriesEmailReminderReport extends InfoObject implements Comparable {
    ...
    public InfoInquiriesEmailReminderReport(String externalId) {
        super(externalId);
    ...
    /**
     * @param numberDegreeStudents
     *            The numberDegreeStudents to set.
     */
    ...
    /**
     * @param numberDegreeStudents
     *            The numberDegreeStudents to add.
     */
    ...
    /**
     * @param numberSentEmails
     *            The numberSentEmails to set.
     */
    ...
    /**
     * @param numberUnansweredInquiries
     *            The numberUnansweredInquiries to set.
     */
    ...
    /**
     * @param numberUnansweredInquiries
     *            The numberUnansweredInquiries to add.
     */
    ...
    /**
     * @param totalNumberInquiries
     *            The totalNumberInquiries to set.
     */
    ...
    /**
     * @param numberStudentsWithEmail
     *            The numberStudentsWithEmail to set.
     */
