...
public class InfoSiteTeachers extends DataTranferObject implements ISiteComponent {
    ...
    public boolean equals(Object objectToCompare) {
        ...
        if (objectToCompare instanceof InfoSiteTeachers
                && (((((InfoSiteTeachers) objectToCompare).getIsResponsible() != null && this.getIsResponsible() != null && ((InfoSiteTeachers) objectToCompare)
                        .getIsResponsible().equals(this.getIsResponsible())) || ((InfoSiteTeachers) objectToCompare)
                        .getIsResponsible() == null && this.getIsResponsible() == null))) {
            result = true;
        }
        ...
        if (((InfoSiteTeachers) objectToCompare).getInfoTeachers() == null || this.getInfoTeachers() == null
