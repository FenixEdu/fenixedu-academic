...
public class ShiftAndLessonKeys extends InfoObject {
    ...
    public ShiftAndLessonKeys(String nomeTurno, DiaSemana diaSemana, Calendar inicio, Calendar fim, RoomKey keySala) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ShiftAndLessonKeys) {
            ...
            resultado =
                    (getNomeTurno().equals(keysTurnoAndAula.getNomeTurno()))
