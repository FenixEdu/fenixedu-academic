            ...
            if (change) {
                ...
                for (InfoGuideEntry infoGuideEntry : newInfoGuideEntries) {
                    GuideEntry guideEntry =
                            guide.getEntry(infoGuideEntry.getGraduationType(), infoGuideEntry.getDocumentType(),
            ...
            if (change) {
                ...
                for (InfoGuideEntry infoGuideEntry : newInfoGuideEntries) {
                    ...
                    if (guideEntry.getDocumentType().equals(DocumentType.GRATUITY)) {
                        ...
                        paymentTransaction =
                                new GratuityTransaction(guideEntry.getPrice(), new Timestamp(Calendar.getInstance()
                    ...
                    if (guideEntry.getDocumentType().equals(DocumentType.INSURANCE)) {
                        paymentTransaction =
                                new InsuranceTransaction(guideEntry.getPrice(), new Timestamp(Calendar.getInstance()
                                        .getTimeInMillis()), guideEntry.getDescription(), infoGuide.getPaymentType(),
                                        TransactionType.INSURANCE_PAYMENT, Boolean.FALSE, guide.getPerson(), personAccount,
                                        guideEntry, executionDegree.getExecutionYear(), registration);
                    }
                }
