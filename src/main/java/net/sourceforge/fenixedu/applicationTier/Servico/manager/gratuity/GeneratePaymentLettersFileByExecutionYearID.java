...
public class GeneratePaymentLettersFileByExecutionYearID {
    ...
    public static byte[] run(String executionYearID, Date paymentEndDate) throws FenixServiceException {
        ...
        List executionDegreeList =
                ExecutionDegree.getAllByExecutionYearAndDegreeType(executionYear.getYear(), DegreeType.MASTER_DEGREE);
    ...
    private static GratuityLetterFileEntry createGratuityLetterFileEntryForGratuitySituation(GratuitySituation gratuitySituation,
        ...
        if (gratuitySituation.getStudentCurricularPlan().getSpecialization()
            ...
            scholarShipPartValue =
                    new Double(gratuitySituation.getRemainingValue().doubleValue()
    ...
    private static byte[] writeLetterFiles(List gratuityLetterFileEntries, ExecutionYear executionYear)
        ...
        for (Iterator iter = gratuityLetterFileEntries.iterator(); iter.hasNext();) {
            ...
            DegreeCurricularPlan degreeCurricularPlan =
                    gratuityLetterFileEntry.getStudentCurricularPlan().getDegreeCurricularPlan();
