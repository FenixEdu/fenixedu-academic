...
public class SearchPersonsForParticipations implements AutoCompleteProvider<Person> {
    ...
    public Collection<Person> getSearchResults(Map<String, String> argsMap, String value, int maxCount) {
        ...
        return Person.findInternalPerson(value, (size == null) ? 20 : Integer.parseInt(size));
    }
