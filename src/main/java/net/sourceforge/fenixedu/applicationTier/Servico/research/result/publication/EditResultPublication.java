...
public class EditResultPublication extends ResultPublicationService {
    ...
    protected ResearchResultPublication run(BookBean bean) throws FenixServiceException {
        ...
        if (publication instanceof Book) {
            ((Book) publication).setEditAll(bean.getTitle(), bean.getKeywords(), bean.getPublisher(), bean.getYear(),
                    bean.getVolume(), bean.getSeries(), bean.getAddress(), bean.getEdition(), bean.getIsbn(),
                    bean.getNumberPages(), bean.getLanguage(), bean.getCountry(), bean.getScope(), bean.getNote(),
    ...
    protected ResearchResultPublication run(BookPartBean bean) throws FenixServiceException {
        ...
        if (publication instanceof BookPart) {
            ((BookPart) publication).setEditAll(bean.getTitle(), bean.getKeywords(), bean.getBookTitle(), bean.getChapter(),
                    bean.getFirstPage(), bean.getLastPage(), bean.getPublisher(), bean.getYear(), bean.getVolume(),
                    bean.getSeries(), bean.getEdition(), bean.getCountry(), bean.getAddress(), bean.getNote(), bean.getMonth(),
                    bean.getUrl());
            finalPublication = publication;
    ...
    protected ResearchResultPublication run(InproceedingsBean bean) throws FenixServiceException {
        ...
        if (publication instanceof Inproceedings) {
            ...
            ((Inproceedings) publication).setEditAll(bean.getTitle(), bean.getKeywords(), bean.getEventEdition(),
                    bean.getPublisher(), bean.getAddress(), bean.getFirstPage(), bean.getLastPage(), bean.getNote(),
                    bean.getLanguage(), bean.getUrl());
    ...
    protected ResearchResultPublication run(ProceedingsBean bean) throws FenixServiceException {
        ...
        if (publication instanceof Proceedings) {
            ...
            ((Proceedings) publication).setEditAll(bean.getTitle(), bean.getKeywords(), bean.getEventEdition(),
                    bean.getPublisher(), bean.getAddress(), bean.getNote(), bean.getUrl());
            finalPublication = publication;
    ...
    protected ResearchResultPublication run(ThesisBean bean) throws FenixServiceException {
        ...
        if (publication instanceof Thesis) {
            ((Thesis) publication).setEditAll(bean.getThesisType(), bean.getTitle(), bean.getKeywords(), bean.getOrganization(),
                    bean.getYear(), bean.getAddress(), bean.getNote(), bean.getNumberPages(), bean.getLanguage(),
                    bean.getMonth(), bean.getYearBegin(), bean.getMonthBegin(), bean.getUrl());
    ...
    protected ResearchResultPublication run(ManualBean bean) throws FenixServiceException {
        ...
        if (publication instanceof Manual) {
            ((Manual) publication).setEditAll(bean.getTitle(), bean.getKeywords(), bean.getOrganization(), bean.getYear(),
                    bean.getAddress(), bean.getNote(), bean.getEdition(), bean.getMonth(), bean.getUrl());
            finalPublication = publication;
    ...
    protected ResearchResultPublication run(TechnicalReportBean bean) throws FenixServiceException {
        ...
        if (publication instanceof TechnicalReport) {
            ((TechnicalReport) publication).setEditAll(bean.getTitle(), bean.getKeywords(), bean.getOrganization(),
                    bean.getYear(), bean.getTechnicalReportType(), bean.getNumber(), bean.getAddress(), bean.getNote(),
                    bean.getNumberPages(), bean.getLanguage(), bean.getMonth(), bean.getUrl());
            finalPublication = publication;
        } else {
    ...
    protected ResearchResultPublication run(OtherPublicationBean bean) throws FenixServiceException {
        ...
        if (publication instanceof OtherPublication) {
            ((OtherPublication) publication).setEditAll(bean.getTitle(), bean.getKeywords(), bean.getPublisher(), bean.getYear(),
                    bean.getHowPublished(), bean.getNote(), bean.getAddress(), bean.getOtherPublicationType(),
                    bean.getNumberPages(), bean.getLanguage(), bean.getCountry(), bean.getMonth(), bean.getUrl());
            finalPublication = publication;
