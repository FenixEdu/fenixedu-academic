...
public abstract class ResultPublicationService extends FenixService {
    ...
    protected Book createBookFromBean(BookBean bean) {
        return new Book(bean.getPerson(), bean.getRole(), bean.getTitle(), bean.getKeywords(), bean.getPublisher(),
                bean.getYear(), bean.getVolume(), bean.getSeries(), bean.getAddress(), bean.getEdition(), bean.getIsbn(),
                bean.getNumberPages(), bean.getLanguage(), bean.getCountry(), bean.getScope(), bean.getNote(), bean.getMonth(),
                bean.getUrl());
    }

    protected BookPart createBookPartFromBean(BookPartBean bean) {
        return new BookPart(bean.getPerson(), bean.getRole(), bean.getTitle(), bean.getKeywords(), bean.getBookTitle(),
                bean.getChapter(), bean.getVolume(), bean.getPublisher(), bean.getYear(), bean.getFirstPage(),
                bean.getLastPage(), bean.getSeries(), bean.getEdition(), bean.getOrganization(), bean.getCountry(),
    ...
    protected Manual createManualFromBean(ManualBean bean) {
        return new Manual(bean.getPerson(), bean.getTitle(), bean.getKeywords(), bean.getOrganization(), bean.getYear(),
    ...
    protected TechnicalReport createTechnicalReportFromBean(TechnicalReportBean bean) {
        return new TechnicalReport(bean.getPerson(), bean.getTitle(), bean.getKeywords(), bean.getOrganization(), bean.getYear(),
                bean.getTechnicalReportType(), bean.getNumber(), bean.getAddress(), bean.getNote(), bean.getNumberPages(),
