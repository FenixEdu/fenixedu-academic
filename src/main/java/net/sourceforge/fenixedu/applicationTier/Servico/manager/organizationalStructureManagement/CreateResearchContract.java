    ...
    public static void run(ResearchContractBean bean, Person creator, String url) throws FenixServiceException {
        ...
        if (loginIdentification == null) {
            ...
            if (loginIdentification.getPassword() == null) {
                ...
                String subject =
                        BundleUtil.getStringFromResourceBundle("resources.WebsiteManagerResources", "email.login.subject");
                String message =
                        BundleUtil.getStringFromResourceBundle("resources.WebsiteManagerResources", "email.login.message",
