...
public class ReadAllCurricularCoursesByCompetenceCourse {

    @Checked("RolePredicates.MANAGER_PREDICATE")
    @Service
    public static List<CurricularCourse> run(final Integer competenceID) throws NonExistingServiceException {
        final CompetenceCourse competenceCourse = RootDomainObject.getInstance().readCompetenceCourseByOID(competenceID);
