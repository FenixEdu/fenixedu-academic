    ...
    protected Layout getLayout(Object object, Class type) {
        return new Layout() {
            ...
            public HtmlComponent createComponent(Object object, Class type) {
                ...
                addContentToBuffer(buffer, researcher.getAllowsContactByStudents(),
                        getTextFromBundle(getKeyForStudents(), getBundle()));
                addContentToBuffer(buffer, researcher.getAllowsContactByMedia(), getTextFromBundle(getKeyForMedia(), getBundle()));
                addContentToBuffer(buffer, researcher.getAllowsContactByOtherResearchers(),
                        getTextFromBundle(getKeyForOtherResearchers(), getBundle()));
