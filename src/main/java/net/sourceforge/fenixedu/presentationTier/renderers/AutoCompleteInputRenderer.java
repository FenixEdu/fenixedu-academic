...
public class AutoCompleteInputRenderer extends pt.ist.fenixWebFramework.rendererExtensions.AutoCompleteInputRenderer {
     ...
     * must implement the interface {@link net.sourceforge.fenixedu.applicationTier.Servico.commons.AutoCompleteSearchService} .
     * 
     * @property
     */
    ...
    /**
     * Allows you to pass extra arguments to the service in the form <code>paramA=value1,paramB=value2</code>. This arguments will
     * be
