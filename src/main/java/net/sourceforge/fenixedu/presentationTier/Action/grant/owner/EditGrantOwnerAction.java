...
@Mapping(module = "facultyAdmOffice", path = "/editGrantOwner",
        input = "/editGrantOwner.do?page=0&method=prepareEditGrantOwnerForm", attribute = "editGrantOwnerForm",
        formBean = "editGrantOwnerForm", scope = "request", parameter = "method")
@Forwards(value = { @Forward(name = "edit-grant-owner-form", path = "/facultyAdmOffice/grant/owner/editGrantOwnerForm.jsp"),
