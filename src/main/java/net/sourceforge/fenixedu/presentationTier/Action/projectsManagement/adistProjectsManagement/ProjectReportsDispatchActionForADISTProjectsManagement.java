...
@Mapping(module = "adistProjectsManagement", path = "/projectReport", attribute = "rubricForm", formBean = "rubricForm",
...
public class ProjectReportsDispatchActionForADISTProjectsManagement extends
