...
@Forwards(value = { @Forward(name = "chooseManagers", path = "/webSiteManager/commons/chooseManagers.jsp",
        tileProperties = @Tile(bodyContext = "/departmentAdmOffice/site/siteContext.jsp",
