...
@Mapping(path = "/viewSite", module = "resourceAllocationManager")
@Forwards(value = { @Forward(name = "erro", path = "/executionCourseNotFound.jsp"),
...
@Exceptions(
        value = {
                ...
                @ExceptionHandling(
                        ...
                        handler = net.sourceforge.fenixedu.presentationTier.config.FenixErrorExceptionHandler.class,
                        type = net.sourceforge.fenixedu.presentationTier.Action.exceptions.NonExistingAssociatedCurricularCoursesActionException.class) })
