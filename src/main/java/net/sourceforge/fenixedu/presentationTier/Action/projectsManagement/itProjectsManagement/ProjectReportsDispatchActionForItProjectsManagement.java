...
@Mapping(module = "itProjectsManagement", path = "/projectReport", attribute = "rubricForm", formBean = "rubricForm",
...
public class ProjectReportsDispatchActionForItProjectsManagement extends
