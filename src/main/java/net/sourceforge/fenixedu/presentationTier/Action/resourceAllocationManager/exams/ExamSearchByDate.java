 ...
 */
@Mapping(module = "resourceAllocationManager", path = "/ExamSearchByDate", input = "/ExamSearchByDate.do?method=prepare&page=0",
        attribute = "examSearchByDateForm", formBean = "examSearchByDateForm", scope = "request", parameter = "method")
...
public class ExamSearchByDate extends FenixContextDispatchAction {
    ...
    public ActionForward search(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        String examDateString =
                " Exames de dia " + new Integer(examDate.get(Calendar.DAY_OF_MONTH)) + "/"
        ...
        if (examStartTime != null) {
            examDateString +=
                    " a começar às " + new Integer(examStartTime.get(Calendar.HOUR_OF_DAY)) + ":"
        ...
        if (examEndTime != null) {
            examDateString +=
                    " a terminar às " + new Integer(examEndTime.get(Calendar.HOUR_OF_DAY)) + ":"
                            + new Integer(examEndTime.get(Calendar.MINUTE));
        }

        InfoViewExam infoViewExam = ReadExamsByDate.run(examDate, examStartTime, examEndTime);
