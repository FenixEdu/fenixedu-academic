...
import net.sourceforge.fenixedu.applicationTier.Servico.masterDegree.administrativeOffice.thesis.CreateMasterDegreeThesis;
...
@Mapping(path = "/createMasterDegreeThesisLookup", module = "masterDegreeAdministrativeOffice",
        input = "/createMasterDegreeThesis.do?page=0&method=reloadForm", formBean = "createMasterDegreeThesisForm")
