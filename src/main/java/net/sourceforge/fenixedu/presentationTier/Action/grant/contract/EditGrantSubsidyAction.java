 ...
 * @author Pica
 */
@Mapping(module = "facultyAdmOffice", path = "/editGrantSubsidy",
        input = "/editGrantSubsidy.do?page=0&method=prepareEditGrantSubsidyForm", attribute = "editGrantSubsidyForm",
        formBean = "editGrantSubsidyForm", scope = "request", parameter = "method")
@Forwards(value = {
