...
public class SearchCoursesInformationAction extends SearchAction {
    ...
    protected void doAfterSearch(SearchActionMapping mapping, HttpServletRequest request, Collection result) {
        ...
        final Comparator comparator = new Comparator() {
            ...
            public int compare(Object o1, Object o2) {
                ...
                if (infoScopes1.isEmpty() && infoScopes2.isEmpty()) {
                    ...
                    return InfoCurricularCourseScope.COMPARATOR_BY_YEAR_SEMESTER_BRANCH_AND_NAME.compare(infoScopes1.first(),
                            infoScopes2.first());
                }
            }

            private SortedSet<InfoCurricularCourseScope> getFilteredAndSortedInfoScopes(
                    final InfoSiteCourseInformation infoSiteCourseInformation) {
                final SortedSet<InfoCurricularCourseScope> result =
                        new TreeSet<InfoCurricularCourseScope>(
                                InfoCurricularCourseScope.COMPARATOR_BY_YEAR_SEMESTER_BRANCH_AND_NAME);
                ...
                for (final InfoCurricularCourse infoCurricularCourse : infoSiteCourseInformation.getInfoCurricularCourses()) {
                    if (infoDegreeCurricularPlan == null
                            || infoDegreeCurricularPlan.equals(infoCurricularCourse.getInfoDegreeCurricularPlan())) {
        ...
        for (final InfoSiteCourseInformation infoSiteCourseInformation : infoSiteCoursesInformation) {
            ...
            if (!statistics.containsKey(numberOfFields)) {
                ...
                int value = (statistics.get(numberOfFields)).intValue();
                value++;
            ...
            for (final InfoCurricularCourse infoCurricularCourse : infoSiteCourseInformation.getInfoCurricularCourses()) {
                if (infoDegreeCurricularPlan == null
                    ...
                    for (InfoCurricularCourseScope infoCurricularCourseScope : infoCurricularCourse.getInfoScopes()) {
                        String year =
                                infoCurricularCourseScope.getInfoCurricularSemester().getInfoCurricularYear().getYear()
                                        .toString();
                    ...
                    infoCourse.setExecutionPeriod(infoSiteCourseInformation.getInfoExecutionCourse().getInfoExecutionPeriod()
                            .getName());
                    ...
                    for (final InfoTeacher infoTeacher : infoSiteCourseInformation.getInfoLecturingTeachers()) {
                        ...
                        final InfoDepartment infoDepartment =
                                InfoDepartment.newInfoFromDomain(infoTeacher.getTeacher() != null ? infoTeacher.getTeacher()
    ...
    protected void prepareFormConstants(ActionMapping mapping, HttpServletRequest request, ActionForm form) throws Exception {
        ...
        List infoExecutionDegrees =
                ReadExecutionDegreesByExecutionYearAndDegreeType.run(executionYear, DegreeType.DEGREE, DegreeType.BOLONHA_DEGREE,
        ...
        Collections.sort(infoExecutionDegrees, new Comparator() {
            ...
            public int compare(Object o1, Object o2) {
                ...
                return infoExecutionDegree1.getInfoDegreeCurricularPlan().getInfoDegree().getNome()
                        .compareTo(infoExecutionDegree2.getInfoDegreeCurricularPlan().getInfoDegree().getNome());
            }
        });
