...
@Forwards(tileProperties = @Tile(extend = "definition.sop.periods"), value = {
        @Forward(name = "firstPage", path = "/resourceAllocationManager/periods/firstPage.jsp", contextRelative = true,
                useTile = true, redirect = false, tileProperties = @Tile(title = "private.resourcemanagement.periods.periods")),
        @Forward(name = "managePeriods", path = "/resourceAllocationManager/periods/managePeriods.jsp", tileProperties = @Tile(
                title = "private.resourcemanagement.periods.periodmanagement")) })
