...
@Mapping(module = "institucionalProjectsManagement", path = "/projectReport", attribute = "rubricForm", formBean = "rubricForm",
...
public class ProjectReportsDispatchActionForInstitucionalProjectsManagement extends
