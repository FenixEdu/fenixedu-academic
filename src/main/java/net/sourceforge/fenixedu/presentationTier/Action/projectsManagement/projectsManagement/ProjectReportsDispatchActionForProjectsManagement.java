...
@Mapping(module = "projectsManagement", path = "/projectReport", attribute = "rubricForm", formBean = "rubricForm",
...
public class ProjectReportsDispatchActionForProjectsManagement extends
