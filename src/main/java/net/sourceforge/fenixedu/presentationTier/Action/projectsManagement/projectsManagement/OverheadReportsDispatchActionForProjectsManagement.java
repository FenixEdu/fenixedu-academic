...
@Mapping(module = "projectsManagement", path = "/overheadReport", attribute = "rubricForm", formBean = "rubricForm",
...
public class OverheadReportsDispatchActionForProjectsManagement extends
