...
@Mapping(module = "operator", path = "/createClassificationsForStudents", attribute = "createClassificationsForm",
        formBean = "createClassificationsForm", scope = "request", parameter = "method")
