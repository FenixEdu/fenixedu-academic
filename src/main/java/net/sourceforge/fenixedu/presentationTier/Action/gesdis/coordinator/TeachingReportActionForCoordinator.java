...
@Mapping(module = "coordinator", path = "/viewTeachingReport", input = "/viewTeachingReport.do?method=read",
        attribute = "teachingReportForm", formBean = "teachingReportForm", scope = "request", parameter = "method")
...
public class TeachingReportActionForCoordinator extends
        net.sourceforge.fenixedu.presentationTier.Action.gesdis.TeachingReportAction {
}