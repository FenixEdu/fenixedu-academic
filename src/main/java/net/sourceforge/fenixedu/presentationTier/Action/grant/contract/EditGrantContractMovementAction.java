 ...
 * @author Pica
 */
@Mapping(module = "facultyAdmOffice", path = "/editGrantContractMovement",
        input = "/editGrantContractMovement.do?page=0&method=prepareEditGrantContractMovementForm",
        attribute = "editGrantContractMovementForm", formBean = "editGrantContractMovementForm", scope = "request",
        parameter = "method")
@Forwards(value = {
        @Forward(name = "edit-grant-contract-movement", path = "/facultyAdmOffice/grant/contract/editGrantContractMovement.jsp"),
        @Forward(name = "manage-grant-contract-movement",
                path = "/manageGrantContractMovement.do?method=prepareManageGrantContractMovement") })
            ...
            if (idGrantMovement != null) // Editing a grant contract movement
            {
                try {
                    ...
                    InfoGrantContractMovement infoGrantContractMovement =
                            (InfoGrantContractMovement) ServiceUtils.executeService("ReadGrantContractMovement", args);
