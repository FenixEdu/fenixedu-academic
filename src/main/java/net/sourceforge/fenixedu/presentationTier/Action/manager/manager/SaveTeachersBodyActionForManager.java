...
@Mapping(module = "manager", path = "/saveTeachersBody", input = "/readTeacherInCharge.do", attribute = "teacherForm",
        formBean = "teacherForm", scope = "request")
...
public class SaveTeachersBodyActionForManager extends
