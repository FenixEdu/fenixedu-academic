 ...
 * 
 */
@Mapping(module = "gep", path = "/competenceCoursesStatistics", input = "/competenceCoursesStatistics.do?method=prepare",
        attribute = "competenceCourseStatisticsForm", formBean = "competenceCourseStatisticsForm", scope = "request",
        parameter = "method")
