...
@Mapping(module = "adistProjectsManagement", path = "/overheadReport", attribute = "rubricForm", formBean = "rubricForm",
...
public class OverheadReportsDispatchActionForADISTProjectsManagement extends
