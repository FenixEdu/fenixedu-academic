...
@Mapping(module = "alumni", path = "/documentRequest", input = "/administrativeOfficeServicesSection.do",
...
@Forwards(value = {
        ...
        @Forward(name = "viewDocumentRequests",
                path = "/alumni/administrativeOfficeServices/documentRequests/viewDocumentRequests.jsp", tileProperties = @Tile(
                        title = "private.alumni.academicservices.viewrequests"), redirect = true),
        ...
        @Forward(name = "chooseRegistration",
                path = "/alumni/administrativeOfficeServices/documentRequests/chooseRegistration.jsp", tileProperties = @Tile(
                        title = "private.alumni.academicservices.certificaterequests")),
        ...
        @Forward(name = "viewDocumentRequest",
                path = "/alumni/administrativeOfficeServices/documentRequests/viewDocumentRequest.jsp", tileProperties = @Tile(
                        title = "private.alumni.academicservices.viewrequests")) })
