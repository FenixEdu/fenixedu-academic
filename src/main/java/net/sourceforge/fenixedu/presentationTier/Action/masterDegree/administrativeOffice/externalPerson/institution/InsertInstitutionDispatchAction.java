...
@Mapping(module = "masterDegreeAdministrativeOffice", path = "/insertInstitution", input = "df.page.insertInstitution",
        attribute = "insertInstitutionForm", formBean = "insertInstitutionForm", scope = "request", parameter = "method")
