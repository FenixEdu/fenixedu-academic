...
@Mapping(path = "/viewStudentCurriculum", module = "coordinator", input = "/viewStudentCurriculum.do?method=prepareView&page=0", formBean = "studentCurricularPlanAndEnrollmentsSelectionForm")
@Forwards(value = {
...
public class CurriculumDispatchAction_AM3 extends CurriculumDispatchAction {
