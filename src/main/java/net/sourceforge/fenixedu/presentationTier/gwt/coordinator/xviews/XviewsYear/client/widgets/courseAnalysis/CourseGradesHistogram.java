...
public class CourseGradesHistogram extends Composite {
    ...
    private void loadGradesHistogram(int[] gradesDistribution) {
        gradesHistogramCanvas =
                new GradesHistogramCanvas(window, gradesHistogramCanvaslWidth, gradesHistogramCanvasHeight, gradesDistribution,
                        window.getBundle().grades(), window.getBundle().distribution());
