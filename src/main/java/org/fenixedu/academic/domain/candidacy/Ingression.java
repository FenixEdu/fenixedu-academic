...
public enum Ingression implements IPresentableEnum {
    ...
    REA01("Funcionários portugueses de missão diplomática no estrangeiro e seus familiares que os acompanhem"),
    ...
    REA05(
            "Estudantes nacionais dos países africanos de expressão portuguesa, bolseiros do Governo Português, dos Governos respectivos, da Fundação Calouste Gulbenkian, ao abrigo de convenções com a UE, com frequência de ensino superior"),

    REA06(
            "Estudantes nacionais dos países africanos de expressão portuguesa, bolseiros do Governo Português, dos Governos respectivos, da Fundação Calouste Gulbenkian, ao abrigo de convenções com a UE, com o 12º ano de escolaridade do ensino secundário português ou equivalente"),

    REA07("Praticantes desportivos de alto rendimento"),
    ...
    REA10("Naturais e filhos de naturais do território de Timor Leste"),
