...
public class PreviousYearsEnrolmentExecutor extends CurricularRuleExecutor {
    ...
    protected RuleResult executeEnrolmentWithRulesAndTemporaryEnrolment(ICurricularRule curricularRule,
        ...
        if (enrolmentContext.isToEvaluateRulesByYear()) {
            return YEAR_EXECUTOR.executeEnrolmentWithRulesAndTemporaryEnrolment(curricularRule, sourceDegreeModuleToEvaluate,
                    enrolmentContext);
        }

        return SEMESTER_EXECUTOR.executeEnrolmentWithRulesAndTemporaryEnrolment(curricularRule, sourceDegreeModuleToEvaluate,
                enrolmentContext);
