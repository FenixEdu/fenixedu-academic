...
public class StudentStatute extends StudentStatute_Base {
    ...
    public StudentStatute(Student student, StatuteType statuteType, ExecutionSemester beginExecutionPeriod, ExecutionSemester
        ...
        this();
        edit(student, statuteType, beginExecutionPeriod, endExecutionPeriod, beginDate, endDate, comment);
    }
    ...
    public void edit(Student student, StatuteType statuteType, ExecutionSemester beginExecutionPeriod,
