...
@SpringFunctionality(app = AcademicAdministrationSpringApplication.class, title = "teacher.professorships.title", accessGroup = "#managers")
...
public class ProfessorshipController {
	...
	@ResponseBody
	public Boolean changeResponsibleFor(@PathVariable Professorship professorship,
			@PathVariable Boolean responsibleFor) {
