...
public class DocumentPurposeTypeProvider implements DataProvider {
    ...
    public Object provide(Object source, Object currentValue) {
        ...
        if (source instanceof DocumentRequestCreateBean) {
            ...
            documentPurposeTypes =
                    DocumentPurposeTypeInstance.findActivesFor(bean.getChosenServiceRequestType())
                            .sorted(DocumentPurposeTypeInstance.COMPARE_BY_LEGACY).collect(Collectors.toList());
        } else {
            documentPurposeTypes =
