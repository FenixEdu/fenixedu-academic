...
public class StudentStatutesDA extends FenixDispatchAction {
    ...
    public ActionForward seniorStatutePostBackEdit(ActionMapping mapping, ActionForm actionForm, HttpServletRequest request,
            HttpServletResponse response) {
    ...
    public ActionForward editStatute(ActionMapping mapping, ActionForm actionForm, HttpServletRequest request,
        ...
        try {
            atomic(() -> {
                studentStatute.edit(manageStatuteBean.getStudent(), manageStatuteBean.getStatuteType(),
