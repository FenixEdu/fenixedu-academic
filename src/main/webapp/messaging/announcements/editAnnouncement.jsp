...
<%@page import="org.fenixedu.academic.domain.messaging.Announcement"%>
...
<%-- Photo --%>	
	...
	<tr>
		<th>
			<bean:message bundle="MESSAGING_RESOURCES" key="org.fenixedu.academic.domain.messaging.Announcement.editorNotes.label"/>:
		</th>
		<td>
