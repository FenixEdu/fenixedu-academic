	...
	<logic:present name="candidacyBean">
		...
		<fieldset style="display: block;">
			...
			<table class="tstyle1 thlight mtop15">
				...
				<logic:iterate id="thesisSubjectBean" name="individualProcessBean" property="thesisSubjectBeans" type="org.fenixedu.academic.domain.phd.candidacy.PhdThesisSubjectOrderBean">
					<tr>
