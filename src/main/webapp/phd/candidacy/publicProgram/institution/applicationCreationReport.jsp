...
<logic:notEmpty name="individualCandidacyProcess" property="associatedPaymentCode">
	...
	<table>
		...
		<tr>
			...
			<td><fr:view name="individualCandidacyProcess" property="candidacy.event.originalAmountToPay"/> &euro;</td>
		</tr>
	</table>
	...
	<p>
		...
		<ul>
			...
			<li><bean:message key="message.phd.institution.application.unable.to.pay.with.sibs.bank.transfer.value" bundle="PHD_RESOURCES" />: <fr:view name="individualCandidacyProcess" property="candidacy.event.originalAmountToPay"/> &euro;</li>
		</ul>
	</p>
