...
--%>
<html:link action="/phdProgramCandidacyProcess.do?method=viewIndividualProgramProcess" paramId="processId" paramName="process" paramProperty="externalId">
...
<fr:form action="<%= "/phdProgramCandidacyProcess.do?method=editProcessAttributes&processId=" + processId %>">
	...
	<fr:edit id="processBean" name="processBean" >
		...
		<fr:destination name="invalid" path="<%= "/phdProgramCandidacyProcess.do?method=editProcessAttributesInvalid&processId=" + processId %>" />
