...
<h3 class="mbottom0"><strong><%= PhdBundleUtil.getEnumName((Enum<?>) suspendedContainer, "Phd") %> (<%= size %>)</strong></h3>
...
<bean:size id="size" name="processList" />
<h3 class="mbottom0"><strong><%= PhdBundleUtil.getEnumName((Enum<?>) concludedContainer, "Phd") %> (<%= size %>)</strong></h3>
...
<bean:size id="size" name="processList" />
<h3 class="mbottom0"><strong><%= PhdBundleUtil.getEnumName((Enum<?>) abolishedContainer, "Phd") %> (<%= size %>)</strong></h3>
...
<logic:notEqual name="size" value="0">
	<table class="tstyle2 thlight thleft">
		<tr>
			...
			<th class="col4"><bean:message key="label.org.fenixedu.academic.domain.phd.PhdIndividualProgramProcess.executionYear" bundle="PHD_RESOURCES"/></th>
			<th class="col5"><bean:message key="label.org.fenixedu.academic.domain.phd.PhdIndividualProgramProcess.phdProgram" bundle="PHD_RESOURCES"/></th>
			<th class="col6"><bean:message key="label.org.fenixedu.academic.domain.phd.PhdIndividualProgramProcess.activeState" bundle="PHD_RESOURCES"/></th>
			<th class="col7"></th>
		</tr>
		<logic:iterate id="process" name="processList">
			<tr>
