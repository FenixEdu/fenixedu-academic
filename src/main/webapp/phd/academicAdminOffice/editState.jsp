...
--%>
<html:link action="<%= String.format("/phdIndividualProgramProcess.do?method=managePhdIndividualProgramProcessState&processId=%s", processId) %>">
...
<fr:form action="<%= String.format("/phdIndividualProgramProcess.do?method=editState&processId=%s&stateId=%s", processId, stateId) %>" >
	...
	<fr:edit id="bean-edit" name="bean">
		...
		<fr:destination name="invalid" path = "<%= String.format("/phdIndividualProgramProcess.do?method=editStateInvalid&processId=%s&stateId=%s", processId, stateId) %>"/>
		<fr:destination name="cancel" path = "<%= String.format("/phdIndividualProgramProcess.do?method=managePhdIndividualProgramProcessState&processId=%s", processId) %>" />
	</fr:edit>
