...
<fr:form action="<%="/publicPresentationSeminarProcess.do?processId=" + processId.toString() %>" encoding="multipart/form-data">
	...
	<html:submit bundle="HTMLALT_RESOURCES" altKey="submit.submit" onclick="this.form.method.value='rejectComission';"><bean:message bundle="PHD_RESOURCES" key="label.reject"/></html:submit>
