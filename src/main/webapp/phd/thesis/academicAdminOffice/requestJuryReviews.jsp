...
<%-- ### Title #### --%>
<h2><bean:message key="label.phd.request.jury.reviews" bundle="PHD_RESOURCES" /></h2>
<%-- ### End of Title ### --%>
...
<fr:form action="<%= "/phdThesisProcess.do?processId=" + processId.toString() %>">
	...
	<html:submit bundle="HTMLALT_RESOURCES" altKey="submit.submit" onclick="this.form.method.value='requestJuryReviews';"><bean:message bundle="PHD_RESOURCES" key="label.submit"/></html:submit>
