...
<logic:present name="infoSiteTeachersInformation">
	<logic:iterate id="infoSiteTeacherInformation" name="infoSiteTeachersInformation">
		...
		<table class="infoselected" width="100%">
			...
			<tr>
				<td><bean:message key="message.teacherInformation.category" bundle="GEP_RESOURCES"/>
					&nbsp;<logic:notEmpty name="infoSiteTeacherInformation" property="infoTeacher.infoCategory"><bean:write name="infoSiteTeacherInformation" property="infoTeacher.infoCategory.name" /></logic:notEmpty>
		...
		<p class="infoop"><span class="emphasis-box">5</span>
			<bean:message key="message.teacherInformation.externalActivities" arg0="<%=org.fenixedu.academic.domain.organizationalStructure.Unit.getInstitutionAcronym()%>" bundle="GEP_RESOURCES"/></p>
