...
<fr:edit id="accountingEventCreateBean"
	...
	action="/accountingEventsManagement.do?method=createAdministrativeOfficeFeeAndInsuranceEvent">
	<fr:layout name="tabular">
		<fr:property name="classes" value="tstyle2 thlight" />
		<fr:property name="columnClasses" value="nowrap," />
		<fr:destination name="invalid"
			path="/accountingEventsManagement.do?method=prepareCreateAdministrativeOfficeFeeAndInsuranceEventInvalid" />
