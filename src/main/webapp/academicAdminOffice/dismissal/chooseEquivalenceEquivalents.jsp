...
<fr:form action="<%= "/studentEquivalences.do?scpID=" + scpID.toString() %>">
	...
	<fr:edit id="dismissalType" name="dismissalBean" schema="DismissalBean.chooseEquivalents">
		...
		<fr:destination name="dismissalTypePostBack" path="<%= "/studentEquivalences.do?method=dismissalTypePostBack&scpID=" + scpID.toString()%>"/>
		<fr:destination name="invalid" path="<%= "/studentEquivalences.do?method=stepTwo&scpID=" + scpID.toString() %>"/>
	</fr:edit>
