...
<%@ taglib uri="http://fenix-ashes.ist.utl.pt/fenix-renderers" prefix="fr"%>
	...
	<logic:iterate id="postingRule" name="postingRules">
		<div style="background: #f5f5f5; width: 485px; margin: 1em 1em 0 0; float: left; border: 1px solid #ddd; padding: 0 1em 1em 1em; height: 350px;">
			<bean:define id="postingRuleId" name="postingRule" property="externalId"/>
			<p class="indent1" style="position: relative; top: 90%; left: 3%;">
