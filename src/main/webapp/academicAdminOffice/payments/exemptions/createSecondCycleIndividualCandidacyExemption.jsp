...
<fr:form action='<%="/exemptionsManagement.do?eventId=" + eventId %>'>
	...
	<fr:edit id="create-penalty-exemption-bean" name="createPenaltyExemptionBean" schema="SecondCycleIndividualCandidacyExemptionBean.edit">
		<fr:layout name="tabular">
			<fr:property name="classes" value="tstyle4" />
			<fr:property name="columnClasses" value=",,tdclear tderror1" />
		</fr:layout>
		<fr:destination name="invalid" path='<%="/exemptionsManagement.do?method=prepareCreateSecondCycleIndividualCandidacyExemptionInvalid&amp;eventId=" + eventId %>'/>
	</fr:edit>

	<html:submit bundle="HTMLALT_RESOURCES" altKey="submit.submit" onclick="this.form.method.value='createSecondCycleIndividualCandidacyExemption';">
