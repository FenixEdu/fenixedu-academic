...
<h2><bean:message key="title.candidate.info" /></h2>
	<table class="tstyle1">
        <logic:present name="personalInfo">
          ...
          <tr>
	            ...
	            <td><span><bean:write name="personalInfo" property="nome"/></span></td>
          </tr>
          <!-- Candidate Number -->
          <tr>
	            <td><bean:message key="label.candidate.candidateNumber" />:</td>
	            <td><span><bean:write name="masterDegreeCandidate" property="candidateNumber"/></span></td>
          </tr>
          <!-- Specialization -->
          <tr>
	            <td><bean:message key="label.candidate.specialization" />:</td>
	            <td><span><bean:message name="masterDegreeCandidate" property="specialization.name" bundle="ENUMERATION_RESOURCES"/></span></td>
          </tr>
          <!-- Specialization Area -->
          <tr>
	            <td><bean:message key="label.candidate.specializationArea" />:</td>
	            <td><span><bean:write name="masterDegreeCandidate" property="specializationArea"/></span></td>
          </tr>
    </table>
     ...
     <table class="tstyle1">
          ...
          <tr>
            ...
            <td><span><bean:write name="personalInfo" property="telefone"/></span></td>
          </tr>
          <!-- Telemovel -->
          <tr>
            <td><bean:message key="label.person.mobilePhone" /></td>
            <td><span><bean:write name="personalInfo" property="telemovel"/></span></td>
          </tr>
          <!-- E-Mail -->
          <tr>
            <td><bean:message key="label.person.email" /></td>
            <td><span><bean:write name="personalInfo" property="email"/></span></td>
          </tr>
          <!-- WebPage -->
          <tr>
            <td><bean:message key="label.person.webSite" /></td>
            <td><span><bean:write name="personalInfo" property="enderecoWeb"/></span></td>
          </tr>
	</table>
    ...
    <table class="tstyle1">
          ...
          <tr>
            ...
            <td><span><bean:write name="masterDegreeCandidate" property="majorDegree"/></span></td>
          </tr>
          <!-- Ano de Licenciatura -->
          <tr>
            <td><bean:message key="label.candidate.majorDegreeYear" />:</td>
            <td><span><bean:write name="masterDegreeCandidate" property="majorDegreeYear"/></span></td>
          </tr>
          <!-- Escola de Licenciatura -->
          <tr>
            <td><bean:message key="label.candidate.majorDegreeSchool" />:</td>
            <td><span><bean:write name="masterDegreeCandidate" property="majorDegreeSchool"/></span></td>
          </tr>
          <!-- Media -->
          <tr>
            <td><bean:message key="label.candidate.average" />:</td>
            <td><span><bean:write name="masterDegreeCandidate" property="average"/> <bean:message key="label.candidate.values"/></span></td>
          </tr>
    </table>
...
%>
         		<td colspan="2"><bean:message key="label.masterDegree.administrativeOffice.activeSituation" /></td>
         	<% } 
%>
           <tr>
            <td><bean:message key="label.masterDegree.administrativeOffice.situation" />:</td>
            <td><span><bean:write name="situation" property="situation"/></span></td>
		   </tr>
		   <tr>
		   ...
		   <tr>
            ...
            <td><span><bean:write name="situation" property="remarks"/></span></td>
		   </tr>
         </logic:iterate>
        </logic:present>
     </table>
   ...
   <table class="tstyle1">
	...
	<logic:present name="studyPlan">
			...
			<table>
				<tr>
					<td><b><bean:message key="label.masterDegree.studyPlan.curricularCourseName"/></b></td>
					<td><b><bean:message key="label.masterDegree.studyPlan.curricularCourseCredits"/></b></td>
				</tr>
