	...
	<logic:notEmpty name="childProcesses">
		...
		<fr:view name="childProcesses" schema="IndividualCandidacyProcess.list.processes.coordinator">
			<fr:layout name="tabular-sortable">
				...
				<fr:property name="linkFormat(viewProcess)" value='<%= "/caseHandling" + childProcessName.toString() + ".do?method=listProcessAllowedActivities&amp;processId=${idInternal}&amp;degreeCurricularPlanID=" + degreeCurricularPlanID.toString() %>' />
