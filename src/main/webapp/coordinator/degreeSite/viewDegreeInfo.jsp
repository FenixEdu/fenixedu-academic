...
<html:form action="/degreeSiteManagement">
	...
	<logic:equal name="info" value="description">
		<fr:edit type="org.fenixedu.academic.domain.DegreeInfo" name="currentDegreeInfo" schema="degree.info.description" nested="true">
		    <fr:layout>
	...
	<logic:equal name="info" value="acess">
		<fr:edit type="org.fenixedu.academic.domain.DegreeInfo" name="currentDegreeInfo" schema="degree.info.access" nested="true">
			<fr:layout>
	    	    <fr:property name="classes" value="tstyle2 thlight thright thtop mbottom2"/>
	        	<fr:property name="columnClasses" value="width10em,pbottom1,tdclear tderror1 valigntop"/>
		    </fr:layout>
	...
	<logic:equal name="info" value="professionalStatus">
		<fr:edit type="org.fenixedu.academic.domain.DegreeInfo" name="currentDegreeInfo" schema="degree.info.professional.status" nested="true">
			<fr:layout>
	    	    <fr:property name="classes" value="tstyle2 thlight thright thtop mbottom2"/>
	        	<fr:property name="columnClasses" value="width10em,pbottom1,tdclear tderror1 valigntop"/>
		    </fr:layout>
