...
&lt;/schema&gt;</pre>
    ...
    <div>
        <p><strong>Result</strong></p>
        <div style="border: 1px solid #000; padding: 20px 20px 20px 20px" >
            <fr:edit id="validate" name="LOGGED_USER_ATTRIBUTE" property="person" schema="person.simple-edit-validated">
                <fr:layout name="tabular">
                    <fr:property name="classes" value="style1"/>
                    <fr:property name="columnClasses" value="listClasses,,"/>
                </fr:layout>
    ...
    <div>
        ...
        <div style="border: 1px solid #000; padding: 20px 20px 20px 20px">
            <fr:create id="dynamic-defaults" type="net.sourceforge.fenixedu.domain.Person" schema="person.create-minimal">
                ...
                <fr:default slot="name" name="LOGGED_USER_ATTRIBUTE" property="person.name"/>
                <fr:default slot="username" value="<%= "p" + 12345 %>"/>
                <fr:default slot="idDocumentType" value="IDENTITY_CARD" 
                            converter="pt.ist.fenixWebFramework.renderers.converters.EnumConverter"/>
                <fr:default slot="isPassInKerberos" value="true"/>
    ...
    <div>
        ...
        <div style="border: 1px solid #000; padding: 20px 20px 20px 20px">
            <fr:create id="hidden" type="net.sourceforge.fenixedu.domain.Person" schema="person.create-minimal-defaults">
                <fr:hidden slot="personRoles" multiple="true" name="LOGGED_USER_ATTRIBUTE" property="person.personRoles"/>
...
&lt;/fr:create&gt;</pre>
    ...
    <div>
        ...
        <div style="border: 1px solid #000; padding: 20px 20px 20px 20px">
            <fr:create id="hidden" type="net.sourceforge.fenixedu.domain.Person" schema="person.create-minimal-defaults">
                <fr:hidden slot="personRoles" name="LOGGED_USER_ATTRIBUTE" property="person.personRoles[1]"/>
                <fr:hidden slot="personRoles" name="LOGGED_USER_ATTRIBUTE" property="person.personRoles[0]"/>
