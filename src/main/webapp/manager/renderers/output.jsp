...
<div style="border-left: 1px solid #AAAAAA; padding-left: 10px;">
    ...
    <div>
        ...
        <div style="border: 1px solid #000; padding: 20px 20px 20px 20px" >
            <fr:view name="LOGGED_USER_ATTRIBUTE"/>
        </div>
    </div>
</div>
...
<div style="border-left: 1px solid #AAAAAA; padding-left: 10px;">
    ...
    <div>
        <p><strong>Result</strong></p>
        <div style="border: 1px solid #000; padding: 20px 20px 20px 20px" >
            <fr:view name="LOGGED_USER_ATTRIBUTE" property="person" layout="tabular"/>
        </div>
    </div>
</div>
...
<div style="border-left: 1px solid #AAAAAA; padding-left: 10px;">
    ...
    <div>
        <p><strong>Result</strong></p>
        <div style="border: 1px solid #000; padding: 20px 20px 20px 20px" >
            <fr:view name="LOGGED_USER_ATTRIBUTE" property="person" layout="tabular" schema="person.simple-admin-info"/>
        </div>
    </div>
</div>
...
&lt;/fr:view&gt;</pre>
    ...
    <div>
        <p><strong>Result</strong></p>
        <div style="border: 1px solid #000; padding: 20px 20px 20px 20px" >
            <fr:view name="LOGGED_USER_ATTRIBUTE" property="person" schema="person.simple-admin-info">
                <fr:layout name="tabular">
                    <fr:property name="classes" value="style1"/>
                    <fr:property name="columnClasses" value="listClasses,"/>
                </fr:layout>
...
&lt;/fr:view&gt;</pre>
    ...
    <div>
        <p><strong>Result</strong></p>
        <div style="border: 1px solid #000; padding: 20px 20px 20px 20px" >
            <fr:view name="LOGGED_USER_ATTRIBUTE" property="person" schema="person.simple-admin-info.extended">
                <fr:layout name="tabular">
                    <fr:property name="classes" value="style1"/>
                    <fr:property name="columnClasses" value="listClasses,"/>
                </fr:layout>
...
(...)
    ...
    <div>
        <p><strong>Result</strong></p>
        <div style="border: 1px solid #000; padding: 20px 20px 20px 20px" >
            <fr:view name="LOGGED_USER_ATTRIBUTE" property="person" schema="person.simple-admin-info.extended" layout="nice-details-table"/>
        </div>
    </div>
</div>
