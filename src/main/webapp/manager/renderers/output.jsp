...
<div style="border-left: 1px solid #AAAAAA; padding-left: 10px;">
    ...
    <div>
        ...
        <div style="border: 1px solid #000; padding: 20px 20px 20px 20px" >
            <fr:view name="USER_SESSION_ATTRIBUTE"/>
        </div>
    </div>
</div>
...
<div style="border-left: 1px solid #AAAAAA; padding-left: 10px;">
    ...
    <div>
        <p><strong>Result</strong></p>
        <div style="border: 1px solid #000; padding: 20px 20px 20px 20px" >
            <fr:view name="USER_SESSION_ATTRIBUTE" property="user.person" layout="tabular"/>
        </div>
    </div>
</div>
...
<div style="border: 1px solid #000; padding: 20px 20px 20px 20px;">
    <bean:define id="personId" name="USER_SESSION_ATTRIBUTE" property="user.person.externalId"/>
...
<div style="border-left: 1px solid #AAAAAA; padding-left: 10px;">
    ...
    <div>
        <p><strong>Result</strong></p>
        <div style="border: 1px solid #000; padding: 20px 20px 20px 20px" >
            <fr:view name="USER_SESSION_ATTRIBUTE" property="user.person" layout="tabular" schema="person.simple-admin-info"/>
        </div>
    </div>
</div>
...
&lt;/fr:view&gt;</pre>
    ...
    <div>
        <p><strong>Result</strong></p>
        <div style="border: 1px solid #000; padding: 20px 20px 20px 20px" >
            <fr:view name="USER_SESSION_ATTRIBUTE" property="user.person" schema="person.simple-admin-info">
                <fr:layout name="tabular">
                    <fr:property name="classes" value="style1"/>
                    <fr:property name="columnClasses" value="listClasses,"/>
                </fr:layout>
...
&lt;/fr:view&gt;</pre>
    ...
    <div>
        <p><strong>Result</strong></p>
        <div style="border: 1px solid #000; padding: 20px 20px 20px 20px" >
            <fr:view name="USER_SESSION_ATTRIBUTE" property="user.person" schema="person.simple-admin-info.extended">
                <fr:layout name="tabular">
                    <fr:property name="classes" value="style1"/>
                    <fr:property name="columnClasses" value="listClasses,"/>
                </fr:layout>
...
(...)
    ...
    <div>
        <p><strong>Result</strong></p>
        <div style="border: 1px solid #000; padding: 20px 20px 20px 20px" >
            <fr:view name="USER_SESSION_ATTRIBUTE" property="user.person" schema="person.simple-admin-info.extended" layout="nice-details-table"/>
        </div>
    </div>
</div>
...
&lt;/fr:view&gt;</pre>
    ...
    <div>
        <p><strong>Result</strong></p>
        <div style="border: 1px solid #000; padding: 20px 20px 20px 20px" >
            <fr:view name="USER_SESSION_ATTRIBUTE" property="user.person">
                <fr:layout name="template">
                    <fr:property name="template" value="/manager/renderers/template.jsp"/>
                </fr:layout>
            </fr:view>
