...
<bean:define id="postingRuleId" name="postingRuleEditor"
	property="specializationDegreeGratuityPR.externalId" />
...
action="<%= "/postingRules.do?method=editSpecializationDegreeGratuityPR&degreeCurricularPlanId=" + degreeCurricularPlanId %>">
	<fr:layout name="tabular">
		<fr:property name="classes"
			value="tstyle2 thmiddle thright thlight mtop05" />
	</fr:layout>
	<fr:destination name="invalid"
		path="<%="/postingRules.do?method=prepareEditSpecializationDegreeGratuityPRInvalid&postingRuleId=" + postingRuleId + "&amp;degreeCurricularPlanId=" + degreeCurricularPlanId %>" />
