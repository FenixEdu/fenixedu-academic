...
<fr:edit id="createPostingRuleBean" name="createPostingRuleBean"
	schema="CreatePartialRegimePRBean.edit"
	action="/postingRules.do?method=createPartialRegimePR">
	<fr:layout name="tabular">
		<fr:property name="classes" value="tstyle4 thlight thcenter mtop05" />
		<fr:destination name="invalid" path="/postingRules.do?method=prepareCreatePartialRegimePRInvalid" />
		<fr:destination name="changeExecutionYearPostback" path="/postingRules.do?method=prepareCreatePartialRegimePRPostback"/>
