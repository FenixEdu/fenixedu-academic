...
<fr:edit id="createPostingRuleBean" name="createPostingRuleBean"
	schema="CreateEnrolmentGratuityPRBean.edit"
	action="/postingRules.do?method=createEnrolmentGratuityPR">
	<fr:layout name="tabular">
		<fr:property name="classes" value="tstyle4 thlight thcenter mtop05" />
		<fr:destination name="invalid" path="/postingRules.do?method=prepareCreateEnrolmentGratuityPRInvalid" />
		<fr:destination name="changeExecutionYearPostback" path="/postingRules.do?method=prepareCreateEnrolmentGratuityPRPostback"/>
