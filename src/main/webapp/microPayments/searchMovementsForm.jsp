...
<p>Cliente (<bean:message key="institution.name.abbreviation" bundle="GLOBAL_RESOURCES" /> ID): <input type="text"/> <input type="button" value="Pesquisar"  onClick="parent.location='reprografia_movimentos_01.html'"/></p> 
