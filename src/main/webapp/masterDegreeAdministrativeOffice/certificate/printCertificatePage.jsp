...
<tiles:insert definition="df.layout.two-column.posGrad" beanName="" flush="true">
  <tiles:put name="title" value="Secretaria de Pós-Graduação125" />
  ...
  <tiles:put name="body" value="/masterDegreeAdministrativeOffice/certificate/printCertificatePage_bd.jsp" />
