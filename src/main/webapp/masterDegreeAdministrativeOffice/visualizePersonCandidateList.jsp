...
<tiles:insert definition="df.layout.two-column.posGrad" beanName="" flush="true">
  <tiles:put name="title" value="Secretaria de Pós-Graduação200" />
  ...
  <tiles:put name="body" value="/masterDegreeAdministrativeOffice/visualizePersonCandidateList_bd.jsp" />
