...
<tiles:insert definition="df.layout.two-column.posGrad" beanName="" flush="true">
  ...
  <tiles:put name="serviceName" value="Secretaria de Pós-Graduação108" />
  ...
  <tiles:put name="body" value="/masterDegreeAdministrativeOffice/candidate/displayCandidateListForRegistration_bd.jsp" />
