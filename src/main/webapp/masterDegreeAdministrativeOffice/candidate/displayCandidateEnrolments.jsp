...
<tiles:insert definition="df.layout.two-column.posGrad" beanName="" flush="true">
  <tiles:put name="title" value="Secretaria de Pós-Graduação9" />
  <tiles:put name="serviceName" value="Secretaria de Pós-Graduação106" />
  ...
  <tiles:put name="body" value="/masterDegreeAdministrativeOffice/candidate/displayCandidateEnrolments_bd.jsp" />
