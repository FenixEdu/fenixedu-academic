...
<tiles:insert definition="df.layout.two-column.posGrad" beanName="" flush="true">
  <tiles:put name="title" value="Secretaria de Pós-Graduação13" />
  <tiles:put name="serviceName" value="Secretaria de Pós-Graduação110" />
  ...
  <tiles:put name="body" value="/masterDegreeAdministrativeOffice/candidate/displayCandidatesFinalList_bd.jsp" />
