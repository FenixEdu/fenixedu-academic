...
<tiles:insert definition="df.layout.two-column.posGrad" beanName="" flush="true">
  <tiles:put name="title" value="Secretaria de Pós-Graduação163" />
  ...
  <tiles:put name="body" value="/masterDegreeAdministrativeOffice/marksManagement/editStudentMark_bd.jsp" />
