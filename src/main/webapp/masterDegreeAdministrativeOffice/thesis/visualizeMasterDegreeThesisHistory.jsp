...
<tiles:insert definition="df.layout.two-column.posGrad" beanName="" flush="true">
  <tiles:put name="title" value="Secretaria de Pós-Graduação190" />
  ...
  <tiles:put name="body" value="/masterDegreeAdministrativeOffice/thesis/visualizeMasterDegreeThesisHistory_bd.jsp" />
