...
<p class="mvert05"><strong><bean:message key="label.teacher.id" arg0="<%=net.sourceforge.fenixedu.domain.organizationalStructure.Unit.getInstitutionAcronym()%>"/>: </strong><bean:write name="teacher" property="teacherId"/></p>
