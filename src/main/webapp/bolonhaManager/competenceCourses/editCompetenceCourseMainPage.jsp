...
<f:view>
	...
	<fc:dataRepeater value="#{CompetenceCourseManagement.sortedCompetenceCourseLoads}" var="competenceCourseLoad" rowCountVar="numberOfElements">
		...
		<h:outputText value="#{competenceCourseLoad.problemsHours} h/#{bolonhaBundle['lowerCase.semester']}</li>" escape="false"/>
		...
		<h:outputText value="#{competenceCourseLoad.otherHours} h/#{bolonhaBundle['lowerCase.semester']}</li>" escape="false"/>		
