				...
				<div class="infoop2">
					...
					<logic:iterate id="executionCourse" name="executionCourses">
						<p style="margin: 0 0 0.5em 0;">
							...
							<html:link page="<%="/teacher/teachingInquiry.do?method=showInquiriesPrePage&" + net.sourceforge.fenixedu.presentationTier.servlets.filters.ContentInjectionRewriter.buildContextAttribute("/teacher")%>" paramId="executionCourseID" paramName="executionCourse" paramProperty="externalId">
								<strong>
