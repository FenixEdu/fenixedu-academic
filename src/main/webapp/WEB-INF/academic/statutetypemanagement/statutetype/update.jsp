...
<div class="well well-sm" style="display:inline-block">
	<a class="" href="${pageContext.request.contextPath}/academic/statutetypemanagement/statutetype/read/${statuteType.externalId}" ><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<spring:message code="label.event.back" /></a>
|&nbsp;&nbsp;</div>
...
<div class="col-sm-10">
	<input id="statuteType_code" class="form-control" type="text" name="code" value='${statuteType.code}' readonly/> 
</div>
</div>
<div class="form-group row">
...
<div class="col-sm-10">
	<input id="statuteType_name" class="form-control" type="text" name="name"  bennu-localized-string value='${not empty param.name ? param.name.json() : statuteType.name.json() }'/> 
</div>
</div>		
<div class="form-group row">
