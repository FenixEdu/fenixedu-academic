...
<div class="col-sm-10">
	<input id="ingressionType_fullDescription" class="form-control" type="text" name="fulldescription"  bennu-localized-string value='${not empty param.fulldescription ? param.fulldescription : "{}" } '/> 
</div>
</div>		
<div class="form-group row">
