...
<div class="well well-sm" style="display:inline-block">
	<a class="" href="${pageContext.request.contextPath}/academic/candidacy/manageingressiontype/ingressiontype/read/${ingressionType.externalId}" ><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<spring:message code="label.event.back" /></a>
</div>
...
<div class="form-group row">
<div class="col-sm-2 control-label"><spring:message code="label.IngressionType.fullDescription"/></div> 

<div class="col-sm-10">
	<input id="ingressionType_fullDescription" class="form-control" type="text" name="fulldescription"  bennu-localized-string value='${not empty param.fulldescription ? param.fulldescription : ingressionType.fullDescription.json() } '/> 
</div>
</div>		
<div class="form-group row">
...
<div class="form-group row">
<div class="col-sm-2 control-label"><spring:message code="label.IngressionType.isExternalCourseChange"/></div> 

<div class="col-sm-2">
<select id="ingressionType_isExternalCourseChange" name="isexternalcoursechange" class="form-control">
<option value="true"><spring:message code="label.yes"/></option>				
<option value="false"><spring:message code="label.no"/></option>
</select>
	<script>
		$("#ingressionType_isExternalCourseChange").val('<c:out value='${not empty param.isexternalcoursechange ? param.isexternalcoursechange : ingressionType.isExternalCourseChange }'/>');
	</script>	
</div>
</div>		
<div class="form-group row">
...
<div class="form-group row">
<div class="col-sm-2 control-label"><spring:message code="label.IngressionType.isInternalCourseChange"/></div> 

<div class="col-sm-2">
<select id="ingressionType_isInternalCourseChange" name="isinternalcoursechange" class="form-control">
<option value="true"><spring:message code="label.yes"/></option>				
<option value="false"><spring:message code="label.no"/></option>
</select>
	<script>
		$("#ingressionType_isInternalCourseChange").val('<c:out value='${not empty param.isinternalcoursechange ? param.isinternalcoursechange : ingressionType.isInternalCourseChange }'/>');
	</script>	
</div>
</div>		
<div class="form-group row">
