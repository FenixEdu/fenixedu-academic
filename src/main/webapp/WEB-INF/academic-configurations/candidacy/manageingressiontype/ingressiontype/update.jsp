...
<div class="page-header">
	<h1><spring:message code="label.candidacy.manageIngressionType.UpdateIngressionType" />
		<small></small>
	</h1>
</div>
...
<div class="well well-sm" style="display:inline-block">
	<a class="" href="${pageContext.request.contextPath}/academic-configurations/candidacy/manageingressiontype/ingressiontype/read/${ingressionType.externalId}" ><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<spring:message code="label.event.back" /></a>
</div>
...
<div class="col-sm-10">
	<input id="ingressionType_description" class="form-control" type="text" name="description"  bennu-localized-string value='${not empty param.description ? param.description : ingressionType.description.json() } '/> 
</div>
</div>		
<div class="form-group row">
...
<option value="false"><spring:message code="label.no"/></option>
	...
	<script>
		$("#ingressionType_isDirectAccessFrom1stCycle").val('<c:out value='${not empty param.isdirectaccessfrom1stcycle ? param.isdirectaccessfrom1stcycle : ingressionType.directAccessFrom1stCycle }'/>');
	</script>	
</div>
</div>		
<div class="form-group row">
...
<option value="false"><spring:message code="label.no"/></option>
	...
	<script>
		$("#ingressionType_isExternalDegreeChange").val('<c:out value='${not empty param.isexternaldegreechange ? param.isexternaldegreechange : ingressionType.externalDegreeChange }'/>');
	</script>	
</div>
</div>		
<div class="form-group row">
...
<option value="false"><spring:message code="label.no"/></option>
	...
	<script>
		$("#ingressionType_isFirstCycleAttribution").val('<c:out value='${not empty param.isfirstcycleattribution ? param.isfirstcycleattribution : ingressionType.firstCycleAttribution }'/>');
	</script>	
</div>
</div>		
<div class="form-group row">
...
<option value="false"><spring:message code="label.no"/></option>
	...
	<script>
		$("#ingressionType_isHandicappedContingent").val('<c:out value='${not empty param.ishandicappedcontingent ? param.ishandicappedcontingent : ingressionType.handicappedContingent }'/>');
	</script>	
</div>
</div>		
<div class="form-group row">
...
<option value="false"><spring:message code="label.no"/></option>
	...
	<script>
		$("#ingressionType_isInternal2ndCycleAccess").val('<c:out value='${not empty param.isinternal2ndcycleaccess ? param.isinternal2ndcycleaccess : ingressionType.internal2ndCycleAccess }'/>');
	</script>	
</div>
</div>		
<div class="form-group row">
...
<option value="false"><spring:message code="label.no"/></option>
	...
	<script>
		$("#ingressionType_isInternal3rdCycleAccess").val('<c:out value='${not empty param.isinternal3rdcycleaccess ? param.isinternal3rdcycleaccess : ingressionType.internal3rdCycleAccess }'/>');
	</script>	
</div>
</div>		
<div class="form-group row">
...
<option value="false"><spring:message code="label.no"/></option>
	...
	<script>
		$("#ingressionType_isInternalDegreeChange").val('<c:out value='${not empty param.isinternaldegreechange ? param.isinternaldegreechange : ingressionType.internalDegreeChange }'/>');
	</script>	
</div>
</div>		
<div class="form-group row">
...
<option value="false"><spring:message code="label.no"/></option>
	...
	<script>
		$("#ingressionType_isIsolatedCurricularUnits").val('<c:out value='${not empty param.isisolatedcurricularunits ? param.isisolatedcurricularunits : ingressionType.isolatedCurricularUnits }'/>');
	</script>	
</div>
</div>		
<div class="form-group row">
...
<option value="false"><spring:message code="label.no"/></option>
	...
	<script>
		$("#ingressionType_isMiddleAndSuperiorCourses").val('<c:out value='${not empty param.ismiddleandsuperiorcourses ? param.ismiddleandsuperiorcourses : ingressionType.middleAndSuperiorCourses }'/>');
	</script>	
</div>
</div>		
<div class="form-group row">
...
<option value="false"><spring:message code="label.no"/></option>
	...
	<script>
		$("#ingressionType_isOver23").val('<c:out value='${not empty param.isover23 ? param.isover23 : ingressionType.over23 }'/>');
	</script>	
</div>
</div>		
<div class="form-group row">
...
<option value="false"><spring:message code="label.no"/></option>
	...
	<script>
		$("#ingressionType_isReIngression").val('<c:out value='${not empty param.isreingression ? param.isreingression : ingressionType.reIngression }'/>');
	</script>	
</div>
</div>		
<div class="form-group row">
...
<option value="false"><spring:message code="label.no"/></option>
	...
	<script>
		$("#ingressionType_isTransfer").val('<c:out value='${not empty param.istransfer ? param.istransfer : ingressionType.transfer }'/>');
	</script>	
</div>
</div>		
  </div>
