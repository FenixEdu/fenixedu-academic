    ...
    <main>
        ...
        <section>
            <div class="alert alert-info" role="alert">
                ...
                <ul>
                    <li> <c:out value='${template.code}'/> </li>
                    <li> <c:out value='${template.title.content}'/> </li>
                    <li> <c:out value='${template.description.content}'/> </li>
                </ul>
            </div>
        </section>
            ...
            <section>
                <div class="form-group">
                    ...
                    <div class="col-sm-10 error-msg-container">
                        ...
                        <span class="help-block error-msg hidden"><spring:message code="accounting.management.event.templates.alert.validation.config.apply.from"/> ${templateLastConfigDate.toString("yyyy-MM-dd")}.</span>
                    </div>
                </div>
                <div class="form-group">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="alert alert-info" role="alert">
                                                        ...
                                                        <ul>
                                                            <li> <c:out value='${child.code}'/> </li>
                                                            <li> <c:out value='${child.title.content}'/> </li>
                                                            <li> <c:out value='${child.description.content}'/> </li>
                                                        </ul>
                                                    </div>
