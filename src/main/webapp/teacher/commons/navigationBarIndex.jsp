...
<ul>
  ...
  <li>
   ...
   <li>
	...
	<%-- 
  <li>
  	<bean:define id="url"><%= request.getContextPath() %>/teacher/credits.do?method=showTeacherCredits&amp;teacherId=<bean:write name="USER_SESSION_ATTRIBUTE" property="user.person.teacher.externalId"/>&amp;executionPeriodId=<%= ExecutionPeriod.readActualExecutionPeriod().getExternalId() %></bean:define>
  	<html:link href="<%= url %>">
...
<%-- 
	<logic:notPresent name="USER_SESSION_ATTRIBUTE" property="user.person.employee">
	...
	<logic:present name="USER_SESSION_ATTRIBUTE" property="user.person.employee">
		<logic:empty name="USER_SESSION_ATTRIBUTE" property="user.person.employee.currentDepartmentWorkingPlace">
			<li><html:link page="/manageNonRegularTeachingService.do?method=showNonRegularTeachingService"><bean:message key="link.teacherService" bundle="APPLICATION_RESOURCES" /></html:link></li>
		</logic:empty>
	</logic:present>
--%>
	...
	<logic:present name="USER_SESSION_ATTRIBUTE" property="user.person.teacher">
		<logic:equal name="USER_SESSION_ATTRIBUTE" property="user.person.teacher.erasmusCoordinator" value="true"> 
