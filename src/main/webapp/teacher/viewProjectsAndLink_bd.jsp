...
<logic:empty name="executionCourse" property="exportGroupingsSet">
	...
	<ul>
		<li><html:link page="/studentGroupManagement.do?method=prepareCreateGroupProperties" paramId="executionCourseID" paramName="executionCourseID" ><bean:message key="link.groupPropertiesDefinition"/></html:link></li>
		<logic:present name="hasProposals">
			<li>
				<html:link page="/studentGroupManagement.do?method=viewNewProjectProposals" paramId="executionCourseID" paramName="executionCourseID" ><bean:message key="link.executionCourseProposals.received"/></html:link>
			</li>
		</logic:present>
	</ul>
</logic:empty>
 ...
 <logic:notEmpty name="executionCourse" property="exportGroupingsSet"> 
	...
	<ul class="mtop15">
		<li>
			<html:link page="/studentGroupManagement.do?method=prepareCreateGroupProperties" paramId="executionCourseID" paramName="executionCourseID" ><bean:message key="link.groupPropertiesDefinition"/></html:link>
		</li>
		<logic:present name="hasProposals">
			<li>
				<html:link page="/studentGroupManagement.do?method=viewNewProjectProposals" paramId="executionCourseID" paramName="executionCourseID" ><bean:message key="link.executionCourseProposals.received"/></html:link>
		...
		<logic:present name="waitingAnswer">
			<li>
				<html:link page="/studentGroupManagement.do?method=viewSentedProjectProposalsWaiting" paramId="executionCourseID" paramName="executionCourseID" ><bean:message key="link.executionCourseProposals.sented"/></html:link>
			</li>
		</logic:present>
	</ul>
...
<table class="tstyle4">
        <tbody>
    	 <tr>
            ...
            <logic:iterate id="infoGroupProperties" name="executionCourse" property="groupings" >
            	<tr>
                    <td class="acenter">
                        <b>
                        <html:link page="<%= "/studentGroupManagement.do?method=viewShiftsAndGroups&amp;executionCourseID=" + pageContext.findAttribute("executionCourseID")%>" paramId="groupPropertiesCode" paramName="infoGroupProperties" paramProperty="externalId">
                	 ...
                	 <td  class="acenter">
	                	 ...
	                	 <logic:notEmpty name="infoGroupProperties" property="groupMaximumNumber">
	                   	 ...
	                   	 <p class="mvert0"><b><bean:message key="label.student.viewExecutionCourseProjects.GroupEnrolmentPolicy"/>:</b>
		                   	 <bean:message key="${infoGroupProperties.enrolmentPolicy.type == 1 ? 'label.atomic' : 'label.individual'}"/>
	                   	 </p>
	                   	 
                	</td>
                	
                	<td class="acenter">
                		<bean:size id="count" name="infoGroupProperties" property="exportGroupingsSet"/>
                		<logic:greaterThan name="count" value="1">
            		    <logic:iterate id="infoExportGrouping" name="infoGroupProperties" property="exportGroupingsSet" >
