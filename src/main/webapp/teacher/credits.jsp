...
<ul class="mvert1">
	<li>
		<html:link href='<%= linkToPrintSchedules %>' target="_blank">
...
<h3 class="mtop2"><span class="underline1">4) <bean:message key="label.teacherCreditsSheet.institutionWorkingTime" arg0="<%=net.sourceforge.fenixedu.domain.organizationalStructure.Unit.getInstitutionAcronym()%>" bundle="TEACHER_CREDITS_SHEET_RESOURCES"/></span></h3>
...
<logic:notEmpty name="serviceExemptions">
	<table class="tstyle4 mbottom05">
		...
		<logic:iterate id="serviceExemption" name="serviceExemptions" >
			<tr>
				<td style="text-align:left">
					<bean:write name="serviceExemption" property="type.name"/>
				</td>
				<td>
