...
<fr:form action='<%="/caseHandling" + processName + ".do?processId=" + processId.toString() %>'>
	...
	<fr:schema type="net.sourceforge.fenixedu.domain.candidacyProcess.graduatedPerson.DegreeCandidacyForGraduatedPersonIndividualCandidacyResultBean" bundle="APPLICATION_RESOURCES">
...
<fr:form action='<%="/caseHandling" + processName + ".do?processId=" + processId.toString() %>'>
	...
	<logic:notEmpty name="individualCandidacyResultBean" property="candidacyProcess">
		...
		<fr:edit id="individualCandidacyResultBean.manage"
			...
			schema="DegreeCandidacyForGraduatedPersonIndividualCandidacyResultBean.introduce.result.coordinator">
			<fr:layout name="tabular-editable">
				<fr:property name="classes" value="tstyle4 thlight thright mtop025"/>
		        <fr:property name="columnClasses" value="width12em,,tdclear tderror1"/>
			</fr:layout>
