	...
	<logic:notEmpty name="component" property="items">
		<logic:iterate id="item" name="component" property="items">
			...
			<logic:present name="item" property="infoFileItems">
				...
				<bean:define id="itemCode" name="item" property="externalId" type="java.lang.Integer"/>
				...
				<bean:define id="fileItemId" name="infoFileItem" property="externalId" type="java.lang.Integer"/>
					<tr>
