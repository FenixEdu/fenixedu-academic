...
<logic:present name="infoDegreeCurricularPlan">
	...
	<div class="breadcumbs mvert0"><%= pt.ist.fenixWebFramework.servlets.filters.contentRewrite.RequestRewriter.HAS_CONTEXT_PREFIX %><a href="http://www.ist.utl.pt/index.shtml"><bean:message key="institution.name.abbreviation" bundle="GLOBAL_RESOURCES" /></a>
