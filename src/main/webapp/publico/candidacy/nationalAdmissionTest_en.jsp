...
<h1>Prospective Students: BSc degree in <%=org.fenixedu.academic.domain.organizationalStructure.Unit.getInstitutionAcronym()%></h1>
<p>Students applying to a 1st cycle (BSc degree) in <%=org.fenixedu.academic.domain.organizationalStructure.Unit.getInstitutionAcronym()%> should enroll into one of the following programs:</p>
<ul>
...
<p>The requirements to apply for the <%=org.fenixedu.academic.domain.organizationalStructure.Unit.getInstitutionAcronym()%> Courses are the following (on a scale of 0 to 200 points):</p>
<ul>
