...
<p>The admission in first cycle degree of <bean:message key="institution.name.abbreviation" bundle="GLOBAL_RESOURCES" /> can be made through the following access mechanisms:</p>
