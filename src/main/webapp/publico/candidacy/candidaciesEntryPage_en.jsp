...
<p>The admission in first cycle degree of <%=org.fenixedu.academic.domain.organizationalStructure.Unit.getInstitutionAcronym()%> can be made through the following access mechanisms:</p>
...
<ul>
	...
	<li><%= pt.ist.fenixWebFramework.servlets.filters.contentRewrite.GenericChecksumRewriter.NO_CHECKSUM_PREFIX %><a href="<%= org.fenixedu.academic.domain.Installation.getInstance().getInstituitionURL() %>en/htm/profile/pstudent/lic/change-transfer-course.shtml">Degree Change and Transfers</a></li>
	<li>Concurso Especial de Acesso
		<ul style="margin-top: 0.5em;">
			<li><%= pt.ist.fenixWebFramework.servlets.filters.contentRewrite.GenericChecksumRewriter.NO_CHECKSUM_PREFIX %><a href="<%= org.fenixedu.academic.domain.Installation.getInstance().getInstituitionURL() %>en/htm/profile/pstudent/lic/middle-course.shtml">Bachelor first cycle degrees owners</a></li>
