...
<fr:form action='<%= mappingPath + ".do?userAction=createCandidacy" %>' id="erasmusCandidacyForm">
	...
	<logic:notEmpty name="individualCandidacyProcessBean" property="candidacyProcess">
		...
		<p><em>Specify the date of arrival and departure. Also specify the types of study you're going to do at <bean:message key="institution.name.abbreviation" bundle="GLOBAL_RESOURCES" />.</em></p>
