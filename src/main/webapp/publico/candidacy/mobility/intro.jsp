...
<p class="mvert05">
	<ul>
		<li><b>Photo</b> (passport-like) - The photo will be used to generate <%=org.fenixedu.academic.domain.organizationalStructure.Unit.getInstitutionAcronym()%> student card. Please upload a passport-like photo.</li>
