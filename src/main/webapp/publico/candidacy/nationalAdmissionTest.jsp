...
<p>Os estudantes que pretendam candidatar-se ao <%=org.fenixedu.academic.domain.organizationalStructure.Unit.getInstitutionAcronym()%> com vista a obter uma formação superior deverão optar por um dos seguintes percursos, consoante a área de estudos pretendida:</p>
<ul>
...
<p>As condi&ccedil;&otilde;es exigidas para a candidatura aos Cursos ministrados no <%=org.fenixedu.academic.domain.organizationalStructure.Unit.getInstitutionAcronym()%> s&atilde;o as seguintes (expressas numa escala de 0 a 200 pontos):</p>
<ul>
...
<ul> 
	...
	<li><a href="<%= org.fenixedu.academic.domain.Installation.getInstance().getInstituitionURL() %>html/campus/tagus/sat/">Servi&ccedil;os Administrativos do IST-Taguspark (SAT)</a></li> 
	<li><a href="http://guiatecnico.aeist.pt/">Guia do T&eacute;cnico </a> &nbsp;(Publica&ccedil;&atilde;o da responsabilidade da <a href="http://ae.ist.utl.pt/">Associa&ccedil;&atilde;o de Estudantes do <%=org.fenixedu.academic.domain.organizationalStructure.Unit.getInstitutionAcronym()%></a>) </li> 
	<li><a href="http://guialisboa.aeist.pt/">Guia de Lisboa</a>&nbsp;(Publica&ccedil;&atilde;o da responsabilidade da <a href="http://ae.ist.utl.pt/">Associa&ccedil;&atilde;o de Estudantes do <%=org.fenixedu.academic.domain.organizationalStructure.Unit.getInstitutionAcronym()%></a>) </li> 

</ul>	
</div>
<h2 id="doc">Documentos</h2>
<ul class="material">
	<li class="pdf"><a href="<%= org.fenixedu.academic.domain.Installation.getInstance().getInstituitionURL() %>files/ensino/reg_1e2ciclo_20082009.pdf">Regulamento do 1º e 2º ciclo para 2008/2009</a> (PDF, 826KB)</li>
	<li class="pdf"><a href="<%= org.fenixedu.academic.domain.Installation.getInstance().getInstituitionURL() %>files/ensino/propinas_20082009.pdf">Propinas do 1º e 2º ciclo para 2008/2009</a> (PDF, 28KB)</li>
</ul>
