...
<p><em><bean:message key="message.candidacy.upload.png.jpg.documents" bundle="CANDIDATE_RESOURCES"/></em></p>
...
<fr:form action='<%= mappingPath + ".do?method=uploadPhoto" %>' encoding="multipart/form-data">
	...
	<fr:edit id="individualCandidacyProcessBean.document.file"
		...
		schema="PublicCandidacyProcessBean.secondcycle.photo.edit">
