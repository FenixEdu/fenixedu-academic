...
<h2 class="brown">In this page</h2>
	<ul>
    	<li><%= pt.ist.fenixWebFramework.servlets.filters.contentRewrite.GenericChecksumRewriter.NO_CHECKSUM_PREFIX_HAS_CONTEXT_PREFIX %><a href="#desc">Description</a></li>
    	<li><%= pt.ist.fenixWebFramework.servlets.filters.contentRewrite.GenericChecksumRewriter.NO_CHECKSUM_PREFIX_HAS_CONTEXT_PREFIX %><a href="#vag">Vacancies</a></li>
    	<li><%= pt.ist.fenixWebFramework.servlets.filters.contentRewrite.GenericChecksumRewriter.NO_CHECKSUM_PREFIX_HAS_CONTEXT_PREFIX %><a href="#praz">Deadlines</a></li>
    	<li><%= pt.ist.fenixWebFramework.servlets.filters.contentRewrite.GenericChecksumRewriter.NO_CHECKSUM_PREFIX_HAS_CONTEXT_PREFIX %><a href="#prop">Tuition fees</a></li>
    	<li><%= pt.ist.fenixWebFramework.servlets.filters.contentRewrite.GenericChecksumRewriter.NO_CHECKSUM_PREFIX_HAS_CONTEXT_PREFIX %><a href="#critsel">Selection criteria</a></li>
    	<li><%= pt.ist.fenixWebFramework.servlets.filters.contentRewrite.GenericChecksumRewriter.NO_CHECKSUM_PREFIX_HAS_CONTEXT_PREFIX %><a href="#docnec">Documentation needed</a></li>
    	<li><%= pt.ist.fenixWebFramework.servlets.filters.contentRewrite.GenericChecksumRewriter.NO_CHECKSUM_PREFIX_HAS_CONTEXT_PREFIX %><a href="#emol">Application fees</a></li>
    	<li><%= pt.ist.fenixWebFramework.servlets.filters.contentRewrite.GenericChecksumRewriter.NO_CHECKSUM_PREFIX_HAS_CONTEXT_PREFIX %><a href="#faq">FAQ</a></li>
...
<h3>Q1: I am a final-year student of a 1st cycle programme in <bean:message key="institution.name.abbreviation" bundle="GLOBAL_RESOURCES" />. Do I have to do anything specific to continue my studies in the same 2nd cycle programme?</h3>
<p>No, in these cases the transition to the 2nd cycle is automatic.</p>

<h3>Q2: I am a final-year student of a 1st cycle programme at <bean:message key="institution.name.abbreviation" bundle="GLOBAL_RESOURCES" />. In which conditions is the transition to a different 2nd cycle automatic?</h3>
<p>A2: After completing the 1st cycle programme at <bean:message key="institution.name.abbreviation" bundle="GLOBAL_RESOURCES" /> you can always pursuit your studies in a different 2nd cycle programme at <bean:message key="institution.name.abbreviation" bundle="GLOBAL_RESOURCES" /> as long as both programmes are scientifically coherent. This <a href="http://www.ist.utl.pt/files/ensino/coerencias_cientificas_0910.pdf">scientific coherence</a> occurs whenever the training skills of the 1st cycle respect the training needs for admission to the 2nd cycle.</p>

<h3>Q3: I am a final-year student of a 1st programme at <bean:message key="institution.name.abbreviation" bundle="GLOBAL_RESOURCES" />. What should I do if I want to pursuit my studies in a 2nd cycle programme at <bean:message key="institution.name.abbreviation" bundle="GLOBAL_RESOURCES" /> which have no scientific coherence with the 1st cycle programme?</h3>
<p>A3: You should submit your application for the 2nd cycle programme following the deadlines and regulations defined for that purpose. The application will be analysed along with the applications of external students that intend to enroll in a 2nd cycle programme at <bean:message key="institution.name.abbreviation" bundle="GLOBAL_RESOURCES" />.</p>

<h3>Q4: I hold a pre-Bologna graduate programme from <bean:message key="institution.name.abbreviation" bundle="GLOBAL_RESOURCES" />. May I apply for a 2nd cycle Master programme, in the same area of expertise?</h3>
<p>A4: Yes. </p>
