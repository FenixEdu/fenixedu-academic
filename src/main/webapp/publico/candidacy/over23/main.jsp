...
<h2 class="brown">Nesta página</h2>
	<ul>
    	...
    	<li><a href="<%= fullPath + "?method=prepareRecoverAccessLink" %>"><b>Recuperar Acesso</b></a></li>
   </ul>
</div>
...
<p><a href="<%= org.fenixedu.academic.domain.Installation.getInstance().getInstituitionURL() %>files/ensino/reg_maiores23.pdf">Regulamento (PDF, 68KB)</a></p>


<h2 id="critsel">Critérios de selecção</h2>

<p>A avaliação da capacidade para a frequência de um curso de licenciatura ou do 1º ciclo de um curso integrado do <%=org.fenixedu.academic.domain.organizationalStructure.Unit.getInstitutionAcronym()%> consta das seguintes componentes:</p>
...
<p><a href="<%= org.fenixedu.academic.domain.Installation.getInstance().getInstituitionURL() %>files/ensino/programas_23anos_20092010.pdf">Programa das provas de avaliação (PDF, 136KB)</a></p>
...
<table class="tab_simpler" summary="Prazos para candidatos em mudanÃ§a ou transferÃªncia de curso" cellspacing="0">
	...
	<td>Data limite para apresentação de recursos ao Presidente do <%=org.fenixedu.academic.domain.organizationalStructure.Unit.getInstitutionAcronym()%></td>
	</tr>
	<tr>
