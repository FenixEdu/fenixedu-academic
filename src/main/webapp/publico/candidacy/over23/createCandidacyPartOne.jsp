...
<fr:form id="over23CandidacyForm" action='<%= mappingPath + ".do?method=continueCandidacyCreation" %>' encoding="multipart/form-data">
		...
		<table>
			<tr>
				<td colspan="2">
					<bean:message key="message.ist.former.student.number.required" arg0="<%=net.sourceforge.fenixedu.domain.organizationalStructure.Unit.getInstitutionName().getContent()%>" bundle="CANDIDATE_RESOURCES"/>
				</td>
			</tr>
			<tr>
				<td class="width175px">
					<bean:message key="label.studentNumber" bundle="CANDIDATE_RESOURCES"/>:
				</td>
				<td>
