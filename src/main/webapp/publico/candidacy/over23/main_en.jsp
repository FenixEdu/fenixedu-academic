...
<p>A avaliação da capacidade para a frequência de um curso de licenciatura ou do 1º ciclo de um curso integrado do <bean:message key="institution.name.abbreviation" bundle="GLOBAL_RESOURCES" /> consta das seguintes componentes:</p>
...
<table class="tab_simpler" summary="Prazos para candidatos em mudanÃ§a ou transferÃªncia de curso" cellspacing="0">
	...
	<td>Data limite para apresentação de recursos ao Presidente do <bean:message key="institution.name.abbreviation" bundle="GLOBAL_RESOURCES" /></td>
	</tr>
	<tr>
