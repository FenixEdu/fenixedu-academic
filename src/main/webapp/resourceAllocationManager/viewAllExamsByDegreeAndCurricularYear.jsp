...
<tiles:insert definition="df.layout.two-column" beanName="" flush="true">
  ...
  <tiles:put name="title" value="private.resourcemanagement.reviewswritten.executiondates.searchbydate"/>
  ...
  <tiles:put name="body" value="/resourceAllocationManager/viewAllExamsByDegreeAndCurricularYear_bd.jsp" />
