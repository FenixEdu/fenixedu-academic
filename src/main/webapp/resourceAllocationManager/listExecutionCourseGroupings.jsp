...
<tiles:insert definition="df.layout.two-column" beanName="" flush="true">
  ...
  <tiles:put name="title" value="private.resourcemanagement.disciplinesexecution.manage.listingofpools" />
  ...
  <tiles:put name="body" value="/resourceAllocationManager/listExecutionCourseGroupings_bd.jsp" />
