...
<tiles:insert definition="df.layout.two-column" beanName="" flush="true">
  <tiles:put name="title" value="private.resourcemanagement.schedules.shifts.students" />
  ...
  <tiles:put name="body" value="/resourceAllocationManager/viewStudentsEnroledInShift_bd.jsp" />
