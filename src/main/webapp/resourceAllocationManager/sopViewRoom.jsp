...
<tiles:insert definition="df.layout.two-column" beanName="" flush="true">
  ...
  <tiles:put name="title" value="private.resourcemanagement.rooms.manage.handleshowroom"/>
  ...
  <tiles:put name="body" value="/resourceAllocationManager/sopViewRoom_bd.jsp" />
