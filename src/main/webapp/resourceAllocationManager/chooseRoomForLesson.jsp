...
<tiles:insert definition="df.layout.two-column" beanName="" flush="true">
  <tiles:put name="title" value="private.resourcemanagement.schedules.shifts.chooseRoom" />
  ...
  <tiles:put name="body" value="/resourceAllocationManager/chooseRoomForLesson_bd.jsp" />
