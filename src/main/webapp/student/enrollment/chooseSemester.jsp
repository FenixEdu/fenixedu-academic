...
<fr:form action="/studentEnrollmentManagement.do?method=chooseExecutionPeriod">
	<fr:edit id="chooseSemester" name="chooseSemester">
		<fr:schema bundle="STUDENT_RESOURCES"
			...
			<fr:slot name="chosenSemester" layout="menu-select-postback" key="label.semester" required="true">
				<fr:property name="from" value="semestersForCourses" />
        ...
        <fr:destination name="postBack" path="/studentEnrollmentManagement.do?method=chooseExecutionPeriod" />
	</fr:edit>      
</fr:form>