...
app.controller("GroupingsCtrl", ['$scope', '$rootScope',
  '$http',
      ...
      function($scope, $rootScope, $http, $routeParams,
        ...
        $scope.enrollStudent = function() {
          $http({
            ...
            .success(
              function() {
                $scope.message = "Student enrolled in group " + $scope.studentGroup.groupNumber;
        ...
        $scope.unenrollStudent = function() {
          $http({
            ...
            .success(
              function() {
                $rootScope.message = "Student unenrolled from group " + $scope.studentGroup.groupNumber;
        ...
        $scope.changeShift = function(shift) {
          ...
          $http({
            ...
            .success(
              function() {
                $scope.message = "Group change to shift " + shift.name;
                $scope.shift = shift;
                return;
              }).error(function(data) {
              $rootScope.error = data.message
        ...
        $scope.createStudentGroup = function(shift) {
          ...
          $http({
            ...
            .success(
              function() {
                $rootScope.message = "Group created";
                $location.path("/grouping/" + $routeParams.groupId);
                return;
              }).error(function(data) {
              $rootScope.error = data.message
