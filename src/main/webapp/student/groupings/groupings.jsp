...
<div>
	<input type="hidden" ng-model="contextPath" value="${pageContext.request.contextPath}" />
	<input type="hidden" ng-model="person" value="${currentPerson}" />
	...
	<div>
		...
		<div class="well " ng-repeat="grouping in groupings">
			<div class="row">
				<div class="col-md-2">
					<p>
						<strong>${fr:message('resources.ApplicationResources', 'label.grouping')}</strong>
						<span>{{grouping.name}}</span>
					</p>
				</div>
				<div class="col-md-1">
					<p>
						<a class="middle btn btn-default" ng-href="#/grouping/{{grouping.externalId}}" ng-disabled="!grouping.externalId">
				...
				<div class="col-md-2">
					...
					<p>
						<span ng-show="!grouping.maximumGroupCapacity && !grouping.minimumGroupCapacity &&
						...
						<span ng-show="grouping.maximumGroupCapacity "> <abbr
				...
				<div class="col-md-12" ng-hide="groupings == null || groupings.length">
