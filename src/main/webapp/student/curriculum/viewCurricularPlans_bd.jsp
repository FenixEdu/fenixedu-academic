...
<%@ page import="org.fenixedu.academic.dto.InfoStudentCurricularPlan" %>
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td class="infoop">
					...
					O plano curricular com a data mais antiga (ano da sua entrada no <%=org.fenixedu.academic.domain.organizationalStructure.Unit.getInstitutionAcronym()%>), contem o seu currículo tal e qual como o pode visionar no ponto habitual acedido através da página do <%=org.fenixedu.academic.domain.organizationalStructure.Unit.getInstitutionAcronym()%>.<br/>
