				...
				<table border="0" width="100%" height="100" align="center"
					...
					<tr>
						<td width="50" height="100"><img
							...
							alt="<bean:message key="istlogo" arg0="<%=org.fenixedu.academic.domain.organizationalStructure.Unit.getInstitutionName().getContent()%>" bundle="IMAGE_RESOURCES" />"
						...
						<table border="0" width="100%" height="100%">
							<tr valign="top" align="left">
								...
								&nbsp;<b>Centro de Informática do <%= org.fenixedu.academic.domain.organizationalStructure.Unit.getInstitutionName().getContent() %></b><br />
								<hr size="1">
								</td>
							</tr>
						</table>
