...
<h3 class="separator2 mtop2"><bean:message key="title.scientificCouncil.thesis.review.section.orientation.external.add"/></h3>
...
<div style="margin-left: 35px; width: 90%;">
	<fr:edit name="evaluationMemberBean"
		...
		<fr:schema type="org.fenixedu.academic.domain.thesis.Thesis" bundle="SCIENTIFIC_COUNCIL_RESOURCES">
            ...
            <fr:slot name="personName" key="label.orientation.member.personName" validator="org.fenixedu.academic.ui.renderers.validators.RequiredAutoCompleteSelectionValidator">
            ...
            <fr:slot name="personEmail" key="label.orientation.member.personEmail" validator="org.fenixedu.academic.ui.renderers.validators.RequiredAutoCompleteSelectionValidator">
                <fr:property name="size" value="70" />
                <fr:property name="labelField" value="presentationName" />
                <fr:property name="args" value="slot=name,size=20" />
                <fr:property name="minChars" value="3" />
