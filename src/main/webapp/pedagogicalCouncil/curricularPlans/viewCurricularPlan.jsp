...
<fp:select actionClass="org.fenixedu.academic.ui.struts.action.pedagogicalCouncil.PedagogicalCouncilApp$PedagogicalCurricularPlansManagement" />
...
<h:outputText value="<div class='invisible'>" escape="false"/>
	...
	<h:outputLink value="#{facesContext.externalContext.requestContextPath}/pedagogicalCouncil/curricularPlans/viewCurricularPlanStructure.faces" rendered="#{!empty CurricularCourseManagement.degreeCurricularPlan.root.childContexts}">
	...
	<h:panelGroup rendered="#{!empty CurricularCourseManagement.degreeCurricularPlan.degreeStructure.childs}">
		...
		<h:outputLink value="#{facesContext.externalContext.requestContextPath}/pedagogicalCouncil/curricularPlans/viewCurricularPlan.faces" rendered="#{CurricularCourseManagement.organizeBy == 'years'}">
		...
		<h:outputLink value="#{facesContext.externalContext.requestContextPath}/pedagogicalCouncil/curricularPlans/viewCurricularPlan.faces" rendered="#{CurricularCourseManagement.organizeBy == 'groups'}">
	...
	<h:panelGroup rendered="#{!empty CurricularCourseManagement.degreeCurricularPlan.root.childContexts}">	
		...
		<h:outputLink value="#{facesContext.externalContext.requestContextPath}/pedagogicalCouncil/curricularPlans/viewCurricularPlan.faces" rendered="#{CurricularCourseManagement.showRules == 'false'}">
		...
		<h:outputText value=" , " escape="false"/>
		<h:outputLink value="#{facesContext.externalContext.requestContextPath}/pedagogicalCouncil/curricularPlans/viewCurricularPlan.faces" rendered="#{CurricularCourseManagement.showRules == 'true'}">
	...
	<h:panelGroup rendered="#{CurricularCourseManagement.showRules == 'true' && CurricularCourseManagement.organizeBy == 'groups'}">
		...
		<h:outputLink value="#{facesContext.externalContext.requestContextPath}/pedagogicalCouncil/curricularPlans/viewCurricularPlan.faces" rendered="#{CurricularCourseManagement.hideCourses == 'true'}">
			<h:outputText value="#{bolonhaBundle['show']}" />
			<f:param name="degreeCurricularPlanID" value="#{CurricularCourseManagement.degreeCurricularPlanID}"/>
			<f:param name="organizeBy" value="#{CurricularCourseManagement.organizeBy}"/>
			<f:param name="showRules" value="#{CurricularCourseManagement.showRules}"/>
		...
		<h:outputText value=" , " escape="false"/>
		<h:outputLink value="#{facesContext.externalContext.requestContextPath}/pedagogicalCouncil/curricularPlans/viewCurricularPlan.faces" rendered="#{CurricularCourseManagement.hideCourses == 'false'}">
			<h:outputText value="#{bolonhaBundle['hide']}" />
			<f:param name="degreeCurricularPlanID" value="#{CurricularCourseManagement.degreeCurricularPlanID}"/>
			<f:param name="organizeBy" value="#{CurricularCourseManagement.organizeBy}"/>
			<f:param name="showRules" value="#{CurricularCourseManagement.showRules}"/>
