...
public class ContextUtils {
    ...
    public static final void setExecutionPeriodContext(
        ...
        if (executionPeriodOIDString == null) {
            executionPeriodOIDString = request
                    .getParameter(SessionConstants.EXECUTION_PERIOD_OID);
        }
        ...
        if (executionPeriodOID != null) {
            ...
            try {
                ...
                infoExecutionPeriod = (InfoExecutionPeriod) ServiceUtils
            ...
            try {
                infoExecutionPeriod = (InfoExecutionPeriod) ServiceUtils
                        .executeService(null, "ReadCurrentExecutionPeriod",
                                new Object[0]);
            } catch (FenixServiceException e) {
                e.printStackTrace();
            }
        ...
        if (infoExecutionPeriod != null) {
            ...
            if (infoExecutionPeriod.getInfoExecutionYear() != null) {
                request.setAttribute("schoolYear", infoExecutionPeriod
    ...
    public static void setExecutionDegreeContext(HttpServletRequest request) {
        ...
        if ((executionDegreeOIDString == null)
            ...
            executionDegreeOIDString = request
                    .getParameter(SessionConstants.EXECUTION_DEGREE_OID);
    ...
    public static void setCurricularYearContext(HttpServletRequest request) {
        ...
        if (curricularYearOIDString == null) {
            curricularYearOIDString = request
                    .getParameter(SessionConstants.CURRICULAR_YEAR_OID);
        }
        ...
        if (curricularYearOID != null) {
            ...
            try {
                ...
                infoCurricularYear = (InfoCurricularYear) ServiceUtils
                        .executeService(null, "ReadCurricularYearByOID", args);
            } catch (FenixServiceException e) {
                e.printStackTrace();
            }
            ...
            if (infoCurricularYear != null) {
                // Place it in request
                request.setAttribute(SessionConstants.CURRICULAR_YEAR,
                        infoCurricularYear);
    ...
    public static void setCurricularYearsContext(HttpServletRequest request) {
        ...
        String curricularYears_1 = (String) request
                .getAttribute(SessionConstants.CURRICULAR_YEARS_1);
        String curricularYears_2 = (String) request
                .getAttribute(SessionConstants.CURRICULAR_YEARS_2);
        String curricularYears_3 = (String) request
                .getAttribute(SessionConstants.CURRICULAR_YEARS_3);
        String curricularYears_4 = (String) request
                .getAttribute(SessionConstants.CURRICULAR_YEARS_4);
        String curricularYears_5 = (String) request
                .getAttribute(SessionConstants.CURRICULAR_YEARS_5);
        if (curricularYears_1 == null) {
            curricularYears_1 = request
                    .getParameter(SessionConstants.CURRICULAR_YEARS_1);
        }
        if (curricularYears_2 == null) {
            curricularYears_2 = request
                    .getParameter(SessionConstants.CURRICULAR_YEARS_2);
        }
        if (curricularYears_3 == null) {
            curricularYears_3 = request
                    .getParameter(SessionConstants.CURRICULAR_YEARS_3);
        }
        if (curricularYears_4 == null) {
            curricularYears_4 = request
                    .getParameter(SessionConstants.CURRICULAR_YEARS_4);
        }
        if (curricularYears_5 == null) {
            curricularYears_5 = request
                    .getParameter(SessionConstants.CURRICULAR_YEARS_5);
        }
        ...
        request.setAttribute(SessionConstants.CURRICULAR_YEARS_LIST,
                curricularYears);
    }
    ...
    public static void setExecutionCourseContext(HttpServletRequest request) {
        ...
        if (executionCourseOIDString == null) {
            executionCourseOIDString = request
                    .getParameter(SessionConstants.EXECUTION_COURSE_OID);
        }
        ...
        if (executionCourseOID != null) {
            ...
            try {
                ...
                infoExecutionCourse = (InfoExecutionCourse) ServiceUtils
                        .executeService(null, "ReadExecutionCourseByOID", args);
            } catch (FenixServiceException e) {
                e.printStackTrace();
            }
    ...
    public static void setShiftContext(HttpServletRequest request) {
        String shiftOIDString = (String) request
                .getAttribute(SessionConstants.SHIFT_OID);
        ...
        if (shiftOID != null) {
            ...
            try {
                ...
                infoShift = (InfoShift) ServiceUtils.executeService(null,
                        "ReadShiftByOID", args);
            } catch (FenixServiceException e) {
                e.printStackTrace();
            }
            ...
            if (infoShift != null) {
                ...
                chainComparator.addComparator(new Comparator() {
                    ...
                    public int compare(Object o1, Object o2) {
                        ...
                        Integer time1 = new Integer(ctime1
                                .get(Calendar.HOUR_OF_DAY)
                                * 60 + ctime1.get(Calendar.MINUTE));

                        Integer time2 = new Integer(ctime2
                                .get(Calendar.HOUR_OF_DAY)
                                * 60 + ctime2.get(Calendar.MINUTE));
    ...
    public static void setClassContext(HttpServletRequest request) {
        String classOIDString = (String) request
                .getAttribute(SessionConstants.CLASS_VIEW_OID);
        if (classOIDString == null) {
            classOIDString = request
                    .getParameter(SessionConstants.CLASS_VIEW_OID);
        }
        ...
        if (classOID != null) {
            ...
            try {
                ...
                infoClass = (InfoClass) ServiceUtils.executeService(null,
                        "ReadClassByOID", args);
            } catch (FenixServiceException e) {
                e.printStackTrace();
            }
    ...
    public static void setLessonContext(HttpServletRequest request) {
        String lessonOIDString = (String) request
                .getAttribute(SessionConstants.LESSON_OID);
        ...
        if (lessonOID != null) {
            ...
            try {
                ...
                infoLesson = (InfoLesson) ServiceUtils.executeService(null,
    ...
    public static void setSelectedRoomsContext(HttpServletRequest request)
        ...
        Object argsSelectRooms[] = { new InfoRoom(readRequestValue(request,
                "selectRoomCriteria_Name"), readRequestValue(request,
                "selectRoomCriteria_Building"), readIntegerRequestValue(
                request, "selectRoomCriteria_Floor"), readTypeRoomRequestValue(
                request, "selectRoomCriteria_Type"), readIntegerRequestValue(
                request, "selectRoomCriteria_CapacityNormal"),
                readIntegerRequestValue(request,
                        "selectRoomCriteria_CapacityExame")) };

        List selectedRooms = null;
        try {
            selectedRooms = (List) ServiceManagerServiceFactory.executeService(
    ...
    private static void setRoomSearchCriteriaContext(HttpServletRequest request) {
        ...
        request.setAttribute("selectRoomCriteria_Name", readRequestValue(
                request, "selectRoomCriteria_Name"));
        request.setAttribute("selectRoomCriteria_Building", readRequestValue(
                request, "selectRoomCriteria_Building"));
        request.setAttribute("selectRoomCriteria_Floor", readRequestValue(
                request, "selectRoomCriteria_Floor"));
        request.setAttribute("selectRoomCriteria_Type", readRequestValue(
                request, "selectRoomCriteria_Type"));
    ...
    public static void setSelectedRoomIndexContext(HttpServletRequest request) {
        ...
        if (selectedRoomIndexString == null) {
            selectedRoomIndexString = request
                    .getParameter(SessionConstants.SELECTED_ROOM_INDEX);
        }
        ...
        if (selectedRoomIndexString != null) {
            ...
            // Place it in request
            request.setAttribute(SessionConstants.SELECTED_ROOM_INDEX,
                    selectedRoomIndex);
        } else {
    ...
    public static void prepareChangeExecutionDegreeAndCurricularYear(
            HttpServletRequest request) {
        ...
        request.setAttribute(SessionConstants.LABELLIST_CURRICULAR_YEARS,
                labelListOfCurricularYears);

        /* Obtain a list of degrees for the specified execution year */
        Object argsLerLicenciaturas[] = { infoExecutionPeriod
                .getInfoExecutionYear() };
        List executionDegreeList = null;
        try {
            executionDegreeList = (List) ServiceUtils
        ...
        while (iterator.hasNext()) {
            ...
            labelListOfExecutionDegrees.add(new LabelValueBean(name,
                    infoExecutionDegree.getIdInternal().toString()));
        }
        ...
        try {
            ...
            for (int i = 0; i < executionPeriods.size(); i++) {
                InfoExecutionPeriod infoExecutionPeriod2 = (InfoExecutionPeriod) executionPeriods
                        .get(i);
                executionPeriodsLabelValueList.add(new LabelValueBean(
                        infoExecutionPeriod2.getName()
                                + " - "
                                + infoExecutionPeriod2.getInfoExecutionYear()
                                        .getYear(), ""
    ...
    // -------------------------------------------------------------------------------
    private static String readRequestValue(HttpServletRequest request,
            String name) {
        String obj = null;
    ...
    private static Integer readIntegerRequestValue(HttpServletRequest request,
            String name) {
    ...
    public static List getLabelListOfExecutionDegrees(List executionDegreeList) {
        List labelListOfExecutionDegrees = (List) CollectionUtils.collect(
                executionDegreeList,
    ...
    private static class EXECUTION_DEGREE_2_EXECUTION_DEGREE_LABEL implements
            Transformer {
        ...
        public Object transform(Object arg0) {
            ...
            return new LabelValueBean(name, infoExecutionDegree.getIdInternal()
                    .toString());
        }
    }
    ...
    public static ArrayList createExecutionDegreeList(HttpServletRequest request)
        ...
        while (iterator.hasNext()) {
            ...
            licenciaturas.add(new LabelValueBean(name, infoExecutionDegree
