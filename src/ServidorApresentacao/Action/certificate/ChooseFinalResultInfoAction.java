		...
		if (session != null) {
			...
			if (infoStudentCurricularPlan == null){
				...
				try {	
					...
					infoFinalResult =  (InfoFinalResult) ServiceManagerServiceFactory.executeService(userView, "FinalResult", args);
				...
				if (infoFinalResult == null){
					...
					if (enrolmentList.size() == 0){
						...
						try {
							...
							endOfScholarshipDate = (Date) ServiceManagerServiceFactory.executeService(userView, "GetEndOfScholarshipDate", argsTemp);
						...
						while(iterator1.hasNext()) {	 
							...
							InfoCurricularCourseScope infoCurricularCourseScope = infoEnrolment2.getInfoCurricularCourseScope();
