...
public class AdicionarAulasFormAction extends FenixAction {
  ...
  public static String THEO_PRAT_HOURS_LIMIT_EXCEEDED = "errors.shift.theoPrat.hours.limit.exceeded";
  ...
  public static String THEO_PRAT_HOURS_LIMIT_REACHED = "errors.shift.theoPrat.hours.limit.reached";
...
//      return mapping.findForward("Sucesso");
  	...
  	private ActionErrors getActionErrors(InfoShiftServiceResult result, InfoShift infoShift) {
