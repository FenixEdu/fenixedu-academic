...
extends FenixContextDispatchAction
{
    ...
    private InfoExamsMap getExamsMap(HttpServletRequest request) throws FenixActionException
    {
        ...
        InfoCurricularYear curricularYearObj =
            (InfoCurricularYear) request.getAttribute(SessionConstants.CURRICULAR_YEAR);
    ...
    public ActionForward createByCourse(
        ActionMapping mapping,
        ActionForm form,
        HttpServletRequest request,
        HttpServletResponse response)
    ...
    public ActionForward createByDay(
        ActionMapping mapping,
        ActionForm form,
        HttpServletRequest request,
        HttpServletResponse response)
        ...
        throws Exception
    {
        ...
        if (!result.booleanValue())
        	throw new Exception("ERROR ON  DELETE EXAM");	
