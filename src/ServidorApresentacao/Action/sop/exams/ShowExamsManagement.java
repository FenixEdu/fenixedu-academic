...
//	extends FenixExecutionDegreeAndCurricularYearContextDispatchAction {
    ...
    public ActionForward view(ActionMapping mapping, ActionForm form,
        ...
        request.setAttribute(SessionConstants.LABELLIST_CURRICULAR_YEARS,
                ContextUtils.createCurricularYearList());
        request.setAttribute(SessionConstants.DEGREES, ContextUtils
                .createExecutionDegreeList(request));
    ...
    private InfoExamsMap getExamsMap(HttpServletRequest request)
        ...
        IUserView userView = (IUserView) request.getSession().getAttribute(
        ...
        ArrayList curricularYearsList = new ArrayList();
        curricularYearsList.add(curricularYear);

        Object[] args = { infoExecutionDegree, curricularYearsList,
                infoExecutionPeriod};
    ...
    public ActionForward createByCourse(ActionMapping mapping, ActionForm form,
        ...
        request.setAttribute(SessionConstants.EXECUTION_COURSE_KEY,
                infoExecutionCourse);
    ...
    public ActionForward createByDay(ActionMapping mapping, ActionForm form,
            HttpServletRequest request, HttpServletResponse response)
            throws Exception {
        ...
        Integer month = new Integer(request
                .getParameter(SessionConstants.MONTH));
    ...
    public ActionForward edit(ActionMapping mapping, ActionForm form,
        ...
        Integer examID = new Integer(request
                .getParameter(SessionConstants.EXAM_OID));
        Object[] args = { examID};
        InfoExam infoExam = (InfoExam) ServiceUtils.executeService(userView,
                "ReadExamByOID", args);
        request.setAttribute(SessionConstants.EXAM, infoExam);
        request.setAttribute(SessionConstants.EXAM_OID, infoExam
                .getIdInternal());
    ...
    public ActionForward delete(ActionMapping mapping, ActionForm form,
        ...
        try {
            Boolean result = (Boolean) ServiceUtils.executeService(userView,
                    "DeleteExamNew", args);
            ...
            if (exception.getMessage() != null
                    && exception.getMessage().length() > 0) {
                actionErrors.add("error.deleteExam",
                        new ActionError(exception.getMessage()));
            }
        }
