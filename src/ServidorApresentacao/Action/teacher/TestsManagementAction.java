...
public class TestsManagementAction extends FenixDispatchAction
{
			...
			HttpServletResponse response) throws FenixActionException
	{
		...
		Object[] args =
		{executionCourseId, title, information};
			...
			HttpServletRequest request, HttpServletResponse response) throws FenixActionException
	{
		...
		{
			Object[] args =
			{executionCourseId, testCode, order, asc};
			...
			HttpServletRequest request, HttpServletResponse response) throws FenixActionException
	{
		...
		{
			Object[] args =
			{executionCourseId, metadataCode, exerciseCode, path};
		...
		{
			Object[] args =
			{executionCourseId, testCode, path};
			...
			HttpServletRequest request, HttpServletResponse response) throws FenixActionException
	{
		...
		String path = getServlet().getServletContext().getRealPath("/");
		Object[] arguments =
		{executionCourseId, testCode, metadataCodes, questionOrder, questionValue, path};
		try
		{
			...
			HttpServletRequest request, HttpServletResponse response) throws FenixActionException
	{
		...
		{
			Object[] args =
			{executionCourseId, testCode, questionCode, path};
			...
			HttpServletRequest request, HttpServletResponse response) throws FenixActionException
	{
		...
		Integer questionCode = getCodeFromRequest(request, "questionCode");
		Object[] args =
		{executionCourseCode, testCode, questionCode};
		try
		{
			...
			HttpServletResponse response) throws FenixActionException
	{
		...
		{
			Object[] args =
			{studentCode, testCode, exerciseCode, imgCode, path};
			try
			{
			...
			HttpServletResponse response) throws FenixActionException
	{
		...
		String path = getServlet().getServletContext().getRealPath("/");
		Object[] args =
		{executionCourseCode, testCode, path};
		SiteView siteView = null;
		try
		{
			...
			HttpServletRequest request, HttpServletResponse response) throws FenixActionException
	{
		...
		String information = request.getParameter("information");
		Object[] args =
		{executionCourseCode, testCode, title, information};
		try
		{
			...
			HttpServletRequest request, HttpServletResponse response) throws FenixActionException
	{
		...
		Object[] args =
		{objectCode, testCode, testInformation, beginDate, beginHour, endDate, endHour, testTypeArg,
				correctionAvailabilityArg, studentFeedbackArg, selected, new Boolean(insertByShifts),
			...
			HttpServletRequest request, HttpServletResponse response) throws FenixActionException
	{
		...
		if ((((DynaActionForm) form).get("beginDateFormatted")).equals(""))
			((DynaActionForm) form).set("beginDateFormatted", ((InfoSiteDistributedTest) siteView
					.getComponent()).getInfoDistributedTest().getBeginDateFormatted());
		...
		if ((((DynaActionForm) form).get("endDateFormatted")).equals(""))
			((DynaActionForm) form).set("endDateFormatted", ((InfoSiteDistributedTest) siteView
					.getComponent()).getInfoDistributedTest().getEndDateFormatted());
		...
		if ((((DynaActionForm) form).get("studentFeedback")).equals(""))
			((DynaActionForm) form).set("studentFeedback", ((InfoSiteDistributedTest) siteView
					.getComponent()).getInfoDistributedTest().getStudentFeedback().toString());
			...
			HttpServletRequest request, HttpServletResponse response) throws FenixActionException
	{
		...
		Object[] args =
		{objectCode, distributedTestCode, testInformation, beginDate, beginHour, endDate, endHour,
				testTypeArg, correctionAvailabilityArg, studentFeedbackArg, selected,
			...
			HttpServletRequest request, HttpServletResponse response) throws FenixActionException
	{
		...
		try
		{
			infoStudentTestQuestionList = (List) ServiceUtils.executeService(userView,
					"ReadStudentDistributedTest", new Object[]
					{objectCode, distributedTestCode, studentCode, path});
		}
		catch (FenixServiceException e)
		{
			throw new FenixActionException(e);
			...
			HttpServletRequest request, HttpServletResponse response) throws FenixActionException
	{
		...
		try
		{
			infoStudentTestLogList = (List) ServiceUtils.executeService(userView, "ReadStudentTestLog",
					new Object[]
					{objectCode, distributedTestCode, studentCode});
		}
		catch (FenixServiceException e)
		{
			throw new FenixActionException(e);
			...
			HttpServletRequest request, HttpServletResponse response) throws FenixActionException
	{
		...
		try
		{
			...
			{
				Object[] args =
				{objectCode, request.getParameterValues("distributedTestCodes")};
				result = (String) ServiceUtils.executeService(userView,
						"ReadDistributedTestMarksToString", args);
			}
		}
			...
			HttpServletRequest request, HttpServletResponse response) throws FenixActionException
	{
		...
		{
			Object[] args =
			{executionCourseId, order, asc, path};
			...
			HttpServletRequest request, HttpServletResponse response) throws FenixActionException
	{
		...
		{
			Object[] args =
			{executionCourseId, metadataId, path};
			...
			HttpServletRequest request, HttpServletResponse response) throws FenixActionException
	{
		...
		{
			Object[] args =
			{executionCourseId, exerciseId, variationCode, path};
			...
			HttpServletRequest request, HttpServletResponse response) throws FenixActionException
	{
		...
		{
			Object[] args =
			{executionCourseId, exerciseId, author, description, difficulty, string2Hour(learningTime),
					level, mainSubject, secondarySubject};
