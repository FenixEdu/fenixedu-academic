 ...
 *
 */
package ServidorApresentacao.Action.treasury;
...
//			
//			if ( infoGuide != null)
//				createContributorForm.set("contributorNumber", String.valueOf(infoGuide.getInfoContributor().getContributorNumber()));
//			else
...
//			
//			if ( infoGuide != null) {
//				session.setAttribute("infoContributor", infoContributor);
//				return mapping.findForward("CreateGuideReady");
//			}
