...
public class ReadPersonInfoOfStudentsAction
...
//		Clear the Session
		...
		if (session != null)
		{
			...
			try
			{
				infoStudent = (InfoStudent) gestor.executar(userView,"ReadStudentByNumberAndType",args );
			}
			...
			request.setAttribute("infoStudent",(InfoStudent) infoStudent);
			//request.setAttribute("graduationType",graduationType);
			request.setAttribute("studentNumber",studentNumber);
			request.setAttribute("infoPerson",(InfoPerson) infoStudent.getInfoPerson());
