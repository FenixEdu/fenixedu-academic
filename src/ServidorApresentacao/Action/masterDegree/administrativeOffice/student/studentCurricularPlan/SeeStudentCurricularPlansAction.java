...
public class SeeStudentCurricularPlansAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws FenixActionException {
		...
		ArrayList studentCurricularPlansList = null;
		try {
			studentCurricularPlansList = (ArrayList) ServiceUtils.executeService(userView, "ReadPosGradStudentCurricularPlans", args);
