...
public class ChangeApplicationInfoDispatchAction extends DispatchAction {
	...
	public ActionForward change(
		...
		if (session != null) {
			...
			newMasterDegreeCandidate.setAverage(
				Double.valueOf(
					(String) changeApplicationInfoForm.get("average")));
			newMasterDegreeCandidate.setMajorDegree(
				(String) changeApplicationInfoForm.get("majorDegree"));
			newMasterDegreeCandidate.setMajorDegreeSchool(
				(String) changeApplicationInfoForm.get("majorDegreeSchool"));
			newMasterDegreeCandidate.setMajorDegreeYear(
				(Integer) changeApplicationInfoForm.get("majorDegreeYear"));
			newMasterDegreeCandidate.setSpecializationArea(
				(String) changeApplicationInfoForm.get("specializationArea"));
	...
	public ActionForward prepare(
		...
		if (session != null) {
			...
			request.setAttribute(
				SessionConstants.NATIONALITY_LIST_KEY,
				nationalityList);
			request.setAttribute(
			...
			request.setAttribute(
				SessionConstants.SEX_LIST_KEY,
				new Sexo().toArrayList());
			request.setAttribute(
				SessionConstants.MONTH_DAYS_KEY,
				Data.getMonthDays());
			request.setAttribute(
				SessionConstants.MONTH_LIST_KEY,
				Data.getMonths());
			request.setAttribute(SessionConstants.YEARS_KEY, Data.getYears());
			request.setAttribute(
				SessionConstants.EXPIRATION_YEARS_KEY,
				Data.getExpirationYears());
			request.setAttribute(
