 ...
 * @author jpvl
 */
public class OutOfCurricularEnrolmentPeriodActionException
	extends OutOfPeriodActionException {
	 ...
	 * @param endDate
	 */
	public OutOfCurricularEnrolmentPeriodActionException(String messageKey, Date startDate, Date endDate, ActionForward actionForward) {
