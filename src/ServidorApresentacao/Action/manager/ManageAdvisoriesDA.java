...
public class ManageAdvisoriesDA extends FenixDispatchAction {
	...
	public ActionForward createAdvisory(
		ActionMapping mapping,
		ActionForm form,
		HttpServletRequest request,
		HttpServletResponse response)
		...
		infoAdvisory.setExpires(
			DateFormat.getDateInstance(DateFormat.DATE_FIELD).parse(
				(String) advisoryForm.get("experationDate")));

		Object[] args =
			{
				infoAdvisory,
				new AdvisoryRecipients(
					(Integer) advisoryForm.get("recipients"))};
