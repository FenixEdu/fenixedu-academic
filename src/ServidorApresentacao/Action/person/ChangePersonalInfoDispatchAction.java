...
public class ChangePersonalInfoDispatchAction extends DispatchAction {
	public ActionForward change(ActionMapping mapping, ActionForm form,
		...
		String dayString = (String) changePersonalInformationForm
				.get("birthDay");
		String monthString = (String) changePersonalInformationForm
				.get("birthMonth");
		String yearString = (String) changePersonalInformationForm
				.get("birthYear");
		Integer day = null;
		Integer month = null;
		Integer year = null;
		if ((dayString == null) || (monthString == null)
				|| (yearString == null) || (dayString.length() == 0)
				|| (monthString.length() == 0) || (yearString.length() == 0)) {
			infoPerson.setNascimento(null);
		} else {
			day = new Integer((String) changePersonalInformationForm
					.get("birthDay"));
			month = new Integer((String) changePersonalInformationForm
					.get("birthMonth"));
			year = new Integer((String) changePersonalInformationForm
					.get("birthYear"));
			birthDate.set(year.intValue(), month.intValue(), day.intValue());
			infoPerson.setNascimento(birthDate.getTime());
		}
		dayString = (String) changePersonalInformationForm
				.get("idIssueDateDay");
		monthString = (String) changePersonalInformationForm
				.get("idIssueDateMonth");
		yearString = (String) changePersonalInformationForm
				.get("idIssueDateYear");
		if ((dayString == null) || (monthString == null)
				|| (yearString == null) || (dayString.length() == 0)
				|| (monthString.length() == 0) || (yearString.length() == 0)) {
			...
			year = new Integer((String) changePersonalInformationForm
					.get("idIssueDateYear"));
			idDocumentIssueDate.set(year.intValue(), month.intValue(), day
					.intValue());
			infoPerson.setDataEmissaoDocumentoIdentificacao(idDocumentIssueDate
					.getTime());
		}
		dayString = (String) changePersonalInformationForm
		...
		if ((dayString == null) || (monthString == null)
			...
			year = new Integer((String) changePersonalInformationForm
					.get("idExpirationDateYear"));
			idDocumentExpirationDate.set(year.intValue(), month.intValue(), day
					.intValue());
			infoPerson
					.setDataValidadeDocumentoIdentificacao(idDocumentExpirationDate
							.getTime());
		}
		InfoCountry nationality = new InfoCountry();
		nationality.setNationality((String) changePersonalInformationForm
				.get("nationality"));
		...
		infoPerson
				.setNumeroDocumentoIdentificacao((String) changePersonalInformationForm
						.get("identificationDocumentNumber"));
		infoPerson
				.setLocalEmissaoDocumentoIdentificacao((String) changePersonalInformationForm
		...
		infoPerson.setNomePai((String) changePersonalInformationForm
				.get("fatherName"));
		infoPerson.setNomeMae((String) changePersonalInformationForm
				.get("motherName"));
		infoPerson
				.setFreguesiaNaturalidade((String) changePersonalInformationForm
						.get("birthPlaceParish"));
		infoPerson
				.setConcelhoNaturalidade((String) changePersonalInformationForm
						.get("birthPlaceMunicipality"));
		infoPerson
				.setDistritoNaturalidade((String) changePersonalInformationForm
						.get("birthPlaceDistrict"));
		infoPerson.setMorada((String) changePersonalInformationForm
				.get("address"));
		infoPerson.setLocalidade((String) changePersonalInformationForm
				.get("place"));
		infoPerson.setCodigoPostal((String) changePersonalInformationForm
				.get("postCode"));
		infoPerson.setFreguesiaMorada((String) changePersonalInformationForm
				.get("addressParish"));
		infoPerson.setConcelhoMorada((String) changePersonalInformationForm
				.get("addressMunicipality"));
		infoPerson.setDistritoMorada((String) changePersonalInformationForm
				.get("addressDistrict"));
		infoPerson.setTelefone((String) changePersonalInformationForm
				.get("telephone"));
		...
		if (changePersonalInformationForm.get("availableWebSite") != null
				&& changePersonalInformationForm.get("availableWebSite").equals(
						"true")) {
			infoPerson.setAvailableWebSite(Boolean.TRUE);
		} else {
			infoPerson.setAvailableWebSite(Boolean.FALSE);			
		}
		infoPerson.setNumContribuinte((String) changePersonalInformationForm
				.get("contributorNumber"));
		infoPerson.setProfissao((String) changePersonalInformationForm
				.get("occupation"));
		infoPerson.setUsername((String) changePersonalInformationForm
				.get("username"));
		infoPerson
				.setLocalidadeCodigoPostal((String) changePersonalInformationForm
						.get("areaOfAreaCode"));
	...
	public ActionForward prepare(ActionMapping mapping, ActionForm form,
		...
		changePersonalInfoForm.set("identificationDocumentNumber", infoPerson
				.getNumeroDocumentoIdentificacao());
		changePersonalInfoForm.set("identificationDocumentType", infoPerson
				.getTipoDocumentoIdentificacao().toString());
		changePersonalInfoForm.set("identificationDocumentIssuePlace",
		...
		if (infoPerson.getNascimento() == null) {
			changePersonalInfoForm.set("birthDay", Data.OPTION_DEFAULT);
			changePersonalInfoForm.set("birthMonth", Data.OPTION_DEFAULT);
			changePersonalInfoForm.set("birthYear", Data.OPTION_DEFAULT);
		} else {
			birthDate.setTime(infoPerson.getNascimento());
			changePersonalInfoForm.set("birthDay", new Integer(birthDate
					.get(Calendar.DAY_OF_MONTH)).toString());
			changePersonalInfoForm.set("birthMonth", new Integer(birthDate
					.get(Calendar.MONTH)).toString());
			changePersonalInfoForm.set("birthYear", new Integer(birthDate
		...
		if (infoPerson.getDataEmissaoDocumentoIdentificacao() == null) {
			changePersonalInfoForm.set("idIssueDateDay", Data.OPTION_DEFAULT);
			changePersonalInfoForm.set("idIssueDateMonth", Data.OPTION_DEFAULT);
			changePersonalInfoForm.set("idIssueDateYear", Data.OPTION_DEFAULT);
		} else {
			identificationDocumentIssueDate.setTime(infoPerson
					.getDataEmissaoDocumentoIdentificacao());
			changePersonalInfoForm.set("idIssueDateDay", new Integer(
					identificationDocumentIssueDate.get(Calendar.DAY_OF_MONTH))
					.toString());
			changePersonalInfoForm.set("idIssueDateMonth", new Integer(
					identificationDocumentIssueDate.get(Calendar.MONTH))
					.toString());
			changePersonalInfoForm.set("idIssueDateYear", new Integer(
					identificationDocumentIssueDate.get(Calendar.YEAR))
					.toString());
		}
		...
		if (infoPerson.getDataValidadeDocumentoIdentificacao() == null) {
			changePersonalInfoForm.set("idExpirationDateDay",
					Data.OPTION_DEFAULT);
			changePersonalInfoForm.set("idExpirationDateMonth",
					Data.OPTION_DEFAULT);
			changePersonalInfoForm.set("idExpirationDateYear",
					Data.OPTION_DEFAULT);
		} else {
			identificationDocumentExpirationDate.setTime(infoPerson
					.getDataValidadeDocumentoIdentificacao());
			changePersonalInfoForm.set("idExpirationDateDay", new Integer(
					identificationDocumentExpirationDate
							.get(Calendar.DAY_OF_MONTH)).toString());
			changePersonalInfoForm.set("idExpirationDateMonth", new Integer(
					identificationDocumentExpirationDate.get(Calendar.MONTH))
					.toString());
			changePersonalInfoForm.set("idExpirationDateYear", new Integer(
		...
		if (infoPerson.getInfoPais() == null) {
			...
			changePersonalInfoForm.set("nationality", infoPerson.getInfoPais()
					.getNationality());
		}
		changePersonalInfoForm.set("birthPlaceParish", infoPerson
				.getFreguesiaNaturalidade());
		changePersonalInfoForm.set("birthPlaceMunicipality", infoPerson
				.getConcelhoNaturalidade());
		changePersonalInfoForm.set("birthPlaceDistrict", infoPerson
		...
		changePersonalInfoForm.set("addressParish", infoPerson
				.getFreguesiaMorada());
		changePersonalInfoForm.set("addressMunicipality", infoPerson
				.getConcelhoMorada());
		changePersonalInfoForm.set("addressDistrict", infoPerson
				.getDistritoMorada());
		...
		if (infoPerson.getEstadoCivil() != null)
			changePersonalInfoForm.set("maritalStatus", infoPerson
					.getEstadoCivil().toString());
		...
		while (iterador.hasNext()) {
			...
			nationalityList
					.add(new LabelValueBean(countryTemp.getNationality(),
							countryTemp.getNationality()));
		}
		session.setAttribute(SessionConstants.NATIONALITY_LIST_KEY,
				nationalityList);
		session.setAttribute(SessionConstants.MARITAL_STATUS_LIST_KEY,
		...
		session.setAttribute(SessionConstants.SEX_LIST_KEY, new Sexo()
				.toArrayList());
		session.setAttribute(SessionConstants.MONTH_DAYS_KEY, Data
				.getMonthDays());
		...
		session.setAttribute(SessionConstants.EXPIRATION_YEARS_KEY, Data
				.getExpirationYears());
