		...
		while(iterador.hasNext()){
			...
			if (EMail
				.send(
					...
					"Nova Password para acesso à Assiduidade do Funcionário número " + passwordForm.getUsername(), 
					"A nova password do funcionário número " + passwordForm.getUsername() + " é:      " + passwordNova)) {
						enviado = true;
					}			
		}
