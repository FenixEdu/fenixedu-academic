...
public class TimeTable {
	...
	public TimeTable(
		...
		timeTableGrid =
			new TimeTableSlot[numberOfDays
				.intValue()][numberOfHours
				.intValue()];
	}
	/**
	...
	public void addLesson(InfoShowOccupation infoShowOccupation) {
		...
		for (int hourIndex = startIndex;
			...
			TimeTableSlot timeTableSlot =
				getTimeTableSlot(dayColumn, hourIndex);
...
/*	private InfoLessonWrapper getInfoLessonWrapper(InfoLesson infoLesson) {
	...
	private int getDayIndex(DiaSemana day) {
		...
		if (day != null) {
			switch (day.getDiaSemana().intValue()) {
				...
				default :
					System.out.println(
						"RenderTimeTableTag.converteDia(): dia de semana inválido.");
					dayIndex = -1;
					break;
			}
		}
	...
	public static int getHourIndex(Calendar time, int minimumHourInMinutes, int slotSize) {
		...
		return (hourInMinutes - minimumHourInMinutes)
			/ slotSize;
	}
	/**
	 * Method getMinutes.
