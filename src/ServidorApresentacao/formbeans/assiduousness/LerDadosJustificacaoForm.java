...
public class LerDadosJustificacaoForm extends ActionForm {
	...
	public void setForm(
		ArrayList listaSiglasJustificacao,
		String sigla,
		...
		IStrategyJustificacoes justificacaoStrategy =
			SuporteStrategyJustificacoes.getInstance().callStrategy((String) (paramJustificacao.getTipo()));
	...
	public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
		...
		IStrategyJustificacoes justificacaoStrategy =
			SuporteStrategyJustificacoes.getInstance().callStrategy(
				(String) ((ParamJustificacao) listaJustificacoes.get(indiceLista)).getTipo());
