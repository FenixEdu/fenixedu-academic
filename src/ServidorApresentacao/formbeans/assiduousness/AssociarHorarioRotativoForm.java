...
public class AssociarHorarioRotativoForm extends ActionForm {
  ...
  private ArrayList _listaHorarios = new ArrayList();
  ...
  public ArrayList getListaHorarios() {
  ...
  public void setListaListaHorarios(ArrayList listaHorarios) {
  ...
  public void setForm(String nome, String numMecanografico, ArrayList rotacaoHorario, 
  HashMap listaRegimesRotacao, java.util.Date dataInicio, java.util.Date dataFim, boolean isExcepcaoHorario){
    setNome(nome);
  ...
  public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
    ...
    if((request.getParameter("diaInicio") != null) || (request.getParameter("mesInicio") != null) || (request.getParameter("anoInicio") != null)){
      if(((request.getParameter("diaInicio")).length() < 1) || ((request.getParameter("mesInicio")).length() < 1) || (request.getParameter("anoInicio").length() < 1)){
        ...
        if((request.getParameter("diaFim").length() > 0) && (request.getParameter("mesFim").length() > 0) && (request.getParameter("anoFim").length() > 0)){
          try {
