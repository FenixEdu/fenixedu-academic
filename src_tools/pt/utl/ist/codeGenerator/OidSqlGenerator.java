...
public class OidSqlGenerator {
    ...
    private static class UpdateRegistry extends Writer {
        ...
        private void addUpdateKeyInstruction(final String tablename, final String otherTablename, final String key, final String newKey) {
        ...
        protected void writeSelect(final FileWriter fileWriter, final String domainClassName, final String tablename) throws IOException {
            fileWriter.append("select @xpto:=null;\nselect @xpto:=DOMAIN_CLASS_INFO.DOMAIN_CLASS_ID from DOMAIN_CLASS_INFO where DOMAIN_CLASS_INFO.DOMAIN_CLASS_NAME = '");
        ...
        protected void writeUpdate(final FileWriter fileWriter, final String domainClassName, final String tablename) throws IOException {
            fileWriter.append("update ");
            fileWriter.append(tablename);
