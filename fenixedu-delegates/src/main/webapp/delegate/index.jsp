...
<ul>
	<li><p class="mtop05 mbottom05"><bean:message key="text.delegates.delegatesConsult.description" arg0="<%=org.fenixedu.academic.domain.organizationalStructure.Unit.getInstitutionAcronym()%>" bundle="DELEGATES_RESOURCES" />;</p></li>
