...
create table DEGREE_CURRICULAR_PLAN (
   ...
   index DEGREE_CURRICULAR_PLAN_KEY_DEGREE (KEY_DEGREE)
)type=InnoDB;
...
create table CURRICULAR_COURSE_SCOPE (
   ...
   index CURRICULAR_COURSE_SCOPE_KEY_CURRICULAR_COURSE (KEY_CURRICULAR_COURSE),
   index CURRICULAR_COURSE_SCOPE_KEY_CURRICULAR_SEMESTER (KEY_CURRICULAR_SEMESTER)
)type=InnoDB;
...
create table CURRICULAR_SEMESTER (
   ...
   index CURRICULAR_SEMESTER_KEY_CURRICULAR_YEAR (KEY_CURRICULAR_YEAR)
)type=InnoDB;
