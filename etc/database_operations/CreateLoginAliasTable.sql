...
insert into LOGIN_ALIAS
    select null, concat('"', USER.USER_U_ID, '"'), IDENTIFICATION.ID_INTERNAL, '?????', null, 1
...
insert into LOGIN_ALIAS
    select null, concat('"P', PARTY.ID_INTERNAL, '"'), IDENTIFICATION.ID_INTERNAL, 'ROLE_TYPE', 'PERSON', 1
...
insert into LOGIN_ALIAS
    select null, concat('"D', TEACHER.TEACHER_NUMBER, '"'), IDENTIFICATION.ID_INTERNAL, 'ROLE_TYPE', 'TEACHER', 1
...
insert into LOGIN_ALIAS
    select null, concat('"F', ass_FUNCIONARIO.EMPLOYEE_NUMBER, '"'), IDENTIFICATION.ID_INTERNAL, 'ROLE_TYPE', 'EMPLOYEE', 1
...
insert into LOGIN_ALIAS
    select null, concat('"B', GRANT_OWNER.NUMBER, '"'), IDENTIFICATION.ID_INTERNAL, 'ROLE_TYPE', 'GRANT_OWNER', 1
...
insert into LOGIN_ALIAS
    select null, concat('"G', PARTY.ID_INTERNAL, '"'), IDENTIFICATION.ID_INTERNAL, 'ROLE_TYPE', 'PROJECTS_MANAGER', 1
    from IDENTIFICATION, USER, PARTY, PERSON_ROLE, ROLE
    where IDENTIFICATION.KEY_USER = USER.ID_INTERNAL
        and USER.KEY_PERSON = PARTY.ID_INTERNAL
        and PERSON_ROLE.KEY_PERSON = PARTY.ID_INTERNAL
...
insert into LOGIN_ALIAS
    select null, concat('"G', PARTY.ID_INTERNAL, '"'), IDENTIFICATION.ID_INTERNAL, 'ROLE_TYPE', 'INSTITUCIONAL_PROJECTS_MANAGER', 1
    from IDENTIFICATION, USER, PARTY, PERSON_ROLE, ROLE
    where IDENTIFICATION.KEY_USER = USER.ID_INTERNAL
        and USER.KEY_PERSON = PARTY.ID_INTERNAL
        and PERSON_ROLE.KEY_PERSON = PARTY.ID_INTERNAL
...
insert into LOGIN_ALIAS
    select null, concat('"C', PARTY.ID_INTERNAL, '"'), IDENTIFICATION.ID_INTERNAL, 'ROLE_TYPE', 'CANDIDATE', 1
    from IDENTIFICATION, USER, PARTY, PERSON_ROLE, ROLE
    where IDENTIFICATION.KEY_USER = USER.ID_INTERNAL
        and USER.KEY_PERSON = PARTY.ID_INTERNAL
        and PERSON_ROLE.KEY_PERSON = PARTY.ID_INTERNAL
...
insert into LOGIN_ALIAS
    select null, concat('"C', PARTY.ID_INTERNAL, '"'), IDENTIFICATION.ID_INTERNAL, 'ROLE_TYPE', 'MASTER_DEGREE_CANDIDATE', 1
    from IDENTIFICATION, USER, PARTY, PERSON_ROLE, ROLE
    where IDENTIFICATION.KEY_USER = USER.ID_INTERNAL
        and USER.KEY_PERSON = PARTY.ID_INTERNAL
        and PERSON_ROLE.KEY_PERSON = PARTY.ID_INTERNAL
...
insert into LOGIN_ALIAS
    select null, concat('"L', STUDENT.NUMBER, '"'), IDENTIFICATION.ID_INTERNAL, 'ROLE_TYPE', 'ALUMNI', 1
...
insert into LOGIN_ALIAS
    select null, concat('"I', STUDENT.NUMBER, '"'), IDENTIFICATION.ID_INTERNAL, 'ROLE_TYPE', 'STUDENT', 1
...
insert into LOGIN_ALIAS
    select null, concat('"A', STUDENT.NUMBER, '"'), IDENTIFICATION.ID_INTERNAL, 'ROLE_TYPE', 'STUDENT', 1
    from IDENTIFICATION, USER, PARTY, PERSON_ROLE, ROLE, STUDENT, REGISTRATION, STUDENT_CURRICULAR_PLAN, DEGREE_CURRICULAR_PLAN, DEGREE, STUDENT_KIND
    where IDENTIFICATION.KEY_USER = USER.ID_INTERNAL
        and USER.KEY_PERSON = PARTY.ID_INTERNAL
        and PERSON_ROLE.KEY_PERSON = PARTY.ID_INTERNAL
...
insert into LOGIN_ALIAS
    select null, concat('"T', STUDENT.NUMBER, '"'), IDENTIFICATION.ID_INTERNAL, 'ROLE_TYPE', 'STUDENT', 1
    from IDENTIFICATION, USER, PARTY, PERSON_ROLE, ROLE, STUDENT, REGISTRATION, STUDENT_CURRICULAR_PLAN, DEGREE_CURRICULAR_PLAN, DEGREE, STUDENT_KIND
    where IDENTIFICATION.KEY_USER = USER.ID_INTERNAL
        and USER.KEY_PERSON = PARTY.ID_INTERNAL
        and PERSON_ROLE.KEY_PERSON = PARTY.ID_INTERNAL
...
insert into LOGIN_ALIAS
    select null, concat('"M', STUDENT.NUMBER, '"'), IDENTIFICATION.ID_INTERNAL, 'ROLE_TYPE', 'STUDENT', 1
    from IDENTIFICATION, USER, PARTY, PERSON_ROLE, ROLE, STUDENT, REGISTRATION, STUDENT_CURRICULAR_PLAN, DEGREE_CURRICULAR_PLAN, DEGREE, STUDENT_KIND
    where IDENTIFICATION.KEY_USER = USER.ID_INTERNAL
        and USER.KEY_PERSON = PARTY.ID_INTERNAL
        and PERSON_ROLE.KEY_PERSON = PARTY.ID_INTERNAL
...
insert into LOGIN_ALIAS
    select null, concat('"L', STUDENT.NUMBER, '"'), IDENTIFICATION.ID_INTERNAL, 'ROLE_TYPE', 'STUDENT', 1
    from IDENTIFICATION, USER, PARTY, PERSON_ROLE, ROLE, STUDENT, REGISTRATION, STUDENT_CURRICULAR_PLAN, DEGREE_CURRICULAR_PLAN, DEGREE, STUDENT_KIND
    where IDENTIFICATION.KEY_USER = USER.ID_INTERNAL
        and USER.KEY_PERSON = PARTY.ID_INTERNAL
        and PERSON_ROLE.KEY_PERSON = PARTY.ID_INTERNAL
...
insert into LOGIN_ALIAS
    select null, concat('"', IDENTIFICATION.USERNAME, '"'), IDENTIFICATION.ID_INTERNAL, '?????', null, 1
