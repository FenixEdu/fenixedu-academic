INSERT INTO ROLE (ROLE_TYPE, OJB_CONCRETE_CLASS) VALUES('HTML_CAPABLE_SENDER','net.sourceforge.fenixedu.domain.Role');
SELECT @xpto:=null;
...
update ROLE set PORTAL_SUB_APPLICATION = '/messaging', PAGE = '/index.do', PAGE_NAME_PROPERTY = 'portal.messaging' where ROLE.ROLE_TYPE = 'HTML_CAPABLE_SENDER';
