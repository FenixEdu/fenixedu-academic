...
alter table `PARTY_CONTACT` add `OID_PREV_PARTY_CONTACT` bigint unsigned, add `OID_PARTY_CONTACT_VALIDATION` bigint unsigned, add `OID_CURRENT_PARTY_CONTACT` bigint unsigned, add `ACTIVE` tinyint(1);
