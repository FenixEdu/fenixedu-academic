INSERT INTO ROLE (ROLE_TYPE, OJB_CONCRETE_CLASS) VALUES('CONTACT_ADMIN','net.sourceforge.fenixedu.domain.Role');
SELECT @xpto:=null;
...
UPDATE ROLE SET OID = (@xpto << 32) + ID_INTERNAL where ROLE_TYPE = "CONTACT_ADMIN";
