...
UPDATE DOMAIN_CLASS_INFO SET DOMAIN_CLASS_NAME = "net.sourceforge.fenixedu.domain.ExecutionSemester" WHERE DOMAIN_CLASS_INFO = "net.sourceforge.fenixedu.domain.ExecutionPeriod";