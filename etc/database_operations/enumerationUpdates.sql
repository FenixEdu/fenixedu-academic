...
update REIMBURSEMENT_GUIDE_SITUATION set REIMBURSEMENT_GUIDE_STATE = 'ISSUED' where STATE = 1;
update REIMBURSEMENT_GUIDE_SITUATION set REIMBURSEMENT_GUIDE_STATE = 'APPROVED' where STATE = 2;
update REIMBURSEMENT_GUIDE_SITUATION set REIMBURSEMENT_GUIDE_STATE = 'PAYED' where STATE = 3;
update REIMBURSEMENT_GUIDE_SITUATION set REIMBURSEMENT_GUIDE_STATE = 'ANNULLED' where STATE = 4;
