...
update SIBS_PAYMENT_FILE_ENTRY set PAYMENT_STATUS = 'NOT_PROCESSED_PAYMENT' where DELIVERY_TYPE = 1;
update SIBS_PAYMENT_FILE_ENTRY set PAYMENT_STATUS = 'PROCESSED_PAYMENT' where DELIVERY_TYPE = 2;
update SIBS_PAYMENT_FILE_ENTRY set PAYMENT_STATUS = 'DUPLICATE_GRATUITY_PAYMENT' where DELIVERY_TYPE = 3;
update SIBS_PAYMENT_FILE_ENTRY set PAYMENT_STATUS = 'DUPLICATE_INSURANCE_PAYMENT' where DELIVERY_TYPE = 4;
update SIBS_PAYMENT_FILE_ENTRY set PAYMENT_STATUS = 'INVALID_EXECUTION_YEAR' where DELIVERY_TYPE = 5;
update SIBS_PAYMENT_FILE_ENTRY set PAYMENT_STATUS = 'INVALID_EXECUTION_DEGREE' where DELIVERY_TYPE = 6;
update SIBS_PAYMENT_FILE_ENTRY set PAYMENT_STATUS = 'INVALID_INSURANCE_VALUE' where DELIVERY_TYPE = 7;
update SIBS_PAYMENT_FILE_ENTRY set PAYMENT_STATUS = 'UNABLE_TO_DETERMINE_STUDENT_CURRICULAR_PLAN' where DELIVERY_TYPE = 8;
