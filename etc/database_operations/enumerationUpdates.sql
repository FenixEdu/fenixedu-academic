...
update GROUP_PROPERTIES set CLASS_TYPE = 'TEORICA' where CLASS_TYPE = 1;
update GROUP_PROPERTIES set CLASS_TYPE = 'PRATICA' where CLASS_TYPE = 2;
update GROUP_PROPERTIES set CLASS_TYPE = 'TEORICO_PRATICA' where CLASS_TYPE = 3;
update GROUP_PROPERTIES set CLASS_TYPE = 'LABORATORIAL' where CLASS_TYPE = 4;