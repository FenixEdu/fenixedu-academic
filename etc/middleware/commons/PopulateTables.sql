...
CREATE INDEX mw_STUDENT_AUXILIARY_TABLE_INDEX_2 on mw_STUDENT_AUXILIARY_TABLE(degreeCode);
CREATE INDEX mw_STUDENT_AUXILIARY_TABLE_INDEX_3 on mw_STUDENT_AUXILIARY_TABLE(number,degreeCode);
