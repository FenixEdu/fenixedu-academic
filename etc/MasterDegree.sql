...
create table MASTER_DEGREE_CANDIDATE (
   ...
   unique u1 (IDENTIFICATION_DOCUMENT_NUMBER, IDENTIFICATION_DOCUMENT_TYPE, APPLICATION_YEAR, DEGREE_KEY),
   unique u3 (USERNAME),
   unique u2 (CANDIDATE_NUMBER, DEGREE_KEY, APPLICATION_YEAR))
   type=InnoDB;
