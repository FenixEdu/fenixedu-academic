...
CREATE TABLE ANNOUNCEMENT (
  ...
  LAST_MODIFICATION_DATE timestamp(14) NOT NULL default '00000000000000',
  INFORMATION text,
...
--
-- Table structure for table `ATTENDS_SET`
--

DROP TABLE IF EXISTS ATTENDS_SET;
CREATE TABLE ATTENDS_SET (
  ID_INTERNAL int(11) unsigned NOT NULL auto_increment,
...
--
-- Table structure for table `ATTEND_ATTENDS_SET`
--

DROP TABLE IF EXISTS ATTEND_ATTENDS_SET;
CREATE TABLE ATTEND_ATTENDS_SET (
  ID_INTERNAL int(11) unsigned NOT NULL auto_increment,
  KEY_ATTEND int(11) NOT NULL default '0',
  KEY_ATTENDS_SET int(11) NOT NULL default '0',
  ACK_OPT_LOCK int(11) default NULL,
  PRIMARY KEY  (ID_INTERNAL),
  UNIQUE KEY U1 (KEY_ATTEND,KEY_ATTENDS_SET)
) TYPE=MyISAM;
...
DROP TABLE IF EXISTS AtribuicaoDisciplinas;
...
CREATE TABLE COUNTRY (
  ...
  ACK_OPT_LOCK int(11) default NULL,
  PRIMARY KEY  (ID_INTERNAL),
  UNIQUE KEY U1 (NAME,NATIONALITY,CODE)
) TYPE=MyISAM;
...
CREATE TABLE CURRICULAR_COURSE (
  ...
  ENROLLMENT_ALLOWED tinyint(1) NOT NULL default '1',
  PRIMARY KEY  (ID_INTERNAL),
...
CREATE TABLE CURRICULAR_COURSE_GROUP (
  ...
  MINIMUM_VALUE int(11) NOT NULL default '0',
...
CREATE TABLE CURRICULUM (
  ...
  KEY_PERSON_WHO_ALTERED int(11) default NULL,
  ACK_OPT_LOCK int(11) default NULL,
  PRIMARY KEY  (ID_INTERNAL)
) TYPE=MyISAM COMMENT='InnoDB free: 372736 kB; InnoDB free: 372736 kB';
...
CREATE TABLE ENROLMENT_PERIOD (
  ...
  PRIMARY KEY  (ID_INTERNAL),
  UNIQUE KEY U1 (CLASS_NAME,KEY_DEGREE_CURRICULAR_PLAN,KEY_EXECUTION_PERIOD)
) TYPE=MyISAM;
...
DROP TABLE IF EXISTS FAQ_ENTRY;
CREATE TABLE FAQ_ENTRY (
  ID_INTERNAL int(11) NOT NULL auto_increment,
  ACK_OPT_LOCK int(11) default NULL,
  KEY_PARENT_SECTION int(11) default NULL,
...
CREATE TABLE FINAL_DEGREE_WORK_SCHEDULEING (
  ...
  END_OF_PROPOSAL_PERIOD timestamp(12) NOT NULL default '000000000000',
...
--
-- Table structure for table `GLOSSARY_ENTRY`
--
...
--
-- Table structure for table `GRANT_CONTRACT_MOVEMENT`
--

DROP TABLE IF EXISTS GRANT_CONTRACT_MOVEMENT;
CREATE TABLE GRANT_CONTRACT_MOVEMENT (
  ID_INTERNAL int(11) unsigned NOT NULL auto_increment,
  ACK_OPT_LOCK int(11) default NULL,
  LOCATION varchar(100) NOT NULL default '',
  DATE_ARRIVAL date NOT NULL default '0000-00-00',
  DATE_DEPARTURE date NOT NULL default '0000-00-00',
...
--
-- Table structure for table `GRATUITY_TRANSACTION`
--

DROP TABLE IF EXISTS GRATUITY_TRANSACTION;
CREATE TABLE GRATUITY_TRANSACTION (
  ID_INTERNAL int(11) NOT NULL auto_increment,
  ACK_OPT_LOCK int(11) default NULL,
  VALUE float NOT NULL default '0',
  TRANSACTION_DATE timestamp(14) NOT NULL,
  REMARKS text,
...
CREATE TABLE GROUP_PROPERTIES (
  ...
  PRIMARY KEY  (ID_INTERNAL),
  UNIQUE KEY NAME_KEY_ATTENDS_SET (NAME,KEY_ATTENDS_SET)
) TYPE=MyISAM COMMENT='InnoDB free: 372736 kB';

--
-- Table structure for table `GROUP_PROPERTIES_EXECUTION_COURSE`
--

DROP TABLE IF EXISTS GROUP_PROPERTIES_EXECUTION_COURSE;
CREATE TABLE GROUP_PROPERTIES_EXECUTION_COURSE (
  ID_INTERNAL int(11) unsigned NOT NULL auto_increment,
  KEY_GROUP_PROPERTIES int(11) unsigned NOT NULL default '0',
  KEY_EXECUTION_COURSE int(11) NOT NULL default '0',
  PROPOSAL_STATE int(11) default NULL,
  KEY_SENDER_PERSON int(11) default NULL,
  KEY_RECEIVER_PERSON int(11) default NULL,
  KEY_SENDER_EXECUTION_COURSE int(11) default NULL,
  ACK_OPT_LOCK int(11) default NULL,
  PRIMARY KEY  (ID_INTERNAL),
  UNIQUE KEY U1 (KEY_GROUP_PROPERTIES,KEY_EXECUTION_COURSE)
) TYPE=MyISAM;
...
--
-- Table structure for table `INSURANCE_VALUE`
--

DROP TABLE IF EXISTS INSURANCE_VALUE;
CREATE TABLE INSURANCE_VALUE (
  ID_INTERNAL int(11) NOT NULL auto_increment,
  ACK_OPT_LOCK int(11) default NULL,
  ANNUAL_VALUE float NOT NULL default '0',
  END_DATE date NOT NULL default '0000-00-00',
  KEY_EXECUTION_YEAR int(11) NOT NULL default '0',
  PRIMARY KEY  (ID_INTERNAL),
  UNIQUE KEY KEY_EXECUTION_YEAR (KEY_EXECUTION_YEAR)
) TYPE=MyISAM;
...
CREATE TABLE PERSON (
  ...
  AVAILABLE_PHOTO tinyint(1) NOT NULL default '0',
  PRIMARY KEY  (ID_INTERNAL),
...
--
-- Table structure for table `PERSONAL_DATA_USE_INQUIRY_ANSWERS`
--

DROP TABLE IF EXISTS PERSONAL_DATA_USE_INQUIRY_ANSWERS;
CREATE TABLE PERSONAL_DATA_USE_INQUIRY_ANSWERS (
  ID_INTERNAL int(11) NOT NULL auto_increment,
  KEY_STUDENT int(11) NOT NULL default '0',
...
CREATE TABLE PERSON_ACCOUNT (
  ...
  KEY_PERSON int(11) NOT NULL default '0',
  PRIMARY KEY  (ID_INTERNAL),
  UNIQUE KEY KEY_PERSON (KEY_PERSON)
) TYPE=MyISAM;
...
DROP TABLE IF EXISTS REIMBURSEMENT_TRANSACTION;
CREATE TABLE REIMBURSEMENT_TRANSACTION (
  ...
  WAS_INTERNAL_BALANCE int(1) NOT NULL default '0',
  KEY_RESPONSIBLE_PERSON int(11) NOT NULL default '0',
  KEY_REIMBURSEMENT_GUIDE_ENTRY int(11) default NULL,
  KEY_PERSON_ACCOUNT int(11) NOT NULL default '0',
  PRIMARY KEY  (ID_INTERNAL),
  UNIQUE KEY KEY_REIMBURSEMENT_GUIDE_ENTRY (KEY_REIMBURSEMENT_GUIDE_ENTRY)
) TYPE=MyISAM;

--
-- Table structure for table `RESIDENCE_CANDIDACIES`
--

DROP TABLE IF EXISTS RESIDENCE_CANDIDACIES;
CREATE TABLE RESIDENCE_CANDIDACIES (
  ID_INTERNAL int(11) NOT NULL auto_increment,
  KEY_STUDENT int(11) NOT NULL default '0',
  DISLOCATED tinyint(1) default NULL,
  OBSERVATIONS varchar(240) default NULL,
  CREATION_DATE datetime NOT NULL default '0000-00-00 00:00:00',
  ACK_OPT_LOCK int(11) default NULL,
  PRIMARY KEY  (ID_INTERNAL)
) TYPE=MyISAM;
...
--
-- Table structure for table `SIBS_PAYMENT_FILE`
--

DROP TABLE IF EXISTS SIBS_PAYMENT_FILE;
CREATE TABLE SIBS_PAYMENT_FILE (
  ID_INTERNAL int(11) NOT NULL auto_increment,
  FILENAME varchar(100) NOT NULL default '',
  ACK_OPT_LOCK int(11) default NULL,
  PRIMARY KEY  (ID_INTERNAL),
  UNIQUE KEY U1 (FILENAME)
) TYPE=MyISAM;

--
-- Table structure for table `SIBS_PAYMENT_FILE_ENTRY`
--

DROP TABLE IF EXISTS SIBS_PAYMENT_FILE_ENTRY;
CREATE TABLE SIBS_PAYMENT_FILE_ENTRY (
  ID_INTERNAL int(11) NOT NULL auto_increment,
  ACK_OPT_LOCK int(11) default NULL,
  KEY_SIBS_PAYMENT_FILE int(11) NOT NULL default '0',
  YEAR int(4) NOT NULL default '0',
  STUDENT_NUMBER int(11) NOT NULL default '0',
  PAYMENT_TYPE int(11) NOT NULL default '0',
  TRANSACTION_DATE timestamp(14) NOT NULL,
  PAYED_VALUE float NOT NULL default '0',
...
CREATE TABLE STUDENT (
  ...
  ENTRY_GRADE float(10,2) default NULL,
  CONTIGENT varchar(10) default NULL,
  INGRESSION varchar(10) default NULL,
  IST_UNIVERSITY varchar(10) default NULL,
  PRIMARY KEY  (ID_INTERNAL),
...
CREATE TABLE STUDENT_GROUP (
  ...
  PRIMARY KEY  (ID_INTERNAL),
  UNIQUE KEY GROUP_NUMBER_KEY_ATTENDS_SET (GROUP_NUMBER,KEY_ATTENDS_SET)
) TYPE=MyISAM COMMENT='InnoDB free: 372736 kB';
...
--
-- Table structure for table `_NUMBER_ENROLLMENTS_`
--

DROP TABLE IF EXISTS _NUMBER_ENROLLMENTS_;
CREATE TABLE _NUMBER_ENROLLMENTS_ (
  NUMBER int(11) unsigned NOT NULL default '0',
  NUMBER_ENROLLMENTS bigint(21) NOT NULL default '0'
) TYPE=MyISAM;

--
-- Table structure for table `_NUMBER_ENROLLMENTS_FIRST_TIME`
--

DROP TABLE IF EXISTS _NUMBER_ENROLLMENTS_FIRST_TIME;
CREATE TABLE _NUMBER_ENROLLMENTS_FIRST_TIME (
  NUMBER int(11) unsigned NOT NULL default '0',
  NUMBER_ENROLLMENTS bigint(21) NOT NULL default '0',
  CODE varchar(100) NOT NULL default ''
) TYPE=MyISAM;
...
DROP TABLE IF EXISTS branch_20032004;
...
CREATE TABLE crd_CREDITS (
  ...
  MASTER_DEGREE_CREDITS float default NULL,
  PRIMARY KEY  (ID_INTERNAL),
...
--
-- Table structure for table `dbo_aluno`
--

DROP TABLE IF EXISTS dbo_aluno;
CREATE TABLE dbo_aluno (
  numero varchar(254) NOT NULL default '',
  nome varchar(254) default NULL,
  apelido varchar(254) default NULL,
  datnascimento varchar(254) default NULL,
  sexo varchar(254) default NULL,
  bi varchar(254) default NULL,
  nacionalidade varchar(254) default NULL,
  morad_origem varchar(254) default NULL,
  pais_origem varchar(254) default NULL,
  morad_local varchar(254) default NULL,
  localid_morad varchar(254) default NULL,
  codpost_loca varchar(254) default NULL,
  localid_postal varchar(254) default NULL,
  tel_local varchar(254) default NULL,
  univ_origem varchar(254) default NULL,
  coord_origem varchar(254) default NULL,
  coord_local varchar(254) default NULL,
  licenciatura varchar(254) default NULL,
  tipo_frequencia varchar(254) default NULL,
  datini varchar(254) default NULL,
  datfim varchar(254) default NULL,
  acordo varchar(254) default NULL,
  tipo_aluno varchar(254) default NULL,
  obs varchar(254) default NULL,
  palavrachave varchar(254) default NULL,
  codpost_local varchar(254) default NULL,
  mo varchar(254) default NULL,
  morad_origem2 varchar(254) default NULL,
  morad_loca varchar(254) default NULL,
  PRIMARY KEY  (numero)
) TYPE=MyISAM;

--
-- Table structure for table `dbo_anulaCurricular`
--

DROP TABLE IF EXISTS dbo_anulaCurricular;
CREATE TABLE dbo_anulaCurricular (
  numero varchar(254) default NULL,
  cadeira varchar(254) default NULL,
  coord varchar(254) default NULL,
  anoinscricao varchar(254) default NULL,
  anocadeira varchar(254) default NULL,
  semestre varchar(254) default NULL,
  nota varchar(254) default NULL,
  datalancamento varchar(254) default NULL,
  dataexame varchar(254) default NULL,
  grauequiv varchar(254) default NULL,
  creditoequiv varchar(254) default NULL,
  tipo_aluno varchar(254) default NULL,
  curso varchar(254) default NULL,
  quemaltera varchar(254) default NULL,
  dataalter varchar(254) default NULL,
  n_reg varchar(254) default NULL,
  tipoalt varchar(254) default NULL,
  state varchar(254) default NULL,
  epoca varchar(254) default NULL
) TYPE=MyISAM;

--
-- Table structure for table `dbo_anulaCurriculares`
--

DROP TABLE IF EXISTS dbo_anulaCurriculares;
CREATE TABLE dbo_anulaCurriculares (
  numero varchar(254) default NULL,
  cadeira varchar(254) default NULL,
  coord varchar(254) default NULL,
  anoinscricao varchar(254) default NULL,
...
--
-- Table structure for table `dbo_cadeira`
--

DROP TABLE IF EXISTS dbo_cadeira;
CREATE TABLE dbo_cadeira (
  codcurso varchar(254) default NULL,
  ano varchar(254) default NULL,
  semestre varchar(254) default NULL,
  codigocad varchar(254) default NULL,
  nome varchar(254) default NULL
) TYPE=MyISAM;

--
-- Table structure for table `dbo_curriculo`
--

DROP TABLE IF EXISTS dbo_curriculo;
CREATE TABLE dbo_curriculo (
  numero varchar(254) default NULL,
  cadeira varchar(254) default NULL,
  coord varchar(254) default NULL,
  anoinscricao varchar(254) default NULL,
  ...
  tipo_aluno varchar(254) default NULL,
  curso varchar(254) default NULL,
  quemalter varchar(254) default NULL,
  dataalter varchar(254) default NULL,
  n_reg varchar(254) default NULL,
  state varchar(254) default NULL,
  epoca varchar(254) default NULL
...
--
-- Table structure for table `dbo_curriculos`
--

DROP TABLE IF EXISTS dbo_curriculos;
CREATE TABLE dbo_curriculos (
  numero varchar(254) default NULL,
  cadeira varchar(254) default NULL,
  coord varchar(254) default NULL,
  anoinscricao varchar(254) default NULL,
...
--
-- Table structure for table `dbo_curso`
--

DROP TABLE IF EXISTS dbo_curso;
CREATE TABLE dbo_curso (
  codigocurso varchar(254) default NULL,
  nome varchar(254) default NULL
) TYPE=MyISAM;

--
-- Table structure for table `dbo_nacionalidade`
--

DROP TABLE IF EXISTS dbo_nacionalidade;
CREATE TABLE dbo_nacionalidade (
  codigonac varchar(254) default NULL,
...
DROP TABLE IF EXISTS guide_aux;
...
DROP TABLE IF EXISTS lessons_update;
...
--
-- Table structure for table `math_RESPONSAVEIS`
--

DROP TABLE IF EXISTS math_RESPONSAVEIS;
CREATE TABLE math_RESPONSAVEIS (
  ID_INTERNAL int(11) NOT NULL auto_increment,
  Codigo_do_Curso varchar(254) default NULL,
  Campus varchar(254) default NULL,
  Nome_do_Curso varchar(254) default NULL,
  Abreviatura_do_Curso varchar(254) default NULL,
  Nome_da_disciplina varchar(254) default NULL,
  Ano varchar(254) default NULL,
  Semestre varchar(254) default NULL,
  Tipo_de_disciplina varchar(254) default NULL,
  Nome_da_area_cientifica varchar(254) default NULL,
  Departamento varchar(254) default NULL,
  Seccao varchar(254) default NULL,
  Codigo_da_disciplina_no_IST varchar(254) default NULL,
  Nome_da_disciplina_no_IST varchar(254) default NULL,
  Horas_teoricas_semanais varchar(254) default NULL,
  Horas_praticas_semanais varchar(254) default NULL,
  Horas_laboratoriais_semanais varchar(254) default NULL,
  Horas_de_auto_estudo_semanais varchar(254) default NULL,
  Creditos_internos varchar(254) default NULL,
  Creditos_ECTS varchar(254) default NULL,
  Nome_do_responsavel varchar(254) default NULL,
  Nome_abreviado_do_responsavel varchar(254) default NULL,
  Telefone_do_responsavel varchar(254) default NULL,
  Nome_da_seccao_do_responsavel varchar(254) default NULL,
  EC_do_responsavel varchar(254) default NULL,
  PRIMARY KEY  (ID_INTERNAL)
) TYPE=MyISAM;

--
-- Table structure for table `mw_ALMEIDA_COUNTRY`
--

DROP TABLE IF EXISTS mw_ALMEIDA_COUNTRY;
CREATE TABLE mw_ALMEIDA_COUNTRY (
  KEY_COUNTRY int(11) default NULL,
  ALMEIDA_CODE int(11) NOT NULL default '0',
  NAME varchar(100) NOT NULL default '',
  ID_INTERNAL int(11) NOT NULL auto_increment,
  PRIMARY KEY  (ID_INTERNAL),
  UNIQUE KEY U2 (NAME),
  UNIQUE KEY U1 (KEY_COUNTRY,ALMEIDA_CODE)
) TYPE=MyISAM;
...
--
-- Table structure for table `mw_EQUIVALENCES`
--

DROP TABLE IF EXISTS mw_EQUIVALENCES;
CREATE TABLE mw_EQUIVALENCES (
  studentNumber int(11) NOT NULL default '0',
  courseCode varchar(11) NOT NULL default '',
  courseName varchar(255) NOT NULL default '',
  ACK_OPT_LOCK int(11) NOT NULL default '1'
) TYPE=MyISAM;
...
--
-- Table structure for table `mw_SCHOOL_REGISTRATION_CANDIDATE`
--

DROP TABLE IF EXISTS mw_SCHOOL_REGISTRATION_CANDIDATE;
CREATE TABLE mw_SCHOOL_REGISTRATION_CANDIDATE (
  studentNumber int(11) NOT NULL default '0',
  curricularYear int(11) NOT NULL default '0',
  degreeCode int(11) NOT NULL default '0',
  ...
  entryGrade float(10,2) default NULL,
  contingent varchar(10) default NULL,
  ingression varchar(10) default NULL,
  istUniversity varchar(10) default NULL,
  entryPhase int(11) default NULL,
  idInternal int(11) NOT NULL auto_increment,
  PRIMARY KEY  (idInternal),
  UNIQUE KEY U1 (studentNumber),
  UNIQUE KEY U2 (idNumber)
) TYPE=MyISAM;
...
DROP TABLE IF EXISTS plano_curricular_2003final;
...
DROP TABLE IF EXISTS submeter126;
...
DROP TABLE IF EXISTS tmp_DOCENTE;
...
DROP TABLE IF EXISTS tmp_GRATUITY_LETTERS_2002;
...
DROP TABLE IF EXISTS tmp_GRATUITY_LETTERS_2002_2003;
...
DROP TABLE IF EXISTS tmp_GRATUITY_LETTERS_2003;
