...
9. To drop employee and contract information from giaf
    ...
    delete from PERSISTENT_GROUP where STRATEGY = 'org.fenixedu.academic.domain.accessControl.DepartmentPresidentStrategy';
