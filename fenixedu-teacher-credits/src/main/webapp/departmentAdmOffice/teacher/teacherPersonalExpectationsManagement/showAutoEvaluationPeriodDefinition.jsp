...
<logic:present role="role(DEPARTMENT_ADMINISTRATIVE_OFFICE)">
	...
	<logic:notEmpty name="bean">
		...
		<fr:form action="/autoEvaluationTeacherExpectationManagementAction.do?method=showPeriodWithSelectedYear">
		...
		<logic:notEmpty name="period">
			...
			<ul class="list5">
				<li>
					<html:link page="<%= "/autoEvaluationTeacherExpectationManagementAction.do?method=editPeriod&executionYearId=" + executionYearId.toString() %>">
		...
		<logic:notEmpty name="bean" property="executionYear">
			...
			<logic:empty name="period">
				...
				<ul class="list5">
					<li>
						<html:link page="<%= "/autoEvaluationTeacherExpectationManagementAction.do?method=createPeriod&executionYearId=" + executionYearId.toString() %>">
