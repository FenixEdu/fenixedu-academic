...
<logic:notEmpty name="period">
	<h2><bean:message key="label.editTeacherExpectationEvaluationPeriodManagement.title"/></h2>
</logic:notEmpty>
<logic:empty name="period">	
	<h2><bean:message key="label.createTeacherExpectationEvaluationPeriodManagement.title"/></h2>
</logic:empty>
...
<logic:present role="role(DEPARTMENT_ADMINISTRATIVE_OFFICE)">
	...
	<logic:notEmpty name="period">		
		...
		<fr:edit id="editInterval" name="period" schema="editTeacherPersonalExpectationsEvaluationPeriod" layout="tabular">
			...
			<fr:destination name="success" path="<%= "/teacherPersonalExpectationsEvaluationPeriod.do?method=showPeriodInExecutionYear&executionYearId=" + executionYearId %>"/>
			<fr:destination name="cancel" path="/teacherPersonalExpectationsEvaluationPeriod.do?method=showPeriod"/>
		</fr:edit>		
	</logic:notEmpty>	
	...
	<logic:empty name="period">		
		...
		<fr:create id="createInterval" type="org.fenixedu.academic.domain.TeacherPersonalExpectationsEvaluationPeriod" schema="createTeacherPersonalExpectationsEvaluationPeriod">
		   	<fr:layout name="tabular">
				<fr:property name="classes" value="tstyle5 thlight thright mtop05"/>
				<fr:property name="columnClasses" value=",,tdclear tderror1"/>
			</fr:layout>
