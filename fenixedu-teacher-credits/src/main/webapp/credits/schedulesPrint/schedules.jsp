...
<h3 class="mbottom05"><bean:message key="label.institution.working.time" arg0="<%=org.fenixedu.academic.domain.organizationalStructure.Unit.getInstitutionAcronym()%>"  bundle="TEACHER_CREDITS_SHEET_RESOURCES"/></h3>
