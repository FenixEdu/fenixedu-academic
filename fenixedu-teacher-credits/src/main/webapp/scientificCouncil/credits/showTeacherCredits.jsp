...
<h3 class="mtop2"><span class="underline1">2) <bean:message key="label.teacherCreditsSheet.professorships.postGraduation" bundle="TEACHER_CREDITS_SHEET_RESOURCES"/></span></h3>
