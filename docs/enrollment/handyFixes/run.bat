...
REM mysql ciapl < update_enrolment_set_state2.sql > temp3.sql
REM mysql ciapl < temp3.sql
REM mysql ciapl < update_enrolment_set_state6.sql > temp4.sql
REM mysql ciapl < temp4.sql
REM del temp1.sql
REM del temp2.sql
REM del temp3.sql
REM del temp4.sql
