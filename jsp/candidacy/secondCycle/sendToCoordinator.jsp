...
<h2><bean:message key="label.candidacy.secondCycle.send.to.coordinator" bundle="APPLICATION_RESOURCES"/></h2>
...
<fr:form action='<%= "/caseHandling" + processName.toString() + ".do?processId=" + processId.toString() %>'>
	...
	<strong><bean:message key="label.candidacy.secondCycle.send.to.coordinator.confirm.message" bundle="APPLICATION_RESOURCES" />?</strong>
	<br/>
	<br/>
