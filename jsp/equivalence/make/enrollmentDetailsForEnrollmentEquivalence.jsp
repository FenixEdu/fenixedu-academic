...
<bean:define id="infoEnrolmentEvaluation" name="infoEnrolmentEvaluation" scope="request"/>
...
<h3><bean:message key="message.enrollment.equivalence.enrollment.details"/></h3>
