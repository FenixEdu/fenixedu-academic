...
<logic:notEqual name="sizeInfoStudentCurricularPlans" value="0">
	...
	<table>
		<tr>
			...
			<td class="infoop">
				<strong><bean:message key="message.enrollment.equivalence.choose.student.plans.delete"/></strong>
			</td>
		</tr>
	</table>
	...
	<html:form action="/selectStudentCurricularPlansToDeleteEnrollmentEquivalence.do">
