...
<ft:tilesView definition="departmentAdmOffice.masterPage" attributeName="body-inline">
	...
	<h:form>
		...
		<h:panelGrid columns="2">
			<h:commandButton alt="#{htmlAltBundle['commandButton.save']}" action="#{teacherExpectationDefinitionPeriodManagement.savePeriod}" value="#{bundle['button.save']}" styleClass="inputbutton" />
