...
<logic:present role="DEPARTMENT_ADMINISTRATIVE_OFFICE">
	...
	<logic:notEmpty name="bean">
		...
		<logic:notEmpty name="period">
			...
			<ul class="list5">
				<li>
					<html:link page="<%= "/teacherPersonalExpectationsEvaluationPeriod.do?method=editPeriod&executionYearId=" + executionYearId %>">
		...
		<logic:empty name="period">
			...
			<ul class="list5">
				<li>
					<html:link page="<%= "/teacherPersonalExpectationsEvaluationPeriod.do?method=createPeriod&executionYearId=" + executionYearId %>">
