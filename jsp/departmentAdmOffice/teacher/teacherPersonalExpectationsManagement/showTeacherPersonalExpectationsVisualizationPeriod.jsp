...
<logic:present role="DEPARTMENT_ADMINISTRATIVE_OFFICE">
	...
	<logic:notEmpty name="bean">
		...
		<logic:notEmpty name="period">
			...
			<ul class="list5">
				<li>
					<html:link page="<%= "/teacherPersonalExpectationsVisualizationPeriod.do?method=editPeriod&executionYearId=" + executionYearId.toString() %>">
		...
		<logic:notEmpty name="bean" property="executionYear">
			...
			<logic:empty name="period">
				...
				<ul class="list5">
					<li>
						<html:link page="<%= "/teacherPersonalExpectationsVisualizationPeriod.do?method=createPeriod&executionYearId=" + executionYearId.toString() %>">
