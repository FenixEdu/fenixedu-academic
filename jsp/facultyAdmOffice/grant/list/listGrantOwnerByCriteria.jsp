...
<tr>
	...
	<td>
        <html:link page='<%= "/listGrantOwnerByCriteria.do?method=prepareListGrantOwnerByCriteria&amp;spanNumber=" + request.getAttribute("beforeSpan") + "&amp;numberOfElementsInSpan=" + request.getAttribute("numberOfElementsInSpan") + "&amp;orderBy=" + request.getAttribute("orderBy") + "&amp;totalElements=" + request.getAttribute("totalElements") %>' > 
...
<html:form action="/listGrantOwnerByCriteria" style="display:inline">
	...
	<td>
        <html:link page='<%= "/listGrantOwnerByCriteria.do?method=prepareListGrantOwnerByCriteria&amp;spanNumber=" + request.getAttribute("afterSpan") + "&amp;numberOfElementsInSpan=" + request.getAttribute("numberOfElementsInSpan") + "&amp;orderBy=" + request.getAttribute("orderBy") + "&amp;totalElements=" + request.getAttribute("totalElements") %>' > 
