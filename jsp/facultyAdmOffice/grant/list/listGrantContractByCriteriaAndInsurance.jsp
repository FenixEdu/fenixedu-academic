...
<bean:define id="validToTheDate" name="listGrantContractByCriteriaForm" property="validToTheDate"/>
	...
	<tr>
		...
		<td>
		<html:link page='<%= "/listGrantContractAndInsuranceByCriteria.do?method=prepareListGrantContractByCriteria&amp;spanNumber=" + request.getAttribute("beforeSpan") + "&amp;orderBy=" + orderBy + "&amp;totalElements=" + totalElements + "&amp;argsInRequest=1&amp;filterType=" + filterType + "&amp;beginContract=" + beginContract + "&amp;endContract=" + endContract + "&amp;grantTypeId=" + grantTypeId + "&amp;validToTheDate=" + validToTheDate %>' > 
    ...
    <logic:iterate id="infoListGrantOwnerByOrder" name="listGrantContract">
        <tr>
			...
			<td class="listClasses">&nbsp;
				<logic:present name="infoListGrantOwnerByOrder" property="totalOfDays">
			        <bean:write name="infoListGrantOwnerByOrder" property="totalOfDays"/>
			    </logic:present>&nbsp;
			</td>
            <td class="listClasses">
