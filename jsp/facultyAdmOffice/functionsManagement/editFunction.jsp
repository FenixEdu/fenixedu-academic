...
<ft:tilesView definition="facultyAdmOffice.masterPage" attributeName="body-inline">
	...
	<h:form>
		...
		<h:panelGrid columns="2" styleClass="infoop">			
			...
			<h:panelGroup>
				<h:inputText alt="#{htmlAltBundle['inputText.beginDate']}" id="beginDate" required="true" size="10" value="#{facultyAdmOfficeFunctionsManagementBackingBean.beginDate}">												
			...
			<h:panelGroup>
				<h:inputText alt="#{htmlAltBundle['inputText.endDate']}" id="endDate" required="true" size="10" value="#{facultyAdmOfficeFunctionsManagementBackingBean.endDate}">
					<fc:dateValidator format="dd/MM/yyyy" strict="true"/>
				</h:inputText>				
				<h:outputText value="#{bundle['label.date.format']}"/>
