...
<logic:iterate id="role" name="userView" property="roles">
	...
	<logic:equal name="role" property="portalSubApplication" value="/scientificCouncil">
	    <td width="20%" nowrap class="navopgeralSelected-td">
	</logic:equal>
	<logic:notEqual name="role" property="portalSubApplication" value="/scientificCouncil">
