...
<ul>
	<li>
		<html:link page="<%= String.format("/scientificCouncilManageThesis.do?method=listApproved&amp;thesisID=%s", thesisId) %>">
			<bean:message key="title.scientificCouncil.list.approved" />
		</html:link>
	</li>
</ul>
