...
<ft:tilesView definition="scientificCouncil.masterPage" attributeName="body-inline">
	...
	<h:form>						
		...
		<h:panelGrid columns="3" styleClass="infoop">			
			...
			<h:inputText id="name" required="true" size="30" value="#{scientificCouncilFunctionsManagementBackingBean.personName}"/>
			<h:commandButton action="#{scientificCouncilFunctionsManagementBackingBean.searchPersonByName}" styleClass="inputbutton" value="#{bundle['button.searchPerson']}"/>
		</h:panelGrid>		
	...
	<h:form>
	    ...
	    <h:panelGrid columns="5" styleClass="infoop">	    	 
			...
			<h:inputText id="number" required="true" size="5" value="#{scientificCouncilFunctionsManagementBackingBean.personNumber}"/>			
			<h:commandButton action="#{scientificCouncilFunctionsManagementBackingBean.searchPersonByNumber}" styleClass="inputbutton" value="#{bundle['button.searchPerson']}"/>
		</h:panelGrid>
