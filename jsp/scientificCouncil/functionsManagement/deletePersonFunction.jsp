...
<ft:tilesView definition="scientificCouncil.masterPage" attributeName="body-inline">
	...
	<h:form>
		...
		<h:panelGrid columns="2" columnClasses="valigntop">		
			...
			<h:panelGroup>			
				<h:outputText value="#{scientificCouncilFunctionsManagementBackingBean.personFunction.unit.parentUnitsPresentationNameWithBreakLine}" escape="false"/>
				<h:outputText value="<br/>" escape="false"/>	
				<h:outputText value="#{scientificCouncilFunctionsManagementBackingBean.personFunction.unit.presentationName}"/>
			</h:panelGroup>	
