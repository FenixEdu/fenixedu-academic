...
<ft:tilesView definition="scientificCouncil.masterPage" attributeName="body-inline">
	...
	<h:form>
		...
		<h:panelGrid rendered="#{scientificCouncilFunctionsManagementBackingBean.numberOfFunctions > 0}" 
			...
			<h:panelGroup>
				<h:inputText id="credits" size="5" maxlength="5" value="#{scientificCouncilFunctionsManagementBackingBean.credits}"/>
		...
		<h:panelGrid rendered="#{scientificCouncilFunctionsManagementBackingBean.numberOfFunctions > 0}"
			...
			<h:panelGroup>
				<h:inputText disabled="#{scientificCouncilFunctionsManagementBackingBean.disabledVar == 0}" id="beginDate"  size="10" value="#{scientificCouncilFunctionsManagementBackingBean.beginDate}">							
			...
			<h:panelGroup>
				<h:inputText disabled="#{scientificCouncilFunctionsManagementBackingBean.disabledVar == 0}" id="endDate" size="10" value="#{scientificCouncilFunctionsManagementBackingBean.endDate}">
					<fc:dateValidator format="dd/MM/yyyy" strict="true"/>
				</h:inputText>				
				<h:outputText value="#{bundle['label.date.format']}"/>
		...
		<h:panelGrid columns="3" rendered="#{scientificCouncilFunctionsManagementBackingBean.numberOfFunctions > 0}">							
			<h:panelGroup>
				<fc:commandButton action="#{scientificCouncilFunctionsManagementBackingBean.verifyFunction}" value="#{bundle['button.continue']}" styleClass="inputbutton">
