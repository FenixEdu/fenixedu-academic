...
<table>		
	...
	<tr>
		...
		<td><html:textarea rows="4" cols="56" name="infoCurriculum" property="generalObjectives" />
		</td>
	...
	<tr>
		...
		<td><html:textarea rows="4" cols="56"  name="infoCurriculum" property="generalObjectivesEn" />
		</td>
	...
	<tr>
		...
		<td><html:textarea rows="4" cols="56"  name="infoCurriculum" property="operacionalObjectives" />
		</td>
	...
	<tr>
		...
		<td><html:textarea rows="4" cols="56" name="infoCurriculum" property="operacionalObjectivesEn" />
		</td>
...
<tr>
		...
		<td><html:textarea rows="4" cols="56"  name="infoCurriculum" property="program" />
		</td>
	...
	<tr>
		...
		<td><html:textarea rows="4" cols="56" name="infoCurriculum" property="programEn" />
		</td>
...
<table>
	<tr>
		...
		<html:hidden property="index" value="<%= degreeCurricularPlanId.toString() %>"/>
