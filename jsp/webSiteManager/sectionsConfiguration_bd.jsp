		...
		<logic:notEmpty name="sectionsList" >
			...
			<logic:iterate id="section" name="sectionsList">
				...
				<tr>
					...
					<td class="listClasses">
						<html:select bundle="HTMLALT_RESOURCES" altKey="select.whatToSort" name="section" property="whatToSort" indexed="true">
					...
					<td class="listClasses">
						<html:select bundle="HTMLALT_RESOURCES" altKey="select.sortingOrder" name="section" property="sortingOrder" indexed="true">
