...
<html:form action="/editPublication.do" >
	...
	<table>
		<tr>
			...
			<td>
				<html:select property="infoPublicationTypeId" onchange="this.form.method.value='lightPrepare';this.form.submit();">
	...
	<table>
		<tr>
			<td>
				<html:submit styleClass="inputbutton" onclick='<%= "this.form.method.value='edit'" %>' >				
					Alterar
				</html:submit>
			</td>
			<td>
