...
<tiles:insert page="/fenixLayout_2col.jsp" flush="true">
  <tiles:put name="title" value=".IST - Portal de Coordenador - Atribuição Manual de Equivalências"/>
  ...
  <tiles:put name="body" value="/coordinator/equivalence/showAllAvailableCurricularCoursesForEquivalence_bd.jsp"/>
