...
<ft:tilesView definition="df.coordinator.evaluation-management" attributeName="body-inline">
	...
	<h:form>
		...
		<h:panelGrid styleClass="infotable" columns="2" border="0">
			...
			<h:panelGroup>
				<h:inputText id="day" required="true" maxlength="2" size="2" value="#{coordinatorWrittenTestsManagementBackingBean.day}">
					<f:validateLongRange minimum="1" maximum="31" />
				</h:inputText>
				<h:message for="day" errorClass="error" />
				<h:outputText value=" / "/>
				<h:inputText id="month" required="true" maxlength="2" size="2" value="#{coordinatorWrittenTestsManagementBackingBean.month}">
					<f:validateLongRange minimum="1" maximum="12" />
				</h:inputText>
				<h:message for="month" errorClass="error" />
				<h:outputText value=" / "/>
				<h:inputText id="year" required="true" maxlength="4" size="4" value="#{coordinatorWrittenTestsManagementBackingBean.year}"/>				
			...
			<h:panelGroup>
				<h:inputText id="beginHour" required="true" maxlength="2" size="2" value="#{coordinatorWrittenTestsManagementBackingBean.beginHour}">
					<f:validateLongRange minimum="0" maximum="23" />
				</h:inputText>
				<h:message for="beginHour" errorClass="error" />
				<h:outputText value=" : "/>
				<h:inputText id="beginMinute" required="true" maxlength="2" size="2" value="#{coordinatorWrittenTestsManagementBackingBean.beginMinute}">
			...
			<h:panelGroup>
				<h:inputText id="endHour" required="true" maxlength="2" size="2" value="#{coordinatorWrittenTestsManagementBackingBean.endHour}">
					<f:validateLongRange minimum="0" maximum="23" />
				</h:inputText>
				<h:message for="endHour" errorClass="error" />
				<h:outputText value=" : "/>
				<h:inputText id="endMinute" required="true" maxlength="2" size="2" value="#{coordinatorWrittenTestsManagementBackingBean.endMinute}">
					<f:validateLongRange minimum="0" maximum="59" />
				</h:inputText>
			...
			<h:panelGroup>
				<h:inputText id="description" required="true" maxlength="120" size="15" value="#{coordinatorWrittenTestsManagementBackingBean.description}"/>
				<h:message for="description" errorClass="error" />
			</h:panelGroup>
		</h:panelGrid>
		<h:outputText value="<br/>" escape="false"/>
		<h:commandButton action="#{coordinatorWrittenTestsManagementBackingBean.createWrittenTest}" styleClass="inputbutton" value="#{bundle['button.create']}"/>
		<h:commandButton immediate="true" action="#{coordinatorWrittenTestsManagementBackingBean.showWrittenTestsForExecutionCourses}" styleClass="inputbutton" value="#{bundle['button.cancel']}"/>
	</h:form>
