...
<%@ taglib uri="/WEB-INF/struts-bean.tld" prefix="bean"%>
	...
	&nbsp;&nbsp;- <html:link page="/studentListByDegree.do?method=getCurricularCourses&jspTitle=title.studentListByCourse&page=0"><bean:message key="link.studentListByCourse" /></html:link>
	<br>
