...
<html:form action="/degreeSiteManagement">
		...
		<div class="gen-button">
			<logic:present name="info">
				<logic:equal name="info" value="description">
					<img src="<%= request.getContextPath() %>/images/portugal-flag.gif"
						alt="Icon: English version!" width="16" height="12" />
					<html:link
						page="<%= "/degreeSiteManagement.do?method=viewInformation&amp;info=description&amp;degreeCurricularPlanID=" + degreeCurricularPlanID.toString()%>">
			...
			<logic:present name="info">
				<logic:equal name="info" value="acess">
					<img src="<%= request.getContextPath() %>/images/portugal-flag.gif"
						alt="Icon: English version!" width="16" height="12" />
					<html:link
						page="<%= "/degreeSiteManagement.do?method=viewInformation&amp;info=acess&amp;degreeCurricularPlanID=" + degreeCurricularPlanID.toString()%>">
						<bean:message key="link.coordinator.degreeSite.editPortuguese" />
					</html:link>
				</logic:equal>
			</logic:present>
			<logic:present name="info">
				<logic:equal name="info" value="professionalStatus">
					<img src="<%= request.getContextPath() %>/images/portugal-flag.gif"
						alt="Icon: English version!" width="16" height="12" />
					<html:link
						page="<%= "/degreeSiteManagement.do?method=viewInformation&amp;info=professionalStatus&amp;degreeCurricularPlanID=" + degreeCurricularPlanID.toString()%>">
						<bean:message key="link.coordinator.degreeSite.editPortuguese" />
					</html:link>
				</logic:equal>
			</logic:present>			
	...
	<logic:notPresent name="inEnglish">
		<div class="gen-button">
			<logic:present name="info">
				<logic:equal name="info" value="description">
					<img src="<%= request.getContextPath() %>/images/england-flag.gif"
						alt="Icon: English version!" width="16" height="12" />
					<html:link
						page="<%= "/degreeSiteManagement.do?method=viewInformation&amp;info=description&amp;inEnglish=true&amp;degreeCurricularPlanID=" + degreeCurricularPlanID.toString()%>">
			...
			<logic:present name="info">
				<logic:equal name="info" value="acess">
					<img src="<%= request.getContextPath() %>/images/england-flag.gif"
						alt="Icon: English version!" width="16" height="12" />
					<html:link
						page="<%= "/degreeSiteManagement.do?method=viewInformation&amp;info=acess&amp;inEnglish=true&amp;degreeCurricularPlanID=" + degreeCurricularPlanID.toString()%>">
						<bean:message key="link.coordinator.degreeSite.editEnglish" />
					</html:link>
				</logic:equal>
			</logic:present>
			<logic:present name="info">
				<logic:equal name="info" value="professionalStatus">
					<img src="<%= request.getContextPath() %>/images/england-flag.gif"
						alt="Icon: English version!" width="16" height="12" />
					<html:link
						page="<%= "/degreeSiteManagement.do?method=viewInformation&amp;info=professionalStatus&amp;inEnglish=true&amp;degreeCurricularPlanID=" + degreeCurricularPlanID.toString()%>">
						<bean:message key="link.coordinator.degreeSite.editEnglish" />
					</html:link>
				</logic:equal>
			</logic:present>			
		...
		<logic:notPresent name="inEnglish">
				...
				<logic:equal name="info" value="description">
					<tr>
						<td><strong><bean:message
							key="label.coordinator.degreeSite.description" /></strong></td>
					</tr>
					<tr>
					...
					<tr>
						<td><strong><bean:message
							key="label.coordinator.degreeSite.objectives" /></strong></td>
					</tr>
					<tr>
					...
					<tr>
						<td><strong><bean:message
							key="label.coordinator.degreeSite.history" /></strong></td>
					</tr>
					<tr>
					...
					<tr>
						<td><strong><bean:message
							key="label.coordinator.degreeSite.professionalExits" /></strong></td>
					</tr>
					<tr>
					...
					<tr>
						<td><strong><bean:message
							key="label.coordinator.degreeSite.additionalInfo" /></strong></td>
					</tr>
					<tr>
					...
					<html:hidden property="qualificationLevel" />
					<html:hidden property="recognitions" />		
			...
			<logic:present name="info">
				<logic:equal name="info" value="acess">
					<tr>
						<td><strong><bean:message
							key="label.coordinator.degreeSite.testIngression" /></strong></td>
					</tr>
					<tr>
					...
					<tr>
						<td><strong><bean:message
							key="label.coordinator.degreeSite.classifications" /></strong></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<table>
							<tr>
								<td>
								<p align="left"><strong><bean:message
									key="label.coordinator.degreeSite.drifts" />:&nbsp;</strong></p>
								</td>
								<td>
								<p align="right"><strong><bean:message
									key="label.coordinator.degreeSite.drifts.initial" /></strong></p>
								</td>
								<td><html:text property="driftsInitial" size="5" /></td>
								<td>
								<p align="right"><strong><bean:message
									key="label.coordinator.degreeSite.drifts.first" /></strong></p>
								</td>
								<td><html:text property="driftsFirst" size="5" /></td>
								<td>
								<p align="right"><strong><bean:message
									key="label.coordinator.degreeSite.drifts.second" /></strong></p>
								</td>
							...
							<tr>
								<td>
								<p align="left"><strong><bean:message
									key="label.coordinator.degreeSite.marks" />:&nbsp;</strong></p>
								</td>
								<td>
								<p align="right"><strong><bean:message
									key="label.coordinator.degreeSite.mark.min" /></strong></p>
								</td>
								<td><html:text property="markMin" size="5" /></td>
								<td>
								<p align="right"><strong><bean:message
									key="label.coordinator.degreeSite.mark.max" /></strong></p>
								</td>
								<td><html:text property="markMax" size="5" /></td>
								<td>
								<p align="right"><strong><bean:message
									key="label.coordinator.degreeSite.mark.average" /></strong></p>
								</td>
			...
			<logic:present name="info">
				<logic:equal name="info" value="professionalStatus">
					<tr>
						<td><strong><bean:message
							key="label.coordinator.degreeSite.qualificationLevel" /></strong></td>
					</tr>
					<tr>
						<td><html:textarea property="qualificationLevel" cols="80" rows="8" /></td>
					</tr>
					<tr>
						<td><strong><bean:message
							key="label.coordinator.degreeSite.recognitions" /></strong></td>
					</tr>
					<tr>
						<td><html:textarea property="recognitions" cols="80" rows="8" /></td>
					</tr>
			...
			<html:hidden property="qualificationLevelEn" />
			<html:hidden property="recognitionsEn" />
		...
		<logic:present name="inEnglish">
			...
			<logic:present name="info">
				<logic:equal name="info" value="description">
					...
					<tr>
						<td><html:textarea property="professionalExitsEn" cols="80"
							rows="8" /></td>
					</tr>
			...
			<logic:present name="info">
				<logic:equal name="info" value="professionalStatus">
					...
					<tr>
						<td><html:textarea property="qualificationLevelEn" cols="80" rows="8" /></td>
					</tr>
					<tr>
						<td><strong><bean:message
							key="label.coordinator.degreeSite.recognitions" /></strong></td>
					...
					<tr>
						<td><html:textarea property="recognitionsEn" cols="80" rows="8" /></td>
					</tr>
