...
<h2><bean:message key="title.shifts.available"/></h2>
	</logic:present>
	<logic:notPresent name="available">						
<h2><bean:message key="title.shifts.inserted"/></h2>		
	<ul>
		<li>
			<html:link  page="/chooseExecutionCourse.do"><bean:message key="label.addShift"/></html:link>
		</li>
	</ul>
	</logic:notPresent>
