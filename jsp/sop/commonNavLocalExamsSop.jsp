...
<ul>
  ...
  <li><html:link page="/chooseDayAndShiftForm.do?method=prepare"><bean:message key="link.exams.searchEmptyRooms"/></html:link></li>
  <li><html:link page="/chooseExamsMapContextDA.do?method=prepare"><bean:message key="link.exams.consultRoomOccupation"/></html:link></li>
</ul>
