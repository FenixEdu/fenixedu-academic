...
<table width="50%" border="0" align="center" cellpadding="0" cellspacing="2">
  <tr>
    <td width="25%" nowrap class="navopgeral"><html:link page="/home.do">Home</html:link></td>
	...
	<td width="25%" nowrap class="centerContent"><html:link page="/logoff.do"><img alt="" border="0" src="<%= request.getContextPath() %>/images/logout.gif"></html:link></td>
  </tr>
</table>
