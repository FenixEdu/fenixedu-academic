...
<ul>
    ...
    <li><html:link page="/chooseExecutionPeriod.do?method=prepare">Gestão de Horï¿½rios</html:link></li>
    ...
    <li><html:link page="/chooseExecutionYearAndDegreeCurricularPlan.do?method=prepare" styleClass="active"><bean:message key="link.curriculumHistoric" bundle="CURRICULUM_HISTORIC_RESOURCES"/></html:link></li>
</ul>
</div>