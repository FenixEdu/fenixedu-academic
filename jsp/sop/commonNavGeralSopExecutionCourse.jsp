...
<table width="50%" border="0" align="center" cellpadding="0" cellspacing="2">
  <tr>
	...
	<td width="20%" nowrap class="navopgeralSelected-td"><html:link page="/manageExecutionCourses.do?method=prepareSearch&amp;page=0&amp">Gestão de Disciplinas</html:link></td>
