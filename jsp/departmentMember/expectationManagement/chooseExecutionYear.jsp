...
<ft:tilesView definition="departmentMember.masterPage" attributeName="body-inline">
	...
	<h:form>
		<h:panelGrid columns="2">
			<h:selectOneMenu id="dropDownListExecutionYearID" value="#{teacherExpectationManagement.selectedExecutionYearID}">
				<f:selectItems value="#{teacherExpectationManagement.executionYears}" />
			</h:selectOneMenu>
			<h:commandLink action="#{teacherExpectationManagement.viewPersonalExpecation}" value="#{bundle['link.continue']}" />
		</h:panelGrid>
	</h:form>
