...
<h3><bean:message key="cms.websiteManagement.item.create" bundle="CMS_RESOURCES"/></h3>
...
<fr:create type="net.sourceforge.fenixedu.domain.cms.website.WebsiteItem" schema="cms.content.basic"
