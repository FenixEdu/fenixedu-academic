...
<%@ taglib uri="/WEB-INF/fenix-renderers.tld" prefix="fr" %>
	...
	<ul>
		...
		<li><html:link  page="/vigilancy/unavailablePeriodManagement.do?method=manageUnavailablePeriodsOfVigilants"><bean:message bundle="VIGILANCY_RESOURCES" key="label.person.vigilancy.displayUnavailableInformation"/></html:link></li>
		<li><html:link  page="/vigilancy/vigilantGroupManagement.do?method=manageIncompatiblesOfVigilants"><bean:message bundle="VIGILANCY_RESOURCES" key="label.person.vigilancy.displayIncompatibleInformation"/></html:link></li>
