...
<logic:present name="studentCurricularPlan">
	...
	<logic:greaterThan name="enrollmentsSize" value="0">
		<html:form action="/courseEnrolmentWithoutRulesManagerDA.do">
			<html:hidden bundle="HTMLALT_RESOURCES" altKey="hidden.method" property="method" value="unEnrollCourses2"/>
			...
			<table >
				<tr>
					...
					<th class="listClasses-header">
						<bean:message key="label.course.enrollment.accumulated.ectsCredits" />
					</th>					
					<th class="listClasses-header">
				...
				<logic:iterate id="enrollment" name="studentCurrentSemesterEnrollments" type="net.sourceforge.fenixedu.domain.Enrolment">
					...
					<tr>
						...
						<td class="listClasses">
							<bean:write name="enrollment" property="accumulatedEctsCredits"/>
						</td>						
...
<html:form action="/courseEnrolmentWithoutRulesManagerDA.do">
	<html:hidden bundle="HTMLALT_RESOURCES" altKey="hidden.method" property="method" value="prepareEnrollmentCourses2"/>
	<html:hidden bundle="HTMLALT_RESOURCES" altKey="hidden.page" property="page" value="1"/>
	<html:hidden property="studentCurricularPlan" />
	<html:hidden property="studentNumber" />	
	<html:hidden bundle="HTMLALT_RESOURCES" altKey="hidden.executionPeriod" property="executionPeriod" />
