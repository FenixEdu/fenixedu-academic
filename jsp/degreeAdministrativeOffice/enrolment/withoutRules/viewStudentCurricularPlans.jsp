	...
	<logic:notEmpty name="studentCurricularPlans">
		<fr:view name="studentCurricularPlans" schema="student.studentCurricularPlans">
			<fr:layout name="tabular" >
				...
				<fr:property name="linkFormat(view)" value="<%= "/courseEnrolmentWithoutRulesManagerDA.do?method=readEnrolments2&amp;studentCurricularPlan=${idInternal}&amp;executionPeriod=" + executionID%>" />
