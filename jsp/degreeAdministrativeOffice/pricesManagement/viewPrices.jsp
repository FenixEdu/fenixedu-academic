...
<h2><bean:message key="label.pricesManagement" /></h2>
...
<logic:iterate id="postingRule" name="postingRules">
	...
	<tr>
		<td>
			<strong><bean:message key="label.pricesManagement.price"/></strong>
		</td>
		<td>
	...
	<tr>
		<td><strong><bean:message key="label.pricesManagement.pricePerUnit"/></strong></td>
		<td><bean:write name="postingRule" property="amountPerUnit"/> <strong><bean:message key="label.currencySymbol"/></strong></td>
	</tr>
	</logic:notEqual>
	<tr>
		<td><strong><bean:message key="label.pricesManagement.pricePerPage"/></strong></td>
	...
	<tr>
		<td colspan="2">
			...
			<html:link page="<%= "/pricesManagement.do?method=prepareEditPrice&postingRuleId=" + postingRuleId %>"><bean:message key="link.pricesManagement.edit"/></html:link>
		</td>
	</tr>
</logic:iterate>
</table>
