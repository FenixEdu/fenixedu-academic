...
<fr:form action='<%= "/payments.do?personId=" + personId %>'>
	...
	<h2><bean:message key="label.payments.eventsWithInstallments" /></h2>
	...
	<logic:notEmpty name="paymentsManagementDTO" property="entryDTOs">
		...
		<br/>
		<html:submit bundle="HTMLALT_RESOURCES" altKey="submit.submit" styleClass="inputbutton" onclick="this.form.method.value='preparePrintGuide';"><bean:message key="button.payments.guide"/></html:submit>
		<html:submit bundle="HTMLALT_RESOURCES" altKey="submit.submit" styleClass="inputbutton" onclick="this.form.method.value='preparePaymentWithInstallments';"><bean:message key="button.payments.preparePayment"/></html:submit>
	...
	<logic:empty name="paymentsManagementDTO" property="entryDTOs">
		<span class="error0"><bean:message key="label.payments.events.noEvents" /></span>
	</logic:empty>
