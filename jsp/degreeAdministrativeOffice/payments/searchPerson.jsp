...
<html:form action="/payments.do">
	...
	<h3><bean:message
		key="label.payments.searchByCandidacyNumber" /></h3>
	<table>
		<tr>
			<td>
				<bean:message
					key="label.payments.number" />:
			</td>
			<td>
	...
	<h3><bean:message
		key="label.payments.searchByUsername" /></h3>
	<table>
	  <tr>
	    <td>
	    	<bean:message key="label.payments.username" />:
	    </td>
	    <td>
	    ...
	    <td>
  	    ...
  	    <td>
			...
			<bean:message key="label.payments.search" />
			</html:submit>
		</td>
	  </tr>
	</table>
	...
	<h3><bean:message
		key="label.payments.searchByDocumentIDandType" /></h3>	
	<table>
	  <tr>
	    <td>
	    	<bean:message key="label.payments.documentType" />:
	    </td>
	    <td>
	  ...
	  <tr>
	    <td>
	    	<bean:message key="label.payments.documentNumber" />:
	    </td>
	    <td>
