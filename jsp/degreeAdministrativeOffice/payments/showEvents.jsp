...
<fr:form action='<%= "/payments.do?personId=" + personId %>'>
	...
	<h2><bean:message key="label.payments.currentEvents" /></h2>
	...
	<logic:notEmpty name="paymentsManagementDTO" property="entryDTOs">
		...
		<html:submit bundle="HTMLALT_RESOURCES" altKey="submit.submit" styleClass="inputbutton" onclick="this.form.method.value='preparePayment';"><bean:message key="button.payments.preparePayment"/></html:submit>
