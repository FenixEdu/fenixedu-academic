...
<html:link page="<%="/viewAttendsSet.do?method=viewAttendsSet&amp;objectCode=" + pageContext.findAttribute("objectCode")+ "&amp;groupPropertiesCode=" + request.getParameter("groupPropertiesCode")+ "&amp;attendsSetCode=" + request.getParameter("attendsSetCode")%>">
...
<table width="50%" cellpadding="0" border="0">
	...
	<logic:iterate id="infoAttend" name="infoAttendsSet" property="infoAttends">
