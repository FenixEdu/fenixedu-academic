...
<h2><bean:message key="title.editDistributedTest" />&nbsp;"<bean:write name="distributedTestForm" property="title" />"</h2>
	...
	<html:hidden property="distributedTestCode" />
	...
	<table>
		...
		<tr>
			...
			<td><html:radio property="imsFeedback" value="true" onclick="selectImsFeedback()" /></td>
		</tr>
		<tr>
			<td></td>
			<td><bean:message key="message.no" /></td>
			<td><html:radio property="imsFeedback" value="false" /></td>
		</tr>
	</table>
	<br />
	<br />
	...
	<table>
		<tr>
			...
			<td><html:submit styleClass="inputbutton" property="addStudents">
				<bean:message key="link.students" />
			</html:submit></td>
			<td><html:submit styleClass="inputbutton" property="addShifts">
	...
	<table align="center">
		<tr>
			<td><html:submit styleClass="inputbutton" property="save">
