...
<li><html:link page="/viewExecutionCourseProjects.do?method=viewExecutionCourseProjects" paramId="objectCode" paramName="executionCourse" paramProperty="idInternal"><bean:message key="link.groupsManagement"/></html:link></li>
	...
	<li><html:link page="/courseInformation.do?method=prepareEdit" paramId="executionCourseId" paramName="executionCourse" paramProperty="idInternal"><bean:message key="link.courseInformationManagement"/></html:link></li>
	</ul>
</logic:present>