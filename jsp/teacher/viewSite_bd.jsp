...
<h2><bean:message key="label.professorships.admin" /></h2>
<p>Utilizando as funcionalidades deste módulo pode definir como as páginas da sua disciplina aparecem ao público, e a informação disponibilizada. Esta é a primeira versão deste módulo. Regularmente iremos melhorá-lo e aumentar as suas funcionalidades. Assim, todas as críticas e sugestões são importantes. Poderá utilizar o e-mail: <a href="mailto:suporte@dot.ist.utl.pt ">suporte@dot.ist.utl.pt </a>
<br />
