			...
			<table class="infotable"> 	
				<tr>
					<td class="bottomborder" colspan="3">
						...
						<b><bean:message key="label.day"/></b>: <bean:write name="exam" property="date"/> <i><bean:message key="label.at" /></i> <bean:write name="exam" property="beginningHour"/><br />
					</td>
				</tr>
				<tr>
					<td colspan="3">
				...
				<tr>
					...
					<td>
						<html:text size="10" name="exam" property="enrollmentBeginDayFormatted"/> <i><bean:message key="label.at" /></i> <html:text size="5" name="exam" property="enrollmentBeginTimeFormatted"/> <i>(dd/mm/aaaa <bean:message key="label.at" /> hh:mm)</i><br />
					</td>
				...
				<tr>
					...
					<td class="bottomborder">
						<html:text size="10" name="exam" property="enrollmentEndDayFormatted"/> <i><bean:message key="label.at" /></i> <html:text size="5" name="exam" property="enrollmentEndTimeFormatted"/> <i>(dd/mm/aaaa <bean:message key="label.at" /> hh:mm)</i><br/>						
					</td>
				</tr>			
				<tr>
					<td colspan="3">
				...
				<tr>
					<td colspan="3">
						<html:link 
							...
							<b><bean:message key="label.students.listMarks"/></b></html:link><br />
					</td>
				</tr> 
			</table>
		</html:form>
