...
<logic:notEqual name="metadatasSize" value="0">
	...
	<logic:greaterThan name="metadatasSize" value="10">
		...
		<div class="gen-button">
			<html:link href="javascript:invertSelect()" titleKey="label.selectAllExercises">
			<bean:message key="label.selectAllExercises"/></html:link>
		<div>
		</td></tr>
		<tr><td>
	...
	<tr>
		...
		<logic:equal name="order" value="description">
			<logic:equal name="asc" value="true">
				...
				<html:link page="<%= "/questionsManagement.do?method=showAvailableQuestions&amp;objectCode=" + pageContext.findAttribute("objectCode")+ "&amp;testCode=" + pageContext.findAttribute("testCode")+ "&amp;order=description&amp;asc=false"%>" titleKey="label.orderByDescription">
			...
			<logic:notEqual name="asc" value="true">
				<img hspace="5" border="0" src="<%= request.getContextPath() %>/images/gray_square.gif" alt="" />
				<html:link page="<%= "/questionsManagement.do?method=showAvailableQuestions&amp;objectCode=" + pageContext.findAttribute("objectCode")+ "&amp;testCode=" + pageContext.findAttribute("testCode")+ "&amp;order=description"%>" titleKey="label.orderByDescription">
				<bean:message key="label.description"/>
				</html:link>
		...
		<logic:equal name="order" value="mainSubject">
			<logic:equal name="asc" value="true">
				<img hspace="5" border="0" src="<%= request.getContextPath() %>/images/gray_square.gif" alt="" />
				<html:link page="<%= "/questionsManagement.do?method=showAvailableQuestions&amp;objectCode=" + pageContext.findAttribute("objectCode")+ "&amp;testCode=" + pageContext.findAttribute("testCode")+ "&amp;order=mainSubject&amp;asc=false"%>" titleKey="label.orderByMateriaPrincipal">
			...
			<logic:notEqual name="asc" value="true">
				<img hspace="5" border="0" src="<%= request.getContextPath() %>/images/gray_square.gif" alt="" />
				<html:link page="<%= "/questionsManagement.do?method=showAvailableQuestions&amp;objectCode=" + pageContext.findAttribute("objectCode")+ "&amp;testCode=" + pageContext.findAttribute("testCode")+ "&amp;order=mainSubject"%>" titleKey="label.orderByMateriaPrincipal">
				<bean:message key="label.test.materiaPrincipal"/>
				</html:link>
		...
		<div class="gen-button">
			...
			<logic:equal name="asc" value="true">
				<img hspace="5" border="0" src="<%= request.getContextPath() %>/images/gray_square.gif" alt="" />
				<html:link page="<%= "/questionsManagement.do?method=showAvailableQuestions&amp;objectCode=" + pageContext.findAttribute("objectCode")+ "&amp;testCode=" + pageContext.findAttribute("testCode")+ "&amp;order=difficulty&amp;asc=false"%>" titleKey="label.orderByDifficulty">
			...
			<logic:notEqual name="asc" value="true">
				<img hspace="5" border="0" src="<%= request.getContextPath() %>/images/gray_square.gif" alt="" />
				<html:link page="<%= "/questionsManagement.do?method=showAvailableQuestions&amp;objectCode=" + pageContext.findAttribute("objectCode")+ "&amp;testCode=" + pageContext.findAttribute("testCode")+ "&amp;order=difficulty"%>" titleKey="label.orderByDifficulty">
				<bean:message key="label.test.difficulty"/>
				</html:link>
	...
	<div class="gen-button">
		<logic:equal name="order" value="numberOfMembers">
			<logic:equal name="asc" value="true">
				<html:link page="<%= "/questionsManagement.do?method=showAvailableQuestions&amp;objectCode=" + pageContext.findAttribute("objectCode")+ "&amp;testCode=" + pageContext.findAttribute("testCode")+ "&amp;order=numberOfMembers&amp;asc=false"%>" titleKey="label.orderByQuantidadeExercicios">
			...
			<logic:notEqual name="asc" value="true">
				<html:link page="<%= "/questionsManagement.do?method=showAvailableQuestions&amp;objectCode=" + pageContext.findAttribute("objectCode")+ "&amp;testCode=" + pageContext.findAttribute("testCode")+ "&amp;order=numberOfMembers"%>" titleKey="label.orderByQuantidadeExercicios">
				<bean:message key="label.test.quantidadeExercicios"/>
				</html:link>
