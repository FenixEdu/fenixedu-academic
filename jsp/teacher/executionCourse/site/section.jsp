...
<div class="mvert1">
    <html:link page="<%= String.format("/manageExecutionCourseSite.do?method=sections&amp;executionCourseID=%s", executionCourseId) %>">
        <bean:message key="link.breadCrumbs.top" bundle="SITE_RESOURCES"/>
    </html:link> &gt;
    
    <logic:iterate id="crumb" name="sectionBreadCrumbs">
        <html:link page="<%= String.format("/manageExecutionCourseSite.do?method=section&amp;executionCourseID=%s", executionCourseId) %>" paramId="sectionID" paramName="crumb" paramProperty="idInternal">
...
<p>
	<span>
		...
		<bean:define id="url" type="java.lang.String">/manageExecutionCourseSite.do?method=editSection&amp;sectionID=<bean:write name="section" property="idInternal"/></bean:define>
    ...
    <span class="switchNoneStyle">
        	<span class="pleft1">	
        		<img src="<%= request.getContextPath() %>/images/dotist_post.gif" alt="<bean:message key="dotist_post" bundle="IMAGE_RESOURCES" />" /> 
        		<bean:define id="url" type="java.lang.String">/manageExecutionCourseSite.do?method=deleteSection&amp;sectionID=<bean:write name="section" property="idInternal"/></bean:define>
        		<html:link page="<%= url %>" paramId="executionCourseID" paramName="executionCourse" paramProperty="idInternal">
	...
	<span class="pleft1">
		<img src="<%= request.getContextPath() %>/images/dotist_post.gif" alt="<bean:message key="dotist_post" bundle="IMAGE_RESOURCES" />" /> 
		<bean:define id="url" type="java.lang.String">/manageExecutionCourseSite.do?method=createSection&amp;sectionID=<bean:write name="section" property="idInternal"/></bean:define>
		<html:link page="<%= url %>" paramId="executionCourseID" paramName="executionCourse" paramProperty="idInternal">
	...
	<span class="pleft1">
		<img src="<%= request.getContextPath() %>/images/dotist_post.gif" alt="<bean:message key="dotist_post" bundle="IMAGE_RESOURCES" />" /> 
		<bean:define id="url" type="java.lang.String">/manageExecutionCourseSite.do?method=editSectionPermissions&amp;sectionID=<bean:write name="section" property="idInternal"/></bean:define>
		<html:link page="<%= url %>" paramId="executionCourseID" paramName="executionCourse" paramProperty="idInternal">
...
<div id="<%= deleteSectionId %>" class="dnone mvert05">
    <fr:form action="<%= String.format("/manageExecutionCourseSite.do?method=confirmSectionDelete&amp;executionCourseID=%s&amp;sectionID=%s&amp;confirm=true", executionCourseId, section.getIdInternal()) %>">
        <p class="width550px">
...
<logic:notEmpty name="section" property="orderedSubSections">
    <fr:form action="<%= "/manageExecutionCourseSite.do?method=saveSectionsOrder&amp;executionCourseID=" + executionCourseId + "&amp;sectionID=" + section.getIdInternal() %>">
    ...
    <div style="background: #FAFAFF; border: 1px solid #EEE; margin: 10px 0px 10px 0px; padding: 10px 10px 10px 10px;">
        <fr:view name="section" property="orderedSubSections">
            ...
            <fr:destination name="section.view" path="<%= "/manageExecutionCourseSite.do?method=section&sectionID=${idInternal}&executionCourseID=" + executionCourseId %>"/>
        </fr:view>

		<p class="mtop15">
		    <fr:form action="<%= "/manageExecutionCourseSite.do?method=section&amp;executionCourseID=" + executionCourseId + "&amp;sectionID=" + section.getIdInternal() %>">
...
<ul class="mbottom2">
    <li>
        <bean:define id="url" type="java.lang.String">/manageExecutionCourseSite.do?method=createItem&amp;sectionID=<bean:write name="section" property="idInternal"/></bean:define>
        <html:link page="<%= url %>" paramId="executionCourseID" paramName="executionCourse" paramProperty="idInternal">
    ...
    <logic:notEmpty name="section" property="associatedItems">
        ...
        <logic:greaterThan name="itemsCount" value="1">
            <li>
                <html:link page="<%= "/manageExecutionCourseSite.do?method=organizeSectionItems&amp;executionCourseID=" + executionCourseId + "&amp;sectionID=" + section.getIdInternal() %>">
...
<logic:notEmpty name="section" property="associatedItems">
	<logic:iterate id="item" name="section" property="orderedItems" type="net.sourceforge.fenixedu.domain.Item">
        ...
        <span>
			<img src="<%= request.getContextPath() %>/images/dotist_post.gif" alt="<bean:message key="dotist_post" bundle="IMAGE_RESOURCES" />" /> 
			<bean:define id="url" type="java.lang.String">/manageExecutionCourseSite.do?method=editItem&amp;itemID=<bean:write name="item" property="idInternal"/></bean:define>
			<html:link page="<%= url %>" paramId="executionCourseID" paramName="executionCourse" paramProperty="idInternal">
				<bean:message key="button.editItem"/>
			</html:link>
		</span>

        <bean:define id="deleteUrl" type="java.lang.String" value="<%= String.format("/manageExecutionCourseSite.do?method=deleteItem&amp;executionCourseID=%s&amp;itemID=%s", executionCourseId, item.getIdInternal()) %>"/>
		...
		<span class="pleft1">
	        <img src="<%= request.getContextPath() %>/images/dotist_post.gif" alt="<bean:message key="dotist_post" bundle="IMAGE_RESOURCES" />" /> 
	        <bean:define id="url" type="java.lang.String">/manageExecutionCourseSite.do?method=editItemPermissions&amp;itemID=<bean:write name="item" property="idInternal"/></bean:define>
	        <html:link page="<%= url %>" paramId="executionCourseID" paramName="executionCourse" paramProperty="idInternal">
		...
		<span class="pleft1">
			<img src="<%= request.getContextPath() %>/images/dotist_post.gif" alt="<bean:message key="dotist_post" bundle="IMAGE_RESOURCES" />" /> 
			<bean:define id="url" type="java.lang.String">/manageExecutionCourseSite.do?method=uploadFile&amp;itemID=<bean:write name="item" property="idInternal"/></bean:define>
			<html:link page="<%= url %>" paramId="executionCourseID" paramName="executionCourse" paramProperty="idInternal">
...
<!--  
        ...
        <logic:notEmpty name="item" property="fileItems">
            ...
            <logic:greaterThan name="filesCount" value="1">
        			<span class="pleft1">
        		        <img src="<%= request.getContextPath() %>/images/dotist_post.gif" alt="<bean:message key="dotist_post" bundle="IMAGE_RESOURCES" />" /> 
        	            <bean:define id="url" type="java.lang.String">/manageExecutionCourseSite.do?method=organizeItemFiles&amp;itemID=<bean:write name="item" property="idInternal"/></bean:define>
        	            <html:link page="<%= url %>" paramId="executionCourseID" paramName="executionCourse" paramProperty="idInternal">
                    	...
                    	<ul>
                        	<logic:iterate id="fileItem" name="item" property="sortedFileItems" type="net.sourceforge.fenixedu.domain.FileItem">
                        		...
                        		<li>
        							...
        							<span class="pleft1">
            		                		(<html:link page="<%= String.format("/manageExecutionCourseSite.do?method=deleteFile&amp;executionCourseID=%s&amp;sectionID=%s&amp;itemID=%s&amp;fileItemId=%s", executionCourseId, section.getIdInternal(), item.getIdInternal(), fileItem.getIdInternal()) %>"
            			                    ...
            			                    <html:link page="<%= String.format("/manageExecutionCourseSite.do?method=prepareEditItemFilePermissions&amp;executionCourseID=%s&amp;sectionID=%s&amp;itemID=%s&amp;fileItemId=%s", executionCourseId, section.getIdInternal(), item.getIdInternal(), fileItem.getIdInternal()) %>">
