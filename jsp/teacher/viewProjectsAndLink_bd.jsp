        ...
        <tbody>
            <logic:iterate id="infoGroupProperties" name="component" property="infoGroupPropertiesList" >
                <tr>
                    <td>
                        <br>
                        <h2><li><html:link page="<%= "/viewProjectStudentGroups.do?method=viewProjectStudentGroups&amp;objectCode=" + pageContext.findAttribute("objectCode")%>" paramId="groupPropertiesCode" paramName="infoGroupProperties" paramProperty="idInternal">
