...
<table>
	<tr><td class="infoop"><bean:message key="message.exercisesFirstPage.information" /></td></tr>
</table>
<br/>
...
<table>
	<tr><td>
		<div class="gen-button">
			<html:link page="<%= "/exercisesManagement.do?method=insertNewExercise&amp;objectCode=" + pageContext.findAttribute("objectCode")+ "&amp;order="+ pageContext.findAttribute("order")+"&amp;asc="+pageContext.findAttribute("asc")%>">
...
<logic:notEqual name="metadatasSize" value="0">
	...
	<tr >
		...
		<logic:equal name="order" value="description">
			<logic:equal name="asc" value="true">
				...
				<html:link page="<%= "/exercisesManagement.do?method=exercisesFirstPage&amp;objectCode=" + pageContext.findAttribute("objectCode")+"&amp;order=description&amp;asc=false" %>">
			...
			<logic:notEqual name="asc" value="true">
				<img hspace="5" border="0" src="<%= request.getContextPath() %>/images/gray_square.gif" alt="" />
				<html:link page="<%= "/exercisesManagement.do?method=exercisesFirstPage&amp;objectCode=" + pageContext.findAttribute("objectCode")+"&amp;order=description"%>">
				<bean:message key="label.description"/>
				</html:link>
				<html:link page="<%= "/exercisesManagement.do?method=exercisesFirstPage&amp;objectCode=" + pageContext.findAttribute("objectCode")+"&amp;order=description"%>">
		...
		<logic:equal name="order" value="mainSubject">
			<logic:equal name="asc" value="true">
				<img hspace="5" border="0" src="<%= request.getContextPath() %>/images/gray_square.gif" alt="" />
				<html:link page="<%= "/exercisesManagement.do?method=exercisesFirstPage&amp;objectCode=" + pageContext.findAttribute("objectCode")+"&amp;order=mainSubject&amp;asc=false"%>">
			...
			<logic:notEqual name="asc" value="true">
				<img hspace="5" border="0" src="<%= request.getContextPath() %>/images/gray_square.gif" alt="" />
				<html:link page="<%= "/exercisesManagement.do?method=exercisesFirstPage&amp;objectCode=" + pageContext.findAttribute("objectCode")+"&amp;order=mainSubject"%>">
				<bean:message key="label.test.materiaPrincipal"/>
				</html:link>
				<html:link page="<%= "/exercisesManagement.do?method=exercisesFirstPage&amp;objectCode=" + pageContext.findAttribute("objectCode")+"&amp;order=mainSubject"%>">
		...
		<logic:equal name="order" value="difficulty">
			<logic:equal name="asc" value="true">
				<img hspace="5" border="0" src="<%= request.getContextPath() %>/images/gray_square.gif" alt="" />
				<html:link page="<%= "/exercisesManagement.do?method=exercisesFirstPage&amp;objectCode=" + pageContext.findAttribute("objectCode")+"&amp;order=difficulty&amp;asc=false"%>">
			...
			<logic:notEqual name="asc" value="true">
				<img hspace="5" border="0" src="<%= request.getContextPath() %>/images/gray_square.gif" alt="" />
				<html:link page="<%= "/exercisesManagement.do?method=exercisesFirstPage&amp;objectCode=" + pageContext.findAttribute("objectCode")+"&amp;order=difficulty"%>">
				<bean:message key="label.test.difficulty"/>
				</html:link>
				<html:link page="<%= "/exercisesManagement.do?method=exercisesFirstPage&amp;objectCode=" + pageContext.findAttribute("objectCode")+"&amp;order=difficulty"%>">
				<img hspace="5" border="0" src="<%= request.getContextPath() %>/images/downArrow.gif" alt="" />
		...
		<logic:equal name="order" value="numberOfMembers">
			<logic:equal name="asc" value="true">
				<html:link page="<%= "/exercisesManagement.do?method=exercisesFirstPage&amp;objectCode=" + pageContext.findAttribute("objectCode")+"&amp;order=numberOfMembers&amp;asc=false"%>">
			...
			<logic:notEqual name="asc" value="true">
				<html:link page="<%= "/exercisesManagement.do?method=exercisesFirstPage&amp;objectCode=" + pageContext.findAttribute("objectCode")+"&amp;order=numberOfMembers"%>">
				<bean:message key="label.test.quantidadeExercicios"/>
				</html:link>
				<html:link page="<%= "/exercisesManagement.do?method=exercisesFirstPage&amp;objectCode=" + pageContext.findAttribute("objectCode")+"&amp;order=numberOfMembers"%>">
				<img hspace="5" border="0" src="<%= request.getContextPath() %>/images/downArrow.gif" alt="" />
	...
	<tr>
		...
		<td><div class="gen-button">
			<html:link page="<%= "/exercisesManagement.do?method=prepareEditExercise&amp;objectCode=" + pageContext.findAttribute("objectCode") + "&amp;exerciseCode=" + pageContext.findAttribute("exerciseCode")+ "&amp;order="+ pageContext.findAttribute("order")+"&amp;asc="+pageContext.findAttribute("asc")%>">
				<bean:message key="label.edit" />
			</html:link>
		</div></td>
		<td><div class="gen-button">
			<html:link page="<%= "/exercisesManagement.do?method=prepareAddExerciseVariation&amp;objectCode=" + pageContext.findAttribute("objectCode") + "&amp;exerciseCode=" + pageContext.findAttribute("exerciseCode")+ "&amp;order="+ pageContext.findAttribute("order")+"&amp;asc="+pageContext.findAttribute("asc")%>">
				<bean:message key="label.add" />
			</html:link>
		</div></td>
		<td><div class="gen-button">
			<html:link page="<%= "/exercisesManagement.do?method=prepareRemoveExercise&amp;objectCode=" + pageContext.findAttribute("objectCode") + "&amp;exerciseCode=" + pageContext.findAttribute("exerciseCode")+ "&amp;order="+ pageContext.findAttribute("order")+"&amp;asc="+pageContext.findAttribute("asc")%>">
