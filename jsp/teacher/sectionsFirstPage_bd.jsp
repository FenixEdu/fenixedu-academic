...
<p>Para começar deverá criar uma nova secção. Uma secção tem um título e dentro da mesma pode inserir itens e subsecções. Os itens podem conter a informação que desejar, inclusivé apontadores para recursos externos.
</p>
