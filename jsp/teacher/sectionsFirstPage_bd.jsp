...
<br/>
Se desejar ver um exemplo pode consultar a página de disciplina de  <html:link href="<%= request.getContextPath()+"/publico/executionCourse.do?method=firstPage&amp;executionCourseID=34661" %>"  target="_blank">Programação com Objectos</html:link>.<br/> Note que nesta página de disciplina aparecem no menu de navegação do lado esquerdo as secções: Avaliação Conhecimentos, Material de Apoio e Planificação.
</p>
