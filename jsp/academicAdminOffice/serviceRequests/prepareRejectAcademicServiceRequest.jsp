...
<h2><bean:message bundle="ACADEMIC_OFFICE_RESOURCES" key="reject.request" /></h2>
...
<p>
	<strong><bean:message bundle="ACADEMIC_OFFICE_RESOURCES"  key="confirm.reject"/></strong>
	<table>
		<tr>
			...
			<td>
				<html:form action="<%="/academicServiceRequestsManagement.do?method=rejectAcademicServiceRequest&academicServiceRequestId=" + academicServiceRequest.getIdInternal().toString()%>">
		...
		<tr>
			<td>
				<html:submit styleClass="inputbutton"><bean:message key="reject" bundle="APPLICATION_RESOURCES"/></html:submit>		
				</html:form>
			</td>
			<td>
