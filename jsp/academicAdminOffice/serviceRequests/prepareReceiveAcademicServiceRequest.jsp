...
<html:form action="<%="/academicServiceRequestsManagement.do?method=receiveAcademicServiceRequest&amp;academicServiceRequestId=" + academicServiceRequest.getIdInternal().toString()%>" style="display: inline;">
