...
<h2><bean:message bundle="DEGREE_OFFICE_RESOURCES" key="label.markSheet.rectificationHistoric"/></h2>
...
<logic:present name="enrolmentEvaluation">
	<table class="tstyle4">
	  <tr>
	    <td><bean:message bundle="DEGREE_OFFICE_RESOURCES" key="label.markSheet.original.grade"/></td>
	  ...
	  <logic:iterate id="evaluation" name="rectificationEvaluations">
		  <tr>
		    <td><bean:message bundle="DEGREE_OFFICE_RESOURCES" key="label.markSheet.rectification"/></td>
		    <td>
		    	<bean:write name="evaluation" property="grade"/> (<dt:format pattern="dd/MM/yyyy"><bean:write name="evaluation" property="examDate.time"/></dt:format>)<br/>
	 				...
	 				<bean:message bundle="DEGREE_OFFICE_RESOURCES" key="label.markSheet.reason"/>:
	...
	<html:form action="/rectifyMarkSheet.do">
		...
		<br/>
		<html:submit bundle="HTMLALT_RESOURCES" altKey="submit.submit" styleClass="inputbutton"><bean:message bundle="DEGREE_OFFICE_RESOURCES" key="label.back"/></html:submit>
	</html:form>
