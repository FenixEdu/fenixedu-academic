...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
     ...
     <table width="500"  border="0" align="center" cellpadding="0" cellspacing="0" class="tablebrd">
       ...
       <tr>
         <td><p>&nbsp;</p>
         <span class="error"><html:errors property="invalidAuthentication"/></span>
           <html:form action="/authenticationStudentForm">
		   <table align='center' border="0">
           <!-- input username -->
           <tr>
             <td><bean:message key="property.login.username"/> </td>
           ...
           <!-- input password -->
           <tr>
             <td><bean:message key="property.login.password"/> </td>
