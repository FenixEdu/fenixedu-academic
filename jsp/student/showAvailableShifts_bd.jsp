					...
					<table >
						...
						<tr>
							<td style="text-align: left;">
								Estes são os agrupamentos de aulas correspondentes à turma que escolheu.
								Seleccione os que deseja frequentar. Note que:
								<ul>
									<li>
										As inscrições em laboratórios são da responsabilidade dos docentes da disciplina.
									</li>
									<li>
										Carregue no botão inscrever para proceder à submissão das suas alterações.
									</li>
									<li>
										Poderá seguir o link "Visualizar Turmas e Horário" para voltar à página de escolha de turma e visualização
										do horário e estado da inscrição.
									</li>
									<li>
										Lembre-se que a qualquer momento, durante o período de inscrição, pode efectuar alterações.
									</li>
									<li>
										Em caso de dúvida ou se necessitar de ajuda, contacte-nos utilizando:
										<a href="mailto:suporte@dot.ist.utl.pt">
											suporte@dot.ist.utl.pt
										</a>
									</li>
								</ul>
							</td>
					...
					<div align="center">
						<h3>
							<html:link page="/studentShiftEnrolmentManager.do?method=initializeShiftEnrolment" transaction="true">
