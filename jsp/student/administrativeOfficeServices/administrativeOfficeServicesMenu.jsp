...
<ul>
	...
	<li><html:link page="/administrativeOfficeServicesSection.do" titleKey="documents.requirement.link.title"><bean:message key="documents.requirement"/></html:link></li>
