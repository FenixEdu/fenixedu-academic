...
<br />	
	<table width="70%" align="center">
		<tr>
			<td colspan="3"><h2 class="redtxt">Informa��es de utiliza��o:</h2><p>Na lista abaixo est�o as turmas que disp�em de vagas nas disciplinas a que pretende frequentar. Para facilitar a escolha, encontram-se ordenadas, por ordem decrescente, de n�mero de disciplinas que se pretende frequentar. Seleccione, por favor, a turma desejada.</p><h2>Turmas</h2></td>
		</tr>
		<tr>
		...
		<logic:iterate id="infoClass" name="infoStudentShiftEnrolment" property="allowedClasses" >
			...
			<tr>
				<td class="listClasses"><bean:write name="curricularYear"/>� Ano</td>
