...
<ul>
	...
	<html:link page="<%="/studentShiftEnrollmentManagerLoockup.do?method=" + link + "&amp;studentId=" + studentId.toString() %>"><bean:message key="link.student.seeAllClasses" /></html:link>
	</li>
</ul>
</logic:present>
			...
			<logic:present name="selectedSchoolClass" >
				...
				<logic:notEqual name="schoolClassId" value="<%= classIdSelected.toString() %>">		
					...
					<logic:present name="executionCourse">
						...
						<html:link page="<%= "/studentShiftEnrollmentManagerLoockup.do?method=" + classSelected + "&amp;studentId=" + studentId.toString()
					...
					<logic:notPresent name="executionCourse">
						<html:link page="<%= "/studentShiftEnrollmentManagerLoockup.do?method=" + classSelected + "&amp;studentId=" + studentId.toString() + "&amp;classId=" + schoolClassId.toString()%>">
							<bean:message key="label.class" />&nbsp;<bean:write name="schoolClass" property="nome" />		
						</html:link>
					</logic:notPresent>					
