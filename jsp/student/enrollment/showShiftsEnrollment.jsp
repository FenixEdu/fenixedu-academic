...
<p><strong><bean:message key="message.shift.enrollement.curricular"/></strong></p>	
		...
		<table class="special">
			<tr>
				...
				<th title="Te�rica"><bean:message key="label.shiftType.theoric"/></th>
				<th title="Pr�tica"><bean:message key="label.shiftType.pratic"/></th>
				<th title="Laborat�rio"><bean:message key="label.shiftType.laboratory"/></th>
				<th title="Te�rico-pr�tica"><bean:message key="label.shiftType.theoricoPratic"/></th>
			</tr>			
