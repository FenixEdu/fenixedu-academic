...
<p class="mtop2 mbottom05">Para facilitar o processo, antes de prosseguir com a inscrição em disciplinas, tome conhecimento de:</p>
<ul class="mtop05">
	<li>regras de inscrição do seu curso</li>
	<li>disciplinas a que se pretende inscrever antes de prosseguir com a inscrição</li>
</ul>


<h3 class="mtop15 separator2">Introdução</h3>

<p>Na tabela encontra representados os grupos de disciplinas (linhas amarelas), disciplinas que ainda não concluíu (nas linhas a branco), disciplinas em que se encontra inscrito (linhas verdes), disciplinas com inscrição provisória (linhhas amarelas) e disciplinas com inscrição impossível (linhas vermelhas).  As disciplinas que já concluíu não aparecem, só aparecem as disciplinas e grupos a que se pode inscrever. Os grupos de disciplinas estão hierarquizados de acordo com a estrutura do curso.</p>
...
<li><strong>Escolher disciplinas de opção (qualquer disciplina do IST):</strong><br/> Carregar no link "Escolher Opção". Deverá inscrever-se primeiro nas disciplinas e nos grupos do currículo e só no final às disciplinas de opção. <em>Atenção: quando carrega em "Escolher Opção" as opções que não foram guardadas são perdidas. Antes de carregar em  "Escolher Opção" certifique-se que guardou as alterações.</em></li>
<li><strong>Confirmar a inscrição em disciplinas:</strong><br/> As linhas que aparecem a verde correpondem ás disciplinas em que se encontra inscrito. Também pode consultar o seu Currículo do Aluno para ver a totalidade das disciplinas a que está inscrito.</li>
</ul>
...
<ul class="list4">
	<li><strong>Inscrições confirmadas</strong> (linhas verdes)</li>
	<li><strong>Inscrições provisórias:</strong> (linhas amarelas)<br/> São inscrições ainda por confirmar, porque os requisitos mínimos necessários para efectivar a inscrição ainda não estão assegurados. Acontece em casos como:
		<ul>
	...
	<li><strong>Inscrições impossíveis:</strong> (linhas vermelhas)<br/> Inscrições nas quais não foram preenchidos os requesitos para confirmar a inscrição. Deverá refazer a inscrição noutra disciplina antes de terminar o prazo.</li>
</ul>
