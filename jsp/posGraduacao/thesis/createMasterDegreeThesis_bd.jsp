			...
			<tr><td colspan="4" >
				<table border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td class="infoop">
							<strong>Nota:</strong> Na indica��o do nome pode ser fornecido apenas parte do nome do orientador externo.<br/>
							Exemplo 1: Para selecionar todos os orientadores externos que come�am com a letra "A" escreva <strong>A%</strong><br/>
							Exemplo 2: Para selecionar todos os orientadores externos que come�am com a letra "A" e que tenham um segundo nome que come�am com a letra "M" escreva <strong>A% M%</strong>
						</td>
					</tr>
				</table></td>	
			</tr>
			...
			<tr><td colspan="4" >
				<table border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td class="infoop">
							<strong>Nota:</strong> Na indica��o do nome pode ser fornecido apenas parte do nome do co-orientador externo.<br/>
							Exemplo 1: Para selecionar todos os co-orientadores externos que come�am com a letra "A" escreva <strong>A%</strong><br/>
							Exemplo 2: Para selecionar todos os co-orientadores externos que come�am com a letra "A" e que tenham um segundo nome que come�am com a letra "M" escreva <strong>A% M%</strong>
						</td>
					</tr>
				</table></td>	
			</tr>
