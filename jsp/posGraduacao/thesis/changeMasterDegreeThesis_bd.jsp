				...
				<table border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td class="infoop">
							...
							Exemplo 2: Para selecionar todos os co-orientadores externos que come�am com a letra "A" e que tenham um segundo nome que come�a com a letra "M" escreva <strong>A% M%</strong>
						</td>
					</tr>
				</table></td>	
			</tr>
