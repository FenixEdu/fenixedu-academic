...
<ul>
	<blockquote>
	    ...
	    <li><html:link page="/seeStudentCurricularPlans.do?method=start"><bean:message key="link.masterDegree.administrativeOffice.seeStudentCurricularPlans"/></html:link></li>
	</blockquote>
</ul>
<ul>
