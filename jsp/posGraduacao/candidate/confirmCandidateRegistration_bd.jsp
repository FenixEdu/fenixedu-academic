...
<logic:present name="infoMasterDegreeCandidate">
	<html:form action="/candidateRegistrationConfirmation.do?method=confirm">
		...
		<div class="infoop">
			...
			<br />&nbsp;&nbsp;&nbsp;&nbsp;Caso este Aluno tenha um n�mero de P�s-Gradua��o que lhe foi atribuido antes do ano lectivo de <strong>2002/2003</strong> introduza-o aqui. 
			<br />&nbsp;&nbsp;&nbsp;&nbsp;Caso este Aluno  ainda n�o tenha um n�mero atribuido ou que essa atribui��o tenha sido feita no decorrer do ano lectivo de <strong>2002/2003</strong> 
			<br />&nbsp;&nbsp;&nbsp;&nbsp;deixe este campo vazio que o programa atribuir� um novo n�mero ou associar� o aluno ao seu respectivo n�mero.
