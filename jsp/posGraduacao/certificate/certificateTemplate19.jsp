...
prestou provas para obten��o do grau de Mestre em  
...
( MBA em  <bean:write name="infoMasterDegreeThesisDataVersion"  property="infoMasterDegreeThesis.infoStudentCurricularPlan.infoDegreeCurricularPlan.infoDegree.nome"/> )
</b> concluidas em  
<bean:write name="conclusiondate" />, com a defesa da disserta��o intitulada "
