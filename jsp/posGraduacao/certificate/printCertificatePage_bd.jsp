...
<table width="100%">
 	...
 	<tr>
		<td>	
	  		<p>O COORDENADOR DO N�CLEO DE P�S-GRADUA��O E FORMA��O CONT�NUA DO INSTITUTO SUPERIOR T�CNICO DA UNIVERSIDADE T�CNICA DE LISBOA CERTIFICA, a requerimento do(a) interessado(a), que do seu processo individual organizado e arquivado nesta secretaria, consta que:<br />
			<%--Certificate --%>			
			...
			<jsp:include page="./certificateTemplate4.jsp" flush="true" />
				...
				<logic:present name="<%= SessionConstants.FINAL_RESULT_SIMPLE%>">
					...
					<logic:equal name="infoStudentCurricularPlan"  property="infoDegreeCurricularPlan.infoDegree.nome" value="Log�stica">
						<jsp:include page="./certificateTemplate16.jsp" flush="true" />
					</logic:equal>
					<logic:notEqual name="infoStudentCurricularPlan"  property="infoDegreeCurricularPlan.infoDegree.nome" value="Log�stica">
