...
<span class="hide">Faï¿½o saber que ao licenciado</span> <bean:write name="infoStudentCurricularPlan" property="infoStudent.infoPerson.nome"/><br/>
...
<span style="margin-left: 4.7cm;" class="hide">lhe foi concebido em,</span>
	...
	<span style="margin:0; padding:0; width: 20em; position: absolute; right: 5.6cm; top: 1.8em;"><span class="hide"> com a qualificaï¿½ï¿½o de &nbsp;</span><span> <bean:message name="<%= SessionConstants.FINAL_RESULT %>" bundle="ENUMERATION_RESOURCES"/></span></span>
</div>

<span class="hide">que, em conformidade com as disposiï¿½ï¿½es legais em vigor, lhe mandei passar a presente carta de curso</span>
<p style="margin-top: 0.40cm; margin-left: 3.8cm;"><span class="hide">Universidade Tï¿½cnica de Lisboa, em</span>&nbsp;&nbsp; <%= java.text.DateFormat.getDateInstance(java.text.DateFormat.LONG, new java.util.Locale("pt", "PT")).format(new java.util.Date()) %><br/></p>
