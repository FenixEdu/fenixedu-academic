...
<p style="margin-bottom: 1.00cm;"><span class="hide">��o com o t�tulo &nbsp;&nbsp;</span> <bean:write name="infoThesisDataVersion" property="dissertationTitle"/></p>
...
<span class="hide">que, em conformidade com as disposi��es legais em vigor, lhe mandei passar a presente carta de curso</span>
<p style="margin-top: 0.40cm; margin-left: 3.8cm;"><span class="hide">Universidade T�cnica de Lisboa, em</span>&nbsp;&nbsp; <%= java.text.DateFormat.getDateInstance(java.text.DateFormat.LONG, new java.util.Locale("pt", "PT")).format(new java.util.Date()) %><br/></p>
