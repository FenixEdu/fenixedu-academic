...
<p style="margin-top: 0.38cm; margin-left: 3.8cm;"><span class="hide">Universidade TÉCNICA de Lisboa, em</span>&nbsp;&nbsp; <%= java.text.DateFormat.getDateInstance(java.text.DateFormat.LONG, new java.util.Locale("pt", "PT")).format(new java.util.Date()) %><br/></p>
