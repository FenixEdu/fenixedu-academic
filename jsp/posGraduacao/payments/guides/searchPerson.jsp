...
<html:form action="/guidesManagement">
	...
	<h3><bean:message key="label.masterDegree.administrativeOffice.payments.searchByCandidacyNumber" /></h3>		
	<bean:message key="label.masterDegree.administrativeOffice.payments.candidacyNumber" />:
	<html:text property="candidacyNumber"/>
	<br/><br/>
	<html:submit styleClass="inputbutton" onclick="this.form.method.value='searchPersonByCandidacyNumber'"><bean:message key="label.masterDegree.administrativeOffice.payments.search"/></html:submit>
	
	<br/><br/><br/>
	
	<h3><bean:message key="label.masterDegree.administrativeOffice.payments.searchByUsername" /></h3>
	<bean:message key="label.masterDegree.administrativeOffice.payments.username" />:
	<html:text property="username"/>
	<br/><br/>
	<html:submit styleClass="inputbutton" onclick="this.form.method.value='searchPersonByUsername'"><bean:message key="label.masterDegree.administrativeOffice.payments.search"/></html:submit>
	
	<br/><br/><br/>
	
	<h3><bean:message key="label.masterDegree.administrativeOffice.payments.searchByDocumentIDandType" /></h3>
	<bean:message key="label.masterDegree.administrativeOffice.payments.documentType" />:
	<e:labelValues id="documentTypes" enumeration="net.sourceforge.fenixedu.domain.person.IDDocumentType" bundle="ENUMERATION_RESOURCES"/>
