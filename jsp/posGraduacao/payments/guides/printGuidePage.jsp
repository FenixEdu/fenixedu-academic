          ...
          <table border="0" width="100%" height="104" align="center" cellpadding="0" cellspacing="0">
            <tr> 
              <td width="50" height="100">
               <img src="<%= request.getContextPath() %>/posGraduacao/payments/guides/images/istlogo.gif" width="50" height="104" border="0"/> 
              </td>
              <td>
                &nbsp;
              </td>
              <td>
                <table border="0" width="100%" height="100%">
                  ...
                  <tr> 
                    <td align="right" valign="top"> <b>Guia de Pagamento</b>,<br/>relativa ao Ano Lectivo 1233233
                    </td>
                  </tr>
                </table>
              </td>
