...
<div id="hdr-nav"><a href="mailto:suporte@dot.ist.utl.pt"><img alt="Icon de Suporte" src="<%= request.getContextPath() %>/images/sup-bar.gif" /></a><a href="<%= request.getContextPath() %>/logoff.do"><img alt="Icon de Logout" src="<%= request.getContextPath() %>/images/logoff-bar.gif" /></a></div>
<!-- End Header -->
<!-- NavGeral -->
...
<table width="100%" border="0" cellspacing="0">
   <tr>
     <td id="navlateral" width="25%" valign="top" nowrap="nowrap"><tiles:insert attribute="navLocal" />
     </td>
     <td id="bodycontent" width="100%" valign="top" >
