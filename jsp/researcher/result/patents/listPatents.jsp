...
<logic:present role="RESEARCHER">
	...
	<html:link module="/researcher" page="/resultPatents/prepareCreatePatent.do">
	...
	<logic:notEmpty name="resultPatents">
		<fr:view name="resultPatents" schema="result.patentShortList" >
			<fr:layout name="tabular">
				<fr:property name="link(edit)" value="/resultPatents/prepareEditPatent.do"/>
				...
				<fr:property name="link(delete)" value="/resultPatents/prepareDeletePatent.do"/>
