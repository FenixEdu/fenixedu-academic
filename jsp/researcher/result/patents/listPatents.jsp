...
<logic:present role="RESEARCHER">
	...
	<html:link module="/researcher" page="/result/resultsManagement.do?method=prepareCreateEditResult&action=createPatent">
	...
	<logic:empty name="patentsList">
		<p><bean:message bundle="RESEARCHER_RESOURCES" key="researcher.result.patent.listPatentsUseCase.emptyList"/></p>
		<br/>
	</logic:empty>
	<logic:notEmpty name="patentsList">
		<fr:view name="patentsList" layout="tabular-list">
			<fr:layout>
				<fr:property name="subLayout" value="values-comma"/>
				<fr:property name="subSchema" value="patents.resume.list"/>
			
				<fr:property name="link(edit)" value="/result/resultsManagement.do?method=prepareCreateEditResult&action=editPatent"/>
