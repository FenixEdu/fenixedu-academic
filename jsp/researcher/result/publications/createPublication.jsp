...
<logic:present role="RESEARCHER">								   
	...
	<logic:equal name="publicationBean" property="createJournal" value="false">
		<logic:equal name="publicationBean" property="createEvent" value="false">
			...
			<p class="breadcumbs"><span class="actual"><bean:message key="label.1stStepInsertPublicationData" bundle="RESEARCHER_RESOURCES"/></span> > <span><bean:message key="label.2ndStepAssociateEvent" bundle="RESEARCHER_RESOURCES"/></span></p>
			</logic:equal>
