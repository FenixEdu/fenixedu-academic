...
<html:form action="/supportLessonsManagement">
	...
	<table class="mbottom2">
		...
		<tr>
			...
			<td>
				<html:text property="startTimeHour" maxlength="2" size="1" /> : <html:text property="startTimeMinutes" maxlength="2" size="1"/>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<html:text property="endTimeHour" maxlength="2" size="1"/> : <html:text property="endTimeMinutes" maxlength="2" size="1"/>
			</td>
		</tr>
		<tr>
			<td>
