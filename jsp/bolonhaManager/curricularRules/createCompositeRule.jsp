...
<ft:tilesView definition="bolonhaManager.masterPage" attributeName="body-inline">
	...
	<h:form>
		<fc:viewState binding="#{CompositeRulesManagement.viewState}"/>
		<h:outputText escape="false" value="<input id='degreeCurricularPlanID' name='degreeCurricularPlanID' type='hidden' value='#{CompositeRulesManagement.degreeCurricularPlanID}'/>"/>
		<h:outputText escape="false" value="<input id='degreeModuleID' name='degreeModuleID' type='hidden' value='#{CompositeRulesManagement.degreeModuleID}'/>"/>
		
		<h:outputText value="<p><strong>#{bolonhaBundle['degreeModule.to.apply.rule']}:</strong> " escape="false"/>
		<h:outputText value="<span class='attention'>#{CompositeRulesManagement.degreeModule.name}</span><p/>" escape="false"/>
