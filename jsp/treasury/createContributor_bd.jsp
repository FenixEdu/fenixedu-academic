...
<html>
  <head>
    <title><bean:message key="title.treasury.createContributor" /></title>
  </head>
  <body>
   ...
   <table>
    ...
    <html:form action="/createContributorDispatchAction?method=create">
       ...
       <!-- Contributor Number -->
       <tr>
         <td><bean:message key="label.treasury.contributorNumber"/> </td>
       ...
       <!-- Contributor Name -->
       <tr>
         <td><bean:message key="label.treasury.contributorName"/> </td>
       ...
       <!-- Contributor Address -->
       <tr>
         <td><bean:message key="label.treasury.contributorAddress"/> </td>
