...
<fr:form action='<%= "/payments.do?personId=" + personId + "&amp;administrativeOfficeId=" + administrativeOfficeId + "&amp;administrativeOfficeUnitId=" + administrativeOfficeUnitId%>'>
	...
	<h2><bean:message bundle="TREASURY_RESOURCES" key="label.payments.currentEvents" /></h2>
	...
	<logic:messagesPresent message="true"  property="<%=org.apache.struts.action.ActionMessages.GLOBAL_MESSAGE%>">
		<ul class="nobullet list6">
			<html:messages id="messages" message="true" bundle="APPLICATION_RESOURCES"  property="<%=org.apache.struts.action.ActionMessages.GLOBAL_MESSAGE%>" bundle="APPLICATION_RESOURCES">
				<li><span class="error0"><bean:write name="messages" /></span></li>
			</html:messages>
		</ul>
	</logic:messagesPresent>
	...
	<logic:notEmpty name="paymentsManagementDTO" property="entryDTOs">
		...
		<p>
		<html:submit bundle="HTMLALT_RESOURCES" altKey="submit.submit" onclick="this.form.method.value='preparePrintGuide';"><bean:message bundle="TREASURY_RESOURCES" key="label.payments.guide"/></html:submit>
		<html:submit bundle="HTMLALT_RESOURCES" altKey="submit.submit" onclick="this.form.method.value='preparePayment';"><bean:message bundle="TREASURY_RESOURCES" key="label.payments.payment"/></html:submit>
