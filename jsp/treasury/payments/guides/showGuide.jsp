...
<h2><bean:message bundle="TREASURY_RESOURCES" key="label.payments.guide"/></h2>
...
<logic:notEmpty name="paymentsManagementDTO" property="selectedEntries">
	...
	<html:form action="/guides.do?method=printGuide" target="_blank">
		<fr:edit id="paymentsManagementDTO" name="paymentsManagementDTO" visible="false"/>
		<html:submit bundle="HTMLALT_RESOURCES" altKey="submit.submit">
			<bean:message bundle="TREASURY_RESOURCES" key="label.payments.print"/>
		</html:submit>
	</html:form>
...
<logic:empty name="paymentsManagementDTO" property="selectedEntries">
	<span class="error"><!-- Error messages go here --><bean:message bundle="TREASURY_RESOURCES" key="label.payments.not.found"/></span>
</logic:empty>
