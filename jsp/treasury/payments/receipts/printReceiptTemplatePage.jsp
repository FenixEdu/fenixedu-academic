...
<tr>
	...
	<td style="padding-left: 1em;">
		...
		<b><bean:message bundle="TREASURY_RESOURCES" key="label.payments.printTemplates.costCenter"/> <bean:write name="ownerUnit" property="costCenterCode"/></b>
		<br/>
		...
		<logic:notEqual name="ownerUnit" property="idInternal" value="<%=creatorUnitId.toString()%>">
			<strong><bean:message bundle="TREASURY_RESOURCES"  key="label.payments.printTemplates.issuedBy"/>:</strong> <bean:write name="creatorUnit" property="name"/>
		</logic:notEqual>
		<hr size="1"/>
	</td>
</tr>
...
<p style="margin-bottom: 0.5em; margin-top: 2em;"><strong><bean:message bundle="TREASURY_RESOURCES"  key="label.payments.printTemplates.receipt.contributor"/> </strong></p>
		...
		<table style="width: 95%;">
			<tr>
				...
				<td style="text-align: right; width: 190px;">
					_______________
					<bean:define id="amount" name="entry" property="originalAmount" type="Money" /> <%=amount.toPlainString()%><bean:message bundle="APPLICATION_RESOURCES" key="label.currencySymbol" />
				</td>
			</tr>
		</table>
	</logic:iterate>
