			...
			<table>
				<tr>
					...
					<table valign="top" align="left" width="90%" cellspacing="0" cellpadding="1">
						<logic:iterate id="lineSummaryPTE" name="infoExpensesReport" property="summaryPTEReport">
							<tr>
					...
					<table valign="top" align="right" width="100%" cellspacing="0" cellpadding="1">
						<logic:iterate id="lineSummaryEUR" name="infoExpensesReport" property="summaryEURReport">
							<tr>
