...
<logic:present name="infoCostCenter" scope="request">
	<p><bean:define id="title" value="title.institucionalProgectsManagement" /></p>
</logic:present>
...
<!--End Context -->
<!-- Header -->
<div id="header"><img alt="Logo <bean:message key="dot.title" bundle="GLOBAL_RESOURCES"/>"
...
<div id="hdr-nav"><a href="<%= supportLink %>"><img alt="Suporte" src="<%= request.getContextPath() %>/images/sup-bar.gif" /></a><a
	href="<%= request.getContextPath() %>/logoff.do"><img alt="Logout" src="<%= request.getContextPath() %>/images/logoff-bar.gif" /></a></div>
<!-- End Header -->
<!-- NavGeral -->
