...
<logic:present name="userView" name="<%= SessionConstants.U_VIEW %>" scope="session">
	...
	<ul>
		...
		<li><html:link page="/projectReport.do?method=prepareShowReport&amp;reportType=completeExpensesReport">
		...
		<li><html:link page="/projectReport.do?method=prepareShowReport&amp;reportType=projectBudgetaryBalanceReport">
			<bean:message key="link.budgetaryBalance" />
		</html:link></li>
		<li><html:link page="/projectReport.do?method=prepareShowReport&amp;reportType=openingProjectFileReport">
	...
	<ul>
		<li><html:link page="/projectReport.do?method=prepareShowReport&amp;reportType=summaryReport">
