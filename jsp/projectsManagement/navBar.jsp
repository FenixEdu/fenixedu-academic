...
<logic:present name="userView" name="<%= SessionConstants.U_VIEW %>"
	...
	<ul>
		<li><html:link
			page="/projectReport.do?method=prepareShowReport&amp;reportType=expensesReport">
			<bean:message key="link.expenses" />
		</html:link></li>
		<li><html:link
			page="/projectReport.do?method=prepareShowReport&amp;reportType=revenueReport">
			<bean:message key="link.revenue" />
		</html:link></li>
		<li><html:link
			page="/projectReport.do?method=prepareShowReport&amp;reportType=cabimentosReport">
			<bean:message key="label.cabimentos" />
		</html:link></li>
		<li><html:link
			page="/projectReport.do?method=prepareShowReport&amp;reportType=adiantamentosReport">
	...
	<ul>
		<li><html:link
			page="/projectReport.do?method=getReport&amp;reportType=summaryReport">
	...
	<ul>
		<li><html:link
			page="/projectReport.do?method=showHelp&amp;helpPage=listHelp">
			<bean:message key="link.listHelp" />
		</html:link></li>
		<li><html:link
			page="/projectReport.do?method=showHelp&amp;helpPage=explorationUnitsRubric">
			<bean:message key="link.explorationUnitsRubric" />
		</html:link></li>
		<li><html:link
			page="/projectReport.do?method=showHelp&amp;helpPage=expensesRubric">
			<bean:message key="link.expensesRubric" />
		</html:link></li>
		<li><html:link
			page="/projectReport.do?method=showHelp&amp;helpPage=revenueRubric">
			<bean:message key="link.revenueRubric" />
		</html:link></li>
		<li><html:link
			page="/projectReport.do?method=showHelp&amp;helpPage=projectTypesRubric">
