...
<logic:present name="materialTypeBean">	
	...
	<bean:define id="showMaterialSpaceOccupationLink">
		/manageMaterialSpaceOccupations.do?method=showMaterialSpaceOccupations&page=0&spaceInformationID=<bean:write name="spaceInformationID"/>
	</bean:define>
	<bean:define id="prepareInsertMaterialOccupationLink">
	...
	<bean:define id="prepareChooseMaterial">
		/manageMaterialSpaceOccupations.do?method=prepareChooseMaterial&page=0
	</bean:define>
	<fr:edit name="materialTypeBean" id="materialTypeWithMaterialType" type="net.sourceforge.fenixedu.dataTransferObject.spaceManager.MaterialTypeBean"
		schema="ChooseMaterialType" action="<%= prepareChooseMaterial %>">			
	...
	<logic:notEmpty name="materialTypeBean" property="materialType">	
		...
		<bean:define id="chooseMaterialSchema">
			Choose<bean:write name="materialTypeBean" property="materialType.simpleName"/>
		</bean:define>
