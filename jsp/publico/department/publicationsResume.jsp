 			...
 			<bean:define id="resultId" name="result" property="idInternal"/>
				<li>
		 			<fr:view name="result" layout="nonNullValues" schema="<%=currentSchema%>">
		 				...
		 				<fr:destination name="view.publication" path="<%= "/unitSite/showResearchResult.do?method=showPublication&amp;resultId=" + resultId + "&amp;selectedDepartmentUnitID=" + unitID + "&amp;siteID=" + siteID %>"/>
