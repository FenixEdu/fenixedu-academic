...
<div class="breadcumbs"><a href="<%= institutionUrl %>"><bean:message key="institution.name.abbreviation" bundle="GLOBAL_RESOURCES"/></a> >
	...
	<!--<div class="col_left">			 	-->
		<logic:notEmpty name="infoDegreeInfo" property="descriptionEn" >			 	
			...
			<p><!-- BREVE DESCRI�AO DA LICENCIATURA--><bean:write name="infoDegreeInfo" property="descriptionEn" filter="false" /></p>
		</logic:notEmpty>
	...
	<logic:notEmpty name="infoDegreeInfo" property="professionalExitsEn" >
		...
		<p><!-- TEXTO - SA�DAS PROFISSIONAIS--><bean:write name="infoDegreeInfo" property="professionalExitsEn" filter="false" /></p>  
	</logic:notEmpty>
	<br />
	<br /> 			  
