...
<li>
	<html:link page="<%= "/accessAnnouncements.do" + "?exeCode=" + pageContext.findAttribute("executionCourseName") + "&amp;ePName=" + pageContext.findAttribute("executionPeriodName") + "&amp;eYName=" + pageContext.findAttribute("executionYearYear") %>">
...
<li> <a href="/" onclick="houdini('seccao');return false;">Informa&ccedil;&atilde;o Curricular</a></li>
 ...
 <dl id="seccao" style="display: none;">
            <dd><html:link page="<%= "/accessObjectives.do?method=acessObjectives" + "&amp;exeCode=" + pageContext.findAttribute("executionCourseName") + "&amp;ePName=" + pageContext.findAttribute("executionPeriodName") + "&amp;eYName=" + pageContext.findAttribute("executionYearYear") %>">
				<bean:message key="link.objectives"/>
				</html:link></dd>
            <dd><html:link page="<%= "/accessProgram.do?method=acessProgram" + "&amp;exeCode=" + pageContext.findAttribute("executionCourseName") + "&amp;ePName=" + pageContext.findAttribute("executionPeriodName") + "&amp;eYName=" + pageContext.findAttribute("executionYearYear") %>">
				<bean:message key="link.program"/>
				</html:link></dd>
			 <dd><html:link page="<%= "/viewEvaluation.do?exeCode=" + pageContext.findAttribute("executionCourseName") + "&amp;ePName=" + pageContext.findAttribute("executionPeriodName") + "&amp;eYName=" + pageContext.findAttribute("executionYearYear") %>">
				<bean:message key="link.evaluation"/>
				</html:link></dd>	
            <dd><html:link page="<%= "/accessBibliographicReferences.do?method=viewBibliographicReference" + "&amp;exeCode=" + pageContext.findAttribute("executionCourseName") + "&amp;ePName=" + pageContext.findAttribute("executionPeriodName") + "&amp;eYName=" + pageContext.findAttribute("executionYearYear") %>">
