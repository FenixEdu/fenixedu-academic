...
<logic:present name="section">
    ...
    <a href="<%= request.getContextPath() + SectionProcessor.getSectionAbsolutePath(executionCourse, section) %>">#</a>
    ...
    <logic:notEmpty name="protectedItems">
            ...
            <a href="<%= request.getContextPath() + ItemProcessor.getItemAbsolutePath(executionCourse, item) %>">#</a>
