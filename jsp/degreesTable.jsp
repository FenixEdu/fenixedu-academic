...
<logic:present name="bolonha">
<bean:define id="bolonha" type="java.lang.String" toScope="request">
	<bean:write name="bolonha"/>
</bean:define>
</logic:present>
	...
	<logic:present name="bolonha">
		<logic:iterate id="bolonhaDegree" name="bolonhaDegrees">
			<logic:equal name="bolonhaDegree" property="bolonhaDegreeType" value="<%= degreeType.toString() %>">
				...
				<TR>
					<TD>
						<html:link href="<%= "bolonha/" + degreeAcronym.toString() %>" title="<%= degreeName.toString() %>">
							<bean:write name="bolonhaDegree" property="acronym"/>
						</html:link>
					</TD>
					<TD>
						<html:link href="<%= "bolonha/" + degreeAcronym.toString() + "/disciplinas"%>">
							<bean:message key="courseSite.url.subpattern" bundle="GLOBAL_RESOURCES"/>
						</html:link>
					</TD>
					<TD>
						<html:link href="<%= "bolonha/" + degreeAcronym.toString() + "/horarios"%>">
							<bean:message key="schedules.url.subpattern" bundle="GLOBAL_RESOURCES"/>
						</html:link>
					</TD>
					<TD>
						<html:link href="<%= "bolonha/" + degreeAcronym.toString() + "/exames"%>">
							<bean:message key="exams.url.subpattern" bundle="GLOBAL_RESOURCES"/>
						</html:link>
					</TD>
				</TR>
