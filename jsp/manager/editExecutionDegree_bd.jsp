...
<html:form action="/editExecutionDegree">
	...
	<html:hidden property="method" value="editPeriods"/>
	<html:hidden property="degreeId" value="<%= request.getParameter("degreeId") %>"/>
	<html:hidden property="degreeCurricularPlanId" value="<%= request.getParameter("degreeCurricularPlanId") %>"/>
	<html:hidden property="executionDegreeId" value="<%= request.getParameter("executionDegreeId") %>"/>
	<html:hidden property="periodToEdit"/>
	
<table>
		<tr>
			<td colspan=4>
				Periodo Aulas 1º Semestre:
			</td>
		</tr>
		...
		<logic:iterate indexId="i" id="xpto" name="executionDegreeForm" property="lessonsFirstStartDay">		
			<tr>
				...
				<td>
					<html:text maxlength="2" size="2" property="lessonsFirstStartDay" 
					...
					/
					<html:text maxlength="2" size="2" property="lessonsFirstStartMonth" 
					...
					/
					<html:text maxlength="4" size="4" property="lessonsFirstStartYear" 
				...
				<td>
					<html:text maxlength="2" size="2" property="lessonsFirstEndDay" 
					...
					/
					<html:text maxlength="2" size="2" property="lessonsFirstEndMonth" 
					...
					/
					<html:text maxlength="4" size="4" property="lessonsFirstEndYear" 
		...
		<logic:iterate indexId="i" id="xpto" name="executionDegreeForm" property="examsFirstStartDay">		
			<tr>
				...
				<td>
					<html:text maxlength="2" size="2" property="examsFirstStartDay" 
					...
					/
					<html:text maxlength="2" size="2" property="examsFirstStartMonth" 
					...
					/
					<html:text maxlength="4" size="4" property="examsFirstStartYear" 
				...
				<td>
					<html:text maxlength="2" size="2" property="examsFirstEndDay" 
					...
					/
					<html:text maxlength="2" size="2" property="examsFirstEndMonth" 
					...
					/
					<html:text maxlength="4" size="4" property="examsFirstEndYear" 
		...
		<logic:iterate indexId="i" id="xpto" name="executionDegreeForm" property="lessonsSecondStartDay">		
			<tr>
				...
				<td>
					<html:text maxlength="2" size="2" property="lessonsSecondStartDay" 
					...
					/
					<html:text maxlength="2" size="2" property="lessonsSecondStartMonth" 
					...
					/
					<html:text maxlength="4" size="4" property="lessonsSecondStartYear" 
				...
				<td>
					<html:text maxlength="2" size="2" property="lessonsSecondEndDay" 
					...
					/
					<html:text maxlength="2" size="2" property="lessonsSecondEndMonth" 
					...
					/
					<html:text maxlength="4" size="4" property="lessonsSecondEndYear" 
		...
		<logic:iterate indexId="i" id="xpto" name="executionDegreeForm" property="examsSecondStartDay">		
			<tr>
				...
				<td>
					<html:text maxlength="2" size="2" property="examsSecondStartDay" 
					...
					/
					<html:text maxlength="2" size="2" property="examsSecondStartMonth" 
					...
					/
					<html:text maxlength="4" size="4" property="examsSecondStartYear" 
				...
				<td>
					<html:text maxlength="2" size="2" property="examsSecondEndDay" 
					...
					/
					<html:text maxlength="2" size="2" property="examsSecondEndMonth" 
					...
					/
					<html:text maxlength="4" size="4" property="examsSecondEndYear" 
...
<br/>
	<html:submit styleClass="inputbutton" onclick="this.form.method.value='editPeriods';this.form.page.value=2;">
		<bean:message key="button.save"/>
	</html:submit>
	<html:reset  styleClass="inputbutton">
		<bean:message key="label.clear"/>
