...
<p>
    ...
    <span class="pleft1">
        <img src="<%= request.getContextPath() %>/images/dotist_post.gif" alt="<bean:message key="dotist_post" bundle="IMAGE_RESOURCES" />" /> 
        <html:link page="<%= String.format("%s?method=prepareCreateFunctionalitySection&amp;%s&amp;sectionID=%s", actionName, context, sectionId) %>">
            <bean:message key="link.create.SubFunctionalitySection" bundle="SITE_RESOURCES"/>
        </html:link>
    </span>
