		...
		<html:hidden bundle="HTMLALT_RESOURCES" altKey="hidden.degreeId" property="degreeId" value="<%= request.getParameter("degreeId") %>"/>
			<table cellpadding="0" border="0">
				<tr>
					...
					<th class="listClasses-header">Aulas 1� Semestre
					</th>
					<th class="listClasses-header">Exames 1� Semestre
					</th>
					<th class="listClasses-header">Aulas 2� Semestre
					</th>
					<th class="listClasses-header">Exames 2� Semestre
					</th>
					<th class="listClasses-header">
					</th>
				</tr>
