...
<html:form action="/insertProfessorShipNonAffiliatedTeacher" method="get"> 
	...
	<table cellspacing="10">
		<logic:iterate name="nonAffiliatedTeachers" id="nonAffiliatedTeacher">
			<tr>
				...
				<td><td><html:link module="/manager" page="<%="/insertProfessorShipNonAffiliatedTeacher.do?method=insertProfessorship&amp;degreeId=" + request.getParameter("degreeId") + "&amp;degreeCurricularPlanId=" + request.getParameter("degreeCurricularPlanId")  + "&amp;curricularCourseId=" + request.getParameter("curricularCourseId") + "&amp;executionCourseId=" + request.getParameter("executionCourseId") + "&amp;nonAffiliatedTeacherID=" + nonAffiliatedTeacherID %>" paramId="executionCourseName" paramName="executionCourseName">Associar � disciplina</html:link></td>
			</tr>
		</logic:iterate>
	</table>
	</logic:notEmpty>
	...
	<table cellpadding="5">
		...
		<tr>
			<td> Escolha a institui��o � qual o docente pertence </td>		
			<td>
		...
		<logic:notPresent parameter="insertInstitution">
			<tr>
				<td><html:link module="/manager" page="<%="/insertProfessorShipNonAffiliatedTeacher.do?method=prepare&amp;degreeId=" + request.getParameter("degreeId") + "&amp;degreeCurricularPlanId=" + request.getParameter("degreeCurricularPlanId")  + "&amp;curricularCourseId=" + request.getParameter("curricularCourseId") + "&amp;executionCourseId=" + request.getParameter("executionCourseId") + "&amp;insertInstitution=true"%>" paramId="executionCourseName" paramName="executionCourseName">Inserir nova institui��o</html:link></td>
			</tr>
		</logic:notPresent>
