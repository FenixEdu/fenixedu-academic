	...
	<h:form>
		...
		<h:panelGroup rendered="#{!empty createExecutionDegrees.degreeCurricularPlansSelectItems.value || !empty createExecutionDegrees.bolonhaDegreeCurricularPlansSelectItems.value}">
			<h:outputText value="<fieldset class='lfloat3'>" escape="false"/>
				...
				<h:outputText value="<p><label>Ano de execu��o:</label>" escape="false"/>
				...
				<h:outputText value="</p>" escape="false"/>
				<h:outputText value="<p><label>Mapa de exames tempor�rio:</label>" escape="false"/>
					<h:selectBooleanCheckbox value="#{createExecutionDegrees.temporaryExamMap}" />		
				<h:outputText value="</p>" escape="false"/>
				<h:outputText value="</div>" escape="false"/>

				<h:outputText value="<div class='simpleblock4'>" escape="false"/>
				<h:outputText value="<p><label><strong>1� Semestre</strong></label></p><br/>" escape="false"/>
				...
				<h:outputText value="</p>" escape="false"/>
				<h:outputText value="<p><label>Prazo Lan�amento Notas</label>" escape="false"/>
				...
				<h:outputText value="<div class='simpleblock4'>" escape="false"/>
				<h:outputText value="<p><label><strong>2� Semestre</strong></label></p><br/>" escape="false"/>
				<h:outputText value="<p><label>Aulas</label>" escape="false"/>
				...
				<h:outputText value="<div class='simpleblock4'>" escape="false"/>
				<h:outputText value="<p><label><strong>�poca Especial</strong></label></p><br/>" escape="false"/>
				<h:outputText value="<p><label>Exames</label>" escape="false"/>
