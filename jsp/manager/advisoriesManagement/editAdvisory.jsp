...
<ft:tilesView definition="definition.manager.masterPage" attributeName="body-inline">
	...
	<h:form>
		...
		<h:panelGrid columns="2">
			...
			<h:panelGroup>
				<h:inputText id="sender" required="true" size="50" value="#{advisoriesManagementBackingBean.sender}"/>
				<h:message for="sender" styleClass="error"/>
			</h:panelGroup>
		
			<h:outputText value="#{bundle['property.advisory.subject']}"/>
			<h:panelGroup>
				<h:inputText id="subject" required="true" size="50" value="#{advisoriesManagementBackingBean.subject}"/>
				<h:message for="subject" styleClass="error"/>
			</h:panelGroup>
			
			<h:outputText value="#{bundle['property.advisory.expirationDate']}"/>
			<h:panelGroup>
				<h:inputText id="expires" required="true" size="20" value="#{advisoriesManagementBackingBean.expires}" />				
		 ...
		 <h:commandButton styleClass="inputbutton" action="editAdvisory" immediate="true" value="#{bundle['label.return']}" />
