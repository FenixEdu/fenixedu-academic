...
<bean:define id="userView"
			 name="<%= SessionConstants.U_VIEW %>"
			 scope="session"/>
<table width="50%" border="0" align="center" cellpadding="0" cellspacing="2">
	<tr>
		<logic:iterate id="role" name="userView" property="roles">
			...
			<logic:equal name="role" property="portalSubApplication" value="/manager">
		...
		<td width="20%" nowrap class="centerContent">
			<html:link forward="logoff">
				<img alt="" border="0" src="<%= request.getContextPath() %>/images/logout.gif">
			</html:link>
		</td>
	</tr>
</table>	