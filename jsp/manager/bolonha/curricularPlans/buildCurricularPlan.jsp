...
<ft:tilesView definition="definition.manager.masterPage" attributeName="body-inline">
	...
	<h:form>
		...
		<h:outputLink value="#{CurricularCourseManagement.request.contextPath}/manager/bolonha/curricularPlans/editCurricularPlanStructure.faces">
		...
		<h:panelGroup rendered="#{!empty CurricularCourseManagement.degreeCurricularPlan.root.childContexts}">
			<h:outputText value="<li>" escape="false"/>
				<h:outputLink value="#{CurricularCourseManagement.request.contextPath}/manager/bolonha/curricularPlans/setCurricularRules.faces" >
		...
		<h:panelGroup rendered="#{!empty CurricularCourseManagement.degreeCurricularPlan.degreeStructure.childs}">
			...
			<h:outputLink value="#{CurricularCourseManagement.request.contextPath}/manager/bolonha/curricularPlans/buildCurricularPlan.faces" rendered="#{CurricularCourseManagement.organizeBy == 'years'}">
			...
			<h:outputLink value="#{CurricularCourseManagement.request.contextPath}/manager/bolonha/curricularPlans/buildCurricularPlan.faces" rendered="#{CurricularCourseManagement.organizeBy == 'groups'}">
