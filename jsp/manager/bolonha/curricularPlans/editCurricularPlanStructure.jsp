...
<ft:tilesView definition="definition.manager.masterPage" attributeName="body-inline">
	...
	<h:form>
		...
		<h:panelGroup rendered="#{!empty CurricularCourseManagement.degreeCurricularPlan.root.childContexts}">
			...
			<h:outputLink value="#{CurricularCourseManagement.request.contextPath}/manager/bolonha/curricularPlans/editCurricularPlanStructure.faces" rendered="#{CurricularCourseManagement.toOrder == 'true'}">
			...
			<h:outputLink value="#{CurricularCourseManagement.request.contextPath}/manager/bolonha/curricularPlans/editCurricularPlanStructure.faces" rendered="#{CurricularCourseManagement.toOrder == 'false'}">
