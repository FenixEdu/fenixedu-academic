...
<ft:tilesView definition="definition.manager.masterPage" attributeName="body-inline">
	...
	<h:panelGroup>
		...
		<fc:dataRepeater value="#{DegreeManagement.filteredBolonhaDegrees}" var="degree" rendered="#{!empty DegreeManagement.filteredBolonhaDegrees}">
			...
			<h:outputLink value="#{DegreeManagement.request.contextPath}/manager/bolonha/curricularPlans/viewDegree.faces">
			...
			<fc:dataRepeater value="#{degree.degreeCurricularPlans}" var="degreeCurricularPlan" rendered="#{!empty degree.degreeCurricularPlans}" rowIndexVar="index">
				...
				<h:outputText value="<td>" escape="false"/>
				<h:outputLink value="#{DegreeManagement.request.contextPath}/manager/bolonha/curricularPlans/viewCurricularPlan.faces">
				...
				<h:outputLink value="#{DegreeManagement.request.contextPath}/manager/bolonha/curricularPlans/editCurricularPlan.faces">
				...
				<h:outputText value=" , " escape="false" rendered="#{degreeCurricularPlan.userCanBuild}"/>
				<h:outputLink value="#{DegreeManagement.request.contextPath}/manager/bolonha/curricularPlans/buildCurricularPlan.faces" rendered="#{degreeCurricularPlan.userCanBuild}">
